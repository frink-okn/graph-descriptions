...
# Class: glass processing capability (sudokn_GlassProcessingCapability)
...
URI: [sudokn:GlassProcessingCapability](http://asu.edu/semantics/SUDOKN/GlassProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknGlassProcessingCapability
    click SudoknGlassProcessingCapability href "../SudoknGlassProcessingCapability"
      ...
      SudoknGlassProcessingCapability : rdfs_label
        
          
    
    
    SudoknGlassProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknGlassProcessingCapability](../classes/SudoknGlassProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknGlassProcessingCapability](../classes/SudoknGlassProcessingCapability.md) |
...
| ---  | ---  |
| self | sudokn:GlassProcessingCapability |
| native | sudokn-kg/:SudoknGlassProcessingCapability |
...
<details>
```yaml
name: sudokn_GlassProcessingCapability
description: TODO -- tell the world what this class (type) describes.
title: glass processing capability
todos:
- TODO -- Todos for this class go here
- or you can delete the todos
- if you think the class is perfect.
notes:
- Class with 2866 occurences.
examples:
- value: sudokn:101PIPE-Glass-inst
from_schema: sudokn-kg
is_a: sudokn_MaterialProcessingCapability
slots:
- rdfs_label
class_uri: sudokn:GlassProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_GlassProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
