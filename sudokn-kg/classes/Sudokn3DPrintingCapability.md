...
# Class: TODO -- what's a good name for this class (type)? (sudokn_3DPrintingCapability)
...
URI: [sudokn:3DPrintingCapability](http://asu.edu/semantics/SUDOKN/3DPrintingCapability)
...
```mermaid
 classDiagram
    class Sudokn3DPrintingCapability
    click Sudokn3DPrintingCapability href "../Sudokn3DPrintingCapability"
      Sudokn3DPrintingCapability : rdfs_label
        
          
    
    
    Sudokn3DPrintingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [Sudokn3DPrintingCapability](../classes/Sudokn3DPrintingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [Sudokn3DPrintingCapability](../classes/Sudokn3DPrintingCapability.md) |
...
| ---  | ---  |
| self | sudokn:3DPrintingCapability |
| native | sudokn-kg/:Sudokn3DPrintingCapability |
...
<details>
```yaml
name: sudokn_3DPrintingCapability
...
examples:
- value: sudokn:applerock-3DPrinting
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:3DPrintingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_3DPrintingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
