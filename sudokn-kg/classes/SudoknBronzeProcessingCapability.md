...
# Class: bronze processing capability (sudokn_BronzeProcessingCapability)




This class occurs 1754 times.


URI: [sudokn:BronzeProcessingCapability](http://asu.edu/semantics/SUDOKN/BronzeProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknBronzeProcessingCapability
    click SudoknBronzeProcessingCapability href "../SudoknBronzeProcessingCapability"
      ...
      SudoknBronzeProcessingCapability <|-- SudoknPhosphorBronzeProcessingCapability
        click SudoknPhosphorBronzeProcessingCapability href "../SudoknPhosphorBronzeProcessingCapability"
      
      
      SudoknBronzeProcessingCapability : rdfs_label
        
          
    
    
    SudoknBronzeProcessingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
    ...
    * [SudoknMaterialProcessingCapability](../classes/SudoknMaterialProcessingCapability.md)
        * [SudoknMetalProcessingCapability](../classes/SudoknMetalProcessingCapability.md)
            * **SudoknBronzeProcessingCapability**
                * [SudoknPhosphorBronzeProcessingCapability](../classes/SudoknPhosphorBronzeProcessingCapability.md)
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject <br/>  | direct | 1754 |
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknBronzeProcessingCapability](../classes/SudoknBronzeProcessingCapability.md) |
...
```yaml
name: sudokn_BronzeProcessingCapability
title: bronze processing capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_MetalProcessingCapability
slots:
- rdfs_label
class_uri: sudokn:BronzeProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_BronzeProcessingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
