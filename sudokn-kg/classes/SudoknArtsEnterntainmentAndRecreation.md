...
# Class: No class (type) name specified (sudokn_ArtsEnterntainmentAndRecreation)
...
URI: [sudokn:ArtsEnterntainmentAndRecreation](http://asu.edu/semantics/SUDOKN/ArtsEnterntainmentAndRecreation)
...
```mermaid
 classDiagram
    class SudoknArtsEnterntainmentAndRecreation
    click SudoknArtsEnterntainmentAndRecreation href "../SudoknArtsEnterntainmentAndRecreation"
      ...
      SudoknArtsEnterntainmentAndRecreation : sudokn_hasNAICSCodeValue
        
          
    
    
    SudoknArtsEnterntainmentAndRecreation --> "0..1" Any : sudokn_hasNAICSCodeValue
    click Any href "../Any"

        
      SudoknArtsEnterntainmentAndRecreation : sudokn_hasNAICSTextValue
        
          
    
    
    SudoknArtsEnterntainmentAndRecreation --> "0..1" Any : sudokn_hasNAICSTextValue
    click Any href "../Any"
...
```yaml
name: sudokn_ArtsEnterntainmentAndRecreation
...
class_uri: sudokn:ArtsEnterntainmentAndRecreation
...
attributes:
  sudokn_hasNAICSCodeValue:
    ...
    owner: sudokn_ArtsEnterntainmentAndRecreation
    domain_of:
    - sudokn_NAICS332111
    - sudokn_NAICS332112
    - sudokn_NAICS332114
