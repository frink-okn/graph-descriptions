...
# Class: TODO -- what's a good name for this class (type)? (ussdwis_PublicWaterSystem-TNCWS)
...
URI: [ussdwis:PublicWaterSystem-TNCWS](http://sawgraph.spatialai.org/v1/us-sdwis#PublicWaterSystem-TNCWS)
...
```mermaid
 classDiagram
    ...
    click UssdwisPublicWaterSystem-TNCWS href "../UssdwisPublicWaterSystem-TNCWS"
      ...
      UssdwisPublicWaterSystem-TNCWS : geo_hasSerialization
        
          
    
    
    UssdwisPublicWaterSystem-TNCWS --> "0..1" GeoWktLiteral : geo_hasSerialization
...
| ---  | ---  |
| self | ussdwis:PublicWaterSystem-TNCWS |
| native | sawgraph-kg/:UssdwisPublicWaterSystem-TNCWS |
...
<details>
```yaml
name: ussdwis_PublicWaterSystem-TNCWS
...
- if you think the class is perfect.
notes:
- Class with 27833 occurences.
from_schema: sawgraph-kg
rank: 1000
is_a: geo_SpatialObject
class_uri: ussdwis:PublicWaterSystem-TNCWS
...
attributes:
  geo_hasSerialization:
    ...
    owner: ussdwis_PublicWaterSystem-TNCWS
    domain_of:
    - geo_Geometry
    - geo_SpatialObject
