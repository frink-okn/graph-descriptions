...
# Class: TODO -- what's a good name for this class (type)? (sudokn_PowderCoatingCapability)
...
URI: [sudokn:PowderCoatingCapability](http://asu.edu/semantics/SUDOKN/PowderCoatingCapability)
...
```mermaid
 classDiagram
    class SudoknPowderCoatingCapability
    click SudoknPowderCoatingCapability href "../SudoknPowderCoatingCapability"
      SudoknMechanicalCoatingCapability <|-- SudoknPowderCoatingCapability
        click SudoknMechanicalCoatingCapability href "../SudoknMechanicalCoatingCapability"
      
      SudoknPowderCoatingCapability : rdfs_label
        
          
    
    
    SudoknPowderCoatingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknPowderCoatingCapability](../classes/SudoknPowderCoatingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknPowderCoatingCapability](../classes/SudoknPowderCoatingCapability.md) |
...
| Value |
| --- |
| sudokn:3PINDUSTRIES-PowderCoatingCapability-inst |
...
| ---  | ---  |
| self | sudokn:PowderCoatingCapability |
| native | sudokn-kg/:SudoknPowderCoatingCapability |
...
<details>
```yaml
name: sudokn_PowderCoatingCapability
...
- if you think the class is perfect.
notes:
- Class with 679 occurences.
examples:
- value: sudokn:3PINDUSTRIES-PowderCoatingCapability-inst
from_schema: sudokn-kg
rank: 1000
is_a: sudokn_MechanicalCoatingCapability
slots:
- rdfs_label
class_uri: sudokn:PowderCoatingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_PowderCoatingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
