...
# Class: ASME certificate (sudokn_ASMECertificate)
...
| Value |
| --- |
| sudokn:AAATECH-ASMECertificate |
...
| ---  | ---  |
| self | sudokn:ASMECertificate |
| native | sudokn-kg/:SudoknASMECertificate |
...
title: ASME certificate
todos:
- TODO -- Todos for this class go here
- or you can delete the todos
- if you think the class is perfect.
notes:
- Class with 804 occurences.
examples:
- value: sudokn:AAATECH-ASMECertificate
