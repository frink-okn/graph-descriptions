...
# Class: TODO -- what's a good name for this class (type)? (sudokn_EndFormingCapability)
...
URI: [sudokn:EndFormingCapability](http://asu.edu/semantics/SUDOKN/EndFormingCapability)
...
```mermaid
 classDiagram
    class SudoknEndFormingCapability
    click SudoknEndFormingCapability href "../SudoknEndFormingCapability"
      SudoknEndFormingCapability : rdfs_label
        
          
    
    
    SudoknEndFormingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknEndFormingCapability](../classes/SudoknEndFormingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknEndFormingCapability](../classes/SudoknEndFormingCapability.md) |
...
| ---  | ---  |
| self | sudokn:EndFormingCapability |
| native | sudokn-kg/:SudoknEndFormingCapability |
...
<details>
```yaml
name: sudokn_EndFormingCapability
...
examples:
- value: sudokn:IndTool-EndForming
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:EndFormingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_EndFormingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
