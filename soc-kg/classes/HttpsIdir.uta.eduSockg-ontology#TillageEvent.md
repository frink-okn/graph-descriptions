...
# Class: HttpsIdir.uta.eduSockg-ontology#TillageEvent
...
URI: [https://idir.uta.edu/sockg-ontology#TillageEvent](https://idir.uta.edu/sockg-ontology#TillageEvent)
...
```mermaid
 classDiagram
    ...
    click HttpsIdir.uta.eduSockg-ontology#TillageEvent href "../HttpsIdir.uta.eduSockg-ontology#TillageEvent"
      HttpsIdir.uta.eduSockg-ontology#TillageEvent : rdfs_label
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#TillageEvent --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: https___idir.uta.edu_sockg-ontology#TillageEvent
from_schema: okns:soc-kg
rank: 1000
slots:
- rdfs_label
class_uri: https://idir.uta.edu/sockg-ontology#TillageEvent
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: https___idir.uta.edu_sockg-ontology#TillageEvent
    domain_of:
    - qudt_AspectClass
    - qudt_BinaryPrefix
