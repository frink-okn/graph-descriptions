...
# Class: Water Sample by Source (coso_WaterSampleBySource)





URI: [coso:WaterSampleBySource](http://w3id.org/coso/v1/contaminoso#WaterSampleBySource)
...
```mermaid
 classDiagram
    ...
    click CosoWaterSampleBySource href "../CosoWaterSampleBySource"
      ...
      CosoWaterSampleBySource <|-- CosoDrinkingWaterSample
        click CosoDrinkingWaterSample href "../CosoDrinkingWaterSample"
      CosoWaterSampleBySource <|-- CosoGroundWaterSample
        click CosoGroundWaterSample href "../CosoGroundWaterSample"
      CosoWaterSampleBySource <|-- CosoSurfaceWaterSample
        click CosoSurfaceWaterSample href "../CosoSurfaceWaterSample"
      CosoWaterSampleBySource <|-- CosoWasteWaterSample
        click CosoWasteWaterSample href "../CosoWasteWaterSample"
      
      
      CosoWaterSampleBySource : owl_sameAs
        
          
    
    
    CosoWaterSampleBySource --> "0..1" OwlThing : owl_sameAs
    click OwlThing href "../OwlThing"

        
      CosoWaterSampleBySource : rdfs_label
        
          
    
    
    CosoWaterSampleBySource --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
* [OwlThing](../classes/OwlThing.md)
    * [SosaSample](../classes/SosaSample.md)
        * [CosoWaterSample](../classes/CosoWaterSample.md)
            * **CosoWaterSampleBySource**
                * [CosoDrinkingWaterSample](../classes/CosoDrinkingWaterSample.md)
                * [CosoGroundWaterSample](../classes/CosoGroundWaterSample.md)
                * [CosoSurfaceWaterSample](../classes/CosoSurfaceWaterSample.md)
                * [CosoWasteWaterSample](../classes/CosoWasteWaterSample.md)
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject | [CosoWaterSample](../classes/CosoWaterSample.md) |  |
| [owl_sameAs](../slots/owl_sameAs.md) | 0..1 <br/> [OwlThing](../classes/OwlThing.md) | The property that determines that two given individuals are equal | [CosoWaterSample](../classes/CosoWaterSample.md) |  |
...
```yaml
name: coso_WaterSampleBySource
title: Water Sample by Source
from_schema: okns:sawgraph-kg
rank: 1000
is_a: coso_WaterSample
class_uri: coso:WaterSampleBySource
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: coso_WaterSampleBySource
    domain_of:
