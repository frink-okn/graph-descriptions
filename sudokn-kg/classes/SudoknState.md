...
# Class: No class (type) name specified (sudokn_State)
...
This class occurs 129 times.


URI: [sudokn:State](http://asu.edu/semantics/SUDOKN/State)
...
```mermaid
 classDiagram
    ...
    click SudoknState href "../SudoknState"
      ...
      SudoknState : rdfs_label
        
          
    
    
    SudoknState --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string) | No slot (predicate) description specified <br/>  | direct | 129 |
...
| ---  | --- | --- | --- |
| [SudoknCity](../classes/SudoknCity.md) | [sudokn_locatedInState](../slots/sudokn_locatedInState.md) | range | [SudoknState](../classes/SudoknState.md) |
