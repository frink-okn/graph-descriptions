...
# Class: aerospace industry (sudokn_AerospaceIndustry)
...
URI: [sudokn:AerospaceIndustry](http://asu.edu/semantics/SUDOKN/AerospaceIndustry)
...
```mermaid
 classDiagram
    ...
    click SudoknAerospaceIndustry href "../SudoknAerospaceIndustry"
      ...
      SudoknAerospaceIndustry : rdfs_label
        
          
    
    
    SudoknAerospaceIndustry --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknAerospaceIndustry](../classes/SudoknAerospaceIndustry.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknAerospaceIndustry](../classes/SudoknAerospaceIndustry.md) |
...
| ---  | ---  |
| self | sudokn:AerospaceIndustry |
| native | sudokn-kg/:SudoknAerospaceIndustry |
...
slots:
- rdfs_label
class_uri: sudokn:AerospaceIndustry
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_AerospaceIndustry
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
