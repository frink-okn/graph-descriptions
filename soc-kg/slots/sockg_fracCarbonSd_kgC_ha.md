...
# Slot: No slot (predicate) name specified (sockg_fracCarbonSd_kgC_ha)
...
URI: [sockg:fracCarbonSd_kgC_ha](https://idir.uta.edu/sockg-ontology/docs/fracCarbonSd_kgC_ha)
...
| --- | --- | --- | --- | --- |
| sockg_YieldNutrientUptake | double | sockg:individuals/624996 | 113.0581 | 20 |
