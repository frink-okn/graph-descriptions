...
# Class: Labor (fio-epa-frs_Agency.Labor)
...
URI: [fio-epa-frs:Agency.Labor](http://w3id.org/fio/v1/epa-frs#Agency.Labor)
...
```mermaid
 classDiagram
    class Fio-epa-frsAgency.Labor
    click Fio-epa-frsAgency.Labor href "../Fio-epa-frsAgency.Labor"
      ProvAgent <|-- Fio-epa-frsAgency.Labor
        click ProvAgent href "../ProvAgent"
      
      Fio-epa-frsAgency.Labor : owl_sameAs
        
          
    
    
    Fio-epa-frsAgency.Labor --> "0..1" OwlThing : owl_sameAs
    click OwlThing href "../OwlThing"

        
      Fio-epa-frsAgency.Labor : rdfs_label
        
          
    
    
    Fio-epa-frsAgency.Labor --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
- rdfs_label
- owl_sameAs
class_uri: fio-epa-frs:Agency.Labor
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: fio-epa-frs_Agency.Labor
    domain_of:
    - time_DayOfWeek
    - time_TemporalUnit
