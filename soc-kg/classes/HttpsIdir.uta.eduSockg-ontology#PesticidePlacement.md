...
# Class: HttpsIdir.uta.eduSockg-ontology#PesticidePlacement
...
URI: [https://idir.uta.edu/sockg-ontology#PesticidePlacement](https://idir.uta.edu/sockg-ontology#PesticidePlacement)
...
```mermaid
 classDiagram
    ...
    click HttpsIdir.uta.eduSockg-ontology#PesticidePlacement href "../HttpsIdir.uta.eduSockg-ontology#PesticidePlacement"
      HttpsIdir.uta.eduSockg-ontology#PesticidePlacement : rdfs_label
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#PesticidePlacement --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: https___idir.uta.edu_sockg-ontology#PesticidePlacement
from_schema: okns:soc-kg
rank: 1000
slots:
- rdfs_label
class_uri: https://idir.uta.edu/sockg-ontology#PesticidePlacement
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: https___idir.uta.edu_sockg-ontology#PesticidePlacement
    domain_of:
