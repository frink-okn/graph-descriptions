...
# Class: etching capability (sudokn_EtchingCapability)




This class occurs 487 times.


URI: [sudokn:EtchingCapability](http://asu.edu/semantics/SUDOKN/EtchingCapability)
...
```mermaid
 classDiagram
    ...
    click SudoknEtchingCapability href "../SudoknEtchingCapability"
      ...
      SudoknEtchingCapability : rdfs_label
        
          
    
    
    SudoknEtchingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject <br/>  | direct | 487 |
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknEtchingCapability](../classes/SudoknEtchingCapability.md) |
...
```yaml
name: sudokn_EtchingCapability
title: etching capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_ChemicalMachiningCapability
slots:
- rdfs_label
class_uri: sudokn:EtchingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_EtchingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
