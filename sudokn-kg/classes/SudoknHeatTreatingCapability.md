...
# Class: No class (type) name specified (sudokn_HeatTreatingCapability)
...
```mermaid
 classDiagram
    ...
    SudoknHeatTreatingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string) | No slot (predicate) description specified <br/>  | direct | 923 |
...
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknHeatTreatingCapability](../classes/SudoknHeatTreatingCapability.md) |
