...
# Class: TODO -- what's a good name for this class (type)? (sudokn_SubmergedArcWeldingCapability)
...
| ---  | ---  |
| self | sudokn:SubmergedArcWeldingCapability |
| native | sudokn-kg/:SudoknSubmergedArcWeldingCapability |
