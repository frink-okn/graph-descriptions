...
URI: [sudokn:PrintingCapability](http://asu.edu/semantics/SUDOKN/PrintingCapability)
...
```mermaid
 classDiagram
    class SudoknPrintingCapability
    click SudoknPrintingCapability href "../SudoknPrintingCapability"
      ...
      SudoknPrintingCapability : rdfs_label
        
          
    
    
    SudoknPrintingCapability --> "0..1" String : rdfs_label
        ...
        * [SudoknFinishingCapability](../classes/SudoknFinishingCapability.md)
            * [SudoknCoatingCapability](../classes/SudoknCoatingCapability.md)
                * **SudoknPrintingCapability**
                    * [SudoknWetPaintingCapability](../classes/SudoknWetPaintingCapability.md)
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknPrintingCapability](../classes/SudoknPrintingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknPrintingCapability](../classes/SudoknPrintingCapability.md) |
...
| Value |
| --- |
| sudokn:CargoControlUSA-Printing |
...
| ---  | ---  |
| self | sudokn:PrintingCapability |
| native | sudokn-kg/:SudoknPrintingCapability |
...
slots:
- rdfs_label
class_uri: sudokn:PrintingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_PrintingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
