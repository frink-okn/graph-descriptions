...
# Class: copper processing capability (sudokn_CopperProcessingCapability)
...
URI: [sudokn:CopperProcessingCapability](http://asu.edu/semantics/SUDOKN/CopperProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknCopperProcessingCapability
    click SudoknCopperProcessingCapability href "../SudoknCopperProcessingCapability"
      ...
      SudoknCopperProcessingCapability : rdfs_label
        
          
    
    
    SudoknCopperProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknCopperProcessingCapability](../classes/SudoknCopperProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknCopperProcessingCapability](../classes/SudoknCopperProcessingCapability.md) |
...
| Value |
| --- |
| sudokn:1776FABRICATION-Copper-inst |
...
| ---  | ---  |
| self | sudokn:CopperProcessingCapability |
| native | sudokn-kg/:SudoknCopperProcessingCapability |
...
<details>
```yaml
name: sudokn_CopperProcessingCapability
description: TODO -- tell the world what this class (type) describes.
title: copper processing capability
todos:
- TODO -- Todos for this class go here
- or you can delete the todos
- if you think the class is perfect.
notes:
- Class with 2784 occurences.
examples:
- value: sudokn:1776FABRICATION-Copper-inst
from_schema: sudokn-kg
is_a: sudokn_MetalProcessingCapability
slots:
- rdfs_label
class_uri: sudokn:CopperProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_CopperProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
