...
| ---  | ---  |
| self | sudokn:OwnershipStatusClassifier |
| native | sudokn-kg/:SudoknOwnershipStatusClassifier |
...
attributes:
  skos_altLabel:
    ...
    - if you think the class is perfect.
    comments:
    - 1 occurrences with subject type sudokn_OwnershipStatusClassifier and object
      type string.
    examples:
