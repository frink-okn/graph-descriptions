...
# Class: TODO -- what's a good name for this class (type)? (sudokn_GovermentIndustry)
...
URI: [sudokn:GovermentIndustry](http://asu.edu/semantics/SUDOKN/GovermentIndustry)
...
```mermaid
 classDiagram
    class SudoknGovermentIndustry
    click SudoknGovermentIndustry href "../SudoknGovermentIndustry"
      SudoknGovermentIndustry : rdfs_label
        
          
    
    
    SudoknGovermentIndustry --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknGovermentIndustry](../classes/SudoknGovermentIndustry.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknGovermentIndustry](../classes/SudoknGovermentIndustry.md) |
...
| ---  | ---  |
| self | sudokn:GovermentIndustry |
| native | sudokn-kg/:SudoknGovermentIndustry |
...
examples:
- value: sudokn:govermentindustry-inst
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:GovermentIndustry
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_GovermentIndustry
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
