...
# Class: TODO -- what's a good name for this class (type)? (sudokn_KnurlingCapability)
...
URI: [sudokn:KnurlingCapability](http://asu.edu/semantics/SUDOKN/KnurlingCapability)
...
```mermaid
 classDiagram
    class SudoknKnurlingCapability
    click SudoknKnurlingCapability href "../SudoknKnurlingCapability"
      SudoknKnurlingCapability : rdfs_label
        
          
    
    
    SudoknKnurlingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknKnurlingCapability](../classes/SudoknKnurlingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknKnurlingCapability](../classes/SudoknKnurlingCapability.md) |
...
| Value |
| --- |
| sudokn:AAAIND-KnurlingCapability-inst |
...
| ---  | ---  |
| self | sudokn:KnurlingCapability |
| native | sudokn-kg/:SudoknKnurlingCapability |
...
<details>
```yaml
name: sudokn_KnurlingCapability
...
- if you think the class is perfect.
notes:
- Class with 64 occurences.
examples:
- value: sudokn:AAAIND-KnurlingCapability-inst
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:KnurlingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_KnurlingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
