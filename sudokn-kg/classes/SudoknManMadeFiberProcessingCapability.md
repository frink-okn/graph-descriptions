...
# Class: man made fiber processing capability (sudokn_ManMadeFiberProcessingCapability)
...
URI: [sudokn:ManMadeFiberProcessingCapability](http://asu.edu/semantics/SUDOKN/ManMadeFiberProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknManMadeFiberProcessingCapability
    click SudoknManMadeFiberProcessingCapability href "../SudoknManMadeFiberProcessingCapability"
      ...
      SudoknManMadeFiberProcessingCapability : rdfs_label
        
          
    
    
    SudoknManMadeFiberProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknManMadeFiberProcessingCapability](../classes/SudoknManMadeFiberProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknManMadeFiberProcessingCapability](../classes/SudoknManMadeFiberProcessingCapability.md) |
...
| Value |
| --- |
| sudokn:CargoControlUSA-ManMadeFiber-cap |
...
| ---  | ---  |
| self | sudokn:ManMadeFiberProcessingCapability |
| native | sudokn-kg/:SudoknManMadeFiberProcessingCapability |
...
<details>
```yaml
name: sudokn_ManMadeFiberProcessingCapability
description: TODO -- tell the world what this class (type) describes.
title: man made fiber processing capability
todos:
- TODO -- Todos for this class go here
- or you can delete the todos
- if you think the class is perfect.
...
examples:
- value: sudokn:CargoControlUSA-ManMadeFiber-cap
from_schema: sudokn-kg
is_a: sudokn_FiberProcessingCapability
slots:
- rdfs_label
class_uri: sudokn:ManMadeFiberProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ManMadeFiberProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
