...
# Class: powder metal forming capability (sudokn_PowderMetalFormingCapability)





URI: [sudokn:PowderMetalFormingCapability](http://asu.edu/semantics/SUDOKN/PowderMetalFormingCapability)
...
```mermaid
 classDiagram
    class SudoknPowderMetalFormingCapability
    click SudoknPowderMetalFormingCapability href "../SudoknPowderMetalFormingCapability"
      ...
      SudoknPowderMetalFormingCapability <|-- SudoknSparkPlasmaSinteringCapability
        click SudoknSparkPlasmaSinteringCapability href "../SudoknSparkPlasmaSinteringCapability"
      
      
      SudoknPowderMetalFormingCapability : rdfs_label
        
          
    
    
    SudoknPowderMetalFormingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
    ...
    * [SudoknManufacturingProcessCapability](../classes/SudoknManufacturingProcessCapability.md)
        * [SudoknFormingCapability](../classes/SudoknFormingCapability.md)
            * **SudoknPowderMetalFormingCapability**
                * [SudoknSparkPlasmaSinteringCapability](../classes/SudoknSparkPlasmaSinteringCapability.md)
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject | [SudoknFormingCapability](../classes/SudoknFormingCapability.md) |  |
...
```yaml
name: sudokn_PowderMetalFormingCapability
title: powder metal forming capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_FormingCapability
class_uri: sudokn:PowderMetalFormingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_PowderMetalFormingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
