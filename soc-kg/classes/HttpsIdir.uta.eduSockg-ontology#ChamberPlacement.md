...
# Class: HttpsIdir.uta.eduSockg-ontology#ChamberPlacement
...
URI: [https://idir.uta.edu/sockg-ontology#ChamberPlacement](https://idir.uta.edu/sockg-ontology#ChamberPlacement)
...
```mermaid
 classDiagram
    ...
    click HttpsIdir.uta.eduSockg-ontology#ChamberPlacement href "../HttpsIdir.uta.eduSockg-ontology#ChamberPlacement"
      HttpsIdir.uta.eduSockg-ontology#ChamberPlacement : rdfs_label
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#ChamberPlacement --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: https___idir.uta.edu_sockg-ontology#ChamberPlacement
from_schema: okns:soc-kg
rank: 1000
slots:
- rdfs_label
class_uri: https://idir.uta.edu/sockg-ontology#ChamberPlacement
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: https___idir.uta.edu_sockg-ontology#ChamberPlacement
    domain_of:
