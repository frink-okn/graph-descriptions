...
# Class: TODO -- what's a good name for this class (type)? (sudokn_CNCGrindingCapability)
...
URI: [sudokn:CNCGrindingCapability](http://asu.edu/semantics/SUDOKN/CNCGrindingCapability)
...
```mermaid
 classDiagram
    class SudoknCNCGrindingCapability
    click SudoknCNCGrindingCapability href "../SudoknCNCGrindingCapability"
      SudoknCNCGrindingCapability : rdfs_label
        
          
    
    
    SudoknCNCGrindingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCNCGrindingCapability](../classes/SudoknCNCGrindingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCNCGrindingCapability](../classes/SudoknCNCGrindingCapability.md) |
...
| Value |
| --- |
| sudokn:SEITechnologies-CNCGrinding |
...
| ---  | ---  |
| self | sudokn:CNCGrindingCapability |
| native | sudokn-kg/:SudoknCNCGrindingCapability |
...
<details>
```yaml
name: sudokn_CNCGrindingCapability
...
examples:
- value: sudokn:SEITechnologies-CNCGrinding
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:CNCGrindingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_CNCGrindingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
