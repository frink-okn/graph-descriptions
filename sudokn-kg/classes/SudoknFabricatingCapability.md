...
# Class: fabricating capability (sudokn_FabricatingCapability)




This class occurs 2518 times.


URI: [sudokn:FabricatingCapability](http://asu.edu/semantics/SUDOKN/FabricatingCapability)
...
```mermaid
 classDiagram
    class SudoknFabricatingCapability
    click SudoknFabricatingCapability href "../SudoknFabricatingCapability"
      SudoknAssemblyCapability <|-- SudoknFabricatingCapability
        click SudoknAssemblyCapability href "../SudoknAssemblyCapability"
      

      SudoknFabricatingCapability <|-- SudoknSemiconductorFabricatingCapability
        click SudoknSemiconductorFabricatingCapability href "../SudoknSemiconductorFabricatingCapability"
      
      
      SudoknFabricatingCapability : rdfs_label
        
          
    
    
    SudoknFabricatingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
    ...
    * [SudoknManufacturingProcessCapability](../classes/SudoknManufacturingProcessCapability.md)
        * [SudoknAssemblyCapability](../classes/SudoknAssemblyCapability.md)
            * **SudoknFabricatingCapability**
                * [SudoknSemiconductorFabricatingCapability](../classes/SudoknSemiconductorFabricatingCapability.md)
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject <br/>  | direct | 2518 |
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknFabricatingCapability](../classes/SudoknFabricatingCapability.md) |
...
```yaml
name: sudokn_FabricatingCapability
title: fabricating capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_AssemblyCapability
slots:
- rdfs_label
class_uri: sudokn:FabricatingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_FabricatingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
