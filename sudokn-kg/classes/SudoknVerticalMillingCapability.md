...
# Class: No class (type) name specified (sudokn_VerticalMillingCapability)
...
This class occurs 437 times.


URI: [sudokn:VerticalMillingCapability](http://asu.edu/semantics/SUDOKN/VerticalMillingCapability)
...
```mermaid
 classDiagram
    class SudoknVerticalMillingCapability
    click SudoknVerticalMillingCapability href "../SudoknVerticalMillingCapability"
      ...
      SudoknVerticalMillingCapability <|-- SudoknEndMillingCapability
        click SudoknEndMillingCapability href "../SudoknEndMillingCapability"
      SudoknVerticalMillingCapability <|-- SudoknFaceMillingCapability
        click SudoknFaceMillingCapability href "../SudoknFaceMillingCapability"
      
      
      SudoknVerticalMillingCapability : rdfs_label
        
          
    
    
    SudoknVerticalMillingCapability --> "0..1" String : rdfs_label
            ...
            * [SudoknMultiPointCuttingCapability](../classes/SudoknMultiPointCuttingCapability.md)
                * [SudoknMillingCapability](../classes/SudoknMillingCapability.md)
                    * **SudoknVerticalMillingCapability**
                        * [SudoknEndMillingCapability](../classes/SudoknEndMillingCapability.md)
                        * [SudoknFaceMillingCapability](../classes/SudoknFaceMillingCapability.md)
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string) | No slot (predicate) description specified <br/>  | direct | 437 |
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknVerticalMillingCapability](../classes/SudoknVerticalMillingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknVerticalMillingCapability](../classes/SudoknVerticalMillingCapability.md) |
  ...
  rdfs_label:
    ...
    annotations:
      string:
        tag: string
        value: 437
class_uri: sudokn:VerticalMillingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_VerticalMillingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
    - owl_NamedIndividual
