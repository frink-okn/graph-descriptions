...
# Class: TODO -- what's a good name for this class (type)? (sudokn_ElectropolishingCapability)
...
```mermaid
 classDiagram
    ...
    SudoknElectropolishingCapability --> "0..1" String : rdfs_label
...
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknElectropolishingCapability](../classes/SudoknElectropolishingCapability.md) |
...
| Value |
| --- |
| sudokn:ACMESDI-ElectropolishingCapability-inst |
...
| ---  | ---  |
| self | sudokn:ElectropolishingCapability |
| native | sudokn-kg/:SudoknElectropolishingCapability |
...
- if you think the class is perfect.
notes:
- Class with 61 occurences.
examples:
- value: sudokn:ACMESDI-ElectropolishingCapability-inst
