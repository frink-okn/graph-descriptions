...
# Class: TODO -- what's a good name for this class (type)? (sudokn_KOSHERApproved)
...
URI: [sudokn:KOSHERApproved](http://asu.edu/semantics/SUDOKN/KOSHERApproved)
...
```mermaid
 classDiagram
    class SudoknKOSHERApproved
    click SudoknKOSHERApproved href "../SudoknKOSHERApproved"
      SudoknKOSHERApproved : rdfs_label
        
          
    
    
    SudoknKOSHERApproved --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasCertificate](../slots/sudokn_hasCertificate.md) | any_of[range] | [SudoknKOSHERApproved](../classes/SudoknKOSHERApproved.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasCertificate](../slots/sudokn_hasCertificate.md) | any_of[range] | [SudoknKOSHERApproved](../classes/SudoknKOSHERApproved.md) |
...
| Value |
| --- |
| sudokn:SinnovaTek-KOSHERApproved |
...
| ---  | ---  |
| self | sudokn:KOSHERApproved |
| native | sudokn-kg/:SudoknKOSHERApproved |
...
examples:
- value: sudokn:SinnovaTek-KOSHERApproved
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:KOSHERApproved
