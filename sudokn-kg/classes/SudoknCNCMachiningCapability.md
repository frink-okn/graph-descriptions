...
# Class: TODO -- what's a good name for this class (type)? (sudokn_CNCMachiningCapability)
...
```mermaid
 classDiagram
    ...
    SudoknCNCMachiningCapability --> "0..1" String : rdfs_label
...
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCNCMachiningCapability](../classes/SudoknCNCMachiningCapability.md) |
...
| Value |
| --- |
| sudokn:1776FABRICATION-CNCMachiningCapability-inst |
...
| ---  | ---  |
| self | sudokn:CNCMachiningCapability |
| native | sudokn-kg/:SudoknCNCMachiningCapability |
...
- if you think the class is perfect.
notes:
- Class with 1427 occurences.
examples:
- value: sudokn:1776FABRICATION-CNCMachiningCapability-inst
