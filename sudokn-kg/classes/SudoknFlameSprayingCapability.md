...
# Class: flame spraying capability (sudokn_FlameSprayingCapability)
...
URI: [sudokn:FlameSprayingCapability](http://asu.edu/semantics/SUDOKN/FlameSprayingCapability)
...
```mermaid
 classDiagram
    class SudoknFlameSprayingCapability
    click SudoknFlameSprayingCapability href "../SudoknFlameSprayingCapability"
      ...
      SudoknFlameSprayingCapability : rdfs_label
        
          
    
    
    SudoknFlameSprayingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknFlameSprayingCapability](../classes/SudoknFlameSprayingCapability.md) |
...
```yaml
name: sudokn_FlameSprayingCapability
title: flame spraying capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_ThermalSprayCoatingCapability
slots:
- rdfs_label
class_uri: sudokn:FlameSprayingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_FlameSprayingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
