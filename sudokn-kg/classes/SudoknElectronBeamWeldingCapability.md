...
# Class: TODO -- what's a good name for this class (type)? (sudokn_ElectronBeamWeldingCapability)
...
URI: [sudokn:ElectronBeamWeldingCapability](http://asu.edu/semantics/SUDOKN/ElectronBeamWeldingCapability)
...
```mermaid
 classDiagram
    class SudoknElectronBeamWeldingCapability
    click SudoknElectronBeamWeldingCapability href "../SudoknElectronBeamWeldingCapability"
      ...
      SudoknElectronBeamWeldingCapability : rdfs_label
        
          
    
    
    SudoknElectronBeamWeldingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknElectronBeamWeldingCapability](../classes/SudoknElectronBeamWeldingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknElectronBeamWeldingCapability](../classes/SudoknElectronBeamWeldingCapability.md) |
...
| Value |
| --- |
| sudokn:AWS-ElectronBeamWeldingCapability-inst |
...
| ---  | ---  |
| self | sudokn:ElectronBeamWeldingCapability |
| native | sudokn-kg/:SudoknElectronBeamWeldingCapability |
...
<details>
```yaml
name: sudokn_ElectronBeamWeldingCapability
...
- if you think the class is perfect.
notes:
- Class with 6 occurences.
examples:
- value: sudokn:AWS-ElectronBeamWeldingCapability-inst
from_schema: sudokn-kg
rank: 1000
is_a: sudokn_HighEnergyBeamWeldingCapability
slots:
- rdfs_label
class_uri: sudokn:ElectronBeamWeldingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ElectronBeamWeldingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
