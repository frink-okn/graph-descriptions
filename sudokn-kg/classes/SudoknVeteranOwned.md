...
# Class: Veteran Owned (sudokn_VeteranOwned)





URI: [sudokn:VeteranOwned](http://asu.edu/semantics/SUDOKN/VeteranOwned)
...
```mermaid
 classDiagram
    ...
    click SudoknVeteranOwned href "../SudoknVeteranOwned"
      ...
      SudoknVeteranOwned : rdfs_label
        
          
    
    
    SudoknVeteranOwned --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: sudokn_VeteranOwned
title: Veteran Owned
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_OwnershipStatusClassifier
class_uri: sudokn:VeteranOwned
