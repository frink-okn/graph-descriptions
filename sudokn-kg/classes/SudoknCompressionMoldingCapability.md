...
# Class: compression molding capability (sudokn_CompressionMoldingCapability)





URI: [sudokn:CompressionMoldingCapability](http://asu.edu/semantics/SUDOKN/CompressionMoldingCapability)
...
```mermaid
 classDiagram
    class SudoknCompressionMoldingCapability
    click SudoknCompressionMoldingCapability href "../SudoknCompressionMoldingCapability"
      ...
      SudoknCompressionMoldingCapability : rdfs_label
        
          
    
    
    SudoknCompressionMoldingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: sudokn_CompressionMoldingCapability
title: compression molding capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_MoldingCapability
class_uri: sudokn:CompressionMoldingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_CompressionMoldingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
