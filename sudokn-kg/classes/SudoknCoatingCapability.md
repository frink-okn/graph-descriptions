...
# Class: coating capability (sudokn_CoatingCapability)




This class occurs 1744 times.


URI: [sudokn:CoatingCapability](http://asu.edu/semantics/SUDOKN/CoatingCapability)
...
```mermaid
 classDiagram
    class SudoknCoatingCapability
    click SudoknCoatingCapability href "../SudoknCoatingCapability"
      SudoknSurfaceFinishingCapability <|-- SudoknCoatingCapability
        click SudoknSurfaceFinishingCapability href "../SudoknSurfaceFinishingCapability"
      

      SudoknCoatingCapability <|-- SudoknBlackOxideCoatingCapability
        click SudoknBlackOxideCoatingCapability href "../SudoknBlackOxideCoatingCapability"
      SudoknCoatingCapability <|-- SudoknChemicalCoatingCapability
        click SudoknChemicalCoatingCapability href "../SudoknChemicalCoatingCapability"
      SudoknCoatingCapability <|-- SudoknGalvanizingCapability
        click SudoknGalvanizingCapability href "../SudoknGalvanizingCapability"
      SudoknCoatingCapability <|-- SudoknMechanicalCoatingCapability
        click SudoknMechanicalCoatingCapability href "../SudoknMechanicalCoatingCapability"
      SudoknCoatingCapability <|-- SudoknPassivationCapability
        click SudoknPassivationCapability href "../SudoknPassivationCapability"
      SudoknCoatingCapability <|-- SudoknPhosphateCoatingCapability
        click SudoknPhosphateCoatingCapability href "../SudoknPhosphateCoatingCapability"
      SudoknCoatingCapability <|-- SudoknPrintingCapability
        click SudoknPrintingCapability href "../SudoknPrintingCapability"
      SudoknCoatingCapability <|-- SudoknThermalCoatingCapability
        click SudoknThermalCoatingCapability href "../SudoknThermalCoatingCapability"
      
      
      SudoknCoatingCapability : rdfs_label
        
          
    
    
    SudoknCoatingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
    ...
    * [SudoknManufacturingProcessCapability](../classes/SudoknManufacturingProcessCapability.md)
        * [SudoknSurfaceFinishingCapability](../classes/SudoknSurfaceFinishingCapability.md)
            * **SudoknCoatingCapability**
                * [SudoknBlackOxideCoatingCapability](../classes/SudoknBlackOxideCoatingCapability.md)
                * [SudoknChemicalCoatingCapability](../classes/SudoknChemicalCoatingCapability.md)
                * [SudoknGalvanizingCapability](../classes/SudoknGalvanizingCapability.md)
                * [SudoknMechanicalCoatingCapability](../classes/SudoknMechanicalCoatingCapability.md)
                * [SudoknPassivationCapability](../classes/SudoknPassivationCapability.md)
                * [SudoknPhosphateCoatingCapability](../classes/SudoknPhosphateCoatingCapability.md)
                * [SudoknPrintingCapability](../classes/SudoknPrintingCapability.md)
                * [SudoknThermalCoatingCapability](../classes/SudoknThermalCoatingCapability.md)
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject <br/>  | direct | 1744 |
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCoatingCapability](../classes/SudoknCoatingCapability.md) |
...
```yaml
name: sudokn_CoatingCapability
title: coating capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_SurfaceFinishingCapability
slots:
- rdfs_label
class_uri: sudokn:CoatingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_CoatingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
