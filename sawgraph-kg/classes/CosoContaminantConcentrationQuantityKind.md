...
# Class: Contaminant Concentration Quantity Kind (coso_ContaminantConcentrationQuantityKind)


_A type of contaminant quantity that is a concentration measurement._
...
URI: [coso:ContaminantConcentrationQuantityKind](http://w3id.org/coso/v1/contaminoso#ContaminantConcentrationQuantityKind)
...
```mermaid
 classDiagram
    class CosoContaminantConcentrationQuantityKind
    click CosoContaminantConcentrationQuantityKind href "../CosoContaminantConcentrationQuantityKind"
      ...
      CosoContaminantConcentrationQuantityKind : owl_sameAs
        
          
    
    
    CosoContaminantConcentrationQuantityKind --> "0..1" OwlThing : owl_sameAs
    click OwlThing href "../OwlThing"

        
      CosoContaminantConcentrationQuantityKind : rdfs_label
        
          
    
    
    CosoContaminantConcentrationQuantityKind --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- |
| [HttpW3id.orgSawgraphV1Me-egad#EGAD-AggregatePFAS-Concentration](../classes/HttpW3id.orgSawgraphV1Me-egad#EGAD-AggregatePFAS-Concentration.md) | [stad_hasQualityKind](../slots/stad_hasQualityKind.md) | any_of[range] | [CosoContaminantConcentrationQuantityKind](../classes/CosoContaminantConcentrationQuantityKind.md) |
| [HttpW3id.orgSawgraphV1Me-egad#EGAD-PFAS-Observation](../classes/HttpW3id.orgSawgraphV1Me-egad#EGAD-PFAS-Observation.md) | [coso_observedProperty](../slots/coso_observedProperty.md) | any_of[range] | [CosoContaminantConcentrationQuantityKind](../classes/CosoContaminantConcentrationQuantityKind.md) |
| [HttpW3id.orgSawgraphV1Me-egad#EGAD-SinglePFAS-Concentration](../classes/HttpW3id.orgSawgraphV1Me-egad#EGAD-SinglePFAS-Concentration.md) | [stad_hasQualityKind](../slots/stad_hasQualityKind.md) | any_of[range] | [CosoContaminantConcentrationQuantityKind](../classes/CosoContaminantConcentrationQuantityKind.md) |
| [HttpW3id.orgSawgraphV1Us-wqp#Observation](../classes/HttpW3id.orgSawgraphV1Us-wqp#Observation.md) | [coso_observedProperty](../slots/coso_observedProperty.md) | any_of[range] | [CosoContaminantConcentrationQuantityKind](../classes/CosoContaminantConcentrationQuantityKind.md) |
...
```yaml
name: coso_ContaminantConcentrationQuantityKind
description: A type of contaminant quantity that is a concentration measurement.
title: Contaminant Concentration Quantity Kind
...
- rdfs_label
- owl_sameAs
class_uri: coso:ContaminantConcentrationQuantityKind
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: coso_ContaminantConcentrationQuantityKind
    domain_of:
