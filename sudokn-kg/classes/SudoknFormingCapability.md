...
```mermaid
 classDiagram
    ...
    SudoknFormingCapability --> "0..1" String : rdfs_label
...
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknFormingCapability](../classes/SudoknFormingCapability.md) |
...
| Value |
| --- |
| sudokn:1776FABRICATION-FormingCapability-inst |
...
| ---  | ---  |
| self | sudokn:FormingCapability |
| native | sudokn-kg/:SudoknFormingCapability |
...
- if you think the class is perfect.
notes:
- Class with 1802 occurences.
examples:
- value: sudokn:1776FABRICATION-FormingCapability-inst
