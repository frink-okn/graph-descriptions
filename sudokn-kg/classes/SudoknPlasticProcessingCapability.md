...
# Class: plastic processing capability (sudokn_PlasticProcessingCapability)




This class occurs 4159 times.


URI: [sudokn:PlasticProcessingCapability](http://asu.edu/semantics/SUDOKN/PlasticProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknPlasticProcessingCapability
    click SudoknPlasticProcessingCapability href "../SudoknPlasticProcessingCapability"
      ...
      SudoknPlasticProcessingCapability <|-- SudoknAcetalProcessingCapability
        click SudoknAcetalProcessingCapability href "../SudoknAcetalProcessingCapability"
      SudoknPlasticProcessingCapability <|-- SudoknDelrinProcessingCapability
        click SudoknDelrinProcessingCapability href "../SudoknDelrinProcessingCapability"
      SudoknPlasticProcessingCapability <|-- SudoknPolycarbonateProcessingCapability
        click SudoknPolycarbonateProcessingCapability href "../SudoknPolycarbonateProcessingCapability"
      
      
      SudoknPlasticProcessingCapability : rdfs_label
        
          
    
    
    SudoknPlasticProcessingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
* [IoscProductionCapability](../classes/IoscProductionCapability.md)
    * [SudoknMaterialProcessingCapability](../classes/SudoknMaterialProcessingCapability.md)
        * **SudoknPlasticProcessingCapability**
            * [SudoknAcetalProcessingCapability](../classes/SudoknAcetalProcessingCapability.md)
            * [SudoknDelrinProcessingCapability](../classes/SudoknDelrinProcessingCapability.md)
            * [SudoknPolycarbonateProcessingCapability](../classes/SudoknPolycarbonateProcessingCapability.md)
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject <br/>  | direct | 4159 |
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknPlasticProcessingCapability](../classes/SudoknPlasticProcessingCapability.md) |
...
```yaml
name: sudokn_PlasticProcessingCapability
title: plastic processing capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_MaterialProcessingCapability
slots:
- rdfs_label
class_uri: sudokn:PlasticProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_PlasticProcessingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
