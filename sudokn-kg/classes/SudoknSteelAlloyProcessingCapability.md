...
# Class: TODO -- what's a good name for this class (type)? (sudokn_SteelAlloyProcessingCapability)
...
URI: [sudokn:SteelAlloyProcessingCapability](http://asu.edu/semantics/SUDOKN/SteelAlloyProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknSteelAlloyProcessingCapability
    click SudoknSteelAlloyProcessingCapability href "../SudoknSteelAlloyProcessingCapability"
      SudoknSteelAlloyProcessingCapability : rdfs_label
        
          
    
    
    SudoknSteelAlloyProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknSteelAlloyProcessingCapability](../classes/SudoknSteelAlloyProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknSteelAlloyProcessingCapability](../classes/SudoknSteelAlloyProcessingCapability.md) |
...
| Value |
| --- |
| sudokn:3DIMENSIONAL-SteelAlloy-inst |
...
| ---  | ---  |
| self | sudokn:SteelAlloyProcessingCapability |
| native | sudokn-kg/:SudoknSteelAlloyProcessingCapability |
...
<details>
```yaml
name: sudokn_SteelAlloyProcessingCapability
...
- if you think the class is perfect.
notes:
- Class with 365 occurences.
examples:
- value: sudokn:3DIMENSIONAL-SteelAlloy-inst
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:SteelAlloyProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_SteelAlloyProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
