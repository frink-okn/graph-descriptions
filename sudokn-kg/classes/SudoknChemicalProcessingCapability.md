...
# Class: TODO -- what's a good name for this class (type)? (sudokn_ChemicalProcessingCapability)
...
URI: [sudokn:ChemicalProcessingCapability](http://asu.edu/semantics/SUDOKN/ChemicalProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknChemicalProcessingCapability
    click SudoknChemicalProcessingCapability href "../SudoknChemicalProcessingCapability"
      SudoknChemicalProcessingCapability : rdfs_label
        
          
    
    
    SudoknChemicalProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknChemicalProcessingCapability](../classes/SudoknChemicalProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknChemicalProcessingCapability](../classes/SudoknChemicalProcessingCapability.md) |
...
| Value |
| --- |
| sudokn:AAAPLATING-ChemicalProcessingCapability-inst |
...
| ---  | ---  |
| self | sudokn:ChemicalProcessingCapability |
| native | sudokn-kg/:SudoknChemicalProcessingCapability |
...
<details>
```yaml
name: sudokn_ChemicalProcessingCapability
...
- if you think the class is perfect.
notes:
- Class with 194 occurences.
examples:
- value: sudokn:AAAPLATING-ChemicalProcessingCapability-inst
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:ChemicalProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ChemicalProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
