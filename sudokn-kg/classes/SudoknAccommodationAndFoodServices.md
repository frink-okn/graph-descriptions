...
# Class: No class (type) name specified (sudokn_AccommodationAndFoodServices)
...
URI: [sudokn:AccommodationAndFoodServices](http://asu.edu/semantics/SUDOKN/AccommodationAndFoodServices)
...
```mermaid
 classDiagram
    class SudoknAccommodationAndFoodServices
    click SudoknAccommodationAndFoodServices href "../SudoknAccommodationAndFoodServices"
      ...
      SudoknAccommodationAndFoodServices : sudokn_hasNAICSCodeValue
        
          
    
    
    SudoknAccommodationAndFoodServices --> "0..1" Any : sudokn_hasNAICSCodeValue
    click Any href "../Any"

        
      SudoknAccommodationAndFoodServices : sudokn_hasNAICSTextValue
        
          
    
    
    SudoknAccommodationAndFoodServices --> "0..1" Any : sudokn_hasNAICSTextValue
    click Any href "../Any"
...
```yaml
name: sudokn_AccommodationAndFoodServices
...
class_uri: sudokn:AccommodationAndFoodServices
...
attributes:
  sudokn_hasNAICSCodeValue:
    ...
    owner: sudokn_AccommodationAndFoodServices
    domain_of:
    - sudokn_NAICS332111
    - sudokn_NAICS332112
    - sudokn_NAICS332114
