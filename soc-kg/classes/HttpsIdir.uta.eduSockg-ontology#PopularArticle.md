...
# Class: HttpsIdir.uta.eduSockg-ontology#PopularArticle
...
URI: [https://idir.uta.edu/sockg-ontology#PopularArticle](https://idir.uta.edu/sockg-ontology#PopularArticle)
...
```mermaid
 classDiagram
    ...
    click HttpsIdir.uta.eduSockg-ontology#PopularArticle href "../HttpsIdir.uta.eduSockg-ontology#PopularArticle"
      ...
      HttpsIdir.uta.eduSockg-ontology#PopularArticle : dct_bibliographicCitation
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#PopularArticle --> "0..1" RdfsLiteral : dct_bibliographicCitation
    click RdfsLiteral href "../RdfsLiteral"

        
      HttpsIdir.uta.eduSockg-ontology#PopularArticle : dct_creator
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#PopularArticle --> "0..1" Any : dct_creator
    click Any href "../Any"

        
      HttpsIdir.uta.eduSockg-ontology#PopularArticle : dct_issued
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#PopularArticle --> "0..1" Any : dct_issued
    click Any href "../Any"

        
      HttpsIdir.uta.eduSockg-ontology#PopularArticle : dct_title
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#PopularArticle --> "0..1" Any : dct_title
    click Any href "../Any"

        
      HttpsIdir.uta.eduSockg-ontology#PopularArticle : https___idir.uta.edu_sockg_ontology#correspondingAuthor
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#PopularArticle --> "0..1" String : https___idir.uta.edu_sockg_ontology#correspondingAuthor
    click String href "../String"

        
      HttpsIdir.uta.eduSockg-ontology#PopularArticle : rdfs_label
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#PopularArticle --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: https___idir.uta.edu_sockg-ontology#PopularArticle
...
- dct_issued
class_uri: https://idir.uta.edu/sockg-ontology#PopularArticle
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: https___idir.uta.edu_sockg-ontology#PopularArticle
    domain_of:
    - qudt_AspectClass
    - qudt_BinaryPrefix
