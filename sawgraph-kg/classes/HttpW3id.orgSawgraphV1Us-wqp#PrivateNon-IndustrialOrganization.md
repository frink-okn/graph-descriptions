...
# Class: HttpW3id.orgSawgraphV1Us-wqp#PrivateNon-IndustrialOrganization
...
URI: [http://w3id.org/sawgraph/v1/us-wqp#PrivateNon-Industrial_Organization](http://w3id.org/sawgraph/v1/us-wqp#PrivateNon-Industrial_Organization)
...
```mermaid
 classDiagram
    class HttpW3id.orgSawgraphV1Us-wqp#PrivateNon-IndustrialOrganization
    click HttpW3id.orgSawgraphV1Us-wqp#PrivateNon-IndustrialOrganization href "../HttpW3id.orgSawgraphV1Us-wqp#PrivateNon-IndustrialOrganization"
      HttpW3id.orgSawgraphV1Us-wqp#PrivateNon-IndustrialOrganization : http___w3id.org_sawgraph_v1_us_wqp#organizationId
        
          
    
    
    HttpW3id.orgSawgraphV1Us-wqp#PrivateNon-IndustrialOrganization --> "0..1" String : http___w3id.org_sawgraph_v1_us_wqp#organizationId
    click String href "../String"

        
      HttpW3id.orgSawgraphV1Us-wqp#PrivateNon-IndustrialOrganization : rdfs_label
        
          
    
    
    HttpW3id.orgSawgraphV1Us-wqp#PrivateNon-IndustrialOrganization --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- | --- |
| [http___w3id.org_sawgraph_v1_us_wqp#organizationId](../slots/http___w3id.org_sawgraph_v1_us_wqp#organizationId.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string) |  <br/>  | direct | 1 |
...
```yaml
name: http___w3id.org_sawgraph_v1_us-wqp#PrivateNon-Industrial_Organization
from_schema: okns:sawgraph-kg
rank: 1000
slots:
- http___w3id.org_sawgraph_v1_us-wqp#organizationId
- rdfs_label
class_uri: http://w3id.org/sawgraph/v1/us-wqp#PrivateNon-Industrial_Organization
...
attributes:
  http___w3id.org_sawgraph_v1_us-wqp#organizationId:
    ...
    owner: http___w3id.org_sawgraph_v1_us-wqp#PrivateNon-Industrial_Organization
    domain_of:
