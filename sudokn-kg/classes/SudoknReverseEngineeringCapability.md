...
# Class: No class (type) name specified (sudokn_ReverseEngineeringCapability)
...
URI: [sudokn:ReverseEngineeringCapability](http://asu.edu/semantics/SUDOKN/ReverseEngineeringCapability)
...
```mermaid
 classDiagram
    class SudoknReverseEngineeringCapability
    click SudoknReverseEngineeringCapability href "../SudoknReverseEngineeringCapability"
      ...
      SudoknReverseEngineeringCapability : rdfs_label
        
          
    
    
    SudoknReverseEngineeringCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknReverseEngineeringCapability](../classes/SudoknReverseEngineeringCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknReverseEngineeringCapability](../classes/SudoknReverseEngineeringCapability.md) |
...
```yaml
name: sudokn_ReverseEngineeringCapability
  ...
  rdfs_label:
    ...
    annotations:
      string:
        tag: string
        value: 2
class_uri: sudokn:ReverseEngineeringCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ReverseEngineeringCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
    - owl_NamedIndividual
