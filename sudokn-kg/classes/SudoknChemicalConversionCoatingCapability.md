...
# Class: SudoknChemicalConversionCoatingCapability





URI: [sudokn:ChemicalConversionCoatingCapability](http://asu.edu/semantics/SUDOKN/ChemicalConversionCoatingCapability)
...
```mermaid
 classDiagram
    class SudoknChemicalConversionCoatingCapability
    click SudoknChemicalConversionCoatingCapability href "../SudoknChemicalConversionCoatingCapability"
      SudoknChemicalCoatingCapability <|-- SudoknChemicalConversionCoatingCapability
        click SudoknChemicalCoatingCapability href "../SudoknChemicalCoatingCapability"
      

      SudoknChemicalConversionCoatingCapability <|-- SudoknAlkalineOxideConversionCoatingCapability
        click SudoknAlkalineOxideConversionCoatingCapability href "../SudoknAlkalineOxideConversionCoatingCapability"
      SudoknChemicalConversionCoatingCapability <|-- SudoknChromateConversionCoatingCapability
        click SudoknChromateConversionCoatingCapability href "../SudoknChromateConversionCoatingCapability"
      SudoknChemicalConversionCoatingCapability <|-- SudoknFusedNitrateConversionCoatingCapability
        click SudoknFusedNitrateConversionCoatingCapability href "../SudoknFusedNitrateConversionCoatingCapability"
      SudoknChemicalConversionCoatingCapability <|-- SudoknPhosphateConversionCoatingCapability
        click SudoknPhosphateConversionCoatingCapability href "../SudoknPhosphateConversionCoatingCapability"
      
      
      SudoknChemicalConversionCoatingCapability : rdfs_label
        
          
    
    
    SudoknChemicalConversionCoatingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
* [IoscProductionCapability](../classes/IoscProductionCapability.md)
    * [SudoknManufacturingProcessCapability](../classes/SudoknManufacturingProcessCapability.md)
        * [SudoknSurfaceFinishingCapability](../classes/SudoknSurfaceFinishingCapability.md)
            * [SudoknCoatingCapability](../classes/SudoknCoatingCapability.md)
                * [SudoknChemicalCoatingCapability](../classes/SudoknChemicalCoatingCapability.md)
                    * **SudoknChemicalConversionCoatingCapability**
                        * [SudoknAlkalineOxideConversionCoatingCapability](../classes/SudoknAlkalineOxideConversionCoatingCapability.md)
                        * [SudoknChromateConversionCoatingCapability](../classes/SudoknChromateConversionCoatingCapability.md)
                        * [SudoknFusedNitrateConversionCoatingCapability](../classes/SudoknFusedNitrateConversionCoatingCapability.md)
                        * [SudoknPhosphateConversionCoatingCapability](../classes/SudoknPhosphateConversionCoatingCapability.md)
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject | [SudoknCoatingCapability](../classes/SudoknCoatingCapability.md), [SudoknChemicalCoatingCapability](../classes/SudoknChemicalCoatingCapability.md), [SudoknSurfaceFinishingCapability](../classes/SudoknSurfaceFinishingCapability.md) |  |
...
```yaml
name: sudokn_ChemicalConversionCoatingCapability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_ChemicalCoatingCapability
class_uri: sudokn:ChemicalConversionCoatingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ChemicalConversionCoatingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
