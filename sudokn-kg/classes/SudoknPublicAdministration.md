...
# Class: No class (type) name specified (sudokn_PublicAdministration)
...
URI: [sudokn:PublicAdministration](http://asu.edu/semantics/SUDOKN/PublicAdministration)
...
```mermaid
 classDiagram
    class SudoknPublicAdministration
    click SudoknPublicAdministration href "../SudoknPublicAdministration"
      ...
      SudoknPublicAdministration : sudokn_hasNAICSCodeValue
        
          
    
    
    SudoknPublicAdministration --> "0..1" Any : sudokn_hasNAICSCodeValue
    click Any href "../Any"

        
      SudoknPublicAdministration : sudokn_hasNAICSTextValue
        
          
    
    
    SudoknPublicAdministration --> "0..1" Any : sudokn_hasNAICSTextValue
    click Any href "../Any"
...
```yaml
name: sudokn_PublicAdministration
...
class_uri: sudokn:PublicAdministration
...
attributes:
  sudokn_hasNAICSCodeValue:
    ...
    owner: sudokn_PublicAdministration
    domain_of:
    - sudokn_NAICS332111
    - sudokn_NAICS332112
    - sudokn_NAICS332114
