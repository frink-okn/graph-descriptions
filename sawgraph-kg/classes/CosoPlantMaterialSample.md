...
# Class: Plant Material Sample (coso_PlantMaterialSample)
...
URI: [coso:PlantMaterialSample](http://w3id.org/coso/v1/contaminoso#PlantMaterialSample)
...
```mermaid
 classDiagram
    class CosoPlantMaterialSample
    click CosoPlantMaterialSample href "../CosoPlantMaterialSample"
      SosaSample <|-- CosoPlantMaterialSample
        click SosaSample href "../SosaSample"
      
      CosoPlantMaterialSample : coso_fromSamplePoint
        
          
    
    
    CosoPlantMaterialSample --> "0..1" Any : coso_fromSamplePoint
    click Any href "../Any"

        
      CosoPlantMaterialSample : coso_isSampleOf
        
          
    
    
    CosoPlantMaterialSample --> "0..1" Any : coso_isSampleOf
    click Any href "../Any"

        
      CosoPlantMaterialSample : coso_sampleAnnotation
        
          
    
    
    CosoPlantMaterialSample --> "0..1" Any : coso_sampleAnnotation
    click Any href "../Any"

        
      CosoPlantMaterialSample : coso_sampleOfMaterialType
        
          
    
    
    CosoPlantMaterialSample --> "0..1" Any : coso_sampleOfMaterialType
    click Any href "../Any"

        
      CosoPlantMaterialSample : dct_identifier
        
          
    
    
    CosoPlantMaterialSample --> "0..1" RdfsLiteral : dct_identifier
    click RdfsLiteral href "../RdfsLiteral"

        
      CosoPlantMaterialSample : http___w3id.org_sawgraph_v1_me_egad#sampleCollectionLocation
        
          
    
    
    CosoPlantMaterialSample --> "0..1" Any : http___w3id.org_sawgraph_v1_me_egad#sampleCollectionLocation
    click Any href "../Any"

        
      CosoPlantMaterialSample : http___w3id.org_sawgraph_v1_me_egad#sampleCollectionMethod
        
          
    
    
    CosoPlantMaterialSample --> "0..1" Any : http___w3id.org_sawgraph_v1_me_egad#sampleCollectionMethod
    click Any href "../Any"

        
      CosoPlantMaterialSample : owl_sameAs
        
          
    
    
    CosoPlantMaterialSample --> "0..1" OwlThing : owl_sameAs
    click OwlThing href "../OwlThing"

        
      CosoPlantMaterialSample : prov_wasAttributedTo
        
          
    
    
    CosoPlantMaterialSample --> "0..1" ProvAgent : prov_wasAttributedTo
    click ProvAgent href "../ProvAgent"

        
      CosoPlantMaterialSample : rdfs_label
        
          
    
    
    CosoPlantMaterialSample --> "0..1" Any : rdfs_label
    click Any href "../Any"

        
      CosoPlantMaterialSample : sosa_isSampleOf
        
          
    
    
    CosoPlantMaterialSample --> "0..1" HttpW3id.orgSawgraphV1Me-egad#EGAD-SampledFeature : sosa_isSampleOf
...
| ---  | --- | --- | --- |
| [HttpW3id.orgSawgraphV1Me-egad#EGAD-PFAS-Observation](../classes/HttpW3id.orgSawgraphV1Me-egad#EGAD-PFAS-Observation.md) | [coso_analyzedSample](../slots/coso_analyzedSample.md) | any_of[range] | [CosoPlantMaterialSample](../classes/CosoPlantMaterialSample.md) |
| [HttpW3id.orgSawgraphV1Me-egad#EGAD-PFAS-Observation](../classes/HttpW3id.orgSawgraphV1Me-egad#EGAD-PFAS-Observation.md) | [coso_hasAnyFeatureOfInterest](../slots/coso_hasAnyFeatureOfInterest.md) | any_of[range] | [CosoPlantMaterialSample](../classes/CosoPlantMaterialSample.md) |
| [HttpW3id.orgSawgraphV1Us-wqp#Observation](../classes/HttpW3id.orgSawgraphV1Us-wqp#Observation.md) | [coso_analyzedSample](../slots/coso_analyzedSample.md) | any_of[range] | [CosoPlantMaterialSample](../classes/CosoPlantMaterialSample.md) |
| [MeEgadEGAD-PFAS-Observation](../classes/MeEgadEGAD-PFAS-Observation.md) | [coso_analyzedSample](../slots/coso_analyzedSample.md) | any_of[range] | [CosoPlantMaterialSample](../classes/CosoPlantMaterialSample.md) |
| [MeEgadEGAD-PFAS-Observation](../classes/MeEgadEGAD-PFAS-Observation.md) | [coso_hasAnyFeatureOfInterest](../slots/coso_hasAnyFeatureOfInterest.md) | any_of[range] | [CosoPlantMaterialSample](../classes/CosoPlantMaterialSample.md) |
...
```yaml
name: coso_PlantMaterialSample
title: Plant Material Sample
...
- coso_fromSamplePoint
class_uri: coso:PlantMaterialSample
...
attributes:
  coso_isSampleOf:
    ...
    owner: coso_PlantMaterialSample
    domain_of:
