...
# Class: No class (type) name specified (sudokn_PressureWeldingCapability)
...
URI: [sudokn:PressureWeldingCapability](http://asu.edu/semantics/SUDOKN/PressureWeldingCapability)
...
```mermaid
 classDiagram
    class SudoknPressureWeldingCapability
    click SudoknPressureWeldingCapability href "../SudoknPressureWeldingCapability"
      ...
      SudoknPressureWeldingCapability : rdfs_label
        
          
    
    
    SudoknPressureWeldingCapability --> "0..1" String : rdfs_label
...
```yaml
name: sudokn_PressureWeldingCapability
...
class_uri: sudokn:PressureWeldingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_PressureWeldingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
    - owl_NamedIndividual
