...
# Class: transportation industry (sudokn_TransportationIndustry)
...
URI: [sudokn:TransportationIndustry](http://asu.edu/semantics/SUDOKN/TransportationIndustry)
...
```mermaid
 classDiagram
    class SudoknTransportationIndustry
    click SudoknTransportationIndustry href "../SudoknTransportationIndustry"
      ...
      SudoknTransportationIndustry : rdfs_label
        
          
    
    
    SudoknTransportationIndustry --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknTransportationIndustry](../classes/SudoknTransportationIndustry.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknTransportationIndustry](../classes/SudoknTransportationIndustry.md) |
...
| Value |
| --- |
| sudokn:Transportation-Industry |
...
| ---  | ---  |
| self | sudokn:TransportationIndustry |
| native | sudokn-kg/:SudoknTransportationIndustry |
...
<details>
```yaml
name: sudokn_TransportationIndustry
...
examples:
- value: sudokn:Transportation-Industry
from_schema: sudokn-kg
is_a: iosc_Industry
slots:
- rdfs_label
class_uri: sudokn:TransportationIndustry
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_TransportationIndustry
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
