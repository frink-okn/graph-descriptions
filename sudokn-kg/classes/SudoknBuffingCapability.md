...
# Class: buffing capability (sudokn_BuffingCapability)





URI: [sudokn:BuffingCapability](http://asu.edu/semantics/SUDOKN/BuffingCapability)
...
```mermaid
 classDiagram
    ...
    click SudoknBuffingCapability href "../SudoknBuffingCapability"
      ...
      SudoknBuffingCapability : rdfs_label
        
          
    
    
    SudoknBuffingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: sudokn_BuffingCapability
title: buffing capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_AbrassiveMachiningCapability
class_uri: sudokn:BuffingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_BuffingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
