...
# Class: TODO -- what's a good name for this class (type)? (sudokn_CNCBendingCapability)
...
URI: [sudokn:CNCBendingCapability](http://asu.edu/semantics/SUDOKN/CNCBendingCapability)
...
```mermaid
 classDiagram
    class SudoknCNCBendingCapability
    click SudoknCNCBendingCapability href "../SudoknCNCBendingCapability"
      SudoknCNCBendingCapability : rdfs_label
        
          
    
    
    SudoknCNCBendingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCNCBendingCapability](../classes/SudoknCNCBendingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCNCBendingCapability](../classes/SudoknCNCBendingCapability.md) |
...
| Value |
| --- |
| sudokn:MechanicalSpecialty-CNCBending |
...
| ---  | ---  |
| self | sudokn:CNCBendingCapability |
| native | sudokn-kg/:SudoknCNCBendingCapability |
...
<details>
```yaml
name: sudokn_CNCBendingCapability
...
examples:
- value: sudokn:MechanicalSpecialty-CNCBending
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:CNCBendingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_CNCBendingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
