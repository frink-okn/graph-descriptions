...
# Slot: No slot (predicate) name specified (sockg_fracIronSd_gFe_ha)
...
URI: [sockg:fracIronSd_gFe_ha](https://idir.uta.edu/sockg-ontology/docs/fracIronSd_gFe_ha)
...
| --- | --- | --- | --- | --- |
| sockg_YieldNutrientUptake | double | sockg:individuals/624996 | 19.13825 | 20 |
