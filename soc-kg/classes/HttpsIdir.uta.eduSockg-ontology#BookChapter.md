...
# Class: HttpsIdir.uta.eduSockg-ontology#BookChapter
...
URI: [https://idir.uta.edu/sockg-ontology#BookChapter](https://idir.uta.edu/sockg-ontology#BookChapter)
...
```mermaid
 classDiagram
    ...
    click HttpsIdir.uta.eduSockg-ontology#BookChapter href "../HttpsIdir.uta.eduSockg-ontology#BookChapter"
      ...
      HttpsIdir.uta.eduSockg-ontology#BookChapter : dct_bibliographicCitation
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#BookChapter --> "0..1" RdfsLiteral : dct_bibliographicCitation
    click RdfsLiteral href "../RdfsLiteral"

        
      HttpsIdir.uta.eduSockg-ontology#BookChapter : dct_creator
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#BookChapter --> "0..1" Any : dct_creator
    click Any href "../Any"

        
      HttpsIdir.uta.eduSockg-ontology#BookChapter : dct_isPartOf
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#BookChapter --> "0..1" Any : dct_isPartOf
    click Any href "../Any"

        
      HttpsIdir.uta.eduSockg-ontology#BookChapter : dct_issued
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#BookChapter --> "0..1" Any : dct_issued
    click Any href "../Any"

        
      HttpsIdir.uta.eduSockg-ontology#BookChapter : dct_title
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#BookChapter --> "0..1" Any : dct_title
    click Any href "../Any"

        
      HttpsIdir.uta.eduSockg-ontology#BookChapter : https___idir.uta.edu_sockg_ontology#correspondingAuthor
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#BookChapter --> "0..1" String : https___idir.uta.edu_sockg_ontology#correspondingAuthor
    click String href "../String"

        
      HttpsIdir.uta.eduSockg-ontology#BookChapter : rdfs_label
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#BookChapter --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| [https___idir.uta.edu_sockg_ontology#correspondingAuthor](../slots/https___idir.uta.edu_sockg_ontology#correspondingAuthor.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string) |  <br/>  | direct | 2 |
...
| ---  | --- | --- | --- |
| [HttpsIdir.uta.eduSockg-ontology#Location](../classes/HttpsIdir.uta.eduSockg-ontology#Location.md) | [https___idir.uta.edu_sockg_ontology#cites](../slots/https___idir.uta.edu_sockg_ontology#cites.md) | any_of[range] | [HttpsIdir.uta.eduSockg-ontology#BookChapter](../classes/HttpsIdir.uta.eduSockg-ontology#BookChapter.md) |
...
```yaml
name: https___idir.uta.edu_sockg-ontology#BookChapter
...
- dct_creator
- rdfs_label
class_uri: https://idir.uta.edu/sockg-ontology#BookChapter
...
attributes:
  dct_issued:
    ...
    slot_uri: dct:issued
    alias: dct_issued
    owner: https___idir.uta.edu_sockg-ontology#BookChapter
    domain_of:
