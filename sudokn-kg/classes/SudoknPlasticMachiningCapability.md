...
# Class: plastic machining capability (sudokn_PlasticMachiningCapability)
...
```mermaid
 classDiagram
    ...
    SudoknPlasticMachiningCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
title: plastic machining capability
