...
# Class: SudoknWomenOwned





URI: [sudokn:WomenOwned](http://asu.edu/semantics/SUDOKN/WomenOwned)
...
```mermaid
 classDiagram
    ...
    click SudoknWomenOwned href "../SudoknWomenOwned"
      ...
      SudoknWomenOwned : rdfs_label
        
          
    
    
    SudoknWomenOwned --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: sudokn_WomenOwned
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_OwnershipStatusClassifier
class_uri: sudokn:WomenOwned
