...
# Class: chemical engraving capability (sudokn_ChemicalEngravingCapability)





URI: [sudokn:ChemicalEngravingCapability](http://asu.edu/semantics/SUDOKN/ChemicalEngravingCapability)
...
```mermaid
 classDiagram
    class SudoknChemicalEngravingCapability
    click SudoknChemicalEngravingCapability href "../SudoknChemicalEngravingCapability"
      ...
      SudoknChemicalEngravingCapability : rdfs_label
        
          
    
    
    SudoknChemicalEngravingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: sudokn_ChemicalEngravingCapability
title: chemical engraving capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_ChemicalMachiningCapability
class_uri: sudokn:ChemicalEngravingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ChemicalEngravingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
