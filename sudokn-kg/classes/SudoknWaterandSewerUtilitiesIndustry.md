...
# Class: TODO -- what's a good name for this class (type)? (sudokn_WaterandSewerUtilitiesIndustry)
...
URI: [sudokn:WaterandSewerUtilitiesIndustry](http://asu.edu/semantics/SUDOKN/WaterandSewerUtilitiesIndustry)
...
```mermaid
 classDiagram
    class SudoknWaterandSewerUtilitiesIndustry
    click SudoknWaterandSewerUtilitiesIndustry href "../SudoknWaterandSewerUtilitiesIndustry"
      SudoknWaterandSewerUtilitiesIndustry : rdfs_label
        
          
    
    
    SudoknWaterandSewerUtilitiesIndustry --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknWaterandSewerUtilitiesIndustry](../classes/SudoknWaterandSewerUtilitiesIndustry.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknWaterandSewerUtilitiesIndustry](../classes/SudoknWaterandSewerUtilitiesIndustry.md) |
...
| Value |
| --- |
| sudokn:WaterandSewerUtilities-Industry |
...
| ---  | ---  |
| self | sudokn:WaterandSewerUtilitiesIndustry |
| native | sudokn-kg/:SudoknWaterandSewerUtilitiesIndustry |
...
examples:
- value: sudokn:WaterandSewerUtilities-Industry
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_WaterandSewerUtilitiesIndustry
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
