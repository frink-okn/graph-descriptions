...
# Class: HttpsIdir.uta.eduSockg-ontology#GHGFlux




This class occurs 132766 times.


URI: [https://idir.uta.edu/sockg-ontology#GHGFlux](https://idir.uta.edu/sockg-ontology#GHGFlux)
...
```mermaid
 classDiagram
    ...
    click HttpsIdir.uta.eduSockg-ontology#GHGFlux href "../HttpsIdir.uta.eduSockg-ontology#GHGFlux"
      ...
      HttpsIdir.uta.eduSockg-ontology#GHGFlux : dct_date
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#GHGFlux --> "0..1" RdfsLiteral : dct_date
    click RdfsLiteral href "../RdfsLiteral"

        
      HttpsIdir.uta.eduSockg-ontology#GHGFlux : https___idir.uta.edu_sockg_ontology#fromUnit
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#GHGFlux --> "0..1" Any : https___idir.uta.edu_sockg_ontology#fromUnit
    click Any href "../Any"

        
      HttpsIdir.uta.eduSockg-ontology#GHGFlux : https___idir.uta.edu_sockg_ontology#hasChamberPlacement
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#GHGFlux --> "0..1" HttpsIdir.uta.eduSockg-ontology#ChamberPlacement : https___idir.uta.edu_sockg_ontology#hasChamberPlacement
    click HttpsIdir.uta.eduSockg-ontology#ChamberPlacement href "../HttpsIdir.uta.eduSockg-ontology#ChamberPlacement"

        
      HttpsIdir.uta.eduSockg-ontology#GHGFlux : https___idir.uta.edu_sockg_ontology#hasCrop
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#GHGFlux --> "0..1" HttpsLod.nal.usda.govNalt7140 : https___idir.uta.edu_sockg_ontology#hasCrop
    click HttpsLod.nal.usda.govNalt7140 href "../HttpsLod.nal.usda.govNalt7140"

        
      HttpsIdir.uta.eduSockg-ontology#GHGFlux : https___idir.uta.edu_sockg_ontology#hasMeasurement
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#GHGFlux --> "0..1" HttpsIdir.uta.eduSockg-ontology#Measurement : https___idir.uta.edu_sockg_ontology#hasMeasurement
    click HttpsIdir.uta.eduSockg-ontology#Measurement href "../HttpsIdir.uta.eduSockg-ontology#Measurement"

        
      HttpsIdir.uta.eduSockg-ontology#GHGFlux : https___idir.uta.edu_sockg_ontology#usesTreatment
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#GHGFlux --> "0..1" Any : https___idir.uta.edu_sockg_ontology#usesTreatment
    click Any href "../Any"
...
| ---  | --- | --- | --- | --- |
| [https___idir.uta.edu_sockg_ontology#fromUnit](../slots/https___idir.uta.edu_sockg_ontology#fromUnit.md) | 0..1 <br/> [xsd:anyURI](http://www.w3.org/2001/XMLSchema#anyURI)&nbsp;or&nbsp;<br />[HttpsIdir.uta.eduSockg-ontology#ExperimentalUnit](../classes/HttpsIdir.uta.eduSockg-ontology#ExperimentalUnit.md) |  <br/>  | direct | 132766 |
| [https___idir.uta.edu_sockg_ontology#hasChamberPlacement](../slots/https___idir.uta.edu_sockg_ontology#hasChamberPlacement.md) | 0..1 <br/> [HttpsIdir.uta.eduSockg-ontology#ChamberPlacement](../classes/HttpsIdir.uta.eduSockg-ontology#ChamberPlacement.md) |  <br/>  | direct | 127419 |
| [https___idir.uta.edu_sockg_ontology#hasMeasurement](../slots/https___idir.uta.edu_sockg_ontology#hasMeasurement.md) | 0..1 <br/> [HttpsIdir.uta.eduSockg-ontology#Measurement](../classes/HttpsIdir.uta.eduSockg-ontology#Measurement.md) |  <br/>  | direct | 928275 |
| [https___idir.uta.edu_sockg_ontology#usesTreatment](../slots/https___idir.uta.edu_sockg_ontology#usesTreatment.md) | 0..1 <br/> [xsd:anyURI](http://www.w3.org/2001/XMLSchema#anyURI)&nbsp;or&nbsp;<br />[HttpsIdir.uta.eduSockg-ontology#Treatment](../classes/HttpsIdir.uta.eduSockg-ontology#Treatment.md) |  <br/>  | direct | 132766 |
| [dct_date](../slots/dct_date.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md) | Date may be used to express temporal information at any level of granularity <br/> description: A point or period of time associated with an event in the lifecycle of the resource. | direct | 132766 |
| [https___idir.uta.edu_sockg_ontology#hasCrop](../slots/https___idir.uta.edu_sockg_ontology#hasCrop.md) | 0..1 <br/> [HttpsLod.nal.usda.govNalt7140](../classes/HttpsLod.nal.usda.govNalt7140.md) |  <br/>  | direct | 128975 |
...
| ---  | --- | --- | --- |
| [HttpsIdir.uta.eduSockg-ontology#GHGFlux](../classes/HttpsIdir.uta.eduSockg-ontology#GHGFlux.md) | [https___idir.uta.edu_sockg_ontology#hasChamberPlacement](../slots/https___idir.uta.edu_sockg_ontology#hasChamberPlacement.md) | domain | [HttpsIdir.uta.eduSockg-ontology#GHGFlux](../classes/HttpsIdir.uta.eduSockg-ontology#GHGFlux.md) |
...
class_uri: https://idir.uta.edu/sockg-ontology#GHGFlux
...
attributes:
  https___idir.uta.edu_sockg-ontology#fromUnit:
    ...
    owner: https___idir.uta.edu_sockg-ontology#GHGFlux
    domain_of:
  ...
  https___idir.uta.edu_sockg-ontology#hasChamberPlacement:
    name: https___idir.uta.edu_sockg-ontology#hasChamberPlacement
    from_schema: okns:soc-kg
    rank: 1000
    domain: https___idir.uta.edu_sockg-ontology#GHGFlux
    slot_uri: https://idir.uta.edu/sockg-ontology#hasChamberPlacement
    alias: https___idir.uta.edu_sockg_ontology#hasChamberPlacement
    owner: https___idir.uta.edu_sockg-ontology#GHGFlux
    domain_of:
    - https___idir.uta.edu_sockg-ontology#GHGFlux
    range: https___idir.uta.edu_sockg-ontology#ChamberPlacement
  https___idir.uta.edu_sockg-ontology#hasMeasurement:
