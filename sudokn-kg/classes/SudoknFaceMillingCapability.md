...
# Class: TODO -- what's a good name for this class (type)? (sudokn_FaceMillingCapability)
...
URI: [sudokn:FaceMillingCapability](http://asu.edu/semantics/SUDOKN/FaceMillingCapability)
...
```mermaid
 classDiagram
    class SudoknFaceMillingCapability
    click SudoknFaceMillingCapability href "../SudoknFaceMillingCapability"
      ...
      SudoknFaceMillingCapability : rdfs_label
        
          
    
    
    SudoknFaceMillingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string) | No slot description provided | [SudoknMachiningCapability](../classes/SudoknMachiningCapability.md), [SudoknVerticalMillingCapability](../classes/SudoknVerticalMillingCapability.md), [SudoknMillingCapability](../classes/SudoknMillingCapability.md) |
...
| ---  | ---  |
| self | sudokn:FaceMillingCapability |
| native | sudokn-kg/:SudoknFaceMillingCapability |
...
<details>
```yaml
name: sudokn_FaceMillingCapability
...
rank: 1000
is_a: sudokn_VerticalMillingCapability
class_uri: sudokn:FaceMillingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_FaceMillingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
