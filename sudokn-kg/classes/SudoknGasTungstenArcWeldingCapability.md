...
# Class: TODO -- what's a good name for this class (type)? (sudokn_GasTungstenArcWeldingCapability)
...
| ---  | ---  |
| self | sudokn:GasTungstenArcWeldingCapability |
| native | sudokn-kg/:SudoknGasTungstenArcWeldingCapability |
