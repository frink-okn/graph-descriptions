...
# Class: boring capability (sudokn_BoringCapability)




This class occurs 857 times.


URI: [sudokn:BoringCapability](http://asu.edu/semantics/SUDOKN/BoringCapability)
...
```mermaid
 classDiagram
    ...
    click SudoknBoringCapability href "../SudoknBoringCapability"
      ...
      SudoknBoringCapability : rdfs_label
        
          
    
    
    SudoknBoringCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
            ...
            * [SudoknSinglePointCuttingCapability](../classes/SudoknSinglePointCuttingCapability.md)
                * [SudoknTurningCapability](../classes/SudoknTurningCapability.md)
                    * **SudoknBoringCapability**
                        * [SudoknHorizontalBoringCapability](../classes/SudoknHorizontalBoringCapability.md)
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknBoringCapability](../classes/SudoknBoringCapability.md) |
...
```yaml
name: sudokn_BoringCapability
title: boring capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_TurningCapability
slots:
- rdfs_label
class_uri: sudokn:BoringCapability
