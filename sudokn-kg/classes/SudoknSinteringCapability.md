...
# Class: TODO -- what's a good name for this class (type)? (sudokn_SinteringCapability)
...
URI: [sudokn:SinteringCapability](http://asu.edu/semantics/SUDOKN/SinteringCapability)
...
```mermaid
 classDiagram
    class SudoknSinteringCapability
    click SudoknSinteringCapability href "../SudoknSinteringCapability"
      SudoknSinteringCapability : rdfs_label
        
          
    
    
    SudoknSinteringCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknSinteringCapability](../classes/SudoknSinteringCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknSinteringCapability](../classes/SudoknSinteringCapability.md) |
...
| Value |
| --- |
| sudokn:3DSYSTEMS-SinteringCapability-inst |
...
| ---  | ---  |
| self | sudokn:SinteringCapability |
| native | sudokn-kg/:SudoknSinteringCapability |
...
<details>
```yaml
name: sudokn_SinteringCapability
...
examples:
- value: sudokn:3DSYSTEMS-SinteringCapability-inst
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:SinteringCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_SinteringCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
