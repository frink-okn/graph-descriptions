...
# Class: gas metal arc welding capability (sudokn_GasMetalArcWeldingCapability)





URI: [sudokn:GasMetalArcWeldingCapability](http://asu.edu/semantics/SUDOKN/GasMetalArcWeldingCapability)
...
```mermaid
 classDiagram
    class SudoknGasMetalArcWeldingCapability
    click SudoknGasMetalArcWeldingCapability href "../SudoknGasMetalArcWeldingCapability"
      ...
      SudoknGasMetalArcWeldingCapability : rdfs_label
        
          
    
    
    SudoknGasMetalArcWeldingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
                ...
                * [SudoknThermalWeldingCapability](../classes/SudoknThermalWeldingCapability.md)
                    * [SudoknElectricArcWeldingCapability](../classes/SudoknElectricArcWeldingCapability.md)
                        * **SudoknGasMetalArcWeldingCapability**
                            * [SudoknMIGWeldingCapability](../classes/SudoknMIGWeldingCapability.md)
...
```yaml
name: sudokn_GasMetalArcWeldingCapability
title: gas metal arc welding capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_ElectricArcWeldingCapability
class_uri: sudokn:GasMetalArcWeldingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_GasMetalArcWeldingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
