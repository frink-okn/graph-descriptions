...
# Class: shell molding capability (sudokn_ShellMoldingCapability)





URI: [sudokn:ShellMoldingCapability](http://asu.edu/semantics/SUDOKN/ShellMoldingCapability)
...
```mermaid
 classDiagram
    class SudoknShellMoldingCapability
    click SudoknShellMoldingCapability href "../SudoknShellMoldingCapability"
      ...
      SudoknShellMoldingCapability : rdfs_label
        
          
    
    
    SudoknShellMoldingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: sudokn_ShellMoldingCapability
title: shell molding capability
from_schema: okns:sudokn-kg
aliases:
- shell mold casting capability
rank: 1000
is_a: sudokn_CastingCapability
class_uri: sudokn:ShellMoldingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ShellMoldingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
