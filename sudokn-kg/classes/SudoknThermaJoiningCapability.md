...
# Class: No class (entity type) name specified -- this class is noted as a superclass of another class in this graph but has not itself been defined. (sudokn_ThermaJoiningCapability)





URI: [sudokn:ThermaJoiningCapability](http://asu.edu/semantics/SUDOKN/ThermaJoiningCapability)
...
```mermaid
 classDiagram
    class SudoknThermaJoiningCapability
    click SudoknThermaJoiningCapability href "../SudoknThermaJoiningCapability"
      SudoknJoiningCapability <|-- SudoknThermaJoiningCapability
      ...
      SudoknThermaJoiningCapability <|-- SudoknSolderingCapability
        click SudoknSolderingCapability href "../SudoknSolderingCapability"
      ...
      SudoknThermaJoiningCapability : rdfs_label
        
          
    
    
    SudoknThermaJoiningCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
    ...
    * [SudoknManufacturingProcessCapability](../classes/SudoknManufacturingProcessCapability.md)
        * [SudoknJoiningCapability](../classes/SudoknJoiningCapability.md)
            * **SudoknThermaJoiningCapability**
                * [SudoknBrazingCapability](../classes/SudoknBrazingCapability.md)
                * [SudoknSolderingCapability](../classes/SudoknSolderingCapability.md)
...
```yaml
name: sudokn_ThermaJoiningCapability
title: No class (entity type) name specified -- this class is noted as a superclass
  of another class in this graph but has not itself been defined.
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_JoiningCapability
class_uri: sudokn:ThermaJoiningCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ThermaJoiningCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
