...
# Class: polishing capability (sudokn_PolishingCapability)




This class occurs 456 times.


URI: [sudokn:PolishingCapability](http://asu.edu/semantics/SUDOKN/PolishingCapability)
...
```mermaid
 classDiagram
    class SudoknPolishingCapability
    click SudoknPolishingCapability href "../SudoknPolishingCapability"
      ...
      SudoknPolishingCapability <|-- SudoknElectropolishingCapability
        click SudoknElectropolishingCapability href "../SudoknElectropolishingCapability"
      
      
      SudoknPolishingCapability : rdfs_label
        
          
    
    
    SudoknPolishingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
        ...
        * [SudoknSurfaceFinishingCapability](../classes/SudoknSurfaceFinishingCapability.md)
            * [SudoknSurfacePreparationCapability](../classes/SudoknSurfacePreparationCapability.md)
                * **SudoknPolishingCapability**
                    * [SudoknElectropolishingCapability](../classes/SudoknElectropolishingCapability.md)
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject <br/>  | direct | 456 |
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknPolishingCapability](../classes/SudoknPolishingCapability.md) |
...
```yaml
name: sudokn_PolishingCapability
title: polishing capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_SurfacePreparationCapability
slots:
- rdfs_label
class_uri: sudokn:PolishingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_PolishingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
