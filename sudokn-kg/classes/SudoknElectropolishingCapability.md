...
# Class: electropolishing capability (sudokn_ElectropolishingCapability)




This class occurs 61 times.


URI: [sudokn:ElectropolishingCapability](http://asu.edu/semantics/SUDOKN/ElectropolishingCapability)
...
```mermaid
 classDiagram
    class SudoknElectropolishingCapability
    click SudoknElectropolishingCapability href "../SudoknElectropolishingCapability"
      ...
      SudoknElectropolishingCapability : rdfs_label
        
          
    
    
    SudoknElectropolishingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject <br/>  | direct | 61 |
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknElectropolishingCapability](../classes/SudoknElectropolishingCapability.md) |
...
```yaml
name: sudokn_ElectropolishingCapability
title: electropolishing capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_PolishingCapability
slots:
- rdfs_label
class_uri: sudokn:ElectropolishingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ElectropolishingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
