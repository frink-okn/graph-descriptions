...
# Class: TODO -- what's a good name for this class (type)? (sudokn_CentrifugalCastingCapability)
...
URI: [sudokn:CentrifugalCastingCapability](http://asu.edu/semantics/SUDOKN/CentrifugalCastingCapability)
...
```mermaid
 classDiagram
    class SudoknCentrifugalCastingCapability
    click SudoknCentrifugalCastingCapability href "../SudoknCentrifugalCastingCapability"
      SudoknCentrifugalCastingCapability : rdfs_label
        
          
    
    
    SudoknCentrifugalCastingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCentrifugalCastingCapability](../classes/SudoknCentrifugalCastingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCentrifugalCastingCapability](../classes/SudoknCentrifugalCastingCapability.md) |
...
| Value |
| --- |
| sudokn:3ERP-CentrifugalCastingCapability-inst |
...
| ---  | ---  |
| self | sudokn:CentrifugalCastingCapability |
| native | sudokn-kg/:SudoknCentrifugalCastingCapability |
...
<details>
```yaml
name: sudokn_CentrifugalCastingCapability
...
examples:
- value: sudokn:3ERP-CentrifugalCastingCapability-inst
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:CentrifugalCastingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_CentrifugalCastingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
