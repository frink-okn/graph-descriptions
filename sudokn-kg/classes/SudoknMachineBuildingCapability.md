...
# Class: TODO -- what's a good name for this class (type)? (sudokn_MachineBuildingCapability)
...
URI: [sudokn:MachineBuildingCapability](http://asu.edu/semantics/SUDOKN/MachineBuildingCapability)
...
```mermaid
 classDiagram
    class SudoknMachineBuildingCapability
    click SudoknMachineBuildingCapability href "../SudoknMachineBuildingCapability"
      SudoknMachineBuildingCapability : rdfs_label
        
          
    
    
    SudoknMachineBuildingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknMachineBuildingCapability](../classes/SudoknMachineBuildingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknMachineBuildingCapability](../classes/SudoknMachineBuildingCapability.md) |
...
| Value |
| --- |
| sudokn:WilliamsMachineandTools-MachineBuilding |
...
| ---  | ---  |
| self | sudokn:MachineBuildingCapability |
| native | sudokn-kg/:SudoknMachineBuildingCapability |
...
<details>
```yaml
name: sudokn_MachineBuildingCapability
...
examples:
- value: sudokn:WilliamsMachineandTools-MachineBuilding
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:MachineBuildingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_MachineBuildingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
