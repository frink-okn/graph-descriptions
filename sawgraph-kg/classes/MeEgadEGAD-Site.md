...
```mermaid
 classDiagram
    ...
    MeEgadEGAD-Site --> "0..1" Any : geo_hasDefaultGeometry
    click Any href "../Any"
    ...
    click Any href "../Any"
      ...
      MeEgadEGAD-Site : kwgo_sfWithin
        
          
    
    
    MeEgadEGAD-Site --> "0..1" Any : kwgo_sfWithin
    click Any href "../Any"

        
      MeEgadEGAD-Site : me_egad_siteNumber
        
          
    
    
    MeEgadEGAD-Site --> "0..1" Integer : me_egad_siteNumber
    click Integer href "../Integer"

        
      MeEgadEGAD-Site : me_egad_siteType
        
          
    
    
    MeEgadEGAD-Site --> "0..1" Any : me_egad_siteType
    click Any href "../Any"

        
      MeEgadEGAD-Site : owl_sameAs
        
          
    
    
    MeEgadEGAD-Site --> "0..1" Any : owl_sameAs
    click Any href "../Any"
    ...
    MeEgadEGAD-Site --> "0..1" String : rdfs_label
    click String href "../String"

        
      MeEgadEGAD-Site : us_sdwis_hasPWSID
        
          
    
    
    MeEgadEGAD-Site --> "0..1" String : us_sdwis_hasPWSID
    click String href "../String"
...
## Inheritance
* **MeEgadEGAD-Site**
    * [MeEgadEGAD-PFAS-Site](../classes/MeEgadEGAD-PFAS-Site.md)
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string) | No slot (predicate) description specified <br/>  | direct | 915 |
| [us_sdwis_hasPWSID](../slots/us_sdwis_hasPWSID.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string) | No slot (predicate) description specified <br/>  | direct | 48 |
| [kwgo_sfWithin](../slots/kwgo_sfWithin.md) | 0..1 <br/> [xsd:anyURI](http://www.w3.org/2001/XMLSchema#anyURI)&nbsp;or&nbsp;<br />[KwgoS2CellLevel13](../classes/KwgoS2CellLevel13.md) | No slot (predicate) description specified <br/>  | direct | 1680 |
| [me_egad_siteNumber](../slots/me_egad_siteNumber.md) | 0..1 <br/> [xsd:integer](http://www.w3.org/2001/XMLSchema#integer) | Site number in the EGAD dataset from the state of Maine <br/>  | direct | 912 |
| [geo_hasGeometry](../slots/geo_hasGeometry.md) | 0..1 <br/> [GeoGeometry](../classes/GeoGeometry.md)&nbsp;or&nbsp;<br />[Sf#Point](../classes/Sf#Point.md) | No slot (predicate) description specified <br/>  | direct | 3364 |
...
| [owl_sameAs](../slots/owl_sameAs.md) | 0..1 <br/> [QudtUnit](../classes/QudtUnit.md)&nbsp;or&nbsp;<br />[xsd:anyURI](http://www.w3.org/2001/XMLSchema#anyURI) | No slot (predicate) description specified <br/>  | direct | 48 |
| [geo_hasDefaultGeometry](../slots/geo_hasDefaultGeometry.md) | 0..1 <br/> [GeoGeometry](../classes/GeoGeometry.md)&nbsp;or&nbsp;<br />[Sf#Point](../classes/Sf#Point.md) | No slot (predicate) description specified <br/>  | direct | 3364 |
