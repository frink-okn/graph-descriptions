...
# Class: ECOLOGY OPERATIONS (fio-epa-frs_EcologyOperation)


_PROGRAMS THAT CONCENTRATE ON ECOLOGICAL SYSTEMS SUCH AS FOREST AND TREE EXPERTISE_
...
URI: [fio-epa-frs:EcologyOperation](http://w3id.org/fio/v1/epa-frs#EcologyOperation)
...
```mermaid
 classDiagram
    class Fio-epa-frsEcologyOperation
    click Fio-epa-frsEcologyOperation href "../Fio-epa-frsEcologyOperation"
      OwlThing <|-- Fio-epa-frsEcologyOperation
        click OwlThing href "../OwlThing"
      
      Fio-epa-frsEcologyOperation : dct_description
        
          
    
    
    Fio-epa-frsEcologyOperation --> "0..1" String : dct_description
    click String href "../String"

        
      Fio-epa-frsEcologyOperation : owl_sameAs
        
          
    
    
    Fio-epa-frsEcologyOperation --> "0..1" OwlThing : owl_sameAs
    click OwlThing href "../OwlThing"

        
      Fio-epa-frsEcologyOperation : rdfs_label
        
          
    
    
    Fio-epa-frsEcologyOperation --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: fio-epa-frs_EcologyOperation
description: PROGRAMS THAT CONCENTRATE ON ECOLOGICAL SYSTEMS SUCH AS FOREST AND TREE
  EXPERTISE
...
- rdfs_label
- owl_sameAs
class_uri: fio-epa-frs:EcologyOperation
