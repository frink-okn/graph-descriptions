...
# Class: TODO -- what's a good name for this class (type)? (sudokn_WireEDMCapability)
...
URI: [sudokn:WireEDMCapability](http://asu.edu/semantics/SUDOKN/WireEDMCapability)
...
```mermaid
 classDiagram
    ...
    click SudoknWireEDMCapability href "../SudoknWireEDMCapability"
      ...
      SudoknWireEDMCapability : rdfs_label
        
          
    
    
    SudoknWireEDMCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknWireEDMCapability](../classes/SudoknWireEDMCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknWireEDMCapability](../classes/SudoknWireEDMCapability.md) |
...
| Value |
| --- |
| sudokn:1DIETECH-WireEDMCapability-inst |
...
| ---  | ---  |
| self | sudokn:WireEDMCapability |
| native | sudokn-kg/:SudoknWireEDMCapability |
...
examples:
- value: sudokn:1DIETECH-WireEDMCapability-inst
from_schema: sudokn-kg
rank: 1000
is_a: sudokn_EDMCapability
slots:
- rdfs_label
class_uri: sudokn:WireEDMCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_WireEDMCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
