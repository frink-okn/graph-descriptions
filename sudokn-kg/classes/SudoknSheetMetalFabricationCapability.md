...
# Class: TODO -- what's a good name for this class (type)? (sudokn_SheetMetalFabricationCapability)
...
URI: [sudokn:SheetMetalFabricationCapability](http://asu.edu/semantics/SUDOKN/SheetMetalFabricationCapability)
...
```mermaid
 classDiagram
    class SudoknSheetMetalFabricationCapability
    click SudoknSheetMetalFabricationCapability href "../SudoknSheetMetalFabricationCapability"
      SudoknSheetMetalFabricationCapability : rdfs_label
        
          
    
    
    SudoknSheetMetalFabricationCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknSheetMetalFabricationCapability](../classes/SudoknSheetMetalFabricationCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknSheetMetalFabricationCapability](../classes/SudoknSheetMetalFabricationCapability.md) |
...
| Value |
| --- |
| sudokn:CMSToolAndDie-SheetMetalFabrication |
...
| ---  | ---  |
| self | sudokn:SheetMetalFabricationCapability |
| native | sudokn-kg/:SudoknSheetMetalFabricationCapability |
...
<details>
```yaml
name: sudokn_SheetMetalFabricationCapability
...
examples:
- value: sudokn:CMSToolAndDie-SheetMetalFabrication
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:SheetMetalFabricationCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_SheetMetalFabricationCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
