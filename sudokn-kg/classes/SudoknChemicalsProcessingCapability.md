...
# Class: chemicals processing capability (sudokn_ChemicalsProcessingCapability)
...
URI: [sudokn:ChemicalsProcessingCapability](http://asu.edu/semantics/SUDOKN/ChemicalsProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknChemicalsProcessingCapability
    click SudoknChemicalsProcessingCapability href "../SudoknChemicalsProcessingCapability"
      ...
      SudoknChemicalsProcessingCapability : rdfs_label
        
          
    
    
    SudoknChemicalsProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknChemicalsProcessingCapability](../classes/SudoknChemicalsProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknChemicalsProcessingCapability](../classes/SudoknChemicalsProcessingCapability.md) |
...
| Value |
| --- |
| sudokn:3DSYSTEMS-Chemicals-inst |
...
| ---  | ---  |
| self | sudokn:ChemicalsProcessingCapability |
| native | sudokn-kg/:SudoknChemicalsProcessingCapability |
...
<details>
```yaml
name: sudokn_ChemicalsProcessingCapability
description: No type description provided
title: chemicals processing capability
todos:
- TODO -- Todos for this class go here
- or you can delete the todos
- if you think the class is perfect.
notes:
- Class with 1344 occurences.
examples:
- value: sudokn:3DSYSTEMS-Chemicals-inst
from_schema: sudokn-kg
rank: 1000
is_a: sudokn_MaterialProcessingCapability
slots:
- rdfs_label
class_uri: sudokn:ChemicalsProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ChemicalsProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
