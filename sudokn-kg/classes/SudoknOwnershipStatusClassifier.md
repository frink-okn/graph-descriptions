...
URI: [sudokn:OwnershipStatusClassifier](http://asu.edu/semantics/SUDOKN/OwnershipStatusClassifier)
...
```mermaid
 classDiagram
    class SudoknOwnershipStatusClassifier
    click SudoknOwnershipStatusClassifier href "../SudoknOwnershipStatusClassifier"
      ...
      SudoknOwnershipStatusClassifier <|-- SudoknDisabledVeteranOwned
        click SudoknDisabledVeteranOwned href "../SudoknDisabledVeteranOwned"
      SudoknOwnershipStatusClassifier <|-- SudoknMinorityOwned
        click SudoknMinorityOwned href "../SudoknMinorityOwned"
      SudoknOwnershipStatusClassifier <|-- SudoknNativeAmericanOwned
        click SudoknNativeAmericanOwned href "../SudoknNativeAmericanOwned"
      SudoknOwnershipStatusClassifier <|-- SudoknSmallDisadvantagedBusiness
        click SudoknSmallDisadvantagedBusiness href "../SudoknSmallDisadvantagedBusiness"
      SudoknOwnershipStatusClassifier <|-- SudoknVeteranOwned
        click SudoknVeteranOwned href "../SudoknVeteranOwned"
      SudoknOwnershipStatusClassifier <|-- SudoknWomenOwned
        click SudoknWomenOwned href "../SudoknWomenOwned"
      
      
      SudoknOwnershipStatusClassifier : rdfs_label
        
          
    
    
    SudoknOwnershipStatusClassifier --> "0..1" Any : rdfs_label
    click Any href "../Any"
    ...
    * [SudoknClassifier](../classes/SudoknClassifier.md)
        * [SudoknSpecialBusinessStatusClassifier](../classes/SudoknSpecialBusinessStatusClassifier.md)
            * **SudoknOwnershipStatusClassifier**
                * [SudoknDisabledVeteranOwned](../classes/SudoknDisabledVeteranOwned.md)
                * [SudoknMinorityOwned](../classes/SudoknMinorityOwned.md)
                * [SudoknNativeAmericanOwned](../classes/SudoknNativeAmericanOwned.md)
                * [SudoknSmallDisadvantagedBusiness](../classes/SudoknSmallDisadvantagedBusiness.md)
                * [SudoknVeteranOwned](../classes/SudoknVeteranOwned.md)
                * [SudoknWomenOwned](../classes/SudoknWomenOwned.md)
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasOwnershipStatusClassifier](../slots/sudokn_hasOwnershipStatusClassifier.md) | any_of[range] | [SudoknOwnershipStatusClassifier](../classes/SudoknOwnershipStatusClassifier.md) |
...
slots:
- rdfs_label
class_uri: sudokn:OwnershipStatusClassifier
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_OwnershipStatusClassifier
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
