...
# Class: No class (entity type) name specified -- this class is noted as a superclass of another class in this graph but has not itself been defined. (sudokn_HighEnergyBeamWeldingCapability)





URI: [sudokn:HighEnergyBeamWeldingCapability](http://asu.edu/semantics/SUDOKN/HighEnergyBeamWeldingCapability)
...
```mermaid
 classDiagram
    class SudoknHighEnergyBeamWeldingCapability
    click SudoknHighEnergyBeamWeldingCapability href "../SudoknHighEnergyBeamWeldingCapability"
      ...
      SudoknHighEnergyBeamWeldingCapability <|-- SudoknElectronBeamWeldingCapability
        click SudoknElectronBeamWeldingCapability href "../SudoknElectronBeamWeldingCapability"
      SudoknHighEnergyBeamWeldingCapability <|-- SudoknLaserBeamWeldingCapability
        click SudoknLaserBeamWeldingCapability href "../SudoknLaserBeamWeldingCapability"
      SudoknHighEnergyBeamWeldingCapability <|-- SudoknPlasmaArcWeldingCapability
        click SudoknPlasmaArcWeldingCapability href "../SudoknPlasmaArcWeldingCapability"
      
      
      SudoknHighEnergyBeamWeldingCapability : rdfs_label
        
          
    
    
    SudoknHighEnergyBeamWeldingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
            ...
            * [SudoknThermaJoiningCapability](../classes/SudoknThermaJoiningCapability.md)
                * [SudoknThermalWeldingCapability](../classes/SudoknThermalWeldingCapability.md)
                    * **SudoknHighEnergyBeamWeldingCapability**
                        * [SudoknElectronBeamWeldingCapability](../classes/SudoknElectronBeamWeldingCapability.md)
                        * [SudoknLaserBeamWeldingCapability](../classes/SudoknLaserBeamWeldingCapability.md)
                        * [SudoknPlasmaArcWeldingCapability](../classes/SudoknPlasmaArcWeldingCapability.md)
...
```yaml
name: sudokn_HighEnergyBeamWeldingCapability
title: No class (entity type) name specified -- this class is noted as a superclass
  of another class in this graph but has not itself been defined.
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_ThermalWeldingCapability
class_uri: sudokn:HighEnergyBeamWeldingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_HighEnergyBeamWeldingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
