...
# Class: TODO -- what's a good name for this class (type)? (sudokn_FrictionWeldingCapability)
...
| ---  | ---  |
| self | sudokn:FrictionWeldingCapability |
| native | sudokn-kg/:SudoknFrictionWeldingCapability |
