...
URI: [pfas:ReportingLimit](http://sawgraph.spatialai.org/v1/pfas#ReportingLimit)
...
```mermaid
 classDiagram
    ...
    click PfasReportingLimit href "../PfasReportingLimit"
      ...
      PfasReportingLimit : contaminoso_resultAnnotation
        
          
    
    
    PfasReportingLimit --> "0..1" Any : contaminoso_resultAnnotation
    click Any href "../Any"

        
      PfasReportingLimit : meegad_methodDetectionLimit
        
          
    
    
    PfasReportingLimit --> "0..1" ContaminosoResultQualifier : meegad_methodDetectionLimit
    click ContaminosoResultQualifier href "../ContaminosoResultQualifier"

        
      PfasReportingLimit : meegad_parameterGroup
        
          
    
    
    PfasReportingLimit --> "0..1" String : meegad_parameterGroup
    click String href "../String"

        
      PfasReportingLimit : meegad_reportingLimit
        
          
    
    
    PfasReportingLimit --> "0..1" ContaminosoResultQualifier : meegad_reportingLimit
    click ContaminosoResultQualifier href "../ContaminosoResultQualifier"

        
      PfasReportingLimit : qudt_numericValue
        
          
    
    
    PfasReportingLimit --> "0..1" Any : qudt_numericValue
    click Any href "../Any"

        
      PfasReportingLimit : rdfs_label
        
          
    
    
    PfasReportingLimit --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | ---  |
| self | pfas:ReportingLimit |
| native | sawgraph-kg/:PfasReportingLimit |
