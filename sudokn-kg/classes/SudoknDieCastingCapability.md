...
# Class: TODO -- what's a good name for this class (type)? (sudokn_DieCastingCapability)
...
URI: [sudokn:DieCastingCapability](http://asu.edu/semantics/SUDOKN/DieCastingCapability)
...
```mermaid
 classDiagram
    class SudoknDieCastingCapability
    click SudoknDieCastingCapability href "../SudoknDieCastingCapability"
      SudoknDieCastingCapability : rdfs_label
        
          
    
    
    SudoknDieCastingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknDieCastingCapability](../classes/SudoknDieCastingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknDieCastingCapability](../classes/SudoknDieCastingCapability.md) |
...
| Value |
| --- |
| sudokn:3DSYSTEMS-DieCastingCapability-inst |
...
| ---  | ---  |
| self | sudokn:DieCastingCapability |
| native | sudokn-kg/:SudoknDieCastingCapability |
...
<details>
```yaml
name: sudokn_DieCastingCapability
...
- if you think the class is perfect.
notes:
- Class with 220 occurences.
examples:
- value: sudokn:3DSYSTEMS-DieCastingCapability-inst
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:DieCastingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_DieCastingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
