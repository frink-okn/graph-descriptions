...
# Class: TODO -- what's a good name for this class (type)? (sudokn_SandCastingCapability)
...
URI: [sudokn:SandCastingCapability](http://asu.edu/semantics/SUDOKN/SandCastingCapability)
...
```mermaid
 classDiagram
    class SudoknSandCastingCapability
    click SudoknSandCastingCapability href "../SudoknSandCastingCapability"
      SudoknSandCastingCapability : rdfs_label
        
          
    
    
    SudoknSandCastingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknSandCastingCapability](../classes/SudoknSandCastingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknSandCastingCapability](../classes/SudoknSandCastingCapability.md) |
...
| Value |
| --- |
| sudokn:GENFOUNDRY-SandCastingCapability-inst |
...
| ---  | ---  |
| self | sudokn:SandCastingCapability |
| native | sudokn-kg/:SudoknSandCastingCapability |
...
<details>
```yaml
name: sudokn_SandCastingCapability
...
examples:
- value: sudokn:GENFOUNDRY-SandCastingCapability-inst
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:SandCastingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_SandCastingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
