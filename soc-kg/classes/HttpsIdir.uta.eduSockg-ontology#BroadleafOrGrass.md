...
# Class: HttpsIdir.uta.eduSockg-ontology#BroadleafOrGrass
...
URI: [https://idir.uta.edu/sockg-ontology#BroadleafOrGrass](https://idir.uta.edu/sockg-ontology#BroadleafOrGrass)
...
```mermaid
 classDiagram
    ...
    click HttpsIdir.uta.eduSockg-ontology#BroadleafOrGrass href "../HttpsIdir.uta.eduSockg-ontology#BroadleafOrGrass"
      HttpsIdir.uta.eduSockg-ontology#BroadleafOrGrass : rdfs_label
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#BroadleafOrGrass --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: https___idir.uta.edu_sockg-ontology#BroadleafOrGrass
from_schema: okns:soc-kg
rank: 1000
slots:
- rdfs_label
class_uri: https://idir.uta.edu/sockg-ontology#BroadleafOrGrass
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: https___idir.uta.edu_sockg-ontology#BroadleafOrGrass
    domain_of:
    - qudt_AspectClass
    - qudt_BinaryPrefix
