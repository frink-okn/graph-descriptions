...
# Class: sand casting capability (sudokn_SandCastingCapability)
...
```mermaid
 classDiagram
    ...
    SudoknSandCastingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
