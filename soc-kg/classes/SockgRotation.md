...
# Class: No class (entity type) name specified (sockg_Rotation)


_Rotation refers to the practice of systematically changing the types of crops grown in a specific area over a certain period, which helps to improve soil health, prevent pest build-up, and enhance yield. This method is essential in sustainable agriculture as it promotes biodiversity and optimizes the use of nutrients in the soil._
...
This class occurs 74 times.


URI: [sockg:Rotation](https://idir.uta.edu/sockg-ontology/docs/Rotation)
...
```mermaid
 classDiagram
    ...
    click SockgRotation href "../SockgRotation"
      SockgRotation : rdfs_seeAlso
        
          
    
    
    SockgRotation --> "0..1" Uri : rdfs_seeAlso
    click Uri href "../Uri"
...
| ---  | --- | --- | --- |
| [SockgRotation](../classes/SockgRotation.md) | [sockg_rotationDescriptor](../slots/sockg_rotationDescriptor.md) | domain | [SockgRotation](../classes/SockgRotation.md) |
...
annotations:
  count:
    tag: count
    value: 74
description: Rotation refers to the practice of systematically changing the types
  of crops grown in a specific area over a certain period, which helps to improve
  soil health, prevent pest build-up, and enhance yield. This method is essential
  in sustainable agriculture as it promotes biodiversity and optimizes the use of
