...
# Class: TODO -- what's a good name for this class (type)? (sudokn_DeepHoleDrillingCapability)
...
```mermaid
 classDiagram
    ...
    SudoknDeepHoleDrillingCapability --> "0..1" String : rdfs_label
...
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknDeepHoleDrillingCapability](../classes/SudoknDeepHoleDrillingCapability.md) |
...
| Value |
| --- |
| sudokn:ABETECMANUFACTURING-DeepHoleDrillingCapability-inst |
...
| ---  | ---  |
| self | sudokn:DeepHoleDrillingCapability |
| native | sudokn-kg/:SudoknDeepHoleDrillingCapability |
...
examples:
- value: sudokn:ABETECMANUFACTURING-DeepHoleDrillingCapability-inst
