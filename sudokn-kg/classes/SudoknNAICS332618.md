...
# Class: TODO -- what's a good name for this class (type)? (sudokn_NAICS332618)
...
URI: [sudokn:NAICS332618](http://asu.edu/semantics/SUDOKN/NAICS332618)
...
```mermaid
 classDiagram
    class SudoknNAICS332618
    click SudoknNAICS332618 href "../SudoknNAICS332618"
      SudoknNAICS332618 : sudokn_hasNAICSCodeValue
        
          
    
    
    SudoknNAICS332618 --> "0..1" Any : sudokn_hasNAICSCodeValue
    click Any href "../Any"

        
      SudoknNAICS332618 : sudokn_hasNAICSTextValue
        
          
    
    
    SudoknNAICS332618 --> "0..1" Any : sudokn_hasNAICSTextValue
    click Any href "../Any"
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasPrimaryNAICSClassifier](../slots/sudokn_hasPrimaryNAICSClassifier.md) | any_of[range] | [SudoknNAICS332618](../classes/SudoknNAICS332618.md) |
...
| ---  | ---  |
| self | sudokn:NAICS332618 |
| native | sudokn-kg/:SudoknNAICS332618 |
