...
# Class: No class (type) name specified (sudokn_Information)
...
URI: [sudokn:Information](http://asu.edu/semantics/SUDOKN/Information)
...
```mermaid
 classDiagram
    ...
    click SudoknInformation href "../SudoknInformation"
      ...
      SudoknInformation : sudokn_hasNAICSCodeValue
        
          
    
    
    SudoknInformation --> "0..1" Any : sudokn_hasNAICSCodeValue
    click Any href "../Any"

        
      SudoknInformation : sudokn_hasNAICSTextValue
        
          
    
    
    SudoknInformation --> "0..1" Any : sudokn_hasNAICSTextValue
    click Any href "../Any"
