...
# Class: rubber injectionm molding capability (sudokn_RubberInjectionMoldingCapability)





URI: [sudokn:RubberInjectionMoldingCapability](http://asu.edu/semantics/SUDOKN/RubberInjectionMoldingCapability)
...
```mermaid
 classDiagram
    class SudoknRubberInjectionMoldingCapability
    click SudoknRubberInjectionMoldingCapability href "../SudoknRubberInjectionMoldingCapability"
      ...
      SudoknRubberInjectionMoldingCapability : rdfs_label
        
          
    
    
    SudoknRubberInjectionMoldingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: sudokn_RubberInjectionMoldingCapability
title: rubber injectionm molding capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_InjectionMoldingCapability
class_uri: sudokn:RubberInjectionMoldingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_RubberInjectionMoldingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
