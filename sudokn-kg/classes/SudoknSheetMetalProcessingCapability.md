...
```mermaid
 classDiagram
    ...
    click SudoknSheetMetalProcessingCapability href "../SudoknSheetMetalProcessingCapability"
      ...
      SudoknSheetMetalProcessingCapability <|-- SudoknBulgeFormingCapability
        click SudoknBulgeFormingCapability href "../SudoknBulgeFormingCapability"
      ...
      SudoknSheetMetalProcessingCapability <|-- SudoknNotchingCapability
        click SudoknNotchingCapability href "../SudoknNotchingCapability"
    ...
    SudoknSheetMetalProcessingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
* [IoscProductionCapability](../classes/IoscProductionCapability.md)
    * [SudoknManufacturingProcessCapability](../classes/SudoknManufacturingProcessCapability.md)
        * **SudoknSheetMetalProcessingCapability**
            ...
            * [SudoknBulgeFormingCapability](../classes/SudoknBulgeFormingCapability.md)
            * [SudoknEmbossingCapability](../classes/SudoknEmbossingCapability.md)
            * [SudoknNotchingCapability](../classes/SudoknNotchingCapability.md)
