...
# Class: electronic product Industry (sudokn_ElectronicProductIndustry)
...
URI: [sudokn:ElectronicProductIndustry](http://asu.edu/semantics/SUDOKN/ElectronicProductIndustry)
...
```mermaid
 classDiagram
    class SudoknElectronicProductIndustry
    click SudoknElectronicProductIndustry href "../SudoknElectronicProductIndustry"
      ...
      SudoknElectronicProductIndustry <|-- SudoknComputerIndustry
        click SudoknComputerIndustry href "../SudoknComputerIndustry"
      
      
      SudoknElectronicProductIndustry : rdfs_label
        
          
    
    
    SudoknElectronicProductIndustry --> "0..1" String : rdfs_label
...
* [IoscIndustry](../classes/IoscIndustry.md)
    * **SudoknElectronicProductIndustry**
        * [SudoknComputerIndustry](../classes/SudoknComputerIndustry.md)
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknElectronicProductIndustry](../classes/SudoknElectronicProductIndustry.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknElectronicProductIndustry](../classes/SudoknElectronicProductIndustry.md) |
...
| ---  | ---  |
| self | sudokn:ElectronicProductIndustry |
| native | sudokn-kg/:SudoknElectronicProductIndustry |
...
<details>
```yaml
name: sudokn_ElectronicProductIndustry
description: No type description provided
title: electronic product Industry
todos:
- TODO -- Todos for this class go here
- or you can delete the todos
- if you think the class is perfect.
...
slots:
- rdfs_label
class_uri: sudokn:ElectronicProductIndustry
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ElectronicProductIndustry
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
