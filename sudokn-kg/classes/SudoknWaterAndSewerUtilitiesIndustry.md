...
# Class: water and sewer utilities industry (sudokn_WaterAndSewerUtilitiesIndustry)
...
```mermaid
 classDiagram
    ...
    SudoknWaterAndSewerUtilitiesIndustry --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
title: water and sewer utilities industry
