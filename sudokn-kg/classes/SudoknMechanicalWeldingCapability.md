...
# Class: No class (type) name specified (sudokn_MechanicalWeldingCapability)
...
```mermaid
 classDiagram
    ...
    SudoknMechanicalWeldingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string) | No slot (predicate) description specified | [SudoknMechanicalJoiningCapability](../classes/SudoknMechanicalJoiningCapability.md), [SudoknJoiningCapability](../classes/SudoknJoiningCapability.md) |  |
