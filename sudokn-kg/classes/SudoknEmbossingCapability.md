...
# Class: TODO -- what's a good name for this class (type)? (sudokn_EmbossingCapability)
...
URI: [sudokn:EmbossingCapability](http://asu.edu/semantics/SUDOKN/EmbossingCapability)
...
```mermaid
 classDiagram
    class SudoknEmbossingCapability
    click SudoknEmbossingCapability href "../SudoknEmbossingCapability"
      ...
      SudoknEmbossingCapability : rdfs_label
        
          
    
    
    SudoknEmbossingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknEmbossingCapability](../classes/SudoknEmbossingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknEmbossingCapability](../classes/SudoknEmbossingCapability.md) |
...
| Value |
| --- |
| sudokn:3ERP-EmbossingCapability-inst |
...
| ---  | ---  |
| self | sudokn:EmbossingCapability |
| native | sudokn-kg/:SudoknEmbossingCapability |
...
<details>
```yaml
name: sudokn_EmbossingCapability
...
examples:
- value: sudokn:3ERP-EmbossingCapability-inst
from_schema: sudokn-kg
rank: 1000
is_a: sudokn_SheetMetalProcessingCapability
slots:
- rdfs_label
class_uri: sudokn:EmbossingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_EmbossingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
