...
# Class: No class (type) name specified (sudokn_Construction)
...
URI: [sudokn:Construction](http://asu.edu/semantics/SUDOKN/Construction)
...
```mermaid
 classDiagram
    ...
    click SudoknConstruction href "../SudoknConstruction"
      ...
      SudoknConstruction : sudokn_hasNAICSCodeValue
        
          
    
    
    SudoknConstruction --> "0..1" Any : sudokn_hasNAICSCodeValue
    click Any href "../Any"

        
      SudoknConstruction : sudokn_hasNAICSTextValue
        
          
    
    
    SudoknConstruction --> "0..1" Any : sudokn_hasNAICSTextValue
    click Any href "../Any"
