...
# Class: No class (type) name specified (sudokn_RestaurantIndustry)
...
URI: [sudokn:RestaurantIndustry](http://asu.edu/semantics/SUDOKN/RestaurantIndustry)
...
```mermaid
 classDiagram
    class SudoknRestaurantIndustry
    click SudoknRestaurantIndustry href "../SudoknRestaurantIndustry"
      ...
      SudoknRestaurantIndustry : rdfs_label
        
          
    
    
    SudoknRestaurantIndustry --> "0..1" String : rdfs_label
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_RestaurantIndustry
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
    - owl_NamedIndividual
