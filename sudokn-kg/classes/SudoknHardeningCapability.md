...
# Class: No class (type) name specified (sudokn_HardeningCapability)
...
This class occurs 269 times.


URI: [sudokn:HardeningCapability](http://asu.edu/semantics/SUDOKN/HardeningCapability)
...
```mermaid
 classDiagram
    class SudoknHardeningCapability
    click SudoknHardeningCapability href "../SudoknHardeningCapability"
      ...
      SudoknHardeningCapability : rdfs_label
        
          
    
    
    SudoknHardeningCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string) | No slot (predicate) description specified <br/>  | direct | 269 |
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknHardeningCapability](../classes/SudoknHardeningCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknHardeningCapability](../classes/SudoknHardeningCapability.md) |
  ...
  rdfs_label:
    ...
    annotations:
      string:
        tag: string
        value: 269
class_uri: sudokn:HardeningCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_HardeningCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
    - owl_NamedIndividual
