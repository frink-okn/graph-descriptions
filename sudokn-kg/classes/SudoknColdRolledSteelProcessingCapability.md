...
# Class: TODO -- what's a good name for this class (type)? (sudokn_ColdRolledSteelProcessingCapability)
...
```mermaid
 classDiagram
    ...
    SudoknColdRolledSteelProcessingCapability --> "0..1" String : rdfs_label
...
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknColdRolledSteelProcessingCapability](../classes/SudoknColdRolledSteelProcessingCapability.md) |
...
| Value |
| --- |
| sudokn:ACCRAFAB-ColdRolledSteel-inst |
...
| ---  | ---  |
| self | sudokn:ColdRolledSteelProcessingCapability |
| native | sudokn-kg/:SudoknColdRolledSteelProcessingCapability |
...
- if you think the class is perfect.
notes:
- Class with 252 occurences.
examples:
- value: sudokn:ACCRAFAB-ColdRolledSteel-inst
