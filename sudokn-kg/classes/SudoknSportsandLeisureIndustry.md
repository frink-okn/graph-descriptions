...
# Class: TODO -- what's a good name for this class (type)? (sudokn_SportsandLeisureIndustry)
...
URI: [sudokn:SportsandLeisureIndustry](http://asu.edu/semantics/SUDOKN/SportsandLeisureIndustry)
...
```mermaid
 classDiagram
    class SudoknSportsandLeisureIndustry
    click SudoknSportsandLeisureIndustry href "../SudoknSportsandLeisureIndustry"
      SudoknSportsandLeisureIndustry : rdfs_label
        
          
    
    
    SudoknSportsandLeisureIndustry --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknSportsandLeisureIndustry](../classes/SudoknSportsandLeisureIndustry.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknSportsandLeisureIndustry](../classes/SudoknSportsandLeisureIndustry.md) |
...
| Value |
| --- |
| sudokn:SportsandLeisure-Industry |
...
| ---  | ---  |
| self | sudokn:SportsandLeisureIndustry |
| native | sudokn-kg/:SudoknSportsandLeisureIndustry |
...
<details>
```yaml
name: sudokn_SportsandLeisureIndustry
...
examples:
- value: sudokn:SportsandLeisure-Industry
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:SportsandLeisureIndustry
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_SportsandLeisureIndustry
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
