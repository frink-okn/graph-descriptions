...
# Class: No class (type) name specified (sudokn_Mining)
...
URI: [sudokn:Mining](http://asu.edu/semantics/SUDOKN/Mining)
...
```mermaid
 classDiagram
    ...
    click SudoknMining href "../SudoknMining"
      ...
      SudoknMining : sudokn_hasNAICSCodeValue
        
          
    
    
    SudoknMining --> "0..1" Any : sudokn_hasNAICSCodeValue
    click Any href "../Any"

        
      SudoknMining : sudokn_hasNAICSTextValue
        
          
    
    
    SudoknMining --> "0..1" Any : sudokn_hasNAICSTextValue
    click Any href "../Any"
