...
# Class: TODO -- what's a good name for this class (type)? (ussdwis_PublicWaterSystem-GW)
...
URI: [ussdwis:PublicWaterSystem-GW](http://sawgraph.spatialai.org/v1/us-sdwis#PublicWaterSystem-GW)
...
```mermaid
 classDiagram
    ...
    click UssdwisPublicWaterSystem-GW href "../UssdwisPublicWaterSystem-GW"
      ...
      UssdwisPublicWaterSystem-GW : geo_hasSerialization
        
          
    
    
    UssdwisPublicWaterSystem-GW --> "0..1" GeoWktLiteral : geo_hasSerialization
...
| ---  | ---  |
| self | ussdwis:PublicWaterSystem-GW |
| native | sawgraph-kg/:UssdwisPublicWaterSystem-GW |
...
<details>
```yaml
name: ussdwis_PublicWaterSystem-GW
...
- if you think the class is perfect.
notes:
- Class with 31412 occurences.
from_schema: sawgraph-kg
rank: 1000
is_a: geo_SpatialObject
class_uri: ussdwis:PublicWaterSystem-GW
...
attributes:
  geo_hasSerialization:
    ...
    owner: ussdwis_PublicWaterSystem-GW
    domain_of:
    - geo_Geometry
    - geo_SpatialObject
