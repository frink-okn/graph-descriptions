...
# Class: TODO -- what's a good name for this class (type)? (sudokn_NAICS332612)
...
URI: [sudokn:NAICS332612](http://asu.edu/semantics/SUDOKN/NAICS332612)
...
```mermaid
 classDiagram
    class SudoknNAICS332612
    click SudoknNAICS332612 href "../SudoknNAICS332612"
      SudoknNAICS332612 : sudokn_hasNAICSCodeValue
        
          
    
    
    SudoknNAICS332612 --> "0..1" Any : sudokn_hasNAICSCodeValue
    click Any href "../Any"

        
      SudoknNAICS332612 : sudokn_hasNAICSTextValue
        
          
    
    
    SudoknNAICS332612 --> "0..1" Any : sudokn_hasNAICSTextValue
    click Any href "../Any"
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasPrimaryNAICSClassifier](../slots/sudokn_hasPrimaryNAICSClassifier.md) | any_of[range] | [SudoknNAICS332612](../classes/SudoknNAICS332612.md) |
...
| ---  | ---  |
| self | sudokn:NAICS332612 |
| native | sudokn-kg/:SudoknNAICS332612 |
