...
# Class: TODO -- what's a good name for this class (type)? (sudokn_CarburizingCapability)
...
URI: [sudokn:CarburizingCapability](http://asu.edu/semantics/SUDOKN/CarburizingCapability)
...
```mermaid
 classDiagram
    class SudoknCarburizingCapability
    click SudoknCarburizingCapability href "../SudoknCarburizingCapability"
      ...
      SudoknCarburizingCapability : rdfs_label
        
          
    
    
    SudoknCarburizingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCarburizingCapability](../classes/SudoknCarburizingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCarburizingCapability](../classes/SudoknCarburizingCapability.md) |
...
| Value |
| --- |
| sudokn:ABLPRODUCTS-CarburizingCapability-inst |
...
| ---  | ---  |
| self | sudokn:CarburizingCapability |
| native | sudokn-kg/:SudoknCarburizingCapability |
...
<details>
```yaml
name: sudokn_CarburizingCapability
...
examples:
- value: sudokn:ABLPRODUCTS-CarburizingCapability-inst
from_schema: sudokn-kg
is_a: sudokn_DiffusionHardeningCapability
slots:
- rdfs_label
class_uri: sudokn:CarburizingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_CarburizingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
