...
# Class: TODO -- what's a good name for this class (type)? (sudokn_BlackOxideCoatingCapability)
...
URI: [sudokn:BlackOxideCoatingCapability](http://asu.edu/semantics/SUDOKN/BlackOxideCoatingCapability)
...
```mermaid
 classDiagram
    class SudoknBlackOxideCoatingCapability
    click SudoknBlackOxideCoatingCapability href "../SudoknBlackOxideCoatingCapability"
      ...
      SudoknBlackOxideCoatingCapability : rdfs_label
        
          
    
    
    SudoknBlackOxideCoatingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknBlackOxideCoatingCapability](../classes/SudoknBlackOxideCoatingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknBlackOxideCoatingCapability](../classes/SudoknBlackOxideCoatingCapability.md) |
...
| Value |
| --- |
| sudokn:3ERP-BlackOxideCoatingCapability-inst |
...
| ---  | ---  |
| self | sudokn:BlackOxideCoatingCapability |
| native | sudokn-kg/:SudoknBlackOxideCoatingCapability |
...
<details>
```yaml
name: sudokn_BlackOxideCoatingCapability
...
- if you think the class is perfect.
notes:
- Class with 228 occurences.
examples:
- value: sudokn:3ERP-BlackOxideCoatingCapability-inst
from_schema: sudokn-kg
rank: 1000
is_a: sudokn_CoatingCapability
slots:
- rdfs_label
class_uri: sudokn:BlackOxideCoatingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_BlackOxideCoatingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
