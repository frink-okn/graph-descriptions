...
# Class: TODO -- what's a good name for this class (type)? (sudokn_PressingCapability)
...
URI: [sudokn:PressingCapability](http://asu.edu/semantics/SUDOKN/PressingCapability)
...
```mermaid
 classDiagram
    class SudoknPressingCapability
    click SudoknPressingCapability href "../SudoknPressingCapability"
      SudoknPressingCapability : rdfs_label
        
          
    
    
    SudoknPressingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknPressingCapability](../classes/SudoknPressingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknPressingCapability](../classes/SudoknPressingCapability.md) |
...
| Value |
| --- |
| sudokn:DDMManufacturing-Pressing |
...
| ---  | ---  |
| self | sudokn:PressingCapability |
| native | sudokn-kg/:SudoknPressingCapability |
...
<details>
```yaml
name: sudokn_PressingCapability
...
examples:
- value: sudokn:DDMManufacturing-Pressing
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:PressingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_PressingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
