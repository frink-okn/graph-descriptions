...
This class occurs 923 times.


URI: [sudokn:HeatTreatingCapability](http://asu.edu/semantics/SUDOKN/HeatTreatingCapability)
...
```mermaid
 classDiagram
    class SudoknHeatTreatingCapability
    click SudoknHeatTreatingCapability href "../SudoknHeatTreatingCapability"
      ...
      SudoknHeatTreatingCapability <|-- SudoknAnnealingCapability
        click SudoknAnnealingCapability href "../SudoknAnnealingCapability"
      SudoknHeatTreatingCapability <|-- SudoknHardeningCapability
        click SudoknHardeningCapability href "../SudoknHardeningCapability"
      SudoknHeatTreatingCapability <|-- SudoknSinteringCapability
        click SudoknSinteringCapability href "../SudoknSinteringCapability"
      
      
      SudoknHeatTreatingCapability : rdfs_label
        
          
    
    
    SudoknHeatTreatingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
* [IoscProductionCapability](../classes/IoscProductionCapability.md)
    * [SudoknManufacturingProcessCapability](../classes/SudoknManufacturingProcessCapability.md)
        * **SudoknHeatTreatingCapability**
            * [SudoknAnnealingCapability](../classes/SudoknAnnealingCapability.md)
            * [SudoknHardeningCapability](../classes/SudoknHardeningCapability.md)
            * [SudoknSinteringCapability](../classes/SudoknSinteringCapability.md)
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject <br/>  | direct | 923 |
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknHeatTreatingCapability](../classes/SudoknHeatTreatingCapability.md) |
...
slots:
- rdfs_label
class_uri: sudokn:HeatTreatingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_HeatTreatingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
