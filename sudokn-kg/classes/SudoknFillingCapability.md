...
# Class: TODO -- what's a good name for this class (type)? (sudokn_FillingCapability)
...
URI: [sudokn:FillingCapability](http://asu.edu/semantics/SUDOKN/FillingCapability)
...
```mermaid
 classDiagram
    class SudoknFillingCapability
    click SudoknFillingCapability href "../SudoknFillingCapability"
      SudoknFillingCapability : rdfs_label
        
          
    
    
    SudoknFillingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknFillingCapability](../classes/SudoknFillingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknFillingCapability](../classes/SudoknFillingCapability.md) |
...
| ---  | ---  |
| self | sudokn:FillingCapability |
| native | sudokn-kg/:SudoknFillingCapability |
...
examples:
- value: sudokn:HorizonTool-Filling
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:FillingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_FillingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
