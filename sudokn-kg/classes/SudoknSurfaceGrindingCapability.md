...
# Class: TODO -- what's a good name for this class (type)? (sudokn_SurfaceGrindingCapability)
...
URI: [sudokn:SurfaceGrindingCapability](http://asu.edu/semantics/SUDOKN/SurfaceGrindingCapability)
...
```mermaid
 classDiagram
    class SudoknSurfaceGrindingCapability
    click SudoknSurfaceGrindingCapability href "../SudoknSurfaceGrindingCapability"
      SudoknSurfaceGrindingCapability : rdfs_label
        
          
    
    
    SudoknSurfaceGrindingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknSurfaceGrindingCapability](../classes/SudoknSurfaceGrindingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknSurfaceGrindingCapability](../classes/SudoknSurfaceGrindingCapability.md) |
...
| Value |
| --- |
| sudokn:UnitedMachineAndMetalFab-SurfaceGrinding |
...
| ---  | ---  |
| self | sudokn:SurfaceGrindingCapability |
| native | sudokn-kg/:SudoknSurfaceGrindingCapability |
...
<details>
```yaml
name: sudokn_SurfaceGrindingCapability
...
examples:
- value: sudokn:UnitedMachineAndMetalFab-SurfaceGrinding
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:SurfaceGrindingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_SurfaceGrindingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
