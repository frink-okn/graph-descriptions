...
# Class: turning capability (sudokn_TurningCapability)




This class occurs 2077 times.


URI: [sudokn:TurningCapability](http://asu.edu/semantics/SUDOKN/TurningCapability)
...
```mermaid
 classDiagram
    ...
    click SudoknTurningCapability href "../SudoknTurningCapability"
      ...
      SudoknTurningCapability <|-- SudoknBoringCapability
        click SudoknBoringCapability href "../SudoknBoringCapability"
      SudoknTurningCapability <|-- SudoknCNCTurningCapability
        click SudoknCNCTurningCapability href "../SudoknCNCTurningCapability"
      SudoknTurningCapability <|-- SudoknLiveToolingCapability
        click SudoknLiveToolingCapability href "../SudoknLiveToolingCapability"
      
      
      SudoknTurningCapability : rdfs_label
        
          
    
    
    SudoknTurningCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
        ...
        * [SudoknMachiningCapability](../classes/SudoknMachiningCapability.md)
            * [SudoknSinglePointCuttingCapability](../classes/SudoknSinglePointCuttingCapability.md)
                * **SudoknTurningCapability**
                    * [SudoknBoringCapability](../classes/SudoknBoringCapability.md)
                    * [SudoknCNCTurningCapability](../classes/SudoknCNCTurningCapability.md)
                    * [SudoknLiveToolingCapability](../classes/SudoknLiveToolingCapability.md)
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject <br/>  | direct | 2077 |
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknTurningCapability](../classes/SudoknTurningCapability.md) |
...
```yaml
name: sudokn_TurningCapability
title: turning capability
from_schema: okns:sudokn-kg
aliases:
- lathe work capability
rank: 1000
is_a: sudokn_SinglePointCuttingCapability
slots:
- rdfs_label
class_uri: sudokn:TurningCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_TurningCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
