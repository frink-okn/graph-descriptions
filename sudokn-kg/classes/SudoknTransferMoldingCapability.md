...
# Class: transfer molding capability (sudokn_TransferMoldingCapability)





URI: [sudokn:TransferMoldingCapability](http://asu.edu/semantics/SUDOKN/TransferMoldingCapability)
...
```mermaid
 classDiagram
    class SudoknTransferMoldingCapability
    click SudoknTransferMoldingCapability href "../SudoknTransferMoldingCapability"
      ...
      SudoknTransferMoldingCapability : rdfs_label
        
          
    
    
    SudoknTransferMoldingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: sudokn_TransferMoldingCapability
title: transfer molding capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_MoldingCapability
class_uri: sudokn:TransferMoldingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_TransferMoldingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
