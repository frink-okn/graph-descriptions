...
# Class: CNC routing capability (sudokn_CNCRoutingCapability)





URI: [sudokn:CNCRoutingCapability](http://asu.edu/semantics/SUDOKN/CNCRoutingCapability)
...
```mermaid
 classDiagram
    class SudoknCNCRoutingCapability
    click SudoknCNCRoutingCapability href "../SudoknCNCRoutingCapability"
      ...
      SudoknCNCRoutingCapability : rdfs_label
        
          
    
    
    SudoknCNCRoutingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: sudokn_CNCRoutingCapability
title: CNC routing capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_CNCMachiningCapability
class_uri: sudokn:CNCRoutingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_CNCRoutingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
