...
# Class: wet painting capability (sudokn_WetPaintingCapability)
...
URI: [sudokn:WetPaintingCapability](http://asu.edu/semantics/SUDOKN/WetPaintingCapability)
...
```mermaid
 classDiagram
    class SudoknWetPaintingCapability
    click SudoknWetPaintingCapability href "../SudoknWetPaintingCapability"
      SudoknPrintingCapability <|-- SudoknWetPaintingCapability
        click SudoknPrintingCapability href "../SudoknPrintingCapability"
      
      SudoknWetPaintingCapability : rdfs_label
        
          
    
    
    SudoknWetPaintingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknWetPaintingCapability](../classes/SudoknWetPaintingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknWetPaintingCapability](../classes/SudoknWetPaintingCapability.md) |
...
| ---  | ---  |
| self | sudokn:WetPaintingCapability |
| native | sudokn-kg/:SudoknWetPaintingCapability |
...
<details>
```yaml
name: sudokn_WetPaintingCapability
description: TODO -- tell the world what this class (type) describes.
title: wet painting capability
todos:
- TODO -- Todos for this class go here
- or you can delete the todos
- if you think the class is perfect.
...
examples:
- value: sudokn:Accu-Fab-WetPainting
from_schema: sudokn-kg
is_a: sudokn_PrintingCapability
slots:
- rdfs_label
class_uri: sudokn:WetPaintingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_WetPaintingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
