...
# Class: TODO -- what's a good name for this class (type)? (sudokn_FDAGMPCompliant)
...
URI: [sudokn:FDAGMPCompliant](http://asu.edu/semantics/SUDOKN/FDAGMPCompliant)
...
```mermaid
 classDiagram
    class SudoknFDAGMPCompliant
    click SudoknFDAGMPCompliant href "../SudoknFDAGMPCompliant"
      SudoknFDAGMPCompliant : rdfs_label
        
          
    
    
    SudoknFDAGMPCompliant --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasCertificate](../slots/sudokn_hasCertificate.md) | any_of[range] | [SudoknFDAGMPCompliant](../classes/SudoknFDAGMPCompliant.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasCertificate](../slots/sudokn_hasCertificate.md) | any_of[range] | [SudoknFDAGMPCompliant](../classes/SudoknFDAGMPCompliant.md) |
...
| Value |
| --- |
| sudokn:IntelligentImplantSystems-FDAGMPCompliant |
...
| ---  | ---  |
| self | sudokn:FDAGMPCompliant |
| native | sudokn-kg/:SudoknFDAGMPCompliant |
...
examples:
- value: sudokn:IntelligentImplantSystems-FDAGMPCompliant
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:FDAGMPCompliant
