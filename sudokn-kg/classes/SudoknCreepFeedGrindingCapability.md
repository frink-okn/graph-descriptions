...
# Class: creep feed grinding capability (sudokn_CreepFeedGrindingCapability)
...
URI: [sudokn:CreepFeedGrindingCapability](http://asu.edu/semantics/SUDOKN/CreepFeedGrindingCapability)
...
```mermaid
 classDiagram
    class SudoknCreepFeedGrindingCapability
    click SudoknCreepFeedGrindingCapability href "../SudoknCreepFeedGrindingCapability"
      ...
      SudoknCreepFeedGrindingCapability : rdfs_label
        
          
    
    
    SudoknCreepFeedGrindingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCreepFeedGrindingCapability](../classes/SudoknCreepFeedGrindingCapability.md) |
...
```yaml
name: sudokn_CreepFeedGrindingCapability
title: creep feed grinding capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_GrindingCapability
slots:
- rdfs_label
class_uri: sudokn:CreepFeedGrindingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_CreepFeedGrindingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
