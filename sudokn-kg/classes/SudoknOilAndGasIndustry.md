...
# Class: TODO -- what's a good name for this class (type)? (sudokn_OilAndGasIndustry)
...
URI: [sudokn:OilAndGasIndustry](http://asu.edu/semantics/SUDOKN/OilAndGasIndustry)
...
```mermaid
 classDiagram
    class SudoknOilAndGasIndustry
    click SudoknOilAndGasIndustry href "../SudoknOilAndGasIndustry"
      SudoknOilAndGasIndustry : rdfs_label
        
          
    
    
    SudoknOilAndGasIndustry --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknOilAndGasIndustry](../classes/SudoknOilAndGasIndustry.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknOilAndGasIndustry](../classes/SudoknOilAndGasIndustry.md) |
...
| ---  | ---  |
| self | sudokn:OilAndGasIndustry |
| native | sudokn-kg/:SudoknOilAndGasIndustry |
...
examples:
- value: sudokn:oilandgasindustry-inst
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:OilAndGasIndustry
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_OilAndGasIndustry
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
