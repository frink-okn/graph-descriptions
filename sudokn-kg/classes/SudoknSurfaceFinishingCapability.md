...
# Class: TODO -- what's a good name for this class (type)? (sudokn_SurfaceFinishingCapability)
...
```mermaid
 classDiagram
    ...
    SudoknSurfaceFinishingCapability --> "0..1" String : rdfs_label
...
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknSurfaceFinishingCapability](../classes/SudoknSurfaceFinishingCapability.md) |
...
| Value |
| --- |
| sudokn:AAAPLATING-SurfaceFinishingCapability-inst |
...
| ---  | ---  |
| self | sudokn:SurfaceFinishingCapability |
| native | sudokn-kg/:SudoknSurfaceFinishingCapability |
...
- if you think the class is perfect.
notes:
- Class with 76 occurences.
examples:
- value: sudokn:AAAPLATING-SurfaceFinishingCapability-inst
