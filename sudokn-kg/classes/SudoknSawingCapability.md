...
# Class: sawing capability (sudokn_SawingCapability)





URI: [sudokn:SawingCapability](http://asu.edu/semantics/SUDOKN/SawingCapability)
...
```mermaid
 classDiagram
    ...
    click SudoknSawingCapability href "../SudoknSawingCapability"
      ...
      SudoknSawingCapability : rdfs_label
        
          
    
    
    SudoknSawingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: sudokn_SawingCapability
title: sawing capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_MultiPointCuttingCapability
class_uri: sudokn:SawingCapability
