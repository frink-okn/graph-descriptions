...
This class occurs 344060 times.
...
```mermaid
 classDiagram
    ...
    click Fio-epa-frsReportingRecord href "../Fio-epa-frsReportingRecord"
      ...
      Fio-epa-frsReportingRecord : dc_identifier
        
          
    
    
    Fio-epa-frsReportingRecord --> "0..1" Any : dc_identifier
    click Any href "../Any"
