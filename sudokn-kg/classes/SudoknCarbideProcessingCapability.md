...
# Class: TODO -- what's a good name for this class (type)? (sudokn_CarbideProcessingCapability)
...
URI: [sudokn:CarbideProcessingCapability](http://asu.edu/semantics/SUDOKN/CarbideProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknCarbideProcessingCapability
    click SudoknCarbideProcessingCapability href "../SudoknCarbideProcessingCapability"
      SudoknCarbideProcessingCapability : rdfs_label
        
          
    
    
    SudoknCarbideProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknCarbideProcessingCapability](../classes/SudoknCarbideProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknCarbideProcessingCapability](../classes/SudoknCarbideProcessingCapability.md) |
...
| ---  | ---  |
| self | sudokn:CarbideProcessingCapability |
| native | sudokn-kg/:SudoknCarbideProcessingCapability |
...
<details>
```yaml
name: sudokn_CarbideProcessingCapability
...
- if you think the class is perfect.
notes:
- Class with 786 occurences.
examples:
- value: sudokn:4PEABODY-Carbide-inst
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:CarbideProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_CarbideProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
