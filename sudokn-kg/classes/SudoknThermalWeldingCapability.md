...
# Class: No class (entity type) name specified -- this class is noted as a superclass of another class in this graph but has not itself been defined. (sudokn_ThermalWeldingCapability)





URI: [sudokn:ThermalWeldingCapability](http://asu.edu/semantics/SUDOKN/ThermalWeldingCapability)
...
```mermaid
 classDiagram
    class SudoknThermalWeldingCapability
    click SudoknThermalWeldingCapability href "../SudoknThermalWeldingCapability"
      SudoknThermaJoiningCapability <|-- SudoknThermalWeldingCapability
        click SudoknThermaJoiningCapability href "../SudoknThermaJoiningCapability"
      

      SudoknThermalWeldingCapability <|-- SudoknBrazeWeldingCapability
        click SudoknBrazeWeldingCapability href "../SudoknBrazeWeldingCapability"
      SudoknThermalWeldingCapability <|-- SudoknDiffusionBondingCapability
        click SudoknDiffusionBondingCapability href "../SudoknDiffusionBondingCapability"
      ...
      SudoknThermalWeldingCapability <|-- SudoknGasWeldingCapability
        click SudoknGasWeldingCapability href "../SudoknGasWeldingCapability"
      SudoknThermalWeldingCapability <|-- SudoknHighEnergyBeamWeldingCapability
        click SudoknHighEnergyBeamWeldingCapability href "../SudoknHighEnergyBeamWeldingCapability"
      
      
      SudoknThermalWeldingCapability : rdfs_label
        
          
    
    
    SudoknThermalWeldingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
        ...
        * [SudoknJoiningCapability](../classes/SudoknJoiningCapability.md)
            * [SudoknThermaJoiningCapability](../classes/SudoknThermaJoiningCapability.md)
                * **SudoknThermalWeldingCapability**
                    * [SudoknBrazeWeldingCapability](../classes/SudoknBrazeWeldingCapability.md)
                    * [SudoknDiffusionBondingCapability](../classes/SudoknDiffusionBondingCapability.md)
                    * [SudoknElectricArcWeldingCapability](../classes/SudoknElectricArcWeldingCapability.md)
                    * [SudoknElectricalResistanceWeldingCapability](../classes/SudoknElectricalResistanceWeldingCapability.md)
                    * [SudoknGasWeldingCapability](../classes/SudoknGasWeldingCapability.md)
                    * [SudoknHighEnergyBeamWeldingCapability](../classes/SudoknHighEnergyBeamWeldingCapability.md)
...
```yaml
name: sudokn_ThermalWeldingCapability
title: No class (entity type) name specified -- this class is noted as a superclass
  of another class in this graph but has not itself been defined.
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_ThermaJoiningCapability
class_uri: sudokn:ThermalWeldingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ThermalWeldingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
