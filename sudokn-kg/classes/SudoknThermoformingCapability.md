...
# Class: thermoforming capability (sudokn_ThermoformingCapability)
...
```mermaid
 classDiagram
    ...
    SudoknThermoformingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
    ...
    * [SudoknManufacturingProcessCapability](../classes/SudoknManufacturingProcessCapability.md)
        * [SudoknFormingCapability](../classes/SudoknFormingCapability.md)
            * **SudoknThermoformingCapability**
                * [SudoknVacuumPressingCapability](../classes/SudoknVacuumPressingCapability.md)
...
title: thermoforming capability
