...
| ---  | ---  |
| self | sudokn:MachiningCapability |
| native | sudokn-kg/:SudoknMachiningCapability |
...
- if you think the class is perfect.
notes:
- Class with 3494 occurences.
examples:
- value: sudokn:/MachiningCapability_1
