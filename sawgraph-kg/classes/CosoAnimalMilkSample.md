...
# Class: Animal Milk Sample (coso_AnimalMilkSample)




This class occurs 429 times.


URI: [coso:AnimalMilkSample](http://w3id.org/coso/v1/contaminoso#AnimalMilkSample)
...
```mermaid
 classDiagram
    class CosoAnimalMilkSample
    click CosoAnimalMilkSample href "../CosoAnimalMilkSample"
      SosaSample <|-- CosoAnimalMilkSample
        click SosaSample href "../SosaSample"
      
      CosoAnimalMilkSample : coso_fromSamplePoint
        
          
    
    
    CosoAnimalMilkSample --> "0..1" Any : coso_fromSamplePoint
    click Any href "../Any"

        
      CosoAnimalMilkSample : coso_isSampleOf
        
          
    
    
    CosoAnimalMilkSample --> "0..1" Any : coso_isSampleOf
    click Any href "../Any"

        
      CosoAnimalMilkSample : coso_sampleAnnotation
        
          
    
    
    CosoAnimalMilkSample --> "0..1" Any : coso_sampleAnnotation
    click Any href "../Any"

        
      CosoAnimalMilkSample : coso_sampleOfMaterialType
        
          
    
    
    CosoAnimalMilkSample --> "0..1" Any : coso_sampleOfMaterialType
    click Any href "../Any"

        
      CosoAnimalMilkSample : dct_identifier
        
          
    
    
    CosoAnimalMilkSample --> "0..1" RdfsLiteral : dct_identifier
    click RdfsLiteral href "../RdfsLiteral"

        
      CosoAnimalMilkSample : http___w3id.org_sawgraph_v1_me_egad#sampleCollectionMethod
        
          
    
    
    CosoAnimalMilkSample --> "0..1" Any : http___w3id.org_sawgraph_v1_me_egad#sampleCollectionMethod
    click Any href "../Any"

        
      CosoAnimalMilkSample : http___w3id.org_sawgraph_v1_me_egad#sampleTreatmentStatus
        
          
    
    
    CosoAnimalMilkSample --> "0..1" Any : http___w3id.org_sawgraph_v1_me_egad#sampleTreatmentStatus
    click Any href "../Any"

        
      CosoAnimalMilkSample : owl_sameAs
        
          
    
    
    CosoAnimalMilkSample --> "0..1" OwlThing : owl_sameAs
    click OwlThing href "../OwlThing"

        
      CosoAnimalMilkSample : prov_wasAttributedTo
        
          
    
    
    CosoAnimalMilkSample --> "0..1" ProvAgent : prov_wasAttributedTo
    click ProvAgent href "../ProvAgent"

        
      CosoAnimalMilkSample : rdfs_label
        
          
    
    
    CosoAnimalMilkSample --> "0..1" Any : rdfs_label
    click Any href "../Any"

        
      CosoAnimalMilkSample : sosa_isSampleOf
        
          
    
    
    CosoAnimalMilkSample --> "0..1" HttpW3id.orgSawgraphV1Me-egad#EGAD-SampledFeature : sosa_isSampleOf
...
| ---  | --- | --- | --- |
| [HttpW3id.orgSawgraphV1Me-egad#EGAD-PFAS-Observation](../classes/HttpW3id.orgSawgraphV1Me-egad#EGAD-PFAS-Observation.md) | [coso_analyzedSample](../slots/coso_analyzedSample.md) | any_of[range] | [CosoAnimalMilkSample](../classes/CosoAnimalMilkSample.md) |
| [HttpW3id.orgSawgraphV1Me-egad#EGAD-PFAS-Observation](../classes/HttpW3id.orgSawgraphV1Me-egad#EGAD-PFAS-Observation.md) | [coso_hasAnyFeatureOfInterest](../slots/coso_hasAnyFeatureOfInterest.md) | any_of[range] | [CosoAnimalMilkSample](../classes/CosoAnimalMilkSample.md) |
| [HttpW3id.orgSawgraphV1Us-wqp#Observation](../classes/HttpW3id.orgSawgraphV1Us-wqp#Observation.md) | [coso_analyzedSample](../slots/coso_analyzedSample.md) | any_of[range] | [CosoAnimalMilkSample](../classes/CosoAnimalMilkSample.md) |
| [MeEgadEGAD-PFAS-Observation](../classes/MeEgadEGAD-PFAS-Observation.md) | [coso_analyzedSample](../slots/coso_analyzedSample.md) | any_of[range] | [CosoAnimalMilkSample](../classes/CosoAnimalMilkSample.md) |
| [MeEgadEGAD-PFAS-Observation](../classes/MeEgadEGAD-PFAS-Observation.md) | [coso_hasAnyFeatureOfInterest](../slots/coso_hasAnyFeatureOfInterest.md) | any_of[range] | [CosoAnimalMilkSample](../classes/CosoAnimalMilkSample.md) |
...
```yaml
name: coso_AnimalMilkSample
title: Animal Milk Sample
...
- coso_fromSamplePoint
class_uri: coso:AnimalMilkSample
