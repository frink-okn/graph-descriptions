...
# Class: TODO -- what's a good name for this class (type)? (sudokn_CustomFoamCuttingCapability)
...
URI: [sudokn:CustomFoamCuttingCapability](http://asu.edu/semantics/SUDOKN/CustomFoamCuttingCapability)
...
```mermaid
 classDiagram
    class SudoknCustomFoamCuttingCapability
    click SudoknCustomFoamCuttingCapability href "../SudoknCustomFoamCuttingCapability"
      SudoknCustomFoamCuttingCapability : rdfs_label
        
          
    
    
    SudoknCustomFoamCuttingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCustomFoamCuttingCapability](../classes/SudoknCustomFoamCuttingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCustomFoamCuttingCapability](../classes/SudoknCustomFoamCuttingCapability.md) |
...
| Value |
| --- |
| sudokn:Zarges-CustomFoamCutting |
...
| ---  | ---  |
| self | sudokn:CustomFoamCuttingCapability |
| native | sudokn-kg/:SudoknCustomFoamCuttingCapability |
...
<details>
```yaml
name: sudokn_CustomFoamCuttingCapability
...
examples:
- value: sudokn:Zarges-CustomFoamCutting
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:CustomFoamCuttingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_CustomFoamCuttingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
