...
# Class: TODO -- what's a good name for this class (type)? (sudokn_TubeFormingCapability)
...
URI: [sudokn:TubeFormingCapability](http://asu.edu/semantics/SUDOKN/TubeFormingCapability)
...
```mermaid
 classDiagram
    class SudoknTubeFormingCapability
    click SudoknTubeFormingCapability href "../SudoknTubeFormingCapability"
      SudoknTubeFormingCapability : rdfs_label
        
          
    
    
    SudoknTubeFormingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknTubeFormingCapability](../classes/SudoknTubeFormingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknTubeFormingCapability](../classes/SudoknTubeFormingCapability.md) |
...
| Value |
| --- |
| sudokn:TubeSpecialtiesCo-TubeForming |
...
| ---  | ---  |
| self | sudokn:TubeFormingCapability |
| native | sudokn-kg/:SudoknTubeFormingCapability |
...
<details>
```yaml
name: sudokn_TubeFormingCapability
...
examples:
- value: sudokn:TubeSpecialtiesCo-TubeForming
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:TubeFormingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_TubeFormingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
