...
# Class: No class (type) name specified (sudokn_RealEstateRentalAndLeasing)
...
URI: [sudokn:RealEstateRentalAndLeasing](http://asu.edu/semantics/SUDOKN/RealEstateRentalAndLeasing)
...
```mermaid
 classDiagram
    class SudoknRealEstateRentalAndLeasing
    click SudoknRealEstateRentalAndLeasing href "../SudoknRealEstateRentalAndLeasing"
      ...
      SudoknRealEstateRentalAndLeasing : sudokn_hasNAICSCodeValue
        
          
    
    
    SudoknRealEstateRentalAndLeasing --> "0..1" Any : sudokn_hasNAICSCodeValue
    click Any href "../Any"

        
      SudoknRealEstateRentalAndLeasing : sudokn_hasNAICSTextValue
        
          
    
    
    SudoknRealEstateRentalAndLeasing --> "0..1" Any : sudokn_hasNAICSTextValue
    click Any href "../Any"
...
```yaml
name: sudokn_RealEstateRentalAndLeasing
...
class_uri: sudokn:RealEstateRentalAndLeasing
...
attributes:
  sudokn_hasNAICSCodeValue:
    ...
    owner: sudokn_RealEstateRentalAndLeasing
    domain_of:
    - sudokn_NAICS332111
    - sudokn_NAICS332112
    - sudokn_NAICS332114
