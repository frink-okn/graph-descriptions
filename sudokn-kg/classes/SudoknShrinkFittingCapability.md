...
# Class: TODO -- what's a good name for this class (type)? (sudokn_ShrinkFittingCapability)
...
```mermaid
 classDiagram
    ...
    SudoknShrinkFittingCapability --> "0..1" String : rdfs_label
...
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknShrinkFittingCapability](../classes/SudoknShrinkFittingCapability.md) |
...
| Value |
| --- |
| sudokn:BRODEURMACHINE-ShrinkFittingCapability-inst |
...
| ---  | ---  |
| self | sudokn:ShrinkFittingCapability |
| native | sudokn-kg/:SudoknShrinkFittingCapability |
...
examples:
- value: sudokn:BRODEURMACHINE-ShrinkFittingCapability-inst
