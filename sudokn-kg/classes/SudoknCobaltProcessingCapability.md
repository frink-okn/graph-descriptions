...
# Class: cobalt processing capability (sudokn_CobaltProcessingCapability)
...
```mermaid
 classDiagram
    ...
    SudoknCobaltProcessingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
title: cobalt processing capability
