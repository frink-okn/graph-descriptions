...
# Class: micro drilling capability (sudokn_MicroDrillingCapability)





URI: [sudokn:MicroDrillingCapability](http://asu.edu/semantics/SUDOKN/MicroDrillingCapability)
...
```mermaid
 classDiagram
    class SudoknMicroDrillingCapability
    click SudoknMicroDrillingCapability href "../SudoknMicroDrillingCapability"
      ...
      SudoknMicroDrillingCapability : rdfs_label
        
          
    
    
    SudoknMicroDrillingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: sudokn_MicroDrillingCapability
title: micro drilling capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_DrillingCapability
class_uri: sudokn:MicroDrillingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_MicroDrillingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
