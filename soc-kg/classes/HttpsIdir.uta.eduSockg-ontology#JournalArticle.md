...
# Class: HttpsIdir.uta.eduSockg-ontology#JournalArticle
...
URI: [https://idir.uta.edu/sockg-ontology#JournalArticle](https://idir.uta.edu/sockg-ontology#JournalArticle)
...
```mermaid
 classDiagram
    ...
    click HttpsIdir.uta.eduSockg-ontology#JournalArticle href "../HttpsIdir.uta.eduSockg-ontology#JournalArticle"
      ...
      HttpsIdir.uta.eduSockg-ontology#JournalArticle : dct_bibliographicCitation
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#JournalArticle --> "0..1" RdfsLiteral : dct_bibliographicCitation
    click RdfsLiteral href "../RdfsLiteral"

        
      HttpsIdir.uta.eduSockg-ontology#JournalArticle : dct_creator
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#JournalArticle --> "0..1" Any : dct_creator
    click Any href "../Any"

        
      HttpsIdir.uta.eduSockg-ontology#JournalArticle : dct_description
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#JournalArticle --> "0..1" String : dct_description
    click String href "../String"

        
      HttpsIdir.uta.eduSockg-ontology#JournalArticle : dct_identifier
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#JournalArticle --> "0..1" RdfsLiteral : dct_identifier
    click RdfsLiteral href "../RdfsLiteral"

        
      HttpsIdir.uta.eduSockg-ontology#JournalArticle : dct_issued
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#JournalArticle --> "0..1" Any : dct_issued
    click Any href "../Any"

        
      HttpsIdir.uta.eduSockg-ontology#JournalArticle : dct_title
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#JournalArticle --> "0..1" Any : dct_title
    click Any href "../Any"

        
      HttpsIdir.uta.eduSockg-ontology#JournalArticle : https___idir.uta.edu_sockg_ontology#correspondingAuthor
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#JournalArticle --> "0..1" String : https___idir.uta.edu_sockg_ontology#correspondingAuthor
    click String href "../String"

        
      HttpsIdir.uta.eduSockg-ontology#JournalArticle : rdfs_label
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#JournalArticle --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| [https___idir.uta.edu_sockg_ontology#correspondingAuthor](../slots/https___idir.uta.edu_sockg_ontology#correspondingAuthor.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string) |  <br/>  | direct | 127 |
...
| ---  | --- | --- | --- |
| [HttpsIdir.uta.eduSockg-ontology#Location](../classes/HttpsIdir.uta.eduSockg-ontology#Location.md) | [https___idir.uta.edu_sockg_ontology#cites](../slots/https___idir.uta.edu_sockg_ontology#cites.md) | any_of[range] | [HttpsIdir.uta.eduSockg-ontology#JournalArticle](../classes/HttpsIdir.uta.eduSockg-ontology#JournalArticle.md) |
...
```yaml
name: https___idir.uta.edu_sockg-ontology#JournalArticle
...
- dct_identifier
- rdfs_label
class_uri: https://idir.uta.edu/sockg-ontology#JournalArticle
...
attributes:
  dct_issued:
    ...
    slot_uri: dct:issued
    alias: dct_issued
    owner: https___idir.uta.edu_sockg-ontology#JournalArticle
    domain_of:
