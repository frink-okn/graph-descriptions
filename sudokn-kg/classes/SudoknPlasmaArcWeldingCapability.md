...
# Class: No class (type) name specified (sudokn_PlasmaArcWeldingCapability)
...
URI: [sudokn:PlasmaArcWeldingCapability](http://asu.edu/semantics/SUDOKN/PlasmaArcWeldingCapability)
...
```mermaid
 classDiagram
    class SudoknPlasmaArcWeldingCapability
    click SudoknPlasmaArcWeldingCapability href "../SudoknPlasmaArcWeldingCapability"
      ...
      SudoknPlasmaArcWeldingCapability : rdfs_label
        
          
    
    
    SudoknPlasmaArcWeldingCapability --> "0..1" String : rdfs_label
...
```yaml
name: sudokn_PlasmaArcWeldingCapability
...
class_uri: sudokn:PlasmaArcWeldingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_PlasmaArcWeldingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
    - owl_NamedIndividual
