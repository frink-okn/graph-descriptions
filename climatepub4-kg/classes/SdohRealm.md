...
# Class: TODO -- what's a good name for this class (type)? (sdoh_Realm)
...
URI: [sdoh:Realm](http://schema.org/Realm)
...
```mermaid
 classDiagram
    class SdohRealm
    click SdohRealm href "../SdohRealm"
      SdohRealm : http___relation.org_HasProjectName
        
          
    
    
    SdohRealm --> "0..1" SdohProject : http___relation.org_HasProjectName
    click SdohProject href "../SdohProject"

        
      SdohRealm : skos_broader
        
          
    
    
    SdohRealm --> "0..1" Any : skos_broader
    click Any href "../Any"

        
      SdohRealm : skos_prefLabel
        
          
    
    
    SdohRealm --> "0..1" String : skos_prefLabel
...
| ---  | --- | --- | --- |
| [SdohCmip6SourceId](../classes/SdohCmip6SourceId.md) | [http___relation.org_HasModelComponent](../slots/http___relation.org_HasModelComponent.md) | any_of[range] | [SdohRealm](../classes/SdohRealm.md) |
...
| ---  | ---  |
| self | sdoh:Realm |
| native | climatepub4-kg/:SdohRealm |
