...
# Class: TODO -- what's a good name for this class (type)? (sudokn_LiquidCoatingCapability)
...
URI: [sudokn:LiquidCoatingCapability](http://asu.edu/semantics/SUDOKN/LiquidCoatingCapability)
...
```mermaid
 classDiagram
    class SudoknLiquidCoatingCapability
    click SudoknLiquidCoatingCapability href "../SudoknLiquidCoatingCapability"
      SudoknLiquidCoatingCapability : rdfs_label
        
          
    
    
    SudoknLiquidCoatingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknLiquidCoatingCapability](../classes/SudoknLiquidCoatingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknLiquidCoatingCapability](../classes/SudoknLiquidCoatingCapability.md) |
...
| Value |
| --- |
| sudokn:MetalMasters-LiquidCoating |
...
| ---  | ---  |
| self | sudokn:LiquidCoatingCapability |
| native | sudokn-kg/:SudoknLiquidCoatingCapability |
...
<details>
```yaml
name: sudokn_LiquidCoatingCapability
...
examples:
- value: sudokn:MetalMasters-LiquidCoating
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:LiquidCoatingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_LiquidCoatingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
