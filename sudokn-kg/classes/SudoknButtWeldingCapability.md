...
# Class: TODO -- what's a good name for this class (type)? (sudokn_ButtWeldingCapability)
...
| ---  | ---  |
| self | sudokn:ButtWeldingCapability |
| native | sudokn-kg/:SudoknButtWeldingCapability |
