...
# Class: TODO -- what's a good name for this class (type)? (sudokn_BerylliumProcessingCapability)
...
URI: [sudokn:BerylliumProcessingCapability](http://asu.edu/semantics/SUDOKN/BerylliumProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknBerylliumProcessingCapability
    click SudoknBerylliumProcessingCapability href "../SudoknBerylliumProcessingCapability"
      SudoknBerylliumProcessingCapability : rdfs_label
        
          
    
    
    SudoknBerylliumProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknBerylliumProcessingCapability](../classes/SudoknBerylliumProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknBerylliumProcessingCapability](../classes/SudoknBerylliumProcessingCapability.md) |
...
| ---  | ---  |
| self | sudokn:BerylliumProcessingCapability |
| native | sudokn-kg/:SudoknBerylliumProcessingCapability |
...
<details>
```yaml
name: sudokn_BerylliumProcessingCapability
...
- if you think the class is perfect.
notes:
- Class with 360 occurences.
examples:
- value: sudokn:3ERP-Beryllium-inst
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:BerylliumProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_BerylliumProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
