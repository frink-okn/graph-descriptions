...
# Class: TODO -- what's a good name for this class (type)? (sudokn_BendingCapability)
...
URI: [sudokn:BendingCapability](http://asu.edu/semantics/SUDOKN/BendingCapability)
...
```mermaid
 classDiagram
    ...
    click SudoknBendingCapability href "../SudoknBendingCapability"
      ...
      SudoknBendingCapability <|-- SudoknWireBendingCapability
        click SudoknWireBendingCapability href "../SudoknWireBendingCapability"
      
      
      SudoknBendingCapability : rdfs_label
        
          
    
    
    SudoknBendingCapability --> "0..1" String : rdfs_label
    ...
    * [SudoknManufacturingProcessCapability](../classes/SudoknManufacturingProcessCapability.md)
        * [SudoknSheetMetalProcessingCapability](../classes/SudoknSheetMetalProcessingCapability.md)
            * **SudoknBendingCapability**
                * [SudoknWireBendingCapability](../classes/SudoknWireBendingCapability.md)
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknBendingCapability](../classes/SudoknBendingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknBendingCapability](../classes/SudoknBendingCapability.md) |
...
| Value |
| --- |
| sudokn:3DIMENSIONAL-BendingCapability-inst |
...
| ---  | ---  |
| self | sudokn:BendingCapability |
| native | sudokn-kg/:SudoknBendingCapability |
...
- if you think the class is perfect.
notes:
- Class with 945 occurences.
examples:
- value: sudokn:3DIMENSIONAL-BendingCapability-inst
from_schema: sudokn-kg
is_a: sudokn_SheetMetalProcessingCapability
slots:
- rdfs_label
class_uri: sudokn:BendingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_BendingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
