...
# Class: TODO -- what's a good name for this class (type)? (sudokn_ISO9000)
...
| ---  | ---  |
| self | sudokn:ISO9000 |
| native | sudokn-kg/:SudoknISO9000 |
...
- if you think the class is perfect.
notes:
- Class with 31 occurences.
examples:
- value: sudokn:AAndGMachining-ISO9000
