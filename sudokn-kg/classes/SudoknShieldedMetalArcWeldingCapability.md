...
# Class: No class (type) name specified (sudokn_ShieldedMetalArcWeldingCapability)
...
URI: [sudokn:ShieldedMetalArcWeldingCapability](http://asu.edu/semantics/SUDOKN/ShieldedMetalArcWeldingCapability)
...
```mermaid
 classDiagram
    class SudoknShieldedMetalArcWeldingCapability
    click SudoknShieldedMetalArcWeldingCapability href "../SudoknShieldedMetalArcWeldingCapability"
      ...
      SudoknShieldedMetalArcWeldingCapability : rdfs_label
        
          
    
    
    SudoknShieldedMetalArcWeldingCapability --> "0..1" String : rdfs_label
...
```yaml
name: sudokn_ShieldedMetalArcWeldingCapability
...
class_uri: sudokn:ShieldedMetalArcWeldingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ShieldedMetalArcWeldingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
    - owl_NamedIndividual
