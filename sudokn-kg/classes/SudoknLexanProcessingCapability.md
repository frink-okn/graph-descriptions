...
# Class: TODO -- what's a good name for this class (type)? (sudokn_LexanProcessingCapability)
...
URI: [sudokn:LexanProcessingCapability](http://asu.edu/semantics/SUDOKN/LexanProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknLexanProcessingCapability
    click SudoknLexanProcessingCapability href "../SudoknLexanProcessingCapability"
      SudoknLexanProcessingCapability : rdfs_label
        
          
    
    
    SudoknLexanProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknLexanProcessingCapability](../classes/SudoknLexanProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknLexanProcessingCapability](../classes/SudoknLexanProcessingCapability.md) |
...
| ---  | ---  |
| self | sudokn:LexanProcessingCapability |
| native | sudokn-kg/:SudoknLexanProcessingCapability |
...
<details>
```yaml
name: sudokn_LexanProcessingCapability
...
- if you think the class is perfect.
notes:
- Class with 461 occurences.
examples:
- value: sudokn:3ERP-Lexan-inst
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:LexanProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_LexanProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
