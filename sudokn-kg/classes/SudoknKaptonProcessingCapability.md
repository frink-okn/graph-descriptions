...
# Class: TODO -- what's a good name for this class (type)? (sudokn_KaptonProcessingCapability)
...
URI: [sudokn:KaptonProcessingCapability](http://asu.edu/semantics/SUDOKN/KaptonProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknKaptonProcessingCapability
    click SudoknKaptonProcessingCapability href "../SudoknKaptonProcessingCapability"
      SudoknKaptonProcessingCapability : rdfs_label
        
          
    
    
    SudoknKaptonProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknKaptonProcessingCapability](../classes/SudoknKaptonProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknKaptonProcessingCapability](../classes/SudoknKaptonProcessingCapability.md) |
...
| ---  | ---  |
| self | sudokn:KaptonProcessingCapability |
| native | sudokn-kg/:SudoknKaptonProcessingCapability |
...
<details>
```yaml
name: sudokn_KaptonProcessingCapability
...
- if you think the class is perfect.
notes:
- Class with 32 occurences.
examples:
- value: sudokn:ALTINC-Kapton-inst
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:KaptonProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_KaptonProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
