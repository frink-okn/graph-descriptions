...
# Class: packing capability (sudokn_PackingCapability)




This class occurs 1765 times.


URI: [sudokn:PackingCapability](http://asu.edu/semantics/SUDOKN/PackingCapability)
...
```mermaid
 classDiagram
    ...
    click SudoknPackingCapability href "../SudoknPackingCapability"
      ...
      SudoknPackingCapability <|-- SudoknLabelingCapability
        click SudoknLabelingCapability href "../SudoknLabelingCapability"
      SudoknPackingCapability <|-- SudoknVacuumPackagingCapability
        click SudoknVacuumPackagingCapability href "../SudoknVacuumPackagingCapability"
      
      
      SudoknPackingCapability : rdfs_label
        
          
    
    
    SudoknPackingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
* [IoscProductionCapability](../classes/IoscProductionCapability.md)
    * [SudoknManufacturingProcessCapability](../classes/SudoknManufacturingProcessCapability.md)
        * **SudoknPackingCapability**
            * [SudoknLabelingCapability](../classes/SudoknLabelingCapability.md)
            * [SudoknVacuumPackagingCapability](../classes/SudoknVacuumPackagingCapability.md)
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject <br/>  | direct | 1765 |
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknPackingCapability](../classes/SudoknPackingCapability.md) |
...
```yaml
name: sudokn_PackingCapability
title: packing capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_ManufacturingProcessCapability
slots:
- rdfs_label
class_uri: sudokn:PackingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_PackingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
