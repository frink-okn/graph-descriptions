...
# Slot: No slot (predicate) name specified (sockg_carbonConcentration_g_per_kg)
...
URI: [sockg:carbonConcentration_g_per_kg](https://idir.uta.edu/sockg-ontology/docs/carbonConcentration_g_per_kg)
...
| --- | --- | --- | --- | --- |
| sockg_BioMassMineral | double | sockg:individuals/39962 | 444.4782 | 6723 |
