...
# Class: FDA-GMP certificate (sudokn_FDA-GMPCertificate)
...
URI: [sudokn:FDA-GMPCertificate](http://asu.edu/semantics/SUDOKN/FDA-GMPCertificate)
...
```mermaid
 classDiagram
    class SudoknFDA-GMPCertificate
    click SudoknFDA-GMPCertificate href "../SudoknFDA-GMPCertificate"
      ...
      SudoknFDA-GMPCertificate : rdfs_label
        
          
    
    
    SudoknFDA-GMPCertificate --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string) | TODO -- tell the world what this slot (predicate) describes | [SudoknFDACertificate](../classes/SudoknFDACertificate.md) |
...
| ---  | ---  |
| self | sudokn:FDA-GMPCertificate |
| native | sudokn-kg/:SudoknFDA-GMPCertificate |
...
<details>
```yaml
name: sudokn_FDA-GMPCertificate
description: TODO -- tell the world what this class (type) describes.
title: FDA-GMP certificate
todos:
- TODO -- Todos for this class go here
- or you can delete the todos
- if you think the class is perfect.
...
is_a: sudokn_FDACertificate
class_uri: sudokn:FDA-GMPCertificate
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_FDA-GMPCertificate
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
