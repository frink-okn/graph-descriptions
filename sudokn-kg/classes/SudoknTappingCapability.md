...
# Class: TODO -- what's a good name for this class (type)? (sudokn_TappingCapability)
...
URI: [sudokn:TappingCapability](http://asu.edu/semantics/SUDOKN/TappingCapability)
...
```mermaid
 classDiagram
    ...
    click SudoknTappingCapability href "../SudoknTappingCapability"
      ...
      SudoknTappingCapability : rdfs_label
        
          
    
    
    SudoknTappingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknTappingCapability](../classes/SudoknTappingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknTappingCapability](../classes/SudoknTappingCapability.md) |
...
| Value |
| --- |
| sudokn:A1JAYS-TappingCapability-inst |
...
| ---  | ---  |
| self | sudokn:TappingCapability |
| native | sudokn-kg/:SudoknTappingCapability |
...
- if you think the class is perfect.
notes:
- Class with 860 occurences.
examples:
- value: sudokn:A1JAYS-TappingCapability-inst
from_schema: sudokn-kg
rank: 1000
is_a: sudokn_HoleMakingCapability
slots:
- rdfs_label
class_uri: sudokn:TappingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_TappingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
