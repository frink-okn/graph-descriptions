...
# Class: ISO 13485 certificate (sudokn_ISO13485Certificate)
...
URI: [sudokn:ISO13485Certificate](http://asu.edu/semantics/SUDOKN/ISO13485Certificate)
...
```mermaid
 classDiagram
    class SudoknISO13485Certificate
    click SudoknISO13485Certificate href "../SudoknISO13485Certificate"
      ...
      SudoknISO13485Certificate : rdfs_label
        
          
    
    
    SudoknISO13485Certificate --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasCertificate](../slots/sudokn_hasCertificate.md) | any_of[range] | [SudoknISO13485Certificate](../classes/SudoknISO13485Certificate.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasCertificate](../slots/sudokn_hasCertificate.md) | any_of[range] | [SudoknISO13485Certificate](../classes/SudoknISO13485Certificate.md) |
...
| Value |
| --- |
| sudokn:3DSYSTEMS-ISO13485Certificate |
...
| ---  | ---  |
| self | sudokn:ISO13485Certificate |
| native | sudokn-kg/:SudoknISO13485Certificate |
...
<details>
```yaml
name: sudokn_ISO13485Certificate
...
- if you think the class is perfect.
notes:
- Class with 326 occurences.
examples:
- value: sudokn:3DSYSTEMS-ISO13485Certificate
from_schema: sudokn-kg
is_a: sudokn_ISOCertificate
slots:
- rdfs_label
class_uri: sudokn:ISO13485Certificate
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ISO13485Certificate
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
