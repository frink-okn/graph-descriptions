...
# Class: TODO -- what's a good name for this class (type)? (sudokn_MillingCapability)
...
```mermaid
 classDiagram
    ...
    SudoknMillingCapability --> "0..1" String : rdfs_label
...
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknMillingCapability](../classes/SudoknMillingCapability.md) |
...
| Value |
| --- |
| sudokn:3DIMENSIONAL-MillingCapability-inst |
...
| ---  | ---  |
| self | sudokn:MillingCapability |
| native | sudokn-kg/:SudoknMillingCapability |
...
- if you think the class is perfect.
notes:
- Class with 2311 occurences.
examples:
- value: sudokn:3DIMENSIONAL-MillingCapability-inst
