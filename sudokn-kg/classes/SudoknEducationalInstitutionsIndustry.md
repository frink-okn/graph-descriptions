...
# Class: TODO -- what's a good name for this class (type)? (sudokn_EducationalInstitutionsIndustry)
...
URI: [sudokn:EducationalInstitutionsIndustry](http://asu.edu/semantics/SUDOKN/EducationalInstitutionsIndustry)
...
```mermaid
 classDiagram
    class SudoknEducationalInstitutionsIndustry
    click SudoknEducationalInstitutionsIndustry href "../SudoknEducationalInstitutionsIndustry"
      SudoknEducationalInstitutionsIndustry : rdfs_label
        
          
    
    
    SudoknEducationalInstitutionsIndustry --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknEducationalInstitutionsIndustry](../classes/SudoknEducationalInstitutionsIndustry.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknEducationalInstitutionsIndustry](../classes/SudoknEducationalInstitutionsIndustry.md) |
...
| Value |
| --- |
| sudokn:EducationalInstitutions-Industry |
...
| ---  | ---  |
| self | sudokn:EducationalInstitutionsIndustry |
| native | sudokn-kg/:SudoknEducationalInstitutionsIndustry |
...
<details>
```yaml
name: sudokn_EducationalInstitutionsIndustry
...
examples:
- value: sudokn:EducationalInstitutions-Industry
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:EducationalInstitutionsIndustry
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_EducationalInstitutionsIndustry
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
