...
# Class: acetal processing capability (sudokn_AcetalProcessingCapability)
...
```mermaid
 classDiagram
    ...
    SudoknAcetalProcessingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject <br/>  | direct | 362 |
...
title: acetal processing capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_PlasticProcessingCapability
slots:
- rdfs_label
