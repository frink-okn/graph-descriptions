...
# Class: molding capability (sudokn_MoldingCapability)




This class occurs 644 times.


URI: [sudokn:MoldingCapability](http://asu.edu/semantics/SUDOKN/MoldingCapability)
...
```mermaid
 classDiagram
    ...
    click SudoknMoldingCapability href "../SudoknMoldingCapability"
      ...
      SudoknMoldingCapability <|-- SudoknCompressionMoldingCapability
        click SudoknCompressionMoldingCapability href "../SudoknCompressionMoldingCapability"
      SudoknMoldingCapability <|-- SudoknInjectionMoldingCapability
        click SudoknInjectionMoldingCapability href "../SudoknInjectionMoldingCapability"
      SudoknMoldingCapability <|-- SudoknRotationalMoldingCapability
        click SudoknRotationalMoldingCapability href "../SudoknRotationalMoldingCapability"
      SudoknMoldingCapability <|-- SudoknTransferMoldingCapability
        click SudoknTransferMoldingCapability href "../SudoknTransferMoldingCapability"
      SudoknMoldingCapability <|-- SudoknVacuumMoldingCapability
        click SudoknVacuumMoldingCapability href "../SudoknVacuumMoldingCapability"
      
      
      SudoknMoldingCapability : rdfs_label
        
          
    
    
    SudoknMoldingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
* [IoscProductionCapability](../classes/IoscProductionCapability.md)
    * [SudoknManufacturingProcessCapability](../classes/SudoknManufacturingProcessCapability.md)
        * **SudoknMoldingCapability**
            * [SudoknCompressionMoldingCapability](../classes/SudoknCompressionMoldingCapability.md)
            * [SudoknInjectionMoldingCapability](../classes/SudoknInjectionMoldingCapability.md)
            * [SudoknRotationalMoldingCapability](../classes/SudoknRotationalMoldingCapability.md)
            * [SudoknTransferMoldingCapability](../classes/SudoknTransferMoldingCapability.md)
            * [SudoknVacuumMoldingCapability](../classes/SudoknVacuumMoldingCapability.md)
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject <br/>  | direct | 644 |
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknMoldingCapability](../classes/SudoknMoldingCapability.md) |
...
```yaml
name: sudokn_MoldingCapability
title: molding capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_ManufacturingProcessCapability
slots:
- rdfs_label
class_uri: sudokn:MoldingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_MoldingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
