...
# Class: TODO -- what's a good name for this class (type)? (sudokn_PolycarbonateProcessingCapability)
...
URI: [sudokn:PolycarbonateProcessingCapability](http://asu.edu/semantics/SUDOKN/PolycarbonateProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknPolycarbonateProcessingCapability
    click SudoknPolycarbonateProcessingCapability href "../SudoknPolycarbonateProcessingCapability"
      SudoknPolycarbonateProcessingCapability : rdfs_label
        
          
    
    
    SudoknPolycarbonateProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknPolycarbonateProcessingCapability](../classes/SudoknPolycarbonateProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknPolycarbonateProcessingCapability](../classes/SudoknPolycarbonateProcessingCapability.md) |
...
| Value |
| --- |
| sudokn:3D-CAM-Polycarbonate-inst |
...
| ---  | ---  |
| self | sudokn:PolycarbonateProcessingCapability |
| native | sudokn-kg/:SudoknPolycarbonateProcessingCapability |
...
<details>
```yaml
name: sudokn_PolycarbonateProcessingCapability
...
- if you think the class is perfect.
notes:
- Class with 693 occurences.
examples:
- value: sudokn:3D-CAM-Polycarbonate-inst
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:PolycarbonateProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_PolycarbonateProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
