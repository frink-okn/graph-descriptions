...
# Class: TODO -- what's a good name for this class (type)? (sudokn_HarperizingCapability)
...
URI: [sudokn:HarperizingCapability](http://asu.edu/semantics/SUDOKN/HarperizingCapability)
...
```mermaid
 classDiagram
    class SudoknHarperizingCapability
    click SudoknHarperizingCapability href "../SudoknHarperizingCapability"
      SudoknHarperizingCapability : rdfs_label
        
          
    
    
    SudoknHarperizingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknHarperizingCapability](../classes/SudoknHarperizingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknHarperizingCapability](../classes/SudoknHarperizingCapability.md) |
...
| Value |
| --- |
| sudokn:KVFCOMPANY-HarperizingCapability-inst |
...
| ---  | ---  |
| self | sudokn:HarperizingCapability |
| native | sudokn-kg/:SudoknHarperizingCapability |
...
<details>
```yaml
name: sudokn_HarperizingCapability
...
examples:
- value: sudokn:KVFCOMPANY-HarperizingCapability-inst
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:HarperizingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_HarperizingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
