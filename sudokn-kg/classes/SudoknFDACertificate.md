...
# Class: FDA certificate (sudokn_FDACertificate)
...
| Value |
| --- |
| sudokn:ACIMEDICAL-FDACertificate |
...
| ---  | ---  |
| self | sudokn:FDACertificate |
| native | sudokn-kg/:SudoknFDACertificate |
...
examples:
- value: sudokn:ACIMEDICAL-FDACertificate
