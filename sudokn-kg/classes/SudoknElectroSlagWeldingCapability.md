...
# Class: No class (type) name specified (sudokn_ElectroSlagWeldingCapability)
...
URI: [sudokn:ElectroSlagWeldingCapability](http://asu.edu/semantics/SUDOKN/ElectroSlagWeldingCapability)
...
```mermaid
 classDiagram
    class SudoknElectroSlagWeldingCapability
    click SudoknElectroSlagWeldingCapability href "../SudoknElectroSlagWeldingCapability"
      ...
      SudoknElectroSlagWeldingCapability : rdfs_label
        
          
    
    
    SudoknElectroSlagWeldingCapability --> "0..1" String : rdfs_label
...
```yaml
name: sudokn_ElectroSlagWeldingCapability
...
class_uri: sudokn:ElectroSlagWeldingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ElectroSlagWeldingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
    - owl_NamedIndividual
