...
# Class: TODO -- what's a good name for this class (type)? (sudokn_SolderingCapability)
...
URI: [sudokn:SolderingCapability](http://asu.edu/semantics/SUDOKN/SolderingCapability)
...
```mermaid
 classDiagram
    class SudoknSolderingCapability
    click SudoknSolderingCapability href "../SudoknSolderingCapability"
      ...
      SudoknSolderingCapability : rdfs_label
        
          
    
    
    SudoknSolderingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknSolderingCapability](../classes/SudoknSolderingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknSolderingCapability](../classes/SudoknSolderingCapability.md) |
...
| Value |
| --- |
| sudokn:ABILITYENGINEERING-SolderingCapability-inst |
...
| ---  | ---  |
| self | sudokn:SolderingCapability |
| native | sudokn-kg/:SudoknSolderingCapability |
...
<details>
```yaml
name: sudokn_SolderingCapability
...
- if you think the class is perfect.
notes:
- Class with 271 occurences.
examples:
- value: sudokn:ABILITYENGINEERING-SolderingCapability-inst
from_schema: sudokn-kg
rank: 1000
is_a: sudokn_ThermaJoiningCapability
slots:
- rdfs_label
class_uri: sudokn:SolderingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_SolderingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
