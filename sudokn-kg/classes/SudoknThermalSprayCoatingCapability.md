...
# Class: thermal spray coating capability (sudokn_ThermalSprayCoatingCapability)





URI: [sudokn:ThermalSprayCoatingCapability](http://asu.edu/semantics/SUDOKN/ThermalSprayCoatingCapability)
...
```mermaid
 classDiagram
    class SudoknThermalSprayCoatingCapability
    click SudoknThermalSprayCoatingCapability href "../SudoknThermalSprayCoatingCapability"
      SudoknThermalCoatingCapability <|-- SudoknThermalSprayCoatingCapability
        click SudoknThermalCoatingCapability href "../SudoknThermalCoatingCapability"
      

      SudoknThermalSprayCoatingCapability <|-- SudoknFlameSprayingCapability
        click SudoknFlameSprayingCapability href "../SudoknFlameSprayingCapability"
      SudoknThermalSprayCoatingCapability <|-- SudoknPlasmaSprayingCapability
        click SudoknPlasmaSprayingCapability href "../SudoknPlasmaSprayingCapability"
      
      
      SudoknThermalSprayCoatingCapability : rdfs_label
        
          
    
    
    SudoknThermalSprayCoatingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
            ...
            * [SudoknCoatingCapability](../classes/SudoknCoatingCapability.md)
                * [SudoknThermalCoatingCapability](../classes/SudoknThermalCoatingCapability.md)
                    * **SudoknThermalSprayCoatingCapability**
                        * [SudoknFlameSprayingCapability](../classes/SudoknFlameSprayingCapability.md)
                        * [SudoknPlasmaSprayingCapability](../classes/SudoknPlasmaSprayingCapability.md)
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject | [SudoknCoatingCapability](../classes/SudoknCoatingCapability.md), [SudoknSurfaceFinishingCapability](../classes/SudoknSurfaceFinishingCapability.md) |  |
...
```yaml
name: sudokn_ThermalSprayCoatingCapability
title: thermal spray coating capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_ThermalCoatingCapability
class_uri: sudokn:ThermalSprayCoatingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ThermalSprayCoatingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
