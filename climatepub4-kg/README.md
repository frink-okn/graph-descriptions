...
| Class | Description |
| --- | --- |
| [HsdoActivity](classes/HsdoActivity.md) | No type description provided<br/>Class with 24 occurences.| 
| [HsdoChronostratigraphicUnit](classes/HsdoChronostratigraphicUnit.md) | No type description provided<br/>Class with 184 occurences.| 
| [HsdoCmip6SourceId](classes/HsdoCmip6SourceId.md) | No type description provided<br/>Class with 134 occurences.| 
| [HsdoDataFormat](classes/HsdoDataFormat.md) | No type description provided<br/>Class with 198 occurences.| 
| [HsdoDataset](classes/HsdoDataset.md) | A body of structured information describing some topic(s) of interest.<br/>Class with 107 occurences.| 
| [HsdoExperiment](classes/HsdoExperiment.md) | No type description provided<br/>Class with 467 occurences.| 
| [HsdoFrequency](classes/HsdoFrequency.md) | No type description provided<br/>Class with 16 occurences.| 
| [HsdoGridLabel](classes/HsdoGridLabel.md) | No type description provided<br/>Class with 45 occurences.| 
| [HsdoHorizontalResolutionRange](classes/HsdoHorizontalResolutionRange.md) | No type description provided<br/>Class with 15 occurences.| 
| [HsdoInstitution](classes/HsdoInstitution.md) | No type description provided<br/>Class with 75 occurences.| 
| [HsdoInstrument](classes/HsdoInstrument.md) | No type description provided<br/>Class with 2416 occurences.| 
| [HsdoLicense](classes/HsdoLicense.md) | No type description provided<br/>Class with 5 occurences.| 
| [HsdoLocation](classes/HsdoLocation.md) | No type description provided<br/>Class with 1168 occurences.| 
| [HsdoMeasurementName](classes/HsdoMeasurementName.md) | No type description provided<br/>Class with 251 occurences.| 
| [HsdoMimeType](classes/HsdoMimeType.md) | No type description provided<br/>Class with 38 occurences.| 
| [HsdoModel](classes/HsdoModel.md) | No type description provided<br/>Class with 372 occurences.| 
| [HsdoModels](classes/HsdoModels.md) | No type description provided<br/>Class with 442 occurences.| 
| [HsdoNominalResolution](classes/HsdoNominalResolution.md) | No type description provided<br/>Class with 16 occurences.| 
| [HsdoObs4MipsSourceId](classes/HsdoObs4MipsSourceId.md) | No type description provided<br/>Class with 106 occurences.| 
| [HsdoPaper](classes/HsdoPaper.md) | No type description provided<br/>Class with 300 occurences.| 
| [HsdoPlatform](classes/HsdoPlatform.md) | No type description provided<br/>Class with 1390 occurences.| 
...
| [HsdoProvider](classes/HsdoProvider.md) | No type description provided<br/>Class with 4469 occurences.| 
| [HsdoRealm](classes/HsdoRealm.md) | No type description provided<br/>Class with 9 occurences.| 
| [HsdoRegion](classes/HsdoRegion.md) | No type description provided<br/>Class with 69 occurences.| 
| [HsdoRelatedUrlContentType](classes/HsdoRelatedUrlContentType.md) | No type description provided<br/>Class with 105 occurences.| 
| [HsdoScienceKeyword](classes/HsdoScienceKeyword.md) | No type description provided<br/>Class with 4109 occurences.| 
| [HsdoSourceType](classes/HsdoSourceType.md) | No type description provided<br/>Class with 15 occurences.| 
| [HsdoSubExperimentId](classes/HsdoSubExperimentId.md) | No type description provided<br/>Class with 75 occurences.| 
| [HsdoTemporalResolutionRange](classes/HsdoTemporalResolutionRange.md) | No type description provided<br/>Class with 36 occurences.| 
| [HsdoVariable](classes/HsdoVariable.md) | No type description provided<br/>Class with 2705 occurences.| 
| [HsdoVerticalResolutionRange](classes/HsdoVerticalResolutionRange.md) | No type description provided<br/>Class with 8 occurences.| 
| [SkosConcept](classes/SkosConcept.md) | No type description provided<br/>Class with 16359 occurences.| 
