...
# Class: Energy (fio-epa-frs_Agency.Energy)
...
URI: [fio-epa-frs:Agency.Energy](http://w3id.org/fio/v1/epa-frs#Agency.Energy)
...
```mermaid
 classDiagram
    class Fio-epa-frsAgency.Energy
    click Fio-epa-frsAgency.Energy href "../Fio-epa-frsAgency.Energy"
      ProvAgent <|-- Fio-epa-frsAgency.Energy
        click ProvAgent href "../ProvAgent"
      
      Fio-epa-frsAgency.Energy : owl_sameAs
        
          
    
    
    Fio-epa-frsAgency.Energy --> "0..1" OwlThing : owl_sameAs
    click OwlThing href "../OwlThing"

        
      Fio-epa-frsAgency.Energy : rdfs_label
        
          
    
    
    Fio-epa-frsAgency.Energy --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| [owl_sameAs](../slots/owl_sameAs.md) | 0..1 <br/> [OwlThing](../classes/OwlThing.md) | The property that determines that two given individuals are equal <br/> No occurrences of this slot in the graph. | direct | 54 |
...
| ---  | --- | --- | --- |
| [Fio-epa-frsEPA-PFAS-Facility](../classes/Fio-epa-frsEPA-PFAS-Facility.md) | [fio_ownedBy](../slots/fio_ownedBy.md) | any_of[range] | [Fio-epa-frsAgency.Energy](../classes/Fio-epa-frsAgency.Energy.md) |
| [Fio-epa-frsFRS-Facility](../classes/Fio-epa-frsFRS-Facility.md) | [fio_ownedBy](../slots/fio_ownedBy.md) | any_of[range] | [Fio-epa-frsAgency.Energy](../classes/Fio-epa-frsAgency.Energy.md) |
...
```yaml
name: fio-epa-frs_Agency.Energy
title: Energy
from_schema: okns:fiokg
exact_mappings:
- http://w3id.org/fio/v1/epa-frs#Agency.Energy
rank: 1000
is_a: prov_Agent
slots:
- rdfs_label
- owl_sameAs
class_uri: fio-epa-frs:Agency.Energy
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: fio-epa-frs_Agency.Energy
    domain_of:
