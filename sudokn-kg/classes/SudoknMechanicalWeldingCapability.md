...
# Class: No class (entity type) name specified -- this class is noted as a superclass of another class in this graph but has not itself been defined. (sudokn_MechanicalWeldingCapability)





URI: [sudokn:MechanicalWeldingCapability](http://asu.edu/semantics/SUDOKN/MechanicalWeldingCapability)
...
```mermaid
 classDiagram
    class SudoknMechanicalWeldingCapability
    click SudoknMechanicalWeldingCapability href "../SudoknMechanicalWeldingCapability"
      SudoknMechanicalJoiningCapability <|-- SudoknMechanicalWeldingCapability
        click SudoknMechanicalJoiningCapability href "../SudoknMechanicalJoiningCapability"
      

      SudoknMechanicalWeldingCapability <|-- SudoknExplosiveWeldingCapability
        click SudoknExplosiveWeldingCapability href "../SudoknExplosiveWeldingCapability"
      SudoknMechanicalWeldingCapability <|-- SudoknFrictionWeldingCapability
        click SudoknFrictionWeldingCapability href "../SudoknFrictionWeldingCapability"
      SudoknMechanicalWeldingCapability <|-- SudoknPressureWeldingCapability
        click SudoknPressureWeldingCapability href "../SudoknPressureWeldingCapability"
      SudoknMechanicalWeldingCapability <|-- SudoknUltrasonicWeldingCapability
        click SudoknUltrasonicWeldingCapability href "../SudoknUltrasonicWeldingCapability"
      
      
      SudoknMechanicalWeldingCapability : rdfs_label
        
          
    
    
    SudoknMechanicalWeldingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
* [IoscProductionCapability](../classes/IoscProductionCapability.md)
    * [SudoknManufacturingProcessCapability](../classes/SudoknManufacturingProcessCapability.md)
        * [SudoknJoiningCapability](../classes/SudoknJoiningCapability.md)
            * [SudoknMechanicalJoiningCapability](../classes/SudoknMechanicalJoiningCapability.md)
                * **SudoknMechanicalWeldingCapability**
                    * [SudoknExplosiveWeldingCapability](../classes/SudoknExplosiveWeldingCapability.md)
                    * [SudoknFrictionWeldingCapability](../classes/SudoknFrictionWeldingCapability.md)
                    * [SudoknPressureWeldingCapability](../classes/SudoknPressureWeldingCapability.md)
                    * [SudoknUltrasonicWeldingCapability](../classes/SudoknUltrasonicWeldingCapability.md)
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject | [SudoknMechanicalJoiningCapability](../classes/SudoknMechanicalJoiningCapability.md), [SudoknJoiningCapability](../classes/SudoknJoiningCapability.md) |  |
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_MechanicalWeldingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
