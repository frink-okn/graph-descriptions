...
# Class: TODO -- what's a good name for this class (type)? (sudokn_ShellMoldCastingCapability)
...
URI: [sudokn:ShellMoldCastingCapability](http://asu.edu/semantics/SUDOKN/ShellMoldCastingCapability)
...
```mermaid
 classDiagram
    class SudoknShellMoldCastingCapability
    click SudoknShellMoldCastingCapability href "../SudoknShellMoldCastingCapability"
      SudoknShellMoldCastingCapability : rdfs_label
        
          
    
    
    SudoknShellMoldCastingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknShellMoldCastingCapability](../classes/SudoknShellMoldCastingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknShellMoldCastingCapability](../classes/SudoknShellMoldCastingCapability.md) |
...
| Value |
| --- |
| sudokn:EAGLEALLOY-ShellMoldCastingCapability-inst |
...
| ---  | ---  |
| self | sudokn:ShellMoldCastingCapability |
| native | sudokn-kg/:SudoknShellMoldCastingCapability |
...
<details>
```yaml
name: sudokn_ShellMoldCastingCapability
...
examples:
- value: sudokn:EAGLEALLOY-ShellMoldCastingCapability-inst
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:ShellMoldCastingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ShellMoldCastingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
