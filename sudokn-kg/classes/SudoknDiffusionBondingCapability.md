...
# Class: No class (type) name specified (sudokn_DiffusionBondingCapability)
...
URI: [sudokn:DiffusionBondingCapability](http://asu.edu/semantics/SUDOKN/DiffusionBondingCapability)
...
```mermaid
 classDiagram
    class SudoknDiffusionBondingCapability
    click SudoknDiffusionBondingCapability href "../SudoknDiffusionBondingCapability"
      ...
      SudoknDiffusionBondingCapability : rdfs_label
        
          
    
    
    SudoknDiffusionBondingCapability --> "0..1" String : rdfs_label
...
```yaml
name: sudokn_DiffusionBondingCapability
...
class_uri: sudokn:DiffusionBondingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_DiffusionBondingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
    - owl_NamedIndividual
