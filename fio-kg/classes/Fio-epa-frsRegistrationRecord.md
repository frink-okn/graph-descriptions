...
```mermaid
 classDiagram
    ...
    click Fio-epa-frsRegistrationRecord href "../Fio-epa-frsRegistrationRecord"
      ...
      Fio-epa-frsRegistrationRecord : dc_identifier
        
          
    
    
    Fio-epa-frsRegistrationRecord --> "0..1" Any : dc_identifier
    click Any href "../Any"
