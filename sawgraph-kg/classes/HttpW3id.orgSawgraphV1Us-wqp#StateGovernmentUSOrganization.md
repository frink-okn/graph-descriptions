...
# Class: HttpW3id.orgSawgraphV1Us-wqp#StateGovernmentUSOrganization
...
URI: [http://w3id.org/sawgraph/v1/us-wqp#StateGovernmentUS_Organization](http://w3id.org/sawgraph/v1/us-wqp#StateGovernmentUS_Organization)
...
```mermaid
 classDiagram
    class HttpW3id.orgSawgraphV1Us-wqp#StateGovernmentUSOrganization
    click HttpW3id.orgSawgraphV1Us-wqp#StateGovernmentUSOrganization href "../HttpW3id.orgSawgraphV1Us-wqp#StateGovernmentUSOrganization"
      HttpW3id.orgSawgraphV1Us-wqp#StateGovernmentUSOrganization : http___w3id.org_sawgraph_v1_us_wqp#organizationDescription
        
          
    
    
    HttpW3id.orgSawgraphV1Us-wqp#StateGovernmentUSOrganization --> "0..1" Uri : http___w3id.org_sawgraph_v1_us_wqp#organizationDescription
    click Uri href "../Uri"

        
      HttpW3id.orgSawgraphV1Us-wqp#StateGovernmentUSOrganization : http___w3id.org_sawgraph_v1_us_wqp#organizationId
        
          
    
    
    HttpW3id.orgSawgraphV1Us-wqp#StateGovernmentUSOrganization --> "0..1" String : http___w3id.org_sawgraph_v1_us_wqp#organizationId
    click String href "../String"

        
      HttpW3id.orgSawgraphV1Us-wqp#StateGovernmentUSOrganization : rdfs_label
        
          
    
    
    HttpW3id.orgSawgraphV1Us-wqp#StateGovernmentUSOrganization --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- | --- |
| [http___w3id.org_sawgraph_v1_us_wqp#organizationId](../slots/http___w3id.org_sawgraph_v1_us_wqp#organizationId.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string) |  <br/>  | direct | 5 |
...
| [http___w3id.org_sawgraph_v1_us_wqp#organizationDescription](../slots/http___w3id.org_sawgraph_v1_us_wqp#organizationDescription.md) | 0..1 <br/> [xsd:anyURI](http://www.w3.org/2001/XMLSchema#anyURI) |  <br/>  | direct | 5 |
...
```yaml
name: http___w3id.org_sawgraph_v1_us-wqp#StateGovernmentUS_Organization
from_schema: okns:sawgraph-kg
rank: 1000
slots:
- http___w3id.org_sawgraph_v1_us-wqp#organizationId
- rdfs_label
- http___w3id.org_sawgraph_v1_us-wqp#organizationDescription
class_uri: http://w3id.org/sawgraph/v1/us-wqp#StateGovernmentUS_Organization
...
attributes:
  http___w3id.org_sawgraph_v1_us-wqp#organizationId:
    name: http___w3id.org_sawgraph_v1_us-wqp#organizationId
    from_schema: okns:sawgraph-kg
    rank: 1000
    slot_uri: http://w3id.org/sawgraph/v1/us-wqp#organizationId
    alias: http___w3id.org_sawgraph_v1_us_wqp#organizationId
    owner: http___w3id.org_sawgraph_v1_us-wqp#StateGovernmentUS_Organization
    domain_of:
  ...
  rdfs_label:
    ...
    - range: string
  http___w3id.org_sawgraph_v1_us-wqp#organizationDescription:
    name: http___w3id.org_sawgraph_v1_us-wqp#organizationDescription
    from_schema: okns:sawgraph-kg
    rank: 1000
    slot_uri: http://w3id.org/sawgraph/v1/us-wqp#organizationDescription
    alias: http___w3id.org_sawgraph_v1_us_wqp#organizationDescription
    owner: http___w3id.org_sawgraph_v1_us-wqp#StateGovernmentUS_Organization
    domain_of:
    - http___w3id.org_sawgraph_v1_us-wqp#Federal_USGovernment_Organization
    - http___w3id.org_sawgraph_v1_us-wqp#StateGovernmentUS_Organization
