...
# Class: HttpsIdir.uta.eduSockg-ontology#Irrigation
...
URI: [https://idir.uta.edu/sockg-ontology#Irrigation](https://idir.uta.edu/sockg-ontology#Irrigation)
...
```mermaid
 classDiagram
    ...
    click HttpsIdir.uta.eduSockg-ontology#Irrigation href "../HttpsIdir.uta.eduSockg-ontology#Irrigation"
      HttpsIdir.uta.eduSockg-ontology#Irrigation : rdfs_label
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#Irrigation --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
slots:
- rdfs_label
class_uri: https://idir.uta.edu/sockg-ontology#Irrigation
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: https___idir.uta.edu_sockg-ontology#Irrigation
    domain_of:
    - qudt_AspectClass
    - qudt_BinaryPrefix
