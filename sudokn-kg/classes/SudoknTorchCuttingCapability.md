...
# Class: No class (entity type) name specified -- this class is noted as a superclass of another class in this graph but has not itself been defined. (sudokn_TorchCuttingCapability)
...
```mermaid
 classDiagram
    ...
    click SudoknTorchCuttingCapability href "../SudoknTorchCuttingCapability"
      ...
      SudoknTorchCuttingCapability : rdfs_label
        
          
    
    
    SudoknTorchCuttingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
        ...
        * [SudoknMachiningCapability](../classes/SudoknMachiningCapability.md)
            * [SudoknThermalSubtractionCapability](../classes/SudoknThermalSubtractionCapability.md)
                * **SudoknTorchCuttingCapability**
                    * [SudoknOxyFuelCutting](../classes/SudoknOxyFuelCutting.md)
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_TorchCuttingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
