...
# Class: TODO -- what's a good name for this class (type)? (sudokn_TeflonProcessingCapability)
...
URI: [sudokn:TeflonProcessingCapability](http://asu.edu/semantics/SUDOKN/TeflonProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknTeflonProcessingCapability
    click SudoknTeflonProcessingCapability href "../SudoknTeflonProcessingCapability"
      SudoknTeflonProcessingCapability : rdfs_label
        
          
    
    
    SudoknTeflonProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknTeflonProcessingCapability](../classes/SudoknTeflonProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknTeflonProcessingCapability](../classes/SudoknTeflonProcessingCapability.md) |
...
| ---  | ---  |
| self | sudokn:TeflonProcessingCapability |
| native | sudokn-kg/:SudoknTeflonProcessingCapability |
...
<details>
```yaml
name: sudokn_TeflonProcessingCapability
...
- if you think the class is perfect.
notes:
- Class with 538 occurences.
examples:
- value: sudokn:3D-CAM-Teflon-inst
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:TeflonProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_TeflonProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
