...
# Class: TODO -- what's a good name for this class (type)? (sudokn_TorchBrazingCapability)
...
URI: [sudokn:TorchBrazingCapability](http://asu.edu/semantics/SUDOKN/TorchBrazingCapability)
...
```mermaid
 classDiagram
    class SudoknTorchBrazingCapability
    click SudoknTorchBrazingCapability href "../SudoknTorchBrazingCapability"
      ...
      SudoknTorchBrazingCapability : rdfs_label
        
          
    
    
    SudoknTorchBrazingCapability --> "0..1" String : rdfs_label
...
| ---  | ---  |
| self | sudokn:TorchBrazingCapability |
| native | sudokn-kg/:SudoknTorchBrazingCapability |
...
<details>
```yaml
name: sudokn_TorchBrazingCapability
...
class_uri: sudokn:TorchBrazingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_TorchBrazingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
