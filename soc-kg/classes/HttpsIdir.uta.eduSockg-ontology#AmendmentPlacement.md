...
# Class: HttpsIdir.uta.eduSockg-ontology#AmendmentPlacement
...
URI: [https://idir.uta.edu/sockg-ontology#AmendmentPlacement](https://idir.uta.edu/sockg-ontology#AmendmentPlacement)
...
```mermaid
 classDiagram
    ...
    click HttpsIdir.uta.eduSockg-ontology#AmendmentPlacement href "../HttpsIdir.uta.eduSockg-ontology#AmendmentPlacement"
      HttpsIdir.uta.eduSockg-ontology#AmendmentPlacement : rdfs_label
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#AmendmentPlacement --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: https___idir.uta.edu_sockg-ontology#AmendmentPlacement
from_schema: okns:soc-kg
rank: 1000
slots:
- rdfs_label
class_uri: https://idir.uta.edu/sockg-ontology#AmendmentPlacement
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: https___idir.uta.edu_sockg-ontology#AmendmentPlacement
    domain_of:
