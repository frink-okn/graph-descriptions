...
# Class: TODO -- what's a good name for this class (type)? (sudokn_ElectroPlatingCapability)
...
URI: [sudokn:ElectroPlatingCapability](http://asu.edu/semantics/SUDOKN/ElectroPlatingCapability)
...
```mermaid
 classDiagram
    class SudoknElectroPlatingCapability
    click SudoknElectroPlatingCapability href "../SudoknElectroPlatingCapability"
      SudoknChemicalCoatingCapability <|-- SudoknElectroPlatingCapability
        click SudoknChemicalCoatingCapability href "../SudoknChemicalCoatingCapability"
      

      SudoknElectroPlatingCapability <|-- SudoknElectrolessNickelPlating
        click SudoknElectrolessNickelPlating href "../SudoknElectrolessNickelPlating"
      
      
      SudoknElectroPlatingCapability : rdfs_label
        
          
    
    
    SudoknElectroPlatingCapability --> "0..1" String : rdfs_label
            ...
            * [SudoknCoatingCapability](../classes/SudoknCoatingCapability.md)
                * [SudoknChemicalCoatingCapability](../classes/SudoknChemicalCoatingCapability.md)
                    * **SudoknElectroPlatingCapability**
                        * [SudoknElectrolessNickelPlating](../classes/SudoknElectrolessNickelPlating.md)
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknElectroPlatingCapability](../classes/SudoknElectroPlatingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknElectroPlatingCapability](../classes/SudoknElectroPlatingCapability.md) |
...
| Value |
| --- |
| sudokn:3DMACH-ElectroPlatingCapability-inst |
...
| ---  | ---  |
| self | sudokn:ElectroPlatingCapability |
| native | sudokn-kg/:SudoknElectroPlatingCapability |
...
<details>
```yaml
name: sudokn_ElectroPlatingCapability
...
- if you think the class is perfect.
notes:
- Class with 1339 occurences.
examples:
- value: sudokn:3DMACH-ElectroPlatingCapability-inst
from_schema: sudokn-kg
rank: 1000
is_a: sudokn_ChemicalCoatingCapability
slots:
- rdfs_label
class_uri: sudokn:ElectroPlatingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ElectroPlatingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
