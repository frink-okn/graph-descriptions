...
# Class: HttpsIdir.uta.eduSockg-ontology#LossesOrDeposition
...
URI: [https://idir.uta.edu/sockg-ontology#LossesOrDeposition](https://idir.uta.edu/sockg-ontology#LossesOrDeposition)
...
```mermaid
 classDiagram
    ...
    click HttpsIdir.uta.eduSockg-ontology#LossesOrDeposition href "../HttpsIdir.uta.eduSockg-ontology#LossesOrDeposition"
      HttpsIdir.uta.eduSockg-ontology#LossesOrDeposition : rdfs_label
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#LossesOrDeposition --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- |
| [HttpsIdir.uta.eduSockg-ontology#WaterQualityArea](../classes/HttpsIdir.uta.eduSockg-ontology#WaterQualityArea.md) | [https___idir.uta.edu_sockg_ontology#hasLossesOrDeposition](../slots/https___idir.uta.edu_sockg_ontology#hasLossesOrDeposition.md) | range | [HttpsIdir.uta.eduSockg-ontology#LossesOrDeposition](../classes/HttpsIdir.uta.eduSockg-ontology#LossesOrDeposition.md) |
| [HttpsIdir.uta.eduSockg-ontology#WindErosionArea](../classes/HttpsIdir.uta.eduSockg-ontology#WindErosionArea.md) | [https___idir.uta.edu_sockg_ontology#hasLossesOrDeposition](../slots/https___idir.uta.edu_sockg_ontology#hasLossesOrDeposition.md) | range | [HttpsIdir.uta.eduSockg-ontology#LossesOrDeposition](../classes/HttpsIdir.uta.eduSockg-ontology#LossesOrDeposition.md) |
...
```yaml
name: https___idir.uta.edu_sockg-ontology#LossesOrDeposition
from_schema: okns:soc-kg
rank: 1000
slots:
- rdfs_label
class_uri: https://idir.uta.edu/sockg-ontology#LossesOrDeposition
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: https___idir.uta.edu_sockg-ontology#LossesOrDeposition
    domain_of:
    - qudt_AspectClass
    - qudt_BinaryPrefix
