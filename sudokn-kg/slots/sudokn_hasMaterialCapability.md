...
# Slot: has material capability (sudokn_hasMaterialCapability)
...
| Value |
| --- |
| sudokn:/Manufacturer_1 sudokn:hasMaterialCapability sudokn:/AluminumProcessingCapability_1 |
| sudokn:/Manufacturer_1 sudokn:hasMaterialCapability sudokn:/StainlessSteelProcessingCapability_1 |
| sudokn:ZTECHPRECISION-company-inst sudokn:hasMaterialCapability sudokn:ZTECHPRECISION-Bronze-inst |
| sudokn:ZTECHPRECISION-company-inst sudokn:hasMaterialCapability sudokn:ZTECHPRECISION-Glass-inst |
| sudokn:ZTECHPRECISION-company-inst sudokn:hasMaterialCapability sudokn:ZTECHPRECISION-Graphite-inst |
| sudokn:ZPI-company-inst sudokn:hasMaterialCapability sudokn:ZPI-Iron-inst |
| sudokn:ZOBER-company-inst sudokn:hasMaterialCapability sudokn:ZOBER-Rubber-inst |
| sudokn:ZTECHPRECISION-company-inst sudokn:hasMaterialCapability sudokn:ZTECHPRECISION-StainlessSteel-inst |
| sudokn:carportsnshedscom sudokn:hasMaterialCapability sudokn:carportsnshedscom-Steel-cap |
| sudokn:Zarges sudokn:hasMaterialCapability sudokn:Zarges-Foam-cap |
| sudokn:Zarges sudokn:hasMaterialCapability sudokn:Zarges-Plastic-cap |
| sudokn:ZOBER-company-inst sudokn:hasMaterialCapability sudokn:ZOBER-Copper-inst |
| sudokn:ZYMACHINING-company-inst sudokn:hasMaterialCapability sudokn:ZYMACHINING-Metal-inst |
| sudokn:applerock sudokn:hasMaterialCapability sudokn:applerock-Wood-cap |
| sudokn:applerock sudokn:hasMaterialCapability sudokn:applerock-Aluminum-cap |
| sudokn:ZOBER-company-inst sudokn:hasMaterialCapability sudokn:ZOBER-Lead-inst |
| sudokn:ZIP-CORVETTE-company-inst sudokn:hasMaterialCapability sudokn:ZIP-CORVETTE-Urethane-inst |
| sudokn:ZURN-company-inst sudokn:hasMaterialCapability sudokn:ZURN-Ceramic-inst |
| sudokn:ZTECHPRECISION-company-inst sudokn:hasMaterialCapability sudokn:ZTECHPRECISION-Delrin-inst |
| sudokn:ZIRCONPLASTICS-company-inst sudokn:hasMaterialCapability sudokn:ZIRCONPLASTICS-Nylon-inst |
| sudokn:ZTECHPRECISION-company-inst sudokn:hasMaterialCapability sudokn:ZTECHPRECISION-Polycarbonate-inst |
| sudokn:ZIMMERMAN-METALS-company-inst sudokn:hasMaterialCapability sudokn:ZIMMERMAN-METALS-Teflon-inst |
| sudokn:ZPI-company-inst sudokn:hasMaterialCapability sudokn:ZPI-Zinc-inst |
| sudokn:ZIONINDUCTION-company-inst sudokn:hasMaterialCapability sudokn:ZIONINDUCTION-AlloySteel-inst |
| sudokn:ZIP-CORVETTE-company-inst sudokn:hasMaterialCapability sudokn:ZIP-CORVETTE-Silicone-inst |
| sudokn:WOVENMETAL-company-inst sudokn:hasMaterialCapability sudokn:WOVENMETAL-SteelAlloy-inst |
| sudokn:applerock sudokn:hasMaterialCapability sudokn:applerock-Composite-cap |
| sudokn:ZIP-CORVETTE-company-inst sudokn:hasMaterialCapability sudokn:ZIP-CORVETTE-Platinum-inst |
| sudokn:ZIPPIA-company-inst sudokn:hasMaterialCapability sudokn:ZIPPIA-Chemicals-inst |
| sudokn:YS-INC-company-inst sudokn:hasMaterialCapability sudokn:YS-INC-Cobalt-inst |
| sudokn:ZTECHPRECISION-company-inst sudokn:hasMaterialCapability sudokn:ZTECHPRECISION-Nickel-inst |
| sudokn:ZTECHPRECISION-company-inst sudokn:hasMaterialCapability sudokn:ZTECHPRECISION-Inconel-inst |
| sudokn:ZALAMACHINE-company-inst sudokn:hasMaterialCapability sudokn:ZALAMACHINE-Titanium-inst |
| sudokn:ZEPHYRENG-company-inst sudokn:hasMaterialCapability sudokn:ZEPHYRENG-Tungsten-inst |
| sudokn:ZTECHPRECISION-company-inst sudokn:hasMaterialCapability sudokn:ZTECHPRECISION-Acetal-inst |
| sudokn:WYOMINGMACHINE-company-inst sudokn:hasMaterialCapability sudokn:WYOMINGMACHINE-Beryllium-inst |
| sudokn:ZTECHPRECISION-company-inst sudokn:hasMaterialCapability sudokn:ZTECHPRECISION-Brass-inst |
| sudokn:ZIPPIA-company-inst sudokn:hasMaterialCapability sudokn:ZIPPIA-Lexan-inst |
| sudokn:XACTEDM-company-inst sudokn:hasMaterialCapability sudokn:XACTEDM-Molybdenum-inst |
| sudokn:ZIPPIA-company-inst sudokn:hasMaterialCapability sudokn:ZIPPIA-Silver-inst |
| sudokn:ZTECHPRECISION-company-inst sudokn:hasMaterialCapability sudokn:ZTECHPRECISION-Carbide-inst |
| sudokn:ZPCI-company-inst sudokn:hasMaterialCapability sudokn:ZPCI-Gold-inst |
| sudokn:ZIP-CORVETTE-company-inst sudokn:hasMaterialCapability sudokn:ZIP-CORVETTE-Tin-inst |
| sudokn:WORTHCO-company-inst sudokn:hasMaterialCapability sudokn:WORTHCO-Chromium-inst |
| sudokn:XACTEDM-company-inst sudokn:hasMaterialCapability sudokn:XACTEDM-Invar-inst |
| sudokn:XACTEDM-company-inst sudokn:hasMaterialCapability sudokn:XACTEDM-Kovar-inst |
| sudokn:ZDMETALPRODUCTS-company-inst sudokn:hasMaterialCapability sudokn:ZDMETALPRODUCTS-Magnesium-inst |
| sudokn:XACTEDM-company-inst sudokn:hasMaterialCapability sudokn:XACTEDM-Tantalum-inst |
| sudokn:WYMAN-GORDON-company-inst sudokn:hasMaterialCapability sudokn:WYMAN-GORDON-Waspaloy-inst |
| sudokn:ZALAMACHINE-company-inst sudokn:hasMaterialCapability sudokn:ZALAMACHINE-Hastelloy-inst |
| sudokn:ZALAMACHINE-company-inst sudokn:hasMaterialCapability sudokn:ZALAMACHINE-ExoticMaterial-inst |
| sudokn:VICKERSENG-company-inst sudokn:hasMaterialCapability sudokn:VICKERSENG-Palladium-inst |
| sudokn:Wire-Bond sudokn:hasMaterialCapability sudokn:Wire-Bond-ZincAlloy-cap |
| sudokn:ZIRCONPLASTICS-company-inst sudokn:hasMaterialCapability sudokn:ZIRCONPLASTICS-Zircon-inst |
| sudokn:XCENTRICMOLD-company-inst sudokn:hasMaterialCapability sudokn:XCENTRICMOLD-SpecialMaterials-inst |
| sudokn:WOIHOUSTON-company-inst sudokn:hasMaterialCapability sudokn:WOIHOUSTON-LowAlloySteel-inst |
| sudokn:ZEPHYRENG-company-inst sudokn:hasMaterialCapability sudokn:ZEPHYRENG-ColdRolledSteel-inst |
| sudokn:ZIPPIA-company-inst sudokn:hasMaterialCapability sudokn:ZIPPIA-Nomex-inst |
| sudokn:XACTEDM-company-inst sudokn:hasMaterialCapability sudokn:XACTEDM-DifficultToMachineMaterials-inst |
| sudokn:THINMETALPARTS-company-inst sudokn:hasMaterialCapability sudokn:THINMETALPARTS-Kapton-inst |
| sudokn:VLINEIND-company-inst sudokn:hasMaterialCapability sudokn:VLINEIND-HighGradeAluminum-inst |
| sudokn:SUPERIOR-IND-company-inst sudokn:hasMaterialCapability sudokn:SUPERIOR-IND-PreciousMaterial-inst |
| sudokn:YAMPAPRECISION-company-inst sudokn:hasMaterialCapability sudokn:YAMPAPRECISION-ExtremelyHardMaterial-inst |
| sudokn:SHAPECORP-company-inst sudokn:hasMaterialCapability sudokn:SHAPECORP-NaturalFiber-inst |
| sudokn:WASHERWERKS-company-inst sudokn:hasMaterialCapability sudokn:WASHERWERKS-PhosBronze-inst |
| sudokn:VOTAW-company-inst sudokn:hasMaterialCapability sudokn:VOTAW-CarbonGraphite-inst |
| sudokn:PREMCorp sudokn:hasMaterialCapability sudokn:PREMCorp-ManMadeFiber-cap |
| sudokn:METALKRAFTPM-company-inst sudokn:hasMaterialCapability sudokn:METALKRAFTPM-PhosphorBronze-inst |
...
| ---  | ---  |
| self | sudokn:hasMaterialCapability |
| native | sudokn-kg/:sudokn_hasMaterialCapability |
