...
# Class: bulge forming capability (sudokn_BulgeFormingCapability)





URI: [sudokn:BulgeFormingCapability](http://asu.edu/semantics/SUDOKN/BulgeFormingCapability)
...
```mermaid
 classDiagram
    class SudoknBulgeFormingCapability
    click SudoknBulgeFormingCapability href "../SudoknBulgeFormingCapability"
      ...
      SudoknBulgeFormingCapability : rdfs_label
        
          
    
    
    SudoknBulgeFormingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject | [SudoknSheetMetalProcessingCapability](../classes/SudoknSheetMetalProcessingCapability.md) |  |
...
```yaml
name: sudokn_BulgeFormingCapability
title: bulge forming capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_SheetMetalProcessingCapability
class_uri: sudokn:BulgeFormingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_BulgeFormingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
