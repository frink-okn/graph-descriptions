...
# Class: fixture design capability (sudokn_FixtureDesignCapability)
...
URI: [sudokn:FixtureDesignCapability](http://asu.edu/semantics/SUDOKN/FixtureDesignCapability)
...
```mermaid
 classDiagram
    class SudoknFixtureDesignCapability
    click SudoknFixtureDesignCapability href "../SudoknFixtureDesignCapability"
      ...
      SudoknFixtureDesignCapability : rdfs_label
        
          
    
    
    SudoknFixtureDesignCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknFixtureDesignCapability](../classes/SudoknFixtureDesignCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknFixtureDesignCapability](../classes/SudoknFixtureDesignCapability.md) |
...
| ---  | ---  |
| self | sudokn:FixtureDesignCapability |
| native | sudokn-kg/:SudoknFixtureDesignCapability |
...
<details>
```yaml
name: sudokn_FixtureDesignCapability
description: No type description provided
title: fixture design capability
todos:
- TODO -- Todos for this class go here
- or you can delete the todos
- if you think the class is perfect.
...
slots:
- rdfs_label
class_uri: sudokn:FixtureDesignCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_FixtureDesignCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
