...
| Value |
| --- |
| sudokn:/Manufacturer_1 sudokn:suppliesToIndustry sudokn:/AerospaceIndustry_1 |
| sudokn:ZPI-company-inst sudokn:suppliesToIndustry sudokn:transportationindustry-inst |
| sudokn:ZIP-CORVETTE-company-inst sudokn:suppliesToIndustry sudokn:automotiveindustry-inst |
| sudokn:ZPI-company-inst sudokn:suppliesToIndustry sudokn:furnitureindustry-inst |
| sudokn:ZYMACHINING-company-inst sudokn:suppliesToIndustry sudokn:constructionindustry-inst |
| sudokn:ZLMACHFAB-company-inst sudokn:suppliesToIndustry sudokn:foodindustry-inst |
| sudokn:ZOBER-company-inst sudokn:suppliesToIndustry sudokn:governmentindustry-inst |
| sudokn:Zarges sudokn:suppliesToIndustry sudokn:Military-Industry |
| sudokn:WYLERINDUSTRIAL-company-inst sudokn:suppliesToIndustry sudokn:utilitiesindustry-inst |
| sudokn:ZYMACHINING-company-inst sudokn:suppliesToIndustry sudokn:miningindustry-inst |
| sudokn:ZIRCONPLASTICS-company-inst sudokn:suppliesToIndustry sudokn:consumergoods-inst |
| sudokn:ZIMMERMAN-METALS-company-inst sudokn:suppliesToIndustry sudokn:healthcareservicesindustry-inst |
| sudokn:ZIPPIA-company-inst sudokn:suppliesToIndustry sudokn:professionalservicesindustry-inst |
| sudokn:ZIRCONPLASTICS-company-inst sudokn:suppliesToIndustry sudokn:sportsandleisureindustry-inst |
| sudokn:Zarges sudokn:suppliesToIndustry sudokn:Communication-Industry |
| sudokn:ZEROLEAK-company-inst sudokn:suppliesToIndustry sudokn:recyclingindustry-inst |
| sudokn:WRICO-NET-company-inst sudokn:suppliesToIndustry sudokn:electronicproductindustry-inst |
| sudokn:ZPI-company-inst sudokn:suppliesToIndustry sudokn:agricultureindustry-inst |
| sudokn:WSJ-company-inst sudokn:suppliesToIndustry sudokn:textilesindustry-inst |
| sudokn:YS-INC-company-inst sudokn:suppliesToIndustry sudokn:chemicalandpetrochemicalindustry-inst |
| sudokn:applerock sudokn:suppliesToIndustry sudokn:HealthCareServices-Industry |
| sudokn:Wysong sudokn:suppliesToIndustry sudokn:IndustrialMachineryandEquipment-Industry |
| sudokn:YHM-company-inst sudokn:suppliesToIndustry sudokn:apparelindustry-inst |
| sudokn:WorthProducts sudokn:suppliesToIndustry sudokn:Aerospace-Industry |
| sudokn:WYOMINGMACHINE-company-inst sudokn:suppliesToIndustry sudokn:machinaryandequipmentindustry-inst |
| sudokn:WONDOOR-company-inst sudokn:suppliesToIndustry sudokn:educationindustry-inst |
| sudokn:XOMETRY-company-inst sudokn:suppliesToIndustry sudokn:electronicautomotiveinudstry-inst |
| sudokn:TEX-FIN-company-inst sudokn:suppliesToIndustry sudokn:warehousingandstorageindustry-inst |
| sudokn:WricoStampingofNC sudokn:suppliesToIndustry sudokn:CommunicationandElectronicPowerUtilities-Industry |
| sudokn:UTILITYMETALS-company-inst sudokn:suppliesToIndustry sudokn:metalproductionindustry-inst |
| sudokn:carportsnshedscom sudokn:suppliesToIndustry sudokn:MetalsProducts-Industry |
| sudokn:WilliamsMachineandTools sudokn:suppliesToIndustry sudokn:ComputersandElectronicProducts-Industry |
| sudokn:SEITechnologies sudokn:suppliesToIndustry sudokn:ElectricVehicles-Industry |
| sudokn:WDLeeandCompany sudokn:suppliesToIndustry sudokn:WaterandSewerUtilities-Industry |
| sudokn:WorthProducts sudokn:suppliesToIndustry sudokn:ConsumerGoods-Industry |
| sudokn:StainlessValveCo sudokn:suppliesToIndustry sudokn:PlasticsandRubberProducts-Industry |
| sudokn:TarRiverIndustrialServices sudokn:suppliesToIndustry sudokn:OffshoreWind-Industry |
| sudokn:WatersManufacturedProducts sudokn:suppliesToIndustry sudokn:RetailTrade-Industry |
| sudokn:VPEI-company-inst sudokn:suppliesToIndustry sudokn:textiles-inst |
| sudokn:Zarges sudokn:suppliesToIndustry sudokn:SportsandLeisure-Industry |
| sudokn:RICHLANDINDUSTRIES-company-inst sudokn:suppliesToIndustry sudokn:retailindustry-inst |
| sudokn:XCHANGER-company-inst sudokn:suppliesToIndustry sudokn:paperindustry-inst |
| sudokn:TRISTATEPLASTICS-company-inst sudokn:suppliesToIndustry sudokn:oilandgasindustry-inst |
| sudokn:RICHLANDINDUSTRIES-company-inst sudokn:suppliesToIndustry sudokn:woodproductmanufacturingindustry-inst |
| sudokn:URETHANESERVICES-company-inst sudokn:suppliesToIndustry sudokn:businessequipmentindustry-inst |
| sudokn:Voigt-AbernathyUniversalMachineDivision sudokn:suppliesToIndustry sudokn:PaperandPaperboardProducts-Industry |
| sudokn:REDWOODPLASTICS-company-inst sudokn:suppliesToIndustry sudokn:plasticandrubberindustry-inst |
| sudokn:TurnerEquipmentCo sudokn:suppliesToIndustry sudokn:EducationalInstitutions-Industry |
| sudokn:SERPAPACKAGING-company-inst sudokn:suppliesToIndustry sudokn:printingandinformationindustry-inst |
| sudokn:SICCODE-company-inst sudokn:suppliesToIndustry sudokn:govermentindustry-inst |
| sudokn:SignandAwningSystems sudokn:suppliesToIndustry sudokn:-Industry |
...
| ---  | ---  |
| self | sudokn:suppliesToIndustry |
| native | sudokn-kg/:sudokn_suppliesToIndustry |
