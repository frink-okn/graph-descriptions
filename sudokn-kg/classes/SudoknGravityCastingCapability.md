...
# Class: gravity casting capability (sudokn_GravityCastingCapability)





URI: [sudokn:GravityCastingCapability](http://asu.edu/semantics/SUDOKN/GravityCastingCapability)
...
```mermaid
 classDiagram
    class SudoknGravityCastingCapability
    click SudoknGravityCastingCapability href "../SudoknGravityCastingCapability"
      ...
      SudoknGravityCastingCapability <|-- SudoknPermanentMoldCastingCapability
        click SudoknPermanentMoldCastingCapability href "../SudoknPermanentMoldCastingCapability"
      
      
      SudoknGravityCastingCapability : rdfs_label
        
          
    
    
    SudoknGravityCastingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
    ...
    * [SudoknManufacturingProcessCapability](../classes/SudoknManufacturingProcessCapability.md)
        * [SudoknCastingCapability](../classes/SudoknCastingCapability.md)
            * **SudoknGravityCastingCapability**
                * [SudoknPermanentMoldCastingCapability](../classes/SudoknPermanentMoldCastingCapability.md)
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject | [SudoknCastingCapability](../classes/SudoknCastingCapability.md) |  |
...
```yaml
name: sudokn_GravityCastingCapability
title: gravity casting capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_CastingCapability
class_uri: sudokn:GravityCastingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_GravityCastingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
