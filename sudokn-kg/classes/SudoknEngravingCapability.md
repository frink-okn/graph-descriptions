...
# Class: engraving capability (sudokn_EngravingCapability)





URI: [sudokn:EngravingCapability](http://asu.edu/semantics/SUDOKN/EngravingCapability)
...
```mermaid
 classDiagram
    class SudoknEngravingCapability
    click SudoknEngravingCapability href "../SudoknEngravingCapability"
      ...
      SudoknEngravingCapability : rdfs_label
        
          
    
    
    SudoknEngravingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
    ...
    * [SudoknManufacturingProcessCapability](../classes/SudoknManufacturingProcessCapability.md)
        * [SudoknMachiningCapability](../classes/SudoknMachiningCapability.md)
            * **SudoknEngravingCapability**
                * [SudoknLaserEngravingCapability](../classes/SudoknLaserEngravingCapability.md)
...
```yaml
name: sudokn_EngravingCapability
title: engraving capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_MachiningCapability
class_uri: sudokn:EngravingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_EngravingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
