...
# Class: HAACP certificate (sudokn_HAACPCertificate)
...
URI: [sudokn:HAACPCertificate](http://asu.edu/semantics/SUDOKN/HAACPCertificate)
...
```mermaid
 classDiagram
    ...
    click SudoknHAACPCertificate href "../SudoknHAACPCertificate"
      ...
      SudoknHAACPCertificate : rdfs_label
        
          
    
    
    SudoknHAACPCertificate --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasCertificate](../slots/sudokn_hasCertificate.md) | any_of[range] | [SudoknHAACPCertificate](../classes/SudoknHAACPCertificate.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasCertificate](../slots/sudokn_hasCertificate.md) | any_of[range] | [SudoknHAACPCertificate](../classes/SudoknHAACPCertificate.md) |
...
| ---  | ---  |
| self | sudokn:HAACPCertificate |
| native | sudokn-kg/:SudoknHAACPCertificate |
...
<details>
```yaml
name: sudokn_HAACPCertificate
description: TODO -- tell the world what this class (type) describes.
title: HAACP certificate
todos:
- TODO -- Todos for this class go here
- or you can delete the todos
- if you think the class is perfect.
...
examples:
- value: sudokn:CMTC-HAACPCertificate
from_schema: sudokn-kg
is_a: sudokn_QualityCertificate
slots:
- rdfs_label
class_uri: sudokn:HAACPCertificate
