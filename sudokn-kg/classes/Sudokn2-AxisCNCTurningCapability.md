...
# Class: TODO -- what's a good name for this class (type)? (sudokn_2-AxisCNCTurningCapability)
...
URI: [sudokn:2-AxisCNCTurningCapability](http://asu.edu/semantics/SUDOKN/2-AxisCNCTurningCapability)
...
```mermaid
 classDiagram
    class Sudokn2-AxisCNCTurningCapability
    click Sudokn2-AxisCNCTurningCapability href "../Sudokn2-AxisCNCTurningCapability"
      Sudokn2-AxisCNCTurningCapability : rdfs_label
        
          
    
    
    Sudokn2-AxisCNCTurningCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [Sudokn2-AxisCNCTurningCapability](../classes/Sudokn2-AxisCNCTurningCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [Sudokn2-AxisCNCTurningCapability](../classes/Sudokn2-AxisCNCTurningCapability.md) |
...
| Value |
| --- |
| sudokn:ComposiMoFabrication-2-AxisCNCTurning |
...
| ---  | ---  |
| self | sudokn:2-AxisCNCTurningCapability |
| native | sudokn-kg/:Sudokn2-AxisCNCTurningCapability |
...
<details>
```yaml
name: sudokn_2-AxisCNCTurningCapability
...
examples:
- value: sudokn:ComposiMoFabrication-2-AxisCNCTurning
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:2-AxisCNCTurningCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_2-AxisCNCTurningCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
