...
# Class: TODO -- what's a good name for this class (type)? (sudokn_PemInsertionCapability)
...
URI: [sudokn:PemInsertionCapability](http://asu.edu/semantics/SUDOKN/PemInsertionCapability)
...
```mermaid
 classDiagram
    class SudoknPemInsertionCapability
    click SudoknPemInsertionCapability href "../SudoknPemInsertionCapability"
      SudoknPemInsertionCapability : rdfs_label
        
          
    
    
    SudoknPemInsertionCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknPemInsertionCapability](../classes/SudoknPemInsertionCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknPemInsertionCapability](../classes/SudoknPemInsertionCapability.md) |
...
| Value |
| --- |
| sudokn:RoyalDevelopmentMetalStamping-PemInsertion |
...
| ---  | ---  |
| self | sudokn:PemInsertionCapability |
| native | sudokn-kg/:SudoknPemInsertionCapability |
...
<details>
```yaml
name: sudokn_PemInsertionCapability
...
examples:
- value: sudokn:RoyalDevelopmentMetalStamping-PemInsertion
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:PemInsertionCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_PemInsertionCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
