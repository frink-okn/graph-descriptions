...
# Class: SudoknLowAlloySteelLeadProcessingCapability





URI: [sudokn:LowAlloySteelLeadProcessingCapability](http://asu.edu/semantics/SUDOKN/LowAlloySteelLeadProcessingCapability)
...
```mermaid
 classDiagram
    ...
    click SudoknLowAlloySteelLeadProcessingCapability href "../SudoknLowAlloySteelLeadProcessingCapability"
      ...
      SudoknLowAlloySteelLeadProcessingCapability : rdfs_label
        
          
    
    
    SudoknLowAlloySteelLeadProcessingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject | [SudoknMetalProcessingCapability](../classes/SudoknMetalProcessingCapability.md), [SudoknSteelProcessingCapability](../classes/SudoknSteelProcessingCapability.md), [SudoknAlloySteelProcessingCapability](../classes/SudoknAlloySteelProcessingCapability.md) |  |
...
```yaml
name: sudokn_LowAlloySteelLeadProcessingCapability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_AlloySteelProcessingCapability
class_uri: sudokn:LowAlloySteelLeadProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_LowAlloySteelLeadProcessingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
