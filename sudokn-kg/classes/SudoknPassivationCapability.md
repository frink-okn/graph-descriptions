...
# Class: TODO -- what's a good name for this class (type)? (sudokn_PassivationCapability)
...
URI: [sudokn:PassivationCapability](http://asu.edu/semantics/SUDOKN/PassivationCapability)
...
```mermaid
 classDiagram
    class SudoknPassivationCapability
    click SudoknPassivationCapability href "../SudoknPassivationCapability"
      SudoknPassivationCapability : rdfs_label
        
          
    
    
    SudoknPassivationCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknPassivationCapability](../classes/SudoknPassivationCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknPassivationCapability](../classes/SudoknPassivationCapability.md) |
...
| Value |
| --- |
| sudokn:AAAPLATING-PassivationCapability-inst |
...
| ---  | ---  |
| self | sudokn:PassivationCapability |
| native | sudokn-kg/:SudoknPassivationCapability |
...
<details>
```yaml
name: sudokn_PassivationCapability
...
- if you think the class is perfect.
notes:
- Class with 280 occurences.
examples:
- value: sudokn:AAAPLATING-PassivationCapability-inst
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:PassivationCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_PassivationCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
