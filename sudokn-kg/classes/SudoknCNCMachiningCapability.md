...
# Class: CNC machining capability (sudokn_CNCMachiningCapability)




This class occurs 1427 times.


URI: [sudokn:CNCMachiningCapability](http://asu.edu/semantics/SUDOKN/CNCMachiningCapability)
...
```mermaid
 classDiagram
    class SudoknCNCMachiningCapability
    click SudoknCNCMachiningCapability href "../SudoknCNCMachiningCapability"
      ...
      SudoknCNCMachiningCapability <|-- SudoknCNCRoutingCapability
        click SudoknCNCRoutingCapability href "../SudoknCNCRoutingCapability"
      SudoknCNCMachiningCapability <|-- SudoknFiveAxixMachiningCapability
        click SudoknFiveAxixMachiningCapability href "../SudoknFiveAxixMachiningCapability"
      SudoknCNCMachiningCapability <|-- SudoknSevenAxisMachiningCapability
        click SudoknSevenAxisMachiningCapability href "../SudoknSevenAxisMachiningCapability"
      
      
      SudoknCNCMachiningCapability : rdfs_label
        
          
    
    
    SudoknCNCMachiningCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
    ...
    * [SudoknManufacturingProcessCapability](../classes/SudoknManufacturingProcessCapability.md)
        * [SudoknMachiningCapability](../classes/SudoknMachiningCapability.md)
            * **SudoknCNCMachiningCapability**
                * [SudoknCNCRoutingCapability](../classes/SudoknCNCRoutingCapability.md)
                * [SudoknFiveAxixMachiningCapability](../classes/SudoknFiveAxixMachiningCapability.md)
                * [SudoknSevenAxisMachiningCapability](../classes/SudoknSevenAxisMachiningCapability.md)
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject <br/>  | direct | 1427 |
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCNCMachiningCapability](../classes/SudoknCNCMachiningCapability.md) |
...
```yaml
name: sudokn_CNCMachiningCapability
title: CNC machining capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_MachiningCapability
slots:
- rdfs_label
class_uri: sudokn:CNCMachiningCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_CNCMachiningCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
