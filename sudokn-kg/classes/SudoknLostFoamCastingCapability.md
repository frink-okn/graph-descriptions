...
# Class: lost foam casting capability (sudokn_LostFoamCastingCapability)





URI: [sudokn:LostFoamCastingCapability](http://asu.edu/semantics/SUDOKN/LostFoamCastingCapability)
...
```mermaid
 classDiagram
    class SudoknLostFoamCastingCapability
    click SudoknLostFoamCastingCapability href "../SudoknLostFoamCastingCapability"
      ...
      SudoknLostFoamCastingCapability : rdfs_label
        
          
    
    
    SudoknLostFoamCastingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: sudokn_LostFoamCastingCapability
title: lost foam casting capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_CastingCapability
class_uri: sudokn:LostFoamCastingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_LostFoamCastingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
