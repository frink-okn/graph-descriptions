...
# Class: TODO -- what's a good name for this class (type)? (sudokn_PlasmaCuttingCapability)
...
URI: [sudokn:PlasmaCuttingCapability](http://asu.edu/semantics/SUDOKN/PlasmaCuttingCapability)
...
```mermaid
 classDiagram
    class SudoknPlasmaCuttingCapability
    click SudoknPlasmaCuttingCapability href "../SudoknPlasmaCuttingCapability"
      ...
      SudoknPlasmaCuttingCapability : rdfs_label
        
          
    
    
    SudoknPlasmaCuttingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknPlasmaCuttingCapability](../classes/SudoknPlasmaCuttingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknPlasmaCuttingCapability](../classes/SudoknPlasmaCuttingCapability.md) |
...
| Value |
| --- |
| sudokn:A-M-W-PlasmaCuttingCapability-inst |
...
| ---  | ---  |
| self | sudokn:PlasmaCuttingCapability |
| native | sudokn-kg/:SudoknPlasmaCuttingCapability |
...
<details>
```yaml
name: sudokn_PlasmaCuttingCapability
...
- if you think the class is perfect.
notes:
- Class with 235 occurences.
examples:
- value: sudokn:A-M-W-PlasmaCuttingCapability-inst
from_schema: sudokn-kg
is_a: sudokn_TorchCuttingCapability
slots:
- rdfs_label
class_uri: sudokn:PlasmaCuttingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_PlasmaCuttingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
