...
# Class: TODO -- what's a good name for this class (type)? (sudokn_WoodProductManufacturingIndustry)
...
URI: [sudokn:WoodProductManufacturingIndustry](http://asu.edu/semantics/SUDOKN/WoodProductManufacturingIndustry)
...
```mermaid
 classDiagram
    class SudoknWoodProductManufacturingIndustry
    click SudoknWoodProductManufacturingIndustry href "../SudoknWoodProductManufacturingIndustry"
      SudoknWoodProductManufacturingIndustry : rdfs_label
        
          
    
    
    SudoknWoodProductManufacturingIndustry --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknWoodProductManufacturingIndustry](../classes/SudoknWoodProductManufacturingIndustry.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknWoodProductManufacturingIndustry](../classes/SudoknWoodProductManufacturingIndustry.md) |
...
| Value |
| --- |
| sudokn:woodproductmanufacturingindustry-inst |
...
| ---  | ---  |
| self | sudokn:WoodProductManufacturingIndustry |
| native | sudokn-kg/:SudoknWoodProductManufacturingIndustry |
...
<details>
```yaml
name: sudokn_WoodProductManufacturingIndustry
...
examples:
- value: sudokn:woodproductmanufacturingindustry-inst
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:WoodProductManufacturingIndustry
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_WoodProductManufacturingIndustry
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
