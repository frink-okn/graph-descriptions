...
# Class: TODO -- what's a good name for this class (type)? (sudokn_AssemblyCapability)
...
URI: [sudokn:AssemblyCapability](http://asu.edu/semantics/SUDOKN/AssemblyCapability)
...
```mermaid
 classDiagram
    class SudoknAssemblyCapability
    click SudoknAssemblyCapability href "../SudoknAssemblyCapability"
      SudoknAssemblyCapability : rdfs_label
        
          
    
    
    SudoknAssemblyCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknAssemblyCapability](../classes/SudoknAssemblyCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknAssemblyCapability](../classes/SudoknAssemblyCapability.md) |
...
| Value |
| --- |
| sudokn:1DIETECH-AssemblyCapability-inst |
...
| ---  | ---  |
| self | sudokn:AssemblyCapability |
| native | sudokn-kg/:SudoknAssemblyCapability |
...
<details>
```yaml
name: sudokn_AssemblyCapability
...
- if you think the class is perfect.
notes:
- Class with 2931 occurences.
examples:
- value: sudokn:1DIETECH-AssemblyCapability-inst
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:AssemblyCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_AssemblyCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
