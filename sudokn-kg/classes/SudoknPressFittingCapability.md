...
# Class: press fitting capability (sudokn_PressFittingCapability)





URI: [sudokn:PressFittingCapability](http://asu.edu/semantics/SUDOKN/PressFittingCapability)
...
```mermaid
 classDiagram
    class SudoknPressFittingCapability
    click SudoknPressFittingCapability href "../SudoknPressFittingCapability"
      ...
      SudoknPressFittingCapability <|-- SudoknShrinkFittingCapability
        click SudoknShrinkFittingCapability href "../SudoknShrinkFittingCapability"
      
      
      SudoknPressFittingCapability : rdfs_label
        
          
    
    
    SudoknPressFittingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
        ...
        * [SudoknJoiningCapability](../classes/SudoknJoiningCapability.md)
            * [SudoknMechanicalJoiningCapability](../classes/SudoknMechanicalJoiningCapability.md)
                * **SudoknPressFittingCapability**
                    * [SudoknShrinkFittingCapability](../classes/SudoknShrinkFittingCapability.md)
...
```yaml
name: sudokn_PressFittingCapability
title: press fitting capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_MechanicalJoiningCapability
class_uri: sudokn:PressFittingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_PressFittingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
