...
# Class: TODO -- what's a good name for this class (type)? (sudokn_IATF16949Certificate)
...
URI: [sudokn:IATF16949Certificate](http://asu.edu/semantics/SUDOKN/IATF16949Certificate)
...
```mermaid
 classDiagram
    class SudoknIATF16949Certificate
    click SudoknIATF16949Certificate href "../SudoknIATF16949Certificate"
      SudoknIATF16949Certificate : rdfs_label
        
          
    
    
    SudoknIATF16949Certificate --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasCertificate](../slots/sudokn_hasCertificate.md) | any_of[range] | [SudoknIATF16949Certificate](../classes/SudoknIATF16949Certificate.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasCertificate](../slots/sudokn_hasCertificate.md) | any_of[range] | [SudoknIATF16949Certificate](../classes/SudoknIATF16949Certificate.md) |
...
| Value |
| --- |
| sudokn:1DIETECH-IATF16949Certificate |
...
| ---  | ---  |
| self | sudokn:IATF16949Certificate |
| native | sudokn-kg/:SudoknIATF16949Certificate |
...
<details>
```yaml
name: sudokn_IATF16949Certificate
...
- if you think the class is perfect.
notes:
- Class with 330 occurences.
examples:
- value: sudokn:1DIETECH-IATF16949Certificate
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:IATF16949Certificate
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_IATF16949Certificate
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
