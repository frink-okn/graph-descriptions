...
# Class: TODO -- what's a good name for this class (type)? (sudokn_AdditiveManufacturingCapability)
...
```mermaid
 classDiagram
    ...
    SudoknAdditiveManufacturingCapability --> "0..1" String : rdfs_label
...
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknAdditiveManufacturingCapability](../classes/SudoknAdditiveManufacturingCapability.md) |
...
| Value |
| --- |
| sudokn:3DSYSTEMS-AdditiveManufacturingCapability-inst |
...
| ---  | ---  |
| self | sudokn:AdditiveManufacturingCapability |
| native | sudokn-kg/:SudoknAdditiveManufacturingCapability |
...
- if you think the class is perfect.
notes:
- Class with 209 occurences.
examples:
- value: sudokn:3DSYSTEMS-AdditiveManufacturingCapability-inst
