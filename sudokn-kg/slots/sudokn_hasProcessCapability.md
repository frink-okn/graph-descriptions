...
| Value |
| --- |
| sudokn:/Manufacturer_1 sudokn:hasProcessCapability sudokn:/AssemblyCapability_1 |
| sudokn:/Manufacturer_1 sudokn:hasProcessCapability sudokn:/FinishingCapability_1 |
| sudokn:/Manufacturer_1 sudokn:hasProcessCapability sudokn:/MachiningCapability_1 |
| sudokn:ZTECHPRECISION-company-inst sudokn:hasProcessCapability sudokn:ZTECHPRECISION-CNCMachiningCapability-inst |
| sudokn:ZYMACHINING-company-inst sudokn:hasProcessCapability sudokn:ZYMACHINING-FabricatingCapability-inst |
| sudokn:ZTECHPRECISION-company-inst sudokn:hasProcessCapability sudokn:ZTECHPRECISION-FinishingCapability-inst |
| sudokn:ZYMACHINING-company-inst sudokn:hasProcessCapability sudokn:ZYMACHINING-FormingCapability-inst |
| sudokn:ZYMACHINING-company-inst sudokn:hasProcessCapability sudokn:ZYMACHINING-MachiningCapability-inst |
| sudokn:ZTECHPRECISION-company-inst sudokn:hasProcessCapability sudokn:ZTECHPRECISION-AssemblyCapability-inst |
| sudokn:ZOBER-company-inst sudokn:hasProcessCapability sudokn:ZOBER-DrawingCapability-inst |
| sudokn:ZTECHPRECISION-company-inst sudokn:hasProcessCapability sudokn:ZTECHPRECISION-EDMCapability-inst |
| sudokn:ZPI-company-inst sudokn:hasProcessCapability sudokn:ZPI-LaserCuttingCapability-inst |
| sudokn:ZOBER-company-inst sudokn:hasProcessCapability sudokn:ZOBER-StampingCapability-inst |
| sudokn:ZYMACHINING-company-inst sudokn:hasProcessCapability sudokn:ZYMACHINING-WeldingCapability-inst |
| sudokn:ZTECHPRECISION-company-inst sudokn:hasProcessCapability sudokn:ZTECHPRECISION-WireEDMCapability-inst |
| sudokn:ZPI-company-inst sudokn:hasProcessCapability sudokn:ZPI-BendingCapability-inst |
| sudokn:ZIERDEN-company-inst sudokn:hasProcessCapability sudokn:ZIERDEN-BoringCapability-inst |
| sudokn:ZLMACHFAB-company-inst sudokn:hasProcessCapability sudokn:ZLMACHFAB-CastingCapability-inst |
| sudokn:YAMPAPRECISION-company-inst sudokn:hasProcessCapability sudokn:YAMPAPRECISION-ElectricalDischargeMachiningCapability-inst |
| sudokn:ZTECHPRECISION-company-inst sudokn:hasProcessCapability sudokn:ZTECHPRECISION-MillingCapability-inst |
| sudokn:ZPCI-company-inst sudokn:hasProcessCapability sudokn:ZPCI-PackingCapability-inst |
| sudokn:ZLMACHFAB-company-inst sudokn:hasProcessCapability sudokn:ZLMACHFAB-TubingCapability-inst |
| sudokn:ZORICHIND-company-inst sudokn:hasProcessCapability sudokn:ZORICHIND-WaterjetCuttingCapability-inst |
| sudokn:ZTECHPRECISION-company-inst sudokn:hasProcessCapability sudokn:ZTECHPRECISION-AnodizingCapability-inst |
| sudokn:ZTECHPRECISION-company-inst sudokn:hasProcessCapability sudokn:ZTECHPRECISION-CNCMillingCapability-inst |
| sudokn:ZTECHPRECISION-company-inst sudokn:hasProcessCapability sudokn:ZTECHPRECISION-DrillingCapability-inst |
| sudokn:ZTECHPRECISION-company-inst sudokn:hasProcessCapability sudokn:ZTECHPRECISION-ElectroPlatingCapability-inst |
| sudokn:ZPI-company-inst sudokn:hasProcessCapability sudokn:ZPI-EtchingCapability-inst |
| sudokn:qualityproducts sudokn:hasProcessCapability sudokn:qualityproducts-Grinding |
| sudokn:ZTECHPRECISION-company-inst sudokn:hasProcessCapability sudokn:ZTECHPRECISION-TurningCapability-inst |
| sudokn:XOMETRY-company-inst sudokn:hasProcessCapability sudokn:XOMETRY-AdditiveManufacturingCapability-inst |
| sudokn:YOMURA-company-inst sudokn:hasProcessCapability sudokn:YOMURA-AddtiveManufacturingCapability-inst |
| sudokn:YOMURA-company-inst sudokn:hasProcessCapability sudokn:YOMURA-DieCastingCapability-inst |
| sudokn:ZPI-company-inst sudokn:hasProcessCapability sudokn:ZPI-ExtrudingCapability-inst |
| sudokn:WINNSPEEDLOCK-company-inst sudokn:hasProcessCapability sudokn:WINNSPEEDLOCK-InvestmentCastingCapability-inst |
| sudokn:ZPCI-company-inst sudokn:hasProcessCapability sudokn:ZPCI-ReamingCapability-inst |
| sudokn:YOH-company-inst sudokn:hasProcessCapability sudokn:YOH-ShapingCapability-inst |
| sudokn:USINAGELAURENTIDES-company-inst sudokn:hasProcessCapability sudokn:USINAGELAURENTIDES-SheetMetalProcessingCapability-inst |
| sudokn:XCENTRICMOLD-company-inst sudokn:hasProcessCapability sudokn:XCENTRICMOLD-SinteringCapability-inst |
| sudokn:VEM-TOOLING-company-inst sudokn:hasProcessCapability sudokn:VEM-TOOLING-VacuumCastingCapability-inst |
| sudokn:YOMURA-company-inst sudokn:hasProcessCapability sudokn:YOMURA-RapidPrototypingCapability-inst |
| sudokn:ZLMACHFAB-company-inst sudokn:hasProcessCapability sudokn:ZLMACHFAB-BlackOxideCoatingCapability-inst |
| sudokn:WMIUSA-company-inst sudokn:hasProcessCapability sudokn:WMIUSA-CentrifugalCastingCapability-inst |
| sudokn:WORTHCO-company-inst sudokn:hasProcessCapability sudokn:WORTHCO-EmbossingCapability-inst |
| sudokn:ZPI-company-inst sudokn:hasProcessCapability sudokn:ZPI-GalvanizingCapability-inst |
| sudokn:TRACEAMATIC-company-inst sudokn:hasProcessCapability sudokn:TRACEAMATIC-PermanentMoldCastingCapability-inst |
| sudokn:ZPI-company-inst sudokn:hasProcessCapability sudokn:ZPI-CoatingCapability-inst |
| sudokn:ZPI-company-inst sudokn:hasProcessCapability sudokn:ZPI-PowderCoatingCapability-inst |
| sudokn:YELP-company-inst sudokn:hasProcessCapability sudokn:YELP-SurfacePreparationCapability-inst |
| sudokn:ZOBER-company-inst sudokn:hasProcessCapability sudokn:ZOBER-VerticalMillingCapability-inst |
| sudokn:ZionIndustries sudokn:hasProcessCapability sudokn:ZionIndustries-HeatTreating |
| sudokn:ZLMACHFAB-company-inst sudokn:hasProcessCapability sudokn:ZLMACHFAB-ForgingCapability-inst |
| sudokn:Zarges sudokn:hasProcessCapability sudokn:Zarges-Molding |
| sudokn:ZHT-company-inst sudokn:hasProcessCapability sudokn:ZHT-LiveToolingCapability-inst |
| sudokn:WSJ-company-inst sudokn:hasProcessCapability sudokn:WSJ-NotchingCapability-inst |
| sudokn:ZIP-CUT-company-inst sudokn:hasProcessCapability sudokn:ZIP-CUT-RollingCapability-inst |
| sudokn:WI-ENGRAVING-company-inst sudokn:hasProcessCapability sudokn:WI-ENGRAVING-LaserEtchingCapability-inst |
| sudokn:qualityproducts sudokn:hasProcessCapability sudokn:qualityproducts-Fabrication |
| sudokn:ZORICHIND-company-inst sudokn:hasProcessCapability sudokn:ZORICHIND-PlasmaCuttingCapability-inst |
| sudokn:WYMOREINC-company-inst sudokn:hasProcessCapability sudokn:WYMOREINC-SandBlastingCapability-inst |
| sudokn:ZEROTOLMFG-company-inst sudokn:hasProcessCapability sudokn:ZEROTOLMFG-HoningCapability-inst |
| sudokn:ZTECHPRECISION-company-inst sudokn:hasProcessCapability sudokn:ZTECHPRECISION-SinkerEDMCapability-inst |
| sudokn:ZOBER-company-inst sudokn:hasProcessCapability sudokn:ZOBER-TappingCapability-inst |
| sudokn:ZPI-company-inst sudokn:hasProcessCapability sudokn:ZPI-PolishingCapability-inst |
| sudokn:XCENTRICMOLD-company-inst sudokn:hasProcessCapability sudokn:XCENTRICMOLD-KnurlingCapability-inst |
| sudokn:TURNER-INDUSTRIES-company-inst sudokn:hasProcessCapability sudokn:TURNER-INDUSTRIES-AbrasiveCleaningCapability-inst |
| sudokn:ZEROTOLMFG-company-inst sudokn:hasProcessCapability sudokn:ZEROTOLMFG-ChemicalProcessingCapability-inst |
| sudokn:WSOULE-company-inst sudokn:hasProcessCapability sudokn:WSOULE-JoiningCapability-inst |
| sudokn:WSOULE-company-inst sudokn:hasProcessCapability sudokn:WSOULE-PassivationCapability-inst |
| sudokn:WEST-TECH-company-inst sudokn:hasProcessCapability sudokn:WEST-TECH-SurfaceFinishingCapability-inst |
| sudokn:YOUNGBERGINDUSTRIES-company-inst sudokn:hasProcessCapability sudokn:YOUNGBERGINDUSTRIES-HorizontalMillingCapability-inst |
| sudokn:XACTEDM-company-inst sudokn:hasProcessCapability sudokn:XACTEDM-PolycrystallineDiamondMachiningCapability-inst |
| sudokn:ZIONINDUCTION-company-inst sudokn:hasProcessCapability sudokn:ZIONINDUCTION-BrazingCapability-inst |
| sudokn:WZTOOL-company-inst sudokn:hasProcessCapability sudokn:WZTOOL-RamEDMCapability-inst |
| sudokn:ZIONINDUCTION-company-inst sudokn:hasProcessCapability sudokn:ZIONINDUCTION-HardeningCapability-inst |
| sudokn:XLIONLINE-company-inst sudokn:hasProcessCapability sudokn:XLIONLINE-DeepHoleDrillingCapability-inst |
| sudokn:WYATTSERVICES-company-inst sudokn:hasProcessCapability sudokn:WYATTSERVICES-AnnealingCapability-inst |
| sudokn:ZOBER-company-inst sudokn:hasProcessCapability sudokn:ZOBER-SolderingCapability-inst |
| sudokn:ZTECHPRECISION-company-inst sudokn:hasProcessCapability sudokn:ZTECHPRECISION-DeburringCapability-inst |
| sudokn:WYATTSERVICES-company-inst sudokn:hasProcessCapability sudokn:WYATTSERVICES-CarburizingCapability-inst |
| sudokn:WALTZBROS-company-inst sudokn:hasProcessCapability sudokn:WALTZBROS-CreepFeedGrindingCapability-inst |
| sudokn:WINONAPOWDER-company-inst sudokn:hasProcessCapability sudokn:WINONAPOWDER-ChromateConversionCoatingCapability-inst |
| sudokn:TCICOATINGS-company-inst sudokn:hasProcessCapability sudokn:TCICOATINGS-PhysicalVaporDepositionCapability-inst |
| sudokn:WOLVERINEPLATING-company-inst sudokn:hasProcessCapability sudokn:WOLVERINEPLATING-ElectrolessNickelPlatingCapability-inst |
| sudokn:WYATTSERVICES-company-inst sudokn:hasProcessCapability sudokn:WYATTSERVICES-NitridingCapability-inst |
| sudokn:VOLLRATHMANUFACTURING-company-inst sudokn:hasProcessCapability sudokn:VOLLRATHMANUFACTURING-SpinningCapability-inst |
| sudokn:WORLD-WIDE-MFG-company-inst sudokn:hasProcessCapability sudokn:WORLD-WIDE-MFG-ElectropolishingCapability-inst |
| sudokn:TTQUALITY-company-inst sudokn:hasProcessCapability sudokn:TTQUALITY-WireHarnessAssemblyCapability-inst |
| sudokn:TTH-company-inst sudokn:hasProcessCapability sudokn:TTH-VaporizedMetalCoatingCapability-inst |
| sudokn:WELDALLMFG-company-inst sudokn:hasProcessCapability sudokn:WELDALLMFG-Oxy-FuelCuttingCapability-inst |
| sudokn:ALCOMETALFABRICATORS sudokn:hasProcessCapability sudokn:ALCOMETALFABRICATORS-LaserProcessing |
| sudokn:VALCOPRECISION-company-inst sudokn:hasProcessCapability sudokn:VALCOPRECISION-PlaningCapability-inst |
| sudokn:APSMATERIALS-company-inst sudokn:hasProcessCapability sudokn:APSMATERIALS-PlasmaSprayingCapability-inst |
| sudokn:WELDALLMFG-company-inst sudokn:hasProcessCapability sudokn:WELDALLMFG-CuttingCapability-inst |
| sudokn:STC-SMC-company-inst sudokn:hasProcessCapability sudokn:STC-SMC-FlameSprayingCapability-inst |
| sudokn:WirtzWireEDM sudokn:hasProcessCapability sudokn:WirtzWireEDM-CNCTurning |
| sudokn:STADCO-company-inst sudokn:hasProcessCapability sudokn:STADCO-ElectronBeamWeldingCapability-inst |
| sudokn:Accu-Fab sudokn:hasProcessCapability sudokn:Accu-Fab-ScreenPrinting |
| sudokn:Accu-Fab sudokn:hasProcessCapability sudokn:Accu-Fab-WetPainting |
| sudokn:applerock sudokn:hasProcessCapability sudokn:applerock-EngineeringDesign |
| sudokn:AlliedMetalFinishing sudokn:hasProcessCapability sudokn:AlliedMetalFinishing-ElectolessNickelPlating |
| sudokn:AlliedMetalFinishing sudokn:hasProcessCapability sudokn:AlliedMetalFinishing-NickelPlating |
| sudokn:Forma-FabMetals sudokn:hasProcessCapability sudokn:Forma-FabMetals-Plating |
| sudokn:VoxelInnovations sudokn:hasProcessCapability sudokn:VoxelInnovations-DieMaking |
| sudokn:VoxelInnovations sudokn:hasProcessCapability sudokn:VoxelInnovations-MoldMaking |
| sudokn:RoyalDevelopmentMetalStamping sudokn:hasProcessCapability sudokn:RoyalDevelopmentMetalStamping-Riveting |
| sudokn:VoxelInnovations sudokn:hasProcessCapability sudokn:VoxelInnovations-ToolMaking |
| sudokn:Alotech sudokn:hasProcessCapability sudokn:Alotech-PLCProgramming |
| sudokn:Aludisc sudokn:hasProcessCapability sudokn:Aludisc-ContinuousCasting |
| sudokn:USADutch sudokn:hasProcessCapability sudokn:USADutch-Punching |
| sudokn:Aludisc sudokn:hasProcessCapability sudokn:Aludisc-Smelting |
| sudokn:AmericanMetalTreating sudokn:hasProcessCapability sudokn:AmericanMetalTreating-DeepFreezing |
| sudokn:AmericanMetalTreating sudokn:hasProcessCapability sudokn:AmericanMetalTreating-VacuumHardening |
| sudokn:TobeManufacturing sudokn:hasProcessCapability sudokn:TobeManufacturing-Shearing |
| sudokn:B+EManufacturingCo sudokn:hasProcessCapability sudokn:B+EManufacturingCo-Prototyping |
| sudokn:THERMA-company-inst sudokn:hasProcessCapability sudokn:THERMA-WoodWorkingCapability-inst |
| sudokn:WEISSIND-company-inst sudokn:hasProcessCapability sudokn:WEISSIND-CarbonitridingCapability-inst |
| sudokn:TWINCOMFG-company-inst sudokn:hasProcessCapability sudokn:TWINCOMFG-ShrinkFittingCapability-inst |
| sudokn:JBSTAMPING-company-inst sudokn:hasProcessCapability sudokn:JBSTAMPING-MechanicalJoiningCapability-inst |
| sudokn:BUSCHPRECISION-company-inst sudokn:hasProcessCapability sudokn:BUSCHPRECISION-OilGroovingCapability-inst |
| sudokn:BarnesMetalCrafters sudokn:hasProcessCapability sudokn:BarnesMetalCrafters-PressBraking |
| sudokn:NanCapVentureOne sudokn:hasProcessCapability sudokn:NanCapVentureOne-RoboticWelding |
| sudokn:Ketchie sudokn:hasProcessCapability sudokn:Ketchie-GearCutting |
| sudokn:TriangleStainless sudokn:hasProcessCapability sudokn:TriangleStainless-MetalFabrication |
| sudokn:CAndHTooling sudokn:hasProcessCapability sudokn:CAndHTooling-CNCmilling |
| sudokn:TruAtlanticManufacturing sudokn:hasProcessCapability sudokn:TruAtlanticManufacturing-SheetMetalFabrication |
| sudokn:CargoControlUSA sudokn:hasProcessCapability sudokn:CargoControlUSA-Printing |
| sudokn:CarolinaPrecisionMachining sudokn:hasProcessCapability sudokn:CarolinaPrecisionMachining-LatheWork |
| sudokn:CarverMachineWorks sudokn:hasProcessCapability sudokn:CarverMachineWorks-MechanicalAssembly |
| sudokn:ClaroLux sudokn:hasProcessCapability sudokn:ClaroLux-BrassBlackening |
| sudokn:ClaroLux sudokn:hasProcessCapability sudokn:ClaroLux-MetalSpinning |
| sudokn:CommonPartsGrouping sudokn:hasProcessCapability sudokn:CommonPartsGrouping-Knitting |
| sudokn:ComposiMoFabrication sudokn:hasProcessCapability sudokn:ComposiMoFabrication-2-AxisCNCTurning |
| sudokn:LlewellynMetalFabricators sudokn:hasProcessCapability sudokn:LlewellynMetalFabricators-TIGWelding |
| sudokn:CovingtonIronWorks sudokn:hasProcessCapability sudokn:CovingtonIronWorks-CNCPlasmaCutting |
| sudokn:WatersBrothersContractors sudokn:hasProcessCapability sudokn:WatersBrothersContractors-Pressing |
| sudokn:DDMManufacturing sudokn:hasProcessCapability sudokn:DDMManufacturing-VacuumForming |
| sudokn:TAMSHELL-company-inst sudokn:hasProcessCapability sudokn:TAMSHELL-SwissMachiningCapability-inst |
| sudokn:DouglasFabricationandMachine sudokn:hasProcessCapability sudokn:DouglasFabricationandMachine-Thermoforming |
| sudokn:INDIMET-company-inst sudokn:hasProcessCapability sudokn:INDIMET-ShellMoldCastingCapability-inst |
| sudokn:K-Industries sudokn:hasProcessCapability sudokn:K-Industries-Installation |
| sudokn:QMFMetalAndElectronicSolutions sudokn:hasProcessCapability sudokn:QMFMetalAndElectronicSolutions-Kitting |
| sudokn:FarrisFabAndMachining sudokn:hasProcessCapability sudokn:FarrisFabAndMachining-CNCPressBrake |
| sudokn:ForgedCustomMetalFabrication sudokn:hasProcessCapability sudokn:ForgedCustomMetalFabrication-SteelManufacturing |
| sudokn:Forma-FabMetals sudokn:hasProcessCapability sudokn:Forma-FabMetals-TurretPunching |
| sudokn:PROTCAST-company-inst sudokn:hasProcessCapability sudokn:PROTCAST-SandCastingCapability-inst |
| sudokn:GaryJYountsMachineCo sudokn:hasProcessCapability sudokn:GaryJYountsMachineCo-CenterlessGrinding |
| sudokn:Zarges sudokn:hasProcessCapability sudokn:Zarges-Painting |
| sudokn:GrowlerManufacturingandEngineering sudokn:hasProcessCapability sudokn:GrowlerManufacturingandEngineering-Wiring |
| sudokn:HARMONYCASTINGS-company-inst sudokn:hasProcessCapability sudokn:HARMONYCASTINGS-PlasterMoldCastingCapability-inst |
| sudokn:HEICOFASTENERS sudokn:hasProcessCapability sudokn:HEICOFASTENERS-Fastening |
| sudokn:ParkerIndustries sudokn:hasProcessCapability sudokn:ParkerIndustries-MetalStamping |
| sudokn:HighlandToolandGauge sudokn:hasProcessCapability sudokn:HighlandToolandGauge-SinkerEdm |
| sudokn:HorizonTool sudokn:hasProcessCapability sudokn:HorizonTool-Filling |
| sudokn:WatersManufacturedProducts sudokn:hasProcessCapability sudokn:WatersManufacturedProducts-Packaging |
| sudokn:IndTool sudokn:hasProcessCapability sudokn:IndTool-CNCCylindricalGrinding |
| sudokn:IndTool sudokn:hasProcessCapability sudokn:IndTool-EndForming |
| sudokn:JKS sudokn:hasProcessCapability sudokn:JKS-DigitalPrinting |
| sudokn:JMCToolAndMachine sudokn:hasProcessCapability sudokn:JMCToolAndMachine-SwissTurning |
| sudokn:K-Industries sudokn:hasProcessCapability sudokn:K-Industries-PipingFabrication |
| sudokn:THELINDGRENGROUP-company-inst sudokn:hasProcessCapability sudokn:THELINDGRENGROUP-HarperizingCapability-inst |
| sudokn:Ketchie sudokn:hasProcessCapability sudokn:Ketchie-Broaching |
| sudokn:WatersBrothersContractors sudokn:hasProcessCapability sudokn:WatersBrothersContractors-WaterJetCutting |
| sudokn:LeonardFabricationandDesign sudokn:hasProcessCapability sudokn:LeonardFabricationandDesign-PrototypeManufacturing |
| sudokn:LiquidProcessSystems sudokn:hasProcessCapability sudokn:LiquidProcessSystems-MIGWeldin |
| sudokn:StratfordFabricating sudokn:hasProcessCapability sudokn:StratfordFabricating-SpotWelding |
| sudokn:StratfordFabricating sudokn:hasProcessCapability sudokn:StratfordFabricating-MIGWelding |
| sudokn:VanWelder sudokn:hasProcessCapability sudokn:VanWelder-CAD |
| sudokn:MODERNALUMINUM-company-inst sudokn:hasProcessCapability sudokn:MODERNALUMINUM-CeramicMoldCastingCapability-inst |
| sudokn:MechanicalSpecialty sudokn:hasProcessCapability sudokn:MechanicalSpecialty-CNCBending |
| sudokn:MechanicalSpecialty sudokn:hasProcessCapability sudokn:MechanicalSpecialty-WaterjetCuttimg |
| sudokn:MetalMasters sudokn:hasProcessCapability sudokn:MetalMasters-LiquidCoating |
| sudokn:PNCONLINE-company-inst sudokn:hasProcessCapability sudokn:PNCONLINE-VacuumPackagingCapability-inst |
| sudokn:OXWELL-company-inst sudokn:hasProcessCapability sudokn:OXWELL-ChemicalCoatingCapability-inst |
| sudokn:PREMCorp sudokn:hasProcessCapability sudokn:PREMCorp-CNCCutting |
| sudokn:PREMCorp sudokn:hasProcessCapability sudokn:PREMCorp-Sewing |
| sudokn:TriangleStainless sudokn:hasProcessCapability sudokn:TriangleStainless-SheetMetalForming |
| sudokn:PerformanceMachineAndFab sudokn:hasProcessCapability sudokn:PerformanceMachineAndFab-CNCForming |
| sudokn:PerformanceMachineAndFab sudokn:hasProcessCapability sudokn:PerformanceMachineAndFab-ProductDesign |
| sudokn:PrecisionSteelWorks sudokn:hasProcessCapability sudokn:PrecisionSteelWorks-Rivetting |
| sudokn:QMFMetalAndElectronicSolutions sudokn:hasProcessCapability sudokn:QMFMetalAndElectronicSolutions-SilkScreening |
| sudokn:RedTailGroup sudokn:hasProcessCapability sudokn:RedTailGroup-CNCWireBending |
| sudokn:SPRINGWORKSUTAH-company-inst sudokn:hasProcessCapability sudokn:SPRINGWORKSUTAH-WireBendingCapability-inst |
| sudokn:RedTailGroup sudokn:hasProcessCapability sudokn:RedTailGroup-WireForming |
| sudokn:WDLeeandCompany sudokn:hasProcessCapability sudokn:WDLeeandCompany-ReverseEngineering |
| sudokn:RoebuckPrecisionMachine sudokn:hasProcessCapability sudokn:RoebuckPrecisionMachine-FixtureDesign |
| sudokn:RoyalDevelopmentMetalStamping sudokn:hasProcessCapability sudokn:RoyalDevelopmentMetalStamping-Fixturing |
| sudokn:RoyalDevelopmentMetalStamping sudokn:hasProcessCapability sudokn:RoyalDevelopmentMetalStamping-PemInsertion |
| sudokn:SEITechnologies sudokn:hasProcessCapability sudokn:SEITechnologies-CNCGrinding |
| sudokn:SignandAwningSystems sudokn:hasProcessCapability sudokn:SignandAwningSystems-Extrusion |
| sudokn:SinnovaTek sudokn:hasProcessCapability sudokn:SinnovaTek-SanitaryWelding |
| sudokn:SurryLogistix sudokn:hasProcessCapability sudokn:SurryLogistix-CNCHorizontalTurning |
| sudokn:SurryLogistix sudokn:hasProcessCapability sudokn:SurryLogistix-CNCLaserCutting |
| sudokn:SurryLogistix sudokn:hasProcessCapability sudokn:SurryLogistix-CNCVerticalMilling |
| sudokn:WintervilleMachineWorks sudokn:hasProcessCapability sudokn:WintervilleMachineWorks-Electroplating |
| sudokn:Tampco sudokn:hasProcessCapability sudokn:Tampco-TubeBending |
| sudokn:TarheelPowderCoating sudokn:hasProcessCapability sudokn:TarheelPowderCoating-MediaBlasting |
| sudokn:Technibilt sudokn:hasProcessCapability sudokn:Technibilt-MigWelding |
| sudokn:Technibilt sudokn:hasProcessCapability sudokn:Technibilt-ResistanceWelding |
| sudokn:TheCouncilToolCompany sudokn:hasProcessCapability sudokn:TheCouncilToolCompany-InductionHeating |
| sudokn:ThermalMetaltreating sudokn:hasProcessCapability sudokn:ThermalMetaltreating-PhosphateCoating |
| sudokn:TriangleCoatings sudokn:hasProcessCapability sudokn:TriangleCoatings-CerakoteCoating |
| sudokn:TubeSpecialtiesCo sudokn:hasProcessCapability sudokn:TubeSpecialtiesCo-TubeForming |
| sudokn:Voigt-AbernathyUniversalMachineDivision sudokn:hasProcessCapability sudokn:Voigt-AbernathyUniversalMachineDivision-SurfaceGrinding |
| sudokn:Voigt-AbernathyUniversalMachineDivision sudokn:hasProcessCapability sudokn:Voigt-AbernathyUniversalMachineDivision-CylindricalGrinding |
| sudokn:VoxelInnovations sudokn:hasProcessCapability sudokn:VoxelInnovations-PulsedElectrochemicalMachining |
| sudokn:WDLeeandCompany sudokn:hasProcessCapability sudokn:WDLeeandCompany-CNCLathe |
| sudokn:WatersBrothersContractors sudokn:hasProcessCapability sudokn:WatersBrothersContractors-FiberOpticLaserCutting |
| sudokn:WeathersMfg sudokn:hasProcessCapability sudokn:WeathersMfg-ZincArcSpray |
| sudokn:WestSideIndustries sudokn:hasProcessCapability sudokn:WestSideIndustries-PlasticMachining |
| sudokn:WilliamsMachineandTools sudokn:hasProcessCapability sudokn:WilliamsMachineandTools-MachineBuilding |
| sudokn:WilliamsPlatingCompany sudokn:hasProcessCapability sudokn:WilliamsPlatingCompany-ChemicalCleaning |
| sudokn:WilliamsPlatingCompany sudokn:hasProcessCapability sudokn:WilliamsPlatingCompany-ElectrolessPlating |
| sudokn:Wire-Bond sudokn:hasProcessCapability sudokn:Wire-Bond-HotDipGalvanizing |
| sudokn:WirtzWireEDM sudokn:hasProcessCapability sudokn:WirtzWireEDM-LaserWelding |
| sudokn:WirtzWireEDM sudokn:hasProcessCapability sudokn:WirtzWireEDM-RAMEdm |
| sudokn:Zarges sudokn:hasProcessCapability sudokn:Zarges-CustomFoamCutting |
| sudokn:applerock sudokn:hasProcessCapability sudokn:applerock-3DPrinting |
| sudokn:applerock sudokn:hasProcessCapability sudokn:applerock-AcrylicFabrication |
| sudokn:applerock sudokn:hasProcessCapability sudokn:applerock-Metalworking |
| sudokn:applerock sudokn:hasProcessCapability sudokn:applerock-Woodworking |
...
| ---  | ---  |
| self | sudokn:hasProcessCapability |
| native | sudokn-kg/:sudokn_hasProcessCapability |
...
- value: sudokn:VOLLRATHMANUFACTURING-company-inst sudokn:hasProcessCapability sudokn:VOLLRATHMANUFACTURING-SpinningCapability-inst
...
- value: sudokn:GrowlerManufacturingandEngineering sudokn:hasProcessCapability sudokn:GrowlerManufacturingandEngineering-Wiring
