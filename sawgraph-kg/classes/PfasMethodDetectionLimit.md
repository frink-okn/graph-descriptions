...
# Class: TODO -- what's a good name for this class (type)? (pfas_MethodDetectionLimit)
...
URI: [pfas:MethodDetectionLimit](http://sawgraph.spatialai.org/v1/pfas#MethodDetectionLimit)
...
```mermaid
 classDiagram
    class PfasMethodDetectionLimit
    click PfasMethodDetectionLimit href "../PfasMethodDetectionLimit"
      ...
      PfasMethodDetectionLimit : contaminoso_resultAnnotation
        
          
    
    
    PfasMethodDetectionLimit --> "0..1" Any : contaminoso_resultAnnotation
    click Any href "../Any"

        
      PfasMethodDetectionLimit : meegad_methodDetectionLimit
        
          
    
    
    PfasMethodDetectionLimit --> "0..1" ContaminosoResultQualifier : meegad_methodDetectionLimit
    click ContaminosoResultQualifier href "../ContaminosoResultQualifier"

        
      PfasMethodDetectionLimit : meegad_parameterGroup
        
          
    
    
    PfasMethodDetectionLimit --> "0..1" String : meegad_parameterGroup
    click String href "../String"

        
      PfasMethodDetectionLimit : meegad_reportingLimit
        
          
    
    
    PfasMethodDetectionLimit --> "0..1" ContaminosoResultQualifier : meegad_reportingLimit
    click ContaminosoResultQualifier href "../ContaminosoResultQualifier"

        
      PfasMethodDetectionLimit : qudt_numericValue
        
          
    
    
    PfasMethodDetectionLimit --> "0..1" Any : qudt_numericValue
    click Any href "../Any"

        
      PfasMethodDetectionLimit : rdfs_label
        
          
    
    
    PfasMethodDetectionLimit --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | ---  |
| self | pfas:MethodDetectionLimit |
| native | sawgraph-kg/:PfasMethodDetectionLimit |
...
<details>
```yaml
name: pfas_MethodDetectionLimit
...
class_uri: pfas:MethodDetectionLimit
...
attributes:
  meegad_reportingLimit:
    ...
    owner: pfas_MethodDetectionLimit
    domain_of:
