...
# Class: TODO -- what's a good name for this class (type)? (sudokn_PermanentMoldCastingCapability)
...
URI: [sudokn:PermanentMoldCastingCapability](http://asu.edu/semantics/SUDOKN/PermanentMoldCastingCapability)
...
```mermaid
 classDiagram
    class SudoknPermanentMoldCastingCapability
    click SudoknPermanentMoldCastingCapability href "../SudoknPermanentMoldCastingCapability"
      SudoknPermanentMoldCastingCapability : rdfs_label
        
          
    
    
    SudoknPermanentMoldCastingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknPermanentMoldCastingCapability](../classes/SudoknPermanentMoldCastingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknPermanentMoldCastingCapability](../classes/SudoknPermanentMoldCastingCapability.md) |
...
| Value |
| --- |
| sudokn:3ERP-PermanentMoldCastingCapability-inst |
...
| ---  | ---  |
| self | sudokn:PermanentMoldCastingCapability |
| native | sudokn-kg/:SudoknPermanentMoldCastingCapability |
...
<details>
```yaml
name: sudokn_PermanentMoldCastingCapability
...
examples:
- value: sudokn:3ERP-PermanentMoldCastingCapability-inst
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:PermanentMoldCastingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_PermanentMoldCastingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
