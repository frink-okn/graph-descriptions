...
# Class: HttpWww.semanticweb.orgTrashOntologies20255Untitled-ontology-278JournalArticle




This class occurs 149 times.


URI: [http://www.semanticweb.org/trash/ontologies/2025/5/untitled-ontology-278/JournalArticle](http://www.semanticweb.org/trash/ontologies/2025/5/untitled-ontology-278/JournalArticle)
...
```mermaid
 classDiagram
    class HttpWww.semanticweb.orgTrashOntologies20255Untitled-ontology-278JournalArticle
    click HttpWww.semanticweb.orgTrashOntologies20255Untitled-ontology-278JournalArticle href "../HttpWww.semanticweb.orgTrashOntologies20255Untitled-ontology-278JournalArticle"
      HttpWww.semanticweb.orgTrashOntologies20255Untitled-ontology-278JournalArticle : dct_bibliographicCitation
        
          
    
    
    HttpWww.semanticweb.orgTrashOntologies20255Untitled-ontology-278JournalArticle --> "0..1" RdfsLiteral : dct_bibliographicCitation
    click RdfsLiteral href "../RdfsLiteral"

        
      HttpWww.semanticweb.orgTrashOntologies20255Untitled-ontology-278JournalArticle : dct_creator
        
          
    
    
    HttpWww.semanticweb.orgTrashOntologies20255Untitled-ontology-278JournalArticle --> "0..1" Any : dct_creator
    click Any href "../Any"

        
      HttpWww.semanticweb.orgTrashOntologies20255Untitled-ontology-278JournalArticle : dct_description
        
          
    
    
    HttpWww.semanticweb.orgTrashOntologies20255Untitled-ontology-278JournalArticle --> "0..1" String : dct_description
    click String href "../String"

        
      HttpWww.semanticweb.orgTrashOntologies20255Untitled-ontology-278JournalArticle : dct_identifier
        
          
    
    
    HttpWww.semanticweb.orgTrashOntologies20255Untitled-ontology-278JournalArticle --> "0..1" RdfsLiteral : dct_identifier
    click RdfsLiteral href "../RdfsLiteral"

        
      HttpWww.semanticweb.orgTrashOntologies20255Untitled-ontology-278JournalArticle : dct_issued
        
          
    
    
    HttpWww.semanticweb.orgTrashOntologies20255Untitled-ontology-278JournalArticle --> "0..1" Any : dct_issued
    click Any href "../Any"

        
      HttpWww.semanticweb.orgTrashOntologies20255Untitled-ontology-278JournalArticle : dct_title
        
          
    
    
    HttpWww.semanticweb.orgTrashOntologies20255Untitled-ontology-278JournalArticle --> "0..1" Any : dct_title
    click Any href "../Any"

        
      HttpWww.semanticweb.orgTrashOntologies20255Untitled-ontology-278JournalArticle : http___www.semanticweb.org_trash_ontologies_2025_5_untitled_ontology_278_correspondingAuthor
        
          
    
    
    HttpWww.semanticweb.orgTrashOntologies20255Untitled-ontology-278JournalArticle --> "0..1" String : http___www.semanticweb.org_trash_ontologies_2025_5_untitled_ontology_278_correspondingAuthor
    click String href "../String"

        
      HttpWww.semanticweb.orgTrashOntologies20255Untitled-ontology-278JournalArticle : rdfs_label
        
          
    
    
    HttpWww.semanticweb.orgTrashOntologies20255Untitled-ontology-278JournalArticle --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- | --- |
| [dct_bibliographicCitation](../slots/dct_bibliographicCitation.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md) | Recommended practice is to include sufficient bibliographic detail to identif... <br/> description: A bibliographic reference for the resource. | direct | 149 |
| [http___www.semanticweb.org_trash_ontologies_2025_5_untitled_ontology_278_correspondingAuthor](../slots/http___www.semanticweb.org_trash_ontologies_2025_5_untitled_ontology_278_correspondingAuthor.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string) |  <br/>  | direct | 127 |
| [dct_creator](../slots/dct_creator.md) | 0..1 <br/> [Any](../classes/Any.md) | Recommended practice is to identify the creator with a URI <br/> description: An entity responsible for making the resource. | direct | 147 |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject <br/>  | direct | 149 |
| [dct_issued](../slots/dct_issued.md) | 0..1 <br/> [xsd:date](http://www.w3.org/2001/XMLSchema#date)&nbsp;or&nbsp;<br />[RdfsLiteral](../classes/RdfsLiteral.md) | Recommended practice is to describe the date, date/time, or period of time as... <br/> description: Date of formal issuance of the resource. | direct | 149 |
| [dct_title](../slots/dct_title.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string)&nbsp;or&nbsp;<br />[RdfsLiteral](../classes/RdfsLiteral.md) | A name given to the resource <br/>  | direct | 134 |
| [dct_description](../slots/dct_description.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string) | Description may include but is not limited to: an abstract, a table of conten... <br/> description: An account of the resource. | direct | 54 |
| [dct_identifier](../slots/dct_identifier.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md) | Recommended practice is to identify the resource by means of a string conform... <br/> description: An unambiguous reference to the resource within a given context. | direct | 119 |
...
```yaml
name: http___www.semanticweb.org_trash_ontologies_2025_5_untitled-ontology-278_JournalArticle
...
- dct_description
- dct_identifier
class_uri: http://www.semanticweb.org/trash/ontologies/2025/5/untitled-ontology-278/JournalArticle
...
attributes:
  dct_bibliographicCitation:
    ...
    owner: http___www.semanticweb.org_trash_ontologies_2025_5_untitled-ontology-278_JournalArticle
    domain_of:
