...
# Class: TODO -- what's a good name for this class (type)? (sudokn_InvestmentCastingCapability)
...
URI: [sudokn:InvestmentCastingCapability](http://asu.edu/semantics/SUDOKN/InvestmentCastingCapability)
...
```mermaid
 classDiagram
    class SudoknInvestmentCastingCapability
    click SudoknInvestmentCastingCapability href "../SudoknInvestmentCastingCapability"
      SudoknInvestmentCastingCapability : rdfs_label
        
          
    
    
    SudoknInvestmentCastingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknInvestmentCastingCapability](../classes/SudoknInvestmentCastingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknInvestmentCastingCapability](../classes/SudoknInvestmentCastingCapability.md) |
...
| Value |
| --- |
| sudokn:3DSYSTEMS-InvestmentCastingCapability-inst |
...
| ---  | ---  |
| self | sudokn:InvestmentCastingCapability |
| native | sudokn-kg/:SudoknInvestmentCastingCapability |
...
<details>
```yaml
name: sudokn_InvestmentCastingCapability
...
- if you think the class is perfect.
notes:
- Class with 83 occurences.
examples:
- value: sudokn:3DSYSTEMS-InvestmentCastingCapability-inst
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:InvestmentCastingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_InvestmentCastingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
