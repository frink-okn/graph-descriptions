...
# Class: anodizing capability (sudokn_AnodizingCapability)




This class occurs 659 times.


URI: [sudokn:AnodizingCapability](http://asu.edu/semantics/SUDOKN/AnodizingCapability)
...
```mermaid
 classDiagram
    class SudoknAnodizingCapability
    click SudoknAnodizingCapability href "../SudoknAnodizingCapability"
      ...
      SudoknAnodizingCapability : rdfs_label
        
          
    
    
    SudoknAnodizingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject <br/>  | direct | 659 |
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknAnodizingCapability](../classes/SudoknAnodizingCapability.md) |
...
```yaml
name: sudokn_AnodizingCapability
title: anodizing capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_ChemicalCoatingCapability
slots:
- rdfs_label
class_uri: sudokn:AnodizingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_AnodizingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
