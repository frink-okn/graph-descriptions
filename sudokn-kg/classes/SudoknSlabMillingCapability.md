...
# Class: TODO -- what's a good name for this class (type)? (sudokn_SlabMillingCapability)
...
URI: [sudokn:SlabMillingCapability](http://asu.edu/semantics/SUDOKN/SlabMillingCapability)
...
```mermaid
 classDiagram
    class SudoknSlabMillingCapability
    click SudoknSlabMillingCapability href "../SudoknSlabMillingCapability"
      ...
      SudoknSlabMillingCapability : rdfs_label
        
          
    
    
    SudoknSlabMillingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string) | No slot description provided | [SudoknMachiningCapability](../classes/SudoknMachiningCapability.md), [SudoknHorizontalMillingCapability](../classes/SudoknHorizontalMillingCapability.md), [SudoknMillingCapability](../classes/SudoknMillingCapability.md) |
...
| ---  | ---  |
| self | sudokn:SlabMillingCapability |
| native | sudokn-kg/:SudoknSlabMillingCapability |
...
<details>
```yaml
name: sudokn_SlabMillingCapability
...
rank: 1000
is_a: sudokn_HorizontalMillingCapability
class_uri: sudokn:SlabMillingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_SlabMillingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
