...
# Class: milling capability (sudokn_MillingCapability)




This class occurs 2311 times.


URI: [sudokn:MillingCapability](http://asu.edu/semantics/SUDOKN/MillingCapability)
...
```mermaid
 classDiagram
    class SudoknMillingCapability
    click SudoknMillingCapability href "../SudoknMillingCapability"
      SudoknMultiPointCuttingCapability <|-- SudoknMillingCapability
        click SudoknMultiPointCuttingCapability href "../SudoknMultiPointCuttingCapability"
      

      SudoknMillingCapability <|-- SudoknCNCMillingCapability
        click SudoknCNCMillingCapability href "../SudoknCNCMillingCapability"
      SudoknMillingCapability <|-- SudoknGearGashingCapability
        click SudoknGearGashingCapability href "../SudoknGearGashingCapability"
      SudoknMillingCapability <|-- SudoknHorizontalMillingCapability
        click SudoknHorizontalMillingCapability href "../SudoknHorizontalMillingCapability"
      SudoknMillingCapability <|-- SudoknThreadMillingCapability
        click SudoknThreadMillingCapability href "../SudoknThreadMillingCapability"
      SudoknMillingCapability <|-- SudoknVerticalMillingCapability
        click SudoknVerticalMillingCapability href "../SudoknVerticalMillingCapability"
      
      
      SudoknMillingCapability : rdfs_label
        
          
    
    
    SudoknMillingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
        ...
        * [SudoknMachiningCapability](../classes/SudoknMachiningCapability.md)
            * [SudoknMultiPointCuttingCapability](../classes/SudoknMultiPointCuttingCapability.md)
                * **SudoknMillingCapability**
                    * [SudoknCNCMillingCapability](../classes/SudoknCNCMillingCapability.md)
                    * [SudoknGearGashingCapability](../classes/SudoknGearGashingCapability.md)
                    * [SudoknHorizontalMillingCapability](../classes/SudoknHorizontalMillingCapability.md)
                    * [SudoknThreadMillingCapability](../classes/SudoknThreadMillingCapability.md)
                    * [SudoknVerticalMillingCapability](../classes/SudoknVerticalMillingCapability.md)
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject <br/>  | direct | 2311 |
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknMillingCapability](../classes/SudoknMillingCapability.md) |
...
```yaml
name: sudokn_MillingCapability
title: milling capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_MultiPointCuttingCapability
slots:
- rdfs_label
class_uri: sudokn:MillingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_MillingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
