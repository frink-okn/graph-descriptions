...
```mermaid
 classDiagram
    ...
    Node519 --> "0..1" OwlThing : owl_sameAs
    click OwlThing href "../OwlThing"

        
      Node519 : prov_startedAtTime
        
          
    
    
    Node519 --> "0..1" Datetime : prov_startedAtTime
...
| [owl_sameAs](../slots/owl_sameAs.md) | 0..1 <br/> [OwlThing](../classes/OwlThing.md) | The property that determines that two given individuals are equal <br/> No occurrences of this slot in the graph. | direct | 80 |
