...
# Class: forging capability (sudokn_ForgingCapability)
...
URI: [sudokn:ForgingCapability](http://asu.edu/semantics/SUDOKN/ForgingCapability)
...
```mermaid
 classDiagram
    ...
    click SudoknForgingCapability href "../SudoknForgingCapability"
      ...
      SudoknForgingCapability : rdfs_label
        
          
    
    
    SudoknForgingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknForgingCapability](../classes/SudoknForgingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknForgingCapability](../classes/SudoknForgingCapability.md) |
...
| Value |
| --- |
| sudokn:889GLOBALSOLUTIONS-ForgingCapability-inst |
...
| ---  | ---  |
| self | sudokn:ForgingCapability |
| native | sudokn-kg/:SudoknForgingCapability |
...
<details>
```yaml
name: sudokn_ForgingCapability
description: TODO -- tell the world what this class (type) describes.
title: forging capability
todos:
- TODO -- Todos for this class go here
- or you can delete the todos
- if you think the class is perfect.
...
examples:
- value: sudokn:889GLOBALSOLUTIONS-ForgingCapability-inst
from_schema: sudokn-kg
is_a: sudokn_ManufacturingProcessCapability
slots:
- rdfs_label
class_uri: sudokn:ForgingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ForgingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
