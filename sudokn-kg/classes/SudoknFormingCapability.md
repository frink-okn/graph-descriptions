...
# Class: forming capability (sudokn_FormingCapability)




This class occurs 1802 times.


URI: [sudokn:FormingCapability](http://asu.edu/semantics/SUDOKN/FormingCapability)
...
```mermaid
 classDiagram
    ...
    click SudoknFormingCapability href "../SudoknFormingCapability"
      ...
      SudoknFormingCapability <|-- SudoknDrawingCapability
        click SudoknDrawingCapability href "../SudoknDrawingCapability"
      SudoknFormingCapability <|-- SudoknExtrudingCapability
        click SudoknExtrudingCapability href "../SudoknExtrudingCapability"
      SudoknFormingCapability <|-- SudoknKnurlingCapability
        click SudoknKnurlingCapability href "../SudoknKnurlingCapability"
      SudoknFormingCapability <|-- SudoknPowderMetalFormingCapability
        click SudoknPowderMetalFormingCapability href "../SudoknPowderMetalFormingCapability"
      SudoknFormingCapability <|-- SudoknRollDieEngravingCapability
        click SudoknRollDieEngravingCapability href "../SudoknRollDieEngravingCapability"
      SudoknFormingCapability <|-- SudoknRollingCapability
        click SudoknRollingCapability href "../SudoknRollingCapability"
      SudoknFormingCapability <|-- SudoknThermoformingCapability
        click SudoknThermoformingCapability href "../SudoknThermoformingCapability"
      SudoknFormingCapability <|-- SudoknTubingCapability
        click SudoknTubingCapability href "../SudoknTubingCapability"
      
      
      SudoknFormingCapability : rdfs_label
        
          
    
    
    SudoknFormingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
* [IoscProductionCapability](../classes/IoscProductionCapability.md)
    * [SudoknManufacturingProcessCapability](../classes/SudoknManufacturingProcessCapability.md)
        * **SudoknFormingCapability**
            * [SudoknDrawingCapability](../classes/SudoknDrawingCapability.md)
            * [SudoknExtrudingCapability](../classes/SudoknExtrudingCapability.md)
            * [SudoknKnurlingCapability](../classes/SudoknKnurlingCapability.md)
            * [SudoknPowderMetalFormingCapability](../classes/SudoknPowderMetalFormingCapability.md)
            * [SudoknRollDieEngravingCapability](../classes/SudoknRollDieEngravingCapability.md)
            * [SudoknRollingCapability](../classes/SudoknRollingCapability.md)
            * [SudoknThermoformingCapability](../classes/SudoknThermoformingCapability.md)
            * [SudoknTubingCapability](../classes/SudoknTubingCapability.md)
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject <br/>  | direct | 1802 |
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknFormingCapability](../classes/SudoknFormingCapability.md) |
...
```yaml
name: sudokn_FormingCapability
title: forming capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_ManufacturingProcessCapability
slots:
- rdfs_label
class_uri: sudokn:FormingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_FormingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
