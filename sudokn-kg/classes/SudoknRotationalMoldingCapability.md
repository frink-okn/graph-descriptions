...
# Class: rotational molding capability (sudokn_RotationalMoldingCapability)





URI: [sudokn:RotationalMoldingCapability](http://asu.edu/semantics/SUDOKN/RotationalMoldingCapability)
...
```mermaid
 classDiagram
    class SudoknRotationalMoldingCapability
    click SudoknRotationalMoldingCapability href "../SudoknRotationalMoldingCapability"
      ...
      SudoknRotationalMoldingCapability : rdfs_label
        
          
    
    
    SudoknRotationalMoldingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: sudokn_RotationalMoldingCapability
title: rotational molding capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_MoldingCapability
class_uri: sudokn:RotationalMoldingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_RotationalMoldingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
