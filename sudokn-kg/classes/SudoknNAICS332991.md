...
# Class: TODO -- what's a good name for this class (type)? (sudokn_NAICS332991)
...
URI: [sudokn:NAICS332991](http://asu.edu/semantics/SUDOKN/NAICS332991)
...
```mermaid
 classDiagram
    class SudoknNAICS332991
    click SudoknNAICS332991 href "../SudoknNAICS332991"
      SudoknNAICS332991 : sudokn_hasNAICSCodeValue
        
          
    
    
    SudoknNAICS332991 --> "0..1" Any : sudokn_hasNAICSCodeValue
    click Any href "../Any"

        
      SudoknNAICS332991 : sudokn_hasNAICSTextValue
        
          
    
    
    SudoknNAICS332991 --> "0..1" Any : sudokn_hasNAICSTextValue
    click Any href "../Any"
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasPrimaryNAICSClassifier](../slots/sudokn_hasPrimaryNAICSClassifier.md) | any_of[range] | [SudoknNAICS332991](../classes/SudoknNAICS332991.md) |
...
| ---  | ---  |
| self | sudokn:NAICS332991 |
| native | sudokn-kg/:SudoknNAICS332991 |
