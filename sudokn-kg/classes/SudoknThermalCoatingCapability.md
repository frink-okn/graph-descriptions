...
# Class: TODO -- what's a good name for this class (type)? (sudokn_ThermalCoatingCapability)
...
```mermaid
 classDiagram
    ...
    SudoknThermalCoatingCapability --> "0..1" String : rdfs_label
...
| ---  | ---  |
| self | sudokn:ThermalCoatingCapability |
| native | sudokn-kg/:SudoknThermalCoatingCapability |
