...
# Class: TODO -- what's a good name for this class (type)? (sudokn_PaperandPaperboardProductsIndustry)
...
URI: [sudokn:PaperandPaperboardProductsIndustry](http://asu.edu/semantics/SUDOKN/PaperandPaperboardProductsIndustry)
...
```mermaid
 classDiagram
    class SudoknPaperandPaperboardProductsIndustry
    click SudoknPaperandPaperboardProductsIndustry href "../SudoknPaperandPaperboardProductsIndustry"
      SudoknPaperandPaperboardProductsIndustry : rdfs_label
        
          
    
    
    SudoknPaperandPaperboardProductsIndustry --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknPaperandPaperboardProductsIndustry](../classes/SudoknPaperandPaperboardProductsIndustry.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknPaperandPaperboardProductsIndustry](../classes/SudoknPaperandPaperboardProductsIndustry.md) |
...
| ---  | ---  |
| self | sudokn:PaperandPaperboardProductsIndustry |
| native | sudokn-kg/:SudoknPaperandPaperboardProductsIndustry |
...
<details>
```yaml
name: sudokn_PaperandPaperboardProductsIndustry
...
examples:
- value: sudokn:PaperandPaperboardProducts-Industry
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:PaperandPaperboardProductsIndustry
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_PaperandPaperboardProductsIndustry
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
