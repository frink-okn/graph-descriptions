...
# Class: TODO -- what's a good name for this class (type)? (sudokn_BrazeWeldingCapability)
...
| ---  | ---  |
| self | sudokn:BrazeWeldingCapability |
| native | sudokn-kg/:SudoknBrazeWeldingCapability |
