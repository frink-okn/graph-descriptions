...
# Class: electron-beam machining capability (sudokn_ElectronBeamMachiningCapability)





URI: [sudokn:ElectronBeamMachiningCapability](http://asu.edu/semantics/SUDOKN/ElectronBeamMachiningCapability)
...
```mermaid
 classDiagram
    class SudoknElectronBeamMachiningCapability
    click SudoknElectronBeamMachiningCapability href "../SudoknElectronBeamMachiningCapability"
      ...
      SudoknElectronBeamMachiningCapability : rdfs_label
        
          
    
    
    SudoknElectronBeamMachiningCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: sudokn_ElectronBeamMachiningCapability
title: electron-beam machining capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_HighEnergyBeamMachiningCapability
class_uri: sudokn:ElectronBeamMachiningCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ElectronBeamMachiningCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
