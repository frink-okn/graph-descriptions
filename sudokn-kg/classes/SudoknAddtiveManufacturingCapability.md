...
# Class: TODO -- what's a good name for this class (type)? (sudokn_AddtiveManufacturingCapability)
...
URI: [sudokn:AddtiveManufacturingCapability](http://asu.edu/semantics/SUDOKN/AddtiveManufacturingCapability)
...
```mermaid
 classDiagram
    class SudoknAddtiveManufacturingCapability
    click SudoknAddtiveManufacturingCapability href "../SudoknAddtiveManufacturingCapability"
      SudoknAddtiveManufacturingCapability : rdfs_label
        
          
    
    
    SudoknAddtiveManufacturingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknAddtiveManufacturingCapability](../classes/SudoknAddtiveManufacturingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknAddtiveManufacturingCapability](../classes/SudoknAddtiveManufacturingCapability.md) |
...
| Value |
| --- |
| sudokn:3DSYSTEMS-AddtiveManufacturingCapability-inst |
...
| ---  | ---  |
| self | sudokn:AddtiveManufacturingCapability |
| native | sudokn-kg/:SudoknAddtiveManufacturingCapability |
...
<details>
```yaml
name: sudokn_AddtiveManufacturingCapability
...
- if you think the class is perfect.
notes:
- Class with 337 occurences.
examples:
- value: sudokn:3DSYSTEMS-AddtiveManufacturingCapability-inst
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:AddtiveManufacturingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_AddtiveManufacturingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
