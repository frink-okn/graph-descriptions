...
# Class: HttpsIdir.uta.eduSockg-ontology#SpeciesMix
...
URI: [https://idir.uta.edu/sockg-ontology#SpeciesMix](https://idir.uta.edu/sockg-ontology#SpeciesMix)
...
```mermaid
 classDiagram
    ...
    click HttpsIdir.uta.eduSockg-ontology#SpeciesMix href "../HttpsIdir.uta.eduSockg-ontology#SpeciesMix"
      HttpsIdir.uta.eduSockg-ontology#SpeciesMix : rdfs_label
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#SpeciesMix --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: https___idir.uta.edu_sockg-ontology#SpeciesMix
from_schema: okns:soc-kg
rank: 1000
slots:
- rdfs_label
class_uri: https://idir.uta.edu/sockg-ontology#SpeciesMix
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: https___idir.uta.edu_sockg-ontology#SpeciesMix
    domain_of:
