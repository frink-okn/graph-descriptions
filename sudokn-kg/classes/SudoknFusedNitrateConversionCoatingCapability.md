...
# Class: SudoknFusedNitrateConversionCoatingCapability





URI: [sudokn:FusedNitrateConversionCoatingCapability](http://asu.edu/semantics/SUDOKN/FusedNitrateConversionCoatingCapability)
...
```mermaid
 classDiagram
    ...
    click SudoknFusedNitrateConversionCoatingCapability href "../SudoknFusedNitrateConversionCoatingCapability"
      ...
      SudoknFusedNitrateConversionCoatingCapability : rdfs_label
        
          
    
    
    SudoknFusedNitrateConversionCoatingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: sudokn_FusedNitrateConversionCoatingCapability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_ChemicalConversionCoatingCapability
class_uri: sudokn:FusedNitrateConversionCoatingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_FusedNitrateConversionCoatingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
