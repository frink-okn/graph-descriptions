...
# Class: TODO -- what's a good name for this class (type)? (sudokn_AnnealingCapability)
...
URI: [sudokn:AnnealingCapability](http://asu.edu/semantics/SUDOKN/AnnealingCapability)
...
```mermaid
 classDiagram
    class SudoknAnnealingCapability
    click SudoknAnnealingCapability href "../SudoknAnnealingCapability"
      SudoknAnnealingCapability : rdfs_label
        
          
    
    
    SudoknAnnealingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknAnnealingCapability](../classes/SudoknAnnealingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknAnnealingCapability](../classes/SudoknAnnealingCapability.md) |
...
| Value |
| --- |
| sudokn:ABIFOUNDRY-AnnealingCapability-inst |
...
| ---  | ---  |
| self | sudokn:AnnealingCapability |
| native | sudokn-kg/:SudoknAnnealingCapability |
...
<details>
```yaml
name: sudokn_AnnealingCapability
...
- if you think the class is perfect.
notes:
- Class with 99 occurences.
examples:
- value: sudokn:ABIFOUNDRY-AnnealingCapability-inst
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:AnnealingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_AnnealingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
