...
URI: [sockg:siltPercent](http://www.semanticweb.org/sockg/ontologies/2024/0/soil-carbon-ontology/siltPercent)
...
| Value |
| --- |
| neo4j://graph.individuals#314443 sockg:siltPercent 0.0 |
...
| ---  | ---  |
| self | sockg:siltPercent |
| native | soc-kg/main/:sockg_siltPercent |
