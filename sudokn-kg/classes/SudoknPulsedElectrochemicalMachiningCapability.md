...
# Class: TODO -- what's a good name for this class (type)? (sudokn_PulsedElectrochemicalMachiningCapability)
...
URI: [sudokn:PulsedElectrochemicalMachiningCapability](http://asu.edu/semantics/SUDOKN/PulsedElectrochemicalMachiningCapability)
...
```mermaid
 classDiagram
    class SudoknPulsedElectrochemicalMachiningCapability
    click SudoknPulsedElectrochemicalMachiningCapability href "../SudoknPulsedElectrochemicalMachiningCapability"
      SudoknPulsedElectrochemicalMachiningCapability : rdfs_label
        
          
    
    
    SudoknPulsedElectrochemicalMachiningCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknPulsedElectrochemicalMachiningCapability](../classes/SudoknPulsedElectrochemicalMachiningCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknPulsedElectrochemicalMachiningCapability](../classes/SudoknPulsedElectrochemicalMachiningCapability.md) |
...
| Value |
| --- |
| sudokn:VoxelInnovations-PulsedElectrochemicalMachining |
...
| ---  | ---  |
| self | sudokn:PulsedElectrochemicalMachiningCapability |
| native | sudokn-kg/:SudoknPulsedElectrochemicalMachiningCapability |
...
<details>
```yaml
name: sudokn_PulsedElectrochemicalMachiningCapability
...
examples:
- value: sudokn:VoxelInnovations-PulsedElectrochemicalMachining
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:PulsedElectrochemicalMachiningCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_PulsedElectrochemicalMachiningCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
