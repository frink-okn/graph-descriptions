...
```mermaid
 classDiagram
    ...
    click HttpsClimatepub4kg.github.ioOntology#Problem href "../HttpsClimatepub4kg.github.ioOntology#Problem"
      HttpsClimatepub4kg.github.ioOntology#Problem : neo4j_name
        
          
    
    
    HttpsClimatepub4kg.github.ioOntology#Problem --> "0..1" String : neo4j_name
    click String href "../String"

        
      HttpsClimatepub4kg.github.ioOntology#Problem : neo4j_paper_id
        
          
    
    
    HttpsClimatepub4kg.github.ioOntology#Problem --> "0..1" String : neo4j_paper_id
    click String href "../String"

        
      HttpsClimatepub4kg.github.ioOntology#Problem : neo4j_uuid
        
          
    
    
    HttpsClimatepub4kg.github.ioOntology#Problem --> "0..1" String : neo4j_uuid
    click String href "../String"
