...
# Class: TODO -- what's a good name for this class (type)? (sudokn_LaserEtchingCapability)
...
URI: [sudokn:LaserEtchingCapability](http://asu.edu/semantics/SUDOKN/LaserEtchingCapability)
...
```mermaid
 classDiagram
    class SudoknLaserEtchingCapability
    click SudoknLaserEtchingCapability href "../SudoknLaserEtchingCapability"
      SudoknLaserEtchingCapability : rdfs_label
        
          
    
    
    SudoknLaserEtchingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknLaserEtchingCapability](../classes/SudoknLaserEtchingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknLaserEtchingCapability](../classes/SudoknLaserEtchingCapability.md) |
...
| Value |
| --- |
| sudokn:A-I-CORP-LaserEtchingCapability-inst |
...
| ---  | ---  |
| self | sudokn:LaserEtchingCapability |
| native | sudokn-kg/:SudoknLaserEtchingCapability |
...
<details>
```yaml
name: sudokn_LaserEtchingCapability
...
examples:
- value: sudokn:A-I-CORP-LaserEtchingCapability-inst
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:LaserEtchingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_LaserEtchingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
