...
# Class: TODO -- what's a good name for this class (type)? (sudokn_DelrinProcessingCapability)
...
URI: [sudokn:DelrinProcessingCapability](http://asu.edu/semantics/SUDOKN/DelrinProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknDelrinProcessingCapability
    click SudoknDelrinProcessingCapability href "../SudoknDelrinProcessingCapability"
      SudoknDelrinProcessingCapability : rdfs_label
        
          
    
    
    SudoknDelrinProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknDelrinProcessingCapability](../classes/SudoknDelrinProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknDelrinProcessingCapability](../classes/SudoknDelrinProcessingCapability.md) |
...
| ---  | ---  |
| self | sudokn:DelrinProcessingCapability |
| native | sudokn-kg/:SudoknDelrinProcessingCapability |
...
<details>
```yaml
name: sudokn_DelrinProcessingCapability
...
- if you think the class is perfect.
notes:
- Class with 289 occurences.
examples:
- value: sudokn:3D-CAM-Delrin-inst
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:DelrinProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_DelrinProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
