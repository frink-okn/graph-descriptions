...
# Class: silicone processing capability (sudokn_SiliconeProcessingCapability)
...
URI: [sudokn:SiliconeProcessingCapability](http://asu.edu/semantics/SUDOKN/SiliconeProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknSiliconeProcessingCapability
    click SudoknSiliconeProcessingCapability href "../SudoknSiliconeProcessingCapability"
      ...
      SudoknSiliconeProcessingCapability : rdfs_label
        
          
    
    
    SudoknSiliconeProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknSiliconeProcessingCapability](../classes/SudoknSiliconeProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknSiliconeProcessingCapability](../classes/SudoknSiliconeProcessingCapability.md) |
...
| Value |
| --- |
| sudokn:3DIMENSIONAL-Silicone-inst |
...
| ---  | ---  |
| self | sudokn:SiliconeProcessingCapability |
| native | sudokn-kg/:SudoknSiliconeProcessingCapability |
...
<details>
```yaml
name: sudokn_SiliconeProcessingCapability
description: No type description provided
title: silicone processing capability
todos:
- TODO -- Todos for this class go here
- or you can delete the todos
- if you think the class is perfect.
notes:
- Class with 690 occurences.
examples:
- value: sudokn:3DIMENSIONAL-Silicone-inst
from_schema: sudokn-kg
rank: 1000
is_a: sudokn_MaterialProcessingCapability
slots:
- rdfs_label
class_uri: sudokn:SiliconeProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_SiliconeProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
