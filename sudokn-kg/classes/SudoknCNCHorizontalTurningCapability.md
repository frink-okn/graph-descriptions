...
# Class: TODO -- what's a good name for this class (type)? (sudokn_CNCHorizontalTurningCapability)
...
URI: [sudokn:CNCHorizontalTurningCapability](http://asu.edu/semantics/SUDOKN/CNCHorizontalTurningCapability)
...
```mermaid
 classDiagram
    class SudoknCNCHorizontalTurningCapability
    click SudoknCNCHorizontalTurningCapability href "../SudoknCNCHorizontalTurningCapability"
      SudoknCNCHorizontalTurningCapability : rdfs_label
        
          
    
    
    SudoknCNCHorizontalTurningCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCNCHorizontalTurningCapability](../classes/SudoknCNCHorizontalTurningCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCNCHorizontalTurningCapability](../classes/SudoknCNCHorizontalTurningCapability.md) |
...
| Value |
| --- |
| sudokn:SurryLogistix-CNCHorizontalTurning |
...
| ---  | ---  |
| self | sudokn:CNCHorizontalTurningCapability |
| native | sudokn-kg/:SudoknCNCHorizontalTurningCapability |
...
<details>
```yaml
name: sudokn_CNCHorizontalTurningCapability
...
examples:
- value: sudokn:SurryLogistix-CNCHorizontalTurning
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:CNCHorizontalTurningCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_CNCHorizontalTurningCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
