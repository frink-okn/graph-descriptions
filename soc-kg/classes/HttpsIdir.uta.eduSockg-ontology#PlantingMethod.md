...
# Class: HttpsIdir.uta.eduSockg-ontology#PlantingMethod
...
URI: [https://idir.uta.edu/sockg-ontology#PlantingMethod](https://idir.uta.edu/sockg-ontology#PlantingMethod)
...
```mermaid
 classDiagram
    ...
    click HttpsIdir.uta.eduSockg-ontology#PlantingMethod href "../HttpsIdir.uta.eduSockg-ontology#PlantingMethod"
      HttpsIdir.uta.eduSockg-ontology#PlantingMethod : rdfs_label
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#PlantingMethod --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: https___idir.uta.edu_sockg-ontology#PlantingMethod
from_schema: okns:soc-kg
rank: 1000
slots:
- rdfs_label
class_uri: https://idir.uta.edu/sockg-ontology#PlantingMethod
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: https___idir.uta.edu_sockg-ontology#PlantingMethod
    domain_of:
