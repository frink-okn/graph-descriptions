...
# Class: TODO -- what's a good name for this class (type)? (sudokn_LowAlloySteelProcessingCapability)
...
URI: [sudokn:LowAlloySteelProcessingCapability](http://asu.edu/semantics/SUDOKN/LowAlloySteelProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknLowAlloySteelProcessingCapability
    click SudoknLowAlloySteelProcessingCapability href "../SudoknLowAlloySteelProcessingCapability"
      SudoknLowAlloySteelProcessingCapability : rdfs_label
        
          
    
    
    SudoknLowAlloySteelProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknLowAlloySteelProcessingCapability](../classes/SudoknLowAlloySteelProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknLowAlloySteelProcessingCapability](../classes/SudoknLowAlloySteelProcessingCapability.md) |
...
| Value |
| --- |
| sudokn:ACADEMYPETROLEUM-LowAlloySteel-inst |
...
| ---  | ---  |
| self | sudokn:LowAlloySteelProcessingCapability |
| native | sudokn-kg/:SudoknLowAlloySteelProcessingCapability |
...
<details>
```yaml
name: sudokn_LowAlloySteelProcessingCapability
...
- if you think the class is perfect.
notes:
- Class with 120 occurences.
examples:
- value: sudokn:ACADEMYPETROLEUM-LowAlloySteel-inst
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:LowAlloySteelProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_LowAlloySteelProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
