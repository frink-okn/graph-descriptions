...
# Class: TODO -- what's a good name for this class (type)? (sudokn_MIGWeldinCapability)
...
URI: [sudokn:MIGWeldinCapability](http://asu.edu/semantics/SUDOKN/MIGWeldinCapability)
...
```mermaid
 classDiagram
    class SudoknMIGWeldinCapability
    click SudoknMIGWeldinCapability href "../SudoknMIGWeldinCapability"
      SudoknMIGWeldinCapability : rdfs_label
        
          
    
    
    SudoknMIGWeldinCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknMIGWeldinCapability](../classes/SudoknMIGWeldinCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknMIGWeldinCapability](../classes/SudoknMIGWeldinCapability.md) |
...
| Value |
| --- |
| sudokn:LiquidProcessSystems-MIGWeldin |
...
| ---  | ---  |
| self | sudokn:MIGWeldinCapability |
| native | sudokn-kg/:SudoknMIGWeldinCapability |
...
<details>
```yaml
name: sudokn_MIGWeldinCapability
...
examples:
- value: sudokn:LiquidProcessSystems-MIGWeldin
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:MIGWeldinCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_MIGWeldinCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
