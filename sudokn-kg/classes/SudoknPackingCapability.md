...
```mermaid
 classDiagram
    ...
    SudoknPackingCapability --> "0..1" String : rdfs_label
...
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknPackingCapability](../classes/SudoknPackingCapability.md) |
...
| Value |
| --- |
| sudokn:3DIMENSIONAL-PackingCapability-inst |
...
| ---  | ---  |
| self | sudokn:PackingCapability |
| native | sudokn-kg/:SudoknPackingCapability |
...
- if you think the class is perfect.
notes:
- Class with 1765 occurences.
examples:
- value: sudokn:3DIMENSIONAL-PackingCapability-inst
