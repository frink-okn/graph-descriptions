...
# Class: TODO -- what's a good name for this class (type)? (sudokn_ProductDesignCapability)
...
URI: [sudokn:ProductDesignCapability](http://asu.edu/semantics/SUDOKN/ProductDesignCapability)
...
```mermaid
 classDiagram
    class SudoknProductDesignCapability
    click SudoknProductDesignCapability href "../SudoknProductDesignCapability"
      SudoknProductDesignCapability : rdfs_label
        
          
    
    
    SudoknProductDesignCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknProductDesignCapability](../classes/SudoknProductDesignCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknProductDesignCapability](../classes/SudoknProductDesignCapability.md) |
...
| Value |
| --- |
| sudokn:PerformanceMachineAndFab-ProductDesign |
...
| ---  | ---  |
| self | sudokn:ProductDesignCapability |
| native | sudokn-kg/:SudoknProductDesignCapability |
...
<details>
```yaml
name: sudokn_ProductDesignCapability
...
examples:
- value: sudokn:PerformanceMachineAndFab-ProductDesign
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:ProductDesignCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ProductDesignCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
