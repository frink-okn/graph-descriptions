...
# Class: TODO -- what's a good name for this class (type)? (sudokn_NylonProcessingCapability)
...
URI: [sudokn:NylonProcessingCapability](http://asu.edu/semantics/SUDOKN/NylonProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknNylonProcessingCapability
    click SudoknNylonProcessingCapability href "../SudoknNylonProcessingCapability"
      SudoknNylonProcessingCapability : rdfs_label
        
          
    
    
    SudoknNylonProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknNylonProcessingCapability](../classes/SudoknNylonProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknNylonProcessingCapability](../classes/SudoknNylonProcessingCapability.md) |
...
| ---  | ---  |
| self | sudokn:NylonProcessingCapability |
| native | sudokn-kg/:SudoknNylonProcessingCapability |
...
<details>
```yaml
name: sudokn_NylonProcessingCapability
...
- if you think the class is perfect.
notes:
- Class with 1177 occurences.
examples:
- value: sudokn:3D-CAM-Nylon-inst
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:NylonProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_NylonProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
