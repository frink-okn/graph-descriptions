...
# Class: No class (type) name specified (sudokn_GasTungstenArcWeldingCapability)
...
URI: [sudokn:GasTungstenArcWeldingCapability](http://asu.edu/semantics/SUDOKN/GasTungstenArcWeldingCapability)
...
```mermaid
 classDiagram
    class SudoknGasTungstenArcWeldingCapability
    click SudoknGasTungstenArcWeldingCapability href "../SudoknGasTungstenArcWeldingCapability"
      ...
      SudoknGasTungstenArcWeldingCapability <|-- SudoknTIGWeldingCapability
        click SudoknTIGWeldingCapability href "../SudoknTIGWeldingCapability"
      
      
      SudoknGasTungstenArcWeldingCapability : rdfs_label
        
          
    
    
    SudoknGasTungstenArcWeldingCapability --> "0..1" String : rdfs_label
                ...
                * [SudoknThermalWeldingCapability](../classes/SudoknThermalWeldingCapability.md)
                    * [SudoknElectricArcWeldingCapability](../classes/SudoknElectricArcWeldingCapability.md)
                        * **SudoknGasTungstenArcWeldingCapability**
                            * [SudoknTIGWeldingCapability](../classes/SudoknTIGWeldingCapability.md)
...
```yaml
name: sudokn_GasTungstenArcWeldingCapability
...
class_uri: sudokn:GasTungstenArcWeldingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_GasTungstenArcWeldingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
    - owl_NamedIndividual
