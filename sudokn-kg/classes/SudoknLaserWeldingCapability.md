...
# Class: TODO -- what's a good name for this class (type)? (sudokn_LaserWeldingCapability)
...
URI: [sudokn:LaserWeldingCapability](http://asu.edu/semantics/SUDOKN/LaserWeldingCapability)
...
```mermaid
 classDiagram
    class SudoknLaserWeldingCapability
    click SudoknLaserWeldingCapability href "../SudoknLaserWeldingCapability"
      SudoknLaserWeldingCapability : rdfs_label
        
          
    
    
    SudoknLaserWeldingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknLaserWeldingCapability](../classes/SudoknLaserWeldingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknLaserWeldingCapability](../classes/SudoknLaserWeldingCapability.md) |
...
| Value |
| --- |
| sudokn:WirtzWireEDM-LaserWelding |
...
| ---  | ---  |
| self | sudokn:LaserWeldingCapability |
| native | sudokn-kg/:SudoknLaserWeldingCapability |
...
<details>
```yaml
name: sudokn_LaserWeldingCapability
...
examples:
- value: sudokn:WirtzWireEDM-LaserWelding
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:LaserWeldingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_LaserWeldingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
