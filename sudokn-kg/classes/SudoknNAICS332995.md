...
# Class: TODO -- what's a good name for this class (type)? (sudokn_NAICS332995)
...
URI: [sudokn:NAICS332995](http://asu.edu/semantics/SUDOKN/NAICS332995)
...
```mermaid
 classDiagram
    class SudoknNAICS332995
    click SudoknNAICS332995 href "../SudoknNAICS332995"
      SudoknNAICS332995 : sudokn_hasNAICSCodeValue
        
          
    
    
    SudoknNAICS332995 --> "0..1" Any : sudokn_hasNAICSCodeValue
    click Any href "../Any"

        
      SudoknNAICS332995 : sudokn_hasNAICSTextValue
        
          
    
    
    SudoknNAICS332995 --> "0..1" Any : sudokn_hasNAICSTextValue
    click Any href "../Any"
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasPrimaryNAICSClassifier](../slots/sudokn_hasPrimaryNAICSClassifier.md) | any_of[range] | [SudoknNAICS332995](../classes/SudoknNAICS332995.md) |
...
| ---  | ---  |
| self | sudokn:NAICS332995 |
| native | sudokn-kg/:SudoknNAICS332995 |
