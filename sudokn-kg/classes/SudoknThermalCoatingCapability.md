...
# Class: SudoknThermalCoatingCapability





URI: [sudokn:ThermalCoatingCapability](http://asu.edu/semantics/SUDOKN/ThermalCoatingCapability)
...
```mermaid
 classDiagram
    ...
    click SudoknThermalCoatingCapability href "../SudoknThermalCoatingCapability"
      ...
      SudoknThermalCoatingCapability : rdfs_label
        
          
    
    
    SudoknThermalCoatingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
        ...
        * [SudoknSurfaceFinishingCapability](../classes/SudoknSurfaceFinishingCapability.md)
            * [SudoknCoatingCapability](../classes/SudoknCoatingCapability.md)
                * **SudoknThermalCoatingCapability**
                    * [SudoknThermalSprayCoatingCapability](../classes/SudoknThermalSprayCoatingCapability.md)
...
```yaml
name: sudokn_ThermalCoatingCapability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_CoatingCapability
class_uri: sudokn:ThermalCoatingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ThermalCoatingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
