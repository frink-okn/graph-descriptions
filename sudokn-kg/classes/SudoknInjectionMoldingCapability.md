...
# Class: TODO -- what's a good name for this class (type)? (sudokn_InjectionMoldingCapability)
...
```mermaid
 classDiagram
    ...
    SudoknInjectionMoldingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string) | TODO -- tell the world what this slot (predicate) describes | [SudoknMoldingCapability](../classes/SudoknMoldingCapability.md) |
...
| ---  | ---  |
| self | sudokn:InjectionMoldingCapability |
| native | sudokn-kg/:SudoknInjectionMoldingCapability |
