...
# Class: TODO -- what's a good name for this class (type)? (sudokn_GasMetalArcWeldingCapability)
...
| ---  | ---  |
| self | sudokn:GasMetalArcWeldingCapability |
| native | sudokn-kg/:SudoknGasMetalArcWeldingCapability |
