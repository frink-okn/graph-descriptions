...
# Class: TODO -- what's a good name for this class (type)? (sudokn_CNCMillingCapability)
...
URI: [sudokn:CNCMillingCapability](http://asu.edu/semantics/SUDOKN/CNCMillingCapability)
...
```mermaid
 classDiagram
    class SudoknCNCMillingCapability
    click SudoknCNCMillingCapability href "../SudoknCNCMillingCapability"
      ...
      SudoknCNCMillingCapability : rdfs_label
        
          
    
    
    SudoknCNCMillingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCNCMillingCapability](../classes/SudoknCNCMillingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCNCMillingCapability](../classes/SudoknCNCMillingCapability.md) |
...
| Value |
| --- |
| sudokn:3DMACH-CNCMillingCapability-inst |
...
| ---  | ---  |
| self | sudokn:CNCMillingCapability |
| native | sudokn-kg/:SudoknCNCMillingCapability |
...
<details>
```yaml
name: sudokn_CNCMillingCapability
...
- if you think the class is perfect.
notes:
- Class with 1105 occurences.
examples:
- value: sudokn:3DMACH-CNCMillingCapability-inst
from_schema: sudokn-kg
is_a: sudokn_MillingCapability
slots:
- rdfs_label
class_uri: sudokn:CNCMillingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_CNCMillingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
