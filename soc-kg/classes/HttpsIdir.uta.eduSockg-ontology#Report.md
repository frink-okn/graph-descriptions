...
# Class: HttpsIdir.uta.eduSockg-ontology#Report
...
URI: [https://idir.uta.edu/sockg-ontology#Report](https://idir.uta.edu/sockg-ontology#Report)
...
```mermaid
 classDiagram
    ...
    click HttpsIdir.uta.eduSockg-ontology#Report href "../HttpsIdir.uta.eduSockg-ontology#Report"
      ...
      HttpsIdir.uta.eduSockg-ontology#Report : dct_bibliographicCitation
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#Report --> "0..1" RdfsLiteral : dct_bibliographicCitation
    click RdfsLiteral href "../RdfsLiteral"

        
      HttpsIdir.uta.eduSockg-ontology#Report : dct_creator
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#Report --> "0..1" Any : dct_creator
    click Any href "../Any"

        
      HttpsIdir.uta.eduSockg-ontology#Report : dct_issued
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#Report --> "0..1" Any : dct_issued
    click Any href "../Any"

        
      HttpsIdir.uta.eduSockg-ontology#Report : dct_title
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#Report --> "0..1" Any : dct_title
    click Any href "../Any"

        
      HttpsIdir.uta.eduSockg-ontology#Report : https___idir.uta.edu_sockg_ontology#correspondingAuthor
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#Report --> "0..1" String : https___idir.uta.edu_sockg_ontology#correspondingAuthor
    click String href "../String"

        
      HttpsIdir.uta.eduSockg-ontology#Report : rdfs_label
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#Report --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- |
| [HttpsIdir.uta.eduSockg-ontology#Location](../classes/HttpsIdir.uta.eduSockg-ontology#Location.md) | [https___idir.uta.edu_sockg_ontology#cites](../slots/https___idir.uta.edu_sockg_ontology#cites.md) | any_of[range] | [HttpsIdir.uta.eduSockg-ontology#Report](../classes/HttpsIdir.uta.eduSockg-ontology#Report.md) |
...
```yaml
name: https___idir.uta.edu_sockg-ontology#Report
...
- dct_issued
class_uri: https://idir.uta.edu/sockg-ontology#Report
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: https___idir.uta.edu_sockg-ontology#Report
    domain_of:
    - qudt_AspectClass
    - qudt_BinaryPrefix
