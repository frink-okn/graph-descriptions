...
# Class: TODO -- what's a good name for this class (type)? (sudokn_CNCTurningCapability)
...
URI: [sudokn:CNCTurningCapability](http://asu.edu/semantics/SUDOKN/CNCTurningCapability)
...
```mermaid
 classDiagram
    class SudoknCNCTurningCapability
    click SudoknCNCTurningCapability href "../SudoknCNCTurningCapability"
      ...
      SudoknCNCTurningCapability : rdfs_label
        
          
    
    
    SudoknCNCTurningCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCNCTurningCapability](../classes/SudoknCNCTurningCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCNCTurningCapability](../classes/SudoknCNCTurningCapability.md) |
...
| Value |
| --- |
| sudokn:ATSMachineSafetySolutions-CNCTurning |
...
| ---  | ---  |
| self | sudokn:CNCTurningCapability |
| native | sudokn-kg/:SudoknCNCTurningCapability |
...
<details>
```yaml
name: sudokn_CNCTurningCapability
...
examples:
- value: sudokn:ATSMachineSafetySolutions-CNCTurning
from_schema: sudokn-kg
is_a: sudokn_TurningCapability
slots:
- rdfs_label
class_uri: sudokn:CNCTurningCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_CNCTurningCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
