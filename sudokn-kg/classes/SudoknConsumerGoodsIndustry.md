...
# Class: consumer goods industry (sudokn_ConsumerGoodsIndustry)
...
URI: [sudokn:ConsumerGoodsIndustry](http://asu.edu/semantics/SUDOKN/ConsumerGoodsIndustry)
...
```mermaid
 classDiagram
    class SudoknConsumerGoodsIndustry
    click SudoknConsumerGoodsIndustry href "../SudoknConsumerGoodsIndustry"
      ...
      SudoknConsumerGoodsIndustry : rdfs_label
        
          
    
    
    SudoknConsumerGoodsIndustry --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknConsumerGoodsIndustry](../classes/SudoknConsumerGoodsIndustry.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknConsumerGoodsIndustry](../classes/SudoknConsumerGoodsIndustry.md) |
...
| ---  | ---  |
| self | sudokn:ConsumerGoodsIndustry |
| native | sudokn-kg/:SudoknConsumerGoodsIndustry |
...
<details>
```yaml
name: sudokn_ConsumerGoodsIndustry
...
examples:
- value: sudokn:ConsumerGoods-Industry
from_schema: sudokn-kg
is_a: iosc_Industry
slots:
- rdfs_label
class_uri: sudokn:ConsumerGoodsIndustry
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ConsumerGoodsIndustry
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
