...
# Class: TODO -- what's a good name for this class (type)? (sudokn_SilkScreeningCapability)
...
URI: [sudokn:SilkScreeningCapability](http://asu.edu/semantics/SUDOKN/SilkScreeningCapability)
...
```mermaid
 classDiagram
    class SudoknSilkScreeningCapability
    click SudoknSilkScreeningCapability href "../SudoknSilkScreeningCapability"
      SudoknSilkScreeningCapability : rdfs_label
        
          
    
    
    SudoknSilkScreeningCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknSilkScreeningCapability](../classes/SudoknSilkScreeningCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknSilkScreeningCapability](../classes/SudoknSilkScreeningCapability.md) |
...
| Value |
| --- |
| sudokn:QMFMetalAndElectronicSolutions-SilkScreening |
...
| ---  | ---  |
| self | sudokn:SilkScreeningCapability |
| native | sudokn-kg/:SudoknSilkScreeningCapability |
...
<details>
```yaml
name: sudokn_SilkScreeningCapability
...
examples:
- value: sudokn:QMFMetalAndElectronicSolutions-SilkScreening
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:SilkScreeningCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_SilkScreeningCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
