...
# Class: iron processing capability (sudokn_IronProcessingCapability)
...
URI: [sudokn:IronProcessingCapability](http://asu.edu/semantics/SUDOKN/IronProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknIronProcessingCapability
    click SudoknIronProcessingCapability href "../SudoknIronProcessingCapability"
      ...
      SudoknIronProcessingCapability : rdfs_label
        
          
    
    
    SudoknIronProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknIronProcessingCapability](../classes/SudoknIronProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknIronProcessingCapability](../classes/SudoknIronProcessingCapability.md) |
...
| ---  | ---  |
| self | sudokn:IronProcessingCapability |
| native | sudokn-kg/:SudoknIronProcessingCapability |
...
<details>
```yaml
name: sudokn_IronProcessingCapability
description: TODO -- tell the world what this class (type) describes.
title: iron processing capability
todos:
- TODO -- Todos for this class go here
- or you can delete the todos
- if you think the class is perfect.
notes:
- Class with 5903 occurences.
examples:
- value: sudokn:101PIPE-Iron-inst
from_schema: sudokn-kg
is_a: sudokn_MetalProcessingCapability
slots:
- rdfs_label
class_uri: sudokn:IronProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_IronProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
