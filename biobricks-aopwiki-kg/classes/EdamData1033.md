...
This class occurs 1478 times.


URI: [edam:data_1033](http://edamontology.org/data_1033)
...
```mermaid
 classDiagram
    class EdamData1033
    click EdamData1033 href "../EdamData1033"
      EdamData1033 : dc_identifier
        
          
    
    
    EdamData1033 --> "0..1" Any : dc_identifier
    click Any href "../Any"

        
      EdamData1033 : dc_source
        
          
    
    
    EdamData1033 --> "0..1" Any : dc_source
    click Any href "../Any"

        
      EdamData1033 : edam_data_1033
        
          
    
    
    EdamData1033 --> "0..1" String : edam_data_1033
...
| ---  | --- | --- | --- | --- |
| [dc_identifier](../slots/dc_identifier.md) | 0..1 <br/> [Any](../classes/Any.md) | Recommended practice is to identify the resource by means of a string conform... <br/> description: An unambiguous reference to the resource within a given context. | direct | 1478 |
| [dc_source](../slots/dc_source.md) | 0..1 <br/> [Any](../classes/Any.md) | The described resource may be derived from the related resource in whole or i... <br/> description: A related resource from which the described resource is derived. | direct | 1478 |
