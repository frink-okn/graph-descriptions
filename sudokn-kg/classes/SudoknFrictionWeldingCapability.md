...
# Class: No class (type) name specified (sudokn_FrictionWeldingCapability)
...
URI: [sudokn:FrictionWeldingCapability](http://asu.edu/semantics/SUDOKN/FrictionWeldingCapability)
...
```mermaid
 classDiagram
    class SudoknFrictionWeldingCapability
    click SudoknFrictionWeldingCapability href "../SudoknFrictionWeldingCapability"
      ...
      SudoknFrictionWeldingCapability : rdfs_label
        
          
    
    
    SudoknFrictionWeldingCapability --> "0..1" String : rdfs_label
...
```yaml
name: sudokn_FrictionWeldingCapability
...
class_uri: sudokn:FrictionWeldingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_FrictionWeldingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
    - owl_NamedIndividual
