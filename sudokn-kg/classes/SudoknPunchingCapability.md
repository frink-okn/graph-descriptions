...
# Class: TODO -- what's a good name for this class (type)? (sudokn_PunchingCapability)
...
URI: [sudokn:PunchingCapability](http://asu.edu/semantics/SUDOKN/PunchingCapability)
...
```mermaid
 classDiagram
    class SudoknPunchingCapability
    click SudoknPunchingCapability href "../SudoknPunchingCapability"
      ...
      SudoknPunchingCapability : rdfs_label
        
          
    
    
    SudoknPunchingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknPunchingCapability](../classes/SudoknPunchingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknPunchingCapability](../classes/SudoknPunchingCapability.md) |
...
| ---  | ---  |
| self | sudokn:PunchingCapability |
| native | sudokn-kg/:SudoknPunchingCapability |
...
<details>
```yaml
name: sudokn_PunchingCapability
...
examples:
- value: sudokn:Aludisc-Punching
from_schema: sudokn-kg
is_a: sudokn_SheetMetalProcessingCapability
slots:
- rdfs_label
class_uri: sudokn:PunchingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_PunchingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
