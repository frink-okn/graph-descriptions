...
# Class: TODO -- what's a good name for this class (type)? (sudokn_VacuumFormingCapability)
...
URI: [sudokn:VacuumFormingCapability](http://asu.edu/semantics/SUDOKN/VacuumFormingCapability)
...
```mermaid
 classDiagram
    class SudoknVacuumFormingCapability
    click SudoknVacuumFormingCapability href "../SudoknVacuumFormingCapability"
      SudoknVacuumFormingCapability : rdfs_label
        
          
    
    
    SudoknVacuumFormingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknVacuumFormingCapability](../classes/SudoknVacuumFormingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknVacuumFormingCapability](../classes/SudoknVacuumFormingCapability.md) |
...
| Value |
| --- |
| sudokn:DDMManufacturing-VacuumForming |
...
| ---  | ---  |
| self | sudokn:VacuumFormingCapability |
| native | sudokn-kg/:SudoknVacuumFormingCapability |
...
<details>
```yaml
name: sudokn_VacuumFormingCapability
...
examples:
- value: sudokn:DDMManufacturing-VacuumForming
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:VacuumFormingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_VacuumFormingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
