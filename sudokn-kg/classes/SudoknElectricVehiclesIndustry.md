...
# Class: TODO -- what's a good name for this class (type)? (sudokn_ElectricVehiclesIndustry)
...
URI: [sudokn:ElectricVehiclesIndustry](http://asu.edu/semantics/SUDOKN/ElectricVehiclesIndustry)
...
```mermaid
 classDiagram
    class SudoknElectricVehiclesIndustry
    click SudoknElectricVehiclesIndustry href "../SudoknElectricVehiclesIndustry"
      SudoknElectricVehiclesIndustry : rdfs_label
        
          
    
    
    SudoknElectricVehiclesIndustry --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknElectricVehiclesIndustry](../classes/SudoknElectricVehiclesIndustry.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknElectricVehiclesIndustry](../classes/SudoknElectricVehiclesIndustry.md) |
...
| Value |
| --- |
| sudokn:ElectricVehicles-Industry |
...
| ---  | ---  |
| self | sudokn:ElectricVehiclesIndustry |
| native | sudokn-kg/:SudoknElectricVehiclesIndustry |
...
<details>
```yaml
name: sudokn_ElectricVehiclesIndustry
...
examples:
- value: sudokn:ElectricVehicles-Industry
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:ElectricVehiclesIndustry
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ElectricVehiclesIndustry
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
