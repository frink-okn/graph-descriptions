...
# Class: SudoknElectrolessNickelPlating





URI: [sudokn:ElectrolessNickelPlating](http://asu.edu/semantics/SUDOKN/ElectrolessNickelPlating)
...
```mermaid
 classDiagram
    ...
    click SudoknElectrolessNickelPlating href "../SudoknElectrolessNickelPlating"
      ...
      SudoknElectrolessNickelPlating : rdfs_label
        
          
    
    
    SudoknElectrolessNickelPlating --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject | [SudoknChemicalCoatingCapability](../classes/SudoknChemicalCoatingCapability.md), [SudoknSurfaceFinishingCapability](../classes/SudoknSurfaceFinishingCapability.md), [SudoknPlatingCapability](../classes/SudoknPlatingCapability.md), [SudoknElectroPlatingCapability](../classes/SudoknElectroPlatingCapability.md), [SudoknCoatingCapability](../classes/SudoknCoatingCapability.md) |  |
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ElectrolessNickelPlating
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
