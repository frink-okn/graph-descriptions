...
# Class: TODO -- what's a good name for this class (type)? (sdoh_Experiment)
...
URI: [sdoh:Experiment](http://schema.org/Experiment)
...
```mermaid
 classDiagram
    class SdohExperiment
    click SdohExperiment href "../SdohExperiment"
      SdohExperiment : http___attribute.org_end_year
        
          
    
    
    SdohExperiment --> "0..1" String : http___attribute.org_end_year
    click String href "../String"

        
      SdohExperiment : http___attribute.org_experiment
        
          
    
    
    SdohExperiment --> "0..1" String : http___attribute.org_experiment
    click String href "../String"

        
      SdohExperiment : http___attribute.org_start_year
        
          
    
    
    SdohExperiment --> "0..1" String : http___attribute.org_start_year
    click String href "../String"

        
      SdohExperiment : http___attribute.org_tier
        
          
    
    
    SdohExperiment --> "0..1" String : http___attribute.org_tier
    click String href "../String"

        
      SdohExperiment : http___relation.org_ComparedTo
        
          
    
    
    SdohExperiment --> "0..1" Any : http___relation.org_ComparedTo
    click Any href "../Any"

        
      SdohExperiment : http___relation.org_HasActivity
        
          
    
    
    SdohExperiment --> "0..1" SdohActivity : http___relation.org_HasActivity
    click SdohActivity href "../SdohActivity"

        
      SdohExperiment : http___relation.org_HasAdditionalAllowedModelComponents
        
          
    
    
    SdohExperiment --> "0..1" Any : http___relation.org_HasAdditionalAllowedModelComponents
    click Any href "../Any"

        
      SdohExperiment : http___relation.org_HasParentActivity
        
          
    
    
    SdohExperiment --> "0..1" SdohActivity : http___relation.org_HasParentActivity
    click SdohActivity href "../SdohActivity"

        
      SdohExperiment : http___relation.org_HasParentExperiment
        
          
    
    
    SdohExperiment --> "0..1" SdohExperiment : http___relation.org_HasParentExperiment
    click SdohExperiment href "../SdohExperiment"

        
      SdohExperiment : http___relation.org_HasProjectName
        
          
    
    
    SdohExperiment --> "0..1" SdohProject : http___relation.org_HasProjectName
    click SdohProject href "../SdohProject"

        
      SdohExperiment : http___relation.org_HasRequiredModelComponents
        
          
    
    
    SdohExperiment --> "0..1" Any : http___relation.org_HasRequiredModelComponents
    click Any href "../Any"

        
      SdohExperiment : http___relation.org_MeasuredAt
        
          
    
    
    SdohExperiment --> "0..1" Any : http___relation.org_MeasuredAt
    click Any href "../Any"

        
      SdohExperiment : http___relation.org_MountedOn
        
          
    
    
    SdohExperiment --> "0..1" Any : http___relation.org_MountedOn
    click Any href "../Any"

        
      SdohExperiment : http___relation.org_Outputs
        
          
    
    
    SdohExperiment --> "0..1" Any : http___relation.org_Outputs
    click Any href "../Any"

        
      SdohExperiment : http___relation.org_ProvidedBy
        
          
    
    
    SdohExperiment --> "0..1" Any : http___relation.org_ProvidedBy
    click Any href "../Any"

        
      SdohExperiment : http___relation.org_RunBy
        
          
    
    
    SdohExperiment --> "0..1" Any : http___relation.org_RunBy
    click Any href "../Any"

        
      SdohExperiment : http___relation.org_TargetsLocation
        
          
    
    
    SdohExperiment --> "0..1" Any : http___relation.org_TargetsLocation
    click Any href "../Any"

        
      SdohExperiment : http___relation.org_UsedIn
        
          
    
    
    SdohExperiment --> "0..1" Any : http___relation.org_UsedIn
    click Any href "../Any"

        
      SdohExperiment : http___relation.org_ValidatedBy
        
          
    
    
    SdohExperiment --> "0..1" Any : http___relation.org_ValidatedBy
    click Any href "../Any"

        
      SdohExperiment : skos_broader
        
          
    
    
    SdohExperiment --> "0..1" Any : skos_broader
    click Any href "../Any"

        
      SdohExperiment : skos_definition
        
          
    
    
    SdohExperiment --> "0..1" String : skos_definition
    click String href "../String"

        
      SdohExperiment : skos_prefLabel
        
          
    
    
    SdohExperiment --> "0..1" String : skos_prefLabel
    click String href "../String"
...
| [http___relation.org_Outputs](../slots/http___relation.org_Outputs.md) | 0..1 <br/> [Any](../classes/Any.md)&nbsp;or&nbsp;<br />[SdohProject](../classes/SdohProject.md)&nbsp;or&nbsp;<br />[SdohModels](../classes/SdohModels.md)&nbsp;or&nbsp;<br />[SdohInstrument](../classes/SdohInstrument.md)&nbsp;or&nbsp;<br />[SdohMeasurementName](../classes/SdohMeasurementName.md)&nbsp;or&nbsp;<br />[SdohActivity](../classes/SdohActivity.md)&nbsp;or&nbsp;<br />[SdohDataFormat](../classes/SdohDataFormat.md)&nbsp;or&nbsp;<br />[SdohInstitution](../classes/SdohInstitution.md)&nbsp;or&nbsp;<br />[SdohVariable](../classes/SdohVariable.md)&nbsp;or&nbsp;<br />[SdohModel](../classes/SdohModel.md)&nbsp;or&nbsp;<br />[SdohDataset](../classes/SdohDataset.md)&nbsp;or&nbsp;<br />[SdohPlatform](../classes/SdohPlatform.md)&nbsp;or&nbsp;<br />[SdohRelatedUrlContentType](../classes/SdohRelatedUrlContentType.md)&nbsp;or&nbsp;<br />[SdohProvider](../classes/SdohProvider.md)&nbsp;or&nbsp;<br />[SdohLocation](../classes/SdohLocation.md)&nbsp;or&nbsp;<br />[SdohExperiment](../classes/SdohExperiment.md)&nbsp;or&nbsp;<br />[SdohScienceKeyword](../classes/SdohScienceKeyword.md) | TODO -- tell the world what this slot (predicate) describes | direct |
| [http___relation.org_ValidatedBy](../slots/http___relation.org_ValidatedBy.md) | 0..1 <br/> [Any](../classes/Any.md)&nbsp;or&nbsp;<br />[SdohProject](../classes/SdohProject.md)&nbsp;or&nbsp;<br />[SdohModels](../classes/SdohModels.md)&nbsp;or&nbsp;<br />[SdohInstrument](../classes/SdohInstrument.md)&nbsp;or&nbsp;<br />[SdohVariable](../classes/SdohVariable.md)&nbsp;or&nbsp;<br />[SdohModel](../classes/SdohModel.md)&nbsp;or&nbsp;<br />[SdohDataset](../classes/SdohDataset.md)&nbsp;or&nbsp;<br />[SdohPlatform](../classes/SdohPlatform.md)&nbsp;or&nbsp;<br />[SdohProvider](../classes/SdohProvider.md)&nbsp;or&nbsp;<br />[SdohExperiment](../classes/SdohExperiment.md)&nbsp;or&nbsp;<br />[SdohScienceKeyword](../classes/SdohScienceKeyword.md) | TODO -- tell the world what this slot (predicate) describes | direct |
| [http___relation.org_ProvidedBy](../slots/http___relation.org_ProvidedBy.md) | 0..1 <br/> [Any](../classes/Any.md)&nbsp;or&nbsp;<br />[SdohProject](../classes/SdohProject.md)&nbsp;or&nbsp;<br />[SdohModels](../classes/SdohModels.md)&nbsp;or&nbsp;<br />[SdohInstrument](../classes/SdohInstrument.md)&nbsp;or&nbsp;<br />[SdohMeasurementName](../classes/SdohMeasurementName.md)&nbsp;or&nbsp;<br />[SdohChronostratigraphicUnit](../classes/SdohChronostratigraphicUnit.md)&nbsp;or&nbsp;<br />[SdohSubExperimentId](../classes/SdohSubExperimentId.md)&nbsp;or&nbsp;<br />[SdohActivity](../classes/SdohActivity.md)&nbsp;or&nbsp;<br />[SdohInstitution](../classes/SdohInstitution.md)&nbsp;or&nbsp;<br />[SdohDataFormat](../classes/SdohDataFormat.md)&nbsp;or&nbsp;<br />[SdohVariable](../classes/SdohVariable.md)&nbsp;or&nbsp;<br />[SdohModel](../classes/SdohModel.md)&nbsp;or&nbsp;<br />[SdohDataset](../classes/SdohDataset.md)&nbsp;or&nbsp;<br />[SdohCmip6SourceId](../classes/SdohCmip6SourceId.md)&nbsp;or&nbsp;<br />[SdohPlatform](../classes/SdohPlatform.md)&nbsp;or&nbsp;<br />[SdohProvider](../classes/SdohProvider.md)&nbsp;or&nbsp;<br />[SdohLocation](../classes/SdohLocation.md)&nbsp;or&nbsp;<br />[SdohExperiment](../classes/SdohExperiment.md)&nbsp;or&nbsp;<br />[SdohScienceKeyword](../classes/SdohScienceKeyword.md) | TODO -- tell the world what this slot (predicate) describes | direct |
| [http___relation.org_UsedIn](../slots/http___relation.org_UsedIn.md) | 0..1 <br/> [Any](../classes/Any.md)&nbsp;or&nbsp;<br />[SdohProject](../classes/SdohProject.md)&nbsp;or&nbsp;<br />[SdohModels](../classes/SdohModels.md)&nbsp;or&nbsp;<br />[SdohInstrument](../classes/SdohInstrument.md)&nbsp;or&nbsp;<br />[SdohChronostratigraphicUnit](../classes/SdohChronostratigraphicUnit.md)&nbsp;or&nbsp;<br />[SdohMeasurementName](../classes/SdohMeasurementName.md)&nbsp;or&nbsp;<br />[SdohActivity](../classes/SdohActivity.md)&nbsp;or&nbsp;<br />[SdohInstitution](../classes/SdohInstitution.md)&nbsp;or&nbsp;<br />[SdohDataFormat](../classes/SdohDataFormat.md)&nbsp;or&nbsp;<br />[SdohVariable](../classes/SdohVariable.md)&nbsp;or&nbsp;<br />[SdohModel](../classes/SdohModel.md)&nbsp;or&nbsp;<br />[SdohDataset](../classes/SdohDataset.md)&nbsp;or&nbsp;<br />[SdohCmip6SourceId](../classes/SdohCmip6SourceId.md)&nbsp;or&nbsp;<br />[SdohPlatform](../classes/SdohPlatform.md)&nbsp;or&nbsp;<br />[SdohProvider](../classes/SdohProvider.md)&nbsp;or&nbsp;<br />[SdohLocation](../classes/SdohLocation.md)&nbsp;or&nbsp;<br />[SdohExperiment](../classes/SdohExperiment.md)&nbsp;or&nbsp;<br />[SdohScienceKeyword](../classes/SdohScienceKeyword.md) | TODO -- tell the world what this slot (predicate) describes | direct |
| [http___relation.org_MountedOn](../slots/http___relation.org_MountedOn.md) | 0..1 <br/> [Any](../classes/Any.md)&nbsp;or&nbsp;<br />[SdohModels](../classes/SdohModels.md)&nbsp;or&nbsp;<br />[SdohInstrument](../classes/SdohInstrument.md)&nbsp;or&nbsp;<br />[SdohInstitution](../classes/SdohInstitution.md)&nbsp;or&nbsp;<br />[SdohPlatform](../classes/SdohPlatform.md)&nbsp;or&nbsp;<br />[SdohProvider](../classes/SdohProvider.md)&nbsp;or&nbsp;<br />[SdohLocation](../classes/SdohLocation.md)&nbsp;or&nbsp;<br />[SdohExperiment](../classes/SdohExperiment.md) | TODO -- tell the world what this slot (predicate) describes | direct |
| [http___attribute.org_end_year](../slots/http___attribute.org_end_year.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string) | TODO -- tell the world what this slot (predicate) describes | direct |
| [http___attribute.org_experiment](../slots/http___attribute.org_experiment.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string) | TODO -- tell the world what this slot (predicate) describes | direct |
| [http___relation.org_HasProjectName](../slots/http___relation.org_HasProjectName.md) | 0..1 <br/> [SdohProject](../classes/SdohProject.md) | TODO -- tell the world what this slot (predicate) describes | direct |
| [http___relation.org_HasActivity](../slots/http___relation.org_HasActivity.md) | 0..1 <br/> [SdohActivity](../classes/SdohActivity.md) | TODO -- tell the world what this slot (predicate) describes | direct |
...
| [http___attribute.org_start_year](../slots/http___attribute.org_start_year.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string) | TODO -- tell the world what this slot (predicate) describes | direct |
...
| ---  | --- | --- | --- |
| [SdohActivity](../classes/SdohActivity.md) | [http___relation.org_UsedIn](../slots/http___relation.org_UsedIn.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohActivity](../classes/SdohActivity.md) | [http___relation.org_RunBy](../slots/http___relation.org_RunBy.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohActivity](../classes/SdohActivity.md) | [skos_broader](../slots/skos_broader.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohActivity](../classes/SdohActivity.md) | [http___relation.org_TargetsLocation](../slots/http___relation.org_TargetsLocation.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohActivity](../classes/SdohActivity.md) | [http___relation.org_ProvidedBy](../slots/http___relation.org_ProvidedBy.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohActivity](../classes/SdohActivity.md) | [http___relation.org_MeasuredAt](../slots/http___relation.org_MeasuredAt.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohActivity](../classes/SdohActivity.md) | [http___relation.org_ComparedTo](../slots/http___relation.org_ComparedTo.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohChronostratigraphicUnit](../classes/SdohChronostratigraphicUnit.md) | [http___relation.org_UsedIn](../slots/http___relation.org_UsedIn.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohChronostratigraphicUnit](../classes/SdohChronostratigraphicUnit.md) | [http___relation.org_RunBy](../slots/http___relation.org_RunBy.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohChronostratigraphicUnit](../classes/SdohChronostratigraphicUnit.md) | [skos_broader](../slots/skos_broader.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohChronostratigraphicUnit](../classes/SdohChronostratigraphicUnit.md) | [http___relation.org_TargetsLocation](../slots/http___relation.org_TargetsLocation.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohChronostratigraphicUnit](../classes/SdohChronostratigraphicUnit.md) | [http___relation.org_MeasuredAt](../slots/http___relation.org_MeasuredAt.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohChronostratigraphicUnit](../classes/SdohChronostratigraphicUnit.md) | [http___relation.org_ComparedTo](../slots/http___relation.org_ComparedTo.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohCmip6SourceId](../classes/SdohCmip6SourceId.md) | [http___relation.org_HasModelComponent](../slots/http___relation.org_HasModelComponent.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohCmip6SourceId](../classes/SdohCmip6SourceId.md) | [http___relation.org_UsedIn](../slots/http___relation.org_UsedIn.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohCmip6SourceId](../classes/SdohCmip6SourceId.md) | [http___relation.org_RunBy](../slots/http___relation.org_RunBy.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohCmip6SourceId](../classes/SdohCmip6SourceId.md) | [skos_broader](../slots/skos_broader.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohCmip6SourceId](../classes/SdohCmip6SourceId.md) | [http___relation.org_ComparedTo](../slots/http___relation.org_ComparedTo.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohCmip6SourceId](../classes/SdohCmip6SourceId.md) | [http___relation.org_Outputs](../slots/http___relation.org_Outputs.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohCmip6SourceId](../classes/SdohCmip6SourceId.md) | [http___relation.org_TargetsLocation](../slots/http___relation.org_TargetsLocation.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohCmip6SourceId](../classes/SdohCmip6SourceId.md) | [http___relation.org_ProvidedBy](../slots/http___relation.org_ProvidedBy.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohCmip6SourceId](../classes/SdohCmip6SourceId.md) | [http___relation.org_ValidatedBy](../slots/http___relation.org_ValidatedBy.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohDataFormat](../classes/SdohDataFormat.md) | [http___relation.org_UsedIn](../slots/http___relation.org_UsedIn.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohDataFormat](../classes/SdohDataFormat.md) | [skos_broader](../slots/skos_broader.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohDataFormat](../classes/SdohDataFormat.md) | [http___relation.org_Outputs](../slots/http___relation.org_Outputs.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohDataFormat](../classes/SdohDataFormat.md) | [http___relation.org_TargetsLocation](../slots/http___relation.org_TargetsLocation.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohDataFormat](../classes/SdohDataFormat.md) | [http___relation.org_ProvidedBy](../slots/http___relation.org_ProvidedBy.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohDataFormat](../classes/SdohDataFormat.md) | [http___relation.org_MeasuredAt](../slots/http___relation.org_MeasuredAt.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohDataFormat](../classes/SdohDataFormat.md) | [http___relation.org_ComparedTo](../slots/http___relation.org_ComparedTo.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohDataset](../classes/SdohDataset.md) | [http___relation.org_UsedIn](../slots/http___relation.org_UsedIn.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohDataset](../classes/SdohDataset.md) | [http___relation.org_HasSourceType](../slots/http___relation.org_HasSourceType.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohDataset](../classes/SdohDataset.md) | [skos_broader](../slots/skos_broader.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohDataset](../classes/SdohDataset.md) | [http___relation.org_Outputs](../slots/http___relation.org_Outputs.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohDataset](../classes/SdohDataset.md) | [http___relation.org_ComparedTo](../slots/http___relation.org_ComparedTo.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohDataset](../classes/SdohDataset.md) | [http___relation.org_TargetsLocation](../slots/http___relation.org_TargetsLocation.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohDataset](../classes/SdohDataset.md) | [http___relation.org_ProvidedBy](../slots/http___relation.org_ProvidedBy.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohDataset](../classes/SdohDataset.md) | [http___relation.org_MeasuredAt](../slots/http___relation.org_MeasuredAt.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohExperiment](../classes/SdohExperiment.md) | [skos_broader](../slots/skos_broader.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohExperiment](../classes/SdohExperiment.md) | [http___relation.org_Outputs](../slots/http___relation.org_Outputs.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohExperiment](../classes/SdohExperiment.md) | [http___relation.org_ValidatedBy](../slots/http___relation.org_ValidatedBy.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohExperiment](../classes/SdohExperiment.md) | [http___relation.org_ProvidedBy](../slots/http___relation.org_ProvidedBy.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohExperiment](../classes/SdohExperiment.md) | [http___relation.org_UsedIn](../slots/http___relation.org_UsedIn.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohExperiment](../classes/SdohExperiment.md) | [http___relation.org_MountedOn](../slots/http___relation.org_MountedOn.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohExperiment](../classes/SdohExperiment.md) | [http___relation.org_HasParentExperiment](../slots/http___relation.org_HasParentExperiment.md) | range | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohExperiment](../classes/SdohExperiment.md) | [http___relation.org_HasAdditionalAllowedModelComponents](../slots/http___relation.org_HasAdditionalAllowedModelComponents.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohExperiment](../classes/SdohExperiment.md) | [http___relation.org_ComparedTo](../slots/http___relation.org_ComparedTo.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohExperiment](../classes/SdohExperiment.md) | [http___relation.org_RunBy](../slots/http___relation.org_RunBy.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohExperiment](../classes/SdohExperiment.md) | [http___relation.org_TargetsLocation](../slots/http___relation.org_TargetsLocation.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohExperiment](../classes/SdohExperiment.md) | [http___relation.org_HasRequiredModelComponents](../slots/http___relation.org_HasRequiredModelComponents.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohExperiment](../classes/SdohExperiment.md) | [http___relation.org_MeasuredAt](../slots/http___relation.org_MeasuredAt.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohFrequency](../classes/SdohFrequency.md) | [skos_broader](../slots/skos_broader.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohFrequency](../classes/SdohFrequency.md) | [http___relation.org_MeasuredAt](../slots/http___relation.org_MeasuredAt.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohHorizontalResolutionRange](../classes/SdohHorizontalResolutionRange.md) | [skos_broader](../slots/skos_broader.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohHorizontalResolutionRange](../classes/SdohHorizontalResolutionRange.md) | [http___relation.org_MeasuredAt](../slots/http___relation.org_MeasuredAt.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohInstitution](../classes/SdohInstitution.md) | [http___relation.org_UsedIn](../slots/http___relation.org_UsedIn.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohInstitution](../classes/SdohInstitution.md) | [skos_broader](../slots/skos_broader.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohInstitution](../classes/SdohInstitution.md) | [http___relation.org_ComparedTo](../slots/http___relation.org_ComparedTo.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohInstitution](../classes/SdohInstitution.md) | [http___relation.org_Outputs](../slots/http___relation.org_Outputs.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohInstitution](../classes/SdohInstitution.md) | [http___relation.org_TargetsLocation](../slots/http___relation.org_TargetsLocation.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohInstitution](../classes/SdohInstitution.md) | [http___relation.org_MeasuredAt](../slots/http___relation.org_MeasuredAt.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohInstitution](../classes/SdohInstitution.md) | [http___relation.org_ValidatedBy](../slots/http___relation.org_ValidatedBy.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohInstitution](../classes/SdohInstitution.md) | [http___relation.org_ProvidedBy](../slots/http___relation.org_ProvidedBy.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohInstrument](../classes/SdohInstrument.md) | [http___relation.org_UsedIn](../slots/http___relation.org_UsedIn.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohInstrument](../classes/SdohInstrument.md) | [http___relation.org_RunBy](../slots/http___relation.org_RunBy.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohInstrument](../classes/SdohInstrument.md) | [skos_broader](../slots/skos_broader.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohInstrument](../classes/SdohInstrument.md) | [http___relation.org_MountedOn](../slots/http___relation.org_MountedOn.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohInstrument](../classes/SdohInstrument.md) | [http___relation.org_Outputs](../slots/http___relation.org_Outputs.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohInstrument](../classes/SdohInstrument.md) | [http___relation.org_TargetsLocation](../slots/http___relation.org_TargetsLocation.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohInstrument](../classes/SdohInstrument.md) | [http___relation.org_ProvidedBy](../slots/http___relation.org_ProvidedBy.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohInstrument](../classes/SdohInstrument.md) | [http___relation.org_MeasuredAt](../slots/http___relation.org_MeasuredAt.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohInstrument](../classes/SdohInstrument.md) | [http___relation.org_ValidatedBy](../slots/http___relation.org_ValidatedBy.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohInstrument](../classes/SdohInstrument.md) | [http___relation.org_ComparedTo](../slots/http___relation.org_ComparedTo.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohLicense](../classes/SdohLicense.md) | [skos_broader](../slots/skos_broader.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohLocation](../classes/SdohLocation.md) | [http___relation.org_UsedIn](../slots/http___relation.org_UsedIn.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohLocation](../classes/SdohLocation.md) | [http___relation.org_RunBy](../slots/http___relation.org_RunBy.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohLocation](../classes/SdohLocation.md) | [skos_broader](../slots/skos_broader.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohLocation](../classes/SdohLocation.md) | [http___relation.org_MountedOn](../slots/http___relation.org_MountedOn.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohLocation](../classes/SdohLocation.md) | [http___relation.org_Outputs](../slots/http___relation.org_Outputs.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohLocation](../classes/SdohLocation.md) | [http___relation.org_TargetsLocation](../slots/http___relation.org_TargetsLocation.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohLocation](../classes/SdohLocation.md) | [http___relation.org_ProvidedBy](../slots/http___relation.org_ProvidedBy.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohLocation](../classes/SdohLocation.md) | [http___relation.org_MeasuredAt](../slots/http___relation.org_MeasuredAt.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohLocation](../classes/SdohLocation.md) | [http___relation.org_ValidatedBy](../slots/http___relation.org_ValidatedBy.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohLocation](../classes/SdohLocation.md) | [http___relation.org_ComparedTo](../slots/http___relation.org_ComparedTo.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohMeasurementName](../classes/SdohMeasurementName.md) | [http___relation.org_UsedIn](../slots/http___relation.org_UsedIn.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohMeasurementName](../classes/SdohMeasurementName.md) | [skos_broader](../slots/skos_broader.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohMeasurementName](../classes/SdohMeasurementName.md) | [http___relation.org_TargetsLocation](../slots/http___relation.org_TargetsLocation.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohMeasurementName](../classes/SdohMeasurementName.md) | [http___relation.org_MeasuredAt](../slots/http___relation.org_MeasuredAt.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohMeasurementName](../classes/SdohMeasurementName.md) | [http___relation.org_ComparedTo](../slots/http___relation.org_ComparedTo.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohMimeType](../classes/SdohMimeType.md) | [skos_broader](../slots/skos_broader.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohModel](../classes/SdohModel.md) | [http___relation.org_UsedIn](../slots/http___relation.org_UsedIn.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohModel](../classes/SdohModel.md) | [http___relation.org_RunBy](../slots/http___relation.org_RunBy.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohModel](../classes/SdohModel.md) | [skos_broader](../slots/skos_broader.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohModel](../classes/SdohModel.md) | [http___relation.org_ComparedTo](../slots/http___relation.org_ComparedTo.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohModel](../classes/SdohModel.md) | [http___relation.org_Outputs](../slots/http___relation.org_Outputs.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohModel](../classes/SdohModel.md) | [http___relation.org_TargetsLocation](../slots/http___relation.org_TargetsLocation.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohModel](../classes/SdohModel.md) | [http___relation.org_MeasuredAt](../slots/http___relation.org_MeasuredAt.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohModel](../classes/SdohModel.md) | [http___relation.org_ValidatedBy](../slots/http___relation.org_ValidatedBy.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohModel](../classes/SdohModel.md) | [http___relation.org_ProvidedBy](../slots/http___relation.org_ProvidedBy.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohModels](../classes/SdohModels.md) | [http___relation.org_UsedIn](../slots/http___relation.org_UsedIn.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohModels](../classes/SdohModels.md) | [http___relation.org_RunBy](../slots/http___relation.org_RunBy.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohModels](../classes/SdohModels.md) | [skos_broader](../slots/skos_broader.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohModels](../classes/SdohModels.md) | [http___relation.org_ComparedTo](../slots/http___relation.org_ComparedTo.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohModels](../classes/SdohModels.md) | [http___relation.org_Outputs](../slots/http___relation.org_Outputs.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohModels](../classes/SdohModels.md) | [http___relation.org_TargetsLocation](../slots/http___relation.org_TargetsLocation.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohModels](../classes/SdohModels.md) | [http___relation.org_MeasuredAt](../slots/http___relation.org_MeasuredAt.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohModels](../classes/SdohModels.md) | [http___relation.org_ValidatedBy](../slots/http___relation.org_ValidatedBy.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohModels](../classes/SdohModels.md) | [http___relation.org_ProvidedBy](../slots/http___relation.org_ProvidedBy.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohNominalResolution](../classes/SdohNominalResolution.md) | [skos_broader](../slots/skos_broader.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohPlatform](../classes/SdohPlatform.md) | [http___relation.org_UsedIn](../slots/http___relation.org_UsedIn.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohPlatform](../classes/SdohPlatform.md) | [http___relation.org_RunBy](../slots/http___relation.org_RunBy.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohPlatform](../classes/SdohPlatform.md) | [skos_broader](../slots/skos_broader.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohPlatform](../classes/SdohPlatform.md) | [http___relation.org_ComparedTo](../slots/http___relation.org_ComparedTo.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohPlatform](../classes/SdohPlatform.md) | [http___relation.org_MountedOn](../slots/http___relation.org_MountedOn.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohPlatform](../classes/SdohPlatform.md) | [http___relation.org_Outputs](../slots/http___relation.org_Outputs.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohPlatform](../classes/SdohPlatform.md) | [http___relation.org_TargetsLocation](../slots/http___relation.org_TargetsLocation.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohPlatform](../classes/SdohPlatform.md) | [http___relation.org_MeasuredAt](../slots/http___relation.org_MeasuredAt.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohPlatform](../classes/SdohPlatform.md) | [http___relation.org_ProvidedBy](../slots/http___relation.org_ProvidedBy.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohProject](../classes/SdohProject.md) | [http___relation.org_UsedIn](../slots/http___relation.org_UsedIn.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohProject](../classes/SdohProject.md) | [http___relation.org_RunBy](../slots/http___relation.org_RunBy.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohProject](../classes/SdohProject.md) | [skos_broader](../slots/skos_broader.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohProject](../classes/SdohProject.md) | [http___relation.org_MountedOn](../slots/http___relation.org_MountedOn.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohProject](../classes/SdohProject.md) | [http___relation.org_Outputs](../slots/http___relation.org_Outputs.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohProject](../classes/SdohProject.md) | [http___relation.org_TargetsLocation](../slots/http___relation.org_TargetsLocation.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohProject](../classes/SdohProject.md) | [http___relation.org_ProvidedBy](../slots/http___relation.org_ProvidedBy.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohProject](../classes/SdohProject.md) | [http___relation.org_MeasuredAt](../slots/http___relation.org_MeasuredAt.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohProject](../classes/SdohProject.md) | [http___relation.org_ValidatedBy](../slots/http___relation.org_ValidatedBy.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohProject](../classes/SdohProject.md) | [http___relation.org_ComparedTo](../slots/http___relation.org_ComparedTo.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohProvider](../classes/SdohProvider.md) | [http___relation.org_UsedIn](../slots/http___relation.org_UsedIn.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohProvider](../classes/SdohProvider.md) | [skos_broader](../slots/skos_broader.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohProvider](../classes/SdohProvider.md) | [http___relation.org_MountedOn](../slots/http___relation.org_MountedOn.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohProvider](../classes/SdohProvider.md) | [http___relation.org_Outputs](../slots/http___relation.org_Outputs.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohProvider](../classes/SdohProvider.md) | [http___relation.org_TargetsLocation](../slots/http___relation.org_TargetsLocation.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohProvider](../classes/SdohProvider.md) | [http___relation.org_ProvidedBy](../slots/http___relation.org_ProvidedBy.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohProvider](../classes/SdohProvider.md) | [http___relation.org_MeasuredAt](../slots/http___relation.org_MeasuredAt.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohProvider](../classes/SdohProvider.md) | [http___relation.org_ValidatedBy](../slots/http___relation.org_ValidatedBy.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohProvider](../classes/SdohProvider.md) | [http___relation.org_ComparedTo](../slots/http___relation.org_ComparedTo.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohRealm](../classes/SdohRealm.md) | [skos_broader](../slots/skos_broader.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohRelatedUrlContentType](../classes/SdohRelatedUrlContentType.md) | [http___relation.org_UsedIn](../slots/http___relation.org_UsedIn.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohRelatedUrlContentType](../classes/SdohRelatedUrlContentType.md) | [skos_broader](../slots/skos_broader.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohRelatedUrlContentType](../classes/SdohRelatedUrlContentType.md) | [http___relation.org_TargetsLocation](../slots/http___relation.org_TargetsLocation.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohRelatedUrlContentType](../classes/SdohRelatedUrlContentType.md) | [http___relation.org_MeasuredAt](../slots/http___relation.org_MeasuredAt.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohRelatedUrlContentType](../classes/SdohRelatedUrlContentType.md) | [http___relation.org_ComparedTo](../slots/http___relation.org_ComparedTo.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohScienceKeyword](../classes/SdohScienceKeyword.md) | [http___relation.org_UsedIn](../slots/http___relation.org_UsedIn.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohScienceKeyword](../classes/SdohScienceKeyword.md) | [http___relation.org_RunBy](../slots/http___relation.org_RunBy.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohScienceKeyword](../classes/SdohScienceKeyword.md) | [skos_broader](../slots/skos_broader.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohScienceKeyword](../classes/SdohScienceKeyword.md) | [http___relation.org_Outputs](../slots/http___relation.org_Outputs.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohScienceKeyword](../classes/SdohScienceKeyword.md) | [http___relation.org_TargetsLocation](../slots/http___relation.org_TargetsLocation.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohScienceKeyword](../classes/SdohScienceKeyword.md) | [http___relation.org_ProvidedBy](../slots/http___relation.org_ProvidedBy.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohScienceKeyword](../classes/SdohScienceKeyword.md) | [http___relation.org_MeasuredAt](../slots/http___relation.org_MeasuredAt.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohScienceKeyword](../classes/SdohScienceKeyword.md) | [http___relation.org_ComparedTo](../slots/http___relation.org_ComparedTo.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohSourceType](../classes/SdohSourceType.md) | [skos_broader](../slots/skos_broader.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohSubExperimentId](../classes/SdohSubExperimentId.md) | [skos_broader](../slots/skos_broader.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohSubExperimentId](../classes/SdohSubExperimentId.md) | [http___relation.org_TargetsLocation](../slots/http___relation.org_TargetsLocation.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohSubExperimentId](../classes/SdohSubExperimentId.md) | [http___relation.org_MeasuredAt](../slots/http___relation.org_MeasuredAt.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohSubExperimentId](../classes/SdohSubExperimentId.md) | [http___relation.org_ComparedTo](../slots/http___relation.org_ComparedTo.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohTemporalResolutionRange](../classes/SdohTemporalResolutionRange.md) | [http___relation.org_UsedIn](../slots/http___relation.org_UsedIn.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohTemporalResolutionRange](../classes/SdohTemporalResolutionRange.md) | [skos_broader](../slots/skos_broader.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohTemporalResolutionRange](../classes/SdohTemporalResolutionRange.md) | [http___relation.org_TargetsLocation](../slots/http___relation.org_TargetsLocation.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohTemporalResolutionRange](../classes/SdohTemporalResolutionRange.md) | [http___relation.org_MeasuredAt](../slots/http___relation.org_MeasuredAt.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohVariable](../classes/SdohVariable.md) | [http___relation.org_UsedIn](../slots/http___relation.org_UsedIn.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohVariable](../classes/SdohVariable.md) | [skos_broader](../slots/skos_broader.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohVariable](../classes/SdohVariable.md) | [http___relation.org_Outputs](../slots/http___relation.org_Outputs.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohVariable](../classes/SdohVariable.md) | [http___relation.org_TargetsLocation](../slots/http___relation.org_TargetsLocation.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohVariable](../classes/SdohVariable.md) | [http___relation.org_ProvidedBy](../slots/http___relation.org_ProvidedBy.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohVariable](../classes/SdohVariable.md) | [http___relation.org_MeasuredAt](../slots/http___relation.org_MeasuredAt.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohVariable](../classes/SdohVariable.md) | [http___relation.org_ValidatedBy](../slots/http___relation.org_ValidatedBy.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohVariable](../classes/SdohVariable.md) | [http___relation.org_ComparedTo](../slots/http___relation.org_ComparedTo.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohVerticalResolutionRange](../classes/SdohVerticalResolutionRange.md) | [skos_broader](../slots/skos_broader.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SdohPaper](../classes/SdohPaper.md) | [http___relation.org_Mention](../slots/http___relation.org_Mention.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
| [SkosConcept](../classes/SkosConcept.md) | [skos_broader](../slots/skos_broader.md) | any_of[range] | [SdohExperiment](../classes/SdohExperiment.md) |
...
| ---  | ---  |
| self | sdoh:Experiment |
| native | climatepub4-kg/:SdohExperiment |
...
- if you think the class is perfect.
notes:
- Class with 467 occurences.
from_schema: climatepub4-kg
slots:
- skos_broader
- http___relation.org_Outputs
- http___relation.org_ValidatedBy
- http___relation.org_ProvidedBy
- http___relation.org_UsedIn
- http___relation.org_MountedOn
- http___attribute.org_end_year
- http___attribute.org_experiment
- http___relation.org_HasProjectName
- http___relation.org_HasActivity
- skos_prefLabel
- http___relation.org_HasParentActivity
- http___relation.org_HasParentExperiment
- http___relation.org_HasAdditionalAllowedModelComponents
- http___relation.org_ComparedTo
- http___relation.org_RunBy
- http___relation.org_TargetsLocation
- http___relation.org_HasRequiredModelComponents
- http___attribute.org_tier
- http___relation.org_MeasuredAt
- http___attribute.org_start_year
- skos_definition
class_uri: sdoh:Experiment
...
attributes:
  ...
  http___relation.org_Outputs:
    name: http___relation.org_Outputs
    description: TODO -- tell the world what this slot (predicate) describes.
    todos:
    - TODO -- Todos for this slot go here
    - or you can delete the todos
    ...
    examples:
    - value: https://climateKG.org/entity/f2b0301b-2f33-4048-9381-25a92226ed66 http://relation.org/Outputs
        https://climateKG.org/entity/2e0784f1-4c74-4e59-adc9-1245ae47db1e
    - value: https://climateKG.org/entity/d1e2c5e2-076b-4949-8125-384712a33b58 http://relation.org/Outputs
        https://climateKG.org/entity/ae02541a-4968-4573-8569-0f4a02575ab2
    - value: https://climateKG.org/entity/ff0316d3-bbdd-463d-9a23-9f1eb69ca2a9 http://relation.org/Outputs
        https://climateKG.org/entity/2e0784f1-4c74-4e59-adc9-1245ae47db1e
    - value: https://climateKG.org/entity/ea213be5-fe37-4179-9a9b-030c2bf42cf5 http://relation.org/Outputs
        https://climateKG.org/entity/8ad656db-1324-4e92-8273-5a765ca29282
    - value: https://climateKG.org/entity/fa13c1b2-6be4-45c3-aefa-7918575a583d http://relation.org/Outputs
        https://climateKG.org/entity/ab3a6b71-992e-4f21-a383-950c24549214
    - value: https://climateKG.org/entity/06c1281f-e306-4511-bdab-ed6c0694f0f9 http://relation.org/Outputs
        https://climateKG.org/entity/386eb378-1d17-4fdb-b0de-7aec4db7be59
    - value: https://climateKG.org/entity/e660d917-0c77-463c-a15b-e8061ed296f8 http://relation.org/Outputs
        https://climateKG.org/entity/8ad656db-1324-4e92-8273-5a765ca29282
    - value: https://climateKG.org/entity/c88a747b-2302-49c9-b747-f2faa21e2b6b http://relation.org/Outputs
        https://climateKG.org/entity/df4bc930-ae90-41ae-9c8a-606e91572dcb
    - value: https://climateKG.org/entity/eeba88d2-20bf-43b1-bccf-b125485405f4 http://relation.org/Outputs
        https://climateKG.org/entity/f1a25060-330c-4f84-9633-ed59ae8c64bf
    - value: https://climateKG.org/entity/ecd03762-df34-49b7-91f2-d8a51acd270e http://relation.org/Outputs
        https://climateKG.org/entity/b632d0cc-d4b0-458e-a182-16bbd2a5ab05
    - value: https://climateKG.org/entity/9d7eed04-9c49-4024-8d0f-06474cc38bbc http://relation.org/Outputs
        https://climateKG.org/entity/99bfdead-54e1-4ef1-9d59-284a6f730c16
    - value: https://climateKG.org/entity/1411273b-4793-485b-91d6-1da4bfdaef22 http://relation.org/Outputs
    ...
    - value: https://climateKG.org/entity/c266a473-338f-4fe9-965c-f8ae853ff57b http://relation.org/Outputs
        https://climateKG.org/entity/4ea1b3cc-d4d2-4803-a416-753cdd1ec451
    - value: https://climateKG.org/entity/17b1489c-fba7-4252-bf23-b981148343f1 http://relation.org/Outputs
        https://climateKG.org/entity/bbd90aa4-fe5e-4580-a51d-90d7568a9fee
    - value: https://climateKG.org/entity/8680cb49-1637-4a47-a5fd-f39d4e618e45 http://relation.org/Outputs
        https://climateKG.org/entity/23703b6b-ee15-4512-b5b2-f441547e2edf
    - value: https://climateKG.org/entity/47be68db-d10d-43e7-b150-61cfd3f06126 http://relation.org/Outputs
        https://climateKG.org/entity/536a86bd-3dd1-4f4a-9b4a-222a12746db5
    - value: https://climateKG.org/entity/1abdb52f-5a0f-4c6f-8812-f642223f6517 http://relation.org/Outputs
        https://climateKG.org/entity/8f528b66-670d-4198-b014-7fdc9e1f6890
    - value: https://climateKG.org/entity/fc94343c-1809-431f-b3da-8ba5b887dda9 http://relation.org/Outputs
        https://climateKG.org/entity/c297fda0-848a-4a9b-85be-86f29c92f212
    - value: https://climateKG.org/entity/f88c4559-fc4b-4b4a-ac57-0f15bb24e8e0 http://relation.org/Outputs
        https://climateKG.org/entity/a9c4dcab-bbd0-4f67-b2c0-bbbe71b8245e
    - value: https://climateKG.org/entity/8680cb49-1637-4a47-a5fd-f39d4e618e45 http://relation.org/Outputs
        https://climateKG.org/entity/5a7bb095-4d12-4232-bc75-b8e82197cb92
    - value: https://climateKG.org/entity/d738d343-0440-4258-850d-107f9cd8072c http://relation.org/Outputs
        https://climateKG.org/entity/1e97323a-ac5b-4d1d-858f-505b875b3bfb
    - value: https://climateKG.org/entity/ee0fce70-2097-4f5b-853a-c34e6cbff929 http://relation.org/Outputs
        https://climateKG.org/entity/536a86bd-3dd1-4f4a-9b4a-222a12746db5
    - value: https://climateKG.org/entity/5debca96-f263-457f-b013-ecdd358a0fef http://relation.org/Outputs
        https://climateKG.org/entity/08a4f002-f368-414d-b923-83dd498452d8
    - value: https://climateKG.org/entity/2892e23f-5249-439d-8c0e-6c1d190b3beb http://relation.org/Outputs
    ...
    - value: https://climateKG.org/entity/f3b5489d-6723-40bf-bd55-68a0f2fc1874 http://relation.org/Outputs
        https://climateKG.org/entity/e384382c-fb2a-43ea-b064-610e6d4807e9
    - value: https://climateKG.org/entity/dc3f297b-8471-4101-b70e-dc5765762061 http://relation.org/Outputs
        https://climateKG.org/entity/d91ab3c6-89b0-4748-b824-1e3d45e49049
    - value: https://climateKG.org/entity/f4bc60f4-5505-4eb4-83e6-585e0683eac3 http://relation.org/Outputs
        https://climateKG.org/entity/a9c4dcab-bbd0-4f67-b2c0-bbbe71b8245e
    - value: https://climateKG.org/entity/f4bc60f4-5505-4eb4-83e6-585e0683eac3 http://relation.org/Outputs
        https://climateKG.org/entity/8ef6560e-c699-49b4-bcb3-6db68506ca22
    - value: https://climateKG.org/entity/ce460962-f74d-459d-977c-97b6c6f06dd0 http://relation.org/Outputs
    ...
    - value: https://climateKG.org/entity/a394776f-b658-44de-b952-90f4e53d58cc http://relation.org/Outputs
        https://climateKG.org/entity/f50672b3-13d8-4206-b6c9-a1f9891ea470
    - value: https://climateKG.org/entity/b2140059-b3ca-415c-b0a7-3e142783ffe8 http://relation.org/Outputs
        https://climateKG.org/entity/5f69ee7f-5bc3-4974-840b-49998de06860
    - value: https://climateKG.org/entity/64b3edd5-584f-407a-ba30-f6965a00fce3 http://relation.org/Outputs
        https://climateKG.org/entity/3d4e44c4-5d99-4a9b-8388-43c63533ee97
    - value: https://climateKG.org/entity/2e0784f1-4c74-4e59-adc9-1245ae47db1e http://relation.org/Outputs
        https://climateKG.org/entity/536a86bd-3dd1-4f4a-9b4a-222a12746db5
    - value: https://climateKG.org/entity/2e0784f1-4c74-4e59-adc9-1245ae47db1e http://relation.org/Outputs
        https://climateKG.org/entity/e384382c-fb2a-43ea-b064-610e6d4807e9
    - value: https://climateKG.org/entity/2e0784f1-4c74-4e59-adc9-1245ae47db1e http://relation.org/Outputs
    ...
    - value: https://climateKG.org/entity/3449b74c-42f8-47c5-8d12-fc62bf909749 http://relation.org/Outputs
        https://climateKG.org/entity/3ce7f4f0-d2db-4352-8762-d88296f7aa15
    - value: https://climateKG.org/entity/fcc9411c-a1c9-415d-a16c-75c42f2cec45 http://relation.org/Outputs
        https://climateKG.org/entity/5f69ee7f-5bc3-4974-840b-49998de06860
    - value: https://climateKG.org/entity/ff0316d3-bbdd-463d-9a23-9f1eb69ca2a9 http://relation.org/Outputs
    ...
    - value: https://climateKG.org/entity/35d2677c-619a-4a47-a5a7-3feb9973c5ab http://relation.org/Outputs
        https://climateKG.org/entity/8491e067-951e-4cba-9619-d376b5c628a0
    - value: https://climateKG.org/entity/b1c1ea44-000a-4535-8e90-d8dd447371d4 http://relation.org/Outputs
        https://climateKG.org/entity/878e70de-f929-4d2f-9325-145ca95787e9
    - value: https://climateKG.org/entity/fa13c1b2-6be4-45c3-aefa-7918575a583d http://relation.org/Outputs
        https://climateKG.org/entity/536a86bd-3dd1-4f4a-9b4a-222a12746db5
    - value: https://climateKG.org/entity/edfbff1e-b24b-40b9-be54-e1823b4d7f49 http://relation.org/Outputs
    ...
    - value: https://climateKG.org/entity/4315c66b-86e9-4127-a456-e549687012cf http://relation.org/Outputs
        https://climateKG.org/entity/c297fda0-848a-4a9b-85be-86f29c92f212
    - value: https://climateKG.org/entity/fa57b0a0-9723-4195-bdd1-4f26aefa0e07 http://relation.org/Outputs
        https://climateKG.org/entity/3d7ecc4f-e79e-40d1-8796-63059888bf5f
    - value: https://climateKG.org/entity/49c6b17a-73b3-4a88-921e-960c5ceca013 http://relation.org/Outputs
        https://climateKG.org/entity/7f1f0059-de73-4a9e-9200-1bbcd2d6e789
    - value: https://climateKG.org/entity/f1a25060-330c-4f84-9633-ed59ae8c64bf http://relation.org/Outputs
        https://climateKG.org/entity/f1a25060-330c-4f84-9633-ed59ae8c64bf
    - value: https://climateKG.org/entity/fa13c1b2-6be4-45c3-aefa-7918575a583d http://relation.org/Outputs
        https://climateKG.org/entity/8680cb49-1637-4a47-a5fd-f39d4e618e45
    - value: https://climateKG.org/entity/4a3988a7-f1c6-4c0a-a93b-9221adbca49b http://relation.org/Outputs
    ...
    - value: https://climateKG.org/entity/5f69ee7f-5bc3-4974-840b-49998de06860 http://relation.org/Outputs
        https://climateKG.org/entity/d3df0ea0-8954-4bea-aa01-c84c5d32eb54
    - value: https://climateKG.org/entity/c266a473-338f-4fe9-965c-f8ae853ff57b http://relation.org/Outputs
        https://climateKG.org/entity/e2e53a45-c6ee-4fac-9c08-7677c1318533
    - value: https://climateKG.org/entity/67290503-94b9-4517-b5b6-063bba2bee27 http://relation.org/Outputs
        https://climateKG.org/entity/ad73e951-fb5b-4a0b-b034-9469a8bfccaa
    - value: https://climateKG.org/entity/7cc62051-537c-4399-b9b9-b59c1a3e0773 http://relation.org/Outputs
        https://climateKG.org/entity/e4e4dac0-f0aa-4757-989c-70522eb64e76
    - value: https://climateKG.org/entity/7f1f0059-de73-4a9e-9200-1bbcd2d6e789 http://relation.org/Outputs
        https://climateKG.org/entity/49c6b17a-73b3-4a88-921e-960c5ceca013
    - value: https://climateKG.org/entity/82fdb39c-4fe8-4e2b-9dcf-67ceb4c6d8b9 http://relation.org/Outputs
        https://climateKG.org/entity/df4bc930-ae90-41ae-9c8a-606e91572dcb
    - value: https://climateKG.org/entity/df160e31-ae45-41a4-9093-a80fe5303cea http://relation.org/Outputs
        https://climateKG.org/entity/8680cb49-1637-4a47-a5fd-f39d4e618e45
    - value: https://climateKG.org/entity/f2b0301b-2f33-4048-9381-25a92226ed66 http://relation.org/Outputs
    ...
    - value: https://climateKG.org/entity/8ad656db-1324-4e92-8273-5a765ca29282 http://relation.org/Outputs
        https://climateKG.org/entity/c899c6e7-9e0f-461b-a588-584e954233b7
    - value: https://climateKG.org/entity/88bc8b39-ad19-4415-b426-e7d37450341a http://relation.org/Outputs
        https://climateKG.org/entity/e4e4dac0-f0aa-4757-989c-70522eb64e76
    - value: https://climateKG.org/entity/8ad656db-1324-4e92-8273-5a765ca29282 http://relation.org/Outputs
    ...
    - value: https://climateKG.org/entity/d138302a-03b3-4cf7-95db-ac98f863c04f http://relation.org/Outputs
    ...
    - value: https://climateKG.org/entity/a68048f4-181c-4c6c-9bfa-9e4171e9f237 http://relation.org/Outputs
        https://climateKG.org/entity/75820b0a-56f5-4599-be19-ef4f078ca7e9
    - value: https://climateKG.org/entity/a956d045-3b12-441c-8a18-fac7d33b2b4e http://relation.org/Outputs
        https://climateKG.org/entity/4f3c0b04-1fe6-4e11-994a-9cc4afd09ce0
    - value: https://climateKG.org/entity/a9c4dcab-bbd0-4f67-b2c0-bbbe71b8245e http://relation.org/Outputs
        https://climateKG.org/entity/1e97323a-ac5b-4d1d-858f-505b875b3bfb
    - value: https://climateKG.org/entity/ba70b595-5263-4ffd-97a2-f86ba91681ae http://relation.org/Outputs
    ...
    - value: https://climateKG.org/entity/d3df0ea0-8954-4bea-aa01-c84c5d32eb54 http://relation.org/Outputs
        https://climateKG.org/entity/878e70de-f929-4d2f-9325-145ca95787e9
    - value: https://climateKG.org/entity/d559b900-eca6-42a4-9311-0297b2ef98ab http://relation.org/Outputs
        https://climateKG.org/entity/f4bc60f4-5505-4eb4-83e6-585e0683eac3
    - value: https://climateKG.org/entity/df0ba39b-7461-4cee-8660-c80fee72e96b http://relation.org/Outputs
        https://climateKG.org/entity/985a5044-8a57-4274-8936-eb8417513a6e
    - value: https://climateKG.org/entity/df0ba39b-7461-4cee-8660-c80fee72e96b http://relation.org/Outputs
        https://climateKG.org/entity/c297fda0-848a-4a9b-85be-86f29c92f212
    - value: https://climateKG.org/entity/e8df7edd-a176-45c9-8515-3a520948ef63 http://relation.org/Outputs
        https://climateKG.org/entity/ba70b595-5263-4ffd-97a2-f86ba91681ae
    - value: https://climateKG.org/entity/f24c4f33-5b89-4e8d-8de7-296078a7f18a http://relation.org/Outputs
        https://climateKG.org/entity/e5563c99-0fb6-43a9-8e20-6b47b1144394
    - value: https://climateKG.org/entity/f4bc60f4-5505-4eb4-83e6-585e0683eac3 http://relation.org/Outputs
        https://climateKG.org/entity/c297fda0-848a-4a9b-85be-86f29c92f212
    - value: https://climateKG.org/entity/f69374fe-eda2-4223-b130-096220251235 http://relation.org/Outputs
    ...
    from_schema: climatepub4-kg
    rank: 1000
    slot_uri: http://relation.org/Outputs
    alias: http___relation.org_Outputs
    owner: sdoh_Experiment
    domain_of:
    - sdoh_Cmip6_Source_Id
    - sdoh_Data_Format
    ...
    - range: sdoh_Science_Keyword
  http___relation.org_ValidatedBy:
    name: http___relation.org_ValidatedBy
    description: TODO -- tell the world what this slot (predicate) describes.
    todos:
    - TODO -- Todos for this slot go here
    - or you can delete the todos
    ...
    examples:
    - value: https://climateKG.org/entity/063177a9-14cd-4750-9aa4-ad5d266bd7ad http://relation.org/ValidatedBy
        https://climateKG.org/entity/3f037b60-c58c-42df-8f19-32910d0055a5
    - value: https://climateKG.org/entity/17b1489c-fba7-4252-bf23-b981148343f1 http://relation.org/ValidatedBy
        https://climateKG.org/entity/451995e8-a883-4468-abfd-a0e211ca9b72
    - value: https://climateKG.org/entity/1ce21438-4c23-4bb5-b99a-da98622cdd02 http://relation.org/ValidatedBy
        https://climateKG.org/entity/f4bc60f4-5505-4eb4-83e6-585e0683eac3
    - value: https://climateKG.org/entity/bbd90aa4-fe5e-4580-a51d-90d7568a9fee http://relation.org/ValidatedBy
        https://climateKG.org/entity/9cd1c7aa-7949-4b44-bedd-381b1ba9394c
    - value: https://climateKG.org/entity/fc94343c-1809-431f-b3da-8ba5b887dda9 http://relation.org/ValidatedBy
        https://climateKG.org/entity/a9c4dcab-bbd0-4f67-b2c0-bbbe71b8245e
    - value: https://climateKG.org/entity/bb5002a8-6ff2-43dd-b0c9-8f9a76e11cb5 http://relation.org/ValidatedBy
        https://climateKG.org/entity/b62575f6-25e9-4a50-b0f6-a45dbf22c8d4
    - value: https://climateKG.org/entity/2878f334-35dc-47a7-a3ae-8c5da1adccd3 http://relation.org/ValidatedBy
        https://climateKG.org/entity/c5b13fa4-0069-40ce-85cb-bfbab34c2058
    - value: https://climateKG.org/entity/d91ab3c6-89b0-4748-b824-1e3d45e49049 http://relation.org/ValidatedBy
        https://climateKG.org/entity/29dbe37e-22e6-4d02-844f-60359fbbc130
    - value: https://climateKG.org/entity/2be0af28-a6b8-4fce-82e4-1ad86788a4d5 http://relation.org/ValidatedBy
        https://climateKG.org/entity/d91ab3c6-89b0-4748-b824-1e3d45e49049
    - value: https://climateKG.org/entity/3898679c-68f8-42af-bbf1-1400955e0076 http://relation.org/ValidatedBy
        https://climateKG.org/entity/5fd5ccc2-5edb-4823-940d-03a290a5c5fc
    - value: https://climateKG.org/entity/db6471b5-3c29-4a85-bded-cf6e0fbf808d http://relation.org/ValidatedBy
        https://climateKG.org/entity/d1e2c5e2-076b-4949-8125-384712a33b58
    - value: https://climateKG.org/entity/40924daf-07bf-4bab-ac78-9b79be30878e http://relation.org/ValidatedBy
        https://climateKG.org/entity/d1e2c5e2-076b-4949-8125-384712a33b58
    - value: https://climateKG.org/entity/b62469fa-105e-4e2c-b621-5915a86c93e1 http://relation.org/ValidatedBy
        https://climateKG.org/entity/a9c4dcab-bbd0-4f67-b2c0-bbbe71b8245e
    - value: https://climateKG.org/entity/8894d92c-be32-465b-ae08-e5de755a92fc http://relation.org/ValidatedBy
        https://climateKG.org/entity/bb5002a8-6ff2-43dd-b0c9-8f9a76e11cb5
    - value: https://climateKG.org/entity/f4bc60f4-5505-4eb4-83e6-585e0683eac3 http://relation.org/ValidatedBy
        https://climateKG.org/entity/ab08cada-1a8e-4636-b834-18dc35266953
    - value: https://climateKG.org/entity/5b775d6e-de6c-4b11-b986-3c3a32cbf66d http://relation.org/ValidatedBy
        https://climateKG.org/entity/db9b56da-e05f-4d58-b9d5-34edc83ca650
    - value: https://climateKG.org/entity/5f69ee7f-5bc3-4974-840b-49998de06860 http://relation.org/ValidatedBy
        https://climateKG.org/entity/b283a59c-0e9a-469c-baf4-591b64cd4671
    - value: https://climateKG.org/entity/75662ed3-35c5-41ee-abba-51ce435d1b31 http://relation.org/ValidatedBy
        https://climateKG.org/entity/4cc8def9-a825-4ede-9e34-4e11cf89488d
    - value: https://climateKG.org/entity/7b36ad79-8cf3-46a9-b26c-52f3a0f1eac9 http://relation.org/ValidatedBy
        https://climateKG.org/entity/2e0784f1-4c74-4e59-adc9-1245ae47db1e
    - value: https://climateKG.org/entity/7b36ad79-8cf3-46a9-b26c-52f3a0f1eac9 http://relation.org/ValidatedBy
        https://climateKG.org/entity/a9c4dcab-bbd0-4f67-b2c0-bbbe71b8245e
    - value: https://climateKG.org/entity/8ad656db-1324-4e92-8273-5a765ca29282 http://relation.org/ValidatedBy
        https://climateKG.org/entity/4dbe7764-a2ea-4a19-b754-696c35ac3205
    - value: https://climateKG.org/entity/bbd90aa4-fe5e-4580-a51d-90d7568a9fee http://relation.org/ValidatedBy
        https://climateKG.org/entity/3b20a141-8408-44b2-adf1-632ac9222c61
    - value: https://climateKG.org/entity/bf0ddf9c-39ba-4b2d-91ac-63021d644276 http://relation.org/ValidatedBy
        https://climateKG.org/entity/a219dbe6-c095-4002-9fbe-012b31da839c
    - value: https://climateKG.org/entity/d91ab3c6-89b0-4748-b824-1e3d45e49049 http://relation.org/ValidatedBy
        https://climateKG.org/entity/6f346c4c-8c86-4825-a5de-4b3ca8e5de6f
    - value: https://climateKG.org/entity/f4bc60f4-5505-4eb4-83e6-585e0683eac3 http://relation.org/ValidatedBy
        https://climateKG.org/entity/17b1489c-fba7-4252-bf23-b981148343f1
    - value: https://climateKG.org/entity/df0ba39b-7461-4cee-8660-c80fee72e96b http://relation.org/ValidatedBy
        https://climateKG.org/entity/a9c4dcab-bbd0-4f67-b2c0-bbbe71b8245e
    - value: https://climateKG.org/entity/fc94343c-1809-431f-b3da-8ba5b887dda9 http://relation.org/ValidatedBy
        https://climateKG.org/entity/a0b26420-3a13-4742-8d6f-391dc5c49d64
    - value: https://climateKG.org/entity/128c5952-616a-4e81-b961-b98c5af0ec29 http://relation.org/ValidatedBy
        https://climateKG.org/entity/6fb2817f-c3e3-4332-85ad-79f74227e6bc
    from_schema: climatepub4-kg
    rank: 1000
    slot_uri: http://relation.org/ValidatedBy
    alias: http___relation.org_ValidatedBy
    owner: sdoh_Experiment
    domain_of:
    - sdoh_Cmip6_Source_Id
    - sdoh_Experiment
    ...
    - range: sdoh_Science_Keyword
  http___relation.org_ProvidedBy:
    name: http___relation.org_ProvidedBy
    description: TODO -- tell the world what this slot (predicate) describes.
    todos:
    - TODO -- Todos for this slot go here
    - or you can delete the todos
    ...
    - 2 occurrences with subject type sdoh_Models and object type sdoh_Experiment.
    - 3 occurrences with subject type sdoh_Instrument and object type sdoh_Science_Keyword.
    ...
    - 5 occurrences with subject type sdoh_Project and object type sdoh_Models.
    - 1 occurrences with subject type sdoh_Instrument and object type sdoh_Variable.
    ...
    examples:
    - value: https://climateKG.org/entity/f860ed88-991f-4b52-90b9-fc8d4046a598 http://relation.org/ProvidedBy
        https://climateKG.org/entity/7b36ad79-8cf3-46a9-b26c-52f3a0f1eac9
    - value: https://climateKG.org/entity/d91ab3c6-89b0-4748-b824-1e3d45e49049 http://relation.org/ProvidedBy
        https://climateKG.org/entity/28761db9-82fe-4a24-9a89-0fd6047fa1ea
    - value: https://climateKG.org/entity/fa13c1b2-6be4-45c3-aefa-7918575a583d http://relation.org/ProvidedBy
        https://climateKG.org/entity/de76fdb4-9055-4cad-8422-3bae8870e799
    - value: https://climateKG.org/entity/0258d108-269d-409f-b2de-422483fe808e http://relation.org/ProvidedBy
        https://climateKG.org/entity/68885007-d975-4f24-bdd5-dd19b246bdf6
    - value: https://climateKG.org/entity/80122908-8018-4511-810c-dd7aaf639b91 http://relation.org/ProvidedBy
        https://climateKG.org/entity/8f528b66-670d-4198-b014-7fdc9e1f6890
    - value: https://climateKG.org/entity/ff0316d3-bbdd-463d-9a23-9f1eb69ca2a9 http://relation.org/ProvidedBy
        https://climateKG.org/entity/f4bc60f4-5505-4eb4-83e6-585e0683eac3
    - value: https://climateKG.org/entity/0364f832-b1a8-4056-b811-51d3d1fc32ed http://relation.org/ProvidedBy
        https://climateKG.org/entity/bbafe0e9-38c1-4124-9bbd-ce0a83e4ca6e
    - value: https://climateKG.org/entity/ee3e296f-fdc0-4695-95af-dbe63f43b679 http://relation.org/ProvidedBy
        https://climateKG.org/entity/523afb73-9b4c-4478-97e2-a7d5e228e31c
    - value: https://climateKG.org/entity/ecbe9f17-6012-4e39-a707-713973b7d167 http://relation.org/ProvidedBy
        https://climateKG.org/entity/ecbe9f17-6012-4e39-a707-713973b7d167
    - value: https://climateKG.org/entity/bc05d7d2-3c96-4bb6-b759-d45e3c673b86 http://relation.org/ProvidedBy
        https://climateKG.org/entity/c1564b40-d4ae-4e5b-b925-411b93cb68c5
    - value: https://climateKG.org/entity/d9750f06-3784-4058-941f-40289c8d9d8b http://relation.org/ProvidedBy
        https://climateKG.org/entity/c7245882-84a1-4192-acfa-a758b5b9c151
    - value: https://climateKG.org/entity/bd24a9a9-7d52-4c29-b2a0-6cefd216ae78 http://relation.org/ProvidedBy
        https://climateKG.org/entity/de76fdb4-9055-4cad-8422-3bae8870e799
    - value: https://climateKG.org/entity/e66edf58-9a3d-4250-b2ba-9120b943403f http://relation.org/ProvidedBy
        https://climateKG.org/entity/5a7bb095-4d12-4232-bc75-b8e82197cb92
    - value: https://climateKG.org/entity/f1e6caa5-2c97-407d-a0db-7bf01794d8e3 http://relation.org/ProvidedBy
        https://climateKG.org/entity/ecc4a2bb-f195-4296-b300-c1227221b688
    - value: https://climateKG.org/entity/da2c70fd-d92b-45be-b159-b2c10cb387c6 http://relation.org/ProvidedBy
        https://climateKG.org/entity/68447296-6019-453b-9684-3cd3ff1530c9
    - value: https://climateKG.org/entity/ffcca1c5-fffd-4359-b282-e00fc77c979e http://relation.org/ProvidedBy
        https://climateKG.org/entity/1c645150-c046-4652-8f68-11167a19ba91
    - value: https://climateKG.org/entity/df0ab7d8-025d-496d-8d5e-991d208c81fa http://relation.org/ProvidedBy
        https://climateKG.org/entity/c9003d36-020d-4e86-995a-498945576c23
    - value: https://climateKG.org/entity/c9003d36-020d-4e86-995a-498945576c23 http://relation.org/ProvidedBy
        https://climateKG.org/entity/d9fbd2ea-803e-48b7-a1f2-774e6845cc1f
    - value: https://climateKG.org/entity/c19dfe38-1e9d-4cdb-a900-07640628425d http://relation.org/ProvidedBy
        https://climateKG.org/entity/de76fdb4-9055-4cad-8422-3bae8870e799
    - value: https://climateKG.org/entity/8289e024-54f7-4c63-a8ca-e7b1aef80be2 http://relation.org/ProvidedBy
    ...
    - value: https://climateKG.org/entity/160af7da-6036-4af5-ba04-d666df8a0daa http://relation.org/ProvidedBy
        https://climateKG.org/entity/8680cb49-1637-4a47-a5fd-f39d4e618e45
    - value: https://climateKG.org/entity/ba2cf9cf-36c9-421b-bd6e-339e7cef1092 http://relation.org/ProvidedBy
        https://climateKG.org/entity/3be6270c-8554-467a-b2c7-9c13bc086b10
    - value: https://climateKG.org/entity/fb0b9fcd-5c96-4989-8c64-a479bbed83ab http://relation.org/ProvidedBy
        https://climateKG.org/entity/04d24dfe-c9f7-43b6-8bd8-8f2613767257
    - value: https://climateKG.org/entity/c266a473-338f-4fe9-965c-f8ae853ff57b http://relation.org/ProvidedBy
        https://climateKG.org/entity/d9fbd2ea-803e-48b7-a1f2-774e6845cc1f
    - value: https://climateKG.org/entity/fa13c1b2-6be4-45c3-aefa-7918575a583d http://relation.org/ProvidedBy
        https://climateKG.org/entity/ae02541a-4968-4573-8569-0f4a02575ab2
    - value: https://climateKG.org/entity/cbab6fb9-2240-4fb4-97c0-6ec918ddd729 http://relation.org/ProvidedBy
        https://climateKG.org/entity/25f8d5c2-1a32-4453-9421-65c5d9d3d114
    - value: https://climateKG.org/entity/df5ff39e-b49f-4517-afc0-1842a1a6fdc7 http://relation.org/ProvidedBy
        https://climateKG.org/entity/04d24dfe-c9f7-43b6-8bd8-8f2613767257
    - value: https://climateKG.org/entity/ff03e9fc-9882-4a5e-ad0b-830d8f1186cb http://relation.org/ProvidedBy
        https://climateKG.org/entity/d287b7f5-7565-4602-a023-005578328c22
    - value: https://climateKG.org/entity/ffdb1819-43ba-4307-80db-dae705f62a8d http://relation.org/ProvidedBy
        https://climateKG.org/entity/9f36c803-a972-4191-a345-faad9f6cf813
    - value: https://climateKG.org/entity/ff850d62-675c-4386-a375-fe4af92ec3ff http://relation.org/ProvidedBy
        https://climateKG.org/entity/9ac7a1c5-4179-47bc-8589-ebaa90d6cbd1
    - value: https://climateKG.org/entity/f9fd6f89-9a67-4ece-9514-3803e7787520 http://relation.org/ProvidedBy
        https://climateKG.org/entity/45abac35-586f-4fed-ac38-5dcd59af2cc5
    - value: https://climateKG.org/entity/fa57b0a0-9723-4195-bdd1-4f26aefa0e07 http://relation.org/ProvidedBy
        https://climateKG.org/entity/bc320625-d9ba-41f5-9336-57e86fd878f3
    - value: https://climateKG.org/entity/de863e7e-caf7-4beb-ab2e-b9f37d96d534 http://relation.org/ProvidedBy
        https://climateKG.org/entity/04d24dfe-c9f7-43b6-8bd8-8f2613767257
    - value: https://climateKG.org/entity/d0b3505e-77bb-45a0-83fe-787bc3812b67 http://relation.org/ProvidedBy
        https://climateKG.org/entity/3de6fa74-bb80-4bc6-ae60-1e6fe8ae6c67
    - value: https://climateKG.org/entity/ecd03762-df34-49b7-91f2-d8a51acd270e http://relation.org/ProvidedBy
        https://climateKG.org/entity/f1a25060-330c-4f84-9633-ed59ae8c64bf
    - value: https://climateKG.org/entity/25193d98-16dc-47df-a2b1-51bbbdcdbc2e http://relation.org/ProvidedBy
        https://climateKG.org/entity/5ba80ec4-1060-4228-ab97-d7c24980c97e
    - value: https://climateKG.org/entity/d6141f58-40bf-4a59-9fc2-707528e53486 http://relation.org/ProvidedBy
        https://climateKG.org/entity/3be6270c-8554-467a-b2c7-9c13bc086b10
    - value: https://climateKG.org/entity/f4bc60f4-5505-4eb4-83e6-585e0683eac3 http://relation.org/ProvidedBy
        https://climateKG.org/entity/de76fdb4-9055-4cad-8422-3bae8870e799
    - value: https://climateKG.org/entity/f0f5d722-bff7-4811-b834-e012afe7341e http://relation.org/ProvidedBy
        https://climateKG.org/entity/4a426aab-4a95-4bf4-8449-19a72a251541
    - value: https://climateKG.org/entity/c77819e9-f62f-48dc-b924-e7a73b4dcda9 http://relation.org/ProvidedBy
        https://climateKG.org/entity/f6350232-b1c7-458c-bc43-bda357ebb6db
    - value: https://climateKG.org/entity/fc4f2acd-ace7-452b-a540-4162f9e9ddb0 http://relation.org/ProvidedBy
        https://climateKG.org/entity/c9003d36-020d-4e86-995a-498945576c23
    - value: https://climateKG.org/entity/aeec8336-4b23-4f14-a985-9ca0150f1afd http://relation.org/ProvidedBy
        https://climateKG.org/entity/3be6270c-8554-467a-b2c7-9c13bc086b10
    - value: https://climateKG.org/entity/d3df0ea0-8954-4bea-aa01-c84c5d32eb54 http://relation.org/ProvidedBy
    ...
    - value: https://climateKG.org/entity/f9ce1564-0144-43d2-a9dd-bc48edcefb37 http://relation.org/ProvidedBy
        https://climateKG.org/entity/da9cf145-0986-42b4-9ae4-c8b65932ee77
    - value: https://climateKG.org/entity/2892e23f-5249-439d-8c0e-6c1d190b3beb http://relation.org/ProvidedBy
        https://climateKG.org/entity/e9f67a66-e9fc-435c-b720-ae32a2c3d8f5
    - value: https://climateKG.org/entity/fb0b9fcd-5c96-4989-8c64-a479bbed83ab http://relation.org/ProvidedBy
        https://climateKG.org/entity/d3df0ea0-8954-4bea-aa01-c84c5d32eb54
    - value: https://climateKG.org/entity/de76fdb4-9055-4cad-8422-3bae8870e799 http://relation.org/ProvidedBy
        https://climateKG.org/entity/b29b46ad-f05f-4144-b965-5f606ce96963
    - value: https://climateKG.org/entity/e325f579-2d4c-4c72-81f4-30cb8723261a http://relation.org/ProvidedBy
        https://climateKG.org/entity/68057636-bb40-472f-86cd-9b5c01f3c3d0
    - value: https://climateKG.org/entity/2a726c91-2cd0-4b08-a301-30396de71b91 http://relation.org/ProvidedBy
        https://climateKG.org/entity/9221496b-49fb-4998-a932-a51e11bf6cd7
    - value: https://climateKG.org/entity/2ab4134d-1ac7-4421-a7a6-659a542aff4c http://relation.org/ProvidedBy
    ...
    - value: https://climateKG.org/entity/2e0784f1-4c74-4e59-adc9-1245ae47db1e http://relation.org/ProvidedBy
        https://climateKG.org/entity/7f60d215-8aea-467c-9c48-8a88d35da522
    - value: https://climateKG.org/entity/a19e4450-64c4-4687-9080-cebded8a90eb http://relation.org/ProvidedBy
        https://climateKG.org/entity/79841056-b651-439c-b638-439e94731d31
    - value: https://climateKG.org/entity/c9003d36-020d-4e86-995a-498945576c23 http://relation.org/ProvidedBy
        https://climateKG.org/entity/2e0784f1-4c74-4e59-adc9-1245ae47db1e
    - value: https://climateKG.org/entity/ae4dd4b3-9603-4dee-9241-ec1ed2b905bf http://relation.org/ProvidedBy
        https://climateKG.org/entity/ae4dd4b3-9603-4dee-9241-ec1ed2b905bf
    - value: https://climateKG.org/entity/553cf82e-b07f-48c7-b7ae-48809acde89c http://relation.org/ProvidedBy
        https://climateKG.org/entity/2a65dfd1-83e7-4886-a732-316b170522a1
    - value: https://climateKG.org/entity/35d2677c-619a-4a47-a5a7-3feb9973c5ab http://relation.org/ProvidedBy
        https://climateKG.org/entity/3ce7f4f0-d2db-4352-8762-d88296f7aa15
    - value: https://climateKG.org/entity/ea5ccefb-e390-43d5-8202-33e004565beb http://relation.org/ProvidedBy
        https://climateKG.org/entity/8680cb49-1637-4a47-a5fd-f39d4e618e45
    - value: https://climateKG.org/entity/ff0316d3-bbdd-463d-9a23-9f1eb69ca2a9 http://relation.org/ProvidedBy
        https://climateKG.org/entity/666b0926-b509-4680-b551-530d8aaca9ec
    - value: https://climateKG.org/entity/fe2719de-c5c8-4ce6-8230-1d16c8155991 http://relation.org/ProvidedBy
        https://climateKG.org/entity/bc90bc40-2a21-4a6f-9fb9-bf3ae5845157
    - value: https://climateKG.org/entity/b1c1ea44-000a-4535-8e90-d8dd447371d4 http://relation.org/ProvidedBy
        https://climateKG.org/entity/666b0926-b509-4680-b551-530d8aaca9ec
    - value: https://climateKG.org/entity/38fb609b-2a10-4d4f-b2e8-7e51161ec974 http://relation.org/ProvidedBy
        https://climateKG.org/entity/59920ad4-85fb-4cee-ba56-f39bc5857a3d
    - value: https://climateKG.org/entity/d9fbd2ea-803e-48b7-a1f2-774e6845cc1f http://relation.org/ProvidedBy
        https://climateKG.org/entity/6fb2817f-c3e3-4332-85ad-79f74227e6bc
    - value: https://climateKG.org/entity/3be6270c-8554-467a-b2c7-9c13bc086b10 http://relation.org/ProvidedBy
    ...
    - value: https://climateKG.org/entity/e8df7edd-a176-45c9-8515-3a520948ef63 http://relation.org/ProvidedBy
        https://climateKG.org/entity/f88c4559-fc4b-4b4a-ac57-0f15bb24e8e0
    - value: https://climateKG.org/entity/ae02541a-4968-4573-8569-0f4a02575ab2 http://relation.org/ProvidedBy
        https://climateKG.org/entity/c5b13fa4-0069-40ce-85cb-bfbab34c2058
    - value: https://climateKG.org/entity/fe37b7a7-b6ca-4880-8dcf-16973cd8ecc8 http://relation.org/ProvidedBy
        https://climateKG.org/entity/eab3419f-a0c2-4d55-9500-87ee00600291
    - value: https://climateKG.org/entity/3970129f-8bb5-49bb-8517-1532f0a0f828 http://relation.org/ProvidedBy
        https://climateKG.org/entity/c9003d36-020d-4e86-995a-498945576c23
    - value: https://climateKG.org/entity/fea56568-3eb7-4527-a8bb-112d5d721e11 http://relation.org/ProvidedBy
        https://climateKG.org/entity/f4bc60f4-5505-4eb4-83e6-585e0683eac3
    - value: https://climateKG.org/entity/432d2336-1111-4305-a8cb-8d0c8a3af632 http://relation.org/ProvidedBy
        https://climateKG.org/entity/45abac35-586f-4fed-ac38-5dcd59af2cc5
    - value: https://climateKG.org/entity/efcb13d4-ce68-4d42-8cc5-932ac3ef6126 http://relation.org/ProvidedBy
        https://climateKG.org/entity/59920ad4-85fb-4cee-ba56-f39bc5857a3d
    - value: https://climateKG.org/entity/b1c1ea44-000a-4535-8e90-d8dd447371d4 http://relation.org/ProvidedBy
        https://climateKG.org/entity/d6aec072-daf9-4f96-b667-6c7831cf6bdd
    - value: https://climateKG.org/entity/f959e3c5-f014-40b7-a134-4d41b616f79d http://relation.org/ProvidedBy
        https://climateKG.org/entity/d4c65f0d-f825-4040-8dd3-69b85979101a
    - value: https://climateKG.org/entity/b1c1ea44-000a-4535-8e90-d8dd447371d4 http://relation.org/ProvidedBy
        https://climateKG.org/entity/d9fbd2ea-803e-48b7-a1f2-774e6845cc1f
    - value: https://climateKG.org/entity/45abac35-586f-4fed-ac38-5dcd59af2cc5 http://relation.org/ProvidedBy
    ...
    - value: https://climateKG.org/entity/f4bc60f4-5505-4eb4-83e6-585e0683eac3 http://relation.org/ProvidedBy
        https://climateKG.org/entity/f1a25060-330c-4f84-9633-ed59ae8c64bf
    - value: https://climateKG.org/entity/f9837873-62cd-402c-af8b-571876942a83 http://relation.org/ProvidedBy
        https://climateKG.org/entity/de76fdb4-9055-4cad-8422-3bae8870e799
    - value: https://climateKG.org/entity/f083ae80-224b-4453-8a18-d1b13d9d2f90 http://relation.org/ProvidedBy
        https://climateKG.org/entity/f4bc60f4-5505-4eb4-83e6-585e0683eac3
    - value: https://climateKG.org/entity/a956d045-3b12-441c-8a18-fac7d33b2b4e http://relation.org/ProvidedBy
    ...
    - value: https://climateKG.org/entity/fa57b0a0-9723-4195-bdd1-4f26aefa0e07 http://relation.org/ProvidedBy
        https://climateKG.org/entity/3d7ecc4f-e79e-40d1-8796-63059888bf5f
    - value: https://climateKG.org/entity/b30ecade-ec88-4f0e-9482-532a2ceeb0d5 http://relation.org/ProvidedBy
        https://climateKG.org/entity/df0ab7d8-025d-496d-8d5e-991d208c81fa
    - value: https://climateKG.org/entity/57441436-5372-484e-983c-f96cbc51ef72 http://relation.org/ProvidedBy
        https://climateKG.org/entity/10c24d93-c480-42fc-a438-4600e2d14a77
    - value: https://climateKG.org/entity/5796ebd9-7dcb-4968-b876-1e678484cc62 http://relation.org/ProvidedBy
    ...
    - value: https://climateKG.org/entity/88dc22d3-1fb6-471a-94de-56acb94f0f58 http://relation.org/ProvidedBy
        https://climateKG.org/entity/666b0926-b509-4680-b551-530d8aaca9ec
    - value: https://climateKG.org/entity/7c5a2cb8-495a-4d32-b9ef-a54f43192712 http://relation.org/ProvidedBy
        https://climateKG.org/entity/51233a6a-ba89-4a05-8692-0934edbadcba
    - value: https://climateKG.org/entity/e236abe1-c8c5-4bca-ab7d-89b5a0392d6b http://relation.org/ProvidedBy
        https://climateKG.org/entity/d91ab3c6-89b0-4748-b824-1e3d45e49049
    - value: https://climateKG.org/entity/fc94343c-1809-431f-b3da-8ba5b887dda9 http://relation.org/ProvidedBy
        https://climateKG.org/entity/ef36cb15-ad64-4bdc-9331-42cc5b493671
    - value: https://climateKG.org/entity/8f528b66-670d-4198-b014-7fdc9e1f6890 http://relation.org/ProvidedBy
        https://climateKG.org/entity/de76fdb4-9055-4cad-8422-3bae8870e799
    - value: https://climateKG.org/entity/68885007-d975-4f24-bdd5-dd19b246bdf6 http://relation.org/ProvidedBy
        https://climateKG.org/entity/68885007-d975-4f24-bdd5-dd19b246bdf6
    - value: https://climateKG.org/entity/74d079b5-9b36-45c9-9b09-7e3646b65a85 http://relation.org/ProvidedBy
    ...
    - value: https://climateKG.org/entity/820f2f42-79e8-4ea5-be0b-b828766e11ad http://relation.org/ProvidedBy
        https://climateKG.org/entity/b631f7b6-9a64-4f2b-bd29-7a20a466e44b
    - value: https://climateKG.org/entity/8289e024-54f7-4c63-a8ca-e7b1aef80be2 http://relation.org/ProvidedBy
        https://climateKG.org/entity/ac392872-1571-4bfd-94dd-81f93d9f1fd0
    - value: https://climateKG.org/entity/8a106157-e0a0-4a3e-bed1-4ce3b8e06151 http://relation.org/ProvidedBy
        https://climateKG.org/entity/d9fbd2ea-803e-48b7-a1f2-774e6845cc1f
    - value: https://climateKG.org/entity/d6141f58-40bf-4a59-9fc2-707528e53486 http://relation.org/ProvidedBy
        https://climateKG.org/entity/a6212424-1146-4a79-a14c-8ce88543b08b
    - value: https://climateKG.org/entity/c72fe5bf-6ec6-48bc-9888-257db1daf0af http://relation.org/ProvidedBy
        https://climateKG.org/entity/d1e2c5e2-076b-4949-8125-384712a33b58
    - value: https://climateKG.org/entity/878e70de-f929-4d2f-9325-145ca95787e9 http://relation.org/ProvidedBy
        https://climateKG.org/entity/d3df0ea0-8954-4bea-aa01-c84c5d32eb54
    - value: https://climateKG.org/entity/910d9fdb-84fe-4f62-9172-41888cc181a4 http://relation.org/ProvidedBy
        https://climateKG.org/entity/d0c16581-6951-4e8d-a0c1-97e9fcaa031a
    - value: https://climateKG.org/entity/9af548c9-7050-4d59-b66d-adf52f2fb242 http://relation.org/ProvidedBy
        https://climateKG.org/entity/da2c70fd-d92b-45be-b159-b2c10cb387c6
    - value: https://climateKG.org/entity/df0ba39b-7461-4cee-8660-c80fee72e96b http://relation.org/ProvidedBy
        https://climateKG.org/entity/8f528b66-670d-4198-b014-7fdc9e1f6890
    - value: https://climateKG.org/entity/a0b26420-3a13-4742-8d6f-391dc5c49d64 http://relation.org/ProvidedBy
        https://climateKG.org/entity/25f8d5c2-1a32-4453-9421-65c5d9d3d114
    - value: https://climateKG.org/entity/a2904083-1e32-4086-b028-a2afc2ffd443 http://relation.org/ProvidedBy
        https://climateKG.org/entity/32f12730-2c26-43e7-a357-dee6ff4b1764
    - value: https://climateKG.org/entity/bff6b593-1884-4aea-87a1-36f606d3a020 http://relation.org/ProvidedBy
        https://climateKG.org/entity/b62575f6-25e9-4a50-b0f6-a45dbf22c8d4
    - value: https://climateKG.org/entity/c9003d36-020d-4e86-995a-498945576c23 http://relation.org/ProvidedBy
        https://climateKG.org/entity/45abac35-586f-4fed-ac38-5dcd59af2cc5
    - value: https://climateKG.org/entity/ac392872-1571-4bfd-94dd-81f93d9f1fd0 http://relation.org/ProvidedBy
        https://climateKG.org/entity/45abac35-586f-4fed-ac38-5dcd59af2cc5
    - value: https://climateKG.org/entity/b7eb8278-0dc3-4121-87ea-14173279dfb4 http://relation.org/ProvidedBy
        https://climateKG.org/entity/68057636-bb40-472f-86cd-9b5c01f3c3d0
    - value: https://climateKG.org/entity/b1c1ea44-000a-4535-8e90-d8dd447371d4 http://relation.org/ProvidedBy
        https://climateKG.org/entity/553cf82e-b07f-48c7-b7ae-48809acde89c
    - value: https://climateKG.org/entity/b8a877b7-d867-4305-9053-3777e5dd330a http://relation.org/ProvidedBy
        https://climateKG.org/entity/85510ccc-5dc9-44ff-871e-775e856714f8
    - value: https://climateKG.org/entity/c5b13fa4-0069-40ce-85cb-bfbab34c2058 http://relation.org/ProvidedBy
        https://climateKG.org/entity/bbafe0e9-38c1-4124-9bbd-ce0a83e4ca6e
    - value: https://climateKG.org/entity/d0b3505e-77bb-45a0-83fe-787bc3812b67 http://relation.org/ProvidedBy
        https://climateKG.org/entity/085edf65-1c8c-414a-b8e4-a1a08ff08f22
    - value: https://climateKG.org/entity/d0b3505e-77bb-45a0-83fe-787bc3812b67 http://relation.org/ProvidedBy
        https://climateKG.org/entity/74d079b5-9b36-45c9-9b09-7e3646b65a85
    - value: https://climateKG.org/entity/d1e2c5e2-076b-4949-8125-384712a33b58 http://relation.org/ProvidedBy
        https://climateKG.org/entity/4270e57b-0ed2-43ab-9a7a-cd09e3983691
    - value: https://climateKG.org/entity/d3df0ea0-8954-4bea-aa01-c84c5d32eb54 http://relation.org/ProvidedBy
        https://climateKG.org/entity/45abac35-586f-4fed-ac38-5dcd59af2cc5
    - value: https://climateKG.org/entity/d3df0ea0-8954-4bea-aa01-c84c5d32eb54 http://relation.org/ProvidedBy
        https://climateKG.org/entity/8680cb49-1637-4a47-a5fd-f39d4e618e45
    - value: https://climateKG.org/entity/f36d71c6-f2ad-49c4-809f-09b4f0688412 http://relation.org/ProvidedBy
    ...
    - value: https://climateKG.org/entity/dd747113-048d-4ed1-aa70-23a7bf528077 http://relation.org/ProvidedBy
        https://climateKG.org/entity/45abac35-586f-4fed-ac38-5dcd59af2cc5
    - value: https://climateKG.org/entity/f4bc60f4-5505-4eb4-83e6-585e0683eac3 http://relation.org/ProvidedBy
    ...
    - value: https://climateKG.org/entity/ee016d07-002a-4c22-b05b-5ead6121ed3f http://relation.org/ProvidedBy
    ...
    from_schema: climatepub4-kg
    rank: 1000
    slot_uri: http://relation.org/ProvidedBy
    alias: http___relation.org_ProvidedBy
    owner: sdoh_Experiment
    domain_of:
    - sdoh_Activity
    - sdoh_Cmip6_Source_Id
    ...
    - range: sdoh_Science_Keyword
  http___relation.org_UsedIn:
    name: http___relation.org_UsedIn
    description: TODO -- tell the world what this slot (predicate) describes.
    todos:
    - TODO -- Todos for this slot go here
    - or you can delete the todos
    ...
    - 1 occurrences with subject type sdoh_Variable and object type sdoh_Project.
    - 4 occurrences with subject type sdoh_Instrument and object type sdoh_Data_Format.
    ...
    examples:
    - value: https://climateKG.org/entity/f8845bec-c628-4185-aac1-4af22481c024 http://relation.org/UsedIn
        https://climateKG.org/entity/bfbfd84c-6bf0-412f-9e75-1bad5241c339
    - value: https://climateKG.org/entity/f1e6caa5-2c97-407d-a0db-7bf01794d8e3 http://relation.org/UsedIn
        https://climateKG.org/entity/8894d92c-be32-465b-ae08-e5de755a92fc
    - value: https://climateKG.org/entity/f1a25060-330c-4f84-9633-ed59ae8c64bf http://relation.org/UsedIn
        https://climateKG.org/entity/ae02541a-4968-4573-8569-0f4a02575ab2
    - value: https://climateKG.org/entity/fa13c1b2-6be4-45c3-aefa-7918575a583d http://relation.org/UsedIn
    ...
    - value: https://climateKG.org/entity/f88c4559-fc4b-4b4a-ac57-0f15bb24e8e0 http://relation.org/UsedIn
        https://climateKG.org/entity/cbab6fb9-2240-4fb4-97c0-6ec918ddd729
    - value: https://climateKG.org/entity/ff0316d3-bbdd-463d-9a23-9f1eb69ca2a9 http://relation.org/UsedIn
        https://climateKG.org/entity/88dc22d3-1fb6-471a-94de-56acb94f0f58
    - value: https://climateKG.org/entity/ff0316d3-bbdd-463d-9a23-9f1eb69ca2a9 http://relation.org/UsedIn
        https://climateKG.org/entity/f4bc60f4-5505-4eb4-83e6-585e0683eac3
    - value: https://climateKG.org/entity/fe4392b0-13a9-43ff-bacc-f44a65aed4fa http://relation.org/UsedIn
        https://climateKG.org/entity/d91ab3c6-89b0-4748-b824-1e3d45e49049
    - value: https://climateKG.org/entity/fe4392b0-13a9-43ff-bacc-f44a65aed4fa http://relation.org/UsedIn
        https://climateKG.org/entity/31ca2413-f257-4ceb-849a-68538efecfee
    - value: https://climateKG.org/entity/f1e6caa5-2c97-407d-a0db-7bf01794d8e3 http://relation.org/UsedIn
        https://climateKG.org/entity/b62575f6-25e9-4a50-b0f6-a45dbf22c8d4
    - value: https://climateKG.org/entity/d1e2c5e2-076b-4949-8125-384712a33b58 http://relation.org/UsedIn
        https://climateKG.org/entity/d91ab3c6-89b0-4748-b824-1e3d45e49049
    - value: https://climateKG.org/entity/f860ed88-991f-4b52-90b9-fc8d4046a598 http://relation.org/UsedIn
        https://climateKG.org/entity/68885007-d975-4f24-bdd5-dd19b246bdf6
    - value: https://climateKG.org/entity/fe37b7a7-b6ca-4880-8dcf-16973cd8ecc8 http://relation.org/UsedIn
        https://climateKG.org/entity/fcc9411c-a1c9-415d-a16c-75c42f2cec45
    - value: https://climateKG.org/entity/fb23c170-9164-40cf-aed0-5a3fbd531fad http://relation.org/UsedIn
        https://climateKG.org/entity/8b7f66ea-d481-4641-9dbf-da90ca3ad9c9
    - value: https://climateKG.org/entity/fb0b9fcd-5c96-4989-8c64-a479bbed83ab http://relation.org/UsedIn
    ...
    - value: https://climateKG.org/entity/c266a473-338f-4fe9-965c-f8ae853ff57b http://relation.org/UsedIn
    ...
    - value: https://climateKG.org/entity/78fb5691-136d-40f8-a834-6e6f4cd768ff http://relation.org/UsedIn
        https://climateKG.org/entity/ea936862-2c98-41e5-8514-6b7288a5f941
    - value: https://climateKG.org/entity/085edf65-1c8c-414a-b8e4-a1a08ff08f22 http://relation.org/UsedIn
        https://climateKG.org/entity/a96e6cd6-0f35-491d-8198-7551d03e1cbc
    - value: https://climateKG.org/entity/ed925b43-db83-4cbb-8347-3dc0081bb8f4 http://relation.org/UsedIn
        https://climateKG.org/entity/00ce4800-70ef-4346-aa15-0554280d0896
    - value: https://climateKG.org/entity/d1e2c5e2-076b-4949-8125-384712a33b58 http://relation.org/UsedIn
        https://climateKG.org/entity/f4bc60f4-5505-4eb4-83e6-585e0683eac3
    - value: https://climateKG.org/entity/ae02541a-4968-4573-8569-0f4a02575ab2 http://relation.org/UsedIn
        https://climateKG.org/entity/063177a9-14cd-4750-9aa4-ad5d266bd7ad
    - value: https://climateKG.org/entity/c297fda0-848a-4a9b-85be-86f29c92f212 http://relation.org/UsedIn
        https://climateKG.org/entity/24b382cb-5ed5-46f5-9134-1e34462f9f20
    - value: https://climateKG.org/entity/f083ae80-224b-4453-8a18-d1b13d9d2f90 http://relation.org/UsedIn
        https://climateKG.org/entity/89bb4e2b-dd39-44ed-a4d3-2b205e9fa68a
    - value: https://climateKG.org/entity/0cd4d2c4-ebfa-4759-b7aa-f9982122f581 http://relation.org/UsedIn
        https://climateKG.org/entity/db06b2a9-4ed5-4222-8533-fbf3ed3bdc23
    - value: https://climateKG.org/entity/0de668aa-cc97-482d-a0eb-cddcb1a705b6 http://relation.org/UsedIn
        https://climateKG.org/entity/4e366444-01ea-4517-9d93-56f55ddf41b7
    - value: https://climateKG.org/entity/fd03d204-4391-4e98-8142-8b8efa235231 http://relation.org/UsedIn
    ...
    - value: https://climateKG.org/entity/cf3d1728-7606-4561-a0dd-116b4dbec21f http://relation.org/UsedIn
        https://climateKG.org/entity/78369c58-beaa-46f2-b286-dd2540634556
    - value: https://climateKG.org/entity/bd24a9a9-7d52-4c29-b2a0-6cefd216ae78 http://relation.org/UsedIn
        https://climateKG.org/entity/8680cb49-1637-4a47-a5fd-f39d4e618e45
    - value: https://climateKG.org/entity/d2e93932-0231-4b23-af2f-217c6315a95e http://relation.org/UsedIn
        https://climateKG.org/entity/f4f7a865-befc-439b-8b6d-bb43ba772ba9
    - value: https://climateKG.org/entity/2e0784f1-4c74-4e59-adc9-1245ae47db1e http://relation.org/UsedIn
        https://climateKG.org/entity/ff0316d3-bbdd-463d-9a23-9f1eb69ca2a9
    - value: https://climateKG.org/entity/160af7da-6036-4af5-ba04-d666df8a0daa http://relation.org/UsedIn
        https://climateKG.org/entity/79841056-b651-439c-b638-439e94731d31
    - value: https://climateKG.org/entity/2e0784f1-4c74-4e59-adc9-1245ae47db1e http://relation.org/UsedIn
        https://climateKG.org/entity/d1e2c5e2-076b-4949-8125-384712a33b58
    - value: https://climateKG.org/entity/2e0784f1-4c74-4e59-adc9-1245ae47db1e http://relation.org/UsedIn
        https://climateKG.org/entity/ae02541a-4968-4573-8569-0f4a02575ab2
    - value: https://climateKG.org/entity/fa57b0a0-9723-4195-bdd1-4f26aefa0e07 http://relation.org/UsedIn
        https://climateKG.org/entity/0399b52c-e3de-4dcc-9eb6-b1e3acf2cf1b
    - value: https://climateKG.org/entity/162e2243-3266-4999-b352-d8a1a9dc82ac http://relation.org/UsedIn
        https://climateKG.org/entity/bbafe0e9-38c1-4124-9bbd-ce0a83e4ca6e
    - value: https://climateKG.org/entity/defd2c00-64e3-4986-9061-feade19f972f http://relation.org/UsedIn
        https://climateKG.org/entity/c5b13fa4-0069-40ce-85cb-bfbab34c2058
    - value: https://climateKG.org/entity/f6e72cf4-b814-4c7d-a013-9e499bcdc773 http://relation.org/UsedIn
        https://climateKG.org/entity/c46d59a8-d874-4db8-87f5-d59ecbb79a29
    - value: https://climateKG.org/entity/ef36cb15-ad64-4bdc-9331-42cc5b493671 http://relation.org/UsedIn
        https://climateKG.org/entity/0b4081fa-5233-4484-bc82-706976defa0e
    - value: https://climateKG.org/entity/1f697c83-969d-48ee-87b8-245b11f7e24f http://relation.org/UsedIn
        https://climateKG.org/entity/dcef091b-18b5-48bf-b191-69ab7a3511f1
    - value: https://climateKG.org/entity/eb784368-9b92-49b0-afc5-ea820e996f33 http://relation.org/UsedIn
        https://climateKG.org/entity/fa57b0a0-9723-4195-bdd1-4f26aefa0e07
    - value: https://climateKG.org/entity/f1a25060-330c-4f84-9633-ed59ae8c64bf http://relation.org/UsedIn
        https://climateKG.org/entity/fa57b0a0-9723-4195-bdd1-4f26aefa0e07
    - value: https://climateKG.org/entity/7f1f0059-de73-4a9e-9200-1bbcd2d6e789 http://relation.org/UsedIn
        https://climateKG.org/entity/c8a4a768-cdad-42ab-b2b5-3100440ffd8f
    - value: https://climateKG.org/entity/cbab6fb9-2240-4fb4-97c0-6ec918ddd729 http://relation.org/UsedIn
        https://climateKG.org/entity/8f528b66-670d-4198-b014-7fdc9e1f6890
    - value: https://climateKG.org/entity/543135bc-7749-49ca-89af-b108cac1afaa http://relation.org/UsedIn
        https://climateKG.org/entity/e9f67a66-e9fc-435c-b720-ae32a2c3d8f5
    - value: https://climateKG.org/entity/cb8f849f-bbe5-4c62-9a50-d729718ad980 http://relation.org/UsedIn
        https://climateKG.org/entity/08684c69-224d-4c4a-a1a7-ea3933ac9081
    - value: https://climateKG.org/entity/f4bc60f4-5505-4eb4-83e6-585e0683eac3 http://relation.org/UsedIn
        https://climateKG.org/entity/e8df7edd-a176-45c9-8515-3a520948ef63
    - value: https://climateKG.org/entity/3d4e44c4-5d99-4a9b-8388-43c63533ee97 http://relation.org/UsedIn
        https://climateKG.org/entity/2e0784f1-4c74-4e59-adc9-1245ae47db1e
    - value: https://climateKG.org/entity/ecc4a2bb-f195-4296-b300-c1227221b688 http://relation.org/UsedIn
        https://climateKG.org/entity/f1a25060-330c-4f84-9633-ed59ae8c64bf
    - value: https://climateKG.org/entity/2b890e5b-1b50-4454-90a9-538dd891da9a http://relation.org/UsedIn
        https://climateKG.org/entity/aef9855c-70e1-4e22-aa25-8ccd23176d3b
    - value: https://climateKG.org/entity/df160e31-ae45-41a4-9093-a80fe5303cea http://relation.org/UsedIn
        https://climateKG.org/entity/3668de06-8a7d-4667-beb8-d04dcac619b0
    - value: https://climateKG.org/entity/fdb04105-e8ba-4a83-9c35-ed3c931ccc9f http://relation.org/UsedIn
        https://climateKG.org/entity/f1a25060-330c-4f84-9633-ed59ae8c64bf
    - value: https://climateKG.org/entity/2e0784f1-4c74-4e59-adc9-1245ae47db1e http://relation.org/UsedIn
    ...
    - value: https://climateKG.org/entity/fc94343c-1809-431f-b3da-8ba5b887dda9 http://relation.org/UsedIn
        https://climateKG.org/entity/ef36cb15-ad64-4bdc-9331-42cc5b493671
    - value: https://climateKG.org/entity/f24c4f33-5b89-4e8d-8de7-296078a7f18a http://relation.org/UsedIn
        https://climateKG.org/entity/2bfd42f1-0453-4c33-a21e-74df3ad64813
    - value: https://climateKG.org/entity/f959e3c5-f014-40b7-a134-4d41b616f79d http://relation.org/UsedIn
        https://climateKG.org/entity/267b7dc6-ffae-4d76-a145-bca4e80313b3
    - value: https://climateKG.org/entity/9830be3b-80ea-4e8c-af46-526882b7f26d http://relation.org/UsedIn
    ...
    - value: https://climateKG.org/entity/d0b3505e-77bb-45a0-83fe-787bc3812b67 http://relation.org/UsedIn
        https://climateKG.org/entity/ff03e9fc-9882-4a5e-ad0b-830d8f1186cb
    - value: https://climateKG.org/entity/3ce7f4f0-d2db-4352-8762-d88296f7aa15 http://relation.org/UsedIn
        https://climateKG.org/entity/1f697c83-969d-48ee-87b8-245b11f7e24f
    - value: https://climateKG.org/entity/ba008542-5c6f-462a-8ddf-21e54cbf3034 http://relation.org/UsedIn
        https://climateKG.org/entity/88dc22d3-1fb6-471a-94de-56acb94f0f58
    - value: https://climateKG.org/entity/3de6fa74-bb80-4bc6-ae60-1e6fe8ae6c67 http://relation.org/UsedIn
        https://climateKG.org/entity/7471c00f-60c7-4ac3-a6db-d49020f22014
    - value: https://climateKG.org/entity/aef9855c-70e1-4e22-aa25-8ccd23176d3b http://relation.org/UsedIn
        https://climateKG.org/entity/4e366444-01ea-4517-9d93-56f55ddf41b7
    - value: https://climateKG.org/entity/fb0b9fcd-5c96-4989-8c64-a479bbed83ab http://relation.org/UsedIn
        https://climateKG.org/entity/b7eb8278-0dc3-4121-87ea-14173279dfb4
    - value: https://climateKG.org/entity/46e4aaa4-349c-4049-a910-035391360010 http://relation.org/UsedIn
        https://climateKG.org/entity/82fdb39c-4fe8-4e2b-9dcf-67ceb4c6d8b9
    - value: https://climateKG.org/entity/a463163e-8e86-4086-8b10-8fd6a95fca4a http://relation.org/UsedIn
        https://climateKG.org/entity/418a8c09-a533-4f9a-ac4b-7078107980bf
    - value: https://climateKG.org/entity/5a5c7e50-e5a0-45f2-be81-0cb96b32cb1e http://relation.org/UsedIn
        https://climateKG.org/entity/dfc20833-d79a-4976-91fd-db9f3efc7822
    - value: https://climateKG.org/entity/f3b5489d-6723-40bf-bd55-68a0f2fc1874 http://relation.org/UsedIn
    ...
    - value: https://climateKG.org/entity/9221496b-49fb-4998-a932-a51e11bf6cd7 http://relation.org/UsedIn
        https://climateKG.org/entity/13df63e8-85ad-405d-9b43-256371e259c0
    - value: https://climateKG.org/entity/8f528b66-670d-4198-b014-7fdc9e1f6890 http://relation.org/UsedIn
        https://climateKG.org/entity/5796ebd9-7dcb-4968-b876-1e678484cc62
    - value: https://climateKG.org/entity/88dc22d3-1fb6-471a-94de-56acb94f0f58 http://relation.org/UsedIn
    ...
    - value: https://climateKG.org/entity/9221496b-49fb-4998-a932-a51e11bf6cd7 http://relation.org/UsedIn
        https://climateKG.org/entity/f4bc60f4-5505-4eb4-83e6-585e0683eac3
    - value: https://climateKG.org/entity/652349bd-f6f9-4c8d-8573-d71e05ad1208 http://relation.org/UsedIn
        https://climateKG.org/entity/e660d917-0c77-463c-a15b-e8061ed296f8
    - value: https://climateKG.org/entity/d3055f47-258e-4556-a885-54cd1fff4680 http://relation.org/UsedIn
        https://climateKG.org/entity/a90306f0-353c-4083-941a-0973a6fd6584
    - value: https://climateKG.org/entity/6231402a-7e4c-42d9-802d-7184eb812f46 http://relation.org/UsedIn
    ...
    - value: https://climateKG.org/entity/afd62c36-fd25-4673-a56d-85be8d47f3d0 http://relation.org/UsedIn
        https://climateKG.org/entity/c7245882-84a1-4192-acfa-a758b5b9c151
    - value: https://climateKG.org/entity/6cb96c3b-1a1c-4d26-a894-2638d5cd05d1 http://relation.org/UsedIn
        https://climateKG.org/entity/c7e7fb38-44ef-4c5b-aa1d-b3fdcf89d838
    - value: https://climateKG.org/entity/6f7a0a68-6387-4f49-84ea-9652139018f5 http://relation.org/UsedIn
        https://climateKG.org/entity/f4bc60f4-5505-4eb4-83e6-585e0683eac3
    - value: https://climateKG.org/entity/df0ba39b-7461-4cee-8660-c80fee72e96b http://relation.org/UsedIn
        https://climateKG.org/entity/ba7cc1c1-c5ef-43ff-9a2e-84629f0a94fa
    - value: https://climateKG.org/entity/785f7c57-93c9-4fe0-8309-ff32aa59a637 http://relation.org/UsedIn
        https://climateKG.org/entity/67290503-94b9-4517-b5b6-063bba2bee27
    - value: https://climateKG.org/entity/a68048f4-181c-4c6c-9bfa-9e4171e9f237 http://relation.org/UsedIn
        https://climateKG.org/entity/160af7da-6036-4af5-ba04-d666df8a0daa
    - value: https://climateKG.org/entity/7c5420a6-94e2-40ca-9dff-20309090d327 http://relation.org/UsedIn
        https://climateKG.org/entity/d91ab3c6-89b0-4748-b824-1e3d45e49049
    - value: https://climateKG.org/entity/804d4f03-ee93-4fc9-ada0-f3dc9a7a6706 http://relation.org/UsedIn
        https://climateKG.org/entity/2892e23f-5249-439d-8c0e-6c1d190b3beb
    - value: https://climateKG.org/entity/8491e067-951e-4cba-9619-d376b5c628a0 http://relation.org/UsedIn
        https://climateKG.org/entity/afd62c36-fd25-4673-a56d-85be8d47f3d0
    - value: https://climateKG.org/entity/8680cb49-1637-4a47-a5fd-f39d4e618e45 http://relation.org/UsedIn
        https://climateKG.org/entity/160af7da-6036-4af5-ba04-d666df8a0daa
    - value: https://climateKG.org/entity/8680cb49-1637-4a47-a5fd-f39d4e618e45 http://relation.org/UsedIn
    ...
    - value: https://climateKG.org/entity/90c21a67-6703-4b59-96ee-c2c602652c80 http://relation.org/UsedIn
        https://climateKG.org/entity/ca240508-9cd7-400e-9420-ad96f72195bd
    - value: https://climateKG.org/entity/914cbb7e-5b20-4bcd-86e3-ffcfa26f0a73 http://relation.org/UsedIn
        https://climateKG.org/entity/5612b95e-cc41-4286-9946-e78506f70f59
    - value: https://climateKG.org/entity/99ef187e-6940-4c10-8d65-00d4426d493b http://relation.org/UsedIn
        https://climateKG.org/entity/fbc53539-ce4e-4e3e-bbd2-8270386616b4
    - value: https://climateKG.org/entity/e1078fd4-fa6b-4c35-81ee-648bc086e9c5 http://relation.org/UsedIn
        https://climateKG.org/entity/f4bc60f4-5505-4eb4-83e6-585e0683eac3
    - value: https://climateKG.org/entity/a96e6cd6-0f35-491d-8198-7551d03e1cbc http://relation.org/UsedIn
        https://climateKG.org/entity/d6464d91-2373-456f-85a7-a5019bdb1076
    - value: https://climateKG.org/entity/a9c4dcab-bbd0-4f67-b2c0-bbbe71b8245e http://relation.org/UsedIn
        https://climateKG.org/entity/eb539ad7-79ee-4d76-8e38-b298b2385626
    - value: https://climateKG.org/entity/cb8f849f-bbe5-4c62-9a50-d729718ad980 http://relation.org/UsedIn
        https://climateKG.org/entity/4315c66b-86e9-4127-a456-e549687012cf
    - value: https://climateKG.org/entity/b62469fa-105e-4e2c-b621-5915a86c93e1 http://relation.org/UsedIn
        https://climateKG.org/entity/d1e2c5e2-076b-4949-8125-384712a33b58
    - value: https://climateKG.org/entity/b6782a30-639e-4d70-8290-81683d248b1f http://relation.org/UsedIn
        https://climateKG.org/entity/e5a658d5-74db-4022-894f-edc8d297767a
    - value: https://climateKG.org/entity/ba70b595-5263-4ffd-97a2-f86ba91681ae http://relation.org/UsedIn
        https://climateKG.org/entity/a9c4dcab-bbd0-4f67-b2c0-bbbe71b8245e
    - value: https://climateKG.org/entity/bac2e743-1d02-4868-8bd6-b8b8741e3794 http://relation.org/UsedIn
        https://climateKG.org/entity/5668f6df-ab5a-4991-9720-dda2faae7f3e
    - value: https://climateKG.org/entity/bbafe0e9-38c1-4124-9bbd-ce0a83e4ca6e http://relation.org/UsedIn
        https://climateKG.org/entity/8ad656db-1324-4e92-8273-5a765ca29282
    - value: https://climateKG.org/entity/c9003d36-020d-4e86-995a-498945576c23 http://relation.org/UsedIn
        https://climateKG.org/entity/e23b4757-38f3-4be1-8d70-035dacb782f6
    - value: https://climateKG.org/entity/d0c16581-6951-4e8d-a0c1-97e9fcaa031a http://relation.org/UsedIn
        https://climateKG.org/entity/b62575f6-25e9-4a50-b0f6-a45dbf22c8d4
    - value: https://climateKG.org/entity/fb0b9fcd-5c96-4989-8c64-a479bbed83ab http://relation.org/UsedIn
        https://climateKG.org/entity/0de668aa-cc97-482d-a0eb-cddcb1a705b6
    - value: https://climateKG.org/entity/d3df0ea0-8954-4bea-aa01-c84c5d32eb54 http://relation.org/UsedIn
        https://climateKG.org/entity/2ca1b865-5555-4375-aa81-72811335b695
    - value: https://climateKG.org/entity/d4548c1b-c0b1-47a9-a2ea-6000baa98647 http://relation.org/UsedIn
        https://climateKG.org/entity/e3f2ed37-dfb2-4d74-9aa7-efe0d67fdd54
    - value: https://climateKG.org/entity/d91ab3c6-89b0-4748-b824-1e3d45e49049 http://relation.org/UsedIn
        https://climateKG.org/entity/1f1436a3-ac80-48e1-abbe-095fc74c9655
    - value: https://climateKG.org/entity/d9fbd2ea-803e-48b7-a1f2-774e6845cc1f http://relation.org/UsedIn
        https://climateKG.org/entity/b971f45d-3a45-4ef2-99df-d6b88bbc7cc3
    - value: https://climateKG.org/entity/f4bc60f4-5505-4eb4-83e6-585e0683eac3 http://relation.org/UsedIn
        https://climateKG.org/entity/9221496b-49fb-4998-a932-a51e11bf6cd7
    - value: https://climateKG.org/entity/ecc4a2bb-f195-4296-b300-c1227221b688 http://relation.org/UsedIn
        https://climateKG.org/entity/4e366444-01ea-4517-9d93-56f55ddf41b7
    - value: https://climateKG.org/entity/e236abe1-c8c5-4bca-ab7d-89b5a0392d6b http://relation.org/UsedIn
        https://climateKG.org/entity/88dc22d3-1fb6-471a-94de-56acb94f0f58
    - value: https://climateKG.org/entity/e23b4757-38f3-4be1-8d70-035dacb782f6 http://relation.org/UsedIn
        https://climateKG.org/entity/c9003d36-020d-4e86-995a-498945576c23
    - value: https://climateKG.org/entity/e8df433e-f868-4ad1-97e7-8610d60a86e3 http://relation.org/UsedIn
    ...
    - value: https://climateKG.org/entity/f4f7a865-befc-439b-8b6d-bb43ba772ba9 http://relation.org/UsedIn
        https://climateKG.org/entity/33f20afe-5ce2-43e9-9676-c5f664fbc324
    - value: https://climateKG.org/entity/ff0316d3-bbdd-463d-9a23-9f1eb69ca2a9 http://relation.org/UsedIn
        https://climateKG.org/entity/afd62c36-fd25-4673-a56d-85be8d47f3d0
    from_schema: climatepub4-kg
    rank: 1000
    slot_uri: http://relation.org/UsedIn
    alias: http___relation.org_UsedIn
    owner: sdoh_Experiment
    domain_of:
    - sdoh_Activity
    - sdoh_Chronostratigraphic_Unit
  ...
  http___relation.org_ComparedTo:
    ...
    - 2 occurrences with subject type sdoh_Model and object type sdoh_Measurement_Name.
    - 17 occurrences with subject type sdoh_Chronostratigraphic_Unit and object type
      sdoh_Chronostratigraphic_Unit.
    ...
    - 3 occurrences with subject type sdoh_Activity and object type sdoh_Project.
    - 1 occurrences with subject type sdoh_Provider and object type sdoh_Model.
    - 5 occurrences with subject type sdoh_Chronostratigraphic_Unit and object type
      sdoh_Experiment.
    ...
    - value: https://climateKG.org/entity/ca154e02-a226-4cc7-8e4a-4474e7eb1eeb http://relation.org/ComparedTo
        https://climateKG.org/entity/4f3c0b04-1fe6-4e11-994a-9cc4afd09ce0
    - value: https://climateKG.org/entity/ce35e51d-6949-400a-889b-4673b8c9a503 http://relation.org/ComparedTo
        https://climateKG.org/entity/502ea6bd-45e9-45af-9092-a4cbe6ba2e7e
    - value: https://climateKG.org/entity/d3df0ea0-8954-4bea-aa01-c84c5d32eb54 http://relation.org/ComparedTo
        https://climateKG.org/entity/b1c1ea44-000a-4535-8e90-d8dd447371d4
    - value: https://climateKG.org/entity/d3df0ea0-8954-4bea-aa01-c84c5d32eb54 http://relation.org/ComparedTo
        https://climateKG.org/entity/d3df0ea0-8954-4bea-aa01-c84c5d32eb54
    - value: https://climateKG.org/entity/d4ac49a1-9ba5-4a90-a033-2ef317028352 http://relation.org/ComparedTo
        https://climateKG.org/entity/16e234b5-5ecb-4e03-b4ec-7a5e03db8017
    - value: https://climateKG.org/entity/d6141f58-40bf-4a59-9fc2-707528e53486 http://relation.org/ComparedTo
        https://climateKG.org/entity/ce35e51d-6949-400a-889b-4673b8c9a503
    - value: https://climateKG.org/entity/fa13c1b2-6be4-45c3-aefa-7918575a583d http://relation.org/ComparedTo
        https://climateKG.org/entity/2e0784f1-4c74-4e59-adc9-1245ae47db1e
    - value: https://climateKG.org/entity/e2e53a45-c6ee-4fac-9c08-7677c1318533 http://relation.org/ComparedTo
        https://climateKG.org/entity/4e366444-01ea-4517-9d93-56f55ddf41b7
    - value: https://climateKG.org/entity/e8df7edd-a176-45c9-8515-3a520948ef63 http://relation.org/ComparedTo
        https://climateKG.org/entity/4315c66b-86e9-4127-a456-e549687012cf
    - value: https://climateKG.org/entity/e8df7edd-a176-45c9-8515-3a520948ef63 http://relation.org/ComparedTo
        https://climateKG.org/entity/8894d92c-be32-465b-ae08-e5de755a92fc
    - value: https://climateKG.org/entity/dc9fcd27-58ac-4705-a522-6475d59cfb81 http://relation.org/ComparedTo
        https://climateKG.org/entity/063177a9-14cd-4750-9aa4-ad5d266bd7ad
    - value: https://climateKG.org/entity/ddcd5941-9ba8-4c39-a498-1e214d1bfa6e http://relation.org/ComparedTo
        https://climateKG.org/entity/74d079b5-9b36-45c9-9b09-7e3646b65a85
    - value: https://climateKG.org/entity/fc94343c-1809-431f-b3da-8ba5b887dda9 http://relation.org/ComparedTo
        https://climateKG.org/entity/df0ba39b-7461-4cee-8660-c80fee72e96b
    - value: https://climateKG.org/entity/fabeb7da-9d33-450e-83b0-5c3651d1e4a1 http://relation.org/ComparedTo
        https://climateKG.org/entity/e2e53a45-c6ee-4fac-9c08-7677c1318533
    - value: https://climateKG.org/entity/ee0fce70-2097-4f5b-853a-c34e6cbff929 http://relation.org/ComparedTo
    ...
    from_schema: climatepub4-kg
    rank: 1000
    slot_uri: http://relation.org/ComparedTo
    alias: http___relation.org_ComparedTo
    owner: sdoh_Experiment
    domain_of:
    - sdoh_Activity
    - sdoh_Chronostratigraphic_Unit
    ...
    - range: sdoh_Science_Keyword
  http___relation.org_RunBy:
    name: http___relation.org_RunBy
    description: TODO -- tell the world what this slot (predicate) describes.
    todos:
    - TODO -- Todos for this slot go here
    - or you can delete the todos
    ...
    - 1 occurrences with subject type sdoh_Location and object type sdoh_Instrument.
    ...
    examples:
    - value: https://climateKG.org/entity/d1e2c5e2-076b-4949-8125-384712a33b58 http://relation.org/RunBy
        https://climateKG.org/entity/68885007-d975-4f24-bdd5-dd19b246bdf6
    - value: https://climateKG.org/entity/00bb59aa-755d-4710-a097-f1e2836f4032 http://relation.org/RunBy
        https://climateKG.org/entity/91294ff2-2621-4976-98c7-b159a056d6f9
    - value: https://climateKG.org/entity/ec994afa-ecd4-4d25-9e8b-335cd982755c http://relation.org/RunBy
        https://climateKG.org/entity/d1e2c5e2-076b-4949-8125-384712a33b58
    - value: https://climateKG.org/entity/ff0316d3-bbdd-463d-9a23-9f1eb69ca2a9 http://relation.org/RunBy
        https://climateKG.org/entity/666b0926-b509-4680-b551-530d8aaca9ec
    - value: https://climateKG.org/entity/e1b54a28-af57-47ad-8291-bdbf723481b1 http://relation.org/RunBy
        https://climateKG.org/entity/ebb8ef06-0f73-48eb-bc22-47f36a729bc6
    - value: https://climateKG.org/entity/eb5e5d7d-2d63-4818-b6bc-80456f2e6ace http://relation.org/RunBy
        https://climateKG.org/entity/7f1f0059-de73-4a9e-9200-1bbcd2d6e789
    - value: https://climateKG.org/entity/b62575f6-25e9-4a50-b0f6-a45dbf22c8d4 http://relation.org/RunBy
        https://climateKG.org/entity/d69f7457-db31-48ce-b8c2-98058c412bc6
    - value: https://climateKG.org/entity/8ad656db-1324-4e92-8273-5a765ca29282 http://relation.org/RunBy
        https://climateKG.org/entity/87f323af-19b8-422b-9e21-f33287b37d3a
    - value: https://climateKG.org/entity/f1c35c74-0b10-46de-9c06-efeda92d383a http://relation.org/RunBy
        https://climateKG.org/entity/35d2677c-619a-4a47-a5a7-3feb9973c5ab
    - value: https://climateKG.org/entity/fa13c1b2-6be4-45c3-aefa-7918575a583d http://relation.org/RunBy
        https://climateKG.org/entity/a6212424-1146-4a79-a14c-8ce88543b08b
    - value: https://climateKG.org/entity/5af07204-b327-4fd3-9f00-74b628deee62 http://relation.org/RunBy
        https://climateKG.org/entity/f4bc60f4-5505-4eb4-83e6-585e0683eac3
    - value: https://climateKG.org/entity/e384382c-fb2a-43ea-b064-610e6d4807e9 http://relation.org/RunBy
        https://climateKG.org/entity/e1b54a28-af57-47ad-8291-bdbf723481b1
    - value: https://climateKG.org/entity/35d2677c-619a-4a47-a5a7-3feb9973c5ab http://relation.org/RunBy
        https://climateKG.org/entity/83ec2082-64bb-48d7-bcd2-454f082d608e
    - value: https://climateKG.org/entity/3668de06-8a7d-4667-beb8-d04dcac619b0 http://relation.org/RunBy
        https://climateKG.org/entity/a1135cb4-a824-4e32-b5b1-7c0633d5f817
    - value: https://climateKG.org/entity/386eb378-1d17-4fdb-b0de-7aec4db7be59 http://relation.org/RunBy
        https://climateKG.org/entity/bd24a9a9-7d52-4c29-b2a0-6cefd216ae78
    - value: https://climateKG.org/entity/e384382c-fb2a-43ea-b064-610e6d4807e9 http://relation.org/RunBy
        https://climateKG.org/entity/3ce7f4f0-d2db-4352-8762-d88296f7aa15
    - value: https://climateKG.org/entity/ba008542-5c6f-462a-8ddf-21e54cbf3034 http://relation.org/RunBy
        https://climateKG.org/entity/00bb59aa-755d-4710-a097-f1e2836f4032
    - value: https://climateKG.org/entity/3ce7f4f0-d2db-4352-8762-d88296f7aa15 http://relation.org/RunBy
        https://climateKG.org/entity/88dc22d3-1fb6-471a-94de-56acb94f0f58
    - value: https://climateKG.org/entity/40b2663d-1313-4382-bb13-016b14fc1f14 http://relation.org/RunBy
        https://climateKG.org/entity/75820b0a-56f5-4599-be19-ef4f078ca7e9
    - value: https://climateKG.org/entity/4c94cb2e-37fb-4a76-a69b-a9d0731dbe3c http://relation.org/RunBy
        https://climateKG.org/entity/5796ebd9-7dcb-4968-b876-1e678484cc62
    - value: https://climateKG.org/entity/4fad64ce-32fe-413d-8b55-c78000d1980c http://relation.org/RunBy
        https://climateKG.org/entity/ae02541a-4968-4573-8569-0f4a02575ab2
    - value: https://climateKG.org/entity/666b0926-b509-4680-b551-530d8aaca9ec http://relation.org/RunBy
        https://climateKG.org/entity/d3594523-ba0d-4275-b121-95039f905058
    - value: https://climateKG.org/entity/71f69b1f-f00c-4303-809b-027d58ebacf5 http://relation.org/RunBy
        https://climateKG.org/entity/b62575f6-25e9-4a50-b0f6-a45dbf22c8d4
    - value: https://climateKG.org/entity/df0ba39b-7461-4cee-8660-c80fee72e96b http://relation.org/RunBy
        https://climateKG.org/entity/7f1f0059-de73-4a9e-9200-1bbcd2d6e789
    - value: https://climateKG.org/entity/785f7c57-93c9-4fe0-8309-ff32aa59a637 http://relation.org/RunBy
        https://climateKG.org/entity/0cd4d2c4-ebfa-4759-b7aa-f9982122f581
    - value: https://climateKG.org/entity/d69f7457-db31-48ce-b8c2-98058c412bc6 http://relation.org/RunBy
        https://climateKG.org/entity/d1e2c5e2-076b-4949-8125-384712a33b58
    - value: https://climateKG.org/entity/eaa0bc43-e283-4bf1-ba20-ca32850a66ef http://relation.org/RunBy
        https://climateKG.org/entity/3ce7f4f0-d2db-4352-8762-d88296f7aa15
    - value: https://climateKG.org/entity/7f1f0059-de73-4a9e-9200-1bbcd2d6e789 http://relation.org/RunBy
        https://climateKG.org/entity/f4bc60f4-5505-4eb4-83e6-585e0683eac3
    - value: https://climateKG.org/entity/81103299-c23d-4a11-9a04-c1041fea5d1b http://relation.org/RunBy
        https://climateKG.org/entity/81103299-c23d-4a11-9a04-c1041fea5d1b
    - value: https://climateKG.org/entity/82af9cb6-cc72-435d-adbe-4a823aabbbcd http://relation.org/RunBy
        https://climateKG.org/entity/75820b0a-56f5-4599-be19-ef4f078ca7e9
    - value: https://climateKG.org/entity/8680cb49-1637-4a47-a5fd-f39d4e618e45 http://relation.org/RunBy
        https://climateKG.org/entity/386eb378-1d17-4fdb-b0de-7aec4db7be59
    - value: https://climateKG.org/entity/a228b67f-0791-470b-a4ca-71b8da279332 http://relation.org/RunBy
        https://climateKG.org/entity/162e2243-3266-4999-b352-d8a1a9dc82ac
    - value: https://climateKG.org/entity/8894d92c-be32-465b-ae08-e5de755a92fc http://relation.org/RunBy
        https://climateKG.org/entity/bb6184eb-1ced-44fb-9668-d57cf1baa2e3
    - value: https://climateKG.org/entity/88dc22d3-1fb6-471a-94de-56acb94f0f58 http://relation.org/RunBy
        https://climateKG.org/entity/d1e2c5e2-076b-4949-8125-384712a33b58
    - value: https://climateKG.org/entity/98e5a7e4-b946-474a-8214-c1b7b3e5f976 http://relation.org/RunBy
        https://climateKG.org/entity/bb18f75e-6305-4be3-b12e-27aeef7d3fe5
    - value: https://climateKG.org/entity/fa57b0a0-9723-4195-bdd1-4f26aefa0e07 http://relation.org/RunBy
        https://climateKG.org/entity/5c2c4a55-5576-4811-9daf-ac981d68e14d
    - value: https://climateKG.org/entity/d0081284-5cef-484d-b1ee-a6787b197a33 http://relation.org/RunBy
        https://climateKG.org/entity/a659fc9d-9d6a-4e47-b052-9270baa48dd4
    - value: https://climateKG.org/entity/a9c4dcab-bbd0-4f67-b2c0-bbbe71b8245e http://relation.org/RunBy
        https://climateKG.org/entity/1e97323a-ac5b-4d1d-858f-505b875b3bfb
    - value: https://climateKG.org/entity/d1e2c5e2-076b-4949-8125-384712a33b58 http://relation.org/RunBy
        https://climateKG.org/entity/f4bc60f4-5505-4eb4-83e6-585e0683eac3
    - value: https://climateKG.org/entity/d57a6f6d-507c-4af1-9bd1-c4e962394a04 http://relation.org/RunBy
        https://climateKG.org/entity/b7bc737c-15de-4b67-9bc3-5fa7c2b651d5
    - value: https://climateKG.org/entity/d91ab3c6-89b0-4748-b824-1e3d45e49049 http://relation.org/RunBy
        https://climateKG.org/entity/1f697c83-969d-48ee-87b8-245b11f7e24f
    - value: https://climateKG.org/entity/ff0316d3-bbdd-463d-9a23-9f1eb69ca2a9 http://relation.org/RunBy
        https://climateKG.org/entity/ff0316d3-bbdd-463d-9a23-9f1eb69ca2a9
    - value: https://climateKG.org/entity/e3f2ed37-dfb2-4d74-9aa7-efe0d67fdd54 http://relation.org/RunBy
        https://climateKG.org/entity/d0c16581-6951-4e8d-a0c1-97e9fcaa031a
    - value: https://climateKG.org/entity/ea213be5-fe37-4179-9a9b-030c2bf42cf5 http://relation.org/RunBy
        https://climateKG.org/entity/87624706-e11f-4043-ac54-479ed94b8dac
    - value: https://climateKG.org/entity/f2b0301b-2f33-4048-9381-25a92226ed66 http://relation.org/RunBy
        https://climateKG.org/entity/2b424588-9bb6-418a-b1c7-06b93be4ba28
    - value: https://climateKG.org/entity/f2c510b5-e0dc-413f-a7a2-35791cb07090 http://relation.org/RunBy
        https://climateKG.org/entity/f2c510b5-e0dc-413f-a7a2-35791cb07090
    - value: https://climateKG.org/entity/f4bc60f4-5505-4eb4-83e6-585e0683eac3 http://relation.org/RunBy
        https://climateKG.org/entity/82af9cb6-cc72-435d-adbe-4a823aabbbcd
    - value: https://climateKG.org/entity/ff0316d3-bbdd-463d-9a23-9f1eb69ca2a9 http://relation.org/RunBy
        https://climateKG.org/entity/e000088a-8252-4603-ba55-38189c45612c
    from_schema: climatepub4-kg
    rank: 1000
    slot_uri: http://relation.org/RunBy
    alias: http___relation.org_RunBy
    owner: sdoh_Experiment
    domain_of:
    - sdoh_Activity
    - sdoh_Chronostratigraphic_Unit
  ...
  http___relation.org_TargetsLocation:
    ...
    - 4 occurrences with subject type sdoh_Chronostratigraphic_Unit and object type
      sdoh_Chronostratigraphic_Unit.
    - 1 occurrences with subject type sdoh_Chronostratigraphic_Unit and object type
      sdoh_Experiment.
    ...
    - 6 occurrences with subject type sdoh_Chronostratigraphic_Unit and object type
      sdoh_Instrument.
    ...
    - value: https://climateKG.org/entity/bbafe0e9-38c1-4124-9bbd-ce0a83e4ca6e http://relation.org/TargetsLocation
        https://climateKG.org/entity/fa13c1b2-6be4-45c3-aefa-7918575a583d
    - value: https://climateKG.org/entity/bbeba5ce-f6b2-437c-be1b-a0dca73b7f33 http://relation.org/TargetsLocation
        https://climateKG.org/entity/db06b2a9-4ed5-4222-8533-fbf3ed3bdc23
    - value: https://climateKG.org/entity/c08833fc-c16a-4a35-bb4a-d8716865b196 http://relation.org/TargetsLocation
        https://climateKG.org/entity/2e0784f1-4c74-4e59-adc9-1245ae47db1e
    - value: https://climateKG.org/entity/c266a473-338f-4fe9-965c-f8ae853ff57b http://relation.org/TargetsLocation
        https://climateKG.org/entity/29f386e9-84fb-4e5d-9733-20233c63b1be
    - value: https://climateKG.org/entity/d0c16581-6951-4e8d-a0c1-97e9fcaa031a http://relation.org/TargetsLocation
        https://climateKG.org/entity/6a7eed90-327a-4609-b952-c9617445a1d1
    - value: https://climateKG.org/entity/db28e274-27f4-4006-a363-32a98eab859d http://relation.org/TargetsLocation
        https://climateKG.org/entity/7c5420a6-94e2-40ca-9dff-20309090d327
    - value: https://climateKG.org/entity/e000088a-8252-4603-ba55-38189c45612c http://relation.org/TargetsLocation
        https://climateKG.org/entity/d896a8cc-4fce-4a8d-86bc-185b324fab2b
    - value: https://climateKG.org/entity/e2203a61-1ef4-4e3d-b7aa-98e7867f8b7c http://relation.org/TargetsLocation
        https://climateKG.org/entity/8e4900ff-c7bc-47a1-aa55-a8892696d769
    - value: https://climateKG.org/entity/fa13c1b2-6be4-45c3-aefa-7918575a583d http://relation.org/TargetsLocation
        https://climateKG.org/entity/c266a473-338f-4fe9-965c-f8ae853ff57b
    - value: https://climateKG.org/entity/e660d917-0c77-463c-a15b-e8061ed296f8 http://relation.org/TargetsLocation
        https://climateKG.org/entity/88dc22d3-1fb6-471a-94de-56acb94f0f58
    - value: https://climateKG.org/entity/e8df7edd-a176-45c9-8515-3a520948ef63 http://relation.org/TargetsLocation
        https://climateKG.org/entity/be92ce0f-2f1f-4649-a3b2-36360964187a
    - value: https://climateKG.org/entity/ee3e296f-fdc0-4695-95af-dbe63f43b679 http://relation.org/TargetsLocation
        https://climateKG.org/entity/386eb378-1d17-4fdb-b0de-7aec4db7be59
    - value: https://climateKG.org/entity/f2c510b5-e0dc-413f-a7a2-35791cb07090 http://relation.org/TargetsLocation
        https://climateKG.org/entity/e384382c-fb2a-43ea-b064-610e6d4807e9
    - value: https://climateKG.org/entity/f4bc60f4-5505-4eb4-83e6-585e0683eac3 http://relation.org/TargetsLocation
    ...
    - value: https://climateKG.org/entity/f4bc60f4-5505-4eb4-83e6-585e0683eac3 http://relation.org/TargetsLocation
        https://climateKG.org/entity/640d703f-9312-4f11-8367-30a8bd8fc508
    - value: https://climateKG.org/entity/f69374fe-eda2-4223-b130-096220251235 http://relation.org/TargetsLocation
        https://climateKG.org/entity/4e366444-01ea-4517-9d93-56f55ddf41b7
    - value: https://climateKG.org/entity/f4f7a865-befc-439b-8b6d-bb43ba772ba9 http://relation.org/TargetsLocation
        https://climateKG.org/entity/86b8b121-d710-4c5b-84b0-7b40717f6c76
    from_schema: climatepub4-kg
    rank: 1000
    slot_uri: http://relation.org/TargetsLocation
    alias: http___relation.org_TargetsLocation
    owner: sdoh_Experiment
    domain_of:
    - sdoh_Activity
    - sdoh_Chronostratigraphic_Unit
  ...
  skos_definition:
    ...
    - if you think the class is perfect.
    comments:
    - 368 occurrences with subject type sdoh_Location and object type string.
    - 2792 occurrences with subject type sdoh_Science_Keyword and object type string.
    - 1114 occurrences with subject type sdoh_Platform and object type string.
    - 24 occurrences with subject type sdoh_Activity and object type string.
    - 141 occurrences with subject type sdoh_Model and object type string.
    - 422 occurrences with subject type sdoh_Experiment and object type string.
    - 3483 occurrences with subject type sdoh_Provider and object type string.
    - 1913 occurrences with subject type sdoh_Instrument and object type string.
    - 1560 occurrences with subject type sdoh_Project and object type string.
    - 168 occurrences with subject type sdoh_Chronostratigraphic_Unit and object type
      string.
    - 93 occurrences with subject type sdoh_Measurement_Name and object type string.
    - 75 occurrences with subject type sdoh_Institution and object type string.
    - 54 occurrences with subject type sdoh_Sub_Experiment_Id and object type string.
    - 37 occurrences with subject type sdoh_Models and object type string.
    - 187 occurrences with subject type sdoh_Data_Format and object type string.
    - 1280 occurrences with subject type sdoh_Variable and object type string.
    - 134 occurrences with subject type sdoh_Cmip6_Source_Id and object type string.
    - 5 occurrences with subject type sdoh_Source_Type and object type string.
    - 106 occurrences with subject type sdoh_Dataset and object type string.
    - 68 occurrences with subject type sdoh_Related_Url_Content_Type and object type
      string.
    - 16 occurrences with subject type sdoh_Frequency and object type string.
    - 4 occurrences with subject type sdoh_License and object type string.
    - 1 occurrences with subject type sdoh_Temporal_Resolution_Range and object type
      string.
    - 16359 occurrences with subject type skos_Concept and object type string.
    - 32 occurrences with subject type sdoh_Mime_Type and object type string.
    examples:
