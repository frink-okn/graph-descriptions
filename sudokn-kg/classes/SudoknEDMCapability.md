...
# Class: TODO -- what's a good name for this class (type)? (sudokn_EDMCapability)
...
URI: [sudokn:EDMCapability](http://asu.edu/semantics/SUDOKN/EDMCapability)
...
```mermaid
 classDiagram
    ...
    click SudoknEDMCapability href "../SudoknEDMCapability"
      ...
      SudoknEDMCapability <|-- SudoknHoleDrillingEDMCapability
        click SudoknHoleDrillingEDMCapability href "../SudoknHoleDrillingEDMCapability"
      SudoknEDMCapability <|-- SudoknRAMEDMCapability
        click SudoknRAMEDMCapability href "../SudoknRAMEDMCapability"
      SudoknEDMCapability <|-- SudoknSinkerEDMCapability
        click SudoknSinkerEDMCapability href "../SudoknSinkerEDMCapability"
      SudoknEDMCapability <|-- SudoknWireEDMCapability
        click SudoknWireEDMCapability href "../SudoknWireEDMCapability"
      
      
      SudoknEDMCapability : rdfs_label
        
          
    
    
    SudoknEDMCapability --> "0..1" String : rdfs_label
...
* [IoscProductionCapability](../classes/IoscProductionCapability.md)
    * [SudoknManufacturingProcessCapability](../classes/SudoknManufacturingProcessCapability.md)
        * [SudoknThermalSubtractionCapability](../classes/SudoknThermalSubtractionCapability.md)
            * **SudoknEDMCapability**
                * [SudoknHoleDrillingEDMCapability](../classes/SudoknHoleDrillingEDMCapability.md)
                * [SudoknRAMEDMCapability](../classes/SudoknRAMEDMCapability.md)
                * [SudoknSinkerEDMCapability](../classes/SudoknSinkerEDMCapability.md)
                * [SudoknWireEDMCapability](../classes/SudoknWireEDMCapability.md)
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknEDMCapability](../classes/SudoknEDMCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknEDMCapability](../classes/SudoknEDMCapability.md) |
...
| Value |
| --- |
| sudokn:1DIETECH-EDMCapability-inst |
...
| ---  | ---  |
| self | sudokn:EDMCapability |
| native | sudokn-kg/:SudoknEDMCapability |
...
- if you think the class is perfect.
notes:
- Class with 1114 occurences.
examples:
- value: sudokn:1DIETECH-EDMCapability-inst
from_schema: sudokn-kg
rank: 1000
is_a: sudokn_ThermalSubtractionCapability
slots:
- rdfs_label
class_uri: sudokn:EDMCapability
