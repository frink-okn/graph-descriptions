...
# Class: No class (type) name specified (sudokn_SheeringCapability)
...
```mermaid
 classDiagram
    ...
    SudoknSheeringCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string) | No slot (predicate) description specified | [SudoknSheetMetalProcessingCapability](../classes/SudoknSheetMetalProcessingCapability.md) |  |
