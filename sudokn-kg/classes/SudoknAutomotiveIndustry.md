...
# Class: No class (type) name specified (sudokn_AutomotiveIndustry)
...
URI: [sudokn:AutomotiveIndustry](http://asu.edu/semantics/SUDOKN/AutomotiveIndustry)
...
```mermaid
 classDiagram
    class SudoknAutomotiveIndustry
    click SudoknAutomotiveIndustry href "../SudoknAutomotiveIndustry"
      ...
      SudoknAutomotiveIndustry <|-- SudoknElectricAutomotiveIndustry
        click SudoknElectricAutomotiveIndustry href "../SudoknElectricAutomotiveIndustry"
      
      
      SudoknAutomotiveIndustry : rdfs_label
        
          
    
    
    SudoknAutomotiveIndustry --> "0..1" String : rdfs_label
...
* [IoscIndustry](../classes/IoscIndustry.md)
    * **SudoknAutomotiveIndustry**
        * [SudoknElectricAutomotiveIndustry](../classes/SudoknElectricAutomotiveIndustry.md)
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknAutomotiveIndustry](../classes/SudoknAutomotiveIndustry.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknAutomotiveIndustry](../classes/SudoknAutomotiveIndustry.md) |
...
```yaml
name: sudokn_AutomotiveIndustry
  ...
  rdfs_label:
    ...
    annotations:
      string:
        tag: string
        value: 2
class_uri: sudokn:AutomotiveIndustry
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_AutomotiveIndustry
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
    - owl_NamedIndividual
