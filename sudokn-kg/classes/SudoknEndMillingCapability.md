...
# Class: TODO -- what's a good name for this class (type)? (sudokn_EndMillingCapability)
...
URI: [sudokn:EndMillingCapability](http://asu.edu/semantics/SUDOKN/EndMillingCapability)
...
```mermaid
 classDiagram
    class SudoknEndMillingCapability
    click SudoknEndMillingCapability href "../SudoknEndMillingCapability"
      ...
      SudoknEndMillingCapability : rdfs_label
        
          
    
    
    SudoknEndMillingCapability --> "0..1" String : rdfs_label
...
| ---  | ---  |
| self | sudokn:EndMillingCapability |
| native | sudokn-kg/:SudoknEndMillingCapability |
...
<details>
```yaml
name: sudokn_EndMillingCapability
...
class_uri: sudokn:EndMillingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_EndMillingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
