...
# Class: TODO -- what's a good name for this class (type)? (sudokn_LEEDCertificate)
...
URI: [sudokn:LEEDCertificate](http://asu.edu/semantics/SUDOKN/LEEDCertificate)
...
```mermaid
 classDiagram
    class SudoknLEEDCertificate
    click SudoknLEEDCertificate href "../SudoknLEEDCertificate"
      SudoknLEEDCertificate : rdfs_label
        
          
    
    
    SudoknLEEDCertificate --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasCertificate](../slots/sudokn_hasCertificate.md) | any_of[range] | [SudoknLEEDCertificate](../classes/SudoknLEEDCertificate.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasCertificate](../slots/sudokn_hasCertificate.md) | any_of[range] | [SudoknLEEDCertificate](../classes/SudoknLEEDCertificate.md) |
...
| Value |
| --- |
| sudokn:MKTFASTENING-LEEDCertificate |
...
| ---  | ---  |
| self | sudokn:LEEDCertificate |
| native | sudokn-kg/:SudoknLEEDCertificate |
...
examples:
- value: sudokn:MKTFASTENING-LEEDCertificate
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:LEEDCertificate
