...
# Class: semiconductor fabricating capability (sudokn_SemiconductorFabricatingCapability)





URI: [sudokn:SemiconductorFabricatingCapability](http://asu.edu/semantics/SUDOKN/SemiconductorFabricatingCapability)
...
```mermaid
 classDiagram
    class SudoknSemiconductorFabricatingCapability
    click SudoknSemiconductorFabricatingCapability href "../SudoknSemiconductorFabricatingCapability"
      ...
      SudoknSemiconductorFabricatingCapability : rdfs_label
        
          
    
    
    SudoknSemiconductorFabricatingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject | [SudoknAssemblyCapability](../classes/SudoknAssemblyCapability.md), [SudoknFabricatingCapability](../classes/SudoknFabricatingCapability.md) |  |
...
```yaml
name: sudokn_SemiconductorFabricatingCapability
title: semiconductor fabricating capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_FabricatingCapability
class_uri: sudokn:SemiconductorFabricatingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_SemiconductorFabricatingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
