...
# Class: AWS welder certificate (sudokn_AWSWelderCertificate)
...
```mermaid
 classDiagram
    ...
    SudoknAWSWelderCertificate --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
title: AWS welder certificate
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_ProfessionalCertificate
slots:
- rdfs_label
