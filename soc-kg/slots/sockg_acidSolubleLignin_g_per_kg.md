...
# Slot: No slot (predicate) name specified (sockg_acidSolubleLignin_g_per_kg)
...
URI: [sockg:acidSolubleLignin_g_per_kg](https://idir.uta.edu/sockg-ontology/docs/acidSolubleLignin_g_per_kg)
