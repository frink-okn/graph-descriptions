...
# Class: EGAD - Site Type (http___w3id.org_sawgraph_v1_me-egad#EGAD-SiteType)
...
URI: [http://w3id.org/sawgraph/v1/me-egad#EGAD-SiteType](http://w3id.org/sawgraph/v1/me-egad#EGAD-SiteType)
...
```mermaid
 classDiagram
    class HttpW3id.orgSawgraphV1Me-egad#EGAD-SiteType
    click HttpW3id.orgSawgraphV1Me-egad#EGAD-SiteType href "../HttpW3id.orgSawgraphV1Me-egad#EGAD-SiteType"
      ...
      HttpW3id.orgSawgraphV1Me-egad#EGAD-SiteType : owl_sameAs
        
          
    
    
    HttpW3id.orgSawgraphV1Me-egad#EGAD-SiteType --> "0..1" OwlThing : owl_sameAs
    click OwlThing href "../OwlThing"

        
      HttpW3id.orgSawgraphV1Me-egad#EGAD-SiteType : rdfs_label
        
          
    
    
    HttpW3id.orgSawgraphV1Me-egad#EGAD-SiteType --> "0..1" Any : rdfs_label
    click Any href "../Any"

        
      HttpW3id.orgSawgraphV1Me-egad#EGAD-SiteType : skos_definition
        
          
    
    
    HttpW3id.orgSawgraphV1Me-egad#EGAD-SiteType --> "0..1" Any : skos_definition
    click Any href "../Any"
...
| ---  | --- | --- | --- | --- |
| [skos_definition](../slots/skos_definition.md) | 0..1 <br/> [Any](../classes/Any.md) | A statement or formal explanation of the meaning of a concept <br/>  | direct | 62 |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject <br/>  | direct | 62 |
| [owl_sameAs](../slots/owl_sameAs.md) | 0..1 <br/> [OwlThing](../classes/OwlThing.md) | The property that determines that two given individuals are equal <br/>  | direct | 124 |
...
| ---  | --- | --- | --- |
| [HttpW3id.orgSawgraphV1Me-egad#EGAD-PFAS-Site](../classes/HttpW3id.orgSawgraphV1Me-egad#EGAD-PFAS-Site.md) | [http___w3id.org_sawgraph_v1_me_egad#siteType](../slots/http___w3id.org_sawgraph_v1_me_egad#siteType.md) | any_of[range] | [HttpW3id.orgSawgraphV1Me-egad#EGAD-SiteType](../classes/HttpW3id.orgSawgraphV1Me-egad#EGAD-SiteType.md) |
| [MeEgadEGAD-PFAS-Site](../classes/MeEgadEGAD-PFAS-Site.md) | [http___w3id.org_sawgraph_v1_me_egad#siteType](../slots/http___w3id.org_sawgraph_v1_me_egad#siteType.md) | any_of[range] | [HttpW3id.orgSawgraphV1Me-egad#EGAD-SiteType](../classes/HttpW3id.orgSawgraphV1Me-egad#EGAD-SiteType.md) |
...
```yaml
name: http___w3id.org_sawgraph_v1_me-egad#EGAD-SiteType
...
- rdfs_label
- owl_sameAs
class_uri: http://w3id.org/sawgraph/v1/me-egad#EGAD-SiteType
...
attributes:
  skos_definition:
    ...
    owner: http___w3id.org_sawgraph_v1_me-egad#EGAD-SiteType
    domain_of:
