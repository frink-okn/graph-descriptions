...
# Class: TODO -- what's a good name for this class (type)? (sudokn_HoleDrillingEDMCapability)
...
URI: [sudokn:HoleDrillingEDMCapability](http://asu.edu/semantics/SUDOKN/HoleDrillingEDMCapability)
...
```mermaid
 classDiagram
    class SudoknHoleDrillingEDMCapability
    click SudoknHoleDrillingEDMCapability href "../SudoknHoleDrillingEDMCapability"
      ...
      SudoknHoleDrillingEDMCapability : rdfs_label
        
          
    
    
    SudoknHoleDrillingEDMCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string) | TODO -- tell the world what this slot (predicate) describes | [SudoknEDMCapability](../classes/SudoknEDMCapability.md) |
...
| ---  | ---  |
| self | sudokn:HoleDrillingEDMCapability |
| native | sudokn-kg/:SudoknHoleDrillingEDMCapability |
...
<details>
```yaml
name: sudokn_HoleDrillingEDMCapability
...
class_uri: sudokn:HoleDrillingEDMCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_HoleDrillingEDMCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
