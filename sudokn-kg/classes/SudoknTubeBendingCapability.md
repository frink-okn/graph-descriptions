...
# Class: TODO -- what's a good name for this class (type)? (sudokn_TubeBendingCapability)
...
URI: [sudokn:TubeBendingCapability](http://asu.edu/semantics/SUDOKN/TubeBendingCapability)
...
```mermaid
 classDiagram
    class SudoknTubeBendingCapability
    click SudoknTubeBendingCapability href "../SudoknTubeBendingCapability"
      SudoknTubeBendingCapability : rdfs_label
        
          
    
    
    SudoknTubeBendingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknTubeBendingCapability](../classes/SudoknTubeBendingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknTubeBendingCapability](../classes/SudoknTubeBendingCapability.md) |
...
| ---  | ---  |
| self | sudokn:TubeBendingCapability |
| native | sudokn-kg/:SudoknTubeBendingCapability |
...
<details>
```yaml
name: sudokn_TubeBendingCapability
...
examples:
- value: sudokn:Tampco-TubeBending
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:TubeBendingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_TubeBendingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
