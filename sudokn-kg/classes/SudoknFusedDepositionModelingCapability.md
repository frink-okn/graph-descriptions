...
# Class: fused deposition modeling capability (sudokn_FusedDepositionModelingCapability)





URI: [sudokn:FusedDepositionModelingCapability](http://asu.edu/semantics/SUDOKN/FusedDepositionModelingCapability)
...
```mermaid
 classDiagram
    class SudoknFusedDepositionModelingCapability
    click SudoknFusedDepositionModelingCapability href "../SudoknFusedDepositionModelingCapability"
      ...
      SudoknFusedDepositionModelingCapability : rdfs_label
        
          
    
    
    SudoknFusedDepositionModelingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: sudokn_FusedDepositionModelingCapability
title: fused deposition modeling capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_AdditiveManufacturingCapability
class_uri: sudokn:FusedDepositionModelingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_FusedDepositionModelingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
