...
| Value |
| --- |
| sudokn:3DSYSTEMS-SheetMetalProcessingCapability-inst |
...
| ---  | ---  |
| self | sudokn:SheetMetalProcessingCapability |
| native | sudokn-kg/:SudoknSheetMetalProcessingCapability |
