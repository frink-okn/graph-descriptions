...
# Class: TODO -- what's a good name for this class (type)? (sudokn_GearHobbingCapability)
...
| ---  | ---  |
| self | sudokn:GearHobbingCapability |
| native | sudokn-kg/:SudoknGearHobbingCapability |
