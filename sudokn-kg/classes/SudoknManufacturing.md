...
# Class: No class (type) name specified (sudokn_Manufacturing)
...
URI: [sudokn:Manufacturing](http://asu.edu/semantics/SUDOKN/Manufacturing)
...
```mermaid
 classDiagram
    ...
    click SudoknManufacturing href "../SudoknManufacturing"
      ...
      SudoknManufacturing : sudokn_hasNAICSCodeValue
        
          
    
    
    SudoknManufacturing --> "0..1" Any : sudokn_hasNAICSCodeValue
    click Any href "../Any"

        
      SudoknManufacturing : sudokn_hasNAICSTextValue
        
          
    
    
    SudoknManufacturing --> "0..1" Any : sudokn_hasNAICSTextValue
    click Any href "../Any"
