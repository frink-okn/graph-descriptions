...
# Class: HttpsIdir.uta.eduSockg-ontology#CuttingHeight
...
URI: [https://idir.uta.edu/sockg-ontology#CuttingHeight](https://idir.uta.edu/sockg-ontology#CuttingHeight)
...
```mermaid
 classDiagram
    ...
    click HttpsIdir.uta.eduSockg-ontology#CuttingHeight href "../HttpsIdir.uta.eduSockg-ontology#CuttingHeight"
      HttpsIdir.uta.eduSockg-ontology#CuttingHeight : rdfs_label
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#CuttingHeight --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: https___idir.uta.edu_sockg-ontology#CuttingHeight
from_schema: okns:soc-kg
rank: 1000
slots:
- rdfs_label
class_uri: https://idir.uta.edu/sockg-ontology#CuttingHeight
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: https___idir.uta.edu_sockg-ontology#CuttingHeight
    domain_of:
