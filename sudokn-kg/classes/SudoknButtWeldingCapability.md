...
# Class: No class (type) name specified (sudokn_ButtWeldingCapability)
...
URI: [sudokn:ButtWeldingCapability](http://asu.edu/semantics/SUDOKN/ButtWeldingCapability)
...
```mermaid
 classDiagram
    class SudoknButtWeldingCapability
    click SudoknButtWeldingCapability href "../SudoknButtWeldingCapability"
      ...
      SudoknButtWeldingCapability : rdfs_label
        
          
    
    
    SudoknButtWeldingCapability --> "0..1" String : rdfs_label
...
```yaml
name: sudokn_ButtWeldingCapability
...
class_uri: sudokn:ButtWeldingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ButtWeldingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
    - owl_NamedIndividual
