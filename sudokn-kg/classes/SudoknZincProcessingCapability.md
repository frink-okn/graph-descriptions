...
# Class: TODO -- what's a good name for this class (type)? (sudokn_ZincProcessingCapability)
...
URI: [sudokn:ZincProcessingCapability](http://asu.edu/semantics/SUDOKN/ZincProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknZincProcessingCapability
    click SudoknZincProcessingCapability href "../SudoknZincProcessingCapability"
      SudoknZincProcessingCapability : rdfs_label
        
          
    
    
    SudoknZincProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknZincProcessingCapability](../classes/SudoknZincProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknZincProcessingCapability](../classes/SudoknZincProcessingCapability.md) |
...
| ---  | ---  |
| self | sudokn:ZincProcessingCapability |
| native | sudokn-kg/:SudoknZincProcessingCapability |
...
<details>
```yaml
name: sudokn_ZincProcessingCapability
...
- if you think the class is perfect.
notes:
- Class with 1266 occurences.
examples:
- value: sudokn:3D-CAM-Zinc-inst
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:ZincProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ZincProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
