...
# Class: TODO -- what's a good name for this class (type)? (sudokn_SeamWeldingCapability)
...
| ---  | ---  |
| self | sudokn:SeamWeldingCapability |
| native | sudokn-kg/:SudoknSeamWeldingCapability |
