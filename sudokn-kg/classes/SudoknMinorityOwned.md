...
# Class: Minority Owned (sudokn_MinorityOwned)





URI: [sudokn:MinorityOwned](http://asu.edu/semantics/SUDOKN/MinorityOwned)
...
```mermaid
 classDiagram
    ...
    click SudoknMinorityOwned href "../SudoknMinorityOwned"
      ...
      SudoknMinorityOwned : rdfs_label
        
          
    
    
    SudoknMinorityOwned --> "0..1" Any : rdfs_label
    click Any href "../Any"
