...
# Class: permanent mold casting capability (sudokn_PermanentMoldCastingCapability)
...
```mermaid
 classDiagram
    ...
    SudoknPermanentMoldCastingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
title: permanent mold casting capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_GravityCastingCapability
slots:
- rdfs_label
