...
# Class: TODO -- what's a good name for this class (type)? (sudokn_KovarProcessingCapability)
...
URI: [sudokn:KovarProcessingCapability](http://asu.edu/semantics/SUDOKN/KovarProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknKovarProcessingCapability
    click SudoknKovarProcessingCapability href "../SudoknKovarProcessingCapability"
      SudoknKovarProcessingCapability : rdfs_label
        
          
    
    
    SudoknKovarProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknKovarProcessingCapability](../classes/SudoknKovarProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknKovarProcessingCapability](../classes/SudoknKovarProcessingCapability.md) |
...
| ---  | ---  |
| self | sudokn:KovarProcessingCapability |
| native | sudokn-kg/:SudoknKovarProcessingCapability |
...
<details>
```yaml
name: sudokn_KovarProcessingCapability
...
examples:
- value: sudokn:A1JAYS-Kovar-inst
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:KovarProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_KovarProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
