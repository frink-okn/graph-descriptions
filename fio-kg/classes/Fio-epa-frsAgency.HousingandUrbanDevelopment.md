...
# Class: Housing and Urban Development (fio-epa-frs_Agency.HousingandUrbanDevelopment)
...
URI: [fio-epa-frs:Agency.HousingandUrbanDevelopment](http://w3id.org/fio/v1/epa-frs#Agency.HousingandUrbanDevelopment)
...
```mermaid
 classDiagram
    class Fio-epa-frsAgency.HousingandUrbanDevelopment
    click Fio-epa-frsAgency.HousingandUrbanDevelopment href "../Fio-epa-frsAgency.HousingandUrbanDevelopment"
      ProvAgent <|-- Fio-epa-frsAgency.HousingandUrbanDevelopment
        click ProvAgent href "../ProvAgent"
      
      Fio-epa-frsAgency.HousingandUrbanDevelopment : owl_sameAs
        
          
    
    
    Fio-epa-frsAgency.HousingandUrbanDevelopment --> "0..1" OwlThing : owl_sameAs
    click OwlThing href "../OwlThing"

        
      Fio-epa-frsAgency.HousingandUrbanDevelopment : rdfs_label
        
          
    
    
    Fio-epa-frsAgency.HousingandUrbanDevelopment --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: fio-epa-frs_Agency.HousingandUrbanDevelopment
title: Housing and Urban Development
from_schema: okns:fio-kg
exact_mappings:
- http://w3id.org/fio/v1/epa-frs#Agency.HousingandUrbanDevelopment
rank: 1000
is_a: prov_Agent
slots:
- rdfs_label
- owl_sameAs
class_uri: fio-epa-frs:Agency.HousingandUrbanDevelopment
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: fio-epa-frs_Agency.HousingandUrbanDevelopment
    domain_of:
