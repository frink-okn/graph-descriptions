...
# Class: oxy-fuel cutting capability (sudokn_OxyFuelCutting)





URI: [sudokn:OxyFuelCutting](http://asu.edu/semantics/SUDOKN/OxyFuelCutting)
...
```mermaid
 classDiagram
    class SudoknOxyFuelCutting
    click SudoknOxyFuelCutting href "../SudoknOxyFuelCutting"
      SudoknTorchCuttingCapability <|-- SudoknOxyFuelCutting
        click SudoknTorchCuttingCapability href "../SudoknTorchCuttingCapability"
      
      SudoknOxyFuelCutting : rdfs_label
        
          
    
    
    SudoknOxyFuelCutting --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
* flame cutting capability
* gas cutting capability
* oxy-acetylene cutting capability
...
```yaml
name: sudokn_OxyFuelCutting
title: oxy-fuel cutting capability
...
class_uri: sudokn:OxyFuelCutting
