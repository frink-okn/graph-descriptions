...
# Class: CNC clyndrical grinding capability (sudokn_CNCClyndricalGrindingCapability)





URI: [sudokn:CNCClyndricalGrindingCapability](http://asu.edu/semantics/SUDOKN/CNCClyndricalGrindingCapability)
...
```mermaid
 classDiagram
    class SudoknCNCClyndricalGrindingCapability
    click SudoknCNCClyndricalGrindingCapability href "../SudoknCNCClyndricalGrindingCapability"
      SudoknClyndricalGrindingCapability <|-- SudoknCNCClyndricalGrindingCapability
        click SudoknClyndricalGrindingCapability href "../SudoknClyndricalGrindingCapability"
      
      SudoknCNCClyndricalGrindingCapability : rdfs_label
        
          
    
    
    SudoknCNCClyndricalGrindingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject | [SudoknMachiningCapability](../classes/SudoknMachiningCapability.md), [SudoknGrindingCapability](../classes/SudoknGrindingCapability.md) |  |
...
```yaml
name: sudokn_CNCClyndricalGrindingCapability
title: CNC clyndrical grinding capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_ClyndricalGrindingCapability
class_uri: sudokn:CNCClyndricalGrindingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_CNCClyndricalGrindingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
