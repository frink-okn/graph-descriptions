...
_A collection of more than one substances._
...
```mermaid
 classDiagram
    ...
    click CosoSubstanceCollection href "../CosoSubstanceCollection"
      ...
      CosoSubstanceCollection : coso_hasMember
        
          
    
    
    CosoSubstanceCollection --> "0..1" Any : coso_hasMember
    click Any href "../Any"

        
      CosoSubstanceCollection : coso_substanceID
        
          
    
    
    CosoSubstanceCollection --> "0..1" String : coso_substanceID
    click String href "../String"

        
      CosoSubstanceCollection : dct_identifier
        
          
    
    
    CosoSubstanceCollection --> "0..1" RdfsLiteral : dct_identifier
    click RdfsLiteral href "../RdfsLiteral"

        
      CosoSubstanceCollection : http___w3id.org_sawgraph_v1_me_egad#dep_chemicalID
        
          
    
    
    CosoSubstanceCollection --> "0..1" String : http___w3id.org_sawgraph_v1_me_egad#dep_chemicalID
    click String href "../String"

        
      CosoSubstanceCollection : owl_sameAs
        
          
    
    
    CosoSubstanceCollection --> "0..1" OwlThing : owl_sameAs
    click OwlThing href "../OwlThing"
    ...
    CosoSubstanceCollection --> "0..1" Any : rdfs_label
    click Any href "../Any"
    ...
    CosoSubstanceCollection --> "0..1" Any : skos_altLabel
    click Any href "../Any"
...
| ---  | --- | --- | --- | --- |
| [coso_substanceID](../slots/coso_substanceID.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string) | The unique identifier for the substance <br/>  | direct | 4 |
| [skos_altLabel](../slots/skos_altLabel.md) | 0..1 <br/> [Any](../classes/Any.md) | An alternative lexical label for a resource <br/> description: skos:prefLabel, skos:altLabel and skos:hiddenLabel are pairwise disjoint properties.<br/>description: The range of skos:altLabel is the class of RDF plain literals. | direct | 10 |
| [dct_identifier](../slots/dct_identifier.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md) | Recommended practice is to identify the resource by means of a string conform... <br/> description: An unambiguous reference to the resource within a given context. | direct | 4 |
...
| ---  | --- | --- | --- |
| [HttpW3id.orgSawgraphV1Me-egad#EGAD-PFAS-Observation](../classes/HttpW3id.orgSawgraphV1Me-egad#EGAD-PFAS-Observation.md) | [CosoOfDatasetSubstance](../classes/CosoOfDatasetSubstance.md) | any_of[range] | [CosoSubstanceCollection](../classes/CosoSubstanceCollection.md) |
| [HttpW3id.orgSawgraphV1Me-egad#EGAD-PFAS-Observation](../classes/HttpW3id.orgSawgraphV1Me-egad#EGAD-PFAS-Observation.md) | [coso_ofSubstance](../slots/coso_ofSubstance.md) | any_of[range] | [CosoSubstanceCollection](../classes/CosoSubstanceCollection.md) |
| [HttpW3id.orgSawgraphV1Us-wqp#Observation](../classes/HttpW3id.orgSawgraphV1Us-wqp#Observation.md) | [CosoOfDatasetSubstance](../classes/CosoOfDatasetSubstance.md) | any_of[range] | [CosoSubstanceCollection](../classes/CosoSubstanceCollection.md) |
| [MeEgadEGAD-PFAS-Observation](../classes/MeEgadEGAD-PFAS-Observation.md) | [coso_ofSubstance](../slots/coso_ofSubstance.md) | any_of[range] | [CosoSubstanceCollection](../classes/CosoSubstanceCollection.md) |
...
description: A collection of more than one substances.
