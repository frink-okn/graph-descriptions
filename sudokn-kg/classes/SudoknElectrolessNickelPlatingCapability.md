...
# Class: TODO -- what's a good name for this class (type)? (sudokn_ElectrolessNickelPlatingCapability)
...
URI: [sudokn:ElectrolessNickelPlatingCapability](http://asu.edu/semantics/SUDOKN/ElectrolessNickelPlatingCapability)
...
```mermaid
 classDiagram
    class SudoknElectrolessNickelPlatingCapability
    click SudoknElectrolessNickelPlatingCapability href "../SudoknElectrolessNickelPlatingCapability"
      SudoknElectrolessNickelPlatingCapability : rdfs_label
        
          
    
    
    SudoknElectrolessNickelPlatingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknElectrolessNickelPlatingCapability](../classes/SudoknElectrolessNickelPlatingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknElectrolessNickelPlatingCapability](../classes/SudoknElectrolessNickelPlatingCapability.md) |
...
| Value |
| --- |
| sudokn:ACCRAFAB-ElectrolessNickelPlatingCapability-inst |
...
| ---  | ---  |
| self | sudokn:ElectrolessNickelPlatingCapability |
| native | sudokn-kg/:SudoknElectrolessNickelPlatingCapability |
...
<details>
```yaml
name: sudokn_ElectrolessNickelPlatingCapability
...
- if you think the class is perfect.
notes:
- Class with 214 occurences.
examples:
- value: sudokn:ACCRAFAB-ElectrolessNickelPlatingCapability-inst
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:ElectrolessNickelPlatingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ElectrolessNickelPlatingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
