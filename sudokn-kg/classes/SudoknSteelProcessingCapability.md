...
```mermaid
 classDiagram
    ...
    SudoknSteelProcessingCapability --> "0..1" String : rdfs_label
...
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknSteelProcessingCapability](../classes/SudoknSteelProcessingCapability.md) |
...
| ---  | ---  |
| self | sudokn:SteelProcessingCapability |
| native | sudokn-kg/:SudoknSteelProcessingCapability |
...
- if you think the class is perfect.
notes:
- Class with 7200 occurences.
examples:
- value: sudokn:101PIPE-Steel-inst
