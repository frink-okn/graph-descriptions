...
# Class: TODO -- what's a good name for this class (type)? (sudokn_PlasterMoldCastingCapability)
...
URI: [sudokn:PlasterMoldCastingCapability](http://asu.edu/semantics/SUDOKN/PlasterMoldCastingCapability)
...
```mermaid
 classDiagram
    class SudoknPlasterMoldCastingCapability
    click SudoknPlasterMoldCastingCapability href "../SudoknPlasterMoldCastingCapability"
      SudoknPlasterMoldCastingCapability : rdfs_label
        
          
    
    
    SudoknPlasterMoldCastingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknPlasterMoldCastingCapability](../classes/SudoknPlasterMoldCastingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknPlasterMoldCastingCapability](../classes/SudoknPlasterMoldCastingCapability.md) |
...
| Value |
| --- |
| sudokn:HARMONYCASTINGS-PlasterMoldCastingCapability-inst |
...
| ---  | ---  |
| self | sudokn:PlasterMoldCastingCapability |
| native | sudokn-kg/:SudoknPlasterMoldCastingCapability |
...
<details>
```yaml
name: sudokn_PlasterMoldCastingCapability
...
examples:
- value: sudokn:HARMONYCASTINGS-PlasterMoldCastingCapability-inst
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:PlasterMoldCastingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_PlasterMoldCastingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
