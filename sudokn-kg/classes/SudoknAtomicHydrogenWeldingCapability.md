...
# Class: No class (type) name specified (sudokn_AtomicHydrogenWeldingCapability)
...
URI: [sudokn:AtomicHydrogenWeldingCapability](http://asu.edu/semantics/SUDOKN/AtomicHydrogenWeldingCapability)
...
```mermaid
 classDiagram
    class SudoknAtomicHydrogenWeldingCapability
    click SudoknAtomicHydrogenWeldingCapability href "../SudoknAtomicHydrogenWeldingCapability"
      ...
      SudoknAtomicHydrogenWeldingCapability : rdfs_label
        
          
    
    
    SudoknAtomicHydrogenWeldingCapability --> "0..1" String : rdfs_label
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_AtomicHydrogenWeldingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
    - owl_NamedIndividual
