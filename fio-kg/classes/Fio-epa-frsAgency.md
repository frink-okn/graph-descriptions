...
# Class: Agency (fio-epa-frs_Agency)


_Federal Agency as identified in EPA Facility Registry Service_
...
This class occurs 54 times.


URI: [fio-epa-frs:Agency](http://w3id.org/fio/v1/epa-frs#Agency)
...
```mermaid
 classDiagram
    class Fio-epa-frsAgency
    click Fio-epa-frsAgency href "../Fio-epa-frsAgency"
      ProvAgent <|-- Fio-epa-frsAgency
        click ProvAgent href "../ProvAgent"
      
      Fio-epa-frsAgency : owl_sameAs
        
          
    
    
    Fio-epa-frsAgency --> "0..1" OwlThing : owl_sameAs
    click OwlThing href "../OwlThing"

        
      Fio-epa-frsAgency : rdfs_label
        
          
    
    
    Fio-epa-frsAgency --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| [owl_sameAs](../slots/owl_sameAs.md) | 0..1 <br/> [OwlThing](../classes/OwlThing.md) | The property that determines that two given individuals are equal <br/>  | direct | 162 |
...
| ---  | --- | --- | --- |
| [Fio-epa-frsEPA-PFAS-Facility](../classes/Fio-epa-frsEPA-PFAS-Facility.md) | [fio_ownedBy](../slots/fio_ownedBy.md) | any_of[range] | [Fio-epa-frsAgency](../classes/Fio-epa-frsAgency.md) |
| [Fio-epa-frsFRS-Facility](../classes/Fio-epa-frsFRS-Facility.md) | [fio_ownedBy](../slots/fio_ownedBy.md) | any_of[range] | [Fio-epa-frsAgency](../classes/Fio-epa-frsAgency.md) |
