...
# Class: stamping capability (sudokn_StampingCapability)
...
URI: [sudokn:StampingCapability](http://asu.edu/semantics/SUDOKN/StampingCapability)
...
```mermaid
 classDiagram
    class SudoknStampingCapability
    click SudoknStampingCapability href "../SudoknStampingCapability"
      ...
      SudoknStampingCapability : rdfs_label
        
          
    
    
    SudoknStampingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknStampingCapability](../classes/SudoknStampingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknStampingCapability](../classes/SudoknStampingCapability.md) |
...
| Value |
| --- |
| sudokn:1DIETECH-StampingCapability-inst |
...
| ---  | ---  |
| self | sudokn:StampingCapability |
| native | sudokn-kg/:SudoknStampingCapability |
...
<details>
```yaml
name: sudokn_StampingCapability
description: TODO -- tell the world what this class (type) describes.
title: stamping capability
todos:
- TODO -- Todos for this class go here
- or you can delete the todos
- if you think the class is perfect.
notes:
- Class with 1216 occurences.
examples:
- value: sudokn:1DIETECH-StampingCapability-inst
from_schema: sudokn-kg
is_a: sudokn_SheetMetalProcessingCapability
slots:
- rdfs_label
class_uri: sudokn:StampingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_StampingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
