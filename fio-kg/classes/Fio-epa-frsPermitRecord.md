...
This class occurs 222329 times.
...
```mermaid
 classDiagram
    ...
    click Fio-epa-frsPermitRecord href "../Fio-epa-frsPermitRecord"
      ...
      Fio-epa-frsPermitRecord : dc_identifier
        
          
    
    
    Fio-epa-frsPermitRecord --> "0..1" Any : dc_identifier
    click Any href "../Any"
