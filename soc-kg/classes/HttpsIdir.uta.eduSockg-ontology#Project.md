...
# Class: HttpsIdir.uta.eduSockg-ontology#Project
...
URI: [https://idir.uta.edu/sockg-ontology#Project](https://idir.uta.edu/sockg-ontology#Project)
...
```mermaid
 classDiagram
    ...
    click HttpsIdir.uta.eduSockg-ontology#Project href "../HttpsIdir.uta.eduSockg-ontology#Project"
      HttpsIdir.uta.eduSockg-ontology#Project : dct_description
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#Project --> "0..1" String : dct_description
...
| ---  | --- | --- | --- |
| [HttpsIdir.uta.eduSockg-ontology#Treatment](../classes/HttpsIdir.uta.eduSockg-ontology#Treatment.md) | [https___idir.uta.edu_sockg_ontology#fromProject](../slots/https___idir.uta.edu_sockg_ontology#fromProject.md) | range | [HttpsIdir.uta.eduSockg-ontology#Project](../classes/HttpsIdir.uta.eduSockg-ontology#Project.md) |
...
```yaml
name: https___idir.uta.edu_sockg-ontology#Project
from_schema: okns:soc-kg
rank: 1000
slots:
- dct_description
class_uri: https://idir.uta.edu/sockg-ontology#Project
...
attributes:
  dct_description:
    ...
    owner: https___idir.uta.edu_sockg-ontology#Project
    domain_of:
    - qudt_BinaryPrefix
