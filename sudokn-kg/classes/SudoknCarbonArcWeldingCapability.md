...
# Class: TODO -- what's a good name for this class (type)? (sudokn_CarbonArcWeldingCapability)
...
| ---  | ---  |
| self | sudokn:CarbonArcWeldingCapability |
| native | sudokn-kg/:SudoknCarbonArcWeldingCapability |
