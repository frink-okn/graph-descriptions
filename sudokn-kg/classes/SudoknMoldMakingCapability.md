...
# Class: mold making capability (sudokn_MoldMakingCapability)
...
URI: [sudokn:MoldMakingCapability](http://asu.edu/semantics/SUDOKN/MoldMakingCapability)
...
```mermaid
 classDiagram
    class SudoknMoldMakingCapability
    click SudoknMoldMakingCapability href "../SudoknMoldMakingCapability"
      ...
      SudoknMoldMakingCapability : rdfs_label
        
          
    
    
    SudoknMoldMakingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknMoldMakingCapability](../classes/SudoknMoldMakingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknMoldMakingCapability](../classes/SudoknMoldMakingCapability.md) |
...
| Value |
| --- |
| sudokn:AllredMetalStampingWorks-MoldMaking |
...
| ---  | ---  |
| self | sudokn:MoldMakingCapability |
| native | sudokn-kg/:SudoknMoldMakingCapability |
...
<details>
```yaml
name: sudokn_MoldMakingCapability
description: TODO -- tell the world what this class (type) describes.
title: mold making capability
todos:
- TODO -- Todos for this class go here
- or you can delete the todos
- if you think the class is perfect.
...
examples:
- value: sudokn:AllredMetalStampingWorks-MoldMaking
from_schema: sudokn-kg
is_a: sudokn_ToolMakingCapability
slots:
- rdfs_label
class_uri: sudokn:MoldMakingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_MoldMakingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
