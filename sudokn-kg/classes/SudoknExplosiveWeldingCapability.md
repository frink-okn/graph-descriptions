...
# Class: No class (type) name specified (sudokn_ExplosiveWeldingCapability)
...
URI: [sudokn:ExplosiveWeldingCapability](http://asu.edu/semantics/SUDOKN/ExplosiveWeldingCapability)
...
```mermaid
 classDiagram
    class SudoknExplosiveWeldingCapability
    click SudoknExplosiveWeldingCapability href "../SudoknExplosiveWeldingCapability"
      ...
      SudoknExplosiveWeldingCapability : rdfs_label
        
          
    
    
    SudoknExplosiveWeldingCapability --> "0..1" String : rdfs_label
...
```yaml
name: sudokn_ExplosiveWeldingCapability
...
class_uri: sudokn:ExplosiveWeldingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ExplosiveWeldingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
    - owl_NamedIndividual
