...
# Class: TODO -- what's a good name for this class (type)? (sudokn_GasBrazingCapability)
...
| ---  | ---  |
| self | sudokn:GasBrazingCapability |
| native | sudokn-kg/:SudoknGasBrazingCapability |
