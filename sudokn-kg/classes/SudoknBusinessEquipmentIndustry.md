...
# Class: business equipment industry (sudokn_BusinessEquipmentIndustry)
...
URI: [sudokn:BusinessEquipmentIndustry](http://asu.edu/semantics/SUDOKN/BusinessEquipmentIndustry)
...
```mermaid
 classDiagram
    class SudoknBusinessEquipmentIndustry
    click SudoknBusinessEquipmentIndustry href "../SudoknBusinessEquipmentIndustry"
      ...
      SudoknBusinessEquipmentIndustry : rdfs_label
        
          
    
    
    SudoknBusinessEquipmentIndustry --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknBusinessEquipmentIndustry](../classes/SudoknBusinessEquipmentIndustry.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknBusinessEquipmentIndustry](../classes/SudoknBusinessEquipmentIndustry.md) |
...
| Value |
| --- |
| sudokn:BusinessEquipment-Industry |
...
| ---  | ---  |
| self | sudokn:BusinessEquipmentIndustry |
| native | sudokn-kg/:SudoknBusinessEquipmentIndustry |
...
<details>
```yaml
name: sudokn_BusinessEquipmentIndustry
description: TODO -- tell the world what this class (type) describes.
title: business equipment industry
todos:
- TODO -- Todos for this class go here
- or you can delete the todos
- if you think the class is perfect.
...
examples:
- value: sudokn:BusinessEquipment-Industry
from_schema: sudokn-kg
is_a: iosc_Industry
slots:
- rdfs_label
class_uri: sudokn:BusinessEquipmentIndustry
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_BusinessEquipmentIndustry
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
