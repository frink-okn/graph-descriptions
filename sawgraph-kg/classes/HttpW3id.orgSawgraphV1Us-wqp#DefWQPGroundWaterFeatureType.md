...
# Class: HttpW3id.orgSawgraphV1Us-wqp#DefWQPGroundWaterFeatureType
...
URI: [http://w3id.org/sawgraph/v1/us-wqp#DefWQPGroundWaterFeatureType](http://w3id.org/sawgraph/v1/us-wqp#DefWQPGroundWaterFeatureType)
...
```mermaid
 classDiagram
    ...
    click HttpW3id.orgSawgraphV1Us-wqp#DefWQPGroundWaterFeatureType href "../HttpW3id.orgSawgraphV1Us-wqp#DefWQPGroundWaterFeatureType"
      ...
      HttpW3id.orgSawgraphV1Us-wqp#DefWQPGroundWaterFeatureType : rdfs_comment
        
          
    
    
    HttpW3id.orgSawgraphV1Us-wqp#DefWQPGroundWaterFeatureType --> "0..1" Any : rdfs_comment
    click Any href "../Any"

        
      HttpW3id.orgSawgraphV1Us-wqp#DefWQPGroundWaterFeatureType : rdfs_label
        
          
    
    
    HttpW3id.orgSawgraphV1Us-wqp#DefWQPGroundWaterFeatureType --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- | --- |
| [rdfs_comment](../slots/rdfs_comment.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A description of the subject resource <br/>  | direct | 3 |
...
| ---  | --- | --- | --- |
| [HttpW3id.orgSawgraphV1Us-wqp#SampledFeature](../classes/HttpW3id.orgSawgraphV1Us-wqp#SampledFeature.md) | [http___w3id.org_sawgraph_v1_us_wqp#locationType](../slots/http___w3id.org_sawgraph_v1_us_wqp#locationType.md) | any_of[range] | [HttpW3id.orgSawgraphV1Us-wqp#DefWQPGroundWaterFeatureType](../classes/HttpW3id.orgSawgraphV1Us-wqp#DefWQPGroundWaterFeatureType.md) |
...
```yaml
name: http___w3id.org_sawgraph_v1_us-wqp#DefWQPGroundWaterFeatureType
...
- rdfs_comment
- rdfs_label
class_uri: http://w3id.org/sawgraph/v1/us-wqp#DefWQPGroundWaterFeatureType
...
attributes:
  rdfs_comment:
    ...
    alias: rdfs_comment
    owner: http___w3id.org_sawgraph_v1_us-wqp#DefWQPGroundWaterFeatureType
    domain_of:
