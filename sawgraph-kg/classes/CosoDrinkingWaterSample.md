...
# Class: Drinking Water Sample (coso_DrinkingWaterSample)





URI: [coso:DrinkingWaterSample](http://w3id.org/coso/v1/contaminoso#DrinkingWaterSample)
...
```mermaid
 classDiagram
    ...
    click CosoDrinkingWaterSample href "../CosoDrinkingWaterSample"
      ...
      CosoDrinkingWaterSample : owl_sameAs
        
          
    
    
    CosoDrinkingWaterSample --> "0..1" OwlThing : owl_sameAs
    click OwlThing href "../OwlThing"

        
      CosoDrinkingWaterSample : rdfs_label
        
          
    
    
    CosoDrinkingWaterSample --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: coso_DrinkingWaterSample
title: Drinking Water Sample
from_schema: okns:sawgraph-kg
rank: 1000
is_a: coso_WaterSampleBySource
class_uri: coso:DrinkingWaterSample
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: coso_DrinkingWaterSample
    domain_of:
