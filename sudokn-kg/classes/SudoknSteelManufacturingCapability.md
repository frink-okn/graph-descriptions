...
# Class: TODO -- what's a good name for this class (type)? (sudokn_SteelManufacturingCapability)
...
URI: [sudokn:SteelManufacturingCapability](http://asu.edu/semantics/SUDOKN/SteelManufacturingCapability)
...
```mermaid
 classDiagram
    class SudoknSteelManufacturingCapability
    click SudoknSteelManufacturingCapability href "../SudoknSteelManufacturingCapability"
      SudoknSteelManufacturingCapability : rdfs_label
        
          
    
    
    SudoknSteelManufacturingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknSteelManufacturingCapability](../classes/SudoknSteelManufacturingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknSteelManufacturingCapability](../classes/SudoknSteelManufacturingCapability.md) |
...
| Value |
| --- |
| sudokn:ForgedCustomMetalFabrication-SteelManufacturing |
...
| ---  | ---  |
| self | sudokn:SteelManufacturingCapability |
| native | sudokn-kg/:SudoknSteelManufacturingCapability |
...
<details>
```yaml
name: sudokn_SteelManufacturingCapability
...
examples:
- value: sudokn:ForgedCustomMetalFabrication-SteelManufacturing
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:SteelManufacturingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_SteelManufacturingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
