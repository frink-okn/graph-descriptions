...
| [KwgoHospitalType](../classes/KwgoHospitalType.md) | Source - https://hifld-geoplatform |  no  |
| [SdosMedicalAudienceType](../classes/SdosMedicalAudienceType.md) | Target audiences types for medical web pages |  no  |
| [KwgoHospitalStatus](../classes/KwgoHospitalStatus.md) | Source - https://hifld-geoplatform |  no  |
| [VoagGovernanceRole](../classes/VoagGovernanceRole.md) | A "Role" with the following instance(s): "authorizer", "steward", "submitter" |  no  |
| [QudtBitEncodingType](../classes/QudtBitEncodingType.md) | A bit encoding is a correspondence between the two possible values of a bit, ... |  no  |
...
| [VoagProductLogo](../classes/VoagProductLogo.md) |  |  no  |
| [VaemCatalogEntry](../classes/VaemCatalogEntry.md) |  |  no  |
| [RdfList](../classes/RdfList.md) | The class of RDF Lists |  no  |
| [HttpsIdir.uta.eduSockg-ontology#PlantFraction](../classes/HttpsIdir.uta.eduSockg-ontology#PlantFraction.md) |  |  no  |
...
| [VoagProvenance](../classes/VoagProvenance.md) | The origin or source of something |  no  |
...
| [VoagIssueStatus](../classes/VoagIssueStatus.md) | The status of an issue: "Closed", "Deferred", "Non issue", "Open", "Resolved" |  no  |
| [HttpsIdir.uta.eduSockg-ontology#Irrigation](../classes/HttpsIdir.uta.eduSockg-ontology#Irrigation.md) |  |  no  |
| [HttpsIdir.uta.eduSockg-ontology#SimulationModel](../classes/HttpsIdir.uta.eduSockg-ontology#SimulationModel.md) |  |  no  |
| [KwgoStormTrackletObservableProperty](../classes/KwgoStormTrackletObservableProperty.md) | Source: https://coast |  no  |
| [SdosBoardingPolicyType](../classes/SdosBoardingPolicyType.md) | A type of boarding policy used by an airline |  no  |
| [KwgoCensusObservableProperty](../classes/KwgoCensusObservableProperty.md) | American Community Survey 5-Year Estimate Observed Property |  no  |
...
| [KwgoMTBSFireObservableProperty](../classes/KwgoMTBSFireObservableProperty.md) | Source - MTBS (https://mtbs |  no  |
| [VoagCreativeCommonsRequirement](../classes/VoagCreativeCommonsRequirement.md) | an action that may or may not be requested of you |  no  |
| [DctAgentClass](../classes/DctAgentClass.md) | A group of agents |  no  |
| [HttpsIdir.uta.eduSockg-ontology#Cultivar](../classes/HttpsIdir.uta.eduSockg-ontology#Cultivar.md) |  |  no  |
| [SdosItemAvailability](../classes/SdosItemAvailability.md) | A list of possible product availability options |  no  |
| [HttpsIdir.uta.eduSockg-ontology#TillageEvent](../classes/HttpsIdir.uta.eduSockg-ontology#TillageEvent.md) |  |  no  |
| [HttpsIdir.uta.eduSockg-ontology#TillageMethod](../classes/HttpsIdir.uta.eduSockg-ontology#TillageMethod.md) |  |  no  |
| [HttpsIdir.uta.eduSockg-ontology#BroadleafOrGrass](../classes/HttpsIdir.uta.eduSockg-ontology#BroadleafOrGrass.md) |  |  no  |
| [HttpsIdir.uta.eduSockg-ontology#HarvestedFraction](../classes/HttpsIdir.uta.eduSockg-ontology#HarvestedFraction.md) |  |  no  |
| [HttpsIdir.uta.eduSockg-ontology#AnimalClass](../classes/HttpsIdir.uta.eduSockg-ontology#AnimalClass.md) |  |  no  |
| [VoagCreativeCommonsProhibition](../classes/VoagCreativeCommonsProhibition.md) | something you may be asked not to do |  no  |
| [SdosMedicalEvidenceLevel](../classes/SdosMedicalEvidenceLevel.md) | Level of evidence for a medical guideline |  no  |
| [QudtBooleanEncodingType](../classes/QudtBooleanEncodingType.md) |  |  no  |
| [VoagSchemaGraph](../classes/VoagSchemaGraph.md) |  |  no  |
...
| [HttpsIdir.uta.eduSockg-ontology#CuttingHeight](../classes/HttpsIdir.uta.eduSockg-ontology#CuttingHeight.md) |  |  no  |
| [VoagLogo](../classes/VoagLogo.md) |  |  no  |
| [HttpsIdir.uta.eduSockg-ontology#AmendmentPlacement](../classes/HttpsIdir.uta.eduSockg-ontology#AmendmentPlacement.md) |  |  no  |
...
| [HttpsIdir.uta.eduSockg-ontology#Parameter](../classes/HttpsIdir.uta.eduSockg-ontology#Parameter.md) |  |  no  |
...
| [QudtIntegerEncodingType](../classes/QudtIntegerEncodingType.md) | The encoding scheme for integer types |  no  |
| [HttpsIdir.uta.eduSockg-ontology#Abstract](../classes/HttpsIdir.uta.eduSockg-ontology#Abstract.md) |  |  no  |
| [QudtCharEncodingType](../classes/QudtCharEncodingType.md) | The class of all character encoding schemes, each of which defines a rule or ... |  no  |
| [HttpsIdir.uta.eduSockg-ontology#OtherEvents](../classes/HttpsIdir.uta.eduSockg-ontology#OtherEvents.md) |  |  no  |
...
| [TimeTemporalUnit](../classes/TimeTemporalUnit.md) | A standard duration, which provides a scale factor for a time extent, or the ... |  no  |
| [HttpsIdir.uta.eduSockg-ontology#Equipment](../classes/HttpsIdir.uta.eduSockg-ontology#Equipment.md) |  |  no  |
...
| [VoagAttribution](../classes/VoagAttribution.md) | An 'Attribution' specifies how credit should be given when citing the creator... |  no  |
| [VoagAttributionLogo](../classes/VoagAttributionLogo.md) |  |  no  |
| [QudtSignednessType](../classes/QudtSignednessType.md) |  |  no  |
...
| [KwgoPublicHealthObservableProperty](../classes/KwgoPublicHealthObservableProperty.md) | Source - https://nccd |  no  |
| [SdosContactPointOption](../classes/SdosContactPointOption.md) | Enumerated options related to a ContactPoint |  no  |
| [HttpsIdir.uta.eduSockg-ontology#StartStopInterval](../classes/HttpsIdir.uta.eduSockg-ontology#StartStopInterval.md) |  |  no  |
| [SdosOrderStatus](../classes/SdosOrderStatus.md) | Enumerated status values for Order |  no  |
| [VoagPedigree](../classes/VoagPedigree.md) | The origin or source of something |  no  |
| [HttpsIdir.uta.eduSockg-ontology#AmendmentType](../classes/HttpsIdir.uta.eduSockg-ontology#AmendmentType.md) |  |  no  |
...
| [VoagChangeFrequency](../classes/VoagChangeFrequency.md) |  |  no  |
...
| [VoagConfidentialityLevel](../classes/VoagConfidentialityLevel.md) |  |  no  |
...
| [HttpsIdir.uta.eduSockg-ontology#ChamberPlacement](../classes/HttpsIdir.uta.eduSockg-ontology#ChamberPlacement.md) |  |  no  |
...
| [HttpsIdir.uta.eduSockg-ontology#SpeciesMix](../classes/HttpsIdir.uta.eduSockg-ontology#SpeciesMix.md) |  |  no  |
...
| [HttpsIdir.uta.eduSockg-ontology#LossesOrDeposition](../classes/HttpsIdir.uta.eduSockg-ontology#LossesOrDeposition.md) |  |  no  |
| [HttpsIdir.uta.eduSockg-ontology#PesticidePlacement](../classes/HttpsIdir.uta.eduSockg-ontology#PesticidePlacement.md) |  |  no  |
...
| [VoagOrganizationLogo](../classes/VoagOrganizationLogo.md) |  |  no  |
...
| [QudtEndianType](../classes/QudtEndianType.md) |  |  no  |
| [KwgoAirPollutant](../classes/KwgoAirPollutant.md) | Source - EPA (https://www |  no  |
| [KwgoImpactObservableProperty](../classes/KwgoImpactObservableProperty.md) | Source - NOAA (https://www |  no  |
| [BiboDocumentStatus](../classes/BiboDocumentStatus.md) | The status of the publication of a document |  no  |
...
| [KwgoCroplandObservableProperty](../classes/KwgoCroplandObservableProperty.md) | Source - https://nassgeodata |  no  |
| [KwgoRoadType](../classes/KwgoRoadType.md) | Source - https://www |  no  |
| [QudtByteEncodingType](../classes/QudtByteEncodingType.md) | This class contains the various ways that information may be encoded into byt... |  no  |
| [VaemParty](../classes/VaemParty.md) | A "Party" is a generalization for an actor that may be realized as a person, ... |  no  |
...
| [KwgoHelipadAvailability](../classes/KwgoHelipadAvailability.md) | Source - https://hifld-geoplatform |  no  |
| [HttpsIdir.uta.eduSockg-ontology#GrowthStage](../classes/HttpsIdir.uta.eduSockg-ontology#GrowthStage.md) |  |  no  |
| [QudtPlaneAngleUnit](../classes/QudtPlaneAngleUnit.md) |  |  no  |
| [VoagGovernance](../classes/VoagGovernance.md) | Governance is mainly concerned with how an artifact is provisioned and manage... |  no  |
...
| [VoagLicenseModel](../classes/VoagLicenseModel.md) |  |  no  |
| [KwgoMagnitudeObservableProperty](../classes/KwgoMagnitudeObservableProperty.md) | Source - NOAA (https://www |  no  |
| [QudtFloatingPointEncodingType](../classes/QudtFloatingPointEncodingType.md) | A "Encoding" with the following instance(s): "Double Precision Encoding", "Si... |  no  |
| [VoagMaturity](../classes/VoagMaturity.md) |  |  no  |
...
| [VoagPublicationStatus](../classes/VoagPublicationStatus.md) |  |  no  |
...
| [BiboThesisDegree](../classes/BiboThesisDegree.md) | The academic degree of a Thesis |  no  |
| [KwgoDroughtIntensity](../classes/KwgoDroughtIntensity.md) | Source - https://droughtmonitor |  no  |
| [HttpsIdir.uta.eduSockg-ontology#PopularArticle](../classes/HttpsIdir.uta.eduSockg-ontology#PopularArticle.md) |  |  no  |
| [KwgoNIFCFireObservableProperty](../classes/KwgoNIFCFireObservableProperty.md) | Source - NIFC (https://data-nifc |  no  |
...
| [KwgoSmokePlumeObservableProperty](../classes/KwgoSmokePlumeObservableProperty.md) | Source - https://satepsanone |  no  |
| [VoagIcon](../classes/VoagIcon.md) |  |  no  |
...
| [HttpsIdir.uta.eduSockg-ontology#PlantingMethod](../classes/HttpsIdir.uta.eduSockg-ontology#PlantingMethod.md) |  |  no  |
| [KwgoSoilMapUnitObservableProperty](../classes/KwgoSoilMapUnitObservableProperty.md) | Source - NRCS-USDA (https://www |  no  |
...
| [VoagPriorityValue](../classes/VoagPriorityValue.md) |  |  no  |
...
| [KwgoLSADArea](../classes/KwgoLSADArea.md) | For legal entities, the LSAD reflects the term that appears in legal document... |  no  |
...
| [VoagCreativeCommonsPermission](../classes/VoagCreativeCommonsPermission.md) | An action that may or may not be allowed or desired |  no  |
...
| [QudtDateTimeStringEncodingType](../classes/QudtDateTimeStringEncodingType.md) | Date Time encodings are logical encodings for expressing date/time quantities... |  no  |
| [HttpsIdir.uta.eduSockg-ontology#JournalArticle](../classes/HttpsIdir.uta.eduSockg-ontology#JournalArticle.md) |  |  no  |
| [KwgoVulnerabilityObservableProperty](../classes/KwgoVulnerabilityObservableProperty.md) | Source - https://www |  no  |
| [TimeDayOfWeek](../classes/TimeDayOfWeek.md) | The day of week |  no  |
| [RdfDatatypeProperty](../classes/RdfDatatypeProperty.md) |  |  no  |
| [KwgoBlueskyWildfireObservableProperty](../classes/KwgoBlueskyWildfireObservableProperty.md) | Source - Bluesky forecast (https://tools |  no  |
| [SdosBoolean](../classes/SdosBoolean.md) | Boolean: True or False |  no  |
| [KwgoClimateObservableProperty](../classes/KwgoClimateObservableProperty.md) | Climate Properties measured by NOAA for their Climate Division Boundaries |  no  |
| [HttpsIdir.uta.eduSockg-ontology#PesticideTarget](../classes/HttpsIdir.uta.eduSockg-ontology#PesticideTarget.md) |  |  no  |
| [HttpsLod.nal.usda.govNalt7140](../classes/HttpsLod.nal.usda.govNalt7140.md) |  |  no  |
| [SdosDataType](../classes/SdosDataType.md) | The basic data types such as Integers, Strings, etc |  no  |
...
| [HttpsIdir.uta.eduSockg-ontology#SurfaceOrLeaching](../classes/HttpsIdir.uta.eduSockg-ontology#SurfaceOrLeaching.md) |  |  no  |
| [VoagChangeType](../classes/VoagChangeType.md) |  |  no  |
| [SdosMedicalStudyStatus](../classes/SdosMedicalStudyStatus.md) | The status of a medical study |  no  |
| [KwgoStormTrackObservableProperty](../classes/KwgoStormTrackObservableProperty.md) | Source: https://coast |  no  |
| [HttpsIdir.uta.eduSockg-ontology#AnimalSpecies](../classes/HttpsIdir.uta.eduSockg-ontology#AnimalSpecies.md) |  |  no  |
| [KwgoFireCause](../classes/KwgoFireCause.md) | A classification of an event that causes a fire, e |  no  |
...
| [HttpsIdir.uta.eduSockg-ontology#FundingSource](../classes/HttpsIdir.uta.eduSockg-ontology#FundingSource.md) |  |  no  |
