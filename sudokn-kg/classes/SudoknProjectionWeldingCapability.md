...
# Class: TODO -- what's a good name for this class (type)? (sudokn_ProjectionWeldingCapability)
...
| ---  | ---  |
| self | sudokn:ProjectionWeldingCapability |
| native | sudokn-kg/:SudoknProjectionWeldingCapability |
