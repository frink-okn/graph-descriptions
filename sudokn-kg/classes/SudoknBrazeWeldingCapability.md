...
# Class: No class (type) name specified (sudokn_BrazeWeldingCapability)
...
URI: [sudokn:BrazeWeldingCapability](http://asu.edu/semantics/SUDOKN/BrazeWeldingCapability)
...
```mermaid
 classDiagram
    class SudoknBrazeWeldingCapability
    click SudoknBrazeWeldingCapability href "../SudoknBrazeWeldingCapability"
      ...
      SudoknBrazeWeldingCapability <|-- SudoknCarbonArcBrazingCapability
        click SudoknCarbonArcBrazingCapability href "../SudoknCarbonArcBrazingCapability"
      SudoknBrazeWeldingCapability <|-- SudoknGasBrazingCapability
        click SudoknGasBrazingCapability href "../SudoknGasBrazingCapability"
      
      
      SudoknBrazeWeldingCapability : rdfs_label
        
          
    
    
    SudoknBrazeWeldingCapability --> "0..1" String : rdfs_label
            ...
            * [SudoknThermaJoiningCapability](../classes/SudoknThermaJoiningCapability.md)
                * [SudoknThermalWeldingCapability](../classes/SudoknThermalWeldingCapability.md)
                    * **SudoknBrazeWeldingCapability**
                        * [SudoknCarbonArcBrazingCapability](../classes/SudoknCarbonArcBrazingCapability.md)
                        * [SudoknGasBrazingCapability](../classes/SudoknGasBrazingCapability.md)
...
```yaml
name: sudokn_BrazeWeldingCapability
...
class_uri: sudokn:BrazeWeldingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_BrazeWeldingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
    - owl_NamedIndividual
