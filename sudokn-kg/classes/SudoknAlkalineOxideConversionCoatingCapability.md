...
# Class: SudoknAlkalineOxideConversionCoatingCapability





URI: [sudokn:AlkalineOxideConversionCoatingCapability](http://asu.edu/semantics/SUDOKN/AlkalineOxideConversionCoatingCapability)
...
```mermaid
 classDiagram
    ...
    click SudoknAlkalineOxideConversionCoatingCapability href "../SudoknAlkalineOxideConversionCoatingCapability"
      ...
      SudoknAlkalineOxideConversionCoatingCapability : rdfs_label
        
          
    
    
    SudoknAlkalineOxideConversionCoatingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: sudokn_AlkalineOxideConversionCoatingCapability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_ChemicalConversionCoatingCapability
class_uri: sudokn:AlkalineOxideConversionCoatingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_AlkalineOxideConversionCoatingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
