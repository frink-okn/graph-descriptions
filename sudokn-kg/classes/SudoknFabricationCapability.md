...
# Class: TODO -- what's a good name for this class (type)? (sudokn_FabricationCapability)
...
URI: [sudokn:FabricationCapability](http://asu.edu/semantics/SUDOKN/FabricationCapability)
...
```mermaid
 classDiagram
    class SudoknFabricationCapability
    click SudoknFabricationCapability href "../SudoknFabricationCapability"
      SudoknFabricationCapability : rdfs_label
        
          
    
    
    SudoknFabricationCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknFabricationCapability](../classes/SudoknFabricationCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknFabricationCapability](../classes/SudoknFabricationCapability.md) |
...
| Value |
| --- |
| sudokn:A-LineCorporation-Fabrication |
...
| ---  | ---  |
| self | sudokn:FabricationCapability |
| native | sudokn-kg/:SudoknFabricationCapability |
...
<details>
```yaml
name: sudokn_FabricationCapability
...
- if you think the class is perfect.
notes:
- Class with 121 occurences.
examples:
- value: sudokn:A-LineCorporation-Fabrication
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:FabricationCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_FabricationCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
