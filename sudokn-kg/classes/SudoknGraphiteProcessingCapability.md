...
# Class: TODO -- what's a good name for this class (type)? (sudokn_GraphiteProcessingCapability)
...
URI: [sudokn:GraphiteProcessingCapability](http://asu.edu/semantics/SUDOKN/GraphiteProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknGraphiteProcessingCapability
    click SudoknGraphiteProcessingCapability href "../SudoknGraphiteProcessingCapability"
      SudoknGraphiteProcessingCapability : rdfs_label
        
          
    
    
    SudoknGraphiteProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknGraphiteProcessingCapability](../classes/SudoknGraphiteProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknGraphiteProcessingCapability](../classes/SudoknGraphiteProcessingCapability.md) |
...
| ---  | ---  |
| self | sudokn:GraphiteProcessingCapability |
| native | sudokn-kg/:SudoknGraphiteProcessingCapability |
...
<details>
```yaml
name: sudokn_GraphiteProcessingCapability
...
- if you think the class is perfect.
notes:
- Class with 472 occurences.
examples:
- value: sudokn:101PIPE-Graphite-inst
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:GraphiteProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_GraphiteProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
