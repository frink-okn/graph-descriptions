...
# Class: TODO -- what's a good name for this class (type)? (sudokn_WiringCapability)
...
URI: [sudokn:WiringCapability](http://asu.edu/semantics/SUDOKN/WiringCapability)
...
```mermaid
 classDiagram
    class SudoknWiringCapability
    click SudoknWiringCapability href "../SudoknWiringCapability"
      SudoknWiringCapability : rdfs_label
        
          
    
    
    SudoknWiringCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknWiringCapability](../classes/SudoknWiringCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknWiringCapability](../classes/SudoknWiringCapability.md) |
...
| ---  | ---  |
| self | sudokn:WiringCapability |
| native | sudokn-kg/:SudoknWiringCapability |
...
examples:
- value: sudokn:GrowlerManufacturingandEngineering-Wiring
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:WiringCapability
