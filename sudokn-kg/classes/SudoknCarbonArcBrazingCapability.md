...
# Class: TODO -- what's a good name for this class (type)? (sudokn_CarbonArcBrazingCapability)
...
| ---  | ---  |
| self | sudokn:CarbonArcBrazingCapability |
| native | sudokn-kg/:SudoknCarbonArcBrazingCapability |
