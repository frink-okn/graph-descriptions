...
# Class: No class (entity type) name specified -- this class is noted as a superclass of another class in this graph but has not itself been defined. (coso_Substance)
...
```mermaid
 classDiagram
    ...
    click CosoSubstance href "../CosoSubstance"
      ...
      CosoSubstance : rdfs_label
        
          
    
    
    CosoSubstance --> "0..1" String : rdfs_label
    click String href "../String"

        
      CosoSubstance : skos_altLabel
        
          
    
    
    CosoSubstance --> "0..1" String : skos_altLabel
    click String href "../String"
