...
# Class: TODO -- what's a good name for this class (type)? (sudokn_ScreenPrintingCapability)
...
URI: [sudokn:ScreenPrintingCapability](http://asu.edu/semantics/SUDOKN/ScreenPrintingCapability)
...
```mermaid
 classDiagram
    class SudoknScreenPrintingCapability
    click SudoknScreenPrintingCapability href "../SudoknScreenPrintingCapability"
      SudoknScreenPrintingCapability : rdfs_label
        
          
    
    
    SudoknScreenPrintingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknScreenPrintingCapability](../classes/SudoknScreenPrintingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknScreenPrintingCapability](../classes/SudoknScreenPrintingCapability.md) |
...
| Value |
| --- |
| sudokn:Accu-Fab-ScreenPrinting |
...
| ---  | ---  |
| self | sudokn:ScreenPrintingCapability |
| native | sudokn-kg/:SudoknScreenPrintingCapability |
...
<details>
```yaml
name: sudokn_ScreenPrintingCapability
...
examples:
- value: sudokn:Accu-Fab-ScreenPrinting
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:ScreenPrintingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ScreenPrintingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
