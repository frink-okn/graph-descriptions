...
# Class: TODO -- what's a good name for this class (type)? (sudokn_ElectronicAutomotiveInudstry)
...
URI: [sudokn:ElectronicAutomotiveInudstry](http://asu.edu/semantics/SUDOKN/ElectronicAutomotiveInudstry)
...
```mermaid
 classDiagram
    class SudoknElectronicAutomotiveInudstry
    click SudoknElectronicAutomotiveInudstry href "../SudoknElectronicAutomotiveInudstry"
      SudoknElectronicAutomotiveInudstry : rdfs_label
        
          
    
    
    SudoknElectronicAutomotiveInudstry --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknElectronicAutomotiveInudstry](../classes/SudoknElectronicAutomotiveInudstry.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknElectronicAutomotiveInudstry](../classes/SudoknElectronicAutomotiveInudstry.md) |
...
| Value |
| --- |
| sudokn:electronicautomotiveinudstry-inst |
...
| ---  | ---  |
| self | sudokn:ElectronicAutomotiveInudstry |
| native | sudokn-kg/:SudoknElectronicAutomotiveInudstry |
...
<details>
```yaml
name: sudokn_ElectronicAutomotiveInudstry
...
examples:
- value: sudokn:electronicautomotiveinudstry-inst
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:ElectronicAutomotiveInudstry
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ElectronicAutomotiveInudstry
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
