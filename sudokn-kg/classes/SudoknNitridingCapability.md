...
# Class: TODO -- what's a good name for this class (type)? (sudokn_NitridingCapability)
...
URI: [sudokn:NitridingCapability](http://asu.edu/semantics/SUDOKN/NitridingCapability)
...
```mermaid
 classDiagram
    class SudoknNitridingCapability
    click SudoknNitridingCapability href "../SudoknNitridingCapability"
      ...
      SudoknNitridingCapability : rdfs_label
        
          
    
    
    SudoknNitridingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknNitridingCapability](../classes/SudoknNitridingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknNitridingCapability](../classes/SudoknNitridingCapability.md) |
...
| Value |
| --- |
| sudokn:ACCURATESTEELTREATING-NitridingCapability-inst |
...
| ---  | ---  |
| self | sudokn:NitridingCapability |
| native | sudokn-kg/:SudoknNitridingCapability |
...
<details>
```yaml
name: sudokn_NitridingCapability
...
examples:
- value: sudokn:ACCURATESTEELTREATING-NitridingCapability-inst
from_schema: sudokn-kg
is_a: sudokn_DiffusionHardeningCapability
slots:
- rdfs_label
class_uri: sudokn:NitridingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_NitridingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
