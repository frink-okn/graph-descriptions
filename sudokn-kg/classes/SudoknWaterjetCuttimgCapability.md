...
# Class: TODO -- what's a good name for this class (type)? (sudokn_WaterjetCuttimgCapability)
...
URI: [sudokn:WaterjetCuttimgCapability](http://asu.edu/semantics/SUDOKN/WaterjetCuttimgCapability)
...
```mermaid
 classDiagram
    class SudoknWaterjetCuttimgCapability
    click SudoknWaterjetCuttimgCapability href "../SudoknWaterjetCuttimgCapability"
      SudoknWaterjetCuttimgCapability : rdfs_label
        
          
    
    
    SudoknWaterjetCuttimgCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknWaterjetCuttimgCapability](../classes/SudoknWaterjetCuttimgCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknWaterjetCuttimgCapability](../classes/SudoknWaterjetCuttimgCapability.md) |
...
| Value |
| --- |
| sudokn:MechanicalSpecialty-WaterjetCuttimg |
...
| ---  | ---  |
| self | sudokn:WaterjetCuttimgCapability |
| native | sudokn-kg/:SudoknWaterjetCuttimgCapability |
...
<details>
```yaml
name: sudokn_WaterjetCuttimgCapability
...
examples:
- value: sudokn:MechanicalSpecialty-WaterjetCuttimg
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:WaterjetCuttimgCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_WaterjetCuttimgCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
