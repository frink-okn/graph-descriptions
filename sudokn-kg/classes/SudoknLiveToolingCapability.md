...
# Class: TODO -- what's a good name for this class (type)? (sudokn_LiveToolingCapability)
...
```mermaid
 classDiagram
    ...
    SudoknLiveToolingCapability --> "0..1" String : rdfs_label
...
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknLiveToolingCapability](../classes/SudoknLiveToolingCapability.md) |
...
| Value |
| --- |
| sudokn:A-1PRECISION-LiveToolingCapability-inst |
...
| ---  | ---  |
| self | sudokn:LiveToolingCapability |
| native | sudokn-kg/:SudoknLiveToolingCapability |
...
- if you think the class is perfect.
notes:
- Class with 287 occurences.
examples:
- value: sudokn:A-1PRECISION-LiveToolingCapability-inst
