...
# Class: EGAD - Analysis Method (me_egad_EGAD-AnalysisMethod)
...
URI: [me_egad:EGAD-AnalysisMethod](http://sawgraph.spatialai.org/v1/me-egad#EGAD-AnalysisMethod)
...
```mermaid
 classDiagram
    class MeEgadEGAD-AnalysisMethod
    click MeEgadEGAD-AnalysisMethod href "../MeEgadEGAD-AnalysisMethod"
      ...
      MeEgadEGAD-AnalysisMethod : owl_sameAs
        
          
    
    
    MeEgadEGAD-AnalysisMethod --> "0..1" OwlThing : owl_sameAs
    click OwlThing href "../OwlThing"

        
      MeEgadEGAD-AnalysisMethod : rdfs_label
        
          
    
    
    MeEgadEGAD-AnalysisMethod --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- |
| [HttpW3id.orgSawgraphV1Me-egad#EGAD-PFAS-Observation](../classes/HttpW3id.orgSawgraphV1Me-egad#EGAD-PFAS-Observation.md) | [coso_analysisMethod](../slots/coso_analysisMethod.md) | any_of[range] | [MeEgadEGAD-AnalysisMethod](../classes/MeEgadEGAD-AnalysisMethod.md) |
| [MeEgadEGAD-PFAS-Observation](../classes/MeEgadEGAD-PFAS-Observation.md) | [coso_analysisMethod](../slots/coso_analysisMethod.md) | any_of[range] | [MeEgadEGAD-AnalysisMethod](../classes/MeEgadEGAD-AnalysisMethod.md) |
...
```yaml
name: me_egad_EGAD-AnalysisMethod
...
- rdfs_label
- owl_sameAs
class_uri: me_egad:EGAD-AnalysisMethod
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: me_egad_EGAD-AnalysisMethod
    domain_of:
