...
# Class: TODO -- what's a good name for this class (type)? (sudokn_Oxy-FuelCuttingCapability)
...
URI: [sudokn:Oxy-FuelCuttingCapability](http://asu.edu/semantics/SUDOKN/Oxy-FuelCuttingCapability)
...
```mermaid
 classDiagram
    class SudoknOxy-FuelCuttingCapability
    click SudoknOxy-FuelCuttingCapability href "../SudoknOxy-FuelCuttingCapability"
      SudoknOxy-FuelCuttingCapability : rdfs_label
        
          
    
    
    SudoknOxy-FuelCuttingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknOxy-FuelCuttingCapability](../classes/SudoknOxy-FuelCuttingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknOxy-FuelCuttingCapability](../classes/SudoknOxy-FuelCuttingCapability.md) |
...
| Value |
| --- |
| sudokn:ALABAMAPLATE-Oxy-FuelCuttingCapability-inst |
...
| ---  | ---  |
| self | sudokn:Oxy-FuelCuttingCapability |
| native | sudokn-kg/:SudoknOxy-FuelCuttingCapability |
...
<details>
```yaml
name: sudokn_Oxy-FuelCuttingCapability
...
- if you think the class is perfect.
notes:
- Class with 27 occurences.
examples:
- value: sudokn:ALABAMAPLATE-Oxy-FuelCuttingCapability-inst
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:Oxy-FuelCuttingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_Oxy-FuelCuttingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
