...
# Class: HttpsIdir.uta.eduSockg-ontology#HarvestedFraction
...
URI: [https://idir.uta.edu/sockg-ontology#HarvestedFraction](https://idir.uta.edu/sockg-ontology#HarvestedFraction)
...
```mermaid
 classDiagram
    ...
    click HttpsIdir.uta.eduSockg-ontology#HarvestedFraction href "../HttpsIdir.uta.eduSockg-ontology#HarvestedFraction"
      HttpsIdir.uta.eduSockg-ontology#HarvestedFraction : rdfs_label
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#HarvestedFraction --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: https___idir.uta.edu_sockg-ontology#HarvestedFraction
from_schema: okns:soc-kg
rank: 1000
slots:
- rdfs_label
class_uri: https://idir.uta.edu/sockg-ontology#HarvestedFraction
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: https___idir.uta.edu_sockg-ontology#HarvestedFraction
    domain_of:
    - qudt_AspectClass
    - qudt_BinaryPrefix
