...
# Class: plating capability (sudokn_PlatingCapability)
...
URI: [sudokn:PlatingCapability](http://asu.edu/semantics/SUDOKN/PlatingCapability)
...
```mermaid
 classDiagram
    ...
    click SudoknPlatingCapability href "../SudoknPlatingCapability"
      ...
      SudoknPlatingCapability : rdfs_label
        
          
    
    
    SudoknPlatingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknPlatingCapability](../classes/SudoknPlatingCapability.md) |
...
```yaml
name: sudokn_PlatingCapability
title: plating capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_ChemicalCoatingCapability
slots:
- rdfs_label
class_uri: sudokn:PlatingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_PlatingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
