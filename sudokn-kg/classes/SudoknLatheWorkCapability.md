...
# Class: TODO -- what's a good name for this class (type)? (sudokn_LatheWorkCapability)
...
URI: [sudokn:LatheWorkCapability](http://asu.edu/semantics/SUDOKN/LatheWorkCapability)
...
```mermaid
 classDiagram
    class SudoknLatheWorkCapability
    click SudoknLatheWorkCapability href "../SudoknLatheWorkCapability"
      SudoknLatheWorkCapability : rdfs_label
        
          
    
    
    SudoknLatheWorkCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknLatheWorkCapability](../classes/SudoknLatheWorkCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknLatheWorkCapability](../classes/SudoknLatheWorkCapability.md) |
...
| Value |
| --- |
| sudokn:CarolinaPrecisionMachining-LatheWork |
...
| ---  | ---  |
| self | sudokn:LatheWorkCapability |
| native | sudokn-kg/:SudoknLatheWorkCapability |
...
<details>
```yaml
name: sudokn_LatheWorkCapability
...
examples:
- value: sudokn:CarolinaPrecisionMachining-LatheWork
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:LatheWorkCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_LatheWorkCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
