...
# Class: TODO -- what's a good name for this class (type)? (sudokn_BrassBlackeningCapability)
...
URI: [sudokn:BrassBlackeningCapability](http://asu.edu/semantics/SUDOKN/BrassBlackeningCapability)
...
```mermaid
 classDiagram
    class SudoknBrassBlackeningCapability
    click SudoknBrassBlackeningCapability href "../SudoknBrassBlackeningCapability"
      SudoknBrassBlackeningCapability : rdfs_label
        
          
    
    
    SudoknBrassBlackeningCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknBrassBlackeningCapability](../classes/SudoknBrassBlackeningCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknBrassBlackeningCapability](../classes/SudoknBrassBlackeningCapability.md) |
...
| Value |
| --- |
| sudokn:ClaroLux-BrassBlackening |
...
| ---  | ---  |
| self | sudokn:BrassBlackeningCapability |
| native | sudokn-kg/:SudoknBrassBlackeningCapability |
...
<details>
```yaml
name: sudokn_BrassBlackeningCapability
...
examples:
- value: sudokn:ClaroLux-BrassBlackening
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:BrassBlackeningCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_BrassBlackeningCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
