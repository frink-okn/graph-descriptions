...
# Class: No class (type) name specified (sudokn_FinanceAndInsurance)
...
URI: [sudokn:FinanceAndInsurance](http://asu.edu/semantics/SUDOKN/FinanceAndInsurance)
...
```mermaid
 classDiagram
    class SudoknFinanceAndInsurance
    click SudoknFinanceAndInsurance href "../SudoknFinanceAndInsurance"
      ...
      SudoknFinanceAndInsurance : sudokn_hasNAICSCodeValue
        
          
    
    
    SudoknFinanceAndInsurance --> "0..1" Any : sudokn_hasNAICSCodeValue
    click Any href "../Any"

        
      SudoknFinanceAndInsurance : sudokn_hasNAICSTextValue
        
          
    
    
    SudoknFinanceAndInsurance --> "0..1" Any : sudokn_hasNAICSTextValue
    click Any href "../Any"
...
```yaml
name: sudokn_FinanceAndInsurance
...
class_uri: sudokn:FinanceAndInsurance
...
attributes:
  sudokn_hasNAICSCodeValue:
    ...
    owner: sudokn_FinanceAndInsurance
    domain_of:
    - sudokn_NAICS332111
    - sudokn_NAICS332112
    - sudokn_NAICS332114
