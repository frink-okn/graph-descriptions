...
# Class: electronic automotive inudstry (sudokn_ElectricAutomotiveIndustry)
...
URI: [sudokn:ElectricAutomotiveIndustry](http://asu.edu/semantics/SUDOKN/ElectricAutomotiveIndustry)
...
```mermaid
 classDiagram
    class SudoknElectricAutomotiveIndustry
    click SudoknElectricAutomotiveIndustry href "../SudoknElectricAutomotiveIndustry"
      ...
      SudoknElectricAutomotiveIndustry : rdfs_label
        
          
    
    
    SudoknElectricAutomotiveIndustry --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string) | TODO -- tell the world what this slot (predicate) describes | [SudoknAutomotiveIndustry](../classes/SudoknAutomotiveIndustry.md) |
...
| ---  | ---  |
| self | sudokn:ElectricAutomotiveIndustry |
| native | sudokn-kg/:SudoknElectricAutomotiveIndustry |
...
<details>
```yaml
name: sudokn_ElectricAutomotiveIndustry
description: TODO -- tell the world what this class (type) describes.
title: electronic automotive inudstry
todos:
- TODO -- Todos for this class go here
- or you can delete the todos
- if you think the class is perfect.
...
is_a: sudokn_AutomotiveIndustry
class_uri: sudokn:ElectricAutomotiveIndustry
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ElectricAutomotiveIndustry
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
