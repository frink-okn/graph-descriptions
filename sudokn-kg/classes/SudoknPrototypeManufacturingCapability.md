...
# Class: TODO -- what's a good name for this class (type)? (sudokn_PrototypeManufacturingCapability)
...
URI: [sudokn:PrototypeManufacturingCapability](http://asu.edu/semantics/SUDOKN/PrototypeManufacturingCapability)
...
```mermaid
 classDiagram
    class SudoknPrototypeManufacturingCapability
    click SudoknPrototypeManufacturingCapability href "../SudoknPrototypeManufacturingCapability"
      SudoknPrototypeManufacturingCapability : rdfs_label
        
          
    
    
    SudoknPrototypeManufacturingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknPrototypeManufacturingCapability](../classes/SudoknPrototypeManufacturingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknPrototypeManufacturingCapability](../classes/SudoknPrototypeManufacturingCapability.md) |
...
| Value |
| --- |
| sudokn:LeonardFabricationandDesign-PrototypeManufacturing |
...
| ---  | ---  |
| self | sudokn:PrototypeManufacturingCapability |
| native | sudokn-kg/:SudoknPrototypeManufacturingCapability |
...
<details>
```yaml
name: sudokn_PrototypeManufacturingCapability
...
examples:
- value: sudokn:LeonardFabricationandDesign-PrototypeManufacturing
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:PrototypeManufacturingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_PrototypeManufacturingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
