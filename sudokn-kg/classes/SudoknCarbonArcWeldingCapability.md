...
# Class: No class (type) name specified (sudokn_CarbonArcWeldingCapability)
...
URI: [sudokn:CarbonArcWeldingCapability](http://asu.edu/semantics/SUDOKN/CarbonArcWeldingCapability)
...
```mermaid
 classDiagram
    class SudoknCarbonArcWeldingCapability
    click SudoknCarbonArcWeldingCapability href "../SudoknCarbonArcWeldingCapability"
      ...
      SudoknCarbonArcWeldingCapability : rdfs_label
        
          
    
    
    SudoknCarbonArcWeldingCapability --> "0..1" String : rdfs_label
...
```yaml
name: sudokn_CarbonArcWeldingCapability
...
class_uri: sudokn:CarbonArcWeldingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_CarbonArcWeldingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
    - owl_NamedIndividual
