...
# Class: ITAR certificate (sudokn_ITARCertificate)
...
| ---  | ---  |
| self | sudokn:ITARCertificate |
| native | sudokn-kg/:SudoknITARCertificate |
...
title: ITAR certificate
todos:
- TODO -- Todos for this class go here
- or you can delete the todos
- if you think the class is perfect.
notes:
- Class with 127 occurences.
examples:
- value: sudokn:5HFAB-ITARCertificate
