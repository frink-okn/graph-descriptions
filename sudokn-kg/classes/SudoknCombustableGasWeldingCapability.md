...
# Class: No class (type) name specified (sudokn_CombustableGasWeldingCapability)
...
URI: [sudokn:CombustableGasWeldingCapability](http://asu.edu/semantics/SUDOKN/CombustableGasWeldingCapability)
...
```mermaid
 classDiagram
    class SudoknCombustableGasWeldingCapability
    click SudoknCombustableGasWeldingCapability href "../SudoknCombustableGasWeldingCapability"
      ...
      SudoknCombustableGasWeldingCapability : rdfs_label
        
          
    
    
    SudoknCombustableGasWeldingCapability --> "0..1" String : rdfs_label
...
```yaml
name: sudokn_CombustableGasWeldingCapability
...
class_uri: sudokn:CombustableGasWeldingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_CombustableGasWeldingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
    - owl_NamedIndividual
