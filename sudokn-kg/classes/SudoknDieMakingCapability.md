...
# Class: TODO -- what's a good name for this class (type)? (sudokn_DieMakingCapability)
...
URI: [sudokn:DieMakingCapability](http://asu.edu/semantics/SUDOKN/DieMakingCapability)
...
```mermaid
 classDiagram
    class SudoknDieMakingCapability
    click SudoknDieMakingCapability href "../SudoknDieMakingCapability"
      SudoknDieMakingCapability : rdfs_label
        
          
    
    
    SudoknDieMakingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknDieMakingCapability](../classes/SudoknDieMakingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknDieMakingCapability](../classes/SudoknDieMakingCapability.md) |
...
| Value |
| --- |
| sudokn:AllredMetalStampingWorks-DieMaking |
...
| ---  | ---  |
| self | sudokn:DieMakingCapability |
| native | sudokn-kg/:SudoknDieMakingCapability |
...
<details>
```yaml
name: sudokn_DieMakingCapability
...
examples:
- value: sudokn:AllredMetalStampingWorks-DieMaking
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:DieMakingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_DieMakingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
