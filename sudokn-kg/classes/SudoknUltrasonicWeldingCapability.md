...
# Class: No class (type) name specified (sudokn_UltrasonicWeldingCapability)
...
URI: [sudokn:UltrasonicWeldingCapability](http://asu.edu/semantics/SUDOKN/UltrasonicWeldingCapability)
...
```mermaid
 classDiagram
    class SudoknUltrasonicWeldingCapability
    click SudoknUltrasonicWeldingCapability href "../SudoknUltrasonicWeldingCapability"
      ...
      SudoknUltrasonicWeldingCapability : rdfs_label
        
          
    
    
    SudoknUltrasonicWeldingCapability --> "0..1" String : rdfs_label
...
```yaml
name: sudokn_UltrasonicWeldingCapability
...
rank: 1000
is_a: sudokn_MechanicalWeldingCapability
class_uri: sudokn:UltrasonicWeldingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_UltrasonicWeldingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
    - owl_NamedIndividual
