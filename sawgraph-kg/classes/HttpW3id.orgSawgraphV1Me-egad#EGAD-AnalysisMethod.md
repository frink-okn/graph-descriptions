...
# Class: EGAD - Analysis Method (http___w3id.org_sawgraph_v1_me-egad#EGAD-AnalysisMethod)
...
URI: [http://w3id.org/sawgraph/v1/me-egad#EGAD-AnalysisMethod](http://w3id.org/sawgraph/v1/me-egad#EGAD-AnalysisMethod)
...
```mermaid
 classDiagram
    class HttpW3id.orgSawgraphV1Me-egad#EGAD-AnalysisMethod
    click HttpW3id.orgSawgraphV1Me-egad#EGAD-AnalysisMethod href "../HttpW3id.orgSawgraphV1Me-egad#EGAD-AnalysisMethod"
      SosaProcedure <|-- HttpW3id.orgSawgraphV1Me-egad#EGAD-AnalysisMethod
        click SosaProcedure href "../SosaProcedure"
      
      HttpW3id.orgSawgraphV1Me-egad#EGAD-AnalysisMethod : owl_sameAs
        
          
    
    
    HttpW3id.orgSawgraphV1Me-egad#EGAD-AnalysisMethod --> "0..1" OwlThing : owl_sameAs
    click OwlThing href "../OwlThing"

        
      HttpW3id.orgSawgraphV1Me-egad#EGAD-AnalysisMethod : rdfs_label
        
          
    
    
    HttpW3id.orgSawgraphV1Me-egad#EGAD-AnalysisMethod --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- |
| [HttpW3id.orgSawgraphV1Me-egad#EGAD-PFAS-Observation](../classes/HttpW3id.orgSawgraphV1Me-egad#EGAD-PFAS-Observation.md) | [coso_analysisMethod](../slots/coso_analysisMethod.md) | any_of[range] | [HttpW3id.orgSawgraphV1Me-egad#EGAD-AnalysisMethod](../classes/HttpW3id.orgSawgraphV1Me-egad#EGAD-AnalysisMethod.md) |
| [MeEgadEGAD-PFAS-Observation](../classes/MeEgadEGAD-PFAS-Observation.md) | [coso_analysisMethod](../slots/coso_analysisMethod.md) | any_of[range] | [HttpW3id.orgSawgraphV1Me-egad#EGAD-AnalysisMethod](../classes/HttpW3id.orgSawgraphV1Me-egad#EGAD-AnalysisMethod.md) |
...
```yaml
name: http___w3id.org_sawgraph_v1_me-egad#EGAD-AnalysisMethod
title: EGAD - Analysis Method
...
- rdfs_label
- owl_sameAs
class_uri: http://w3id.org/sawgraph/v1/me-egad#EGAD-AnalysisMethod
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: http___w3id.org_sawgraph_v1_me-egad#EGAD-AnalysisMethod
    domain_of:
