...
# Class: HttpsIdir.uta.eduSockg-ontology#GrowthStage
...
URI: [https://idir.uta.edu/sockg-ontology#GrowthStage](https://idir.uta.edu/sockg-ontology#GrowthStage)
...
```mermaid
 classDiagram
    ...
    click HttpsIdir.uta.eduSockg-ontology#GrowthStage href "../HttpsIdir.uta.eduSockg-ontology#GrowthStage"
      HttpsIdir.uta.eduSockg-ontology#GrowthStage : rdfs_label
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#GrowthStage --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: https___idir.uta.edu_sockg-ontology#GrowthStage
from_schema: okns:soc-kg
rank: 1000
slots:
- rdfs_label
class_uri: https://idir.uta.edu/sockg-ontology#GrowthStage
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: https___idir.uta.edu_sockg-ontology#GrowthStage
    domain_of:
    - qudt_AspectClass
    - qudt_BinaryPrefix
