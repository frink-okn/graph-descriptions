...
# Class: TODO -- what's a good name for this class (type)? (sudokn_WeldingCapability)
...
URI: [sudokn:WeldingCapability](http://asu.edu/semantics/SUDOKN/WeldingCapability)
...
```mermaid
 classDiagram
    class SudoknWeldingCapability
    click SudoknWeldingCapability href "../SudoknWeldingCapability"
      SudoknWeldingCapability : rdfs_label
        
          
    
    
    SudoknWeldingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknWeldingCapability](../classes/SudoknWeldingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknWeldingCapability](../classes/SudoknWeldingCapability.md) |
...
| Value |
| --- |
| sudokn:1DIETECH-WeldingCapability-inst |
...
| ---  | ---  |
| self | sudokn:WeldingCapability |
| native | sudokn-kg/:SudoknWeldingCapability |
...
- if you think the class is perfect.
notes:
- Class with 2700 occurences.
examples:
- value: sudokn:1DIETECH-WeldingCapability-inst
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:WeldingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_WeldingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
