...
# Class: TODO -- what's a good name for this class (type)? (sudokn_HastelloyProcessingCapability)
...
URI: [sudokn:HastelloyProcessingCapability](http://asu.edu/semantics/SUDOKN/HastelloyProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknHastelloyProcessingCapability
    click SudoknHastelloyProcessingCapability href "../SudoknHastelloyProcessingCapability"
      SudoknHastelloyProcessingCapability : rdfs_label
        
          
    
    
    SudoknHastelloyProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknHastelloyProcessingCapability](../classes/SudoknHastelloyProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknHastelloyProcessingCapability](../classes/SudoknHastelloyProcessingCapability.md) |
...
| ---  | ---  |
| self | sudokn:HastelloyProcessingCapability |
| native | sudokn-kg/:SudoknHastelloyProcessingCapability |
...
<details>
```yaml
name: sudokn_HastelloyProcessingCapability
...
- if you think the class is perfect.
notes:
- Class with 321 occurences.
examples:
- value: sudokn:AAGROUP-Hastelloy-inst
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:HastelloyProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_HastelloyProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
