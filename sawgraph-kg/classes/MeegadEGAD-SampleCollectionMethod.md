...
# Class: TODO -- what's a good name for this class (type)? (meegad_EGAD-SampleCollectionMethod)
...
URI: [meegad:EGAD-SampleCollectionMethod](http://sawgraph.spatialai.org/v1/me-egad#EGAD-SampleCollectionMethod)
...
| ---  | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string)&nbsp;or&nbsp;<br />[xsd:anyURI](http://www.w3.org/2001/XMLSchema#anyURI) | No slot description provided | [ContaminosoSampleAnnotation](../classes/ContaminosoSampleAnnotation.md) |
...
| ---  | ---  |
| self | meegad:EGAD-SampleCollectionMethod |
| native | sawgraph-kg/:MeegadEGAD-SampleCollectionMethod |
...
<details>
```yaml
name: meegad_EGAD-SampleCollectionMethod
...
- if you think the class is perfect.
notes:
- Class with 113 occurences.
from_schema: sawgraph-kg
rank: 1000
is_a: contaminoso_SampleAnnotation
class_uri: meegad:EGAD-SampleCollectionMethod
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: meegad_EGAD-SampleCollectionMethod
    domain_of:
