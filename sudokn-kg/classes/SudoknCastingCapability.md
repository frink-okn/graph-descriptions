...
```mermaid
 classDiagram
    ...
    SudoknCastingCapability --> "0..1" String : rdfs_label
...
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCastingCapability](../classes/SudoknCastingCapability.md) |
...
| Value |
| --- |
| sudokn:3DIMENSIONAL-CastingCapability-inst |
...
| ---  | ---  |
| self | sudokn:CastingCapability |
| native | sudokn-kg/:SudoknCastingCapability |
...
- if you think the class is perfect.
notes:
- Class with 1195 occurences.
examples:
- value: sudokn:3DIMENSIONAL-CastingCapability-inst
