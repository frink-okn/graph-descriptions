...
# Class: WQP - Sample (http___w3id.org_sawgraph_v1_us-wqp#Sample)




This class occurs 5109 times.


URI: [http://w3id.org/sawgraph/v1/us-wqp#Sample](http://w3id.org/sawgraph/v1/us-wqp#Sample)
...
```mermaid
 classDiagram
    class HttpW3id.orgSawgraphV1Us-wqp#Sample
    click HttpW3id.orgSawgraphV1Us-wqp#Sample href "../HttpW3id.orgSawgraphV1Us-wqp#Sample"
      ...
      HttpW3id.orgSawgraphV1Us-wqp#Sample : coso_fromSamplePoint
        
          
    
    
    HttpW3id.orgSawgraphV1Us-wqp#Sample --> "0..1" Any : coso_fromSamplePoint
    click Any href "../Any"

        
      HttpW3id.orgSawgraphV1Us-wqp#Sample : coso_sampleOfMaterialType
        
          
    
    
    HttpW3id.orgSawgraphV1Us-wqp#Sample --> "0..1" Any : coso_sampleOfMaterialType
    click Any href "../Any"

        
      HttpW3id.orgSawgraphV1Us-wqp#Sample : http___w3id.org_sawgraph_v1_us_wqp#hasProjectId
        
          
    
    
    HttpW3id.orgSawgraphV1Us-wqp#Sample --> "0..1" Any : http___w3id.org_sawgraph_v1_us_wqp#hasProjectId
    click Any href "../Any"

        
      HttpW3id.orgSawgraphV1Us-wqp#Sample : http___w3id.org_sawgraph_v1_us_wqp#sampleCollectionMethod
        
          
    
    
    HttpW3id.orgSawgraphV1Us-wqp#Sample --> "0..1" Any : http___w3id.org_sawgraph_v1_us_wqp#sampleCollectionMethod
    click Any href "../Any"

        
      HttpW3id.orgSawgraphV1Us-wqp#Sample : http___w3id.org_sawgraph_v1_us_wqp#sampleID
        
          
    
    
    HttpW3id.orgSawgraphV1Us-wqp#Sample --> "0..1" String : http___w3id.org_sawgraph_v1_us_wqp#sampleID
    click String href "../String"

        
      HttpW3id.orgSawgraphV1Us-wqp#Sample : rdfs_label
        
          
    
    
    HttpW3id.orgSawgraphV1Us-wqp#Sample --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- |
| [HttpW3id.orgSawgraphV1Me-egad#EGAD-PFAS-Observation](../classes/HttpW3id.orgSawgraphV1Me-egad#EGAD-PFAS-Observation.md) | [coso_analyzedSample](../slots/coso_analyzedSample.md) | any_of[range] | [HttpW3id.orgSawgraphV1Us-wqp#Sample](../classes/HttpW3id.orgSawgraphV1Us-wqp#Sample.md) |
| [HttpW3id.orgSawgraphV1Us-wqp#Observation](../classes/HttpW3id.orgSawgraphV1Us-wqp#Observation.md) | [coso_analyzedSample](../slots/coso_analyzedSample.md) | any_of[range] | [HttpW3id.orgSawgraphV1Us-wqp#Sample](../classes/HttpW3id.orgSawgraphV1Us-wqp#Sample.md) |
| [HttpW3id.orgSawgraphV1Us-wqp#Sample](../classes/HttpW3id.orgSawgraphV1Us-wqp#Sample.md) | [http___w3id.org_sawgraph_v1_us_wqp#sampleCollectionMethod](../slots/http___w3id.org_sawgraph_v1_us_wqp#sampleCollectionMethod.md) | domain | [HttpW3id.orgSawgraphV1Us-wqp#Sample](../classes/HttpW3id.orgSawgraphV1Us-wqp#Sample.md) |
| [HttpW3id.orgSawgraphV1Us-wqp#Sample](../classes/HttpW3id.orgSawgraphV1Us-wqp#Sample.md) | [http___w3id.org_sawgraph_v1_us_wqp#hasProjectId](../slots/http___w3id.org_sawgraph_v1_us_wqp#hasProjectId.md) | domain | [HttpW3id.orgSawgraphV1Us-wqp#Sample](../classes/HttpW3id.orgSawgraphV1Us-wqp#Sample.md) |
| [MeEgadEGAD-PFAS-Observation](../classes/MeEgadEGAD-PFAS-Observation.md) | [coso_analyzedSample](../slots/coso_analyzedSample.md) | any_of[range] | [HttpW3id.orgSawgraphV1Us-wqp#Sample](../classes/HttpW3id.orgSawgraphV1Us-wqp#Sample.md) |
...
```yaml
name: http___w3id.org_sawgraph_v1_us-wqp#Sample
title: WQP - Sample
from_schema: okns:sawgraph-kg
rank: 1000
is_a: coso_MaterialSample
slots:
- http___w3id.org_sawgraph_v1_us-wqp#sampleCollectionMethod
- http___w3id.org_sawgraph_v1_us-wqp#hasProjectId
- rdfs_label
- http___w3id.org_sawgraph_v1_us-wqp#sampleID
- coso_sampleOfMaterialType
- coso_fromSamplePoint
class_uri: http://w3id.org/sawgraph/v1/us-wqp#Sample
...
attributes:
  http___w3id.org_sawgraph_v1_us-wqp#sampleCollectionMethod:
    name: http___w3id.org_sawgraph_v1_us-wqp#sampleCollectionMethod
    title: wqp - sample collection method
    from_schema: okns:sawgraph-kg
    rank: 1000
    domain: http___w3id.org_sawgraph_v1_us-wqp#Sample
    slot_uri: http://w3id.org/sawgraph/v1/us-wqp#sampleCollectionMethod
    alias: http___w3id.org_sawgraph_v1_us_wqp#sampleCollectionMethod
    owner: http___w3id.org_sawgraph_v1_us-wqp#Sample
    domain_of:
    ...
    any_of:
    - range: uri
    - range: http___w3id.org_sawgraph_v1_us-wqp#SampleCollectionMethod
  http___w3id.org_sawgraph_v1_us-wqp#hasProjectId:
    name: http___w3id.org_sawgraph_v1_us-wqp#hasProjectId
    title: wqp - has project id
    from_schema: okns:sawgraph-kg
    rank: 1000
    domain: http___w3id.org_sawgraph_v1_us-wqp#Sample
    slot_uri: http://w3id.org/sawgraph/v1/us-wqp#hasProjectId
    alias: http___w3id.org_sawgraph_v1_us_wqp#hasProjectId
    owner: http___w3id.org_sawgraph_v1_us-wqp#Sample
    domain_of:
    - http___w3id.org_sawgraph_v1_us-wqp#Sample
    subproperty_of: coso_sampleAnnotation
    range: Any
    any_of:
    - range: http___w3id.org_sawgraph_v1_us-wqp#Project
    - range: uri
  rdfs_label:
    name: rdfs_label
    ...
    - range: string
  http___w3id.org_sawgraph_v1_us-wqp#sampleID:
    name: http___w3id.org_sawgraph_v1_us-wqp#sampleID
    title: wqp - sample id
    from_schema: okns:sawgraph-kg
    rank: 1000
    slot_uri: http://w3id.org/sawgraph/v1/us-wqp#sampleID
    alias: http___w3id.org_sawgraph_v1_us_wqp#sampleID
    owner: http___w3id.org_sawgraph_v1_us-wqp#Sample
    domain_of:
    - http___w3id.org_sawgraph_v1_us-wqp#Sample
    subproperty_of: coso_sampleAnnotation
