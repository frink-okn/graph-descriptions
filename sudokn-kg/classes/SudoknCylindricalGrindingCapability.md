...
# Class: TODO -- what's a good name for this class (type)? (sudokn_CylindricalGrindingCapability)
...
URI: [sudokn:CylindricalGrindingCapability](http://asu.edu/semantics/SUDOKN/CylindricalGrindingCapability)
...
```mermaid
 classDiagram
    class SudoknCylindricalGrindingCapability
    click SudoknCylindricalGrindingCapability href "../SudoknCylindricalGrindingCapability"
      SudoknCylindricalGrindingCapability : rdfs_label
        
          
    
    
    SudoknCylindricalGrindingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCylindricalGrindingCapability](../classes/SudoknCylindricalGrindingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCylindricalGrindingCapability](../classes/SudoknCylindricalGrindingCapability.md) |
...
| ---  | ---  |
| self | sudokn:CylindricalGrindingCapability |
| native | sudokn-kg/:SudoknCylindricalGrindingCapability |
...
<details>
```yaml
name: sudokn_CylindricalGrindingCapability
...
examples:
- value: sudokn:Voigt-AbernathyUniversalMachineDivision-CylindricalGrinding
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:CylindricalGrindingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_CylindricalGrindingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
