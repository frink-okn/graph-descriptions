...
# Class: TODO -- what's a good name for this class (type)? (sudokn_ContinuousCastingCapability)
...
URI: [sudokn:ContinuousCastingCapability](http://asu.edu/semantics/SUDOKN/ContinuousCastingCapability)
...
```mermaid
 classDiagram
    class SudoknContinuousCastingCapability
    click SudoknContinuousCastingCapability href "../SudoknContinuousCastingCapability"
      SudoknContinuousCastingCapability : rdfs_label
        
          
    
    
    SudoknContinuousCastingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknContinuousCastingCapability](../classes/SudoknContinuousCastingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknContinuousCastingCapability](../classes/SudoknContinuousCastingCapability.md) |
...
| Value |
| --- |
| sudokn:Aludisc-ContinuousCasting |
...
| ---  | ---  |
| self | sudokn:ContinuousCastingCapability |
| native | sudokn-kg/:SudoknContinuousCastingCapability |
...
<details>
```yaml
name: sudokn_ContinuousCastingCapability
...
examples:
- value: sudokn:Aludisc-ContinuousCasting
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:ContinuousCastingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ContinuousCastingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
