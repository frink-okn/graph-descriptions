...
# Class: No class (type) name specified (sudokn_ManagementOfCompaniesAndEnterprise)
...
URI: [sudokn:ManagementOfCompaniesAndEnterprise](http://asu.edu/semantics/SUDOKN/ManagementOfCompaniesAndEnterprise)
...
```mermaid
 classDiagram
    class SudoknManagementOfCompaniesAndEnterprise
    click SudoknManagementOfCompaniesAndEnterprise href "../SudoknManagementOfCompaniesAndEnterprise"
      ...
      SudoknManagementOfCompaniesAndEnterprise : sudokn_hasNAICSCodeValue
        
          
    
    
    SudoknManagementOfCompaniesAndEnterprise --> "0..1" Any : sudokn_hasNAICSCodeValue
    click Any href "../Any"

        
      SudoknManagementOfCompaniesAndEnterprise : sudokn_hasNAICSTextValue
        
          
    
    
    SudoknManagementOfCompaniesAndEnterprise --> "0..1" Any : sudokn_hasNAICSTextValue
    click Any href "../Any"
...
```yaml
name: sudokn_ManagementOfCompaniesAndEnterprise
...
class_uri: sudokn:ManagementOfCompaniesAndEnterprise
...
attributes:
  sudokn_hasNAICSCodeValue:
    ...
    owner: sudokn_ManagementOfCompaniesAndEnterprise
    domain_of:
    - sudokn_NAICS332111
    - sudokn_NAICS332112
    - sudokn_NAICS332114
