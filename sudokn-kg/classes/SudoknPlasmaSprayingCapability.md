...
# Class: plasma spraying capability (sudokn_PlasmaSprayingCapability)
...
URI: [sudokn:PlasmaSprayingCapability](http://asu.edu/semantics/SUDOKN/PlasmaSprayingCapability)
...
```mermaid
 classDiagram
    class SudoknPlasmaSprayingCapability
    click SudoknPlasmaSprayingCapability href "../SudoknPlasmaSprayingCapability"
      ...
      SudoknPlasmaSprayingCapability : rdfs_label
        
          
    
    
    SudoknPlasmaSprayingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknPlasmaSprayingCapability](../classes/SudoknPlasmaSprayingCapability.md) |
...
```yaml
name: sudokn_PlasmaSprayingCapability
title: plasma spraying capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_ThermalSprayCoatingCapability
slots:
- rdfs_label
class_uri: sudokn:PlasmaSprayingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_PlasmaSprayingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
