...
# Class: TODO -- what's a good name for this class (type)? (sudokn_AcetalProcessingCapability)
...
URI: [sudokn:AcetalProcessingCapability](http://asu.edu/semantics/SUDOKN/AcetalProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknAcetalProcessingCapability
    click SudoknAcetalProcessingCapability href "../SudoknAcetalProcessingCapability"
      SudoknAcetalProcessingCapability : rdfs_label
        
          
    
    
    SudoknAcetalProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknAcetalProcessingCapability](../classes/SudoknAcetalProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknAcetalProcessingCapability](../classes/SudoknAcetalProcessingCapability.md) |
...
| ---  | ---  |
| self | sudokn:AcetalProcessingCapability |
| native | sudokn-kg/:SudoknAcetalProcessingCapability |
...
<details>
```yaml
name: sudokn_AcetalProcessingCapability
...
- if you think the class is perfect.
notes:
- Class with 362 occurences.
examples:
- value: sudokn:3ERP-Acetal-inst
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:AcetalProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_AcetalProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
