...
# Class: TODO -- what's a good name for this class (type)? (sudokn_TinProcessingCapability)
...
URI: [sudokn:TinProcessingCapability](http://asu.edu/semantics/SUDOKN/TinProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknTinProcessingCapability
    click SudoknTinProcessingCapability href "../SudoknTinProcessingCapability"
      SudoknTinProcessingCapability : rdfs_label
        
          
    
    
    SudoknTinProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknTinProcessingCapability](../classes/SudoknTinProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknTinProcessingCapability](../classes/SudoknTinProcessingCapability.md) |
...
| Value |
| --- |
| sudokn:A-AMERICANCOMPANIES-Tin-inst |
...
| ---  | ---  |
| self | sudokn:TinProcessingCapability |
| native | sudokn-kg/:SudoknTinProcessingCapability |
...
<details>
```yaml
name: sudokn_TinProcessingCapability
...
- if you think the class is perfect.
notes:
- Class with 417 occurences.
examples:
- value: sudokn:A-AMERICANCOMPANIES-Tin-inst
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:TinProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_TinProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
