...
# Class: TODO -- what's a good name for this class (type)? (sudokn_PlasmaArcWeldingCapability)
...
| ---  | ---  |
| self | sudokn:PlasmaArcWeldingCapability |
| native | sudokn-kg/:SudoknPlasmaArcWeldingCapability |
