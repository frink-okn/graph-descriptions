...
# Class: exotic material processing capability (sudokn_ExoticMaterialProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknExoticMaterialProcessingCapability
    click SudoknExoticMaterialProcessingCapability href "../SudoknExoticMaterialProcessingCapability"
      ...
      SudoknExoticMaterialProcessingCapability : rdfs_label
        
          
    
    
    SudoknExoticMaterialProcessingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject <br/>  | direct | 317 |
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknExoticMaterialProcessingCapability](../classes/SudoknExoticMaterialProcessingCapability.md) |
...
title: exotic material processing capability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ExoticMaterialProcessingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
