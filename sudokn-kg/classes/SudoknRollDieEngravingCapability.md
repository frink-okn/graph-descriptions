...
# Class: roll die engraving capability (sudokn_RollDieEngravingCapability)





URI: [sudokn:RollDieEngravingCapability](http://asu.edu/semantics/SUDOKN/RollDieEngravingCapability)
...
```mermaid
 classDiagram
    class SudoknRollDieEngravingCapability
    click SudoknRollDieEngravingCapability href "../SudoknRollDieEngravingCapability"
      ...
      SudoknRollDieEngravingCapability : rdfs_label
        
          
    
    
    SudoknRollDieEngravingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: sudokn_RollDieEngravingCapability
title: roll die engraving capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_FormingCapability
class_uri: sudokn:RollDieEngravingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_RollDieEngravingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
