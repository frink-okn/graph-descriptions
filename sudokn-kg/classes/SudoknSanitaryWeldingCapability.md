...
# Class: TODO -- what's a good name for this class (type)? (sudokn_SanitaryWeldingCapability)
...
URI: [sudokn:SanitaryWeldingCapability](http://asu.edu/semantics/SUDOKN/SanitaryWeldingCapability)
...
```mermaid
 classDiagram
    class SudoknSanitaryWeldingCapability
    click SudoknSanitaryWeldingCapability href "../SudoknSanitaryWeldingCapability"
      SudoknSanitaryWeldingCapability : rdfs_label
        
          
    
    
    SudoknSanitaryWeldingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknSanitaryWeldingCapability](../classes/SudoknSanitaryWeldingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknSanitaryWeldingCapability](../classes/SudoknSanitaryWeldingCapability.md) |
...
| Value |
| --- |
| sudokn:SinnovaTek-SanitaryWelding |
...
| ---  | ---  |
| self | sudokn:SanitaryWeldingCapability |
| native | sudokn-kg/:SudoknSanitaryWeldingCapability |
...
<details>
```yaml
name: sudokn_SanitaryWeldingCapability
...
examples:
- value: sudokn:SinnovaTek-SanitaryWelding
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:SanitaryWeldingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_SanitaryWeldingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
