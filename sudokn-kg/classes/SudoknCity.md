...
# Class: No class (type) name specified (sudokn_City)
...
This class occurs 2994 times.


URI: [sudokn:City](http://asu.edu/semantics/SUDOKN/City)
...
```mermaid
 classDiagram
    ...
    click SudoknCity href "../SudoknCity"
      ...
      SudoknCity : rdfs_label
        
          
    
    
    SudoknCity --> "0..1" String : rdfs_label
    click String href "../String"

        
      SudoknCity : sudokn_locatedInState
        
          
    
    
    SudoknCity --> "0..1" SudoknState : sudokn_locatedInState
...
| ---  | --- | --- | --- | --- |
| [sudokn_locatedInState](../slots/sudokn_locatedInState.md) | 0..1 <br/> [SudoknState](../classes/SudoknState.md) | No slot (predicate) description specified <br/>  | direct | 3734 |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string) | No slot (predicate) description specified <br/>  | direct | 2994 |
...
| ---  | --- | --- | --- |
| [SudoknGeospatialLocation](../classes/SudoknGeospatialLocation.md) | [sudokn_locatedInCity](../slots/sudokn_locatedInCity.md) | range | [SudoknCity](../classes/SudoknCity.md) |
