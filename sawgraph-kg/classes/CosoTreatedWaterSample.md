...
# Class: Treated Water Sample (coso_TreatedWaterSample)





URI: [coso:TreatedWaterSample](http://w3id.org/coso/v1/contaminoso#TreatedWaterSample)
...
```mermaid
 classDiagram
    ...
    click CosoTreatedWaterSample href "../CosoTreatedWaterSample"
      ...
      CosoTreatedWaterSample : owl_sameAs
        
          
    
    
    CosoTreatedWaterSample --> "0..1" OwlThing : owl_sameAs
    click OwlThing href "../OwlThing"

        
      CosoTreatedWaterSample : rdfs_label
        
          
    
    
    CosoTreatedWaterSample --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: coso_TreatedWaterSample
title: Treated Water Sample
from_schema: okns:sawgraph-kg
rank: 1000
is_a: coso_WaterSampleByTreatment
class_uri: coso:TreatedWaterSample
