...
URI: [hyf:/HY_Canal](https://www.opengis.net/def/schema/hy_features/hyf/HY_Canal)
...
```mermaid
 classDiagram
    ...
    click HyfHYCanal href "../HyfHYCanal"
      ...
      HyfHYCanal : dct_title
        
          
    
    
    HyfHYCanal --> "0..1" Any : dct_title
    click Any href "../Any"

        
      HyfHYCanal : geo_defaultGeometry
        
          
    
    
    HyfHYCanal --> "0..1" GeoGeometry : geo_defaultGeometry
    click GeoGeometry href "../GeoGeometry"

        
      HyfHYCanal : geo_hasGeometry
        
          
    
    
    HyfHYCanal --> "0..1" GeoGeometry : geo_hasGeometry
    click GeoGeometry href "../GeoGeometry"

        
      HyfHYCanal : http___nhdplusv2.spatialai.org_v1_nhdplusv2#hasCOMID
        
          
    
    
    HyfHYCanal --> "0..1" String : http___nhdplusv2.spatialai.org_v1_nhdplusv2#hasCOMID
    click String href "../String"

        
      HyfHYCanal : http___nhdplusv2.spatialai.org_v1_nhdplusv2#hasFCODE
        
          
    
    
    HyfHYCanal --> "0..1" String : http___nhdplusv2.spatialai.org_v1_nhdplusv2#hasFCODE
    click String href "../String"

        
      HyfHYCanal : http___nhdplusv2.spatialai.org_v1_nhdplusv2#hasFTYPE
        
          
    
    
    HyfHYCanal --> "0..1" String : http___nhdplusv2.spatialai.org_v1_nhdplusv2#hasFTYPE
    click String href "../String"

        
      HyfHYCanal : http___nhdplusv2.spatialai.org_v1_nhdplusv2#hasReachCode
        
          
    
    
    HyfHYCanal --> "0..1" String : http___nhdplusv2.spatialai.org_v1_nhdplusv2#hasReachCode
    click String href "../String"

        
      HyfHYCanal : kwgo_sfContains
        
          
    
    
    HyfHYCanal --> "0..1" Any : kwgo_sfContains
    click Any href "../Any"

        
      HyfHYCanal : kwgo_sfCrosses
        
          
    
    
    HyfHYCanal --> "0..1" Any : kwgo_sfCrosses
    click Any href "../Any"

        
      HyfHYCanal : kwgo_sfOverlaps
        
          
    
    
    HyfHYCanal --> "0..1" Any : kwgo_sfOverlaps
    click Any href "../Any"

        
      HyfHYCanal : kwgo_sfTouches
        
          
    
    
    HyfHYCanal --> "0..1" Any : kwgo_sfTouches
    click Any href "../Any"

        
      HyfHYCanal : kwgo_spatialRelation
        
          
    
    
    HyfHYCanal --> "0..1" Any : kwgo_spatialRelation
    click Any href "../Any"

        
      HyfHYCanal : owl_sameAs
        
          
    
    
    HyfHYCanal --> "0..1" OwlThing : owl_sameAs
    click OwlThing href "../OwlThing"

        
      HyfHYCanal : rdfs_label
        
          
    
    
    HyfHYCanal --> "0..1" Any : rdfs_label
    click Any href "../Any"

        
      HyfHYCanal : sdos_name
        
          
    
    
    HyfHYCanal --> "0..1" SdosText : sdos_name
    click SdosText href "../SdosText"

        
      HyfHYCanal : spatial_connectedTo
        
          
    
    
    HyfHYCanal --> "0..1" Any : spatial_connectedTo
    click Any href "../Any"

        
      HyfHYCanal : spatial_spatiallyRelatedTo
        
          
    
    
    HyfHYCanal --> "0..1" Any : spatial_spatiallyRelatedTo
    click Any href "../Any"
