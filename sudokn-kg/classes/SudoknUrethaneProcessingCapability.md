...
# Class: urethane processing capability (sudokn_UrethaneProcessingCapability)
...
URI: [sudokn:UrethaneProcessingCapability](http://asu.edu/semantics/SUDOKN/UrethaneProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknUrethaneProcessingCapability
    click SudoknUrethaneProcessingCapability href "../SudoknUrethaneProcessingCapability"
      ...
      SudoknUrethaneProcessingCapability : rdfs_label
        
          
    
    
    SudoknUrethaneProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknUrethaneProcessingCapability](../classes/SudoknUrethaneProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknUrethaneProcessingCapability](../classes/SudoknUrethaneProcessingCapability.md) |
...
| Value |
| --- |
| sudokn:3-DTECHNICALSERVICES-Urethane-inst |
...
| ---  | ---  |
| self | sudokn:UrethaneProcessingCapability |
| native | sudokn-kg/:SudoknUrethaneProcessingCapability |
...
<details>
```yaml
name: sudokn_UrethaneProcessingCapability
description: TODO -- tell the world what this class (type) describes.
title: urethane processing capability
todos:
- TODO -- Todos for this class go here
- or you can delete the todos
- if you think the class is perfect.
notes:
- Class with 1039 occurences.
examples:
- value: sudokn:3-DTECHNICALSERVICES-Urethane-inst
from_schema: sudokn-kg
is_a: sudokn_MaterialProcessingCapability
slots:
- rdfs_label
class_uri: sudokn:UrethaneProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_UrethaneProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
