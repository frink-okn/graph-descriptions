...
# Class: chemical machining capability (sudokn_ChemicalMachiningCapability)





URI: [sudokn:ChemicalMachiningCapability](http://asu.edu/semantics/SUDOKN/ChemicalMachiningCapability)
...
```mermaid
 classDiagram
    class SudoknChemicalMachiningCapability
    click SudoknChemicalMachiningCapability href "../SudoknChemicalMachiningCapability"
      ...
      SudoknChemicalMachiningCapability <|-- SudoknChemicalEngravingCapability
        click SudoknChemicalEngravingCapability href "../SudoknChemicalEngravingCapability"
      SudoknChemicalMachiningCapability <|-- SudoknEtchingCapability
        click SudoknEtchingCapability href "../SudoknEtchingCapability"
      SudoknChemicalMachiningCapability <|-- SudoknPhotochemicalMachiningProcess
        click SudoknPhotochemicalMachiningProcess href "../SudoknPhotochemicalMachiningProcess"
      
      
      SudoknChemicalMachiningCapability : rdfs_label
        
          
    
    
    SudoknChemicalMachiningCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
    ...
    * [SudoknManufacturingProcessCapability](../classes/SudoknManufacturingProcessCapability.md)
        * [SudoknMachiningCapability](../classes/SudoknMachiningCapability.md)
            * **SudoknChemicalMachiningCapability**
                * [SudoknChemicalEngravingCapability](../classes/SudoknChemicalEngravingCapability.md)
                * [SudoknEtchingCapability](../classes/SudoknEtchingCapability.md)
                * [SudoknPhotochemicalMachiningProcess](../classes/SudoknPhotochemicalMachiningProcess.md)
...
```yaml
name: sudokn_ChemicalMachiningCapability
title: chemical machining capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_MachiningCapability
class_uri: sudokn:ChemicalMachiningCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ChemicalMachiningCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
