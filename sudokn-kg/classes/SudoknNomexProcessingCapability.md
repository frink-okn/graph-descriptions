...
# Class: TODO -- what's a good name for this class (type)? (sudokn_NomexProcessingCapability)
...
URI: [sudokn:NomexProcessingCapability](http://asu.edu/semantics/SUDOKN/NomexProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknNomexProcessingCapability
    click SudoknNomexProcessingCapability href "../SudoknNomexProcessingCapability"
      SudoknNomexProcessingCapability : rdfs_label
        
          
    
    
    SudoknNomexProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknNomexProcessingCapability](../classes/SudoknNomexProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknNomexProcessingCapability](../classes/SudoknNomexProcessingCapability.md) |
...
| Value |
| --- |
| sudokn:ACMANUFACTURING-Nomex-inst |
...
| ---  | ---  |
| self | sudokn:NomexProcessingCapability |
| native | sudokn-kg/:SudoknNomexProcessingCapability |
...
<details>
```yaml
name: sudokn_NomexProcessingCapability
...
- if you think the class is perfect.
notes:
- Class with 58 occurences.
examples:
- value: sudokn:ACMANUFACTURING-Nomex-inst
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:NomexProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_NomexProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
