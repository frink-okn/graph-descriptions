...
# Class: TODO -- what's a good name for this class (type)? (sudokn_ProfessionalServicesIndustry)
...
URI: [sudokn:ProfessionalServicesIndustry](http://asu.edu/semantics/SUDOKN/ProfessionalServicesIndustry)
...
```mermaid
 classDiagram
    class SudoknProfessionalServicesIndustry
    click SudoknProfessionalServicesIndustry href "../SudoknProfessionalServicesIndustry"
      SudoknProfessionalServicesIndustry : rdfs_label
        
          
    
    
    SudoknProfessionalServicesIndustry --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknProfessionalServicesIndustry](../classes/SudoknProfessionalServicesIndustry.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknProfessionalServicesIndustry](../classes/SudoknProfessionalServicesIndustry.md) |
...
| Value |
| --- |
| sudokn:ProfessionalServices-Industry |
...
| ---  | ---  |
| self | sudokn:ProfessionalServicesIndustry |
| native | sudokn-kg/:SudoknProfessionalServicesIndustry |
...
<details>
```yaml
name: sudokn_ProfessionalServicesIndustry
...
examples:
- value: sudokn:ProfessionalServices-Industry
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:ProfessionalServicesIndustry
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ProfessionalServicesIndustry
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
