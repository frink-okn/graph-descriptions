...
# Class: TODO -- what's a good name for this class (type)? (sudokn_AWSWelderCertificate)
...
URI: [sudokn:AWSWelderCertificate](http://asu.edu/semantics/SUDOKN/AWSWelderCertificate)
...
```mermaid
 classDiagram
    class SudoknAWSWelderCertificate
    click SudoknAWSWelderCertificate href "../SudoknAWSWelderCertificate"
      SudoknAWSWelderCertificate : rdfs_label
        
          
    
    
    SudoknAWSWelderCertificate --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasCertificate](../slots/sudokn_hasCertificate.md) | any_of[range] | [SudoknAWSWelderCertificate](../classes/SudoknAWSWelderCertificate.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasCertificate](../slots/sudokn_hasCertificate.md) | any_of[range] | [SudoknAWSWelderCertificate](../classes/SudoknAWSWelderCertificate.md) |
...
| Value |
| --- |
| sudokn:ADVANTAINDUSTRIES-AWSWelderCertificate |
...
| ---  | ---  |
| self | sudokn:AWSWelderCertificate |
| native | sudokn-kg/:SudoknAWSWelderCertificate |
...
<details>
```yaml
name: sudokn_AWSWelderCertificate
...
- if you think the class is perfect.
notes:
- Class with 48 occurences.
examples:
- value: sudokn:ADVANTAINDUSTRIES-AWSWelderCertificate
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:AWSWelderCertificate
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_AWSWelderCertificate
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
