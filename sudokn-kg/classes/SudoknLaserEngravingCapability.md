...
# Class: laser engraving capability (sudokn_LaserEngravingCapability)





URI: [sudokn:LaserEngravingCapability](http://asu.edu/semantics/SUDOKN/LaserEngravingCapability)
...
```mermaid
 classDiagram
    class SudoknLaserEngravingCapability
    click SudoknLaserEngravingCapability href "../SudoknLaserEngravingCapability"
      SudoknEngravingCapability <|-- SudoknLaserEngravingCapability
        click SudoknEngravingCapability href "../SudoknEngravingCapability"
      
      SudoknLaserEngravingCapability : rdfs_label
        
          
    
    
    SudoknLaserEngravingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: sudokn_LaserEngravingCapability
title: laser engraving capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_EngravingCapability
class_uri: sudokn:LaserEngravingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_LaserEngravingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
