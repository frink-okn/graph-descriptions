...
# Class: education industry (sudokn_EducationIndustry)
...
URI: [sudokn:EducationIndustry](http://asu.edu/semantics/SUDOKN/EducationIndustry)
...
```mermaid
 classDiagram
    ...
    click SudoknEducationIndustry href "../SudoknEducationIndustry"
      ...
      SudoknEducationIndustry : rdfs_label
        
          
    
    
    SudoknEducationIndustry --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknEducationIndustry](../classes/SudoknEducationIndustry.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknEducationIndustry](../classes/SudoknEducationIndustry.md) |
...
| ---  | ---  |
| self | sudokn:EducationIndustry |
| native | sudokn-kg/:SudoknEducationIndustry |
...
slots:
- rdfs_label
class_uri: sudokn:EducationIndustry
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_EducationIndustry
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
