...
| ---  | --- | --- | --- | --- |
| [qudt_omUnit](../slots/qudt_omUnit.md) | 0..1 <br/> [xsd:anyURI](http://www.w3.org/2001/XMLSchema#anyURI) |  <br/>  | direct | 1 |
| [rdfs_seeAlso](../slots/rdfs_seeAlso.md) | 0..1 <br/> [RdfsResource](../classes/RdfsResource.md)&nbsp;or&nbsp;<br />[xsd:anyURI](http://www.w3.org/2001/XMLSchema#anyURI) | Further information about the subject resource <br/>  | direct | 8 |
...
| [qudt_scalingOf](../slots/qudt_scalingOf.md) | 0..1 <br/> [QudtDerivedUnit](../classes/QudtDerivedUnit.md)&nbsp;or&nbsp;<br />[QudtUnit](../classes/QudtUnit.md)&nbsp;or&nbsp;<br />[QudtCountingUnit](../classes/QudtCountingUnit.md)&nbsp;or&nbsp;<br />[QudtCurrencyUnit](../classes/QudtCurrencyUnit.md) | This property relates a unit that is scaled to the base unit that its qudt:co... <br/> description: This property relates a unit to another unit it is scaled from | direct | 1 |
...
| [qudt_dbpediaMatch](../slots/qudt_dbpediaMatch.md) | 0..1 <br/> [xsd:anyURI](http://www.w3.org/2001/XMLSchema#anyURI) |  <br/>  | direct | 1 |
...
| [qudt_hasQuantityKind](../slots/qudt_hasQuantityKind.md) | 0..1 <br/> [xsd:anyURI](http://www.w3.org/2001/XMLSchema#anyURI)&nbsp;or&nbsp;<br />[QudtQuantityKind](../classes/QudtQuantityKind.md) |  <br/>  | direct | 42 |
| [qudt_iec61360Code](../slots/qudt_iec61360Code.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string) |  <br/>  | direct | 4 |
| [qudt_plainTextDescription](../slots/qudt_plainTextDescription.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string) | A plain text description is used to provide a description with only simple AS... <br/>  | direct | 3 |
...
| [rdfs_isDefinedBy](../slots/rdfs_isDefinedBy.md) | 0..1 <br/> [OwlOntology](../classes/OwlOntology.md)&nbsp;or&nbsp;<br />[RdfsResource](../classes/RdfsResource.md) | The definition of the subject resource <br/>  | direct | 9 |
| [qudt_udunitsCode](../slots/qudt_udunitsCode.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string) | The UDUNITS package supports units of physical quantities <br/>  | direct | 1 |
...
| [qudt_applicableSystem](../slots/qudt_applicableSystem.md) | 0..1 <br/> [xsd:anyURI](http://www.w3.org/2001/XMLSchema#anyURI) | This property relates a unit of measure with a unit system that may or may no... <br/>  | direct | 28 |
| [qudt_ucumCode](../slots/qudt_ucumCode.md) | 0..1 <br/> [QudtUCUMcs](../types/QudtUCUMcs.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | <p><em>ucumCode</em> associates a QUDT unit with its UCUM code (case-sensitiv... <br/>  | direct | 12 |
| [qudt_conversionMultiplier](../slots/qudt_conversionMultiplier.md) | 0..1 <br/> [xsd:decimal](http://www.w3.org/2001/XMLSchema#decimal) |  <br/>  | direct | 6 |
...
| [qudt_qkdvNumerator](../slots/qudt_qkdvNumerator.md) | 0..1 <br/> [xsd:anyURI](http://www.w3.org/2001/XMLSchema#anyURI)&nbsp;or&nbsp;<br />[QudtQuantityKindDimensionVector](../classes/QudtQuantityKindDimensionVector.md) |  <br/>  | direct | 1 |
...
| [qudt_informativeReference](../slots/qudt_informativeReference.md) | 0..1 <br/> [xsd:anyURI](http://www.w3.org/2001/XMLSchema#anyURI) | Provides a way to reference a source that provided useful but non-normative i... <br/>  | direct | 2 |
| [qudt_uneceCommonCode](../slots/qudt_uneceCommonCode.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string) | The UN/CEFACT Recommendation 20 provides three character alphabetic and alpha... <br/>  | direct | 4 |
...
| [qudt_hasDimensionVector](../slots/qudt_hasDimensionVector.md) | 0..1 <br/> [xsd:anyURI](http://www.w3.org/2001/XMLSchema#anyURI)&nbsp;or&nbsp;<br />[QudtQuantityKindDimensionVector](../classes/QudtQuantityKindDimensionVector.md) |  <br/>  | direct | 6 |
| [qudt_conversionMultiplierSN](../slots/qudt_conversionMultiplierSN.md) | 0..1 <br/> [xsd:decimal](http://www.w3.org/2001/XMLSchema#decimal)&nbsp;or&nbsp;<br />[xsd:double](http://www.w3.org/2001/XMLSchema#double) |  <br/>  | direct | 6 |
...
| [qudt_qkdvDenominator](../slots/qudt_qkdvDenominator.md) | 0..1 <br/> [xsd:anyURI](http://www.w3.org/2001/XMLSchema#anyURI)&nbsp;or&nbsp;<br />[QudtQuantityKindDimensionVector](../classes/QudtQuantityKindDimensionVector.md) |  <br/>  | direct | 1 |
...
| [qudt_symbol](../slots/qudt_symbol.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string) | The symbol is a glyph that is used to represent some concept, typically a uni... <br/>  | direct | 7 |
...
| [CosoDetectQuantityValue](../classes/CosoDetectQuantityValue.md) | [qudt_hasUnit](../slots/qudt_hasUnit.md) | any_of[range] | [QudtUnit](../classes/QudtUnit.md) |
| [CosoNonDetectQuantityValue](../classes/CosoNonDetectQuantityValue.md) | [qudt_hasUnit](../slots/qudt_hasUnit.md) | any_of[range] | [QudtUnit](../classes/QudtUnit.md) |
| [HttpW3id.orgSawgraphV1Me-egad#EGAD-AggregatePFAS-Concentration](../classes/HttpW3id.orgSawgraphV1Me-egad#EGAD-AggregatePFAS-Concentration.md) | [coso_measurementUnit](../slots/coso_measurementUnit.md) | any_of[range] | [QudtUnit](../classes/QudtUnit.md) |
| [HttpW3id.orgSawgraphV1Me-egad#EGAD-MethodDetectionLimit](../classes/HttpW3id.orgSawgraphV1Me-egad#EGAD-MethodDetectionLimit.md) | [qudt_hasUnit](../slots/qudt_hasUnit.md) | any_of[range] | [QudtUnit](../classes/QudtUnit.md) |
| [HttpW3id.orgSawgraphV1Me-egad#EGAD-ReportingLimit](../classes/HttpW3id.orgSawgraphV1Me-egad#EGAD-ReportingLimit.md) | [qudt_hasUnit](../slots/qudt_hasUnit.md) | any_of[range] | [QudtUnit](../classes/QudtUnit.md) |
| [HttpW3id.orgSawgraphV1Me-egad#EGAD-SinglePFAS-Concentration](../classes/HttpW3id.orgSawgraphV1Me-egad#EGAD-SinglePFAS-Concentration.md) | [coso_measurementUnit](../slots/coso_measurementUnit.md) | any_of[range] | [QudtUnit](../classes/QudtUnit.md) |
| [HttpW3id.orgSawgraphV1Us-wqp#InstrumentDetectionLevel](../classes/HttpW3id.orgSawgraphV1Us-wqp#InstrumentDetectionLevel.md) | [qudt_hasUnit](../slots/qudt_hasUnit.md) | any_of[range] | [QudtUnit](../classes/QudtUnit.md) |
| [HttpW3id.orgSawgraphV1Us-wqp#LaboratoryReportingLevel](../classes/HttpW3id.orgSawgraphV1Us-wqp#LaboratoryReportingLevel.md) | [qudt_hasUnit](../slots/qudt_hasUnit.md) | any_of[range] | [QudtUnit](../classes/QudtUnit.md) |
| [HttpW3id.orgSawgraphV1Us-wqp#LowerQuantitationLimit](../classes/HttpW3id.orgSawgraphV1Us-wqp#LowerQuantitationLimit.md) | [qudt_hasUnit](../slots/qudt_hasUnit.md) | any_of[range] | [QudtUnit](../classes/QudtUnit.md) |
| [HttpW3id.orgSawgraphV1Us-wqp#LowerReportingLimit](../classes/HttpW3id.orgSawgraphV1Us-wqp#LowerReportingLimit.md) | [qudt_hasUnit](../slots/qudt_hasUnit.md) | any_of[range] | [QudtUnit](../classes/QudtUnit.md) |
| [HttpW3id.orgSawgraphV1Us-wqp#MethodDetectionLevel](../classes/HttpW3id.orgSawgraphV1Us-wqp#MethodDetectionLevel.md) | [qudt_hasUnit](../slots/qudt_hasUnit.md) | any_of[range] | [QudtUnit](../classes/QudtUnit.md) |
| [HttpW3id.orgSawgraphV1Us-wqp#Sample-SpecificQuantitationLimit](../classes/HttpW3id.orgSawgraphV1Us-wqp#Sample-SpecificQuantitationLimit.md) | [qudt_hasUnit](../slots/qudt_hasUnit.md) | any_of[range] | [QudtUnit](../classes/QudtUnit.md) |
| [MeEgadEGAD-AggregatePFAS-Concentration](../classes/MeEgadEGAD-AggregatePFAS-Concentration.md) | [coso_measurementUnit](../slots/coso_measurementUnit.md) | any_of[range] | [QudtUnit](../classes/QudtUnit.md) |
| [MeEgadEGAD-MethodDetectionLimit](../classes/MeEgadEGAD-MethodDetectionLimit.md) | [qudt_hasUnit](../slots/qudt_hasUnit.md) | any_of[range] | [QudtUnit](../classes/QudtUnit.md) |
| [MeEgadEGAD-ReportingLimit](../classes/MeEgadEGAD-ReportingLimit.md) | [qudt_hasUnit](../slots/qudt_hasUnit.md) | any_of[range] | [QudtUnit](../classes/QudtUnit.md) |
| [MeEgadEGAD-SinglePFAS-Concentration](../classes/MeEgadEGAD-SinglePFAS-Concentration.md) | [coso_measurementUnit](../slots/coso_measurementUnit.md) | any_of[range] | [QudtUnit](../classes/QudtUnit.md) |
