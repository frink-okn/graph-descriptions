...
# Class: abrasive machining capability (sudokn_AbrassiveMachiningCapability)





URI: [sudokn:AbrassiveMachiningCapability](http://asu.edu/semantics/SUDOKN/AbrassiveMachiningCapability)
...
```mermaid
 classDiagram
    class SudoknAbrassiveMachiningCapability
    click SudoknAbrassiveMachiningCapability href "../SudoknAbrassiveMachiningCapability"
      ...
      SudoknAbrassiveMachiningCapability <|-- SudoknBuffingCapability
        click SudoknBuffingCapability href "../SudoknBuffingCapability"
      SudoknAbrassiveMachiningCapability <|-- SudoknGrindingCapability
        click SudoknGrindingCapability href "../SudoknGrindingCapability"
      SudoknAbrassiveMachiningCapability <|-- SudoknHoningCapability
        click SudoknHoningCapability href "../SudoknHoningCapability"
      SudoknAbrassiveMachiningCapability <|-- SudoknLappingCapability
        click SudoknLappingCapability href "../SudoknLappingCapability"
      
      
      SudoknAbrassiveMachiningCapability : rdfs_label
        
          
    
    
    SudoknAbrassiveMachiningCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
    ...
    * [SudoknManufacturingProcessCapability](../classes/SudoknManufacturingProcessCapability.md)
        * [SudoknMachiningCapability](../classes/SudoknMachiningCapability.md)
            * **SudoknAbrassiveMachiningCapability**
                * [SudoknBuffingCapability](../classes/SudoknBuffingCapability.md)
                * [SudoknGrindingCapability](../classes/SudoknGrindingCapability.md)
                * [SudoknHoningCapability](../classes/SudoknHoningCapability.md)
                * [SudoknLappingCapability](../classes/SudoknLappingCapability.md)
...
```yaml
name: sudokn_AbrassiveMachiningCapability
title: abrasive machining capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_MachiningCapability
class_uri: sudokn:AbrassiveMachiningCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_AbrassiveMachiningCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
