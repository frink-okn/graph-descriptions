...
# Class: SudoknNativeAmericanOwned





URI: [sudokn:NativeAmericanOwned](http://asu.edu/semantics/SUDOKN/NativeAmericanOwned)
...
```mermaid
 classDiagram
    ...
    click SudoknNativeAmericanOwned href "../SudoknNativeAmericanOwned"
      ...
      SudoknNativeAmericanOwned : rdfs_label
        
          
    
    
    SudoknNativeAmericanOwned --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: sudokn_NativeAmericanOwned
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_OwnershipStatusClassifier
class_uri: sudokn:NativeAmericanOwned
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_NativeAmericanOwned
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
