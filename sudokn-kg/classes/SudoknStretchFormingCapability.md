...
# Class: No class (type) name specified (sudokn_StretchFormingCapability)
...
URI: [sudokn:StretchFormingCapability](http://asu.edu/semantics/SUDOKN/StretchFormingCapability)
...
```mermaid
 classDiagram
    class SudoknStretchFormingCapability
    click SudoknStretchFormingCapability href "../SudoknStretchFormingCapability"
      ...
      SudoknStretchFormingCapability : rdfs_label
        
          
    
    
    SudoknStretchFormingCapability --> "0..1" String : rdfs_label
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_StretchFormingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
    - owl_NamedIndividual
