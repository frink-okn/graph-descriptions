...
# Class: TODO -- what's a good name for this class (type)? (sudokn_InfraredBrazingCapability)
...
URI: [sudokn:InfraredBrazingCapability](http://asu.edu/semantics/SUDOKN/InfraredBrazingCapability)
...
```mermaid
 classDiagram
    class SudoknInfraredBrazingCapability
    click SudoknInfraredBrazingCapability href "../SudoknInfraredBrazingCapability"
      ...
      SudoknInfraredBrazingCapability : rdfs_label
        
          
    
    
    SudoknInfraredBrazingCapability --> "0..1" String : rdfs_label
...
| ---  | ---  |
| self | sudokn:InfraredBrazingCapability |
| native | sudokn-kg/:SudoknInfraredBrazingCapability |
...
<details>
```yaml
name: sudokn_InfraredBrazingCapability
...
class_uri: sudokn:InfraredBrazingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_InfraredBrazingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
