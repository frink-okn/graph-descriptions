...
# Class: No class (type) name specified (sudokn_CarbonArcBrazingCapability)
...
URI: [sudokn:CarbonArcBrazingCapability](http://asu.edu/semantics/SUDOKN/CarbonArcBrazingCapability)
...
```mermaid
 classDiagram
    class SudoknCarbonArcBrazingCapability
    click SudoknCarbonArcBrazingCapability href "../SudoknCarbonArcBrazingCapability"
      ...
      SudoknCarbonArcBrazingCapability : rdfs_label
        
          
    
    
    SudoknCarbonArcBrazingCapability --> "0..1" String : rdfs_label
...
```yaml
name: sudokn_CarbonArcBrazingCapability
...
rank: 1000
is_a: sudokn_BrazeWeldingCapability
class_uri: sudokn:CarbonArcBrazingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_CarbonArcBrazingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
    - owl_NamedIndividual
