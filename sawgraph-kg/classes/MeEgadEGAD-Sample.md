...
```mermaid
 classDiagram
    ...
    click Any href "../Any"
      ...
      MeEgadEGAD-Sample : coso_sampleAnnotation
        
          
    
    
    MeEgadEGAD-Sample --> "0..1" Any : coso_sampleAnnotation
    click Any href "../Any"
    ...
    MeEgadEGAD-Sample --> "0..1" RdfsLiteral : dct_identifier
    ...
    click Any href "../Any"
      ...
      MeEgadEGAD-Sample : owl_sameAs
        
          
    
    
    MeEgadEGAD-Sample --> "0..1" OwlThing : owl_sameAs
    ...
    MeEgadEGAD-Sample --> "0..1" ProvAgent : prov_wasAttributedTo
    ...
    MeEgadEGAD-Sample --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| [me_egad_sampleTreatmentStatus](../slots/me_egad_sampleTreatmentStatus.md) | 0..1 <br/> [OwlThing](../classes/OwlThing.md)&nbsp;or&nbsp;<br />[OwlNamedIndividual](../classes/OwlNamedIndividual.md)&nbsp;or&nbsp;<br />[MeEgadEGAD-SampleTreatmentStatus](../classes/MeEgadEGAD-SampleTreatmentStatus.md)&nbsp;or&nbsp;<br />[CosoSampleAnnotation](../classes/CosoSampleAnnotation.md) |  <br/>  | direct | 31220 |
| [me_egad_sampleCollectionMethod](../slots/me_egad_sampleCollectionMethod.md) | 0..1 <br/> [MeEgadEGAD-SampleCollectionMethod](../classes/MeEgadEGAD-SampleCollectionMethod.md)&nbsp;or&nbsp;<br />[OwlThing](../classes/OwlThing.md)&nbsp;or&nbsp;<br />[OwlNamedIndividual](../classes/OwlNamedIndividual.md)&nbsp;or&nbsp;<br />[CosoSampleAnnotation](../classes/CosoSampleAnnotation.md) |  <br/>  | direct | 45380 |
| [owl_sameAs](../slots/owl_sameAs.md) | 0..1 <br/> [OwlThing](../classes/OwlThing.md) | The property that determines that two given individuals are equal <br/>  | direct | 46048 |
...
| ---  | --- | --- | --- |
| [HttpW3id.orgSawgraphV1Me-egad#EGAD-PFAS-Observation](../classes/HttpW3id.orgSawgraphV1Me-egad#EGAD-PFAS-Observation.md) | [coso_analyzedSample](../slots/coso_analyzedSample.md) | any_of[range] | [MeEgadEGAD-Sample](../classes/MeEgadEGAD-Sample.md) |
| [HttpW3id.orgSawgraphV1Me-egad#EGAD-PFAS-Observation](../classes/HttpW3id.orgSawgraphV1Me-egad#EGAD-PFAS-Observation.md) | [coso_hasAnyFeatureOfInterest](../slots/coso_hasAnyFeatureOfInterest.md) | any_of[range] | [MeEgadEGAD-Sample](../classes/MeEgadEGAD-Sample.md) |
| [HttpW3id.orgSawgraphV1Us-wqp#Observation](../classes/HttpW3id.orgSawgraphV1Us-wqp#Observation.md) | [coso_analyzedSample](../slots/coso_analyzedSample.md) | any_of[range] | [MeEgadEGAD-Sample](../classes/MeEgadEGAD-Sample.md) |
...
| [MeEgadEGAD-PFAS-Observation](../classes/MeEgadEGAD-PFAS-Observation.md) | [coso_hasAnyFeatureOfInterest](../slots/coso_hasAnyFeatureOfInterest.md) | any_of[range] | [MeEgadEGAD-Sample](../classes/MeEgadEGAD-Sample.md) |
