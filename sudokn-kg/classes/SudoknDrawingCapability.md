...
# Class: drawing capability (sudokn_DrawingCapability)
...
URI: [sudokn:DrawingCapability](http://asu.edu/semantics/SUDOKN/DrawingCapability)
...
```mermaid
 classDiagram
    ...
    click SudoknDrawingCapability href "../SudoknDrawingCapability"
      ...
      SudoknDrawingCapability : rdfs_label
        
          
    
    
    SudoknDrawingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknDrawingCapability](../classes/SudoknDrawingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknDrawingCapability](../classes/SudoknDrawingCapability.md) |
...
| Value |
| --- |
| sudokn:1DIETECH-DrawingCapability-inst |
...
| ---  | ---  |
| self | sudokn:DrawingCapability |
| native | sudokn-kg/:SudoknDrawingCapability |
...
<details>
```yaml
name: sudokn_DrawingCapability
description: TODO -- tell the world what this class (type) describes.
title: drawing capability
todos:
- TODO -- Todos for this class go here
- or you can delete the todos
- if you think the class is perfect.
notes:
- Class with 1449 occurences.
examples:
- value: sudokn:1DIETECH-DrawingCapability-inst
from_schema: sudokn-kg
is_a: sudokn_FormingCapability
slots:
- rdfs_label
class_uri: sudokn:DrawingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_DrawingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
