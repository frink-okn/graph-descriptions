...
# Class: TODO -- what's a good name for this class (type)? (sudokn_MetalsProductsIndustry)
...
URI: [sudokn:MetalsProductsIndustry](http://asu.edu/semantics/SUDOKN/MetalsProductsIndustry)
...
```mermaid
 classDiagram
    class SudoknMetalsProductsIndustry
    click SudoknMetalsProductsIndustry href "../SudoknMetalsProductsIndustry"
      SudoknMetalsProductsIndustry : rdfs_label
        
          
    
    
    SudoknMetalsProductsIndustry --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknMetalsProductsIndustry](../classes/SudoknMetalsProductsIndustry.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknMetalsProductsIndustry](../classes/SudoknMetalsProductsIndustry.md) |
...
| Value |
| --- |
| sudokn:MetalsProducts-Industry |
...
| ---  | ---  |
| self | sudokn:MetalsProductsIndustry |
| native | sudokn-kg/:SudoknMetalsProductsIndustry |
...
<details>
```yaml
name: sudokn_MetalsProductsIndustry
...
examples:
- value: sudokn:MetalsProducts-Industry
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:MetalsProductsIndustry
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_MetalsProductsIndustry
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
