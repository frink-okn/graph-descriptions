...
# Class: horizontal boring capability (sudokn_HorizontalBoringCapability)





URI: [sudokn:HorizontalBoringCapability](http://asu.edu/semantics/SUDOKN/HorizontalBoringCapability)
...
```mermaid
 classDiagram
    class SudoknHorizontalBoringCapability
    click SudoknHorizontalBoringCapability href "../SudoknHorizontalBoringCapability"
      SudoknBoringCapability <|-- SudoknHorizontalBoringCapability
        click SudoknBoringCapability href "../SudoknBoringCapability"
      
      SudoknHorizontalBoringCapability : rdfs_label
        
          
    
    
    SudoknHorizontalBoringCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject | [SudoknTurningCapability](../classes/SudoknTurningCapability.md), [SudoknBoringCapability](../classes/SudoknBoringCapability.md), [SudoknMachiningCapability](../classes/SudoknMachiningCapability.md) |  |
...
```yaml
name: sudokn_HorizontalBoringCapability
title: horizontal boring capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_BoringCapability
class_uri: sudokn:HorizontalBoringCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_HorizontalBoringCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
