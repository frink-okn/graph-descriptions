...
# Class: alloy steel processing capability (sudokn_AlloySteelProcessingCapability)




This class occurs 825 times.


URI: [sudokn:AlloySteelProcessingCapability](http://asu.edu/semantics/SUDOKN/AlloySteelProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknAlloySteelProcessingCapability
    click SudoknAlloySteelProcessingCapability href "../SudoknAlloySteelProcessingCapability"
      ...
      SudoknAlloySteelProcessingCapability <|-- SudoknLowAlloySteelLeadProcessingCapability
        click SudoknLowAlloySteelLeadProcessingCapability href "../SudoknLowAlloySteelLeadProcessingCapability"
      
      
      SudoknAlloySteelProcessingCapability : rdfs_label
        
          
    
    
    SudoknAlloySteelProcessingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
        ...
        * [SudoknMetalProcessingCapability](../classes/SudoknMetalProcessingCapability.md)
            * [SudoknSteelProcessingCapability](../classes/SudoknSteelProcessingCapability.md)
                * **SudoknAlloySteelProcessingCapability**
                    * [SudoknLowAlloySteelLeadProcessingCapability](../classes/SudoknLowAlloySteelLeadProcessingCapability.md)
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject <br/>  | direct | 825 |
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknAlloySteelProcessingCapability](../classes/SudoknAlloySteelProcessingCapability.md) |
...
```yaml
name: sudokn_AlloySteelProcessingCapability
title: alloy steel processing capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_SteelProcessingCapability
slots:
- rdfs_label
class_uri: sudokn:AlloySteelProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_AlloySteelProcessingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
