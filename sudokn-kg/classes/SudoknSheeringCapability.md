...
# Class: sheering capability (sudokn_SheeringCapability)





URI: [sudokn:SheeringCapability](http://asu.edu/semantics/SUDOKN/SheeringCapability)
...
```mermaid
 classDiagram
    class SudoknSheeringCapability
    click SudoknSheeringCapability href "../SudoknSheeringCapability"
      ...
      SudoknSheeringCapability : rdfs_label
        
          
    
    
    SudoknSheeringCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: sudokn_SheeringCapability
title: sheering capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_SheetMetalProcessingCapability
class_uri: sudokn:SheeringCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_SheeringCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
