...
# Class: extruding capability (sudokn_ExtrudingCapability)
...
URI: [sudokn:ExtrudingCapability](http://asu.edu/semantics/SUDOKN/ExtrudingCapability)
...
```mermaid
 classDiagram
    class SudoknExtrudingCapability
    click SudoknExtrudingCapability href "../SudoknExtrudingCapability"
      ...
      SudoknExtrudingCapability : rdfs_label
        
          
    
    
    SudoknExtrudingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknExtrudingCapability](../classes/SudoknExtrudingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknExtrudingCapability](../classes/SudoknExtrudingCapability.md) |
...
| Value |
| --- |
| sudokn:3DSYSTEMS-ExtrudingCapability-inst |
...
| ---  | ---  |
| self | sudokn:ExtrudingCapability |
| native | sudokn-kg/:SudoknExtrudingCapability |
...
<details>
```yaml
name: sudokn_ExtrudingCapability
description: No type description provided
title: extruding capability
todos:
- TODO -- Todos for this class go here
- or you can delete the todos
- if you think the class is perfect.
notes:
- Class with 602 occurences.
examples:
- value: sudokn:3DSYSTEMS-ExtrudingCapability-inst
from_schema: sudokn-kg
rank: 1000
is_a: sudokn_FormingCapability
slots:
- rdfs_label
class_uri: sudokn:ExtrudingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ExtrudingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
