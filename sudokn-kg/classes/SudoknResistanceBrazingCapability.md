...
# Class: TODO -- what's a good name for this class (type)? (sudokn_ResistanceBrazingCapability)
...
URI: [sudokn:ResistanceBrazingCapability](http://asu.edu/semantics/SUDOKN/ResistanceBrazingCapability)
...
```mermaid
 classDiagram
    class SudoknResistanceBrazingCapability
    click SudoknResistanceBrazingCapability href "../SudoknResistanceBrazingCapability"
      ...
      SudoknResistanceBrazingCapability : rdfs_label
        
          
    
    
    SudoknResistanceBrazingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string) | TODO -- tell the world what this slot (predicate) describes | [SudoknBrazingCapability](../classes/SudoknBrazingCapability.md), [SudoknJoiningCapability](../classes/SudoknJoiningCapability.md) |
...
| ---  | ---  |
| self | sudokn:ResistanceBrazingCapability |
| native | sudokn-kg/:SudoknResistanceBrazingCapability |
...
<details>
```yaml
name: sudokn_ResistanceBrazingCapability
...
is_a: sudokn_BrazingCapability
class_uri: sudokn:ResistanceBrazingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ResistanceBrazingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
