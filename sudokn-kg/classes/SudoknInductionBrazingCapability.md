...
# Class: TODO -- what's a good name for this class (type)? (sudokn_InductionBrazingCapability)
...
URI: [sudokn:InductionBrazingCapability](http://asu.edu/semantics/SUDOKN/InductionBrazingCapability)
...
```mermaid
 classDiagram
    class SudoknInductionBrazingCapability
    click SudoknInductionBrazingCapability href "../SudoknInductionBrazingCapability"
      ...
      SudoknInductionBrazingCapability : rdfs_label
        
          
    
    
    SudoknInductionBrazingCapability --> "0..1" String : rdfs_label
...
| ---  | ---  |
| self | sudokn:InductionBrazingCapability |
| native | sudokn-kg/:SudoknInductionBrazingCapability |
...
<details>
```yaml
name: sudokn_InductionBrazingCapability
...
class_uri: sudokn:InductionBrazingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_InductionBrazingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
