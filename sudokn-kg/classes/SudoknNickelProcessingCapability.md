...
# Class: TODO -- what's a good name for this class (type)? (sudokn_NickelProcessingCapability)
...
URI: [sudokn:NickelProcessingCapability](http://asu.edu/semantics/SUDOKN/NickelProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknNickelProcessingCapability
    click SudoknNickelProcessingCapability href "../SudoknNickelProcessingCapability"
      SudoknNickelProcessingCapability : rdfs_label
        
          
    
    
    SudoknNickelProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknNickelProcessingCapability](../classes/SudoknNickelProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknNickelProcessingCapability](../classes/SudoknNickelProcessingCapability.md) |
...
| ---  | ---  |
| self | sudokn:NickelProcessingCapability |
| native | sudokn-kg/:SudoknNickelProcessingCapability |
...
<details>
```yaml
name: sudokn_NickelProcessingCapability
...
- if you think the class is perfect.
notes:
- Class with 1603 occurences.
examples:
- value: sudokn:3DSYSTEMS-Nickel-inst
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:NickelProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_NickelProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
