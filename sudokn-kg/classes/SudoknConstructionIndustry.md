...
# Class: construction industry (sudokn_ConstructionIndustry)
...
| ---  | ---  |
| self | sudokn:ConstructionIndustry |
| native | sudokn-kg/:SudoknConstructionIndustry |
...
examples:
- value: sudokn:Construction-Industry
