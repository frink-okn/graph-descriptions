...
# Class: HttpsIdir.uta.eduSockg-ontology#SoilChemicalSample
...
URI: [https://idir.uta.edu/sockg-ontology#SoilChemicalSample](https://idir.uta.edu/sockg-ontology#SoilChemicalSample)
...
```mermaid
 classDiagram
    ...
    click HttpsIdir.uta.eduSockg-ontology#SoilChemicalSample href "../HttpsIdir.uta.eduSockg-ontology#SoilChemicalSample"
      ...
      HttpsIdir.uta.eduSockg-ontology#SoilChemicalSample : dct_date
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#SoilChemicalSample --> "0..1" RdfsLiteral : dct_date
    click RdfsLiteral href "../RdfsLiteral"

        
      HttpsIdir.uta.eduSockg-ontology#SoilChemicalSample : https___idir.uta.edu_sockg_ontology#fromUnit
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#SoilChemicalSample --> "0..1" Any : https___idir.uta.edu_sockg_ontology#fromUnit
    click Any href "../Any"

        
      HttpsIdir.uta.eduSockg-ontology#SoilChemicalSample : https___idir.uta.edu_sockg_ontology#hasMeasurement
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#SoilChemicalSample --> "0..1" HttpsIdir.uta.eduSockg-ontology#Measurement : https___idir.uta.edu_sockg_ontology#hasMeasurement
    click HttpsIdir.uta.eduSockg-ontology#Measurement href "../HttpsIdir.uta.eduSockg-ontology#Measurement"

        
      HttpsIdir.uta.eduSockg-ontology#SoilChemicalSample : https___idir.uta.edu_sockg_ontology#lowerDepth
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#SoilChemicalSample --> "0..1" QudtQuantityValue : https___idir.uta.edu_sockg_ontology#lowerDepth
    click QudtQuantityValue href "../QudtQuantityValue"

        
      HttpsIdir.uta.eduSockg-ontology#SoilChemicalSample : https___idir.uta.edu_sockg_ontology#upperDepth
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#SoilChemicalSample --> "0..1" QudtQuantityValue : https___idir.uta.edu_sockg_ontology#upperDepth
    click QudtQuantityValue href "../QudtQuantityValue"

        
      HttpsIdir.uta.eduSockg-ontology#SoilChemicalSample : https___idir.uta.edu_sockg_ontology#usesModel
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#SoilChemicalSample --> "0..1" HttpsIdir.uta.eduSockg-ontology#SimulationModel : https___idir.uta.edu_sockg_ontology#usesModel
    click HttpsIdir.uta.eduSockg-ontology#SimulationModel href "../HttpsIdir.uta.eduSockg-ontology#SimulationModel"

        
      HttpsIdir.uta.eduSockg-ontology#SoilChemicalSample : https___idir.uta.edu_sockg_ontology#usesTreatment
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#SoilChemicalSample --> "0..1" Any : https___idir.uta.edu_sockg_ontology#usesTreatment
    click Any href "../Any"
...
| ---  | --- | --- | --- | --- |
| [https___idir.uta.edu_sockg_ontology#fromUnit](../slots/https___idir.uta.edu_sockg_ontology#fromUnit.md) | 0..1 <br/> [xsd:anyURI](http://www.w3.org/2001/XMLSchema#anyURI)&nbsp;or&nbsp;<br />[HttpsIdir.uta.eduSockg-ontology#ExperimentalUnit](../classes/HttpsIdir.uta.eduSockg-ontology#ExperimentalUnit.md) |  <br/>  | direct | 54269 |
| [https___idir.uta.edu_sockg_ontology#usesModel](../slots/https___idir.uta.edu_sockg_ontology#usesModel.md) | 0..1 <br/> [HttpsIdir.uta.eduSockg-ontology#SimulationModel](../classes/HttpsIdir.uta.eduSockg-ontology#SimulationModel.md) |  <br/>  | direct | 6 |
| [https___idir.uta.edu_sockg_ontology#hasMeasurement](../slots/https___idir.uta.edu_sockg_ontology#hasMeasurement.md) | 0..1 <br/> [HttpsIdir.uta.eduSockg-ontology#Measurement](../classes/HttpsIdir.uta.eduSockg-ontology#Measurement.md) |  <br/>  | direct | 248481 |
| [https___idir.uta.edu_sockg_ontology#usesTreatment](../slots/https___idir.uta.edu_sockg_ontology#usesTreatment.md) | 0..1 <br/> [xsd:anyURI](http://www.w3.org/2001/XMLSchema#anyURI)&nbsp;or&nbsp;<br />[HttpsIdir.uta.eduSockg-ontology#Treatment](../classes/HttpsIdir.uta.eduSockg-ontology#Treatment.md) |  <br/>  | direct | 54269 |
...
| [https___idir.uta.edu_sockg_ontology#upperDepth](../slots/https___idir.uta.edu_sockg_ontology#upperDepth.md) | 0..1 <br/> [QudtQuantityValue](../classes/QudtQuantityValue.md) |  <br/>  | direct | 54269 |
| [https___idir.uta.edu_sockg_ontology#lowerDepth](../slots/https___idir.uta.edu_sockg_ontology#lowerDepth.md) | 0..1 <br/> [QudtQuantityValue](../classes/QudtQuantityValue.md) |  <br/>  | direct | 54269 |
...
```yaml
name: https___idir.uta.edu_sockg-ontology#SoilChemicalSample
...
class_uri: https://idir.uta.edu/sockg-ontology#SoilChemicalSample
...
attributes:
  https___idir.uta.edu_sockg-ontology#fromUnit:
    ...
    owner: https___idir.uta.edu_sockg-ontology#SoilChemicalSample
    domain_of:
