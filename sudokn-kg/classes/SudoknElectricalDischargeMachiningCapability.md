...
# Class: TODO -- what's a good name for this class (type)? (sudokn_ElectricalDischargeMachiningCapability)
...
URI: [sudokn:ElectricalDischargeMachiningCapability](http://asu.edu/semantics/SUDOKN/ElectricalDischargeMachiningCapability)
...
```mermaid
 classDiagram
    class SudoknElectricalDischargeMachiningCapability
    click SudoknElectricalDischargeMachiningCapability href "../SudoknElectricalDischargeMachiningCapability"
      SudoknElectricalDischargeMachiningCapability : rdfs_label
        
          
    
    
    SudoknElectricalDischargeMachiningCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknElectricalDischargeMachiningCapability](../classes/SudoknElectricalDischargeMachiningCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknElectricalDischargeMachiningCapability](../classes/SudoknElectricalDischargeMachiningCapability.md) |
...
| Value |
| --- |
| sudokn:3DIMENSIONAL-ElectricalDischargeMachiningCapability-inst |
...
| ---  | ---  |
| self | sudokn:ElectricalDischargeMachiningCapability |
| native | sudokn-kg/:SudoknElectricalDischargeMachiningCapability |
...
<details>
```yaml
name: sudokn_ElectricalDischargeMachiningCapability
...
- if you think the class is perfect.
notes:
- Class with 197 occurences.
examples:
- value: sudokn:3DIMENSIONAL-ElectricalDischargeMachiningCapability-inst
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:ElectricalDischargeMachiningCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ElectricalDischargeMachiningCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
