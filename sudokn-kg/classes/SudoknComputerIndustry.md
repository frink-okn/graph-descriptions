...
# Class: No class (type) name specified (sudokn_ComputerIndustry)
...
URI: [sudokn:ComputerIndustry](http://asu.edu/semantics/SUDOKN/ComputerIndustry)
...
```mermaid
 classDiagram
    ...
    click SudoknComputerIndustry href "../SudoknComputerIndustry"
      ...
      SudoknComputerIndustry : rdfs_label
        
          
    
    
    SudoknComputerIndustry --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string) | No slot (predicate) description specified | [SudoknElectronicProductIndustry](../classes/SudoknElectronicProductIndustry.md) |  |
