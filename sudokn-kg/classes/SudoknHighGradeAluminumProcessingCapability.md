...
# Class: TODO -- what's a good name for this class (type)? (sudokn_HighGradeAluminumProcessingCapability)
...
URI: [sudokn:HighGradeAluminumProcessingCapability](http://asu.edu/semantics/SUDOKN/HighGradeAluminumProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknHighGradeAluminumProcessingCapability
    click SudoknHighGradeAluminumProcessingCapability href "../SudoknHighGradeAluminumProcessingCapability"
      SudoknHighGradeAluminumProcessingCapability : rdfs_label
        
          
    
    
    SudoknHighGradeAluminumProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknHighGradeAluminumProcessingCapability](../classes/SudoknHighGradeAluminumProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknHighGradeAluminumProcessingCapability](../classes/SudoknHighGradeAluminumProcessingCapability.md) |
...
| Value |
| --- |
| sudokn:ALUMA-HighGradeAluminum-inst |
...
| ---  | ---  |
| self | sudokn:HighGradeAluminumProcessingCapability |
| native | sudokn-kg/:SudoknHighGradeAluminumProcessingCapability |
...
<details>
```yaml
name: sudokn_HighGradeAluminumProcessingCapability
...
examples:
- value: sudokn:ALUMA-HighGradeAluminum-inst
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:HighGradeAluminumProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_HighGradeAluminumProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
