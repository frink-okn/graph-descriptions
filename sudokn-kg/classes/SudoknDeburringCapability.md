...
# Class: TODO -- what's a good name for this class (type)? (sudokn_DeburringCapability)
...
URI: [sudokn:DeburringCapability](http://asu.edu/semantics/SUDOKN/DeburringCapability)
...
```mermaid
 classDiagram
    class SudoknDeburringCapability
    click SudoknDeburringCapability href "../SudoknDeburringCapability"
      SudoknDeburringCapability : rdfs_label
        
          
    
    
    SudoknDeburringCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknDeburringCapability](../classes/SudoknDeburringCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknDeburringCapability](../classes/SudoknDeburringCapability.md) |
...
| Value |
| --- |
| sudokn:ABLEBAR-DeburringCapability-inst |
...
| ---  | ---  |
| self | sudokn:DeburringCapability |
| native | sudokn-kg/:SudoknDeburringCapability |
...
<details>
```yaml
name: sudokn_DeburringCapability
...
- if you think the class is perfect.
notes:
- Class with 86 occurences.
examples:
- value: sudokn:ABLEBAR-DeburringCapability-inst
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:DeburringCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_DeburringCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
