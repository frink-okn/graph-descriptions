...
# Class: SudoknChemicalVaporDepositionCapability





URI: [sudokn:ChemicalVaporDepositionCapability](http://asu.edu/semantics/SUDOKN/ChemicalVaporDepositionCapability)
...
```mermaid
 classDiagram
    ...
    click SudoknChemicalVaporDepositionCapability href "../SudoknChemicalVaporDepositionCapability"
      ...
      SudoknChemicalVaporDepositionCapability : rdfs_label
        
          
    
    
    SudoknChemicalVaporDepositionCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject | [SudoknVaporizedMetalCoatingCapability](../classes/SudoknVaporizedMetalCoatingCapability.md), [SudoknCoatingCapability](../classes/SudoknCoatingCapability.md), [SudoknSurfaceFinishingCapability](../classes/SudoknSurfaceFinishingCapability.md) |  |
...
```yaml
name: sudokn_ChemicalVaporDepositionCapability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_VaporizedMetalCoatingCapability
class_uri: sudokn:ChemicalVaporDepositionCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ChemicalVaporDepositionCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
