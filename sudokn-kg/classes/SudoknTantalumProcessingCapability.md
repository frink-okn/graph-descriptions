...
# Class: TODO -- what's a good name for this class (type)? (sudokn_TantalumProcessingCapability)
...
URI: [sudokn:TantalumProcessingCapability](http://asu.edu/semantics/SUDOKN/TantalumProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknTantalumProcessingCapability
    click SudoknTantalumProcessingCapability href "../SudoknTantalumProcessingCapability"
      SudoknTantalumProcessingCapability : rdfs_label
        
          
    
    
    SudoknTantalumProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknTantalumProcessingCapability](../classes/SudoknTantalumProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknTantalumProcessingCapability](../classes/SudoknTantalumProcessingCapability.md) |
...
| ---  | ---  |
| self | sudokn:TantalumProcessingCapability |
| native | sudokn-kg/:SudoknTantalumProcessingCapability |
...
<details>
```yaml
name: sudokn_TantalumProcessingCapability
...
- if you think the class is perfect.
notes:
- Class with 234 occurences.
examples:
- value: sudokn:A1JAYS-Tantalum-inst
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:TantalumProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_TantalumProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
