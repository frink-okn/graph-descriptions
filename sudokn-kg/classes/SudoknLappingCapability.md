...
# Class: lapping capability (sudokn_LappingCapability)





URI: [sudokn:LappingCapability](http://asu.edu/semantics/SUDOKN/LappingCapability)
...
```mermaid
 classDiagram
    ...
    click SudoknLappingCapability href "../SudoknLappingCapability"
      ...
      SudoknLappingCapability : rdfs_label
        
          
    
    
    SudoknLappingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: sudokn_LappingCapability
title: lapping capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_AbrassiveMachiningCapability
class_uri: sudokn:LappingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_LappingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
