...
# Class: No class (type) name specified (io_MaterialProduct)
...
This class occurs 44818 times.


URI: [io:MaterialProduct](https://spec.industrialontologies.org/ontology/core/Core/MaterialProduct)
...
```mermaid
 classDiagram
    class IoMaterialProduct
    click IoMaterialProduct href "../IoMaterialProduct"
      IoMaterialProduct : rdfs_label
        
          
    
    
    IoMaterialProduct --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string) | No slot (predicate) description specified <br/>  | direct | 44836 |
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_manufactures](../slots/sudokn_manufactures.md) | any_of[range] | [IoMaterialProduct](../classes/IoMaterialProduct.md) |
