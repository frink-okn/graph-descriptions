...
# Class: TODO -- what's a good name for this class (type)? (sudokn_MediaBlastingCapability)
...
URI: [sudokn:MediaBlastingCapability](http://asu.edu/semantics/SUDOKN/MediaBlastingCapability)
...
```mermaid
 classDiagram
    class SudoknMediaBlastingCapability
    click SudoknMediaBlastingCapability href "../SudoknMediaBlastingCapability"
      SudoknMediaBlastingCapability : rdfs_label
        
          
    
    
    SudoknMediaBlastingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknMediaBlastingCapability](../classes/SudoknMediaBlastingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknMediaBlastingCapability](../classes/SudoknMediaBlastingCapability.md) |
...
| Value |
| --- |
| sudokn:TarheelPowderCoating-MediaBlasting |
...
| ---  | ---  |
| self | sudokn:MediaBlastingCapability |
| native | sudokn-kg/:SudoknMediaBlastingCapability |
...
<details>
```yaml
name: sudokn_MediaBlastingCapability
...
examples:
- value: sudokn:TarheelPowderCoating-MediaBlasting
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:MediaBlastingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_MediaBlastingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
