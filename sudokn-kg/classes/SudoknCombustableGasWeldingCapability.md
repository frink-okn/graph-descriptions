...
# Class: TODO -- what's a good name for this class (type)? (sudokn_CombustableGasWeldingCapability)
...
| ---  | ---  |
| self | sudokn:CombustableGasWeldingCapability |
| native | sudokn-kg/:SudoknCombustableGasWeldingCapability |
