...
# Class: No class (entity type) name specified -- this class is noted as a superclass of another class in this graph but has not itself been defined. (sudokn_DiffusionHardeningCapability)





URI: [sudokn:DiffusionHardeningCapability](http://asu.edu/semantics/SUDOKN/DiffusionHardeningCapability)
...
```mermaid
 classDiagram
    class SudoknDiffusionHardeningCapability
    click SudoknDiffusionHardeningCapability href "../SudoknDiffusionHardeningCapability"
      ...
      SudoknDiffusionHardeningCapability <|-- SudoknCarbonitridingCapability
        click SudoknCarbonitridingCapability href "../SudoknCarbonitridingCapability"
      SudoknDiffusionHardeningCapability <|-- SudoknCarburizingCapability
        click SudoknCarburizingCapability href "../SudoknCarburizingCapability"
      SudoknDiffusionHardeningCapability <|-- SudoknNitridingCapability
        click SudoknNitridingCapability href "../SudoknNitridingCapability"
      
      
      SudoknDiffusionHardeningCapability : rdfs_label
        
          
    
    
    SudoknDiffusionHardeningCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
    ...
    * [SudoknManufacturingProcessCapability](../classes/SudoknManufacturingProcessCapability.md)
        * [SudoknHeatTreatingCapability](../classes/SudoknHeatTreatingCapability.md)
            * [SudoknHardeningCapability](../classes/SudoknHardeningCapability.md)
                * [SudoknSurfaceHardeningCapability](../classes/SudoknSurfaceHardeningCapability.md)
                    * **SudoknDiffusionHardeningCapability**
                        * [SudoknCarbonitridingCapability](../classes/SudoknCarbonitridingCapability.md)
                        * [SudoknCarburizingCapability](../classes/SudoknCarburizingCapability.md)
                        * [SudoknNitridingCapability](../classes/SudoknNitridingCapability.md)
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_DiffusionHardeningCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
