...
# Class: TODO -- what's a good name for this class (type)? (sudokn_ExtremelyHardMaterialProcessingCapability)
...
URI: [sudokn:ExtremelyHardMaterialProcessingCapability](http://asu.edu/semantics/SUDOKN/ExtremelyHardMaterialProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknExtremelyHardMaterialProcessingCapability
    click SudoknExtremelyHardMaterialProcessingCapability href "../SudoknExtremelyHardMaterialProcessingCapability"
      SudoknExtremelyHardMaterialProcessingCapability : rdfs_label
        
          
    
    
    SudoknExtremelyHardMaterialProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknExtremelyHardMaterialProcessingCapability](../classes/SudoknExtremelyHardMaterialProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknExtremelyHardMaterialProcessingCapability](../classes/SudoknExtremelyHardMaterialProcessingCapability.md) |
...
| Value |
| --- |
| sudokn:ARMORCONTRACT-ExtremelyHardMaterial-inst |
...
| ---  | ---  |
| self | sudokn:ExtremelyHardMaterialProcessingCapability |
| native | sudokn-kg/:SudoknExtremelyHardMaterialProcessingCapability |
...
<details>
```yaml
name: sudokn_ExtremelyHardMaterialProcessingCapability
...
- if you think the class is perfect.
notes:
- Class with 12 occurences.
examples:
- value: sudokn:ARMORCONTRACT-ExtremelyHardMaterial-inst
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:ExtremelyHardMaterialProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ExtremelyHardMaterialProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
