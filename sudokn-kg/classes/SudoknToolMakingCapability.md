...
# Class: tool making capability (sudokn_ToolMakingCapability)
...
URI: [sudokn:ToolMakingCapability](http://asu.edu/semantics/SUDOKN/ToolMakingCapability)
...
```mermaid
 classDiagram
    class SudoknToolMakingCapability
    click SudoknToolMakingCapability href "../SudoknToolMakingCapability"
      ...
      SudoknToolMakingCapability <|-- SudoknMoldMakingCapability
        click SudoknMoldMakingCapability href "../SudoknMoldMakingCapability"
      
      
      SudoknToolMakingCapability : rdfs_label
        
          
    
    
    SudoknToolMakingCapability --> "0..1" String : rdfs_label
...
* [IoscProductionCapability](../classes/IoscProductionCapability.md)
    * [SudoknManufacturingProcessCapability](../classes/SudoknManufacturingProcessCapability.md)
        * **SudoknToolMakingCapability**
            * [SudoknMoldMakingCapability](../classes/SudoknMoldMakingCapability.md)
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknToolMakingCapability](../classes/SudoknToolMakingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknToolMakingCapability](../classes/SudoknToolMakingCapability.md) |
...
| Value |
| --- |
| sudokn:AllredMetalStampingWorks-ToolMaking |
...
| ---  | ---  |
| self | sudokn:ToolMakingCapability |
| native | sudokn-kg/:SudoknToolMakingCapability |
...
<details>
```yaml
name: sudokn_ToolMakingCapability
description: TODO -- tell the world what this class (type) describes.
title: tool making capability
todos:
- TODO -- Todos for this class go here
- or you can delete the todos
- if you think the class is perfect.
...
examples:
- value: sudokn:AllredMetalStampingWorks-ToolMaking
from_schema: sudokn-kg
is_a: sudokn_ManufacturingProcessCapability
slots:
- rdfs_label
class_uri: sudokn:ToolMakingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ToolMakingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
