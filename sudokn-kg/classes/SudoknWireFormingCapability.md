...
# Class: TODO -- what's a good name for this class (type)? (sudokn_WireFormingCapability)
...
URI: [sudokn:WireFormingCapability](http://asu.edu/semantics/SUDOKN/WireFormingCapability)
...
```mermaid
 classDiagram
    class SudoknWireFormingCapability
    click SudoknWireFormingCapability href "../SudoknWireFormingCapability"
      SudoknWireFormingCapability : rdfs_label
        
          
    
    
    SudoknWireFormingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknWireFormingCapability](../classes/SudoknWireFormingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknWireFormingCapability](../classes/SudoknWireFormingCapability.md) |
...
| Value |
| --- |
| sudokn:RedTailGroup-WireForming |
...
| ---  | ---  |
| self | sudokn:WireFormingCapability |
| native | sudokn-kg/:SudoknWireFormingCapability |
...
<details>
```yaml
name: sudokn_WireFormingCapability
...
examples:
- value: sudokn:RedTailGroup-WireForming
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:WireFormingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_WireFormingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
