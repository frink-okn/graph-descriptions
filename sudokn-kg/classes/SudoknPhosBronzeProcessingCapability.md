...
# Class: TODO -- what's a good name for this class (type)? (sudokn_PhosBronzeProcessingCapability)
...
URI: [sudokn:PhosBronzeProcessingCapability](http://asu.edu/semantics/SUDOKN/PhosBronzeProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknPhosBronzeProcessingCapability
    click SudoknPhosBronzeProcessingCapability href "../SudoknPhosBronzeProcessingCapability"
      SudoknPhosBronzeProcessingCapability : rdfs_label
        
          
    
    
    SudoknPhosBronzeProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknPhosBronzeProcessingCapability](../classes/SudoknPhosBronzeProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknPhosBronzeProcessingCapability](../classes/SudoknPhosBronzeProcessingCapability.md) |
...
| Value |
| --- |
| sudokn:CAR-ENG-PhosBronze-inst |
...
| ---  | ---  |
| self | sudokn:PhosBronzeProcessingCapability |
| native | sudokn-kg/:SudoknPhosBronzeProcessingCapability |
...
<details>
```yaml
name: sudokn_PhosBronzeProcessingCapability
...
examples:
- value: sudokn:CAR-ENG-PhosBronze-inst
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:PhosBronzeProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_PhosBronzeProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
