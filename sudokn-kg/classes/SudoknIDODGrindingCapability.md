...
# Class: ID/OD grinding capability (sudokn_IDODGrindingCapability)





URI: [sudokn:IDODGrindingCapability](http://asu.edu/semantics/SUDOKN/IDODGrindingCapability)
...
```mermaid
 classDiagram
    class SudoknIDODGrindingCapability
    click SudoknIDODGrindingCapability href "../SudoknIDODGrindingCapability"
      ...
      SudoknIDODGrindingCapability : rdfs_label
        
          
    
    
    SudoknIDODGrindingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: sudokn_IDODGrindingCapability
title: ID/OD grinding capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_GrindingCapability
class_uri: sudokn:IDODGrindingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_IDODGrindingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
