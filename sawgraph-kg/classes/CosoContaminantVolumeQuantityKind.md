...
# Class: Contaminant Volume Quantity Kind (coso_ContaminantVolumeQuantityKind)


_A type of contaminant quantity that is a volume measurement._
...
URI: [coso:ContaminantVolumeQuantityKind](http://w3id.org/coso/v1/contaminoso#ContaminantVolumeQuantityKind)
...
```mermaid
 classDiagram
    class CosoContaminantVolumeQuantityKind
    click CosoContaminantVolumeQuantityKind href "../CosoContaminantVolumeQuantityKind"
      ...
      CosoContaminantVolumeQuantityKind : owl_sameAs
        
          
    
    
    CosoContaminantVolumeQuantityKind --> "0..1" OwlThing : owl_sameAs
    click OwlThing href "../OwlThing"

        
      CosoContaminantVolumeQuantityKind : rdfs_label
        
          
    
    
    CosoContaminantVolumeQuantityKind --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: coso_ContaminantVolumeQuantityKind
description: A type of contaminant quantity that is a volume measurement.
title: Contaminant Volume Quantity Kind
...
- rdfs_label
- owl_sameAs
class_uri: coso:ContaminantVolumeQuantityKind
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: coso_ContaminantVolumeQuantityKind
    domain_of:
