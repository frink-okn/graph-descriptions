...
# Class: casting capability (sudokn_CastingCapability)




This class occurs 1195 times.


URI: [sudokn:CastingCapability](http://asu.edu/semantics/SUDOKN/CastingCapability)
...
```mermaid
 classDiagram
    ...
    click SudoknCastingCapability href "../SudoknCastingCapability"
      ...
      SudoknCastingCapability <|-- SudoknCentrifugalCastingCapability
        click SudoknCentrifugalCastingCapability href "../SudoknCentrifugalCastingCapability"
      SudoknCastingCapability <|-- SudoknCeramicMoldCastingCapability
        click SudoknCeramicMoldCastingCapability href "../SudoknCeramicMoldCastingCapability"
      SudoknCastingCapability <|-- SudoknContinuousCastingCapability
        click SudoknContinuousCastingCapability href "../SudoknContinuousCastingCapability"
      SudoknCastingCapability <|-- SudoknDieCastingCapability
        click SudoknDieCastingCapability href "../SudoknDieCastingCapability"
      SudoknCastingCapability <|-- SudoknGravityCastingCapability
        click SudoknGravityCastingCapability href "../SudoknGravityCastingCapability"
      SudoknCastingCapability <|-- SudoknInvestmentCastingCapability
        click SudoknInvestmentCastingCapability href "../SudoknInvestmentCastingCapability"
      SudoknCastingCapability <|-- SudoknLostFoamCastingCapability
        click SudoknLostFoamCastingCapability href "../SudoknLostFoamCastingCapability"
      SudoknCastingCapability <|-- SudoknPlasterMoldCastingCapability
        click SudoknPlasterMoldCastingCapability href "../SudoknPlasterMoldCastingCapability"
      SudoknCastingCapability <|-- SudoknSandCastingCapability
        click SudoknSandCastingCapability href "../SudoknSandCastingCapability"
      SudoknCastingCapability <|-- SudoknShellMoldingCapability
        click SudoknShellMoldingCapability href "../SudoknShellMoldingCapability"
      SudoknCastingCapability <|-- SudoknSqueezeCastingCapability
        click SudoknSqueezeCastingCapability href "../SudoknSqueezeCastingCapability"
      SudoknCastingCapability <|-- SudoknVacuumCastingCapability
        click SudoknVacuumCastingCapability href "../SudoknVacuumCastingCapability"
      
      
      SudoknCastingCapability : rdfs_label
        
          
    
    
    SudoknCastingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
* [IoscProductionCapability](../classes/IoscProductionCapability.md)
    * [SudoknManufacturingProcessCapability](../classes/SudoknManufacturingProcessCapability.md)
        * **SudoknCastingCapability**
            * [SudoknCentrifugalCastingCapability](../classes/SudoknCentrifugalCastingCapability.md)
            * [SudoknCeramicMoldCastingCapability](../classes/SudoknCeramicMoldCastingCapability.md)
            * [SudoknContinuousCastingCapability](../classes/SudoknContinuousCastingCapability.md)
            * [SudoknDieCastingCapability](../classes/SudoknDieCastingCapability.md)
            * [SudoknGravityCastingCapability](../classes/SudoknGravityCastingCapability.md)
            * [SudoknInvestmentCastingCapability](../classes/SudoknInvestmentCastingCapability.md)
            * [SudoknLostFoamCastingCapability](../classes/SudoknLostFoamCastingCapability.md)
            * [SudoknPlasterMoldCastingCapability](../classes/SudoknPlasterMoldCastingCapability.md)
            * [SudoknSandCastingCapability](../classes/SudoknSandCastingCapability.md)
            * [SudoknShellMoldingCapability](../classes/SudoknShellMoldingCapability.md)
            * [SudoknSqueezeCastingCapability](../classes/SudoknSqueezeCastingCapability.md)
            * [SudoknVacuumCastingCapability](../classes/SudoknVacuumCastingCapability.md)
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject <br/>  | direct | 1195 |
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCastingCapability](../classes/SudoknCastingCapability.md) |
...
```yaml
name: sudokn_CastingCapability
title: casting capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_ManufacturingProcessCapability
slots:
- rdfs_label
class_uri: sudokn:CastingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_CastingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
