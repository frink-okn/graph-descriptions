...
# Class: TODO -- what's a good name for this class (type)? (sudokn_ResistanceWeldingCapability)
...
URI: [sudokn:ResistanceWeldingCapability](http://asu.edu/semantics/SUDOKN/ResistanceWeldingCapability)
...
```mermaid
 classDiagram
    class SudoknResistanceWeldingCapability
    click SudoknResistanceWeldingCapability href "../SudoknResistanceWeldingCapability"
      SudoknResistanceWeldingCapability : rdfs_label
        
          
    
    
    SudoknResistanceWeldingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknResistanceWeldingCapability](../classes/SudoknResistanceWeldingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknResistanceWeldingCapability](../classes/SudoknResistanceWeldingCapability.md) |
...
| Value |
| --- |
| sudokn:Technibilt-ResistanceWelding |
...
| ---  | ---  |
| self | sudokn:ResistanceWeldingCapability |
| native | sudokn-kg/:SudoknResistanceWeldingCapability |
...
<details>
```yaml
name: sudokn_ResistanceWeldingCapability
...
examples:
- value: sudokn:Technibilt-ResistanceWelding
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:ResistanceWeldingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ResistanceWeldingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
