...
URI: [sudokn:TIGWeldingCapability](http://asu.edu/semantics/SUDOKN/TIGWeldingCapability)
...
```mermaid
 classDiagram
    class SudoknTIGWeldingCapability
    click SudoknTIGWeldingCapability href "../SudoknTIGWeldingCapability"
      ...
      SudoknTIGWeldingCapability : rdfs_label
        
          
    
    
    SudoknTIGWeldingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknTIGWeldingCapability](../classes/SudoknTIGWeldingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknTIGWeldingCapability](../classes/SudoknTIGWeldingCapability.md) |
...
| Value |
| --- |
| sudokn:ComposiMoFabrication-TIGWelding |
...
| ---  | ---  |
| self | sudokn:TIGWeldingCapability |
| native | sudokn-kg/:SudoknTIGWeldingCapability |
...
slots:
- rdfs_label
class_uri: sudokn:TIGWeldingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_TIGWeldingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
