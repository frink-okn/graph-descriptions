...
# Class: metal injection molding capability (sudokn_MetalInjectionMoldingCapability)





URI: [sudokn:MetalInjectionMoldingCapability](http://asu.edu/semantics/SUDOKN/MetalInjectionMoldingCapability)
...
```mermaid
 classDiagram
    class SudoknMetalInjectionMoldingCapability
    click SudoknMetalInjectionMoldingCapability href "../SudoknMetalInjectionMoldingCapability"
      ...
      SudoknMetalInjectionMoldingCapability : rdfs_label
        
          
    
    
    SudoknMetalInjectionMoldingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: sudokn_MetalInjectionMoldingCapability
title: metal injection molding capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_InjectionMoldingCapability
class_uri: sudokn:MetalInjectionMoldingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_MetalInjectionMoldingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
