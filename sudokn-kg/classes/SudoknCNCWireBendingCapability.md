...
# Class: TODO -- what's a good name for this class (type)? (sudokn_CNCWireBendingCapability)
...
URI: [sudokn:CNCWireBendingCapability](http://asu.edu/semantics/SUDOKN/CNCWireBendingCapability)
...
```mermaid
 classDiagram
    class SudoknCNCWireBendingCapability
    click SudoknCNCWireBendingCapability href "../SudoknCNCWireBendingCapability"
      SudoknCNCWireBendingCapability : rdfs_label
        
          
    
    
    SudoknCNCWireBendingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCNCWireBendingCapability](../classes/SudoknCNCWireBendingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCNCWireBendingCapability](../classes/SudoknCNCWireBendingCapability.md) |
...
| Value |
| --- |
| sudokn:RedTailGroup-CNCWireBending |
...
| ---  | ---  |
| self | sudokn:CNCWireBendingCapability |
| native | sudokn-kg/:SudoknCNCWireBendingCapability |
...
<details>
```yaml
name: sudokn_CNCWireBendingCapability
...
examples:
- value: sudokn:RedTailGroup-CNCWireBending
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:CNCWireBendingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_CNCWireBendingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
