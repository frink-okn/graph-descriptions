...
# Class: TODO -- what's a good name for this class (type)? (sudokn_SpotWeldingCapability)
...
URI: [sudokn:SpotWeldingCapability](http://asu.edu/semantics/SUDOKN/SpotWeldingCapability)
...
```mermaid
 classDiagram
    class SudoknSpotWeldingCapability
    click SudoknSpotWeldingCapability href "../SudoknSpotWeldingCapability"
      ...
      SudoknSpotWeldingCapability : rdfs_label
        
          
    
    
    SudoknSpotWeldingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknSpotWeldingCapability](../classes/SudoknSpotWeldingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknSpotWeldingCapability](../classes/SudoknSpotWeldingCapability.md) |
...
| Value |
| --- |
| sudokn:LiquidProcessSystems-SpotWelding |
...
| ---  | ---  |
| self | sudokn:SpotWeldingCapability |
| native | sudokn-kg/:SudoknSpotWeldingCapability |
...
<details>
```yaml
name: sudokn_SpotWeldingCapability
...
examples:
- value: sudokn:LiquidProcessSystems-SpotWelding
from_schema: sudokn-kg
rank: 1000
is_a: sudokn_ElectricalResistanceWeldingCapability
slots:
- rdfs_label
class_uri: sudokn:SpotWeldingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_SpotWeldingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
