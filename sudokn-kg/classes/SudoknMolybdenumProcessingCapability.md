...
# Class: TODO -- what's a good name for this class (type)? (sudokn_MolybdenumProcessingCapability)
...
URI: [sudokn:MolybdenumProcessingCapability](http://asu.edu/semantics/SUDOKN/MolybdenumProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknMolybdenumProcessingCapability
    click SudoknMolybdenumProcessingCapability href "../SudoknMolybdenumProcessingCapability"
      SudoknMolybdenumProcessingCapability : rdfs_label
        
          
    
    
    SudoknMolybdenumProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknMolybdenumProcessingCapability](../classes/SudoknMolybdenumProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknMolybdenumProcessingCapability](../classes/SudoknMolybdenumProcessingCapability.md) |
...
| ---  | ---  |
| self | sudokn:MolybdenumProcessingCapability |
| native | sudokn-kg/:SudoknMolybdenumProcessingCapability |
...
<details>
```yaml
name: sudokn_MolybdenumProcessingCapability
...
- if you think the class is perfect.
notes:
- Class with 382 occurences.
examples:
- value: sudokn:3ERP-Molybdenum-inst
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:MolybdenumProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_MolybdenumProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
