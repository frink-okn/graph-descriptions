...
# Class: TODO -- what's a good name for this class (type)? (sudokn_BrazingCapability)
...
URI: [sudokn:BrazingCapability](http://asu.edu/semantics/SUDOKN/BrazingCapability)
...
```mermaid
 classDiagram
    class SudoknBrazingCapability
    click SudoknBrazingCapability href "../SudoknBrazingCapability"
      SudoknThermaJoiningCapability <|-- SudoknBrazingCapability
        click SudoknThermaJoiningCapability href "../SudoknThermaJoiningCapability"
      

      SudoknBrazingCapability <|-- SudoknDipBrazingCapability
        click SudoknDipBrazingCapability href "../SudoknDipBrazingCapability"
      SudoknBrazingCapability <|-- SudoknFurnaceBrazingCapability
        click SudoknFurnaceBrazingCapability href "../SudoknFurnaceBrazingCapability"
      SudoknBrazingCapability <|-- SudoknInductionBrazingCapability
        click SudoknInductionBrazingCapability href "../SudoknInductionBrazingCapability"
      SudoknBrazingCapability <|-- SudoknInfraredBrazingCapability
        click SudoknInfraredBrazingCapability href "../SudoknInfraredBrazingCapability"
      SudoknBrazingCapability <|-- SudoknResistanceBrazingCapability
        click SudoknResistanceBrazingCapability href "../SudoknResistanceBrazingCapability"
      SudoknBrazingCapability <|-- SudoknTorchBrazingCapability
        click SudoknTorchBrazingCapability href "../SudoknTorchBrazingCapability"
      
      
      SudoknBrazingCapability : rdfs_label
        
          
    
    
    SudoknBrazingCapability --> "0..1" String : rdfs_label
        ...
        * [SudoknJoiningCapability](../classes/SudoknJoiningCapability.md)
            * [SudoknThermaJoiningCapability](../classes/SudoknThermaJoiningCapability.md)
                * **SudoknBrazingCapability**
                    * [SudoknDipBrazingCapability](../classes/SudoknDipBrazingCapability.md)
                    * [SudoknFurnaceBrazingCapability](../classes/SudoknFurnaceBrazingCapability.md)
                    * [SudoknInductionBrazingCapability](../classes/SudoknInductionBrazingCapability.md)
                    * [SudoknInfraredBrazingCapability](../classes/SudoknInfraredBrazingCapability.md)
                    * [SudoknResistanceBrazingCapability](../classes/SudoknResistanceBrazingCapability.md)
                    * [SudoknTorchBrazingCapability](../classes/SudoknTorchBrazingCapability.md)
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknBrazingCapability](../classes/SudoknBrazingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknBrazingCapability](../classes/SudoknBrazingCapability.md) |
...
| Value |
| --- |
| sudokn:ABBCOINC-BrazingCapability-inst |
...
| ---  | ---  |
| self | sudokn:BrazingCapability |
| native | sudokn-kg/:SudoknBrazingCapability |
...
- if you think the class is perfect.
notes:
- Class with 147 occurences.
examples:
- value: sudokn:ABBCOINC-BrazingCapability-inst
from_schema: sudokn-kg
rank: 1000
is_a: sudokn_ThermaJoiningCapability
slots:
- rdfs_label
class_uri: sudokn:BrazingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_BrazingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
