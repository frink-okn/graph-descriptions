...
# Class: Animal Tissue Sample (coso_AnimalTissueSample)




This class occurs 894 times.


URI: [coso:AnimalTissueSample](http://w3id.org/coso/v1/contaminoso#AnimalTissueSample)
...
```mermaid
 classDiagram
    class CosoAnimalTissueSample
    click CosoAnimalTissueSample href "../CosoAnimalTissueSample"
      SosaSample <|-- CosoAnimalTissueSample
        click SosaSample href "../SosaSample"
      
      CosoAnimalTissueSample : coso_fromSamplePoint
        
          
    
    
    CosoAnimalTissueSample --> "0..1" Any : coso_fromSamplePoint
    click Any href "../Any"

        
      CosoAnimalTissueSample : coso_isSampleOf
        
          
    
    
    CosoAnimalTissueSample --> "0..1" Any : coso_isSampleOf
    click Any href "../Any"

        
      CosoAnimalTissueSample : coso_sampleAnnotation
        
          
    
    
    CosoAnimalTissueSample --> "0..1" Any : coso_sampleAnnotation
    click Any href "../Any"

        
      CosoAnimalTissueSample : coso_sampleOfMaterialType
        
          
    
    
    CosoAnimalTissueSample --> "0..1" Any : coso_sampleOfMaterialType
    click Any href "../Any"

        
      CosoAnimalTissueSample : dct_identifier
        
          
    
    
    CosoAnimalTissueSample --> "0..1" RdfsLiteral : dct_identifier
    click RdfsLiteral href "../RdfsLiteral"

        
      CosoAnimalTissueSample : http___w3id.org_sawgraph_v1_me_egad#sampleCollectionLocation
        
          
    
    
    CosoAnimalTissueSample --> "0..1" Any : http___w3id.org_sawgraph_v1_me_egad#sampleCollectionLocation
    click Any href "../Any"

        
      CosoAnimalTissueSample : http___w3id.org_sawgraph_v1_me_egad#sampleCollectionMethod
        
          
    
    
    CosoAnimalTissueSample --> "0..1" Any : http___w3id.org_sawgraph_v1_me_egad#sampleCollectionMethod
    click Any href "../Any"

        
      CosoAnimalTissueSample : owl_sameAs
        
          
    
    
    CosoAnimalTissueSample --> "0..1" OwlThing : owl_sameAs
    click OwlThing href "../OwlThing"

        
      CosoAnimalTissueSample : prov_wasAttributedTo
        
          
    
    
    CosoAnimalTissueSample --> "0..1" ProvAgent : prov_wasAttributedTo
    click ProvAgent href "../ProvAgent"

        
      CosoAnimalTissueSample : rdfs_label
        
          
    
    
    CosoAnimalTissueSample --> "0..1" Any : rdfs_label
    click Any href "../Any"

        
      CosoAnimalTissueSample : sosa_isSampleOf
        
          
    
    
    CosoAnimalTissueSample --> "0..1" HttpW3id.orgSawgraphV1Me-egad#EGAD-SampledFeature : sosa_isSampleOf
...
| ---  | --- | --- | --- |
| [HttpW3id.orgSawgraphV1Me-egad#EGAD-PFAS-Observation](../classes/HttpW3id.orgSawgraphV1Me-egad#EGAD-PFAS-Observation.md) | [coso_analyzedSample](../slots/coso_analyzedSample.md) | any_of[range] | [CosoAnimalTissueSample](../classes/CosoAnimalTissueSample.md) |
| [HttpW3id.orgSawgraphV1Me-egad#EGAD-PFAS-Observation](../classes/HttpW3id.orgSawgraphV1Me-egad#EGAD-PFAS-Observation.md) | [coso_hasAnyFeatureOfInterest](../slots/coso_hasAnyFeatureOfInterest.md) | any_of[range] | [CosoAnimalTissueSample](../classes/CosoAnimalTissueSample.md) |
| [HttpW3id.orgSawgraphV1Us-wqp#Observation](../classes/HttpW3id.orgSawgraphV1Us-wqp#Observation.md) | [coso_analyzedSample](../slots/coso_analyzedSample.md) | any_of[range] | [CosoAnimalTissueSample](../classes/CosoAnimalTissueSample.md) |
| [MeEgadEGAD-PFAS-Observation](../classes/MeEgadEGAD-PFAS-Observation.md) | [coso_analyzedSample](../slots/coso_analyzedSample.md) | any_of[range] | [CosoAnimalTissueSample](../classes/CosoAnimalTissueSample.md) |
| [MeEgadEGAD-PFAS-Observation](../classes/MeEgadEGAD-PFAS-Observation.md) | [coso_hasAnyFeatureOfInterest](../slots/coso_hasAnyFeatureOfInterest.md) | any_of[range] | [CosoAnimalTissueSample](../classes/CosoAnimalTissueSample.md) |
...
```yaml
name: coso_AnimalTissueSample
title: Animal Tissue Sample
...
- coso_fromSamplePoint
class_uri: coso:AnimalTissueSample
