...
# Class: Small Disadvantaged Business (sudokn_SmallDisadvantagedBusiness)





URI: [sudokn:SmallDisadvantagedBusiness](http://asu.edu/semantics/SUDOKN/SmallDisadvantagedBusiness)
...
```mermaid
 classDiagram
    class SudoknSmallDisadvantagedBusiness
    click SudoknSmallDisadvantagedBusiness href "../SudoknSmallDisadvantagedBusiness"
      ...
      SudoknSmallDisadvantagedBusiness : rdfs_label
        
          
    
    
    SudoknSmallDisadvantagedBusiness --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject | [SudoknOwnershipStatusClassifier](../classes/SudoknOwnershipStatusClassifier.md) |  |
...
```yaml
name: sudokn_SmallDisadvantagedBusiness
title: Small Disadvantaged Business
from_schema: okns:sudokn-kg
aliases:
- 8(a)
rank: 1000
is_a: sudokn_OwnershipStatusClassifier
class_uri: sudokn:SmallDisadvantagedBusiness
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_SmallDisadvantagedBusiness
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
