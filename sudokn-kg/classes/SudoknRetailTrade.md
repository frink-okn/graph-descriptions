...
# Class: No class (type) name specified (sudokn_RetailTrade)
...
URI: [sudokn:RetailTrade](http://asu.edu/semantics/SUDOKN/RetailTrade)
...
```mermaid
 classDiagram
    ...
    click SudoknRetailTrade href "../SudoknRetailTrade"
      ...
      SudoknRetailTrade : sudokn_hasNAICSCodeValue
        
          
    
    
    SudoknRetailTrade --> "0..1" Any : sudokn_hasNAICSCodeValue
    click Any href "../Any"

        
      SudoknRetailTrade : sudokn_hasNAICSTextValue
        
          
    
    
    SudoknRetailTrade --> "0..1" Any : sudokn_hasNAICSTextValue
    click Any href "../Any"
