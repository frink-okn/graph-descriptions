...
# Class: TODO -- what's a good name for this class (type)? (sudokn_InvarProcessingCapability)
...
URI: [sudokn:InvarProcessingCapability](http://asu.edu/semantics/SUDOKN/InvarProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknInvarProcessingCapability
    click SudoknInvarProcessingCapability href "../SudoknInvarProcessingCapability"
      SudoknInvarProcessingCapability : rdfs_label
        
          
    
    
    SudoknInvarProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknInvarProcessingCapability](../classes/SudoknInvarProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknInvarProcessingCapability](../classes/SudoknInvarProcessingCapability.md) |
...
| ---  | ---  |
| self | sudokn:InvarProcessingCapability |
| native | sudokn-kg/:SudoknInvarProcessingCapability |
...
<details>
```yaml
name: sudokn_InvarProcessingCapability
...
- if you think the class is perfect.
notes:
- Class with 219 occurences.
examples:
- value: sudokn:A1JAYS-Invar-inst
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:InvarProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_InvarProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
