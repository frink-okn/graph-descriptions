...
# Class: TODO -- what's a good name for this class (type)? (sudokn_HorizontalMillingCapability)
...
URI: [sudokn:HorizontalMillingCapability](http://asu.edu/semantics/SUDOKN/HorizontalMillingCapability)
...
```mermaid
 classDiagram
    class SudoknHorizontalMillingCapability
    click SudoknHorizontalMillingCapability href "../SudoknHorizontalMillingCapability"
      ...
      SudoknHorizontalMillingCapability <|-- SudoknSlabMillingCapability
        click SudoknSlabMillingCapability href "../SudoknSlabMillingCapability"
      
      
      SudoknHorizontalMillingCapability : rdfs_label
        
          
    
    
    SudoknHorizontalMillingCapability --> "0..1" String : rdfs_label
            ...
            * [SudoknMultiPointCuttingCapability](../classes/SudoknMultiPointCuttingCapability.md)
                * [SudoknMillingCapability](../classes/SudoknMillingCapability.md)
                    * **SudoknHorizontalMillingCapability**
                        * [SudoknSlabMillingCapability](../classes/SudoknSlabMillingCapability.md)
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknHorizontalMillingCapability](../classes/SudoknHorizontalMillingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknHorizontalMillingCapability](../classes/SudoknHorizontalMillingCapability.md) |
...
| Value |
| --- |
| sudokn:AAE-MFG-HorizontalMillingCapability-inst |
...
| ---  | ---  |
| self | sudokn:HorizontalMillingCapability |
| native | sudokn-kg/:SudoknHorizontalMillingCapability |
...
<details>
```yaml
name: sudokn_HorizontalMillingCapability
...
- if you think the class is perfect.
notes:
- Class with 181 occurences.
examples:
- value: sudokn:AAE-MFG-HorizontalMillingCapability-inst
from_schema: sudokn-kg
rank: 1000
is_a: sudokn_MillingCapability
slots:
- rdfs_label
class_uri: sudokn:HorizontalMillingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_HorizontalMillingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
