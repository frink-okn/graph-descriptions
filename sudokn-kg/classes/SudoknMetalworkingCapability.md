...
# Class: TODO -- what's a good name for this class (type)? (sudokn_MetalworkingCapability)
...
URI: [sudokn:MetalworkingCapability](http://asu.edu/semantics/SUDOKN/MetalworkingCapability)
...
```mermaid
 classDiagram
    class SudoknMetalworkingCapability
    click SudoknMetalworkingCapability href "../SudoknMetalworkingCapability"
      SudoknMetalworkingCapability : rdfs_label
        
          
    
    
    SudoknMetalworkingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknMetalworkingCapability](../classes/SudoknMetalworkingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknMetalworkingCapability](../classes/SudoknMetalworkingCapability.md) |
...
| ---  | ---  |
| self | sudokn:MetalworkingCapability |
| native | sudokn-kg/:SudoknMetalworkingCapability |
...
<details>
```yaml
name: sudokn_MetalworkingCapability
...
examples:
- value: sudokn:applerock-Metalworking
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:MetalworkingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_MetalworkingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
