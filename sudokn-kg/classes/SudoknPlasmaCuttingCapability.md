...
# Class: plasma cutting capability (sudokn_PlasmaCuttingCapability)
...
```mermaid
 classDiagram
    ...
    SudoknPlasmaCuttingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject <br/>  | direct | 235 |
...
title: plasma cutting capability
