...
# Class: No class (type) name specified (sudokn_AS9100Certificate)
...
This class occurs 1220 times.


URI: [sudokn:AS9100Certificate](http://asu.edu/semantics/SUDOKN/AS9100Certificate)
...
```mermaid
 classDiagram
    ...
    click SudoknAS9100Certificate href "../SudoknAS9100Certificate"
      ...
      SudoknAS9100Certificate : rdfs_label
        
          
    
    
    SudoknAS9100Certificate --> "0..1" String : rdfs_label
    click String href "../String"

        
      SudoknAS9100Certificate : sudokn_attestsTo
        
          
    
    
    SudoknAS9100Certificate --> "0..1" Any : sudokn_attestsTo
    click Any href "../Any"
...
| ---  | --- | --- | --- | --- |
| [sudokn_attestsTo](../slots/sudokn_attestsTo.md) | 0..1 <br/> [OwlNamedIndividual](../classes/OwlNamedIndividual.md)&nbsp;or&nbsp;<br />[xsd:anyURI](http://www.w3.org/2001/XMLSchema#anyURI)&nbsp;or&nbsp;<br />[SudoknQualityManagementCapability](../classes/SudoknQualityManagementCapability.md) | No slot (predicate) description specified <br/>  | direct | 2 |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string) | No slot (predicate) description specified <br/>  | direct | 1219 |
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasCertificate](../slots/sudokn_hasCertificate.md) | any_of[range] | [SudoknAS9100Certificate](../classes/SudoknAS9100Certificate.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasCertificate](../slots/sudokn_hasCertificate.md) | any_of[range] | [SudoknAS9100Certificate](../classes/SudoknAS9100Certificate.md) |
  ...
  sudokn_attestsTo:
    ...
    annotations:
      ...
      sudokn_QualityManagementCapability:
        ...
        value: 1
class_uri: sudokn:AS9100Certificate
...
attributes:
  sudokn_attestsTo:
    ...
    owner: sudokn_AS9100Certificate
    domain_of:
    - owl_NamedIndividual
