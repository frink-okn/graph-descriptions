...
# Class: TODO -- what's a good name for this class (type)? (sudokn_CenterlessGrindingCapability)
...
URI: [sudokn:CenterlessGrindingCapability](http://asu.edu/semantics/SUDOKN/CenterlessGrindingCapability)
...
```mermaid
 classDiagram
    class SudoknCenterlessGrindingCapability
    click SudoknCenterlessGrindingCapability href "../SudoknCenterlessGrindingCapability"
      ...
      SudoknCenterlessGrindingCapability : rdfs_label
        
          
    
    
    SudoknCenterlessGrindingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCenterlessGrindingCapability](../classes/SudoknCenterlessGrindingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCenterlessGrindingCapability](../classes/SudoknCenterlessGrindingCapability.md) |
...
| ---  | ---  |
| self | sudokn:CenterlessGrindingCapability |
| native | sudokn-kg/:SudoknCenterlessGrindingCapability |
...
<details>
```yaml
name: sudokn_CenterlessGrindingCapability
...
slots:
- rdfs_label
class_uri: sudokn:CenterlessGrindingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_CenterlessGrindingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
