...
# Class: TODO -- what's a good name for this class (type)? (sudokn_InconelProcessingCapability)
...
URI: [sudokn:InconelProcessingCapability](http://asu.edu/semantics/SUDOKN/InconelProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknInconelProcessingCapability
    click SudoknInconelProcessingCapability href "../SudoknInconelProcessingCapability"
      SudoknInconelProcessingCapability : rdfs_label
        
          
    
    
    SudoknInconelProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknInconelProcessingCapability](../classes/SudoknInconelProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknInconelProcessingCapability](../classes/SudoknInconelProcessingCapability.md) |
...
| Value |
| --- |
| sudokn:3DXINDUSTRIES-Inconel-inst |
...
| ---  | ---  |
| self | sudokn:InconelProcessingCapability |
| native | sudokn-kg/:SudoknInconelProcessingCapability |
...
<details>
```yaml
name: sudokn_InconelProcessingCapability
...
- if you think the class is perfect.
notes:
- Class with 906 occurences.
examples:
- value: sudokn:3DXINDUSTRIES-Inconel-inst
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:InconelProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_InconelProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
