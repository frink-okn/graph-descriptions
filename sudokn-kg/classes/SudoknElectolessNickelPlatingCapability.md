...
# Class: TODO -- what's a good name for this class (type)? (sudokn_ElectolessNickelPlatingCapability)
...
URI: [sudokn:ElectolessNickelPlatingCapability](http://asu.edu/semantics/SUDOKN/ElectolessNickelPlatingCapability)
...
```mermaid
 classDiagram
    class SudoknElectolessNickelPlatingCapability
    click SudoknElectolessNickelPlatingCapability href "../SudoknElectolessNickelPlatingCapability"
      SudoknElectolessNickelPlatingCapability : rdfs_label
        
          
    
    
    SudoknElectolessNickelPlatingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknElectolessNickelPlatingCapability](../classes/SudoknElectolessNickelPlatingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknElectolessNickelPlatingCapability](../classes/SudoknElectolessNickelPlatingCapability.md) |
...
| Value |
| --- |
| sudokn:AlliedMetalFinishing-ElectolessNickelPlating |
...
| ---  | ---  |
| self | sudokn:ElectolessNickelPlatingCapability |
| native | sudokn-kg/:SudoknElectolessNickelPlatingCapability |
...
<details>
```yaml
name: sudokn_ElectolessNickelPlatingCapability
...
examples:
- value: sudokn:AlliedMetalFinishing-ElectolessNickelPlating
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:ElectolessNickelPlatingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ElectolessNickelPlatingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
