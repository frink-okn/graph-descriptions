...
# Class: TODO -- what's a good name for this class (type)? (sudokn_PhosphateCoatingCapability)
...
URI: [sudokn:PhosphateCoatingCapability](http://asu.edu/semantics/SUDOKN/PhosphateCoatingCapability)
...
```mermaid
 classDiagram
    class SudoknPhosphateCoatingCapability
    click SudoknPhosphateCoatingCapability href "../SudoknPhosphateCoatingCapability"
      ...
      SudoknPhosphateCoatingCapability : rdfs_label
        
          
    
    
    SudoknPhosphateCoatingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknPhosphateCoatingCapability](../classes/SudoknPhosphateCoatingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknPhosphateCoatingCapability](../classes/SudoknPhosphateCoatingCapability.md) |
...
| ---  | ---  |
| self | sudokn:PhosphateCoatingCapability |
| native | sudokn-kg/:SudoknPhosphateCoatingCapability |
...
<details>
```yaml
name: sudokn_PhosphateCoatingCapability
...
slots:
- rdfs_label
class_uri: sudokn:PhosphateCoatingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_PhosphateCoatingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
