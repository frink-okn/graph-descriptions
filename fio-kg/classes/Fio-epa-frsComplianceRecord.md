...
```mermaid
 classDiagram
    ...
    click Fio-epa-frsComplianceRecord href "../Fio-epa-frsComplianceRecord"
      ...
      Fio-epa-frsComplianceRecord : dc_identifier
        
          
    
    
    Fio-epa-frsComplianceRecord --> "0..1" Any : dc_identifier
    click Any href "../Any"
