...
# Class: TODO -- what's a good name for this class (type)? (sudokn_PlatinumProcessingCapability)
...
URI: [sudokn:PlatinumProcessingCapability](http://asu.edu/semantics/SUDOKN/PlatinumProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknPlatinumProcessingCapability
    click SudoknPlatinumProcessingCapability href "../SudoknPlatinumProcessingCapability"
      SudoknPlatinumProcessingCapability : rdfs_label
        
          
    
    
    SudoknPlatinumProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknPlatinumProcessingCapability](../classes/SudoknPlatinumProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknPlatinumProcessingCapability](../classes/SudoknPlatinumProcessingCapability.md) |
...
| ---  | ---  |
| self | sudokn:PlatinumProcessingCapability |
| native | sudokn-kg/:SudoknPlatinumProcessingCapability |
...
<details>
```yaml
name: sudokn_PlatinumProcessingCapability
...
- if you think the class is perfect.
notes:
- Class with 225 occurences.
examples:
- value: sudokn:3DMACH-Platinum-inst
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:PlatinumProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_PlatinumProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
