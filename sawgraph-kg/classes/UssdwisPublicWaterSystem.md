...
# Class: TODO -- what's a good name for this class (type)? (ussdwis_PublicWaterSystem)
...
URI: [ussdwis:PublicWaterSystem](http://sawgraph.spatialai.org/v1/us-sdwis#PublicWaterSystem)
...
```mermaid
 classDiagram
    ...
    click UssdwisPublicWaterSystem href "../UssdwisPublicWaterSystem"
      ...
      UssdwisPublicWaterSystem : geo_hasSerialization
        
          
    
    
    UssdwisPublicWaterSystem --> "0..1" GeoWktLiteral : geo_hasSerialization
...
| ---  | ---  |
| self | ussdwis:PublicWaterSystem |
| native | sawgraph-kg/:UssdwisPublicWaterSystem |
...
<details>
```yaml
name: ussdwis_PublicWaterSystem
...
- if you think the class is perfect.
notes:
- Class with 33717 occurences.
from_schema: sawgraph-kg
is_a: geo_SpatialObject
class_uri: ussdwis:PublicWaterSystem
...
attributes:
  geo_hasSerialization:
    ...
    owner: ussdwis_PublicWaterSystem
    domain_of:
    - geo_Geometry
    - geo_SpatialObject
