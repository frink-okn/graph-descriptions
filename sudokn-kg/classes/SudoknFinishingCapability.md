...
# Class: finishing capability (sudokn_FinishingCapability)
...
URI: [sudokn:FinishingCapability](http://asu.edu/semantics/SUDOKN/FinishingCapability)
...
```mermaid
 classDiagram
    class SudoknFinishingCapability
    click SudoknFinishingCapability href "../SudoknFinishingCapability"
      ...
      SudoknFinishingCapability : rdfs_label
        
          
    
    
    SudoknFinishingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknFinishingCapability](../classes/SudoknFinishingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknFinishingCapability](../classes/SudoknFinishingCapability.md) |
...
| ---  | ---  |
| self | sudokn:FinishingCapability |
| native | sudokn-kg/:SudoknFinishingCapability |
...
<details>
```yaml
name: sudokn_FinishingCapability
description: TODO -- tell the world what this class (type) describes.
title: finishing capability
todos:
- TODO -- Todos for this class go here
- or you can delete the todos
- if you think the class is perfect.
notes:
- Class with 1615 occurences.
examples:
- value: sudokn:/FinishingCapability_1
from_schema: sudokn-kg
is_a: sudokn_ManufacturingProcessCapability
slots:
- rdfs_label
class_uri: sudokn:FinishingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_FinishingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
