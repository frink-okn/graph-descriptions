...
# Class: TODO -- what's a good name for this class (type)? (sudokn_NAICS332311)
...
URI: [sudokn:NAICS332311](http://asu.edu/semantics/SUDOKN/NAICS332311)
...
```mermaid
 classDiagram
    class SudoknNAICS332311
    click SudoknNAICS332311 href "../SudoknNAICS332311"
      SudoknNAICS332311 : sudokn_hasNAICSCodeValue
        
          
    
    
    SudoknNAICS332311 --> "0..1" Any : sudokn_hasNAICSCodeValue
    click Any href "../Any"

        
      SudoknNAICS332311 : sudokn_hasNAICSTextValue
        
          
    
    
    SudoknNAICS332311 --> "0..1" Any : sudokn_hasNAICSTextValue
    click Any href "../Any"
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasPrimaryNAICSClassifier](../slots/sudokn_hasPrimaryNAICSClassifier.md) | any_of[range] | [SudoknNAICS332311](../classes/SudoknNAICS332311.md) |
...
| ---  | ---  |
| self | sudokn:NAICS332311 |
| native | sudokn-kg/:SudoknNAICS332311 |
