...
# Class: TODO -- what's a good name for this class (type)? (sudokn_MechanicalAssemblyCapability)
...
```mermaid
 classDiagram
    ...
    SudoknMechanicalAssemblyCapability --> "0..1" String : rdfs_label
...
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknMechanicalAssemblyCapability](../classes/SudoknMechanicalAssemblyCapability.md) |
...
| Value |
| --- |
| sudokn:CarverMachineWorks-MechanicalAssembly |
...
| ---  | ---  |
| self | sudokn:MechanicalAssemblyCapability |
| native | sudokn-kg/:SudoknMechanicalAssemblyCapability |
...
examples:
- value: sudokn:CarverMachineWorks-MechanicalAssembly
