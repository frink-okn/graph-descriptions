...
# Class: TODO -- what's a good name for this class (type)? (sudokn_PressBrakingCapability)
...
URI: [sudokn:PressBrakingCapability](http://asu.edu/semantics/SUDOKN/PressBrakingCapability)
...
```mermaid
 classDiagram
    class SudoknPressBrakingCapability
    click SudoknPressBrakingCapability href "../SudoknPressBrakingCapability"
      SudoknPressBrakingCapability : rdfs_label
        
          
    
    
    SudoknPressBrakingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknPressBrakingCapability](../classes/SudoknPressBrakingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknPressBrakingCapability](../classes/SudoknPressBrakingCapability.md) |
...
| Value |
| --- |
| sudokn:BarnesMetalCrafters-PressBraking |
...
| ---  | ---  |
| self | sudokn:PressBrakingCapability |
| native | sudokn-kg/:SudoknPressBrakingCapability |
...
<details>
```yaml
name: sudokn_PressBrakingCapability
...
examples:
- value: sudokn:BarnesMetalCrafters-PressBraking
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:PressBrakingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_PressBrakingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
