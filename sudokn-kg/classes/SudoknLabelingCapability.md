...
# Class: labeling capability (sudokn_LabelingCapability)





URI: [sudokn:LabelingCapability](http://asu.edu/semantics/SUDOKN/LabelingCapability)
...
```mermaid
 classDiagram
    class SudoknLabelingCapability
    click SudoknLabelingCapability href "../SudoknLabelingCapability"
      ...
      SudoknLabelingCapability : rdfs_label
        
          
    
    
    SudoknLabelingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject | [SudoknPackingCapability](../classes/SudoknPackingCapability.md) |  |
...
```yaml
name: sudokn_LabelingCapability
title: labeling capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_PackingCapability
class_uri: sudokn:LabelingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_LabelingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
