...
# Class: TODO -- what's a good name for this class (type)? (sudokn_WaterjetCuttingCapability)
...
```mermaid
 classDiagram
    ...
    SudoknWaterjetCuttingCapability --> "0..1" String : rdfs_label
...
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknWaterjetCuttingCapability](../classes/SudoknWaterjetCuttingCapability.md) |
...
| Value |
| --- |
| sudokn:3DIMENSIONAL-WaterjetCuttingCapability-inst |
...
| ---  | ---  |
| self | sudokn:WaterjetCuttingCapability |
| native | sudokn-kg/:SudoknWaterjetCuttingCapability |
...
- if you think the class is perfect.
notes:
- Class with 373 occurences.
examples:
- value: sudokn:3DIMENSIONAL-WaterjetCuttingCapability-inst
