...
# Class: injection molding capability (sudokn_InjectionMoldingCapability)





URI: [sudokn:InjectionMoldingCapability](http://asu.edu/semantics/SUDOKN/InjectionMoldingCapability)
...
```mermaid
 classDiagram
    class SudoknInjectionMoldingCapability
    click SudoknInjectionMoldingCapability href "../SudoknInjectionMoldingCapability"
      ...
      SudoknInjectionMoldingCapability <|-- SudoknMetalInjectionMoldingCapability
        click SudoknMetalInjectionMoldingCapability href "../SudoknMetalInjectionMoldingCapability"
      SudoknInjectionMoldingCapability <|-- SudoknReactionInjectionMoldingCapability
        click SudoknReactionInjectionMoldingCapability href "../SudoknReactionInjectionMoldingCapability"
      SudoknInjectionMoldingCapability <|-- SudoknRubberInjectionMoldingCapability
        click SudoknRubberInjectionMoldingCapability href "../SudoknRubberInjectionMoldingCapability"
      
      
      SudoknInjectionMoldingCapability : rdfs_label
        
          
    
    
    SudoknInjectionMoldingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
    ...
    * [SudoknManufacturingProcessCapability](../classes/SudoknManufacturingProcessCapability.md)
        * [SudoknMoldingCapability](../classes/SudoknMoldingCapability.md)
            * **SudoknInjectionMoldingCapability**
                * [SudoknMetalInjectionMoldingCapability](../classes/SudoknMetalInjectionMoldingCapability.md)
                * [SudoknReactionInjectionMoldingCapability](../classes/SudoknReactionInjectionMoldingCapability.md)
                * [SudoknRubberInjectionMoldingCapability](../classes/SudoknRubberInjectionMoldingCapability.md)
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject | [SudoknMoldingCapability](../classes/SudoknMoldingCapability.md) |  |
...
```yaml
name: sudokn_InjectionMoldingCapability
title: injection molding capability
from_schema: okns:sudokn-kg
aliases:
- plastic molding capability
rank: 1000
is_a: sudokn_MoldingCapability
class_uri: sudokn:InjectionMoldingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_InjectionMoldingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
