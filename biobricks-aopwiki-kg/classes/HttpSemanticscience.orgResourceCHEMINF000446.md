...
# Class: HttpSemanticscience.orgResourceCHEMINF000446
...
URI: [http://semanticscience.org/resource/CHEMINF_000446](http://semanticscience.org/resource/CHEMINF_000446)
...
```mermaid
 classDiagram
    class HttpSemanticscience.orgResourceCHEMINF000446
    click HttpSemanticscience.orgResourceCHEMINF000446 href "../HttpSemanticscience.orgResourceCHEMINF000446"
      HttpSemanticscience.orgResourceCHEMINF000446 : dc_identifier
        
          
    
    
    HttpSemanticscience.orgResourceCHEMINF000446 --> "0..1" Any : dc_identifier
    click Any href "../Any"

        
      HttpSemanticscience.orgResourceCHEMINF000446 : dc_source
        
          
    
    
    HttpSemanticscience.orgResourceCHEMINF000446 --> "0..1" Any : dc_source
    click Any href "../Any"

        
      HttpSemanticscience.orgResourceCHEMINF000446 : dc_title
        
          
    
    
    HttpSemanticscience.orgResourceCHEMINF000446 --> "0..1" Any : dc_title
    click Any href "../Any"

        
      HttpSemanticscience.orgResourceCHEMINF000446 : dct_alternative
        
          
    
    
    HttpSemanticscience.orgResourceCHEMINF000446 --> "0..1" RdfsLiteral : dct_alternative
    click RdfsLiteral href "../RdfsLiteral"

        
      HttpSemanticscience.orgResourceCHEMINF000446 : dct_isPartOf
        
          
    
    
    HttpSemanticscience.orgResourceCHEMINF000446 --> "0..1" Any : dct_isPartOf
    click Any href "../Any"

        
      HttpSemanticscience.orgResourceCHEMINF000446 : http___semanticscience.org_resource_CHEMINF_000059
        
          
    
    
    HttpSemanticscience.orgResourceCHEMINF000446 --> "0..1" Uri : http___semanticscience.org_resource_CHEMINF_000059
    click Uri href "../Uri"

        
      HttpSemanticscience.orgResourceCHEMINF000446 : http___semanticscience.org_resource_CHEMINF_000446
        
          
    
    
    HttpSemanticscience.orgResourceCHEMINF000446 --> "0..1" String : http___semanticscience.org_resource_CHEMINF_000446
    click String href "../String"

        
      HttpSemanticscience.orgResourceCHEMINF000446 : http___semanticscience.org_resource_CHEMINF_000568
        
          
    
    
    HttpSemanticscience.orgResourceCHEMINF000446 --> "0..1" Uri : http___semanticscience.org_resource_CHEMINF_000568
    click Uri href "../Uri"

        
      HttpSemanticscience.orgResourceCHEMINF000446 : skos_exactMatch
        
          
    
    
    HttpSemanticscience.orgResourceCHEMINF000446 --> "0..1" Any : skos_exactMatch
    click Any href "../Any"
...
| ---  | --- | --- | --- |
| [HttpNcicb.nci.nih.govXmlOwlEVSThesaurus.owl#C54571](../classes/HttpNcicb.nci.nih.govXmlOwlEVSThesaurus.owl#C54571.md) | [http___aopkb.org_aop_ontology#has_chemical_entity](../slots/http___aopkb.org_aop_ontology#has_chemical_entity.md) | any_of[range] | [HttpSemanticscience.orgResourceCHEMINF000446](../classes/HttpSemanticscience.orgResourceCHEMINF000446.md) |
...
- dc_source
- skos_exactMatch
class_uri: http://semanticscience.org/resource/CHEMINF_000446
...
attributes:
  http___semanticscience.org_resource_CHEMINF_000446:
    ...
    owner: http___semanticscience.org_resource_CHEMINF_000446
    domain_of:
