...
# Class: paperboard produt industry (sudokn_PaperboardProductsIndustry)
...
URI: [sudokn:PaperboardProductsIndustry](http://asu.edu/semantics/SUDOKN/PaperboardProductsIndustry)
...
```mermaid
 classDiagram
    class SudoknPaperboardProductsIndustry
    click SudoknPaperboardProductsIndustry href "../SudoknPaperboardProductsIndustry"
      ...
      SudoknPaperboardProductsIndustry : rdfs_label
        
          
    
    
    SudoknPaperboardProductsIndustry --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string) | TODO -- tell the world what this slot (predicate) describes | [SudoknPaperIndustry](../classes/SudoknPaperIndustry.md) |
...
| ---  | ---  |
| self | sudokn:PaperboardProductsIndustry |
| native | sudokn-kg/:SudoknPaperboardProductsIndustry |
...
<details>
```yaml
name: sudokn_PaperboardProductsIndustry
description: TODO -- tell the world what this class (type) describes.
title: paperboard produt industry
todos:
- TODO -- Todos for this class go here
- or you can delete the todos
- if you think the class is perfect.
...
is_a: sudokn_PaperIndustry
class_uri: sudokn:PaperboardProductsIndustry
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_PaperboardProductsIndustry
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
