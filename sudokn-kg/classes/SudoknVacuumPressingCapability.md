...
# Class: vacuum pressing capability (sudokn_VacuumPressingCapability)





URI: [sudokn:VacuumPressingCapability](http://asu.edu/semantics/SUDOKN/VacuumPressingCapability)
...
```mermaid
 classDiagram
    class SudoknVacuumPressingCapability
    click SudoknVacuumPressingCapability href "../SudoknVacuumPressingCapability"
      SudoknThermoformingCapability <|-- SudoknVacuumPressingCapability
        click SudoknThermoformingCapability href "../SudoknThermoformingCapability"
      
      SudoknVacuumPressingCapability : rdfs_label
        
          
    
    
    SudoknVacuumPressingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject | [SudoknFormingCapability](../classes/SudoknFormingCapability.md), [SudoknThermoformingCapability](../classes/SudoknThermoformingCapability.md) |  |
...
```yaml
name: sudokn_VacuumPressingCapability
title: vacuum pressing capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_ThermoformingCapability
class_uri: sudokn:VacuumPressingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_VacuumPressingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
