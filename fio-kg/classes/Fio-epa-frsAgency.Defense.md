...
# Class: Defense (fio-epa-frs_Agency.Defense)
...
URI: [fio-epa-frs:Agency.Defense](http://w3id.org/fio/v1/epa-frs#Agency.Defense)
...
```mermaid
 classDiagram
    class Fio-epa-frsAgency.Defense
    click Fio-epa-frsAgency.Defense href "../Fio-epa-frsAgency.Defense"
      ProvAgent <|-- Fio-epa-frsAgency.Defense
        click ProvAgent href "../ProvAgent"
      
      Fio-epa-frsAgency.Defense : owl_sameAs
        
          
    
    
    Fio-epa-frsAgency.Defense --> "0..1" OwlThing : owl_sameAs
    click OwlThing href "../OwlThing"

        
      Fio-epa-frsAgency.Defense : rdfs_label
        
          
    
    
    Fio-epa-frsAgency.Defense --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject <br/>  | direct | 19 |
| [owl_sameAs](../slots/owl_sameAs.md) | 0..1 <br/> [OwlThing](../classes/OwlThing.md) | The property that determines that two given individuals are equal <br/> No occurrences of this slot in the graph. | direct | 38 |
...
| ---  | --- | --- | --- |
| [Fio-epa-frsEPA-PFAS-Facility](../classes/Fio-epa-frsEPA-PFAS-Facility.md) | [fio_ownedBy](../slots/fio_ownedBy.md) | any_of[range] | [Fio-epa-frsAgency.Defense](../classes/Fio-epa-frsAgency.Defense.md) |
| [Fio-epa-frsFRS-Facility](../classes/Fio-epa-frsFRS-Facility.md) | [fio_ownedBy](../slots/fio_ownedBy.md) | any_of[range] | [Fio-epa-frsAgency.Defense](../classes/Fio-epa-frsAgency.Defense.md) |
...
```yaml
name: fio-epa-frs_Agency.Defense
title: Defense
from_schema: okns:fiokg
exact_mappings:
- http://w3id.org/fio/v1/epa-frs#Agency.Defense
rank: 1000
is_a: prov_Agent
slots:
- rdfs_label
- owl_sameAs
class_uri: fio-epa-frs:Agency.Defense
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: fio-epa-frs_Agency.Defense
    domain_of:
