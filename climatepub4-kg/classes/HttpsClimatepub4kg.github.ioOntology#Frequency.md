...
```mermaid
 classDiagram
    ...
    click HttpsClimatepub4kg.github.ioOntology#Frequency href "../HttpsClimatepub4kg.github.ioOntology#Frequency"
      HttpsClimatepub4kg.github.ioOntology#Frequency : neo4j_name
        
          
    
    
    HttpsClimatepub4kg.github.ioOntology#Frequency --> "0..1" String : neo4j_name
    click String href "../String"

        
      HttpsClimatepub4kg.github.ioOntology#Frequency : neo4j_names
        
          
    
    
    HttpsClimatepub4kg.github.ioOntology#Frequency --> "0..1" String : neo4j_names
    click String href "../String"

        
      HttpsClimatepub4kg.github.ioOntology#Frequency : neo4j_uuid
        
          
    
    
    HttpsClimatepub4kg.github.ioOntology#Frequency --> "0..1" String : neo4j_uuid
    click String href "../String"
