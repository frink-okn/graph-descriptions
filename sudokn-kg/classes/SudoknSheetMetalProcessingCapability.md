...
# Class: No class (type) name specified (sudokn_SheetMetalProcessingCapability)
...
URI: [sudokn:SheetMetalProcessingCapability](http://asu.edu/semantics/SUDOKN/SheetMetalProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknSheetMetalProcessingCapability
    click SudoknSheetMetalProcessingCapability href "../SudoknSheetMetalProcessingCapability"
      ...
      SudoknSheetMetalProcessingCapability <|-- SudoknBendingCapability
        click SudoknBendingCapability href "../SudoknBendingCapability"
      SudoknSheetMetalProcessingCapability <|-- SudoknEmbossingCapability
        click SudoknEmbossingCapability href "../SudoknEmbossingCapability"
      SudoknSheetMetalProcessingCapability <|-- SudoknPunchingCapability
        click SudoknPunchingCapability href "../SudoknPunchingCapability"
      SudoknSheetMetalProcessingCapability <|-- SudoknSheeringCapability
        click SudoknSheeringCapability href "../SudoknSheeringCapability"
      SudoknSheetMetalProcessingCapability <|-- SudoknSpinningCapability
        click SudoknSpinningCapability href "../SudoknSpinningCapability"
      SudoknSheetMetalProcessingCapability <|-- SudoknStampingCapability
        click SudoknStampingCapability href "../SudoknStampingCapability"
      SudoknSheetMetalProcessingCapability <|-- SudoknStretchFormingCapability
        click SudoknStretchFormingCapability href "../SudoknStretchFormingCapability"
      
      
      SudoknSheetMetalProcessingCapability : rdfs_label
        
          
    
    
    SudoknSheetMetalProcessingCapability --> "0..1" String : rdfs_label
...
* [IoscProductionCapability](../classes/IoscProductionCapability.md)
    * [SudoknManufacturingProcessCapability](../classes/SudoknManufacturingProcessCapability.md)
        * **SudoknSheetMetalProcessingCapability**
            * [SudoknBendingCapability](../classes/SudoknBendingCapability.md)
            * [SudoknEmbossingCapability](../classes/SudoknEmbossingCapability.md)
            * [SudoknPunchingCapability](../classes/SudoknPunchingCapability.md)
            * [SudoknSheeringCapability](../classes/SudoknSheeringCapability.md)
            * [SudoknSpinningCapability](../classes/SudoknSpinningCapability.md)
            * [SudoknStampingCapability](../classes/SudoknStampingCapability.md)
            * [SudoknStretchFormingCapability](../classes/SudoknStretchFormingCapability.md)
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string) | No slot (predicate) description specified <br/>  | direct | 28 |
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknSheetMetalProcessingCapability](../classes/SudoknSheetMetalProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknSheetMetalProcessingCapability](../classes/SudoknSheetMetalProcessingCapability.md) |
  ...
  rdfs_label:
    ...
    annotations:
      string:
        tag: string
        value: 28
class_uri: sudokn:SheetMetalProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_SheetMetalProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
    - owl_NamedIndividual
