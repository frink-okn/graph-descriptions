...
# Class: HttpW3id.orgComptoxCompToxChemicalEntity




This class occurs 44 times.


URI: [http://w3id.org/comptox/CompTox_ChemicalEntity](http://w3id.org/comptox/CompTox_ChemicalEntity)
...
```mermaid
 classDiagram
    ...
    click HttpW3id.orgComptoxCompToxChemicalEntity href "../HttpW3id.orgComptoxCompToxChemicalEntity"
      ...
      HttpW3id.orgComptoxCompToxChemicalEntity : owl_sameAs
        
          
    
    
    HttpW3id.orgComptoxCompToxChemicalEntity --> "0..1" OwlThing : owl_sameAs
    click OwlThing href "../OwlThing"

        
      HttpW3id.orgComptoxCompToxChemicalEntity : rdfs_label
        
          
    
    
    HttpW3id.orgComptoxCompToxChemicalEntity --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject <br/>  | direct | 44 |
| [owl_sameAs](../slots/owl_sameAs.md) | 0..1 <br/> [OwlThing](../classes/OwlThing.md) | The property that determines that two given individuals are equal <br/>  | direct | 88 |
...
| ---  | --- | --- | --- |
| [Beb7217b5b32080b9606028314249e33b](../classes/Beb7217b5b32080b9606028314249e33b.md) | [http___w3id.org_comptox_sameAsComptoxSubstance](../slots/http___w3id.org_comptox_sameAsComptoxSubstance.md) | any_of[range] | [HttpW3id.orgComptoxCompToxChemicalEntity](../classes/HttpW3id.orgComptoxCompToxChemicalEntity.md) |
| [HttpW3id.orgSawgraphV1Me-egad#EGAD-PFAS-ParameterName](../classes/HttpW3id.orgSawgraphV1Me-egad#EGAD-PFAS-ParameterName.md) | [http___w3id.org_comptox_sameAsComptoxSubstance](../slots/http___w3id.org_comptox_sameAsComptoxSubstance.md) | any_of[range] | [HttpW3id.orgComptoxCompToxChemicalEntity](../classes/HttpW3id.orgComptoxCompToxChemicalEntity.md) |
...
```yaml
name: http___w3id.org_comptox_CompTox_ChemicalEntity
...
- rdfs_label
- owl_sameAs
class_uri: http://w3id.org/comptox/CompTox_ChemicalEntity
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: http___w3id.org_comptox_CompTox_ChemicalEntity
    domain_of:
