...
# Class: No class (type) name specified (sudokn_PercussionWeldingCapability)
...
URI: [sudokn:PercussionWeldingCapability](http://asu.edu/semantics/SUDOKN/PercussionWeldingCapability)
...
```mermaid
 classDiagram
    class SudoknPercussionWeldingCapability
    click SudoknPercussionWeldingCapability href "../SudoknPercussionWeldingCapability"
      ...
      SudoknPercussionWeldingCapability : rdfs_label
        
          
    
    
    SudoknPercussionWeldingCapability --> "0..1" String : rdfs_label
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_PercussionWeldingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
    - owl_NamedIndividual
