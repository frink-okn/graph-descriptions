...
# Class: TODO -- what's a good name for this class (type)? (sudokn_ITARCompliant)
...
URI: [sudokn:ITARCompliant](http://asu.edu/semantics/SUDOKN/ITARCompliant)
...
```mermaid
 classDiagram
    class SudoknITARCompliant
    click SudoknITARCompliant href "../SudoknITARCompliant"
      SudoknITARCompliant : rdfs_label
        
          
    
    
    SudoknITARCompliant --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasCertificate](../slots/sudokn_hasCertificate.md) | any_of[range] | [SudoknITARCompliant](../classes/SudoknITARCompliant.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasCertificate](../slots/sudokn_hasCertificate.md) | any_of[range] | [SudoknITARCompliant](../classes/SudoknITARCompliant.md) |
...
| Value |
| --- |
| sudokn:Accu-Tool-ITARCompliant |
...
| ---  | ---  |
| self | sudokn:ITARCompliant |
| native | sudokn-kg/:SudoknITARCompliant |
...
examples:
- value: sudokn:Accu-Tool-ITARCompliant
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:ITARCompliant
