...
# Class: No class (type) name specified (sudokn_ISO27001Certificate)
...
```mermaid
 classDiagram
    class SudoknISO27001Certificate
    click SudoknISO27001Certificate href "../SudoknISO27001Certificate"
      ...
      SudoknISO27001Certificate : rdfs_label
        
          
    
    
    SudoknISO27001Certificate --> "0..1" String : rdfs_label
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ISO27001Certificate
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
    - owl_NamedIndividual
