...
# Class: Homeland Security (fio-epa-frs_Agency.HomelandSecurity)
...
URI: [fio-epa-frs:Agency.HomelandSecurity](http://w3id.org/fio/v1/epa-frs#Agency.HomelandSecurity)
...
```mermaid
 classDiagram
    class Fio-epa-frsAgency.HomelandSecurity
    click Fio-epa-frsAgency.HomelandSecurity href "../Fio-epa-frsAgency.HomelandSecurity"
      ProvAgent <|-- Fio-epa-frsAgency.HomelandSecurity
        click ProvAgent href "../ProvAgent"
      
      Fio-epa-frsAgency.HomelandSecurity : owl_sameAs
        
          
    
    
    Fio-epa-frsAgency.HomelandSecurity --> "0..1" OwlThing : owl_sameAs
    click OwlThing href "../OwlThing"

        
      Fio-epa-frsAgency.HomelandSecurity : rdfs_label
        
          
    
    
    Fio-epa-frsAgency.HomelandSecurity --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| [owl_sameAs](../slots/owl_sameAs.md) | 0..1 <br/> [OwlThing](../classes/OwlThing.md) | The property that determines that two given individuals are equal <br/>  | direct | 33 |
...
| ---  | --- | --- | --- |
| [Fio-epa-frsEPA-PFAS-Facility](../classes/Fio-epa-frsEPA-PFAS-Facility.md) | [fio_ownedBy](../slots/fio_ownedBy.md) | any_of[range] | [Fio-epa-frsAgency.HomelandSecurity](../classes/Fio-epa-frsAgency.HomelandSecurity.md) |
| [Fio-epa-frsFRS-Facility](../classes/Fio-epa-frsFRS-Facility.md) | [fio_ownedBy](../slots/fio_ownedBy.md) | any_of[range] | [Fio-epa-frsAgency.HomelandSecurity](../classes/Fio-epa-frsAgency.HomelandSecurity.md) |
...
```yaml
name: fio-epa-frs_Agency.HomelandSecurity
...
- rdfs_label
- owl_sameAs
class_uri: fio-epa-frs:Agency.HomelandSecurity
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: fio-epa-frs_Agency.HomelandSecurity
    domain_of:
    - time_DayOfWeek
    - time_TemporalUnit
