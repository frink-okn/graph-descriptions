...
```mermaid
 classDiagram
    ...
    SudoknMoldingCapability --> "0..1" String : rdfs_label
...
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknMoldingCapability](../classes/SudoknMoldingCapability.md) |
...
| Value |
| --- |
| sudokn:889GLOBALSOLUTIONS-MoldingCapability-inst |
...
| ---  | ---  |
| self | sudokn:MoldingCapability |
| native | sudokn-kg/:SudoknMoldingCapability |
...
- if you think the class is perfect.
notes:
- Class with 644 occurences.
examples:
- value: sudokn:889GLOBALSOLUTIONS-MoldingCapability-inst
