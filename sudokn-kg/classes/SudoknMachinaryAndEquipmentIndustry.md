...
# Class: machinary and equipment industry (sudokn_MachinaryAndEquipmentIndustry)
...
URI: [sudokn:MachinaryAndEquipmentIndustry](http://asu.edu/semantics/SUDOKN/MachinaryAndEquipmentIndustry)
...
```mermaid
 classDiagram
    class SudoknMachinaryAndEquipmentIndustry
    click SudoknMachinaryAndEquipmentIndustry href "../SudoknMachinaryAndEquipmentIndustry"
      ...
      SudoknMachinaryAndEquipmentIndustry : rdfs_label
        
          
    
    
    SudoknMachinaryAndEquipmentIndustry --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknMachinaryAndEquipmentIndustry](../classes/SudoknMachinaryAndEquipmentIndustry.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknMachinaryAndEquipmentIndustry](../classes/SudoknMachinaryAndEquipmentIndustry.md) |
...
| ---  | ---  |
| self | sudokn:MachinaryAndEquipmentIndustry |
| native | sudokn-kg/:SudoknMachinaryAndEquipmentIndustry |
...
<details>
```yaml
name: sudokn_MachinaryAndEquipmentIndustry
description: No type description provided
title: machinary and equipment industry
todos:
- TODO -- Todos for this class go here
- or you can delete the todos
- if you think the class is perfect.
...
slots:
- rdfs_label
class_uri: sudokn:MachinaryAndEquipmentIndustry
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_MachinaryAndEquipmentIndustry
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
