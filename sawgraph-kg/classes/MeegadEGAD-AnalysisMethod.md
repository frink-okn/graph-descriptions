...
# Class: TODO -- what's a good name for this class (type)? (meegad_EGAD-AnalysisMethod)
...
URI: [meegad:EGAD-AnalysisMethod](http://sawgraph.spatialai.org/v1/me-egad#EGAD-AnalysisMethod)
...
| ---  | --- | --- | --- |
| [ContaminosoContaminantObservation](../classes/ContaminosoContaminantObservation.md) | [contaminoso_analysisMethod](../slots/contaminoso_analysisMethod.md) | range | [MeegadEGAD-AnalysisMethod](../classes/MeegadEGAD-AnalysisMethod.md) |
...
| ---  | ---  |
| self | meegad:EGAD-AnalysisMethod |
| native | sawgraph-kg/:MeegadEGAD-AnalysisMethod |
...
<details>
```yaml
name: meegad_EGAD-AnalysisMethod
...
slots:
- rdfs_label
class_uri: meegad:EGAD-AnalysisMethod
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: meegad_EGAD-AnalysisMethod
    domain_of:
