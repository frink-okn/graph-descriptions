...
# Class: TODO -- what's a good name for this class (type)? (sudokn_SewingCapability)
...
URI: [sudokn:SewingCapability](http://asu.edu/semantics/SUDOKN/SewingCapability)
...
```mermaid
 classDiagram
    class SudoknSewingCapability
    click SudoknSewingCapability href "../SudoknSewingCapability"
      SudoknSewingCapability : rdfs_label
        
          
    
    
    SudoknSewingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknSewingCapability](../classes/SudoknSewingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknSewingCapability](../classes/SudoknSewingCapability.md) |
...
| ---  | ---  |
| self | sudokn:SewingCapability |
| native | sudokn-kg/:SudoknSewingCapability |
...
examples:
- value: sudokn:PREMCorp-Sewing
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:SewingCapability
