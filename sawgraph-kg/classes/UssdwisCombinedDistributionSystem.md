...
# Class: TODO -- what's a good name for this class (type)? (ussdwis_CombinedDistributionSystem)
...
URI: [ussdwis:CombinedDistributionSystem](http://sawgraph.spatialai.org/v1/us-sdwis#CombinedDistributionSystem)
...
```mermaid
 classDiagram
    ...
    click UssdwisCombinedDistributionSystem href "../UssdwisCombinedDistributionSystem"
      ...
      UssdwisCombinedDistributionSystem : geo_hasSerialization
        
          
    
    
    UssdwisCombinedDistributionSystem --> "0..1" GeoWktLiteral : geo_hasSerialization
...
| ---  | ---  |
| self | ussdwis:CombinedDistributionSystem |
| native | sawgraph-kg/:UssdwisCombinedDistributionSystem |
...
<details>
```yaml
name: ussdwis_CombinedDistributionSystem
...
- if you think the class is perfect.
notes:
- Class with 52 occurences.
from_schema: sawgraph-kg
rank: 1000
is_a: geo_SpatialObject
class_uri: ussdwis:CombinedDistributionSystem
...
attributes:
  geo_hasSerialization:
    ...
    owner: ussdwis_CombinedDistributionSystem
    domain_of:
    - geo_Geometry
    - geo_SpatialObject
