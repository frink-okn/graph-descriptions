...
# Class: single-point cutting capability (sudokn_SinglePointCuttingCapability)





URI: [sudokn:SinglePointCuttingCapability](http://asu.edu/semantics/SUDOKN/SinglePointCuttingCapability)
...
```mermaid
 classDiagram
    class SudoknSinglePointCuttingCapability
    click SudoknSinglePointCuttingCapability href "../SudoknSinglePointCuttingCapability"
      ...
      SudoknSinglePointCuttingCapability <|-- SudoknDiamondMachiningCapability
        click SudoknDiamondMachiningCapability href "../SudoknDiamondMachiningCapability"
      SudoknSinglePointCuttingCapability <|-- SudoknOilGroovingCapability
        click SudoknOilGroovingCapability href "../SudoknOilGroovingCapability"
      SudoknSinglePointCuttingCapability <|-- SudoknPlaningCapability
        click SudoknPlaningCapability href "../SudoknPlaningCapability"
      SudoknSinglePointCuttingCapability <|-- SudoknShapingCapability
        click SudoknShapingCapability href "../SudoknShapingCapability"
      SudoknSinglePointCuttingCapability <|-- SudoknTurningCapability
        click SudoknTurningCapability href "../SudoknTurningCapability"
      
      
      SudoknSinglePointCuttingCapability : rdfs_label
        
          
    
    
    SudoknSinglePointCuttingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
    ...
    * [SudoknManufacturingProcessCapability](../classes/SudoknManufacturingProcessCapability.md)
        * [SudoknMachiningCapability](../classes/SudoknMachiningCapability.md)
            * **SudoknSinglePointCuttingCapability**
                * [SudoknDiamondMachiningCapability](../classes/SudoknDiamondMachiningCapability.md)
                * [SudoknOilGroovingCapability](../classes/SudoknOilGroovingCapability.md)
                * [SudoknPlaningCapability](../classes/SudoknPlaningCapability.md)
                * [SudoknShapingCapability](../classes/SudoknShapingCapability.md)
...
```yaml
name: sudokn_SinglePointCuttingCapability
title: single-point cutting capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_MachiningCapability
class_uri: sudokn:SinglePointCuttingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_SinglePointCuttingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
