...
# Class: No class (entity type) name specified -- this class is noted as a superclass of another class in this graph but has not itself been defined. (sudokn_VaporizedMetalCoatingCapability)
...
```mermaid
 classDiagram
    ...
    click SudoknVaporizedMetalCoatingCapability href "../SudoknVaporizedMetalCoatingCapability"
      ...
      SudoknVaporizedMetalCoatingCapability <|-- SudoknChemicalVaporDepositionCapability
        click SudoknChemicalVaporDepositionCapability href "../SudoknChemicalVaporDepositionCapability"
    ...
    SudoknVaporizedMetalCoatingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
            ...
            * [SudoknCoatingCapability](../classes/SudoknCoatingCapability.md)
                * [SudoknThermalCoatingCapability](../classes/SudoknThermalCoatingCapability.md)
                    * **SudoknVaporizedMetalCoatingCapability**
                        * [SudoknChemicalVaporDepositionCapability](../classes/SudoknChemicalVaporDepositionCapability.md)
