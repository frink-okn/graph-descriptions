...
# Class: TODO -- what's a good name for this class (type)? (sudokn_CNCCuttingCapability)
...
URI: [sudokn:CNCCuttingCapability](http://asu.edu/semantics/SUDOKN/CNCCuttingCapability)
...
```mermaid
 classDiagram
    class SudoknCNCCuttingCapability
    click SudoknCNCCuttingCapability href "../SudoknCNCCuttingCapability"
      SudoknCNCCuttingCapability : rdfs_label
        
          
    
    
    SudoknCNCCuttingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCNCCuttingCapability](../classes/SudoknCNCCuttingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCNCCuttingCapability](../classes/SudoknCNCCuttingCapability.md) |
...
| ---  | ---  |
| self | sudokn:CNCCuttingCapability |
| native | sudokn-kg/:SudoknCNCCuttingCapability |
...
<details>
```yaml
name: sudokn_CNCCuttingCapability
...
examples:
- value: sudokn:PREMCorp-CNCCutting
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:CNCCuttingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_CNCCuttingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
