...
# Class: TODO -- what's a good name for this class (type)? (sudokn_PolycrystallineDiamondMachiningCapability)
...
URI: [sudokn:PolycrystallineDiamondMachiningCapability](http://asu.edu/semantics/SUDOKN/PolycrystallineDiamondMachiningCapability)
...
```mermaid
 classDiagram
    class SudoknPolycrystallineDiamondMachiningCapability
    click SudoknPolycrystallineDiamondMachiningCapability href "../SudoknPolycrystallineDiamondMachiningCapability"
      SudoknPolycrystallineDiamondMachiningCapability : rdfs_label
        
          
    
    
    SudoknPolycrystallineDiamondMachiningCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknPolycrystallineDiamondMachiningCapability](../classes/SudoknPolycrystallineDiamondMachiningCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknPolycrystallineDiamondMachiningCapability](../classes/SudoknPolycrystallineDiamondMachiningCapability.md) |
...
| Value |
| --- |
| sudokn:AAE-MFG-PolycrystallineDiamondMachiningCapability-inst |
...
| ---  | ---  |
| self | sudokn:PolycrystallineDiamondMachiningCapability |
| native | sudokn-kg/:SudoknPolycrystallineDiamondMachiningCapability |
...
<details>
```yaml
name: sudokn_PolycrystallineDiamondMachiningCapability
...
- if you think the class is perfect.
notes:
- Class with 70 occurences.
examples:
- value: sudokn:AAE-MFG-PolycrystallineDiamondMachiningCapability-inst
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:PolycrystallineDiamondMachiningCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_PolycrystallineDiamondMachiningCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
