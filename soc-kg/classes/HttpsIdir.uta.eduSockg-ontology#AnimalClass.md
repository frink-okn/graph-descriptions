...
# Class: HttpsIdir.uta.eduSockg-ontology#AnimalClass
...
URI: [https://idir.uta.edu/sockg-ontology#AnimalClass](https://idir.uta.edu/sockg-ontology#AnimalClass)
...
```mermaid
 classDiagram
    ...
    click HttpsIdir.uta.eduSockg-ontology#AnimalClass href "../HttpsIdir.uta.eduSockg-ontology#AnimalClass"
      HttpsIdir.uta.eduSockg-ontology#AnimalClass : rdfs_label
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#AnimalClass --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: https___idir.uta.edu_sockg-ontology#AnimalClass
from_schema: okns:soc-kg
rank: 1000
slots:
- rdfs_label
class_uri: https://idir.uta.edu/sockg-ontology#AnimalClass
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: https___idir.uta.edu_sockg-ontology#AnimalClass
    domain_of:
