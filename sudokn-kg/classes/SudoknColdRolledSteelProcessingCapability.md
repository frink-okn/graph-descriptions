...
# Class: cold rolled steel processing capability (sudokn_ColdRolledSteelProcessingCapability)
...
URI: [sudokn:ColdRolledSteelProcessingCapability](http://asu.edu/semantics/SUDOKN/ColdRolledSteelProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknColdRolledSteelProcessingCapability
    click SudoknColdRolledSteelProcessingCapability href "../SudoknColdRolledSteelProcessingCapability"
      ...
      SudoknColdRolledSteelProcessingCapability : rdfs_label
        
          
    
    
    SudoknColdRolledSteelProcessingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknColdRolledSteelProcessingCapability](../classes/SudoknColdRolledSteelProcessingCapability.md) |
...
```yaml
name: sudokn_ColdRolledSteelProcessingCapability
title: cold rolled steel processing capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_SteelProcessingCapability
slots:
- rdfs_label
class_uri: sudokn:ColdRolledSteelProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ColdRolledSteelProcessingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
