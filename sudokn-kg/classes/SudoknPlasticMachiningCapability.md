...
# Class: TODO -- what's a good name for this class (type)? (sudokn_PlasticMachiningCapability)
...
URI: [sudokn:PlasticMachiningCapability](http://asu.edu/semantics/SUDOKN/PlasticMachiningCapability)
...
```mermaid
 classDiagram
    class SudoknPlasticMachiningCapability
    click SudoknPlasticMachiningCapability href "../SudoknPlasticMachiningCapability"
      SudoknPlasticMachiningCapability : rdfs_label
        
          
    
    
    SudoknPlasticMachiningCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknPlasticMachiningCapability](../classes/SudoknPlasticMachiningCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknPlasticMachiningCapability](../classes/SudoknPlasticMachiningCapability.md) |
...
| Value |
| --- |
| sudokn:WestSideIndustries-PlasticMachining |
...
| ---  | ---  |
| self | sudokn:PlasticMachiningCapability |
| native | sudokn-kg/:SudoknPlasticMachiningCapability |
...
<details>
```yaml
name: sudokn_PlasticMachiningCapability
...
examples:
- value: sudokn:WestSideIndustries-PlasticMachining
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:PlasticMachiningCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_PlasticMachiningCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
