...
# Class: TODO -- what's a good name for this class (type)? (sudokn_MetalProductionIndustry)
...
URI: [sudokn:MetalProductionIndustry](http://asu.edu/semantics/SUDOKN/MetalProductionIndustry)
...
```mermaid
 classDiagram
    class SudoknMetalProductionIndustry
    click SudoknMetalProductionIndustry href "../SudoknMetalProductionIndustry"
      SudoknMetalProductionIndustry : rdfs_label
        
          
    
    
    SudoknMetalProductionIndustry --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknMetalProductionIndustry](../classes/SudoknMetalProductionIndustry.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknMetalProductionIndustry](../classes/SudoknMetalProductionIndustry.md) |
...
| Value |
| --- |
| sudokn:metalproductionindustry-inst |
...
| ---  | ---  |
| self | sudokn:MetalProductionIndustry |
| native | sudokn-kg/:SudoknMetalProductionIndustry |
...
<details>
```yaml
name: sudokn_MetalProductionIndustry
...
examples:
- value: sudokn:metalproductionindustry-inst
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:MetalProductionIndustry
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_MetalProductionIndustry
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
