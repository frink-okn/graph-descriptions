...
# Class: brass processing capability (sudokn_BrassProcessingCapability)
...
URI: [sudokn:BrassProcessingCapability](http://asu.edu/semantics/SUDOKN/BrassProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknBrassProcessingCapability
    click SudoknBrassProcessingCapability href "../SudoknBrassProcessingCapability"
      ...
      SudoknBrassProcessingCapability : rdfs_label
        
          
    
    
    SudoknBrassProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknBrassProcessingCapability](../classes/SudoknBrassProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknBrassProcessingCapability](../classes/SudoknBrassProcessingCapability.md) |
...
| ---  | ---  |
| self | sudokn:BrassProcessingCapability |
| native | sudokn-kg/:SudoknBrassProcessingCapability |
...
<details>
```yaml
name: sudokn_BrassProcessingCapability
description: No type description provided
title: brass processing capability
todos:
- TODO -- Todos for this class go here
- or you can delete the todos
- if you think the class is perfect.
notes:
- Class with 2596 occurences.
examples:
- value: sudokn:3ERP-Brass-inst
from_schema: sudokn-kg
rank: 1000
is_a: sudokn_MetalProcessingCapability
slots:
- rdfs_label
class_uri: sudokn:BrassProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_BrassProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
