...
# Class: No class (type) name specified (sudokn_SeamWeldingCapability)
...
URI: [sudokn:SeamWeldingCapability](http://asu.edu/semantics/SUDOKN/SeamWeldingCapability)
...
```mermaid
 classDiagram
    class SudoknSeamWeldingCapability
    click SudoknSeamWeldingCapability href "../SudoknSeamWeldingCapability"
      ...
      SudoknSeamWeldingCapability : rdfs_label
        
          
    
    
    SudoknSeamWeldingCapability --> "0..1" String : rdfs_label
...
```yaml
name: sudokn_SeamWeldingCapability
...
class_uri: sudokn:SeamWeldingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_SeamWeldingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
    - owl_NamedIndividual
