...
# Class: TODO -- what's a good name for this class (type)? (sudokn_ShieldedMetalArcWeldingCapability)
...
| ---  | ---  |
| self | sudokn:ShieldedMetalArcWeldingCapability |
| native | sudokn-kg/:SudoknShieldedMetalArcWeldingCapability |
