...
# Class: zinc alloy processing capability (sudokn_ZincAlloyProcessingCapability)
...
URI: [sudokn:ZincAlloyProcessingCapability](http://asu.edu/semantics/SUDOKN/ZincAlloyProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknZincAlloyProcessingCapability
    click SudoknZincAlloyProcessingCapability href "../SudoknZincAlloyProcessingCapability"
      ...
      SudoknZincAlloyProcessingCapability : rdfs_label
        
          
    
    
    SudoknZincAlloyProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknZincAlloyProcessingCapability](../classes/SudoknZincAlloyProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknZincAlloyProcessingCapability](../classes/SudoknZincAlloyProcessingCapability.md) |
...
| Value |
| --- |
| sudokn:ABC-ALUMINUM-ZincAlloy-inst |
...
| ---  | ---  |
| self | sudokn:ZincAlloyProcessingCapability |
| native | sudokn-kg/:SudoknZincAlloyProcessingCapability |
...
<details>
```yaml
name: sudokn_ZincAlloyProcessingCapability
description: No type description provided
title: zinc alloy processing capability
todos:
- TODO -- Todos for this class go here
- or you can delete the todos
- if you think the class is perfect.
notes:
- Class with 80 occurences.
examples:
- value: sudokn:ABC-ALUMINUM-ZincAlloy-inst
from_schema: sudokn-kg
rank: 1000
is_a: sudokn_MetalProcessingCapability
slots:
- rdfs_label
class_uri: sudokn:ZincAlloyProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ZincAlloyProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
