...
# Class: TODO -- what's a good name for this class (type)? (sudokn_FurnaceBrazingCapability)
...
URI: [sudokn:FurnaceBrazingCapability](http://asu.edu/semantics/SUDOKN/FurnaceBrazingCapability)
...
```mermaid
 classDiagram
    class SudoknFurnaceBrazingCapability
    click SudoknFurnaceBrazingCapability href "../SudoknFurnaceBrazingCapability"
      ...
      SudoknFurnaceBrazingCapability : rdfs_label
        
          
    
    
    SudoknFurnaceBrazingCapability --> "0..1" String : rdfs_label
...
| ---  | ---  |
| self | sudokn:FurnaceBrazingCapability |
| native | sudokn-kg/:SudoknFurnaceBrazingCapability |
...
<details>
```yaml
name: sudokn_FurnaceBrazingCapability
...
class_uri: sudokn:FurnaceBrazingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_FurnaceBrazingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
