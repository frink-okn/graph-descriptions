...
# Class: photochemical machining capability (sudokn_PhotochemicalMachiningProcess)





URI: [sudokn:PhotochemicalMachiningProcess](http://asu.edu/semantics/SUDOKN/PhotochemicalMachiningProcess)
...
```mermaid
 classDiagram
    class SudoknPhotochemicalMachiningProcess
    click SudoknPhotochemicalMachiningProcess href "../SudoknPhotochemicalMachiningProcess"
      ...
      SudoknPhotochemicalMachiningProcess : rdfs_label
        
          
    
    
    SudoknPhotochemicalMachiningProcess --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: sudokn_PhotochemicalMachiningProcess
title: photochemical machining capability
from_schema: okns:sudokn-kg
aliases:
- chemical milling
rank: 1000
is_a: sudokn_ChemicalMachiningCapability
class_uri: sudokn:PhotochemicalMachiningProcess
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_PhotochemicalMachiningProcess
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
