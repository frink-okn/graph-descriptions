...
# Class: TODO -- what's a good name for this class (type)? (sudokn_MetalFabricationCapability)
...
URI: [sudokn:MetalFabricationCapability](http://asu.edu/semantics/SUDOKN/MetalFabricationCapability)
...
```mermaid
 classDiagram
    class SudoknMetalFabricationCapability
    click SudoknMetalFabricationCapability href "../SudoknMetalFabricationCapability"
      SudoknMetalFabricationCapability : rdfs_label
        
          
    
    
    SudoknMetalFabricationCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknMetalFabricationCapability](../classes/SudoknMetalFabricationCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknMetalFabricationCapability](../classes/SudoknMetalFabricationCapability.md) |
...
| Value |
| --- |
| sudokn:BroadsightSystems-MetalFabrication |
...
| ---  | ---  |
| self | sudokn:MetalFabricationCapability |
| native | sudokn-kg/:SudoknMetalFabricationCapability |
...
<details>
```yaml
name: sudokn_MetalFabricationCapability
...
examples:
- value: sudokn:BroadsightSystems-MetalFabrication
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:MetalFabricationCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_MetalFabricationCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
