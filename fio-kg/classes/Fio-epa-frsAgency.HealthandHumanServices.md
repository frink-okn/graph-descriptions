...
# Class: Health and Human Services (fio-epa-frs_Agency.HealthandHumanServices)
...
URI: [fio-epa-frs:Agency.HealthandHumanServices](http://w3id.org/fio/v1/epa-frs#Agency.HealthandHumanServices)
...
```mermaid
 classDiagram
    class Fio-epa-frsAgency.HealthandHumanServices
    click Fio-epa-frsAgency.HealthandHumanServices href "../Fio-epa-frsAgency.HealthandHumanServices"
      ProvAgent <|-- Fio-epa-frsAgency.HealthandHumanServices
        click ProvAgent href "../ProvAgent"
      
      Fio-epa-frsAgency.HealthandHumanServices : owl_sameAs
        
          
    
    
    Fio-epa-frsAgency.HealthandHumanServices --> "0..1" OwlThing : owl_sameAs
    click OwlThing href "../OwlThing"

        
      Fio-epa-frsAgency.HealthandHumanServices : rdfs_label
        
          
    
    
    Fio-epa-frsAgency.HealthandHumanServices --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- |
| [Fio-epa-frsEPA-PFAS-Facility](../classes/Fio-epa-frsEPA-PFAS-Facility.md) | [fio_ownedBy](../slots/fio_ownedBy.md) | any_of[range] | [Fio-epa-frsAgency.HealthandHumanServices](../classes/Fio-epa-frsAgency.HealthandHumanServices.md) |
| [Fio-epa-frsFRS-Facility](../classes/Fio-epa-frsFRS-Facility.md) | [fio_ownedBy](../slots/fio_ownedBy.md) | any_of[range] | [Fio-epa-frsAgency.HealthandHumanServices](../classes/Fio-epa-frsAgency.HealthandHumanServices.md) |
...
```yaml
name: fio-epa-frs_Agency.HealthandHumanServices
title: Health and Human Services
from_schema: okns:fio-kg
exact_mappings:
- http://w3id.org/fio/v1/epa-frs#Agency.HealthandHumanServices
rank: 1000
is_a: prov_Agent
slots:
- rdfs_label
- owl_sameAs
class_uri: fio-epa-frs:Agency.HealthandHumanServices
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: fio-epa-frs_Agency.HealthandHumanServices
    domain_of:
