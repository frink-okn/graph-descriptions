...
# Class: HttpsIdir.uta.eduSockg-ontology#SimulationModel
...
URI: [https://idir.uta.edu/sockg-ontology#SimulationModel](https://idir.uta.edu/sockg-ontology#SimulationModel)
...
```mermaid
 classDiagram
    ...
    click HttpsIdir.uta.eduSockg-ontology#SimulationModel href "../HttpsIdir.uta.eduSockg-ontology#SimulationModel"
      HttpsIdir.uta.eduSockg-ontology#SimulationModel : rdfs_label
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#SimulationModel --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: https___idir.uta.edu_sockg-ontology#SimulationModel
from_schema: okns:soc-kg
rank: 1000
slots:
- rdfs_label
class_uri: https://idir.uta.edu/sockg-ontology#SimulationModel
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: https___idir.uta.edu_sockg-ontology#SimulationModel
    domain_of:
    - qudt_AspectClass
    - qudt_BinaryPrefix
