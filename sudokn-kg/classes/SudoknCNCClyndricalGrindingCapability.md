...
# Class: TODO -- what's a good name for this class (type)? (sudokn_CNCClyndricalGrindingCapability)
...
| ---  | ---  |
| self | sudokn:CNCClyndricalGrindingCapability |
| native | sudokn-kg/:SudoknCNCClyndricalGrindingCapability |
