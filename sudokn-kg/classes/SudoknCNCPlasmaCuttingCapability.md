...
# Class: TODO -- what's a good name for this class (type)? (sudokn_CNCPlasmaCuttingCapability)
...
URI: [sudokn:CNCPlasmaCuttingCapability](http://asu.edu/semantics/SUDOKN/CNCPlasmaCuttingCapability)
...
```mermaid
 classDiagram
    class SudoknCNCPlasmaCuttingCapability
    click SudoknCNCPlasmaCuttingCapability href "../SudoknCNCPlasmaCuttingCapability"
      SudoknCNCPlasmaCuttingCapability : rdfs_label
        
          
    
    
    SudoknCNCPlasmaCuttingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCNCPlasmaCuttingCapability](../classes/SudoknCNCPlasmaCuttingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCNCPlasmaCuttingCapability](../classes/SudoknCNCPlasmaCuttingCapability.md) |
...
| Value |
| --- |
| sudokn:CovingtonIronWorks-CNCPlasmaCutting |
...
| ---  | ---  |
| self | sudokn:CNCPlasmaCuttingCapability |
| native | sudokn-kg/:SudoknCNCPlasmaCuttingCapability |
...
<details>
```yaml
name: sudokn_CNCPlasmaCuttingCapability
...
examples:
- value: sudokn:CovingtonIronWorks-CNCPlasmaCutting
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:CNCPlasmaCuttingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_CNCPlasmaCuttingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
