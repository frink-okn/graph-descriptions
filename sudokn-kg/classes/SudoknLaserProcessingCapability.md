...
# Class: TODO -- what's a good name for this class (type)? (sudokn_LaserProcessingCapability)
...
URI: [sudokn:LaserProcessingCapability](http://asu.edu/semantics/SUDOKN/LaserProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknLaserProcessingCapability
    click SudoknLaserProcessingCapability href "../SudoknLaserProcessingCapability"
      SudoknLaserProcessingCapability : rdfs_label
        
          
    
    
    SudoknLaserProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknLaserProcessingCapability](../classes/SudoknLaserProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknLaserProcessingCapability](../classes/SudoknLaserProcessingCapability.md) |
...
| Value |
| --- |
| sudokn:ALCOMETALFABRICATORS-LaserProcessing |
...
| ---  | ---  |
| self | sudokn:LaserProcessingCapability |
| native | sudokn-kg/:SudoknLaserProcessingCapability |
...
<details>
```yaml
name: sudokn_LaserProcessingCapability
...
examples:
- value: sudokn:ALCOMETALFABRICATORS-LaserProcessing
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:LaserProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_LaserProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
