...
```mermaid
 classDiagram
    ...
    click MeEgadEGAD-MethodDetectionLimit href "../MeEgadEGAD-MethodDetectionLimit"
      ...
      MeEgadEGAD-MethodDetectionLimit : owl_sameAs
        
          
    
    
    MeEgadEGAD-MethodDetectionLimit --> "0..1" OwlThing : owl_sameAs
    click OwlThing href "../OwlThing"

        
      MeEgadEGAD-MethodDetectionLimit : qudt_hasUnit
        
          
    
    
    MeEgadEGAD-MethodDetectionLimit --> "0..1" Any : qudt_hasUnit
    click Any href "../Any"

        
      MeEgadEGAD-MethodDetectionLimit : qudt_numericValue
        
          
    
    
    MeEgadEGAD-MethodDetectionLimit --> "0..1" QudtNumericUnion : qudt_numericValue
...
| ---  | --- | --- | --- |
| [HttpW3id.orgSawgraphV1Me-egad#EGAD-AggregatePFAS-Concentration](../classes/HttpW3id.orgSawgraphV1Me-egad#EGAD-AggregatePFAS-Concentration.md) | [coso_resultAnnotation](../slots/coso_resultAnnotation.md) | any_of[range] | [MeEgadEGAD-MethodDetectionLimit](../classes/MeEgadEGAD-MethodDetectionLimit.md) |
| [HttpW3id.orgSawgraphV1Me-egad#EGAD-SinglePFAS-Concentration](../classes/HttpW3id.orgSawgraphV1Me-egad#EGAD-SinglePFAS-Concentration.md) | [coso_resultAnnotation](../slots/coso_resultAnnotation.md) | any_of[range] | [MeEgadEGAD-MethodDetectionLimit](../classes/MeEgadEGAD-MethodDetectionLimit.md) |
| [MeEgadEGAD-AggregatePFAS-Concentration](../classes/MeEgadEGAD-AggregatePFAS-Concentration.md) | [coso_resultAnnotation](../slots/coso_resultAnnotation.md) | any_of[range] | [MeEgadEGAD-MethodDetectionLimit](../classes/MeEgadEGAD-MethodDetectionLimit.md) |
...
| [MeEgadEGAD-SinglePFAS-Concentration](../classes/MeEgadEGAD-SinglePFAS-Concentration.md) | [coso_resultAnnotation](../slots/coso_resultAnnotation.md) | any_of[range] | [MeEgadEGAD-MethodDetectionLimit](../classes/MeEgadEGAD-MethodDetectionLimit.md) |
...
attributes:
  qudt_hasUnit:
    ...
    alias: qudt_hasUnit
    owner: me_egad_EGAD-MethodDetectionLimit
    domain_of:
