...
# Class: curvic grinding capability (sudokn_CurvicGrindingCapability)





URI: [sudokn:CurvicGrindingCapability](http://asu.edu/semantics/SUDOKN/CurvicGrindingCapability)
...
```mermaid
 classDiagram
    class SudoknCurvicGrindingCapability
    click SudoknCurvicGrindingCapability href "../SudoknCurvicGrindingCapability"
      ...
      SudoknCurvicGrindingCapability : rdfs_label
        
          
    
    
    SudoknCurvicGrindingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: sudokn_CurvicGrindingCapability
title: curvic grinding capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_GrindingCapability
class_uri: sudokn:CurvicGrindingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_CurvicGrindingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
