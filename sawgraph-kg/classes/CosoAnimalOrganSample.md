...
# Class: Animal Organ Sample (coso_AnimalOrganSample)




This class occurs 82 times.


URI: [coso:AnimalOrganSample](http://w3id.org/coso/v1/contaminoso#AnimalOrganSample)
...
```mermaid
 classDiagram
    class CosoAnimalOrganSample
    click CosoAnimalOrganSample href "../CosoAnimalOrganSample"
      SosaSample <|-- CosoAnimalOrganSample
        click SosaSample href "../SosaSample"
      
      CosoAnimalOrganSample : coso_fromSamplePoint
        
          
    
    
    CosoAnimalOrganSample --> "0..1" Any : coso_fromSamplePoint
    click Any href "../Any"

        
      CosoAnimalOrganSample : coso_isSampleOf
        
          
    
    
    CosoAnimalOrganSample --> "0..1" Any : coso_isSampleOf
    click Any href "../Any"

        
      CosoAnimalOrganSample : coso_sampleAnnotation
        
          
    
    
    CosoAnimalOrganSample --> "0..1" Any : coso_sampleAnnotation
    click Any href "../Any"

        
      CosoAnimalOrganSample : coso_sampleOfMaterialType
        
          
    
    
    CosoAnimalOrganSample --> "0..1" Any : coso_sampleOfMaterialType
    click Any href "../Any"

        
      CosoAnimalOrganSample : dct_identifier
        
          
    
    
    CosoAnimalOrganSample --> "0..1" RdfsLiteral : dct_identifier
    click RdfsLiteral href "../RdfsLiteral"

        
      CosoAnimalOrganSample : http___w3id.org_sawgraph_v1_me_egad#sampleCollectionLocation
        
          
    
    
    CosoAnimalOrganSample --> "0..1" Any : http___w3id.org_sawgraph_v1_me_egad#sampleCollectionLocation
    click Any href "../Any"

        
      CosoAnimalOrganSample : http___w3id.org_sawgraph_v1_me_egad#sampleCollectionMethod
        
          
    
    
    CosoAnimalOrganSample --> "0..1" Any : http___w3id.org_sawgraph_v1_me_egad#sampleCollectionMethod
    click Any href "../Any"

        
      CosoAnimalOrganSample : owl_sameAs
        
          
    
    
    CosoAnimalOrganSample --> "0..1" OwlThing : owl_sameAs
    click OwlThing href "../OwlThing"

        
      CosoAnimalOrganSample : prov_wasAttributedTo
        
          
    
    
    CosoAnimalOrganSample --> "0..1" ProvAgent : prov_wasAttributedTo
    click ProvAgent href "../ProvAgent"

        
      CosoAnimalOrganSample : rdfs_label
        
          
    
    
    CosoAnimalOrganSample --> "0..1" Any : rdfs_label
    click Any href "../Any"

        
      CosoAnimalOrganSample : sosa_isSampleOf
        
          
    
    
    CosoAnimalOrganSample --> "0..1" HttpW3id.orgSawgraphV1Me-egad#EGAD-SampledFeature : sosa_isSampleOf
...
| ---  | --- | --- | --- |
| [HttpW3id.orgSawgraphV1Me-egad#EGAD-PFAS-Observation](../classes/HttpW3id.orgSawgraphV1Me-egad#EGAD-PFAS-Observation.md) | [coso_analyzedSample](../slots/coso_analyzedSample.md) | any_of[range] | [CosoAnimalOrganSample](../classes/CosoAnimalOrganSample.md) |
| [HttpW3id.orgSawgraphV1Me-egad#EGAD-PFAS-Observation](../classes/HttpW3id.orgSawgraphV1Me-egad#EGAD-PFAS-Observation.md) | [coso_hasAnyFeatureOfInterest](../slots/coso_hasAnyFeatureOfInterest.md) | any_of[range] | [CosoAnimalOrganSample](../classes/CosoAnimalOrganSample.md) |
| [HttpW3id.orgSawgraphV1Us-wqp#Observation](../classes/HttpW3id.orgSawgraphV1Us-wqp#Observation.md) | [coso_analyzedSample](../slots/coso_analyzedSample.md) | any_of[range] | [CosoAnimalOrganSample](../classes/CosoAnimalOrganSample.md) |
| [MeEgadEGAD-PFAS-Observation](../classes/MeEgadEGAD-PFAS-Observation.md) | [coso_analyzedSample](../slots/coso_analyzedSample.md) | any_of[range] | [CosoAnimalOrganSample](../classes/CosoAnimalOrganSample.md) |
| [MeEgadEGAD-PFAS-Observation](../classes/MeEgadEGAD-PFAS-Observation.md) | [coso_hasAnyFeatureOfInterest](../slots/coso_hasAnyFeatureOfInterest.md) | any_of[range] | [CosoAnimalOrganSample](../classes/CosoAnimalOrganSample.md) |
...
```yaml
name: coso_AnimalOrganSample
title: Animal Organ Sample
...
- coso_fromSamplePoint
class_uri: coso:AnimalOrganSample
