...
# Class: TODO -- what's a good name for this class (type)? (sudokn_BeltSandingCapability)
...
URI: [sudokn:BeltSandingCapability](http://asu.edu/semantics/SUDOKN/BeltSandingCapability)
...
```mermaid
 classDiagram
    class SudoknBeltSandingCapability
    click SudoknBeltSandingCapability href "../SudoknBeltSandingCapability"
      ...
      SudoknBeltSandingCapability : rdfs_label
        
          
    
    
    SudoknBeltSandingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string) | TODO -- tell the world what this slot (predicate) describes | [SudoknFinishingCapability](../classes/SudoknFinishingCapability.md), [SudoknSurfacePreparationCapability](../classes/SudoknSurfacePreparationCapability.md) |
...
| ---  | ---  |
| self | sudokn:BeltSandingCapability |
| native | sudokn-kg/:SudoknBeltSandingCapability |
...
<details>
```yaml
name: sudokn_BeltSandingCapability
...
class_uri: sudokn:BeltSandingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_BeltSandingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
