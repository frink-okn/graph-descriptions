...
# Class: TODO -- what's a good name for this class (type)? (sudokn_WaspaloyProcessingCapability)
...
URI: [sudokn:WaspaloyProcessingCapability](http://asu.edu/semantics/SUDOKN/WaspaloyProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknWaspaloyProcessingCapability
    click SudoknWaspaloyProcessingCapability href "../SudoknWaspaloyProcessingCapability"
      SudoknWaspaloyProcessingCapability : rdfs_label
        
          
    
    
    SudoknWaspaloyProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknWaspaloyProcessingCapability](../classes/SudoknWaspaloyProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknWaspaloyProcessingCapability](../classes/SudoknWaspaloyProcessingCapability.md) |
...
| Value |
| --- |
| sudokn:A1MACHINING-Waspaloy-inst |
...
| ---  | ---  |
| self | sudokn:WaspaloyProcessingCapability |
| native | sudokn-kg/:SudoknWaspaloyProcessingCapability |
...
<details>
```yaml
name: sudokn_WaspaloyProcessingCapability
...
- if you think the class is perfect.
notes:
- Class with 66 occurences.
examples:
- value: sudokn:A1MACHINING-Waspaloy-inst
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:WaspaloyProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_WaspaloyProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
