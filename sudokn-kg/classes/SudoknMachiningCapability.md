...
# Class: machining capability (sudokn_MachiningCapability)




This class occurs 3494 times.


URI: [sudokn:MachiningCapability](http://asu.edu/semantics/SUDOKN/MachiningCapability)
...
```mermaid
 classDiagram
    class SudoknMachiningCapability
    click SudoknMachiningCapability href "../SudoknMachiningCapability"
      ...
      SudoknMachiningCapability <|-- SudoknAbrassiveMachiningCapability
        click SudoknAbrassiveMachiningCapability href "../SudoknAbrassiveMachiningCapability"
      SudoknMachiningCapability <|-- SudoknCNCMachiningCapability
        click SudoknCNCMachiningCapability href "../SudoknCNCMachiningCapability"
      SudoknMachiningCapability <|-- SudoknChemicalMachiningCapability
        click SudoknChemicalMachiningCapability href "../SudoknChemicalMachiningCapability"
      SudoknMachiningCapability <|-- SudoknDeburringCapability
        click SudoknDeburringCapability href "../SudoknDeburringCapability"
      SudoknMachiningCapability <|-- SudoknEngravingCapability
        click SudoknEngravingCapability href "../SudoknEngravingCapability"
      SudoknMachiningCapability <|-- SudoknErosionMachiningCapability
        click SudoknErosionMachiningCapability href "../SudoknErosionMachiningCapability"
      SudoknMachiningCapability <|-- SudoknMultiPointCuttingCapability
        click SudoknMultiPointCuttingCapability href "../SudoknMultiPointCuttingCapability"
      SudoknMachiningCapability <|-- SudoknPlasticMachiningCapability
        click SudoknPlasticMachiningCapability href "../SudoknPlasticMachiningCapability"
      SudoknMachiningCapability <|-- SudoknPolycrystallineDiamondMachiningCapability
        click SudoknPolycrystallineDiamondMachiningCapability href "../SudoknPolycrystallineDiamondMachiningCapability"
      SudoknMachiningCapability <|-- SudoknSinglePointCuttingCapability
        click SudoknSinglePointCuttingCapability href "../SudoknSinglePointCuttingCapability"
      SudoknMachiningCapability <|-- SudoknSwissMachiningCapability
        click SudoknSwissMachiningCapability href "../SudoknSwissMachiningCapability"
      SudoknMachiningCapability <|-- SudoknThermalSubtractionCapability
        click SudoknThermalSubtractionCapability href "../SudoknThermalSubtractionCapability"
      SudoknMachiningCapability <|-- SudoknThreadingCapability
        click SudoknThreadingCapability href "../SudoknThreadingCapability"
      SudoknMachiningCapability <|-- SudoknZeroStockMachiningCapability
        click SudoknZeroStockMachiningCapability href "../SudoknZeroStockMachiningCapability"
      
      
      SudoknMachiningCapability : rdfs_label
        
          
    
    
    SudoknMachiningCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
* [IoscProductionCapability](../classes/IoscProductionCapability.md)
    * [SudoknManufacturingProcessCapability](../classes/SudoknManufacturingProcessCapability.md)
        * **SudoknMachiningCapability**
            * [SudoknAbrassiveMachiningCapability](../classes/SudoknAbrassiveMachiningCapability.md)
            * [SudoknCNCMachiningCapability](../classes/SudoknCNCMachiningCapability.md)
            * [SudoknChemicalMachiningCapability](../classes/SudoknChemicalMachiningCapability.md)
            * [SudoknDeburringCapability](../classes/SudoknDeburringCapability.md)
            * [SudoknEngravingCapability](../classes/SudoknEngravingCapability.md)
            * [SudoknErosionMachiningCapability](../classes/SudoknErosionMachiningCapability.md)
            * [SudoknMultiPointCuttingCapability](../classes/SudoknMultiPointCuttingCapability.md)
            * [SudoknPlasticMachiningCapability](../classes/SudoknPlasticMachiningCapability.md)
            * [SudoknPolycrystallineDiamondMachiningCapability](../classes/SudoknPolycrystallineDiamondMachiningCapability.md)
            * [SudoknSinglePointCuttingCapability](../classes/SudoknSinglePointCuttingCapability.md)
            * [SudoknSwissMachiningCapability](../classes/SudoknSwissMachiningCapability.md)
            * [SudoknThermalSubtractionCapability](../classes/SudoknThermalSubtractionCapability.md)
            * [SudoknThreadingCapability](../classes/SudoknThreadingCapability.md)
            * [SudoknZeroStockMachiningCapability](../classes/SudoknZeroStockMachiningCapability.md)
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject <br/>  | direct | 3508 |
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknMachiningCapability](../classes/SudoknMachiningCapability.md) |
...
```yaml
name: sudokn_MachiningCapability
...
slots:
- rdfs_label
class_uri: sudokn:MachiningCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_MachiningCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
