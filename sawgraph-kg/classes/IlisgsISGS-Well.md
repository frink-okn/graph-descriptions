...
# Class: TODO -- what's a good name for this class (type)? (ilisgs_ISGS-Well)
...
URI: [ilisgs:ISGS-Well](http://sawgraph.spatialai.org/v1/il-isgs#ISGS-Well)
...
```mermaid
 classDiagram
    ...
    click IlisgsISGS-Well href "../IlisgsISGS-Well"
      ...
      IlisgsISGS-Well : geo_hasSerialization
        
          
    
    
    IlisgsISGS-Well --> "0..1" GeoWktLiteral : geo_hasSerialization
...
| ---  | ---  |
| self | ilisgs:ISGS-Well |
| native | sawgraph-kg/:IlisgsISGS-Well |
...
- if you think the class is perfect.
notes:
- Class with 379496 occurences.
from_schema: sawgraph-kg
is_a: geo_SpatialObject
class_uri: ilisgs:ISGS-Well
