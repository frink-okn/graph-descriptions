...
# Class: No class (entity type) name specified -- this class is noted as a superclass of another class in this graph but has not itself been defined. (sudokn_ElectricalResistanceWeldingCapability)





URI: [sudokn:ElectricalResistanceWeldingCapability](http://asu.edu/semantics/SUDOKN/ElectricalResistanceWeldingCapability)
...
```mermaid
 classDiagram
    class SudoknElectricalResistanceWeldingCapability
    click SudoknElectricalResistanceWeldingCapability href "../SudoknElectricalResistanceWeldingCapability"
      SudoknThermalWeldingCapability <|-- SudoknElectricalResistanceWeldingCapability
        click SudoknThermalWeldingCapability href "../SudoknThermalWeldingCapability"
      

      SudoknElectricalResistanceWeldingCapability <|-- SudoknButtWeldingCapability
        click SudoknButtWeldingCapability href "../SudoknButtWeldingCapability"
      SudoknElectricalResistanceWeldingCapability <|-- SudoknElectroSlagWeldingCapability
        click SudoknElectroSlagWeldingCapability href "../SudoknElectroSlagWeldingCapability"
      SudoknElectricalResistanceWeldingCapability <|-- SudoknPercussionWeldingCapability
        click SudoknPercussionWeldingCapability href "../SudoknPercussionWeldingCapability"
      SudoknElectricalResistanceWeldingCapability <|-- SudoknProjectionWeldingCapability
        click SudoknProjectionWeldingCapability href "../SudoknProjectionWeldingCapability"
      SudoknElectricalResistanceWeldingCapability <|-- SudoknSeamWeldingCapability
        click SudoknSeamWeldingCapability href "../SudoknSeamWeldingCapability"
      SudoknElectricalResistanceWeldingCapability <|-- SudoknSpotWeldingCapability
        click SudoknSpotWeldingCapability href "../SudoknSpotWeldingCapability"
      
      
      SudoknElectricalResistanceWeldingCapability : rdfs_label
        
          
    
    
    SudoknElectricalResistanceWeldingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
            ...
            * [SudoknThermaJoiningCapability](../classes/SudoknThermaJoiningCapability.md)
                * [SudoknThermalWeldingCapability](../classes/SudoknThermalWeldingCapability.md)
                    * **SudoknElectricalResistanceWeldingCapability**
                        * [SudoknButtWeldingCapability](../classes/SudoknButtWeldingCapability.md)
                        * [SudoknElectroSlagWeldingCapability](../classes/SudoknElectroSlagWeldingCapability.md)
                        * [SudoknPercussionWeldingCapability](../classes/SudoknPercussionWeldingCapability.md)
                        * [SudoknProjectionWeldingCapability](../classes/SudoknProjectionWeldingCapability.md)
                        * [SudoknSeamWeldingCapability](../classes/SudoknSeamWeldingCapability.md)
                        * [SudoknSpotWeldingCapability](../classes/SudoknSpotWeldingCapability.md)
...
```yaml
name: sudokn_ElectricalResistanceWeldingCapability
title: No class (entity type) name specified -- this class is noted as a superclass
  of another class in this graph but has not itself been defined.
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_ThermalWeldingCapability
class_uri: sudokn:ElectricalResistanceWeldingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ElectricalResistanceWeldingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
