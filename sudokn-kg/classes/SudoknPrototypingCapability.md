...
# Class: TODO -- what's a good name for this class (type)? (sudokn_PrototypingCapability)
...
URI: [sudokn:PrototypingCapability](http://asu.edu/semantics/SUDOKN/PrototypingCapability)
...
```mermaid
 classDiagram
    class SudoknPrototypingCapability
    click SudoknPrototypingCapability href "../SudoknPrototypingCapability"
      SudoknPrototypingCapability : rdfs_label
        
          
    
    
    SudoknPrototypingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknPrototypingCapability](../classes/SudoknPrototypingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknPrototypingCapability](../classes/SudoknPrototypingCapability.md) |
...
| Value |
| --- |
| sudokn:B+EManufacturingCo-Prototyping |
...
| ---  | ---  |
| self | sudokn:PrototypingCapability |
| native | sudokn-kg/:SudoknPrototypingCapability |
...
<details>
```yaml
name: sudokn_PrototypingCapability
...
examples:
- value: sudokn:B+EManufacturingCo-Prototyping
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:PrototypingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_PrototypingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
