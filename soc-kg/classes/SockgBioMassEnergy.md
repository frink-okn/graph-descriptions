...
# Class: No class (entity type) name specified (sockg_BioMassEnergy)


_BioMassEnergy represents the energy content derived from agricultural biomass, taking into account various components such as plant material and mineral content at different growth stages. This class is essential for evaluating the viability and energy potential of crops used for bioenergy production in sustainable agricultural practices._
...
URI: [sockg:BioMassEnergy](https://idir.uta.edu/sockg-ontology/docs/BioMassEnergy)
...
```mermaid
 classDiagram
    ...
    click SockgBioMassEnergy href "../SockgBioMassEnergy"
      SockgBioMassEnergy : rdfs_seeAlso
        
          
    
    
    SockgBioMassEnergy --> "0..1" Uri : rdfs_seeAlso
    click Uri href "../Uri"
    ...
    SockgBioMassEnergy --> "0..1" String : sockg_crop
    ...
    SockgBioMassEnergy --> "0..1" Any : sockg_grossCalorificValue_MJ_per_kg
    click Any href "../Any"
    ...
    SockgBioMassEnergy --> "0..1" String : sockg_growthStage
    click String href "../String"
    ...
    SockgBioMassEnergy --> "0..1" Any : sockg_mineralMatter_g_per_kg
    click Any href "../Any"
    ...
    SockgBioMassEnergy --> "0..1" String : sockg_plantFraction
    click String href "../String"
    ...
    SockgBioMassEnergy --> "0..1" Any : sockg_treatmentId
    click Any href "../Any"
...
| ---  | --- | --- | --- | --- |
| [sockg_date](../slots/sockg_date.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string)&nbsp;or&nbsp;<br />[xsd:date](http://www.w3.org/2001/XMLSchema#date) | No slot (predicate) description specified <br/>  | direct | 799 |
| [sockg_crop](../slots/sockg_crop.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string) | No slot (predicate) description specified <br/>  | direct | 799 |
| [sockg_growthStage](../slots/sockg_growthStage.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string) | No slot (predicate) description specified <br/>  | direct | 799 |
| [sockg_measBiomassEnergy_UID](../slots/sockg_measBiomassEnergy_UID.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string) | No slot (predicate) description specified <br/>  | direct | 799 |
| [sockg_plantFraction](../slots/sockg_plantFraction.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string) | No slot (predicate) description specified <br/>  | direct | 799 |
| [sockg_treatmentId](../slots/sockg_treatmentId.md) | 0..1 <br/> [xsd:float](http://www.w3.org/2001/XMLSchema#float)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string)&nbsp;or&nbsp;<br />[xsd:date](http://www.w3.org/2001/XMLSchema#date) | No slot (predicate) description specified <br/>  | direct | 799 |
| [sockg_mineralMatter_g_per_kg](../slots/sockg_mineralMatter_g_per_kg.md) | 0..1 <br/> [xsd:float](http://www.w3.org/2001/XMLSchema#float)&nbsp;or&nbsp;<br />[xsd:double](http://www.w3.org/2001/XMLSchema#double) | No slot (predicate) description specified <br/>  | direct | 799 |
| [sockg_grossCalorificValue_MJ_per_kg](../slots/sockg_grossCalorificValue_MJ_per_kg.md) | 0..1 <br/> [xsd:float](http://www.w3.org/2001/XMLSchema#float)&nbsp;or&nbsp;<br />[xsd:double](http://www.w3.org/2001/XMLSchema#double) | No slot (predicate) description specified <br/>  | direct | 795 |
| [rdfs_seeAlso](../slots/rdfs_seeAlso.md) | 0..1 <br/> [xsd:anyURI](http://www.w3.org/2001/XMLSchema#anyURI) | No slot (predicate) description specified <br/>  | direct | 799 |
...
| ---  | --- | --- | --- |
| [SockgBioMassEnergy](../classes/SockgBioMassEnergy.md) | [sockg_measBiomassEnergy_UID](../slots/sockg_measBiomassEnergy_UID.md) | domain | [SockgBioMassEnergy](../classes/SockgBioMassEnergy.md) |
| [SockgBioMassEnergy](../classes/SockgBioMassEnergy.md) | [sockg_mineralMatter_g_per_kg](../slots/sockg_mineralMatter_g_per_kg.md) | domain | [SockgBioMassEnergy](../classes/SockgBioMassEnergy.md) |
| [SockgBioMassEnergy](../classes/SockgBioMassEnergy.md) | [sockg_grossCalorificValue_MJ_per_kg](../slots/sockg_grossCalorificValue_MJ_per_kg.md) | domain | [SockgBioMassEnergy](../classes/SockgBioMassEnergy.md) |
...
annotations:
  count:
    tag: count
    value: 799
description: BioMassEnergy represents the energy content derived from agricultural
  biomass, taking into account various components such as plant material and mineral
  content at different growth stages. This class is essential for evaluating the viability
  and energy potential of crops used for bioenergy production in sustainable agricultural
  practices.
