...
# Class: TODO -- what's a good name for this class (type)? (sudokn_AbrasiveCleaningCapability)
...
URI: [sudokn:AbrasiveCleaningCapability](http://asu.edu/semantics/SUDOKN/AbrasiveCleaningCapability)
...
```mermaid
 classDiagram
    class SudoknAbrasiveCleaningCapability
    click SudoknAbrasiveCleaningCapability href "../SudoknAbrasiveCleaningCapability"
      SudoknAbrasiveCleaningCapability : rdfs_label
        
          
    
    
    SudoknAbrasiveCleaningCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknAbrasiveCleaningCapability](../classes/SudoknAbrasiveCleaningCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknAbrasiveCleaningCapability](../classes/SudoknAbrasiveCleaningCapability.md) |
...
| Value |
| --- |
| sudokn:AAAPLATING-AbrasiveCleaningCapability-inst |
...
| ---  | ---  |
| self | sudokn:AbrasiveCleaningCapability |
| native | sudokn-kg/:SudoknAbrasiveCleaningCapability |
...
<details>
```yaml
name: sudokn_AbrasiveCleaningCapability
...
- if you think the class is perfect.
notes:
- Class with 9 occurences.
examples:
- value: sudokn:AAAPLATING-AbrasiveCleaningCapability-inst
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:AbrasiveCleaningCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_AbrasiveCleaningCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
