...
# Class: TODO -- what's a good name for this class (type)? (sudokn_DifficultToMachineMaterialsProcessingCapability)
...
URI: [sudokn:DifficultToMachineMaterialsProcessingCapability](http://asu.edu/semantics/SUDOKN/DifficultToMachineMaterialsProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknDifficultToMachineMaterialsProcessingCapability
    click SudoknDifficultToMachineMaterialsProcessingCapability href "../SudoknDifficultToMachineMaterialsProcessingCapability"
      SudoknDifficultToMachineMaterialsProcessingCapability : rdfs_label
        
          
    
    
    SudoknDifficultToMachineMaterialsProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknDifficultToMachineMaterialsProcessingCapability](../classes/SudoknDifficultToMachineMaterialsProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknDifficultToMachineMaterialsProcessingCapability](../classes/SudoknDifficultToMachineMaterialsProcessingCapability.md) |
...
| Value |
| --- |
| sudokn:AEROSPACECOMPONENTS-DifficultToMachineMaterials-inst |
...
| ---  | ---  |
| self | sudokn:DifficultToMachineMaterialsProcessingCapability |
| native | sudokn-kg/:SudoknDifficultToMachineMaterialsProcessingCapability |
...
<details>
```yaml
name: sudokn_DifficultToMachineMaterialsProcessingCapability
...
examples:
- value: sudokn:AEROSPACECOMPONENTS-DifficultToMachineMaterials-inst
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:DifficultToMachineMaterialsProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_DifficultToMachineMaterialsProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
