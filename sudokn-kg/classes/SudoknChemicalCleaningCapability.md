...
# Class: TODO -- what's a good name for this class (type)? (sudokn_ChemicalCleaningCapability)
...
URI: [sudokn:ChemicalCleaningCapability](http://asu.edu/semantics/SUDOKN/ChemicalCleaningCapability)
...
```mermaid
 classDiagram
    class SudoknChemicalCleaningCapability
    click SudoknChemicalCleaningCapability href "../SudoknChemicalCleaningCapability"
      SudoknChemicalCleaningCapability : rdfs_label
        
          
    
    
    SudoknChemicalCleaningCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknChemicalCleaningCapability](../classes/SudoknChemicalCleaningCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknChemicalCleaningCapability](../classes/SudoknChemicalCleaningCapability.md) |
...
| Value |
| --- |
| sudokn:WilliamsPlatingCompany-ChemicalCleaning |
...
| ---  | ---  |
| self | sudokn:ChemicalCleaningCapability |
| native | sudokn-kg/:SudoknChemicalCleaningCapability |
...
<details>
```yaml
name: sudokn_ChemicalCleaningCapability
...
examples:
- value: sudokn:WilliamsPlatingCompany-ChemicalCleaning
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:ChemicalCleaningCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ChemicalCleaningCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
