...
# Class: TODO -- what's a good name for this class (type)? (sudokn_CNCLatheCapability)
...
URI: [sudokn:CNCLatheCapability](http://asu.edu/semantics/SUDOKN/CNCLatheCapability)
...
```mermaid
 classDiagram
    class SudoknCNCLatheCapability
    click SudoknCNCLatheCapability href "../SudoknCNCLatheCapability"
      SudoknCNCLatheCapability : rdfs_label
        
          
    
    
    SudoknCNCLatheCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCNCLatheCapability](../classes/SudoknCNCLatheCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCNCLatheCapability](../classes/SudoknCNCLatheCapability.md) |
...
| Value |
| --- |
| sudokn:WDLeeandCompany-CNCLathe |
...
| ---  | ---  |
| self | sudokn:CNCLatheCapability |
| native | sudokn-kg/:SudoknCNCLatheCapability |
...
<details>
```yaml
name: sudokn_CNCLatheCapability
...
examples:
- value: sudokn:WDLeeandCompany-CNCLathe
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:CNCLatheCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_CNCLatheCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
