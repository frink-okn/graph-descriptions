...
# Class: HttpsIdir.uta.eduSockg-ontology#OtherEvents
...
URI: [https://idir.uta.edu/sockg-ontology#OtherEvents](https://idir.uta.edu/sockg-ontology#OtherEvents)
...
```mermaid
 classDiagram
    ...
    click HttpsIdir.uta.eduSockg-ontology#OtherEvents href "../HttpsIdir.uta.eduSockg-ontology#OtherEvents"
      HttpsIdir.uta.eduSockg-ontology#OtherEvents : rdfs_label
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#OtherEvents --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: https___idir.uta.edu_sockg-ontology#OtherEvents
from_schema: okns:soc-kg
rank: 1000
slots:
- rdfs_label
class_uri: https://idir.uta.edu/sockg-ontology#OtherEvents
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: https___idir.uta.edu_sockg-ontology#OtherEvents
    domain_of:
    - qudt_AspectClass
    - qudt_BinaryPrefix
