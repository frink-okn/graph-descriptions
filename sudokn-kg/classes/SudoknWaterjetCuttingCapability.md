...
# Class: waterjet cutting capability (sudokn_WaterjetCuttingCapability)




This class occurs 373 times.


URI: [sudokn:WaterjetCuttingCapability](http://asu.edu/semantics/SUDOKN/WaterjetCuttingCapability)
...
```mermaid
 classDiagram
    class SudoknWaterjetCuttingCapability
    click SudoknWaterjetCuttingCapability href "../SudoknWaterjetCuttingCapability"
      SudoknErosionMachiningCapability <|-- SudoknWaterjetCuttingCapability
        click SudoknErosionMachiningCapability href "../SudoknErosionMachiningCapability"
      
      SudoknWaterjetCuttingCapability : rdfs_label
        
          
    
    
    SudoknWaterjetCuttingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject <br/>  | direct | 373 |
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknWaterjetCuttingCapability](../classes/SudoknWaterjetCuttingCapability.md) |
...
```yaml
name: sudokn_WaterjetCuttingCapability
title: waterjet cutting capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_ErosionMachiningCapability
slots:
- rdfs_label
class_uri: sudokn:WaterjetCuttingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_WaterjetCuttingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
