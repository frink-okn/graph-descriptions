...
# Class: gear hobbing capability (sudokn_GearHobbingCapability)





URI: [sudokn:GearHobbingCapability](http://asu.edu/semantics/SUDOKN/GearHobbingCapability)
...
```mermaid
 classDiagram
    class SudoknGearHobbingCapability
    click SudoknGearHobbingCapability href "../SudoknGearHobbingCapability"
      ...
      SudoknGearHobbingCapability : rdfs_label
        
          
    
    
    SudoknGearHobbingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: sudokn_GearHobbingCapability
title: gear hobbing capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_MultiPointCuttingCapability
class_uri: sudokn:GearHobbingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_GearHobbingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
