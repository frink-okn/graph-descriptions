...
# Class: TODO -- what's a good name for this class (type)? (sudokn_Textiles)
...
URI: [sudokn:Textiles](http://asu.edu/semantics/SUDOKN/Textiles)
...
```mermaid
 classDiagram
    class SudoknTextiles
    click SudoknTextiles href "../SudoknTextiles"
      SudoknTextiles : rdfs_label
        
          
    
    
    SudoknTextiles --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknTextiles](../classes/SudoknTextiles.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknTextiles](../classes/SudoknTextiles.md) |
...
| ---  | ---  |
| self | sudokn:Textiles |
| native | sudokn-kg/:SudoknTextiles |
...
examples:
- value: sudokn:textiles-inst
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:Textiles
