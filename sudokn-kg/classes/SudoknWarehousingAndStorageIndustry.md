...
# Class: TODO -- what's a good name for this class (type)? (sudokn_WarehousingAndStorageIndustry)
...
URI: [sudokn:WarehousingAndStorageIndustry](http://asu.edu/semantics/SUDOKN/WarehousingAndStorageIndustry)
...
```mermaid
 classDiagram
    class SudoknWarehousingAndStorageIndustry
    click SudoknWarehousingAndStorageIndustry href "../SudoknWarehousingAndStorageIndustry"
      SudoknWarehousingAndStorageIndustry : rdfs_label
        
          
    
    
    SudoknWarehousingAndStorageIndustry --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknWarehousingAndStorageIndustry](../classes/SudoknWarehousingAndStorageIndustry.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknWarehousingAndStorageIndustry](../classes/SudoknWarehousingAndStorageIndustry.md) |
...
| Value |
| --- |
| sudokn:warehousingandstorageindustry-inst |
...
| ---  | ---  |
| self | sudokn:WarehousingAndStorageIndustry |
| native | sudokn-kg/:SudoknWarehousingAndStorageIndustry |
...
<details>
```yaml
name: sudokn_WarehousingAndStorageIndustry
...
examples:
- value: sudokn:warehousingandstorageindustry-inst
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:WarehousingAndStorageIndustry
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_WarehousingAndStorageIndustry
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
