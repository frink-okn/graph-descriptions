...
# Class: TODO -- what's a good name for this class (type)? (sudokn_ExplosiveWeldingCapability)
...
| ---  | ---  |
| self | sudokn:ExplosiveWeldingCapability |
| native | sudokn-kg/:SudoknExplosiveWeldingCapability |
