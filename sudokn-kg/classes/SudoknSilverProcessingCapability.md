...
# Class: TODO -- what's a good name for this class (type)? (sudokn_SilverProcessingCapability)
...
URI: [sudokn:SilverProcessingCapability](http://asu.edu/semantics/SUDOKN/SilverProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknSilverProcessingCapability
    click SudoknSilverProcessingCapability href "../SudoknSilverProcessingCapability"
      SudoknSilverProcessingCapability : rdfs_label
        
          
    
    
    SudoknSilverProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknSilverProcessingCapability](../classes/SudoknSilverProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknSilverProcessingCapability](../classes/SudoknSilverProcessingCapability.md) |
...
| ---  | ---  |
| self | sudokn:SilverProcessingCapability |
| native | sudokn-kg/:SudoknSilverProcessingCapability |
...
<details>
```yaml
name: sudokn_SilverProcessingCapability
...
- if you think the class is perfect.
notes:
- Class with 1251 occurences.
examples:
- value: sudokn:4FELDCO-Silver-inst
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:SilverProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_SilverProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
