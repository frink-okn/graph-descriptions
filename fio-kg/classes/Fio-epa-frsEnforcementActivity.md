...
```mermaid
 classDiagram
    ...
    click Fio-epa-frsEnforcementActivity href "../Fio-epa-frsEnforcementActivity"
      ...
      Fio-epa-frsEnforcementActivity : dc_identifier
        
          
    
    
    Fio-epa-frsEnforcementActivity --> "0..1" Any : dc_identifier
    click Any href "../Any"
