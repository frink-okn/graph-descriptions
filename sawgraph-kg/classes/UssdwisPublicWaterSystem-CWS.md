...
# Class: TODO -- what's a good name for this class (type)? (ussdwis_PublicWaterSystem-CWS)
...
URI: [ussdwis:PublicWaterSystem-CWS](http://sawgraph.spatialai.org/v1/us-sdwis#PublicWaterSystem-CWS)
...
```mermaid
 classDiagram
    ...
    click UssdwisPublicWaterSystem-CWS href "../UssdwisPublicWaterSystem-CWS"
      ...
      UssdwisPublicWaterSystem-CWS : geo_hasSerialization
        
          
    
    
    UssdwisPublicWaterSystem-CWS --> "0..1" GeoWktLiteral : geo_hasSerialization
...
| ---  | ---  |
| self | ussdwis:PublicWaterSystem-CWS |
| native | sawgraph-kg/:UssdwisPublicWaterSystem-CWS |
...
<details>
```yaml
name: ussdwis_PublicWaterSystem-CWS
...
- if you think the class is perfect.
notes:
- Class with 3636 occurences.
from_schema: sawgraph-kg
is_a: geo_SpatialObject
class_uri: ussdwis:PublicWaterSystem-CWS
...
attributes:
  geo_hasSerialization:
    ...
    owner: ussdwis_PublicWaterSystem-CWS
    domain_of:
    - geo_Geometry
    - geo_SpatialObject
