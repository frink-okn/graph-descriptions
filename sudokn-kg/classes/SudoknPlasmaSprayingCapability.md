...
# Class: TODO -- what's a good name for this class (type)? (sudokn_PlasmaSprayingCapability)
...
```mermaid
 classDiagram
    ...
    SudoknPlasmaSprayingCapability --> "0..1" String : rdfs_label
...
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknPlasmaSprayingCapability](../classes/SudoknPlasmaSprayingCapability.md) |
...
| Value |
| --- |
| sudokn:APSMATERIALS-PlasmaSprayingCapability-inst |
...
| ---  | ---  |
| self | sudokn:PlasmaSprayingCapability |
| native | sudokn-kg/:SudoknPlasmaSprayingCapability |
...
examples:
- value: sudokn:APSMATERIALS-PlasmaSprayingCapability-inst
