...
# Class: live tooling capability (sudokn_LiveToolingCapability)




This class occurs 287 times.


URI: [sudokn:LiveToolingCapability](http://asu.edu/semantics/SUDOKN/LiveToolingCapability)
...
```mermaid
 classDiagram
    class SudoknLiveToolingCapability
    click SudoknLiveToolingCapability href "../SudoknLiveToolingCapability"
      ...
      SudoknLiveToolingCapability : rdfs_label
        
          
    
    
    SudoknLiveToolingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject <br/>  | direct | 287 |
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknLiveToolingCapability](../classes/SudoknLiveToolingCapability.md) |
...
```yaml
name: sudokn_LiveToolingCapability
title: live tooling capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_TurningCapability
slots:
- rdfs_label
class_uri: sudokn:LiveToolingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_LiveToolingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
