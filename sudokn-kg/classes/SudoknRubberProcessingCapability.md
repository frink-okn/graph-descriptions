...
# Class: rubber processing capability (sudokn_RubberProcessingCapability)
...
URI: [sudokn:RubberProcessingCapability](http://asu.edu/semantics/SUDOKN/RubberProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknRubberProcessingCapability
    click SudoknRubberProcessingCapability href "../SudoknRubberProcessingCapability"
      ...
      SudoknRubberProcessingCapability : rdfs_label
        
          
    
    
    SudoknRubberProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknRubberProcessingCapability](../classes/SudoknRubberProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknRubberProcessingCapability](../classes/SudoknRubberProcessingCapability.md) |
...
| ---  | ---  |
| self | sudokn:RubberProcessingCapability |
| native | sudokn-kg/:SudoknRubberProcessingCapability |
...
<details>
```yaml
name: sudokn_RubberProcessingCapability
description: No type description provided
title: rubber processing capability
todos:
- TODO -- Todos for this class go here
- or you can delete the todos
- if you think the class is perfect.
notes:
- Class with 1830 occurences.
examples:
- value: sudokn:101PIPE-Rubber-inst
from_schema: sudokn-kg
rank: 1000
is_a: sudokn_MaterialProcessingCapability
slots:
- rdfs_label
class_uri: sudokn:RubberProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_RubberProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
