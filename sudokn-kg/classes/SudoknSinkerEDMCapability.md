...
# Class: TODO -- what's a good name for this class (type)? (sudokn_SinkerEDMCapability)
...
URI: [sudokn:SinkerEDMCapability](http://asu.edu/semantics/SUDOKN/SinkerEDMCapability)
...
```mermaid
 classDiagram
    class SudoknSinkerEDMCapability
    click SudoknSinkerEDMCapability href "../SudoknSinkerEDMCapability"
      ...
      SudoknSinkerEDMCapability : rdfs_label
        
          
    
    
    SudoknSinkerEDMCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknSinkerEDMCapability](../classes/SudoknSinkerEDMCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknSinkerEDMCapability](../classes/SudoknSinkerEDMCapability.md) |
...
| Value |
| --- |
| sudokn:A1JAYS-SinkerEDMCapability-inst |
...
| ---  | ---  |
| self | sudokn:SinkerEDMCapability |
| native | sudokn-kg/:SudoknSinkerEDMCapability |
...
<details>
```yaml
name: sudokn_SinkerEDMCapability
...
- if you think the class is perfect.
notes:
- Class with 148 occurences.
examples:
- value: sudokn:A1JAYS-SinkerEDMCapability-inst
from_schema: sudokn-kg
rank: 1000
is_a: sudokn_EDMCapability
slots:
- rdfs_label
class_uri: sudokn:SinkerEDMCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_SinkerEDMCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
