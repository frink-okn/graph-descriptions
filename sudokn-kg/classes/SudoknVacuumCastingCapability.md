...
# Class: TODO -- what's a good name for this class (type)? (sudokn_VacuumCastingCapability)
...
URI: [sudokn:VacuumCastingCapability](http://asu.edu/semantics/SUDOKN/VacuumCastingCapability)
...
```mermaid
 classDiagram
    class SudoknVacuumCastingCapability
    click SudoknVacuumCastingCapability href "../SudoknVacuumCastingCapability"
      SudoknVacuumCastingCapability : rdfs_label
        
          
    
    
    SudoknVacuumCastingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknVacuumCastingCapability](../classes/SudoknVacuumCastingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknVacuumCastingCapability](../classes/SudoknVacuumCastingCapability.md) |
...
| Value |
| --- |
| sudokn:3DSYSTEMS-VacuumCastingCapability-inst |
...
| ---  | ---  |
| self | sudokn:VacuumCastingCapability |
| native | sudokn-kg/:SudoknVacuumCastingCapability |
...
<details>
```yaml
name: sudokn_VacuumCastingCapability
...
examples:
- value: sudokn:3DSYSTEMS-VacuumCastingCapability-inst
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:VacuumCastingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_VacuumCastingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
