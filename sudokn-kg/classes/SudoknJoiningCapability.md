...
# Class: joining capability (sudokn_JoiningCapability)
...
URI: [sudokn:JoiningCapability](http://asu.edu/semantics/SUDOKN/JoiningCapability)
...
```mermaid
 classDiagram
    ...
    click SudoknJoiningCapability href "../SudoknJoiningCapability"
      ...
      SudoknJoiningCapability <|-- SudoknAdhesiveBondingCapability
        click SudoknAdhesiveBondingCapability href "../SudoknAdhesiveBondingCapability"
      ...
      SudoknJoiningCapability : rdfs_label
        
          
    
    
    SudoknJoiningCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
* [IoscProductionCapability](../classes/IoscProductionCapability.md)
    * [SudoknManufacturingProcessCapability](../classes/SudoknManufacturingProcessCapability.md)
        * **SudoknJoiningCapability**
            * [SudoknAdhesiveBondingCapability](../classes/SudoknAdhesiveBondingCapability.md)
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknJoiningCapability](../classes/SudoknJoiningCapability.md) |
...
```yaml
name: sudokn_JoiningCapability
title: joining capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_ManufacturingProcessCapability
slots:
- rdfs_label
class_uri: sudokn:JoiningCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_JoiningCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
