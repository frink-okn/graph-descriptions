...
# Class: TODO -- what's a good name for this class (type)? (sudokn_FiberOpticLaserCuttingCapability)
...
URI: [sudokn:FiberOpticLaserCuttingCapability](http://asu.edu/semantics/SUDOKN/FiberOpticLaserCuttingCapability)
...
```mermaid
 classDiagram
    class SudoknFiberOpticLaserCuttingCapability
    click SudoknFiberOpticLaserCuttingCapability href "../SudoknFiberOpticLaserCuttingCapability"
      SudoknFiberOpticLaserCuttingCapability : rdfs_label
        
          
    
    
    SudoknFiberOpticLaserCuttingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknFiberOpticLaserCuttingCapability](../classes/SudoknFiberOpticLaserCuttingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknFiberOpticLaserCuttingCapability](../classes/SudoknFiberOpticLaserCuttingCapability.md) |
...
| Value |
| --- |
| sudokn:WatersBrothersContractors-FiberOpticLaserCutting |
...
| ---  | ---  |
| self | sudokn:FiberOpticLaserCuttingCapability |
| native | sudokn-kg/:SudoknFiberOpticLaserCuttingCapability |
...
<details>
```yaml
name: sudokn_FiberOpticLaserCuttingCapability
...
examples:
- value: sudokn:WatersBrothersContractors-FiberOpticLaserCutting
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:FiberOpticLaserCuttingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_FiberOpticLaserCuttingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
