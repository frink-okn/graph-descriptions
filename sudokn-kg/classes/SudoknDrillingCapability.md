...
# Class: drilling capability (sudokn_DrillingCapability)




This class occurs 1361 times.


URI: [sudokn:DrillingCapability](http://asu.edu/semantics/SUDOKN/DrillingCapability)
...
```mermaid
 classDiagram
    class SudoknDrillingCapability
    click SudoknDrillingCapability href "../SudoknDrillingCapability"
      ...
      SudoknDrillingCapability <|-- SudoknDeepHoleDrillingCapability
        click SudoknDeepHoleDrillingCapability href "../SudoknDeepHoleDrillingCapability"
      SudoknDrillingCapability <|-- SudoknMicroDrillingCapability
        click SudoknMicroDrillingCapability href "../SudoknMicroDrillingCapability"
      SudoknDrillingCapability <|-- SudoknSmallHoleDrillingCapability
        click SudoknSmallHoleDrillingCapability href "../SudoknSmallHoleDrillingCapability"
      
      
      SudoknDrillingCapability : rdfs_label
        
          
    
    
    SudoknDrillingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
            ...
            * [SudoknMultiPointCuttingCapability](../classes/SudoknMultiPointCuttingCapability.md)
                * [SudoknHoleMakingCapability](../classes/SudoknHoleMakingCapability.md)
                    * **SudoknDrillingCapability**
                        * [SudoknDeepHoleDrillingCapability](../classes/SudoknDeepHoleDrillingCapability.md)
                        * [SudoknMicroDrillingCapability](../classes/SudoknMicroDrillingCapability.md)
                        * [SudoknSmallHoleDrillingCapability](../classes/SudoknSmallHoleDrillingCapability.md)
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject <br/>  | direct | 1361 |
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknDrillingCapability](../classes/SudoknDrillingCapability.md) |
...
title: drilling capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_HoleMakingCapability
slots:
- rdfs_label
class_uri: sudokn:DrillingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_DrillingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
