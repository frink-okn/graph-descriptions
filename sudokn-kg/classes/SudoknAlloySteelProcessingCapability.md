...
# Class: TODO -- what's a good name for this class (type)? (sudokn_AlloySteelProcessingCapability)
...
```mermaid
 classDiagram
    ...
    SudoknAlloySteelProcessingCapability --> "0..1" String : rdfs_label
...
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknAlloySteelProcessingCapability](../classes/SudoknAlloySteelProcessingCapability.md) |
...
| Value |
| --- |
| sudokn:3DIMENSIONAL-AlloySteel-inst |
...
| ---  | ---  |
| self | sudokn:AlloySteelProcessingCapability |
| native | sudokn-kg/:SudoknAlloySteelProcessingCapability |
...
- if you think the class is perfect.
notes:
- Class with 825 occurences.
examples:
- value: sudokn:3DIMENSIONAL-AlloySteel-inst
