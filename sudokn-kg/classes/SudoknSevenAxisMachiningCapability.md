...
# Class: 7-axis machining capability (sudokn_SevenAxisMachiningCapability)





URI: [sudokn:SevenAxisMachiningCapability](http://asu.edu/semantics/SUDOKN/SevenAxisMachiningCapability)
...
```mermaid
 classDiagram
    class SudoknSevenAxisMachiningCapability
    click SudoknSevenAxisMachiningCapability href "../SudoknSevenAxisMachiningCapability"
      ...
      SudoknSevenAxisMachiningCapability : rdfs_label
        
          
    
    
    SudoknSevenAxisMachiningCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject | [SudoknCNCMachiningCapability](../classes/SudoknCNCMachiningCapability.md), [SudoknMachiningCapability](../classes/SudoknMachiningCapability.md) |  |
...
```yaml
name: sudokn_SevenAxisMachiningCapability
title: 7-axis machining capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_CNCMachiningCapability
class_uri: sudokn:SevenAxisMachiningCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_SevenAxisMachiningCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
