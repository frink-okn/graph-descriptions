...
# Class: TODO -- what's a good name for this class (type)? (sudokn_IndustrialMachineryandEquipmentIndustry)
...
URI: [sudokn:IndustrialMachineryandEquipmentIndustry](http://asu.edu/semantics/SUDOKN/IndustrialMachineryandEquipmentIndustry)
...
```mermaid
 classDiagram
    class SudoknIndustrialMachineryandEquipmentIndustry
    click SudoknIndustrialMachineryandEquipmentIndustry href "../SudoknIndustrialMachineryandEquipmentIndustry"
      SudoknIndustrialMachineryandEquipmentIndustry : rdfs_label
        
          
    
    
    SudoknIndustrialMachineryandEquipmentIndustry --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknIndustrialMachineryandEquipmentIndustry](../classes/SudoknIndustrialMachineryandEquipmentIndustry.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknIndustrialMachineryandEquipmentIndustry](../classes/SudoknIndustrialMachineryandEquipmentIndustry.md) |
...
| Value |
| --- |
| sudokn:IndustrialMachineryandEquipment-Industry |
...
| ---  | ---  |
| self | sudokn:IndustrialMachineryandEquipmentIndustry |
| native | sudokn-kg/:SudoknIndustrialMachineryandEquipmentIndustry |
...
<details>
```yaml
name: sudokn_IndustrialMachineryandEquipmentIndustry
...
examples:
- value: sudokn:IndustrialMachineryandEquipment-Industry
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:IndustrialMachineryandEquipmentIndustry
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_IndustrialMachineryandEquipmentIndustry
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
