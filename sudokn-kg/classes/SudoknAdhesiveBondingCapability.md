...
# Class: adhesive bonding capability (sudokn_AdhesiveBondingCapability)





URI: [sudokn:AdhesiveBondingCapability](http://asu.edu/semantics/SUDOKN/AdhesiveBondingCapability)
...
```mermaid
 classDiagram
    class SudoknAdhesiveBondingCapability
    click SudoknAdhesiveBondingCapability href "../SudoknAdhesiveBondingCapability"
      ...
      SudoknAdhesiveBondingCapability : rdfs_label
        
          
    
    
    SudoknAdhesiveBondingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: sudokn_AdhesiveBondingCapability
title: adhesive bonding capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_JoiningCapability
class_uri: sudokn:AdhesiveBondingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_AdhesiveBondingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
