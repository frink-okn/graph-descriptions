...
# Class: Treasury (fio-epa-frs_Agency.Treasury)
...
URI: [fio-epa-frs:Agency.Treasury](http://w3id.org/fio/v1/epa-frs#Agency.Treasury)
...
```mermaid
 classDiagram
    class Fio-epa-frsAgency.Treasury
    click Fio-epa-frsAgency.Treasury href "../Fio-epa-frsAgency.Treasury"
      ProvAgent <|-- Fio-epa-frsAgency.Treasury
        click ProvAgent href "../ProvAgent"
      
      Fio-epa-frsAgency.Treasury : owl_sameAs
        
          
    
    
    Fio-epa-frsAgency.Treasury --> "0..1" OwlThing : owl_sameAs
    click OwlThing href "../OwlThing"

        
      Fio-epa-frsAgency.Treasury : rdfs_label
        
          
    
    
    Fio-epa-frsAgency.Treasury --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: fio-epa-frs_Agency.Treasury
title: Treasury
...
- rdfs_label
- owl_sameAs
class_uri: fio-epa-frs:Agency.Treasury
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: fio-epa-frs_Agency.Treasury
    domain_of:
    - time_DayOfWeek
    - time_TemporalUnit
