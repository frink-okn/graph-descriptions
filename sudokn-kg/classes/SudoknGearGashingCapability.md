...
# Class: SudoknGearGashingCapability





URI: [sudokn:GearGashingCapability](http://asu.edu/semantics/SUDOKN/GearGashingCapability)
...
```mermaid
 classDiagram
    ...
    click SudoknGearGashingCapability href "../SudoknGearGashingCapability"
      ...
      SudoknGearGashingCapability : rdfs_label
        
          
    
    
    SudoknGearGashingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: sudokn_GearGashingCapability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_MillingCapability
class_uri: sudokn:GearGashingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_GearGashingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
