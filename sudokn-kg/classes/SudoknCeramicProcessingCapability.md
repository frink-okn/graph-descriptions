...
# Class: ceramic processing capability (sudokn_CeramicProcessingCapability)
...
URI: [sudokn:CeramicProcessingCapability](http://asu.edu/semantics/SUDOKN/CeramicProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknCeramicProcessingCapability
    click SudoknCeramicProcessingCapability href "../SudoknCeramicProcessingCapability"
      ...
      SudoknCeramicProcessingCapability : rdfs_label
        
          
    
    
    SudoknCeramicProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknCeramicProcessingCapability](../classes/SudoknCeramicProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknCeramicProcessingCapability](../classes/SudoknCeramicProcessingCapability.md) |
...
| ---  | ---  |
| self | sudokn:CeramicProcessingCapability |
| native | sudokn-kg/:SudoknCeramicProcessingCapability |
...
<details>
```yaml
name: sudokn_CeramicProcessingCapability
description: TODO -- tell the world what this class (type) describes.
title: ceramic processing capability
todos:
- TODO -- Todos for this class go here
- or you can delete the todos
- if you think the class is perfect.
notes:
- Class with 1051 occurences.
examples:
- value: sudokn:3D-CAM-Ceramic-inst
from_schema: sudokn-kg
is_a: sudokn_MaterialProcessingCapability
slots:
- rdfs_label
class_uri: sudokn:CeramicProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_CeramicProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
