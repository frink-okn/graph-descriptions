...
# Class: TODO -- what's a good name for this class (type)? (sudokn_KittingCapability)
...
URI: [sudokn:KittingCapability](http://asu.edu/semantics/SUDOKN/KittingCapability)
...
```mermaid
 classDiagram
    ...
    click SudoknKittingCapability href "../SudoknKittingCapability"
      ...
      SudoknKittingCapability : rdfs_label
        
          
    
    
    SudoknKittingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknKittingCapability](../classes/SudoknKittingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknKittingCapability](../classes/SudoknKittingCapability.md) |
...
| Value |
| --- |
| sudokn:FalconFasteningSolutions-Kitting |
...
| ---  | ---  |
| self | sudokn:KittingCapability |
| native | sudokn-kg/:SudoknKittingCapability |
...
examples:
- value: sudokn:FalconFasteningSolutions-Kitting
from_schema: sudokn-kg
is_a: sudokn_AssemblyCapibility
slots:
- rdfs_label
class_uri: sudokn:KittingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_KittingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
