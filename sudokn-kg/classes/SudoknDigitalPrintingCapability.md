...
# Class: TODO -- what's a good name for this class (type)? (sudokn_DigitalPrintingCapability)
...
URI: [sudokn:DigitalPrintingCapability](http://asu.edu/semantics/SUDOKN/DigitalPrintingCapability)
...
```mermaid
 classDiagram
    class SudoknDigitalPrintingCapability
    click SudoknDigitalPrintingCapability href "../SudoknDigitalPrintingCapability"
      SudoknDigitalPrintingCapability : rdfs_label
        
          
    
    
    SudoknDigitalPrintingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknDigitalPrintingCapability](../classes/SudoknDigitalPrintingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknDigitalPrintingCapability](../classes/SudoknDigitalPrintingCapability.md) |
...
| ---  | ---  |
| self | sudokn:DigitalPrintingCapability |
| native | sudokn-kg/:SudoknDigitalPrintingCapability |
...
<details>
```yaml
name: sudokn_DigitalPrintingCapability
...
examples:
- value: sudokn:JKS-DigitalPrinting
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:DigitalPrintingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_DigitalPrintingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
