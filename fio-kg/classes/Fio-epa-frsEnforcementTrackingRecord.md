...
```mermaid
 classDiagram
    ...
    click Fio-epa-frsEnforcementTrackingRecord href "../Fio-epa-frsEnforcementTrackingRecord"
      ...
      Fio-epa-frsEnforcementTrackingRecord : dc_identifier
        
          
    
    
    Fio-epa-frsEnforcementTrackingRecord --> "0..1" Any : dc_identifier
    click Any href "../Any"
