...
| Class | Description |
| --- | --- |
| [HsdoActivity](classes/HsdoActivity.md) | No class (type) description specified<br/>Class with 24 occurrences.| 
| [HsdoChronostratigraphicUnit](classes/HsdoChronostratigraphicUnit.md) | No class (type) description specified<br/>Class with 184 occurrences.| 
| [HsdoCmip6SourceId](classes/HsdoCmip6SourceId.md) | No class (type) description specified<br/>Class with 134 occurrences.| 
| [HsdoDataFormat](classes/HsdoDataFormat.md) | No class (type) description specified<br/>Class with 198 occurrences.| 
| [HsdoDataset](classes/HsdoDataset.md) | A body of structured information describing some topic(s) of interest.<br/>Class with 107 occurrences.| 
| [HsdoExperiment](classes/HsdoExperiment.md) | No class (type) description specified<br/>Class with 467 occurrences.| 
| [HsdoFrequency](classes/HsdoFrequency.md) | No class (type) description specified<br/>Class with 16 occurrences.| 
| [HsdoGridLabel](classes/HsdoGridLabel.md) | No class (type) description specified<br/>Class with 45 occurrences.| 
| [HsdoHorizontalResolutionRange](classes/HsdoHorizontalResolutionRange.md) | No class (type) description specified<br/>Class with 15 occurrences.| 
| [HsdoInstitution](classes/HsdoInstitution.md) | No class (type) description specified<br/>Class with 75 occurrences.| 
| [HsdoInstrument](classes/HsdoInstrument.md) | No class (type) description specified<br/>Class with 2416 occurrences.| 
| [HsdoLicense](classes/HsdoLicense.md) | No class (type) description specified<br/>Class with 5 occurrences.| 
| [HsdoLocation](classes/HsdoLocation.md) | No class (type) description specified<br/>Class with 1168 occurrences.| 
| [HsdoMeasurementName](classes/HsdoMeasurementName.md) | No class (type) description specified<br/>Class with 251 occurrences.| 
| [HsdoMimeType](classes/HsdoMimeType.md) | No class (type) description specified<br/>Class with 38 occurrences.| 
| [HsdoModel](classes/HsdoModel.md) | No class (type) description specified<br/>Class with 372 occurrences.| 
| [HsdoModels](classes/HsdoModels.md) | No class (type) description specified<br/>Class with 442 occurrences.| 
| [HsdoNominalResolution](classes/HsdoNominalResolution.md) | No class (type) description specified<br/>Class with 16 occurrences.| 
| [HsdoObs4MipsSourceId](classes/HsdoObs4MipsSourceId.md) | No class (type) description specified<br/>Class with 106 occurrences.| 
| [HsdoPaper](classes/HsdoPaper.md) | No class (type) description specified<br/>Class with 300 occurrences.| 
| [HsdoPlatform](classes/HsdoPlatform.md) | No class (type) description specified<br/>Class with 1390 occurrences.| 
...
Use properties from [[Organization]], [[subOrganization]]/[[parentOrganization]] to indicate project sub-structures. 
   <br/>Class with 2057 occurrences.| 
| [HsdoProvider](classes/HsdoProvider.md) | No class (type) description specified<br/>Class with 4469 occurrences.| 
| [HsdoRealm](classes/HsdoRealm.md) | No class (type) description specified<br/>Class with 9 occurrences.| 
| [HsdoRegion](classes/HsdoRegion.md) | No class (type) description specified<br/>Class with 69 occurrences.| 
| [HsdoRelatedUrlContentType](classes/HsdoRelatedUrlContentType.md) | No class (type) description specified<br/>Class with 105 occurrences.| 
| [HsdoScienceKeyword](classes/HsdoScienceKeyword.md) | No class (type) description specified<br/>Class with 4109 occurrences.| 
| [HsdoSourceType](classes/HsdoSourceType.md) | No class (type) description specified<br/>Class with 15 occurrences.| 
| [HsdoSubExperimentId](classes/HsdoSubExperimentId.md) | No class (type) description specified<br/>Class with 75 occurrences.| 
| [HsdoTemporalResolutionRange](classes/HsdoTemporalResolutionRange.md) | No class (type) description specified<br/>Class with 36 occurrences.| 
| [HsdoVariable](classes/HsdoVariable.md) | No class (type) description specified<br/>Class with 2705 occurrences.| 
| [HsdoVerticalResolutionRange](classes/HsdoVerticalResolutionRange.md) | No class (type) description specified<br/>Class with 8 occurrences.| 
| [SkosConcept](classes/SkosConcept.md) | No class (type) description specified<br/>Class with 16359 occurrences.| 
