...
# Class: TODO -- what's a good name for this class (type)? (sudokn_CNCVerticalMillingCapability)
...
URI: [sudokn:CNCVerticalMillingCapability](http://asu.edu/semantics/SUDOKN/CNCVerticalMillingCapability)
...
```mermaid
 classDiagram
    class SudoknCNCVerticalMillingCapability
    click SudoknCNCVerticalMillingCapability href "../SudoknCNCVerticalMillingCapability"
      SudoknCNCVerticalMillingCapability : rdfs_label
        
          
    
    
    SudoknCNCVerticalMillingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCNCVerticalMillingCapability](../classes/SudoknCNCVerticalMillingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCNCVerticalMillingCapability](../classes/SudoknCNCVerticalMillingCapability.md) |
...
| Value |
| --- |
| sudokn:SurryLogistix-CNCVerticalMilling |
...
| ---  | ---  |
| self | sudokn:CNCVerticalMillingCapability |
| native | sudokn-kg/:SudoknCNCVerticalMillingCapability |
...
<details>
```yaml
name: sudokn_CNCVerticalMillingCapability
...
examples:
- value: sudokn:SurryLogistix-CNCVerticalMilling
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:CNCVerticalMillingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_CNCVerticalMillingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
