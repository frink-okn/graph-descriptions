...
# Class: No class (type) name specified (sudokn_AgricultureForestryFishingAndHunting)
...
URI: [sudokn:AgricultureForestryFishingAndHunting](http://asu.edu/semantics/SUDOKN/AgricultureForestryFishingAndHunting)
...
```mermaid
 classDiagram
    class SudoknAgricultureForestryFishingAndHunting
    click SudoknAgricultureForestryFishingAndHunting href "../SudoknAgricultureForestryFishingAndHunting"
      ...
      SudoknAgricultureForestryFishingAndHunting : sudokn_hasNAICSCodeValue
        
          
    
    
    SudoknAgricultureForestryFishingAndHunting --> "0..1" Any : sudokn_hasNAICSCodeValue
    click Any href "../Any"

        
      SudoknAgricultureForestryFishingAndHunting : sudokn_hasNAICSTextValue
        
          
    
    
    SudoknAgricultureForestryFishingAndHunting --> "0..1" Any : sudokn_hasNAICSTextValue
    click Any href "../Any"
...
```yaml
name: sudokn_AgricultureForestryFishingAndHunting
...
class_uri: sudokn:AgricultureForestryFishingAndHunting
...
attributes:
  sudokn_hasNAICSCodeValue:
    ...
    owner: sudokn_AgricultureForestryFishingAndHunting
    domain_of:
    - sudokn_NAICS332111
    - sudokn_NAICS332112
    - sudokn_NAICS332114
