...
# Class: Interior (fio-epa-frs_Agency.Interior)
...
URI: [fio-epa-frs:Agency.Interior](http://w3id.org/fio/v1/epa-frs#Agency.Interior)
...
```mermaid
 classDiagram
    class Fio-epa-frsAgency.Interior
    click Fio-epa-frsAgency.Interior href "../Fio-epa-frsAgency.Interior"
      ProvAgent <|-- Fio-epa-frsAgency.Interior
        click ProvAgent href "../ProvAgent"
      
      Fio-epa-frsAgency.Interior : owl_sameAs
        
          
    
    
    Fio-epa-frsAgency.Interior --> "0..1" OwlThing : owl_sameAs
    click OwlThing href "../OwlThing"

        
      Fio-epa-frsAgency.Interior : rdfs_label
        
          
    
    
    Fio-epa-frsAgency.Interior --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| [owl_sameAs](../slots/owl_sameAs.md) | 0..1 <br/> [OwlThing](../classes/OwlThing.md) | The property that determines that two given individuals are equal <br/> No occurrences of this slot in the graph. | direct | 20 |
...
| ---  | --- | --- | --- |
| [Fio-epa-frsEPA-PFAS-Facility](../classes/Fio-epa-frsEPA-PFAS-Facility.md) | [fio_ownedBy](../slots/fio_ownedBy.md) | any_of[range] | [Fio-epa-frsAgency.Interior](../classes/Fio-epa-frsAgency.Interior.md) |
| [Fio-epa-frsFRS-Facility](../classes/Fio-epa-frsFRS-Facility.md) | [fio_ownedBy](../slots/fio_ownedBy.md) | any_of[range] | [Fio-epa-frsAgency.Interior](../classes/Fio-epa-frsAgency.Interior.md) |
...
```yaml
name: fio-epa-frs_Agency.Interior
title: Interior
from_schema: okns:fiokg
exact_mappings:
- http://w3id.org/fio/v1/epa-frs#Agency.Interior
rank: 1000
is_a: prov_Agent
slots:
- rdfs_label
- owl_sameAs
class_uri: fio-epa-frs:Agency.Interior
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: fio-epa-frs_Agency.Interior
    domain_of:
