...
# Class: TODO -- what's a good name for this class (type)? (sudokn_SmeltingCapability)
...
URI: [sudokn:SmeltingCapability](http://asu.edu/semantics/SUDOKN/SmeltingCapability)
...
```mermaid
 classDiagram
    class SudoknSmeltingCapability
    click SudoknSmeltingCapability href "../SudoknSmeltingCapability"
      SudoknSmeltingCapability : rdfs_label
        
          
    
    
    SudoknSmeltingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknSmeltingCapability](../classes/SudoknSmeltingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknSmeltingCapability](../classes/SudoknSmeltingCapability.md) |
...
| ---  | ---  |
| self | sudokn:SmeltingCapability |
| native | sudokn-kg/:SudoknSmeltingCapability |
...
<details>
```yaml
name: sudokn_SmeltingCapability
...
examples:
- value: sudokn:Aludisc-Smelting
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:SmeltingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_SmeltingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
