...
# Class: TODO -- what's a good name for this class (type)? (sudokn_PhosphorBronzeProcessingCapability)
...
URI: [sudokn:PhosphorBronzeProcessingCapability](http://asu.edu/semantics/SUDOKN/PhosphorBronzeProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknPhosphorBronzeProcessingCapability
    click SudoknPhosphorBronzeProcessingCapability href "../SudoknPhosphorBronzeProcessingCapability"
      SudoknPhosphorBronzeProcessingCapability : rdfs_label
        
          
    
    
    SudoknPhosphorBronzeProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknPhosphorBronzeProcessingCapability](../classes/SudoknPhosphorBronzeProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknPhosphorBronzeProcessingCapability](../classes/SudoknPhosphorBronzeProcessingCapability.md) |
...
| Value |
| --- |
| sudokn:METALKRAFTPM-PhosphorBronze-inst |
...
| ---  | ---  |
| self | sudokn:PhosphorBronzeProcessingCapability |
| native | sudokn-kg/:SudoknPhosphorBronzeProcessingCapability |
...
<details>
```yaml
name: sudokn_PhosphorBronzeProcessingCapability
...
examples:
- value: sudokn:METALKRAFTPM-PhosphorBronze-inst
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:PhosphorBronzeProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_PhosphorBronzeProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
