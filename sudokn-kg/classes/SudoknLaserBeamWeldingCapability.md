...
# Class: No class (type) name specified (sudokn_LaserBeamWeldingCapability)
...
URI: [sudokn:LaserBeamWeldingCapability](http://asu.edu/semantics/SUDOKN/LaserBeamWeldingCapability)
...
```mermaid
 classDiagram
    class SudoknLaserBeamWeldingCapability
    click SudoknLaserBeamWeldingCapability href "../SudoknLaserBeamWeldingCapability"
      ...
      SudoknLaserBeamWeldingCapability : rdfs_label
        
          
    
    
    SudoknLaserBeamWeldingCapability --> "0..1" String : rdfs_label
...
```yaml
name: sudokn_LaserBeamWeldingCapability
...
class_uri: sudokn:LaserBeamWeldingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_LaserBeamWeldingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
    - owl_NamedIndividual
