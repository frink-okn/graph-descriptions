...
# Class: WQP - Result Measure Qualifier (http___w3id.org_sawgraph_v1_us-wqp#ResultMeasureQualifier)




This class occurs 250 times.


URI: [http://w3id.org/sawgraph/v1/us-wqp#ResultMeasureQualifier](http://w3id.org/sawgraph/v1/us-wqp#ResultMeasureQualifier)
...
```mermaid
 classDiagram
    class HttpW3id.orgSawgraphV1Us-wqp#ResultMeasureQualifier
    click HttpW3id.orgSawgraphV1Us-wqp#ResultMeasureQualifier href "../HttpW3id.orgSawgraphV1Us-wqp#ResultMeasureQualifier"
      HttpW3id.orgSawgraphV1Us-wqp#ResultMeasureQualifier : rdfs_comment
        
          
    
    
    HttpW3id.orgSawgraphV1Us-wqp#ResultMeasureQualifier --> "0..1" Any : rdfs_comment
    click Any href "../Any"

        
      HttpW3id.orgSawgraphV1Us-wqp#ResultMeasureQualifier : rdfs_label
        
          
    
    
    HttpW3id.orgSawgraphV1Us-wqp#ResultMeasureQualifier --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- | --- |
| [rdfs_comment](../slots/rdfs_comment.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A description of the subject resource <br/>  | direct | 250 |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject <br/>  | direct | 250 |
...
| ---  | --- | --- | --- |
| [HttpW3id.orgSawgraphV1Us-wqp#Single-PFAS-Concentration](../classes/HttpW3id.orgSawgraphV1Us-wqp#Single-PFAS-Concentration.md) | [coso_hasResultQualifier](../slots/coso_hasResultQualifier.md) | any_of[range] | [HttpW3id.orgSawgraphV1Us-wqp#ResultMeasureQualifier](../classes/HttpW3id.orgSawgraphV1Us-wqp#ResultMeasureQualifier.md) |
...
```yaml
name: http___w3id.org_sawgraph_v1_us-wqp#ResultMeasureQualifier
title: WQP - Result Measure Qualifier
from_schema: okns:sawgraph-kg
rank: 1000
slots:
- rdfs_comment
- rdfs_label
class_uri: http://w3id.org/sawgraph/v1/us-wqp#ResultMeasureQualifier
...
attributes:
  rdfs_comment:
    ...
    alias: rdfs_comment
    owner: http___w3id.org_sawgraph_v1_us-wqp#ResultMeasureQualifier
    domain_of:
