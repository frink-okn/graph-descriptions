...
# Class: surface preparation capability (sudokn_SurfacePreparationCapability)




This class occurs 550 times.


URI: [sudokn:SurfacePreparationCapability](http://asu.edu/semantics/SUDOKN/SurfacePreparationCapability)
...
```mermaid
 classDiagram
    class SudoknSurfacePreparationCapability
    click SudoknSurfacePreparationCapability href "../SudoknSurfacePreparationCapability"
      SudoknSurfaceFinishingCapability <|-- SudoknSurfacePreparationCapability
        click SudoknSurfaceFinishingCapability href "../SudoknSurfaceFinishingCapability"
      

      SudoknSurfacePreparationCapability <|-- SudoknBeltSandingCapability
        click SudoknBeltSandingCapability href "../SudoknBeltSandingCapability"
      SudoknSurfacePreparationCapability <|-- SudoknHarperizingCapability
        click SudoknHarperizingCapability href "../SudoknHarperizingCapability"
      SudoknSurfacePreparationCapability <|-- SudoknPolishingCapability
        click SudoknPolishingCapability href "../SudoknPolishingCapability"
      SudoknSurfacePreparationCapability <|-- SudoknSandBlastingCapability
        click SudoknSandBlastingCapability href "../SudoknSandBlastingCapability"
      SudoknSurfacePreparationCapability <|-- SudoknShotPeeningCapability
        click SudoknShotPeeningCapability href "../SudoknShotPeeningCapability"
      SudoknSurfacePreparationCapability <|-- SudoknUltrasonicCleaningCapability
        click SudoknUltrasonicCleaningCapability href "../SudoknUltrasonicCleaningCapability"
      
      
      SudoknSurfacePreparationCapability : rdfs_label
        
          
    
    
    SudoknSurfacePreparationCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
    ...
    * [SudoknManufacturingProcessCapability](../classes/SudoknManufacturingProcessCapability.md)
        * [SudoknSurfaceFinishingCapability](../classes/SudoknSurfaceFinishingCapability.md)
            * **SudoknSurfacePreparationCapability**
                * [SudoknBeltSandingCapability](../classes/SudoknBeltSandingCapability.md)
                * [SudoknHarperizingCapability](../classes/SudoknHarperizingCapability.md)
                * [SudoknPolishingCapability](../classes/SudoknPolishingCapability.md)
                * [SudoknSandBlastingCapability](../classes/SudoknSandBlastingCapability.md)
                * [SudoknShotPeeningCapability](../classes/SudoknShotPeeningCapability.md)
                * [SudoknUltrasonicCleaningCapability](../classes/SudoknUltrasonicCleaningCapability.md)
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject <br/>  | direct | 550 |
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknSurfacePreparationCapability](../classes/SudoknSurfacePreparationCapability.md) |
...
```yaml
name: sudokn_SurfacePreparationCapability
title: surface preparation capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_SurfaceFinishingCapability
slots:
- rdfs_label
class_uri: sudokn:SurfacePreparationCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_SurfacePreparationCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
