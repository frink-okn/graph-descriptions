...
# Class: printing and infomation industry (sudokn_PrintingAndInformationIndustry)
...
URI: [sudokn:PrintingAndInformationIndustry](http://asu.edu/semantics/SUDOKN/PrintingAndInformationIndustry)
...
```mermaid
 classDiagram
    class SudoknPrintingAndInformationIndustry
    click SudoknPrintingAndInformationIndustry href "../SudoknPrintingAndInformationIndustry"
      ...
      SudoknPrintingAndInformationIndustry : rdfs_label
        
          
    
    
    SudoknPrintingAndInformationIndustry --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknPrintingAndInformationIndustry](../classes/SudoknPrintingAndInformationIndustry.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknPrintingAndInformationIndustry](../classes/SudoknPrintingAndInformationIndustry.md) |
...
| ---  | ---  |
| self | sudokn:PrintingAndInformationIndustry |
| native | sudokn-kg/:SudoknPrintingAndInformationIndustry |
...
<details>
```yaml
name: sudokn_PrintingAndInformationIndustry
description: TODO -- tell the world what this class (type) describes.
title: printing and infomation industry
todos:
- TODO -- Todos for this class go here
- or you can delete the todos
- if you think the class is perfect.
...
slots:
- rdfs_label
class_uri: sudokn:PrintingAndInformationIndustry
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_PrintingAndInformationIndustry
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
