...
# Class: TODO -- what's a good name for this class (type)? (sudokn_MechanicalCoatingCapability)
...
URI: [sudokn:MechanicalCoatingCapability](http://asu.edu/semantics/SUDOKN/MechanicalCoatingCapability)
...
```mermaid
 classDiagram
    class SudoknMechanicalCoatingCapability
    click SudoknMechanicalCoatingCapability href "../SudoknMechanicalCoatingCapability"
      ...
      SudoknMechanicalCoatingCapability : rdfs_label
        
          
    
    
    SudoknMechanicalCoatingCapability --> "0..1" String : rdfs_label
        ...
        * [SudoknFinishingCapability](../classes/SudoknFinishingCapability.md)
            * [SudoknCoatingCapability](../classes/SudoknCoatingCapability.md)
                * **SudoknMechanicalCoatingCapability**
                    * [SudoknPowderCoatingCapability](../classes/SudoknPowderCoatingCapability.md)
...
| ---  | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string) | TODO -- tell the world what this slot (predicate) describes | [SudoknFinishingCapability](../classes/SudoknFinishingCapability.md), [SudoknCoatingCapability](../classes/SudoknCoatingCapability.md) |
...
| ---  | ---  |
| self | sudokn:MechanicalCoatingCapability |
| native | sudokn-kg/:SudoknMechanicalCoatingCapability |
...
<details>
```yaml
name: sudokn_MechanicalCoatingCapability
...
class_uri: sudokn:MechanicalCoatingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_MechanicalCoatingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
