...
# Class: NADCAP certificate (sudokn_NADCAPCertificate)
...
URI: [sudokn:NADCAPCertificate](http://asu.edu/semantics/SUDOKN/NADCAPCertificate)
...
```mermaid
 classDiagram
    ...
    click SudoknNADCAPCertificate href "../SudoknNADCAPCertificate"
      ...
      SudoknNADCAPCertificate : rdfs_label
        
          
    
    
    SudoknNADCAPCertificate --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasCertificate](../slots/sudokn_hasCertificate.md) | any_of[range] | [SudoknNADCAPCertificate](../classes/SudoknNADCAPCertificate.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasCertificate](../slots/sudokn_hasCertificate.md) | any_of[range] | [SudoknNADCAPCertificate](../classes/SudoknNADCAPCertificate.md) |
...
| Value |
| --- |
| sudokn:AAAPLATING-NADCAPCertificate |
...
| ---  | ---  |
| self | sudokn:NADCAPCertificate |
| native | sudokn-kg/:SudoknNADCAPCertificate |
...
<details>
```yaml
name: sudokn_NADCAPCertificate
description: TODO -- tell the world what this class (type) describes.
title: NADCAP certificate
todos:
- TODO -- Todos for this class go here
- or you can delete the todos
- if you think the class is perfect.
...
examples:
- value: sudokn:AAAPLATING-NADCAPCertificate
from_schema: sudokn-kg
is_a: sudokn_QualityCertificate
slots:
- rdfs_label
class_uri: sudokn:NADCAPCertificate
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_NADCAPCertificate
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
