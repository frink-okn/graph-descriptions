...
# Class: natural fiber processing capability (sudokn_NaturalFiberProcessingCapability)
...
URI: [sudokn:NaturalFiberProcessingCapability](http://asu.edu/semantics/SUDOKN/NaturalFiberProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknNaturalFiberProcessingCapability
    click SudoknNaturalFiberProcessingCapability href "../SudoknNaturalFiberProcessingCapability"
      ...
      SudoknNaturalFiberProcessingCapability : rdfs_label
        
          
    
    
    SudoknNaturalFiberProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknNaturalFiberProcessingCapability](../classes/SudoknNaturalFiberProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknNaturalFiberProcessingCapability](../classes/SudoknNaturalFiberProcessingCapability.md) |
...
| Value |
| --- |
| sudokn:BDCUSTOMMFG-NaturalFiber-inst |
...
| ---  | ---  |
| self | sudokn:NaturalFiberProcessingCapability |
| native | sudokn-kg/:SudoknNaturalFiberProcessingCapability |
...
<details>
```yaml
name: sudokn_NaturalFiberProcessingCapability
description: No type description provided
title: natural fiber processing capability
todos:
- TODO -- Todos for this class go here
- or you can delete the todos
- if you think the class is perfect.
...
examples:
- value: sudokn:BDCUSTOMMFG-NaturalFiber-inst
from_schema: sudokn-kg
rank: 1000
is_a: sudokn_FiberProcessingCapability
slots:
- rdfs_label
class_uri: sudokn:NaturalFiberProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_NaturalFiberProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
