...
# Class: TODO -- what's a good name for this class (type)? (sudokn_NAICS332911)
...
```mermaid
 classDiagram
    ...
    SudoknNAICS332911 --> "0..1" Any : sudokn_hasNAICSCodeValue
    click Any href "../Any"
    ...
    SudoknNAICS332911 --> "0..1" Any : sudokn_hasNAICSTextValue
    click Any href "../Any"
...
| ---  | ---  |
| self | sudokn:NAICS332911 |
| native | sudokn-kg/:SudoknNAICS332911 |
