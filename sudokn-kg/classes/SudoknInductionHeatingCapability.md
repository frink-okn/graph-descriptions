...
# Class: TODO -- what's a good name for this class (type)? (sudokn_InductionHeatingCapability)
...
URI: [sudokn:InductionHeatingCapability](http://asu.edu/semantics/SUDOKN/InductionHeatingCapability)
...
```mermaid
 classDiagram
    class SudoknInductionHeatingCapability
    click SudoknInductionHeatingCapability href "../SudoknInductionHeatingCapability"
      SudoknInductionHeatingCapability : rdfs_label
        
          
    
    
    SudoknInductionHeatingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknInductionHeatingCapability](../classes/SudoknInductionHeatingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknInductionHeatingCapability](../classes/SudoknInductionHeatingCapability.md) |
...
| Value |
| --- |
| sudokn:TheCouncilToolCompany-InductionHeating |
...
| ---  | ---  |
| self | sudokn:InductionHeatingCapability |
| native | sudokn-kg/:SudoknInductionHeatingCapability |
...
<details>
```yaml
name: sudokn_InductionHeatingCapability
...
examples:
- value: sudokn:TheCouncilToolCompany-InductionHeating
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:InductionHeatingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_InductionHeatingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
