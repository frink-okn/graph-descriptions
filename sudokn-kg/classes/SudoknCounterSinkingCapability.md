...
# Class: No class (type) name specified (sudokn_CounterSinkingCapability)
...
URI: [sudokn:CounterSinkingCapability](http://asu.edu/semantics/SUDOKN/CounterSinkingCapability)
...
```mermaid
 classDiagram
    class SudoknCounterSinkingCapability
    click SudoknCounterSinkingCapability href "../SudoknCounterSinkingCapability"
      ...
      SudoknCounterSinkingCapability : rdfs_label
        
          
    
    
    SudoknCounterSinkingCapability --> "0..1" String : rdfs_label
...
```yaml
name: sudokn_CounterSinkingCapability
...
class_uri: sudokn:CounterSinkingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_CounterSinkingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
    - owl_NamedIndividual
