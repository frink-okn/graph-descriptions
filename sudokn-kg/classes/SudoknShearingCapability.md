...
# Class: TODO -- what's a good name for this class (type)? (sudokn_ShearingCapability)
...
URI: [sudokn:ShearingCapability](http://asu.edu/semantics/SUDOKN/ShearingCapability)
...
```mermaid
 classDiagram
    class SudoknShearingCapability
    click SudoknShearingCapability href "../SudoknShearingCapability"
      SudoknShearingCapability : rdfs_label
        
          
    
    
    SudoknShearingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknShearingCapability](../classes/SudoknShearingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknShearingCapability](../classes/SudoknShearingCapability.md) |
...
| Value |
| --- |
| sudokn:ArcelorMittalPiedmont-Shearing |
...
| ---  | ---  |
| self | sudokn:ShearingCapability |
| native | sudokn-kg/:SudoknShearingCapability |
...
<details>
```yaml
name: sudokn_ShearingCapability
...
examples:
- value: sudokn:ArcelorMittalPiedmont-Shearing
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:ShearingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ShearingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
