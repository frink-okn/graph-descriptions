...
# Class: No class (type) name specified (sudokn_ProjectionWeldingCapability)
...
URI: [sudokn:ProjectionWeldingCapability](http://asu.edu/semantics/SUDOKN/ProjectionWeldingCapability)
...
```mermaid
 classDiagram
    class SudoknProjectionWeldingCapability
    click SudoknProjectionWeldingCapability href "../SudoknProjectionWeldingCapability"
      ...
      SudoknProjectionWeldingCapability : rdfs_label
        
          
    
    
    SudoknProjectionWeldingCapability --> "0..1" String : rdfs_label
...
```yaml
name: sudokn_ProjectionWeldingCapability
...
class_uri: sudokn:ProjectionWeldingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ProjectionWeldingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
    - owl_NamedIndividual
