...
# Class: TODO -- what's a good name for this class (type)? (sudokn_TungstenProcessingCapability)
...
URI: [sudokn:TungstenProcessingCapability](http://asu.edu/semantics/SUDOKN/TungstenProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknTungstenProcessingCapability
    click SudoknTungstenProcessingCapability href "../SudoknTungstenProcessingCapability"
      SudoknTungstenProcessingCapability : rdfs_label
        
          
    
    
    SudoknTungstenProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknTungstenProcessingCapability](../classes/SudoknTungstenProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknTungstenProcessingCapability](../classes/SudoknTungstenProcessingCapability.md) |
...
| Value |
| --- |
| sudokn:3DXINDUSTRIES-Tungsten-inst |
...
| ---  | ---  |
| self | sudokn:TungstenProcessingCapability |
| native | sudokn-kg/:SudoknTungstenProcessingCapability |
...
<details>
```yaml
name: sudokn_TungstenProcessingCapability
...
- if you think the class is perfect.
notes:
- Class with 820 occurences.
examples:
- value: sudokn:3DXINDUSTRIES-Tungsten-inst
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:TungstenProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_TungstenProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
