...
# Class: TODO -- what's a good name for this class (type)? (sudokn_ReamingCapability)
...
URI: [sudokn:ReamingCapability](http://asu.edu/semantics/SUDOKN/ReamingCapability)
...
```mermaid
 classDiagram
    ...
    click SudoknReamingCapability href "../SudoknReamingCapability"
      ...
      SudoknReamingCapability : rdfs_label
        
          
    
    
    SudoknReamingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknReamingCapability](../classes/SudoknReamingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknReamingCapability](../classes/SudoknReamingCapability.md) |
...
| Value |
| --- |
| sudokn:3DSYSTEMS-ReamingCapability-inst |
...
| ---  | ---  |
| self | sudokn:ReamingCapability |
| native | sudokn-kg/:SudoknReamingCapability |
...
- if you think the class is perfect.
notes:
- Class with 278 occurences.
examples:
- value: sudokn:3DSYSTEMS-ReamingCapability-inst
from_schema: sudokn-kg
is_a: sudokn_HoleMakingCapability
slots:
- rdfs_label
class_uri: sudokn:ReamingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ReamingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
