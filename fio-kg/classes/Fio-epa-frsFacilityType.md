...
# Class: Facility Type (fio-epa-frs_FacilityType)


_Type of Facility as defined by EPA FRS facility type controlled vocabulary_
...
URI: [fio-epa-frs:FacilityType](http://w3id.org/fio/v1/epa-frs#FacilityType)
...
```mermaid
 classDiagram
    class Fio-epa-frsFacilityType
    click Fio-epa-frsFacilityType href "../Fio-epa-frsFacilityType"
      OwlThing <|-- Fio-epa-frsFacilityType
        click OwlThing href "../OwlThing"
      
      Fio-epa-frsFacilityType : owl_sameAs
        
          
    
    
    Fio-epa-frsFacilityType --> "0..1" OwlThing : owl_sameAs
    click OwlThing href "../OwlThing"

        
      Fio-epa-frsFacilityType : rdfs_label
        
          
    
    
    Fio-epa-frsFacilityType --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| [owl_sameAs](../slots/owl_sameAs.md) | 0..1 <br/> [OwlThing](../classes/OwlThing.md) | The property that determines that two given individuals are equal <br/> No occurrences of this slot in the graph. | direct | 14 |
...
| ---  | --- | --- | --- |
| [Fio-epa-frsEPA-PFAS-Facility](../classes/Fio-epa-frsEPA-PFAS-Facility.md) | [fio_epa_frs_ofFacilityType](../slots/fio_epa_frs_ofFacilityType.md) | any_of[range] | [Fio-epa-frsFacilityType](../classes/Fio-epa-frsFacilityType.md) |
| [Fio-epa-frsFRS-Facility](../classes/Fio-epa-frsFRS-Facility.md) | [fio_epa_frs_ofFacilityType](../slots/fio_epa_frs_ofFacilityType.md) | any_of[range] | [Fio-epa-frsFacilityType](../classes/Fio-epa-frsFacilityType.md) |
...
```yaml
name: fio-epa-frs_FacilityType
description: Type of Facility as defined by EPA FRS facility type controlled vocabulary
title: Facility Type
from_schema: okns:fiokg
exact_mappings:
- http://w3id.org/fio/v1/epa-frs#FacilityType
rank: 1000
is_a: owl_Thing
slots:
- rdfs_label
- owl_sameAs
class_uri: fio-epa-frs:FacilityType
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: fio-epa-frs_FacilityType
    domain_of:
