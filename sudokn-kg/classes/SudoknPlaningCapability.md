...
# Class: TODO -- what's a good name for this class (type)? (sudokn_PlaningCapability)
...
URI: [sudokn:PlaningCapability](http://asu.edu/semantics/SUDOKN/PlaningCapability)
...
```mermaid
 classDiagram
    ...
    click SudoknPlaningCapability href "../SudoknPlaningCapability"
      ...
      SudoknPlaningCapability : rdfs_label
        
          
    
    
    SudoknPlaningCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknPlaningCapability](../classes/SudoknPlaningCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknPlaningCapability](../classes/SudoknPlaningCapability.md) |
...
| Value |
| --- |
| sudokn:APPALACHIANCAST-PlaningCapability-inst |
...
| ---  | ---  |
| self | sudokn:PlaningCapability |
| native | sudokn-kg/:SudoknPlaningCapability |
...
- if you think the class is perfect.
notes:
- Class with 17 occurences.
examples:
- value: sudokn:APPALACHIANCAST-PlaningCapability-inst
from_schema: sudokn-kg
rank: 1000
is_a: sudokn_SinglePointCuttingCapability
slots:
- rdfs_label
class_uri: sudokn:PlaningCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_PlaningCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
