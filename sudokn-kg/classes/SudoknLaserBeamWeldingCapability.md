...
# Class: TODO -- what's a good name for this class (type)? (sudokn_LaserBeamWeldingCapability)
...
| ---  | ---  |
| self | sudokn:LaserBeamWeldingCapability |
| native | sudokn-kg/:SudoknLaserBeamWeldingCapability |
