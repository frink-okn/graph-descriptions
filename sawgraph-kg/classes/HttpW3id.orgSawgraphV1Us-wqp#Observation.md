...
# Class: WQP - Observation (http___w3id.org_sawgraph_v1_us-wqp#Observation)
...
URI: [http://w3id.org/sawgraph/v1/us-wqp#Observation](http://w3id.org/sawgraph/v1/us-wqp#Observation)
...
```mermaid
 classDiagram
    class HttpW3id.orgSawgraphV1Us-wqp#Observation
    click HttpW3id.orgSawgraphV1Us-wqp#Observation href "../HttpW3id.orgSawgraphV1Us-wqp#Observation"
      CosoContaminantSampleObservation <|-- HttpW3id.orgSawgraphV1Us-wqp#Observation
        click CosoContaminantSampleObservation href "../CosoContaminantSampleObservation"
      
      HttpW3id.orgSawgraphV1Us-wqp#Observation : coso_analyzedSample
        
          
    
    
    HttpW3id.orgSawgraphV1Us-wqp#Observation --> "0..1" Any : coso_analyzedSample
    click Any href "../Any"

        
      HttpW3id.orgSawgraphV1Us-wqp#Observation : coso_hasFeatureOfInterest
        
          
    
    
    HttpW3id.orgSawgraphV1Us-wqp#Observation --> "0..1" Any : coso_hasFeatureOfInterest
    click Any href "../Any"

        
      HttpW3id.orgSawgraphV1Us-wqp#Observation : coso_hasResult
        
          
    
    
    HttpW3id.orgSawgraphV1Us-wqp#Observation --> "0..1" Any : coso_hasResult
    click Any href "../Any"

        
      HttpW3id.orgSawgraphV1Us-wqp#Observation : coso_observedAtSamplePoint
        
          
    
    
    HttpW3id.orgSawgraphV1Us-wqp#Observation --> "0..1" Any : coso_observedAtSamplePoint
    click Any href "../Any"

        
      HttpW3id.orgSawgraphV1Us-wqp#Observation : coso_observedProperty
        
          
    
    
    HttpW3id.orgSawgraphV1Us-wqp#Observation --> "0..1" Any : coso_observedProperty
    click Any href "../Any"

        
      HttpW3id.orgSawgraphV1Us-wqp#Observation : coso_observedTime
        
          
    
    
    HttpW3id.orgSawgraphV1Us-wqp#Observation --> "0..1" Any : coso_observedTime
    click Any href "../Any"

        
      HttpW3id.orgSawgraphV1Us-wqp#Observation : coso_ofDatasetSubstance
        
          
    
    
    HttpW3id.orgSawgraphV1Us-wqp#Observation --> "0..1" Any : coso_ofDatasetSubstance
    click Any href "../Any"

        
      HttpW3id.orgSawgraphV1Us-wqp#Observation : prov_wasAttributedTo
        
          
    
    
    HttpW3id.orgSawgraphV1Us-wqp#Observation --> "0..1" ProvAgent : prov_wasAttributedTo
    click ProvAgent href "../ProvAgent"

        
      HttpW3id.orgSawgraphV1Us-wqp#Observation : rdfs_label
        
          
    
    
    HttpW3id.orgSawgraphV1Us-wqp#Observation --> "0..1" Any : rdfs_label
    click Any href "../Any"

        
      HttpW3id.orgSawgraphV1Us-wqp#Observation : sosa_resultTime
        
          
    
    
    HttpW3id.orgSawgraphV1Us-wqp#Observation --> "0..1" Any : sosa_resultTime
    click Any href "../Any"
...
```yaml
name: http___w3id.org_sawgraph_v1_us-wqp#Observation
title: WQP - Observation
...
- coso_ofDatasetSubstance
- rdfs_label
- sosa_resultTime
- coso_hasFeatureOfInterest
class_uri: http://w3id.org/sawgraph/v1/us-wqp#Observation
...
attributes:
  coso_observedAtSamplePoint:
    ...
    owner: http___w3id.org_sawgraph_v1_us-wqp#Observation
    domain_of:
  ...
  coso_ofDatasetSubstance:
    ...
    description: A relation between an entity and a chemical substance as identified
      in a dataset specific controlled vocabulary
