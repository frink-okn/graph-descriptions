...
# Class: HttpsIdir.uta.eduSockg-ontology#YieldNutrientUptake




This class occurs 704 times.


URI: [https://idir.uta.edu/sockg-ontology#YieldNutrientUptake](https://idir.uta.edu/sockg-ontology#YieldNutrientUptake)
...
```mermaid
 classDiagram
    ...
    click HttpsIdir.uta.eduSockg-ontology#YieldNutrientUptake href "../HttpsIdir.uta.eduSockg-ontology#YieldNutrientUptake"
      ...
      HttpsIdir.uta.eduSockg-ontology#YieldNutrientUptake : dct_date
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#YieldNutrientUptake --> "0..1" RdfsLiteral : dct_date
    click RdfsLiteral href "../RdfsLiteral"

        
      HttpsIdir.uta.eduSockg-ontology#YieldNutrientUptake : https___idir.uta.edu_sockg_ontology#fromUnit
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#YieldNutrientUptake --> "0..1" Any : https___idir.uta.edu_sockg_ontology#fromUnit
    click Any href "../Any"

        
      HttpsIdir.uta.eduSockg-ontology#YieldNutrientUptake : https___idir.uta.edu_sockg_ontology#hasCrop
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#YieldNutrientUptake --> "0..1" HttpsLod.nal.usda.govNalt7140 : https___idir.uta.edu_sockg_ontology#hasCrop
    click HttpsLod.nal.usda.govNalt7140 href "../HttpsLod.nal.usda.govNalt7140"

        
      HttpsIdir.uta.eduSockg-ontology#YieldNutrientUptake : https___idir.uta.edu_sockg_ontology#hasGrowthStage
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#YieldNutrientUptake --> "0..1" HttpsIdir.uta.eduSockg-ontology#GrowthStage : https___idir.uta.edu_sockg_ontology#hasGrowthStage
    click HttpsIdir.uta.eduSockg-ontology#GrowthStage href "../HttpsIdir.uta.eduSockg-ontology#GrowthStage"

        
      HttpsIdir.uta.eduSockg-ontology#YieldNutrientUptake : https___idir.uta.edu_sockg_ontology#hasMeasurement
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#YieldNutrientUptake --> "0..1" HttpsIdir.uta.eduSockg-ontology#Measurement : https___idir.uta.edu_sockg_ontology#hasMeasurement
    click HttpsIdir.uta.eduSockg-ontology#Measurement href "../HttpsIdir.uta.eduSockg-ontology#Measurement"

        
      HttpsIdir.uta.eduSockg-ontology#YieldNutrientUptake : https___idir.uta.edu_sockg_ontology#hasPlantFraction
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#YieldNutrientUptake --> "0..1" Any : https___idir.uta.edu_sockg_ontology#hasPlantFraction
    click Any href "../Any"

        
      HttpsIdir.uta.eduSockg-ontology#YieldNutrientUptake : https___idir.uta.edu_sockg_ontology#usesTreatment
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#YieldNutrientUptake --> "0..1" Any : https___idir.uta.edu_sockg_ontology#usesTreatment
    click Any href "../Any"
...
| ---  | --- | --- | --- | --- |
| [https___idir.uta.edu_sockg_ontology#fromUnit](../slots/https___idir.uta.edu_sockg_ontology#fromUnit.md) | 0..1 <br/> [xsd:anyURI](http://www.w3.org/2001/XMLSchema#anyURI)&nbsp;or&nbsp;<br />[HttpsIdir.uta.eduSockg-ontology#ExperimentalUnit](../classes/HttpsIdir.uta.eduSockg-ontology#ExperimentalUnit.md) |  <br/>  | direct | 704 |
| [https___idir.uta.edu_sockg_ontology#hasPlantFraction](../slots/https___idir.uta.edu_sockg_ontology#hasPlantFraction.md) | 0..1 <br/> [HttpsIdir.uta.eduSockg-ontology#PlantFractionRelatedMeasurement](../classes/HttpsIdir.uta.eduSockg-ontology#PlantFractionRelatedMeasurement.md)&nbsp;or&nbsp;<br />[HttpsIdir.uta.eduSockg-ontology#PlantFraction](../classes/HttpsIdir.uta.eduSockg-ontology#PlantFraction.md) |  <br/>  | direct | 704 |
| [https___idir.uta.edu_sockg_ontology#hasMeasurement](../slots/https___idir.uta.edu_sockg_ontology#hasMeasurement.md) | 0..1 <br/> [HttpsIdir.uta.eduSockg-ontology#Measurement](../classes/HttpsIdir.uta.eduSockg-ontology#Measurement.md) |  <br/>  | direct | 2252 |
| [https___idir.uta.edu_sockg_ontology#usesTreatment](../slots/https___idir.uta.edu_sockg_ontology#usesTreatment.md) | 0..1 <br/> [xsd:anyURI](http://www.w3.org/2001/XMLSchema#anyURI)&nbsp;or&nbsp;<br />[HttpsIdir.uta.eduSockg-ontology#Treatment](../classes/HttpsIdir.uta.eduSockg-ontology#Treatment.md) |  <br/>  | direct | 704 |
| [dct_date](../slots/dct_date.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md) | Date may be used to express temporal information at any level of granularity <br/> description: A point or period of time associated with an event in the lifecycle of the resource. | direct | 704 |
| [https___idir.uta.edu_sockg_ontology#hasGrowthStage](../slots/https___idir.uta.edu_sockg_ontology#hasGrowthStage.md) | 0..1 <br/> [HttpsIdir.uta.eduSockg-ontology#GrowthStage](../classes/HttpsIdir.uta.eduSockg-ontology#GrowthStage.md) |  <br/>  | direct | 704 |
| [https___idir.uta.edu_sockg_ontology#hasCrop](../slots/https___idir.uta.edu_sockg_ontology#hasCrop.md) | 0..1 <br/> [HttpsLod.nal.usda.govNalt7140](../classes/HttpsLod.nal.usda.govNalt7140.md) |  <br/>  | direct | 704 |
...
```yaml
name: https___idir.uta.edu_sockg-ontology#YieldNutrientUptake
...
class_uri: https://idir.uta.edu/sockg-ontology#YieldNutrientUptake
...
attributes:
  https___idir.uta.edu_sockg-ontology#fromUnit:
    ...
    owner: https___idir.uta.edu_sockg-ontology#YieldNutrientUptake
    domain_of:
