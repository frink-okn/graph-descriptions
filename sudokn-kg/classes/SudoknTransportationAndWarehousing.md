...
# Class: No class (type) name specified (sudokn_TransportationAndWarehousing)
...
URI: [sudokn:TransportationAndWarehousing](http://asu.edu/semantics/SUDOKN/TransportationAndWarehousing)
...
```mermaid
 classDiagram
    class SudoknTransportationAndWarehousing
    click SudoknTransportationAndWarehousing href "../SudoknTransportationAndWarehousing"
      ...
      SudoknTransportationAndWarehousing : sudokn_hasNAICSCodeValue
        
          
    
    
    SudoknTransportationAndWarehousing --> "0..1" Any : sudokn_hasNAICSCodeValue
    click Any href "../Any"

        
      SudoknTransportationAndWarehousing : sudokn_hasNAICSTextValue
        
          
    
    
    SudoknTransportationAndWarehousing --> "0..1" Any : sudokn_hasNAICSTextValue
    click Any href "../Any"
...
```yaml
name: sudokn_TransportationAndWarehousing
...
class_uri: sudokn:TransportationAndWarehousing
...
attributes:
  sudokn_hasNAICSCodeValue:
    ...
    owner: sudokn_TransportationAndWarehousing
    domain_of:
    - sudokn_NAICS332111
    - sudokn_NAICS332112
    - sudokn_NAICS332114
