...
# Class: TODO -- what's a good name for this class (type)? (sudokn_AcrylicFabricationCapability)
...
URI: [sudokn:AcrylicFabricationCapability](http://asu.edu/semantics/SUDOKN/AcrylicFabricationCapability)
...
```mermaid
 classDiagram
    class SudoknAcrylicFabricationCapability
    click SudoknAcrylicFabricationCapability href "../SudoknAcrylicFabricationCapability"
      SudoknAcrylicFabricationCapability : rdfs_label
        
          
    
    
    SudoknAcrylicFabricationCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknAcrylicFabricationCapability](../classes/SudoknAcrylicFabricationCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknAcrylicFabricationCapability](../classes/SudoknAcrylicFabricationCapability.md) |
...
| Value |
| --- |
| sudokn:applerock-AcrylicFabrication |
...
| ---  | ---  |
| self | sudokn:AcrylicFabricationCapability |
| native | sudokn-kg/:SudoknAcrylicFabricationCapability |
...
<details>
```yaml
name: sudokn_AcrylicFabricationCapability
...
examples:
- value: sudokn:applerock-AcrylicFabrication
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:AcrylicFabricationCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_AcrylicFabricationCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
