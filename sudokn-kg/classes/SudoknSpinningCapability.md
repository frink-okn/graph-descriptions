...
# Class: spinning capability (sudokn_SpinningCapability)
...
URI: [sudokn:SpinningCapability](http://asu.edu/semantics/SUDOKN/SpinningCapability)
...
```mermaid
 classDiagram
    class SudoknSpinningCapability
    click SudoknSpinningCapability href "../SudoknSpinningCapability"
      ...
      SudoknSpinningCapability : rdfs_label
        
          
    
    
    SudoknSpinningCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknSpinningCapability](../classes/SudoknSpinningCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknSpinningCapability](../classes/SudoknSpinningCapability.md) |
...
| Value |
| --- |
| sudokn:ACMEMETALSPINNING-SpinningCapability-inst |
...
| ---  | ---  |
| self | sudokn:SpinningCapability |
| native | sudokn-kg/:SudoknSpinningCapability |
...
<details>
```yaml
name: sudokn_SpinningCapability
description: TODO -- tell the world what this class (type) describes.
title: spinning capability
todos:
- TODO -- Todos for this class go here
- or you can delete the todos
- if you think the class is perfect.
...
examples:
- value: sudokn:ACMEMETALSPINNING-SpinningCapability-inst
from_schema: sudokn-kg
is_a: sudokn_SheetMetalProcessingCapability
slots:
- rdfs_label
class_uri: sudokn:SpinningCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_SpinningCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
