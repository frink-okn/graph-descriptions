...
# Class: TODO -- what's a good name for this class (type)? (sudokn_CeramicMoldCastingCapability)
...
URI: [sudokn:CeramicMoldCastingCapability](http://asu.edu/semantics/SUDOKN/CeramicMoldCastingCapability)
...
```mermaid
 classDiagram
    class SudoknCeramicMoldCastingCapability
    click SudoknCeramicMoldCastingCapability href "../SudoknCeramicMoldCastingCapability"
      SudoknCeramicMoldCastingCapability : rdfs_label
        
          
    
    
    SudoknCeramicMoldCastingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCeramicMoldCastingCapability](../classes/SudoknCeramicMoldCastingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCeramicMoldCastingCapability](../classes/SudoknCeramicMoldCastingCapability.md) |
...
| Value |
| --- |
| sudokn:MODERNALUMINUM-CeramicMoldCastingCapability-inst |
...
| ---  | ---  |
| self | sudokn:CeramicMoldCastingCapability |
| native | sudokn-kg/:SudoknCeramicMoldCastingCapability |
...
<details>
```yaml
name: sudokn_CeramicMoldCastingCapability
...
examples:
- value: sudokn:MODERNALUMINUM-CeramicMoldCastingCapability-inst
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:CeramicMoldCastingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_CeramicMoldCastingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
