...
# Class: vacuum molding capability (sudokn_VacuumMoldingCapability)





URI: [sudokn:VacuumMoldingCapability](http://asu.edu/semantics/SUDOKN/VacuumMoldingCapability)
...
```mermaid
 classDiagram
    class SudoknVacuumMoldingCapability
    click SudoknVacuumMoldingCapability href "../SudoknVacuumMoldingCapability"
      ...
      SudoknVacuumMoldingCapability : rdfs_label
        
          
    
    
    SudoknVacuumMoldingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: sudokn_VacuumMoldingCapability
title: vacuum molding capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_MoldingCapability
class_uri: sudokn:VacuumMoldingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_VacuumMoldingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
