...
```mermaid
 classDiagram
    ...
    click SudoknMechanicalJoiningCapability href "../SudoknMechanicalJoiningCapability"
      ...
      SudoknMechanicalJoiningCapability <|-- SudoknPressFittingCapability
        click SudoknPressFittingCapability href "../SudoknPressFittingCapability"
    ...
    SudoknMechanicalJoiningCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
    ...
    * [SudoknManufacturingProcessCapability](../classes/SudoknManufacturingProcessCapability.md)
        * [SudoknJoiningCapability](../classes/SudoknJoiningCapability.md)
            * **SudoknMechanicalJoiningCapability**
                ...
                * [SudoknPressFittingCapability](../classes/SudoknPressFittingCapability.md)
