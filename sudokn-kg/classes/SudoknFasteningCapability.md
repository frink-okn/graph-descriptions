...
# Class: TODO -- what's a good name for this class (type)? (sudokn_FasteningCapability)
...
URI: [sudokn:FasteningCapability](http://asu.edu/semantics/SUDOKN/FasteningCapability)
...
```mermaid
 classDiagram
    class SudoknFasteningCapability
    click SudoknFasteningCapability href "../SudoknFasteningCapability"
      SudoknFasteningCapability : rdfs_label
        
          
    
    
    SudoknFasteningCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknFasteningCapability](../classes/SudoknFasteningCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknFasteningCapability](../classes/SudoknFasteningCapability.md) |
...
| Value |
| --- |
| sudokn:HEICOFASTENERS-Fastening |
...
| ---  | ---  |
| self | sudokn:FasteningCapability |
| native | sudokn-kg/:SudoknFasteningCapability |
...
<details>
```yaml
name: sudokn_FasteningCapability
...
examples:
- value: sudokn:HEICOFASTENERS-Fastening
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:FasteningCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_FasteningCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
