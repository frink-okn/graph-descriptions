...
URI: [sockg:YieldNutrientUptake](https://idir.uta.edu/sockg-ontology/docs/YieldNutrientUptake)
...
```mermaid
 classDiagram
    ...
    click SockgYieldNutrientUptake href "../SockgYieldNutrientUptake"
      SockgYieldNutrientUptake : rdfs_seeAlso
        
          
    
    
    SockgYieldNutrientUptake --> "0..1" Uri : rdfs_seeAlso
    click Uri href "../Uri"
    ...
    SockgYieldNutrientUptake --> "0..1" String : sockg_crop
    ...
    SockgYieldNutrientUptake --> "0..1" Any : sockg_fracCarbon_kgC_ha
    click Any href "../Any"

        
      SockgYieldNutrientUptake : sockg_fracCarbonSd_kgC_ha
        
          
    
    
    SockgYieldNutrientUptake --> "0..1" Any : sockg_fracCarbonSd_kgC_ha
    click Any href "../Any"
    ...
    SockgYieldNutrientUptake --> "0..1" Any : sockg_fracCopper_gCu_ha
    click Any href "../Any"

        
      SockgYieldNutrientUptake : sockg_fracCopperSd_gCu_ha
        
          
    
    
    SockgYieldNutrientUptake --> "0..1" Any : sockg_fracCopperSd_gCu_ha
    click Any href "../Any"
    ...
    SockgYieldNutrientUptake --> "0..1" Any : sockg_fracCropProductivity_kg_ha
    click Any href "../Any"
    ...
    SockgYieldNutrientUptake --> "0..1" Any : sockg_fracIron_gFe_ha
    click Any href "../Any"

        
      SockgYieldNutrientUptake : sockg_fracIronSd_gFe_ha
        
          
    
    
    SockgYieldNutrientUptake --> "0..1" Any : sockg_fracIronSd_gFe_ha
    click Any href "../Any"
    ...
    SockgYieldNutrientUptake --> "0..1" Any : sockg_fracManganese_gMn_ha
    click Any href "../Any"

        
      SockgYieldNutrientUptake : sockg_fracManganeseSd_gMn_ha
        
          
    
    
    SockgYieldNutrientUptake --> "0..1" Any : sockg_fracManganeseSd_gMn_ha
    click Any href "../Any"
    ...
    SockgYieldNutrientUptake --> "0..1" Any : sockg_fracMoisturePercent
    click Any href "../Any"
    ...
    SockgYieldNutrientUptake --> "0..1" Any : sockg_fracNitrogen_kgN_ha
    click Any href "../Any"

        
      SockgYieldNutrientUptake : sockg_fracNitrogenSd_kgN_ha
        
          
    
    
    SockgYieldNutrientUptake --> "0..1" Any : sockg_fracNitrogenSd_kgN_ha
    click Any href "../Any"

        
      SockgYieldNutrientUptake : sockg_fracProductivitySd_kg_ha
        
          
    
    
    SockgYieldNutrientUptake --> "0..1" Any : sockg_fracProductivitySd_kg_ha
    click Any href "../Any"
    ...
    SockgYieldNutrientUptake --> "0..1" Any : sockg_fracZinc_gZn_ha
    click Any href "../Any"

        
      SockgYieldNutrientUptake : sockg_fracZincSd_gZn_ha
        
          
    
    
    SockgYieldNutrientUptake --> "0..1" Any : sockg_fracZincSd_gZn_ha
    click Any href "../Any"
    ...
    SockgYieldNutrientUptake --> "0..1" String : sockg_growthStage
    click String href "../String"
    ...
    SockgYieldNutrientUptake --> "0..1" String : sockg_plantFraction
    click String href "../String"
    ...
    SockgYieldNutrientUptake --> "0..1" Any : sockg_treatmentId
    click Any href "../Any"
...
annotations:
  count:
    tag: count
    value: 429
description: The YieldNutrientUptake class represents the assessment of nutrient uptake
  by crops during different growth stages, essential for understanding the efficiency
  of nutrient use in agricultural practices. It facilitates the analysis of various
  nutrients' contributions to crop productivity and helps in optimizing fertilization
