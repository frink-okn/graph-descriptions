...
# Class: small hole drilling capability (sudokn_SmallHoleDrillingCapability)





URI: [sudokn:SmallHoleDrillingCapability](http://asu.edu/semantics/SUDOKN/SmallHoleDrillingCapability)
...
```mermaid
 classDiagram
    class SudoknSmallHoleDrillingCapability
    click SudoknSmallHoleDrillingCapability href "../SudoknSmallHoleDrillingCapability"
      ...
      SudoknSmallHoleDrillingCapability : rdfs_label
        
          
    
    
    SudoknSmallHoleDrillingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject | [SudoknDrillingCapability](../classes/SudoknDrillingCapability.md), [SudoknMachiningCapability](../classes/SudoknMachiningCapability.md) |  |
...
```yaml
name: sudokn_SmallHoleDrillingCapability
title: small hole drilling capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_DrillingCapability
class_uri: sudokn:SmallHoleDrillingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_SmallHoleDrillingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
