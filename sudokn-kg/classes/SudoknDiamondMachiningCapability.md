...
# Class: diamond machining capability (sudokn_DiamondMachiningCapability)





URI: [sudokn:DiamondMachiningCapability](http://asu.edu/semantics/SUDOKN/DiamondMachiningCapability)
...
```mermaid
 classDiagram
    class SudoknDiamondMachiningCapability
    click SudoknDiamondMachiningCapability href "../SudoknDiamondMachiningCapability"
      ...
      SudoknDiamondMachiningCapability : rdfs_label
        
          
    
    
    SudoknDiamondMachiningCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
* polycrystaline diamond machining
...
```yaml
name: sudokn_DiamondMachiningCapability
title: diamond machining capability
from_schema: okns:sudokn-kg
aliases:
- polycrystaline diamond machining
rank: 1000
is_a: sudokn_SinglePointCuttingCapability
class_uri: sudokn:DiamondMachiningCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_DiamondMachiningCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
