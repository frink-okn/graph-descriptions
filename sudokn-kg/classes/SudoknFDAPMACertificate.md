...
# Class: FDA-PMA certificate (sudokn_FDAPMACertificate)





URI: [sudokn:FDAPMACertificate](http://asu.edu/semantics/SUDOKN/FDAPMACertificate)
...
```mermaid
 classDiagram
    ...
    click SudoknFDAPMACertificate href "../SudoknFDAPMACertificate"
      ...
      SudoknFDAPMACertificate : rdfs_label
        
          
    
    
    SudoknFDAPMACertificate --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject | [SudoknFDACertificate](../classes/SudoknFDACertificate.md) |  |
...
```yaml
name: sudokn_FDAPMACertificate
title: FDA-PMA certificate
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_FDACertificate
class_uri: sudokn:FDAPMACertificate
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_FDAPMACertificate
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
