...
# Class: WQP - Characteristic (http___w3id.org_sawgraph_v1_us-wqp#Characteristic)
...
URI: [http://w3id.org/sawgraph/v1/us-wqp#Characteristic](http://w3id.org/sawgraph/v1/us-wqp#Characteristic)
...
```mermaid
 classDiagram
    class HttpW3id.orgSawgraphV1Us-wqp#Characteristic
    click HttpW3id.orgSawgraphV1Us-wqp#Characteristic href "../HttpW3id.orgSawgraphV1Us-wqp#Characteristic"
      ...
      HttpW3id.orgSawgraphV1Us-wqp#Characteristic : coso_casNumber
        
          
    
    
    HttpW3id.orgSawgraphV1Us-wqp#Characteristic --> "0..1" String : coso_casNumber
    click String href "../String"

        
      HttpW3id.orgSawgraphV1Us-wqp#Characteristic : http___w3id.org_comptox_v1_sameAsComptoxSubstance
        
          
    
    
    HttpW3id.orgSawgraphV1Us-wqp#Characteristic --> "0..1" HttpW3id.orgComptoxV1ChemicalEntity : http___w3id.org_comptox_v1_sameAsComptoxSubstance
    click HttpW3id.orgComptoxV1ChemicalEntity href "../HttpW3id.orgComptoxV1ChemicalEntity"

        
      HttpW3id.orgSawgraphV1Us-wqp#Characteristic : http___w3id.org_sawgraph_v1_us_wqp#groupName
        
          
    
    
    HttpW3id.orgSawgraphV1Us-wqp#Characteristic --> "0..1" String : http___w3id.org_sawgraph_v1_us_wqp#groupName
    click String href "../String"

        
      HttpW3id.orgSawgraphV1Us-wqp#Characteristic : http___w3id.org_sawgraph_v1_us_wqp#srsID
        
          
    
    
    HttpW3id.orgSawgraphV1Us-wqp#Characteristic --> "0..1" String : http___w3id.org_sawgraph_v1_us_wqp#srsID
    click String href "../String"

        
      HttpW3id.orgSawgraphV1Us-wqp#Characteristic : rdfs_label
        
          
    
    
    HttpW3id.orgSawgraphV1Us-wqp#Characteristic --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- | --- |
| [http___w3id.org_comptox_v1_sameAsComptoxSubstance](../slots/http___w3id.org_comptox_v1_sameAsComptoxSubstance.md) | 0..1 <br/> [HttpW3id.orgComptoxV1ChemicalEntity](../classes/HttpW3id.orgComptoxV1ChemicalEntity.md) | A relation between an dataset specific substance and the same substance as id... <br/>  | direct | 45 |
| [coso_casNumber](../slots/coso_casNumber.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string) | The cas number of the substance <br/>  | direct | 40 |
| [http___w3id.org_sawgraph_v1_us_wqp#srsID](../slots/http___w3id.org_sawgraph_v1_us_wqp#srsID.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string) |  <br/>  | direct | 47 |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject <br/>  | direct | 50 |
| [http___w3id.org_sawgraph_v1_us_wqp#groupName](../slots/http___w3id.org_sawgraph_v1_us_wqp#groupName.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string) |  <br/>  | direct | 50 |
...
| ---  | --- | --- | --- |
| [HttpW3id.orgSawgraphV1Me-egad#EGAD-PFAS-Observation](../classes/HttpW3id.orgSawgraphV1Me-egad#EGAD-PFAS-Observation.md) | [CosoOfDatasetSubstance](../classes/CosoOfDatasetSubstance.md) | any_of[range] | [HttpW3id.orgSawgraphV1Us-wqp#Characteristic](../classes/HttpW3id.orgSawgraphV1Us-wqp#Characteristic.md) |
| [HttpW3id.orgSawgraphV1Us-wqp#Characteristic](../classes/HttpW3id.orgSawgraphV1Us-wqp#Characteristic.md) | [http___w3id.org_sawgraph_v1_us_wqp#srsID](../slots/http___w3id.org_sawgraph_v1_us_wqp#srsID.md) | domain | [HttpW3id.orgSawgraphV1Us-wqp#Characteristic](../classes/HttpW3id.orgSawgraphV1Us-wqp#Characteristic.md) |
| [HttpW3id.orgSawgraphV1Us-wqp#Characteristic](../classes/HttpW3id.orgSawgraphV1Us-wqp#Characteristic.md) | [http___w3id.org_sawgraph_v1_us_wqp#groupName](../slots/http___w3id.org_sawgraph_v1_us_wqp#groupName.md) | domain | [HttpW3id.orgSawgraphV1Us-wqp#Characteristic](../classes/HttpW3id.orgSawgraphV1Us-wqp#Characteristic.md) |
| [HttpW3id.orgSawgraphV1Us-wqp#Observation](../classes/HttpW3id.orgSawgraphV1Us-wqp#Observation.md) | [CosoOfDatasetSubstance](../classes/CosoOfDatasetSubstance.md) | any_of[range] | [HttpW3id.orgSawgraphV1Us-wqp#Characteristic](../classes/HttpW3id.orgSawgraphV1Us-wqp#Characteristic.md) |
...
```yaml
name: http___w3id.org_sawgraph_v1_us-wqp#Characteristic
title: WQP - Characteristic
...
- coso_casNumber
- http___w3id.org_sawgraph_v1_us-wqp#srsID
- rdfs_label
- http___w3id.org_sawgraph_v1_us-wqp#groupName
class_uri: http://w3id.org/sawgraph/v1/us-wqp#Characteristic
...
attributes:
  http___w3id.org_comptox_v1_sameAsComptoxSubstance:
    ...
    owner: http___w3id.org_sawgraph_v1_us-wqp#Characteristic
    domain_of:
  ...
  coso_casNumber:
    ...
    range: string
  http___w3id.org_sawgraph_v1_us-wqp#srsID:
    name: http___w3id.org_sawgraph_v1_us-wqp#srsID
    title: wqp - characteristic substance registry service ID
    from_schema: okns:sawgraph-kg
    rank: 1000
    domain: http___w3id.org_sawgraph_v1_us-wqp#Characteristic
    slot_uri: http://w3id.org/sawgraph/v1/us-wqp#srsID
    alias: http___w3id.org_sawgraph_v1_us_wqp#srsID
    owner: http___w3id.org_sawgraph_v1_us-wqp#Characteristic
    domain_of:
    - http___w3id.org_sawgraph_v1_us-wqp#Characteristic
    subproperty_of: coso_substanceID
  ...
  rdfs_label:
    ...
    - range: string
  http___w3id.org_sawgraph_v1_us-wqp#groupName:
    name: http___w3id.org_sawgraph_v1_us-wqp#groupName
    title: wqp - characteristic group name
    from_schema: okns:sawgraph-kg
    rank: 1000
    domain: http___w3id.org_sawgraph_v1_us-wqp#Characteristic
    slot_uri: http://w3id.org/sawgraph/v1/us-wqp#groupName
    alias: http___w3id.org_sawgraph_v1_us_wqp#groupName
    owner: http___w3id.org_sawgraph_v1_us-wqp#Characteristic
    domain_of:
    - http___w3id.org_sawgraph_v1_us-wqp#Characteristic
    range: string
