...
# Class: No class (type) name specified (sudokn_WoodProcessingCapability)
...
This class occurs 2918 times.


URI: [sudokn:WoodProcessingCapability](http://asu.edu/semantics/SUDOKN/WoodProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknWoodProcessingCapability
    click SudoknWoodProcessingCapability href "../SudoknWoodProcessingCapability"
      ...
      SudoknWoodProcessingCapability : rdfs_label
        
          
    
    
    SudoknWoodProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string) | No slot (predicate) description specified <br/>  | direct | 2918 |
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknWoodProcessingCapability](../classes/SudoknWoodProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknWoodProcessingCapability](../classes/SudoknWoodProcessingCapability.md) |
  ...
  rdfs_label:
    ...
    annotations:
      string:
        tag: string
        value: 2918
class_uri: sudokn:WoodProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_WoodProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
    - owl_NamedIndividual
