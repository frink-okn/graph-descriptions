...
URI: [memgs:MGS-Well](http://sawgraph.spatialai.org/v1/me-mgs#MGS-Well)
...
```mermaid
 classDiagram
    ...
    click MemgsMGS-Well href "../MemgsMGS-Well"
      ...
      MemgsMGS-Well : geo_hasSerialization
        
          
    
    
    MemgsMGS-Well --> "0..1" GeoWktLiteral : geo_hasSerialization
...
| ---  | ---  |
| self | memgs:MGS-Well |
| native | sawgraph-kg/:MemgsMGS-Well |
