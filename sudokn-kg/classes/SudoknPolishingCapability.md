...
# Class: TODO -- what's a good name for this class (type)? (sudokn_PolishingCapability)
...
```mermaid
 classDiagram
    ...
    SudoknPolishingCapability --> "0..1" String : rdfs_label
...
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknPolishingCapability](../classes/SudoknPolishingCapability.md) |
...
| Value |
| --- |
| sudokn:A1POLISHING-PolishingCapability-inst |
...
| ---  | ---  |
| self | sudokn:PolishingCapability |
| native | sudokn-kg/:SudoknPolishingCapability |
...
- if you think the class is perfect.
notes:
- Class with 456 occurences.
examples:
- value: sudokn:A1POLISHING-PolishingCapability-inst
