...
# Class: EGAD - Result Type (http___w3id.org_sawgraph_v1_me-egad#EGAD-ResultType)
...
URI: [http://w3id.org/sawgraph/v1/me-egad#EGAD-ResultType](http://w3id.org/sawgraph/v1/me-egad#EGAD-ResultType)
...
```mermaid
 classDiagram
    class HttpW3id.orgSawgraphV1Me-egad#EGAD-ResultType
    click HttpW3id.orgSawgraphV1Me-egad#EGAD-ResultType href "../HttpW3id.orgSawgraphV1Me-egad#EGAD-ResultType"
      ...
      HttpW3id.orgSawgraphV1Me-egad#EGAD-ResultType : owl_sameAs
        
          
    
    
    HttpW3id.orgSawgraphV1Me-egad#EGAD-ResultType --> "0..1" OwlThing : owl_sameAs
    click OwlThing href "../OwlThing"

        
      HttpW3id.orgSawgraphV1Me-egad#EGAD-ResultType : rdfs_label
        
          
    
    
    HttpW3id.orgSawgraphV1Me-egad#EGAD-ResultType --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- |
| [HttpW3id.orgSawgraphV1Me-egad#EGAD-PFAS-Observation](../classes/HttpW3id.orgSawgraphV1Me-egad#EGAD-PFAS-Observation.md) | [http___w3id.org_sawgraph_v1_me_egad#resultType](../slots/http___w3id.org_sawgraph_v1_me_egad#resultType.md) | any_of[range] | [HttpW3id.orgSawgraphV1Me-egad#EGAD-ResultType](../classes/HttpW3id.orgSawgraphV1Me-egad#EGAD-ResultType.md) |
| [HttpW3id.orgSawgraphV1Me-egad#EGAD-PFAS-Observation](../classes/HttpW3id.orgSawgraphV1Me-egad#EGAD-PFAS-Observation.md) | [coso_observationAnnotation](../slots/coso_observationAnnotation.md) | any_of[range] | [HttpW3id.orgSawgraphV1Me-egad#EGAD-ResultType](../classes/HttpW3id.orgSawgraphV1Me-egad#EGAD-ResultType.md) |
| [MeEgadEGAD-PFAS-Observation](../classes/MeEgadEGAD-PFAS-Observation.md) | [coso_observationAnnotation](../slots/coso_observationAnnotation.md) | any_of[range] | [HttpW3id.orgSawgraphV1Me-egad#EGAD-ResultType](../classes/HttpW3id.orgSawgraphV1Me-egad#EGAD-ResultType.md) |
...
```yaml
name: http___w3id.org_sawgraph_v1_me-egad#EGAD-ResultType
...
- rdfs_label
- owl_sameAs
class_uri: http://w3id.org/sawgraph/v1/me-egad#EGAD-ResultType
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: http___w3id.org_sawgraph_v1_me-egad#EGAD-ResultType
    domain_of:
