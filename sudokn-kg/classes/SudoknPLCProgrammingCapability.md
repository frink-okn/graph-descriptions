...
# Class: PLC programming capability (sudokn_PLCProgrammingCapability)
...
URI: [sudokn:PLCProgrammingCapability](http://asu.edu/semantics/SUDOKN/PLCProgrammingCapability)
...
```mermaid
 classDiagram
    class SudoknPLCProgrammingCapability
    click SudoknPLCProgrammingCapability href "../SudoknPLCProgrammingCapability"
      ...
      SudoknPLCProgrammingCapability : rdfs_label
        
          
    
    
    SudoknPLCProgrammingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknPLCProgrammingCapability](../classes/SudoknPLCProgrammingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknPLCProgrammingCapability](../classes/SudoknPLCProgrammingCapability.md) |
...
| ---  | ---  |
| self | sudokn:PLCProgrammingCapability |
| native | sudokn-kg/:SudoknPLCProgrammingCapability |
...
<details>
```yaml
name: sudokn_PLCProgrammingCapability
description: No type description provided
title: PLC programming capability
todos:
- TODO -- Todos for this class go here
- or you can delete the todos
- if you think the class is perfect.
...
examples:
- value: sudokn:Alotech-PLCProgramming
from_schema: sudokn-kg
rank: 1000
is_a: sudokn_EngineeringCapability
slots:
- rdfs_label
class_uri: sudokn:PLCProgrammingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_PLCProgrammingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
