...
```mermaid
 classDiagram
    ...
    click HttpsClimatepub4kg.github.ioOntology#Project href "../HttpsClimatepub4kg.github.ioOntology#Project"
      ...
      HttpsClimatepub4kg.github.ioOntology#Institute : neo4j_name
        
          
    
    
    HttpsClimatepub4kg.github.ioOntology#Institute --> "0..1" String : neo4j_name
    click String href "../String"

        
      HttpsClimatepub4kg.github.ioOntology#Institute : neo4j_names
        
          
    
    
    HttpsClimatepub4kg.github.ioOntology#Institute --> "0..1" String : neo4j_names
    click String href "../String"

        
      HttpsClimatepub4kg.github.ioOntology#Institute : neo4j_uuid
        
          
    
    
    HttpsClimatepub4kg.github.ioOntology#Institute --> "0..1" String : neo4j_uuid
    click String href "../String"
...
| ---  | --- | --- | --- | --- |
| [neo4j_uuid](../slots/neo4j_uuid.md) | 0..1 <br/> [xsd:string](xsd:string) |  <br/>  | direct | 132 |
...
| [neo4j_name](../slots/neo4j_name.md) | 0..1 <br/> [xsd:string](xsd:string) |  <br/>  | direct | 132 |
| [neo4j_names](../slots/neo4j_names.md) | 0..1 <br/> [xsd:string](xsd:string) |  <br/>  | direct | 132 |
