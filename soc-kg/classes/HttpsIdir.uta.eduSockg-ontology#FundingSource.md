...
# Class: HttpsIdir.uta.eduSockg-ontology#FundingSource
...
URI: [https://idir.uta.edu/sockg-ontology#FundingSource](https://idir.uta.edu/sockg-ontology#FundingSource)
...
```mermaid
 classDiagram
    ...
    click HttpsIdir.uta.eduSockg-ontology#FundingSource href "../HttpsIdir.uta.eduSockg-ontology#FundingSource"
      HttpsIdir.uta.eduSockg-ontology#FundingSource : rdfs_label
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#FundingSource --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- |
| [HttpsIdir.uta.eduSockg-ontology#Location](../classes/HttpsIdir.uta.eduSockg-ontology#Location.md) | [https___idir.uta.edu_sockg_ontology#fundedBy](../slots/https___idir.uta.edu_sockg_ontology#fundedBy.md) | range | [HttpsIdir.uta.eduSockg-ontology#FundingSource](../classes/HttpsIdir.uta.eduSockg-ontology#FundingSource.md) |
...
```yaml
name: https___idir.uta.edu_sockg-ontology#FundingSource
from_schema: okns:soc-kg
rank: 1000
slots:
- rdfs_label
class_uri: https://idir.uta.edu/sockg-ontology#FundingSource
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: https___idir.uta.edu_sockg-ontology#FundingSource
    domain_of:
