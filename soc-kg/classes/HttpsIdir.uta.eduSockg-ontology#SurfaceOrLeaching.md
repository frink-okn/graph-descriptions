...
# Class: HttpsIdir.uta.eduSockg-ontology#SurfaceOrLeaching
...
URI: [https://idir.uta.edu/sockg-ontology#SurfaceOrLeaching](https://idir.uta.edu/sockg-ontology#SurfaceOrLeaching)
...
```mermaid
 classDiagram
    ...
    click HttpsIdir.uta.eduSockg-ontology#SurfaceOrLeaching href "../HttpsIdir.uta.eduSockg-ontology#SurfaceOrLeaching"
      HttpsIdir.uta.eduSockg-ontology#SurfaceOrLeaching : rdfs_label
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#SurfaceOrLeaching --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: https___idir.uta.edu_sockg-ontology#SurfaceOrLeaching
from_schema: okns:soc-kg
rank: 1000
slots:
- rdfs_label
class_uri: https://idir.uta.edu/sockg-ontology#SurfaceOrLeaching
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: https___idir.uta.edu_sockg-ontology#SurfaceOrLeaching
    domain_of:
    - qudt_AspectClass
    - qudt_BinaryPrefix
