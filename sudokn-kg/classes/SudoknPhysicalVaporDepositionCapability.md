...
# Class: TODO -- what's a good name for this class (type)? (sudokn_PhysicalVaporDepositionCapability)
...
URI: [sudokn:PhysicalVaporDepositionCapability](http://asu.edu/semantics/SUDOKN/PhysicalVaporDepositionCapability)
...
```mermaid
 classDiagram
    class SudoknPhysicalVaporDepositionCapability
    click SudoknPhysicalVaporDepositionCapability href "../SudoknPhysicalVaporDepositionCapability"
      ...
      SudoknPhysicalVaporDepositionCapability : rdfs_label
        
          
    
    
    SudoknPhysicalVaporDepositionCapability --> "0..1" String : rdfs_label
        ...
        * [SudoknFinishingCapability](../classes/SudoknFinishingCapability.md)
            * [SudoknCoatingCapability](../classes/SudoknCoatingCapability.md)
                * [SudoknThermalCoatingCapability](../classes/SudoknThermalCoatingCapability.md)
                    * [SudoknVaporizedMetalCoatingCapability](../classes/SudoknVaporizedMetalCoatingCapability.md)
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknPhysicalVaporDepositionCapability](../classes/SudoknPhysicalVaporDepositionCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknPhysicalVaporDepositionCapability](../classes/SudoknPhysicalVaporDepositionCapability.md) |
...
| Value |
| --- |
| sudokn:ACCESSOPTICS-PhysicalVaporDepositionCapability-inst |
...
| ---  | ---  |
| self | sudokn:PhysicalVaporDepositionCapability |
| native | sudokn-kg/:SudoknPhysicalVaporDepositionCapability |
...
<details>
```yaml
name: sudokn_PhysicalVaporDepositionCapability
...
- if you think the class is perfect.
notes:
- Class with 10 occurences.
examples:
- value: sudokn:ACCESSOPTICS-PhysicalVaporDepositionCapability-inst
from_schema: sudokn-kg
rank: 1000
is_a: sudokn_VaporizedMetalCoatingCapability
slots:
- rdfs_label
class_uri: sudokn:PhysicalVaporDepositionCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_PhysicalVaporDepositionCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
