...
# Class: SudoknDisabledVeteranOwned





URI: [sudokn:DisabledVeteranOwned](http://asu.edu/semantics/SUDOKN/DisabledVeteranOwned)
...
```mermaid
 classDiagram
    ...
    click SudoknDisabledVeteranOwned href "../SudoknDisabledVeteranOwned"
      ...
      SudoknDisabledVeteranOwned : rdfs_label
        
          
    
    
    SudoknDisabledVeteranOwned --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: sudokn_DisabledVeteranOwned
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_OwnershipStatusClassifier
class_uri: sudokn:DisabledVeteranOwned
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_DisabledVeteranOwned
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
