...
# Class: plunge grinding capability (sudokn_PlungeGrindingCapability)





URI: [sudokn:PlungeGrindingCapability](http://asu.edu/semantics/SUDOKN/PlungeGrindingCapability)
...
```mermaid
 classDiagram
    class SudoknPlungeGrindingCapability
    click SudoknPlungeGrindingCapability href "../SudoknPlungeGrindingCapability"
      ...
      SudoknPlungeGrindingCapability : rdfs_label
        
          
    
    
    SudoknPlungeGrindingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: sudokn_PlungeGrindingCapability
title: plunge grinding capability
from_schema: okns:sudokn-kg
aliases:
- infeed grinding capability
rank: 1000
is_a: sudokn_GrindingCapability
class_uri: sudokn:PlungeGrindingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_PlungeGrindingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
