...
# Class: TODO -- what's a good name for this class (type)? (sudokn_PalladiumProcessingCapability)
...
URI: [sudokn:PalladiumProcessingCapability](http://asu.edu/semantics/SUDOKN/PalladiumProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknPalladiumProcessingCapability
    click SudoknPalladiumProcessingCapability href "../SudoknPalladiumProcessingCapability"
      SudoknPalladiumProcessingCapability : rdfs_label
        
          
    
    
    SudoknPalladiumProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknPalladiumProcessingCapability](../classes/SudoknPalladiumProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknPalladiumProcessingCapability](../classes/SudoknPalladiumProcessingCapability.md) |
...
| Value |
| --- |
| sudokn:AARONMANUFACTURING-Palladium-inst |
...
| ---  | ---  |
| self | sudokn:PalladiumProcessingCapability |
| native | sudokn-kg/:SudoknPalladiumProcessingCapability |
...
<details>
```yaml
name: sudokn_PalladiumProcessingCapability
...
- if you think the class is perfect.
notes:
- Class with 78 occurences.
examples:
- value: sudokn:AARONMANUFACTURING-Palladium-inst
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:PalladiumProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_PalladiumProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
