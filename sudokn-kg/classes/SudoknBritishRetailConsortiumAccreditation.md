...
# Class: TODO -- what's a good name for this class (type)? (sudokn_BritishRetailConsortiumAccreditation)
...
URI: [sudokn:BritishRetailConsortiumAccreditation](http://asu.edu/semantics/SUDOKN/BritishRetailConsortiumAccreditation)
...
```mermaid
 classDiagram
    class SudoknBritishRetailConsortiumAccreditation
    click SudoknBritishRetailConsortiumAccreditation href "../SudoknBritishRetailConsortiumAccreditation"
      SudoknBritishRetailConsortiumAccreditation : rdfs_label
        
          
    
    
    SudoknBritishRetailConsortiumAccreditation --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasCertificate](../slots/sudokn_hasCertificate.md) | any_of[range] | [SudoknBritishRetailConsortiumAccreditation](../classes/SudoknBritishRetailConsortiumAccreditation.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasCertificate](../slots/sudokn_hasCertificate.md) | any_of[range] | [SudoknBritishRetailConsortiumAccreditation](../classes/SudoknBritishRetailConsortiumAccreditation.md) |
...
| Value |
| --- |
| sudokn:ContainerProductsCorporation-BritishRetailConsortiumAccreditation |
...
| ---  | ---  |
| self | sudokn:BritishRetailConsortiumAccreditation |
| native | sudokn-kg/:SudoknBritishRetailConsortiumAccreditation |
...
<details>
```yaml
name: sudokn_BritishRetailConsortiumAccreditation
...
slots:
- rdfs_label
class_uri: sudokn:BritishRetailConsortiumAccreditation
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_BritishRetailConsortiumAccreditation
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
