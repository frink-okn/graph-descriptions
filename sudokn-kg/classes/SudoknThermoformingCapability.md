...
# Class: TODO -- what's a good name for this class (type)? (sudokn_ThermoformingCapability)
...
URI: [sudokn:ThermoformingCapability](http://asu.edu/semantics/SUDOKN/ThermoformingCapability)
...
```mermaid
 classDiagram
    class SudoknThermoformingCapability
    click SudoknThermoformingCapability href "../SudoknThermoformingCapability"
      SudoknThermoformingCapability : rdfs_label
        
          
    
    
    SudoknThermoformingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknThermoformingCapability](../classes/SudoknThermoformingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknThermoformingCapability](../classes/SudoknThermoformingCapability.md) |
...
| Value |
| --- |
| sudokn:DouglasFabricationandMachine-Thermoforming |
...
| ---  | ---  |
| self | sudokn:ThermoformingCapability |
| native | sudokn-kg/:SudoknThermoformingCapability |
...
<details>
```yaml
name: sudokn_ThermoformingCapability
...
examples:
- value: sudokn:DouglasFabricationandMachine-Thermoforming
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:ThermoformingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ThermoformingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
