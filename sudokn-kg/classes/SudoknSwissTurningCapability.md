...
# Class: TODO -- what's a good name for this class (type)? (sudokn_SwissTurningCapability)
...
URI: [sudokn:SwissTurningCapability](http://asu.edu/semantics/SUDOKN/SwissTurningCapability)
...
```mermaid
 classDiagram
    class SudoknSwissTurningCapability
    click SudoknSwissTurningCapability href "../SudoknSwissTurningCapability"
      SudoknSwissTurningCapability : rdfs_label
        
          
    
    
    SudoknSwissTurningCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknSwissTurningCapability](../classes/SudoknSwissTurningCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknSwissTurningCapability](../classes/SudoknSwissTurningCapability.md) |
...
| Value |
| --- |
| sudokn:JMCToolAndMachine-SwissTurning |
...
| ---  | ---  |
| self | sudokn:SwissTurningCapability |
| native | sudokn-kg/:SudoknSwissTurningCapability |
...
<details>
```yaml
name: sudokn_SwissTurningCapability
...
examples:
- value: sudokn:JMCToolAndMachine-SwissTurning
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:SwissTurningCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_SwissTurningCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
