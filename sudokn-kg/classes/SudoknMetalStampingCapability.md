...
# Class: TODO -- what's a good name for this class (type)? (sudokn_MetalStampingCapability)
...
URI: [sudokn:MetalStampingCapability](http://asu.edu/semantics/SUDOKN/MetalStampingCapability)
...
```mermaid
 classDiagram
    class SudoknMetalStampingCapability
    click SudoknMetalStampingCapability href "../SudoknMetalStampingCapability"
      SudoknMetalStampingCapability : rdfs_label
        
          
    
    
    SudoknMetalStampingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknMetalStampingCapability](../classes/SudoknMetalStampingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknMetalStampingCapability](../classes/SudoknMetalStampingCapability.md) |
...
| Value |
| --- |
| sudokn:HermanReevesSheetMetal-MetalStamping |
...
| ---  | ---  |
| self | sudokn:MetalStampingCapability |
| native | sudokn-kg/:SudoknMetalStampingCapability |
...
<details>
```yaml
name: sudokn_MetalStampingCapability
...
examples:
- value: sudokn:HermanReevesSheetMetal-MetalStamping
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:MetalStampingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_MetalStampingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
