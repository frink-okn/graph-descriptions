...
# Class: cyaniding capability (sudokn_CyanidingCapability)





URI: [sudokn:CyanidingCapability](http://asu.edu/semantics/SUDOKN/CyanidingCapability)
...
```mermaid
 classDiagram
    class SudoknCyanidingCapability
    click SudoknCyanidingCapability href "../SudoknCyanidingCapability"
      ...
      SudoknCyanidingCapability : rdfs_label
        
          
    
    
    SudoknCyanidingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: sudokn_CyanidingCapability
title: cyaniding capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_SurfaceHardeningCapability
class_uri: sudokn:CyanidingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_CyanidingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
