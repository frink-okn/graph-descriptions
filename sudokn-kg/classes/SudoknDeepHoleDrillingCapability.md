...
# Class: deep hole drilling capability (sudokn_DeepHoleDrillingCapability)
...
URI: [sudokn:DeepHoleDrillingCapability](http://asu.edu/semantics/SUDOKN/DeepHoleDrillingCapability)
...
```mermaid
 classDiagram
    class SudoknDeepHoleDrillingCapability
    click SudoknDeepHoleDrillingCapability href "../SudoknDeepHoleDrillingCapability"
      ...
      SudoknDeepHoleDrillingCapability <|-- SudoknGunDrillingCapability
        click SudoknGunDrillingCapability href "../SudoknGunDrillingCapability"
      
      
      SudoknDeepHoleDrillingCapability : rdfs_label
        
          
    
    
    SudoknDeepHoleDrillingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
                ...
                * [SudoknHoleMakingCapability](../classes/SudoknHoleMakingCapability.md)
                    * [SudoknDrillingCapability](../classes/SudoknDrillingCapability.md)
                        * **SudoknDeepHoleDrillingCapability**
                            * [SudoknGunDrillingCapability](../classes/SudoknGunDrillingCapability.md)
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknDeepHoleDrillingCapability](../classes/SudoknDeepHoleDrillingCapability.md) |
...
* deep hole machining capability
...
```yaml
name: sudokn_DeepHoleDrillingCapability
title: deep hole drilling capability
from_schema: okns:sudokn-kg
aliases:
- deep hole machining capability
rank: 1000
is_a: sudokn_DrillingCapability
slots:
- rdfs_label
class_uri: sudokn:DeepHoleDrillingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_DeepHoleDrillingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
