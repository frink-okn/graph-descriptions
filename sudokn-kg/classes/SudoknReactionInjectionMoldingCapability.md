...
# Class: reaction injection molding capability (sudokn_ReactionInjectionMoldingCapability)





URI: [sudokn:ReactionInjectionMoldingCapability](http://asu.edu/semantics/SUDOKN/ReactionInjectionMoldingCapability)
...
```mermaid
 classDiagram
    class SudoknReactionInjectionMoldingCapability
    click SudoknReactionInjectionMoldingCapability href "../SudoknReactionInjectionMoldingCapability"
      ...
      SudoknReactionInjectionMoldingCapability : rdfs_label
        
          
    
    
    SudoknReactionInjectionMoldingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: sudokn_ReactionInjectionMoldingCapability
title: reaction injection molding capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_InjectionMoldingCapability
class_uri: sudokn:ReactionInjectionMoldingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ReactionInjectionMoldingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
