...
# Class: No class (type) name specified (sudokn_GasBrazingCapability)
...
URI: [sudokn:GasBrazingCapability](http://asu.edu/semantics/SUDOKN/GasBrazingCapability)
...
```mermaid
 classDiagram
    class SudoknGasBrazingCapability
    click SudoknGasBrazingCapability href "../SudoknGasBrazingCapability"
      ...
      SudoknGasBrazingCapability : rdfs_label
        
          
    
    
    SudoknGasBrazingCapability --> "0..1" String : rdfs_label
...
```yaml
name: sudokn_GasBrazingCapability
...
class_uri: sudokn:GasBrazingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_GasBrazingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
    - owl_NamedIndividual
