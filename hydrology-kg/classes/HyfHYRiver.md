...
URI: [hyf:/HY_River](https://www.opengis.net/def/schema/hy_features/hyf/HY_River)
...
```mermaid
 classDiagram
    ...
    click HyfHYRiver href "../HyfHYRiver"
      ...
      HyfHYRiver : dct_title
        
          
    
    
    HyfHYRiver --> "0..1" Any : dct_title
    click Any href "../Any"

        
      HyfHYRiver : geo_defaultGeometry
        
          
    
    
    HyfHYRiver --> "0..1" GeoGeometry : geo_defaultGeometry
    click GeoGeometry href "../GeoGeometry"

        
      HyfHYRiver : geo_hasGeometry
        
          
    
    
    HyfHYRiver --> "0..1" GeoGeometry : geo_hasGeometry
    click GeoGeometry href "../GeoGeometry"

        
      HyfHYRiver : http___nhdplusv2.spatialai.org_v1_nhdplusv2#hasCOMID
        
          
    
    
    HyfHYRiver --> "0..1" String : http___nhdplusv2.spatialai.org_v1_nhdplusv2#hasCOMID
    click String href "../String"

        
      HyfHYRiver : http___nhdplusv2.spatialai.org_v1_nhdplusv2#hasFCODE
        
          
    
    
    HyfHYRiver --> "0..1" String : http___nhdplusv2.spatialai.org_v1_nhdplusv2#hasFCODE
    click String href "../String"

        
      HyfHYRiver : http___nhdplusv2.spatialai.org_v1_nhdplusv2#hasFTYPE
        
          
    
    
    HyfHYRiver --> "0..1" String : http___nhdplusv2.spatialai.org_v1_nhdplusv2#hasFTYPE
    click String href "../String"

        
      HyfHYRiver : http___nhdplusv2.spatialai.org_v1_nhdplusv2#hasReachCode
        
          
    
    
    HyfHYRiver --> "0..1" String : http___nhdplusv2.spatialai.org_v1_nhdplusv2#hasReachCode
    click String href "../String"

        
      HyfHYRiver : kwgo_sfContains
        
          
    
    
    HyfHYRiver --> "0..1" Any : kwgo_sfContains
    click Any href "../Any"

        
      HyfHYRiver : kwgo_sfCrosses
        
          
    
    
    HyfHYRiver --> "0..1" Any : kwgo_sfCrosses
    click Any href "../Any"

        
      HyfHYRiver : kwgo_sfOverlaps
        
          
    
    
    HyfHYRiver --> "0..1" Any : kwgo_sfOverlaps
    click Any href "../Any"

        
      HyfHYRiver : kwgo_sfTouches
        
          
    
    
    HyfHYRiver --> "0..1" Any : kwgo_sfTouches
    click Any href "../Any"

        
      HyfHYRiver : kwgo_spatialRelation
        
          
    
    
    HyfHYRiver --> "0..1" Any : kwgo_spatialRelation
    click Any href "../Any"

        
      HyfHYRiver : owl_sameAs
        
          
    
    
    HyfHYRiver --> "0..1" OwlThing : owl_sameAs
    click OwlThing href "../OwlThing"

        
      HyfHYRiver : rdfs_label
        
          
    
    
    HyfHYRiver --> "0..1" Any : rdfs_label
    click Any href "../Any"

        
      HyfHYRiver : sdos_name
        
          
    
    
    HyfHYRiver --> "0..1" SdosText : sdos_name
    click SdosText href "../SdosText"

        
      HyfHYRiver : spatial_connectedTo
        
          
    
    
    HyfHYRiver --> "0..1" Any : spatial_connectedTo
    click Any href "../Any"

        
      HyfHYRiver : spatial_spatiallyRelatedTo
        
          
    
    
    HyfHYRiver --> "0..1" Any : spatial_spatiallyRelatedTo
    click Any href "../Any"
