...
# Class: TODO -- what's a good name for this class (type)? (sudokn_PlatingCapability)
...
```mermaid
 classDiagram
    ...
    SudoknPlatingCapability --> "0..1" String : rdfs_label
...
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknPlatingCapability](../classes/SudoknPlatingCapability.md) |
...
| Value |
| --- |
| sudokn:AlliedMetalFinishing-Plating |
...
| ---  | ---  |
| self | sudokn:PlatingCapability |
| native | sudokn-kg/:SudoknPlatingCapability |
...
examples:
- value: sudokn:AlliedMetalFinishing-Plating
