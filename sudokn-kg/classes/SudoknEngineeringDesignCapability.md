...
# Class: engineering design capability (sudokn_EngineeringDesignCapability)
...
URI: [sudokn:EngineeringDesignCapability](http://asu.edu/semantics/SUDOKN/EngineeringDesignCapability)
...
```mermaid
 classDiagram
    class SudoknEngineeringDesignCapability
    click SudoknEngineeringDesignCapability href "../SudoknEngineeringDesignCapability"
      ...
      SudoknEngineeringDesignCapability : rdfs_label
        
          
    
    
    SudoknEngineeringDesignCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknEngineeringDesignCapability](../classes/SudoknEngineeringDesignCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknEngineeringDesignCapability](../classes/SudoknEngineeringDesignCapability.md) |
...
| Value |
| --- |
| sudokn:AirSystemComponentsTitus-EngineeringDesign |
...
| ---  | ---  |
| self | sudokn:EngineeringDesignCapability |
| native | sudokn-kg/:SudoknEngineeringDesignCapability |
...
<details>
```yaml
name: sudokn_EngineeringDesignCapability
...
examples:
- value: sudokn:AirSystemComponentsTitus-EngineeringDesign
from_schema: sudokn-kg
rank: 1000
is_a: sudokn_EngineeringCapability
slots:
- rdfs_label
class_uri: sudokn:EngineeringDesignCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_EngineeringDesignCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
