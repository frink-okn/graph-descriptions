...
```mermaid
 classDiagram
    ...
    click SudoknSurfacePreparationCapability href "../SudoknSurfacePreparationCapability"
      SudoknFinishingCapability <|-- SudoknSurfacePreparationCapability
    ...
    SudoknSurfacePreparationCapability --> "0..1" String : rdfs_label
...
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknSurfacePreparationCapability](../classes/SudoknSurfacePreparationCapability.md) |
...
| Value |
| --- |
| sudokn:3PINDUSTRIES-SurfacePreparationCapability-inst |
...
| ---  | ---  |
| self | sudokn:SurfacePreparationCapability |
| native | sudokn-kg/:SudoknSurfacePreparationCapability |
...
- if you think the class is perfect.
notes:
- Class with 550 occurences.
examples:
- value: sudokn:3PINDUSTRIES-SurfacePreparationCapability-inst
