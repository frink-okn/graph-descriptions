...
# Class: TODO -- what's a good name for this class (type)? (sudokn_MagnesiumProcessingCapability)
...
URI: [sudokn:MagnesiumProcessingCapability](http://asu.edu/semantics/SUDOKN/MagnesiumProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknMagnesiumProcessingCapability
    click SudoknMagnesiumProcessingCapability href "../SudoknMagnesiumProcessingCapability"
      SudoknMagnesiumProcessingCapability : rdfs_label
        
          
    
    
    SudoknMagnesiumProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknMagnesiumProcessingCapability](../classes/SudoknMagnesiumProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknMagnesiumProcessingCapability](../classes/SudoknMagnesiumProcessingCapability.md) |
...
| ---  | ---  |
| self | sudokn:MagnesiumProcessingCapability |
| native | sudokn-kg/:SudoknMagnesiumProcessingCapability |
...
<details>
```yaml
name: sudokn_MagnesiumProcessingCapability
...
- if you think the class is perfect.
notes:
- Class with 419 occurences.
examples:
- value: sudokn:A1JAYS-Magnesium-inst
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:MagnesiumProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_MagnesiumProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
