...
# Class: No class (entity type) name specified -- this class is noted as a superclass of another class in this graph but has not itself been defined. (sudokn_SurfaceHardeningCapability)





URI: [sudokn:SurfaceHardeningCapability](http://asu.edu/semantics/SUDOKN/SurfaceHardeningCapability)
...
```mermaid
 classDiagram
    class SudoknSurfaceHardeningCapability
    click SudoknSurfaceHardeningCapability href "../SudoknSurfaceHardeningCapability"
      SudoknHardeningCapability <|-- SudoknSurfaceHardeningCapability
        click SudoknHardeningCapability href "../SudoknHardeningCapability"
      

      SudoknSurfaceHardeningCapability <|-- SudoknCyanidingCapability
        click SudoknCyanidingCapability href "../SudoknCyanidingCapability"
      SudoknSurfaceHardeningCapability <|-- SudoknDiffusionHardeningCapability
        click SudoknDiffusionHardeningCapability href "../SudoknDiffusionHardeningCapability"
      SudoknSurfaceHardeningCapability <|-- SudoknVacuumHardeningCapability
        click SudoknVacuumHardeningCapability href "../SudoknVacuumHardeningCapability"
      
      
      SudoknSurfaceHardeningCapability : rdfs_label
        
          
    
    
    SudoknSurfaceHardeningCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
* [IoscProductionCapability](../classes/IoscProductionCapability.md)
    * [SudoknManufacturingProcessCapability](../classes/SudoknManufacturingProcessCapability.md)
        * [SudoknHeatTreatingCapability](../classes/SudoknHeatTreatingCapability.md)
            * [SudoknHardeningCapability](../classes/SudoknHardeningCapability.md)
                * **SudoknSurfaceHardeningCapability**
                    * [SudoknCyanidingCapability](../classes/SudoknCyanidingCapability.md)
                    * [SudoknDiffusionHardeningCapability](../classes/SudoknDiffusionHardeningCapability.md)
                    * [SudoknVacuumHardeningCapability](../classes/SudoknVacuumHardeningCapability.md)
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject | [SudoknHeatTreatingCapability](../classes/SudoknHeatTreatingCapability.md), [SudoknHardeningCapability](../classes/SudoknHardeningCapability.md) |  |
...
```yaml
name: sudokn_SurfaceHardeningCapability
title: No class (entity type) name specified -- this class is noted as a superclass
  of another class in this graph but has not itself been defined.
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_HardeningCapability
class_uri: sudokn:SurfaceHardeningCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_SurfaceHardeningCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
