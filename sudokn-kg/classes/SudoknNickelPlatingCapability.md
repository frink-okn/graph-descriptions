...
# Class: TODO -- what's a good name for this class (type)? (sudokn_NickelPlatingCapability)
...
URI: [sudokn:NickelPlatingCapability](http://asu.edu/semantics/SUDOKN/NickelPlatingCapability)
...
```mermaid
 classDiagram
    class SudoknNickelPlatingCapability
    click SudoknNickelPlatingCapability href "../SudoknNickelPlatingCapability"
      SudoknNickelPlatingCapability : rdfs_label
        
          
    
    
    SudoknNickelPlatingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknNickelPlatingCapability](../classes/SudoknNickelPlatingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknNickelPlatingCapability](../classes/SudoknNickelPlatingCapability.md) |
...
| Value |
| --- |
| sudokn:AlliedMetalFinishing-NickelPlating |
...
| ---  | ---  |
| self | sudokn:NickelPlatingCapability |
| native | sudokn-kg/:SudoknNickelPlatingCapability |
...
<details>
```yaml
name: sudokn_NickelPlatingCapability
...
examples:
- value: sudokn:AlliedMetalFinishing-NickelPlating
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:NickelPlatingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_NickelPlatingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
