...
# Class: offshore wind industry (sudokn_OffshoreWindIndustry)
...
URI: [sudokn:OffshoreWindIndustry](http://asu.edu/semantics/SUDOKN/OffshoreWindIndustry)
...
```mermaid
 classDiagram
    class SudoknOffshoreWindIndustry
    click SudoknOffshoreWindIndustry href "../SudoknOffshoreWindIndustry"
      ...
      SudoknOffshoreWindIndustry : rdfs_label
        
          
    
    
    SudoknOffshoreWindIndustry --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknOffshoreWindIndustry](../classes/SudoknOffshoreWindIndustry.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknOffshoreWindIndustry](../classes/SudoknOffshoreWindIndustry.md) |
...
| ---  | ---  |
| self | sudokn:OffshoreWindIndustry |
| native | sudokn-kg/:SudoknOffshoreWindIndustry |
...
<details>
```yaml
name: sudokn_OffshoreWindIndustry
description: TODO -- tell the world what this class (type) describes.
title: offshore wind industry
todos:
- TODO -- Todos for this class go here
- or you can delete the todos
- if you think the class is perfect.
...
examples:
- value: sudokn:OffshoreWind-Industry
from_schema: sudokn-kg
is_a: iosc_Industry
slots:
- rdfs_label
class_uri: sudokn:OffshoreWindIndustry
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_OffshoreWindIndustry
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
