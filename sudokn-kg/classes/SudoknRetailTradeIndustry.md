...
# Class: TODO -- what's a good name for this class (type)? (sudokn_RetailTradeIndustry)
...
URI: [sudokn:RetailTradeIndustry](http://asu.edu/semantics/SUDOKN/RetailTradeIndustry)
...
```mermaid
 classDiagram
    class SudoknRetailTradeIndustry
    click SudoknRetailTradeIndustry href "../SudoknRetailTradeIndustry"
      SudoknRetailTradeIndustry : rdfs_label
        
          
    
    
    SudoknRetailTradeIndustry --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknRetailTradeIndustry](../classes/SudoknRetailTradeIndustry.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknRetailTradeIndustry](../classes/SudoknRetailTradeIndustry.md) |
...
| ---  | ---  |
| self | sudokn:RetailTradeIndustry |
| native | sudokn-kg/:SudoknRetailTradeIndustry |
...
<details>
```yaml
name: sudokn_RetailTradeIndustry
...
examples:
- value: sudokn:RetailTrade-Industry
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:RetailTradeIndustry
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_RetailTradeIndustry
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
