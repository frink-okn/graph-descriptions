...
# Class: TODO -- what's a good name for this class (type)? (sudokn_AbrassiveMachiningCapability)
...
| ---  | ---  |
| self | sudokn:AbrassiveMachiningCapability |
| native | sudokn-kg/:SudoknAbrassiveMachiningCapability |
