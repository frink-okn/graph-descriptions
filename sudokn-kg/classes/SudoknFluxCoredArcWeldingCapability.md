...
# Class: flux-cored arc welding capability (sudokn_FluxCoredArcWeldingCapability)





URI: [sudokn:FluxCoredArcWeldingCapability](http://asu.edu/semantics/SUDOKN/FluxCoredArcWeldingCapability)
...
```mermaid
 classDiagram
    class SudoknFluxCoredArcWeldingCapability
    click SudoknFluxCoredArcWeldingCapability href "../SudoknFluxCoredArcWeldingCapability"
      ...
      SudoknFluxCoredArcWeldingCapability : rdfs_label
        
          
    
    
    SudoknFluxCoredArcWeldingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: sudokn_FluxCoredArcWeldingCapability
title: flux-cored arc welding capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_ElectricArcWeldingCapability
class_uri: sudokn:FluxCoredArcWeldingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_FluxCoredArcWeldingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
