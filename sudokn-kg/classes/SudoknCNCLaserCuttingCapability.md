...
# Class: TODO -- what's a good name for this class (type)? (sudokn_CNCLaserCuttingCapability)
...
URI: [sudokn:CNCLaserCuttingCapability](http://asu.edu/semantics/SUDOKN/CNCLaserCuttingCapability)
...
```mermaid
 classDiagram
    class SudoknCNCLaserCuttingCapability
    click SudoknCNCLaserCuttingCapability href "../SudoknCNCLaserCuttingCapability"
      ...
      SudoknCNCLaserCuttingCapability : rdfs_label
        
          
    
    
    SudoknCNCLaserCuttingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCNCLaserCuttingCapability](../classes/SudoknCNCLaserCuttingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCNCLaserCuttingCapability](../classes/SudoknCNCLaserCuttingCapability.md) |
...
| ---  | ---  |
| self | sudokn:CNCLaserCuttingCapability |
| native | sudokn-kg/:SudoknCNCLaserCuttingCapability |
...
<details>
```yaml
name: sudokn_CNCLaserCuttingCapability
...
is_a: sudokn_LaserCuttingCapability
slots:
- rdfs_label
class_uri: sudokn:CNCLaserCuttingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_CNCLaserCuttingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
