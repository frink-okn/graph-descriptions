...
```mermaid
 classDiagram
    ...
    SudoknPlasticProcessingCapability --> "0..1" String : rdfs_label
...
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknPlasticProcessingCapability](../classes/SudoknPlasticProcessingCapability.md) |
...
| ---  | ---  |
| self | sudokn:PlasticProcessingCapability |
| native | sudokn-kg/:SudoknPlasticProcessingCapability |
...
- if you think the class is perfect.
notes:
- Class with 4159 occurences.
examples:
- value: sudokn:149401-US-Plastic-inst
