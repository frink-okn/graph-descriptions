...
# Class: phosphate conversion coating capability (sudokn_PhosphateConversionCoatingCapability)





URI: [sudokn:PhosphateConversionCoatingCapability](http://asu.edu/semantics/SUDOKN/PhosphateConversionCoatingCapability)
...
```mermaid
 classDiagram
    class SudoknPhosphateConversionCoatingCapability
    click SudoknPhosphateConversionCoatingCapability href "../SudoknPhosphateConversionCoatingCapability"
      ...
      SudoknPhosphateConversionCoatingCapability : rdfs_label
        
          
    
    
    SudoknPhosphateConversionCoatingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: sudokn_PhosphateConversionCoatingCapability
title: phosphate conversion coating capability
from_schema: okns:sudokn-kg
aliases:
- phosphate coating
rank: 1000
is_a: sudokn_ChemicalConversionCoatingCapability
class_uri: sudokn:PhosphateConversionCoatingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_PhosphateConversionCoatingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
