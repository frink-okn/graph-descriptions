...
# Class: surface finishing capability (sudokn_SurfaceFinishingCapability)
...
URI: [sudokn:SurfaceFinishingCapability](http://asu.edu/semantics/SUDOKN/SurfaceFinishingCapability)
...
```mermaid
 classDiagram
    class SudoknSurfaceFinishingCapability
    click SudoknSurfaceFinishingCapability href "../SudoknSurfaceFinishingCapability"
      ...
      SudoknSurfaceFinishingCapability : rdfs_label
        
          
    
    
    SudoknSurfaceFinishingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject <br/>  | direct | 76 |
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknSurfaceFinishingCapability](../classes/SudoknSurfaceFinishingCapability.md) |
...
```yaml
name: sudokn_SurfaceFinishingCapability
...
slots:
- rdfs_label
class_uri: sudokn:SurfaceFinishingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_SurfaceFinishingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
