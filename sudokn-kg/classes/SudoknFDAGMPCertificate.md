...
# Class: FDA-GMP certificate (sudokn_FDAGMPCertificate)





URI: [sudokn:FDAGMPCertificate](http://asu.edu/semantics/SUDOKN/FDAGMPCertificate)
...
```mermaid
 classDiagram
    ...
    click SudoknFDAGMPCertificate href "../SudoknFDAGMPCertificate"
      ...
      SudoknFDAGMPCertificate : rdfs_label
        
          
    
    
    SudoknFDAGMPCertificate --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: sudokn_FDAGMPCertificate
title: FDA-GMP certificate
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_FDACertificate
class_uri: sudokn:FDAGMPCertificate
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_FDAGMPCertificate
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
