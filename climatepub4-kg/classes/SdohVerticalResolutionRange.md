...
# Class: TODO -- what's a good name for this class (type)? (sdoh_Vertical_Resolution_Range)
...
URI: [sdoh:Vertical_Resolution_Range](http://schema.org/Vertical_Resolution_Range)
...
```mermaid
 classDiagram
    class SdohVerticalResolutionRange
    click SdohVerticalResolutionRange href "../SdohVerticalResolutionRange"
      SdohVerticalResolutionRange : skos_broader
        
          
    
    
    SdohVerticalResolutionRange --> "0..1" Any : skos_broader
    click Any href "../Any"

        
      SdohVerticalResolutionRange : skos_prefLabel
        
          
    
    
    SdohVerticalResolutionRange --> "0..1" String : skos_prefLabel
...
| ---  | ---  |
| self | sdoh:Vertical_Resolution_Range |
| native | climatepub4-kg/:SdohVerticalResolutionRange |
...
<details>
```yaml
name: sdoh_Vertical_Resolution_Range
...
- skos_prefLabel
- skos_broader
class_uri: sdoh:Vertical_Resolution_Range
...
attributes:
  skos_prefLabel:
    ...
    owner: sdoh_Vertical_Resolution_Range
    domain_of:
    - sdoh_Activity
