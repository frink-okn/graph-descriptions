...
```mermaid
 classDiagram
    ...
    MeEgadEGAD-SiteType --> "0..1" String : rdfs_label
    ...
    MeEgadEGAD-SiteType --> "0..1" String : skos_definition
    click String href "../String"
...
| ---  | --- | --- | --- | --- |
| [skos_definition](../slots/skos_definition.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string) | No slot (predicate) description specified <br/>  | direct |  |
...
| [MeEgadEGAD-Site](../classes/MeEgadEGAD-Site.md) | [me_egad_siteType](../slots/me_egad_siteType.md) | any_of[range] | [MeEgadEGAD-SiteType](../classes/MeEgadEGAD-SiteType.md) |
