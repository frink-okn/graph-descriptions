...
# Class: Animal Material Sample (coso_AnimalMaterialSample)
...
URI: [coso:AnimalMaterialSample](http://w3id.org/coso/v1/contaminoso#AnimalMaterialSample)
...
```mermaid
 classDiagram
    class CosoAnimalMaterialSample
    click CosoAnimalMaterialSample href "../CosoAnimalMaterialSample"
      SosaSample <|-- CosoAnimalMaterialSample
        click SosaSample href "../SosaSample"
      
      CosoAnimalMaterialSample : coso_fromSamplePoint
        
          
    
    
    CosoAnimalMaterialSample --> "0..1" Any : coso_fromSamplePoint
    click Any href "../Any"

        
      CosoAnimalMaterialSample : coso_isSampleOf
        
          
    
    
    CosoAnimalMaterialSample --> "0..1" Any : coso_isSampleOf
    click Any href "../Any"

        
      CosoAnimalMaterialSample : coso_sampleAnnotation
        
          
    
    
    CosoAnimalMaterialSample --> "0..1" Any : coso_sampleAnnotation
    click Any href "../Any"

        
      CosoAnimalMaterialSample : coso_sampleOfMaterialType
        
          
    
    
    CosoAnimalMaterialSample --> "0..1" Any : coso_sampleOfMaterialType
    click Any href "../Any"

        
      CosoAnimalMaterialSample : dct_identifier
        
          
    
    
    CosoAnimalMaterialSample --> "0..1" RdfsLiteral : dct_identifier
    click RdfsLiteral href "../RdfsLiteral"

        
      CosoAnimalMaterialSample : http___w3id.org_sawgraph_v1_me_egad#sampleCollectionMethod
        
          
    
    
    CosoAnimalMaterialSample --> "0..1" Any : http___w3id.org_sawgraph_v1_me_egad#sampleCollectionMethod
    click Any href "../Any"

        
      CosoAnimalMaterialSample : owl_sameAs
        
          
    
    
    CosoAnimalMaterialSample --> "0..1" OwlThing : owl_sameAs
    click OwlThing href "../OwlThing"

        
      CosoAnimalMaterialSample : prov_wasAttributedTo
        
          
    
    
    CosoAnimalMaterialSample --> "0..1" ProvAgent : prov_wasAttributedTo
    click ProvAgent href "../ProvAgent"

        
      CosoAnimalMaterialSample : rdfs_label
        
          
    
    
    CosoAnimalMaterialSample --> "0..1" Any : rdfs_label
    click Any href "../Any"

        
      CosoAnimalMaterialSample : sosa_isSampleOf
        
          
    
    
    CosoAnimalMaterialSample --> "0..1" HttpW3id.orgSawgraphV1Me-egad#EGAD-SampledFeature : sosa_isSampleOf
...
| ---  | --- | --- | --- |
| [HttpW3id.orgSawgraphV1Me-egad#EGAD-PFAS-Observation](../classes/HttpW3id.orgSawgraphV1Me-egad#EGAD-PFAS-Observation.md) | [coso_analyzedSample](../slots/coso_analyzedSample.md) | any_of[range] | [CosoAnimalMaterialSample](../classes/CosoAnimalMaterialSample.md) |
| [HttpW3id.orgSawgraphV1Me-egad#EGAD-PFAS-Observation](../classes/HttpW3id.orgSawgraphV1Me-egad#EGAD-PFAS-Observation.md) | [coso_hasAnyFeatureOfInterest](../slots/coso_hasAnyFeatureOfInterest.md) | any_of[range] | [CosoAnimalMaterialSample](../classes/CosoAnimalMaterialSample.md) |
| [HttpW3id.orgSawgraphV1Us-wqp#Observation](../classes/HttpW3id.orgSawgraphV1Us-wqp#Observation.md) | [coso_analyzedSample](../slots/coso_analyzedSample.md) | any_of[range] | [CosoAnimalMaterialSample](../classes/CosoAnimalMaterialSample.md) |
| [MeEgadEGAD-PFAS-Observation](../classes/MeEgadEGAD-PFAS-Observation.md) | [coso_analyzedSample](../slots/coso_analyzedSample.md) | any_of[range] | [CosoAnimalMaterialSample](../classes/CosoAnimalMaterialSample.md) |
| [MeEgadEGAD-PFAS-Observation](../classes/MeEgadEGAD-PFAS-Observation.md) | [coso_hasAnyFeatureOfInterest](../slots/coso_hasAnyFeatureOfInterest.md) | any_of[range] | [CosoAnimalMaterialSample](../classes/CosoAnimalMaterialSample.md) |
...
```yaml
name: coso_AnimalMaterialSample
title: Animal Material Sample
...
- coso_fromSamplePoint
class_uri: coso:AnimalMaterialSample
...
attributes:
  coso_isSampleOf:
    ...
    owner: coso_AnimalMaterialSample
    domain_of:
