...
# Class: HttpW3id.orgSawgraphV1Us-wqp#InstrumentDetectionLevel




This class occurs 620 times.


URI: [http://w3id.org/sawgraph/v1/us-wqp#InstrumentDetectionLevel](http://w3id.org/sawgraph/v1/us-wqp#InstrumentDetectionLevel)
...
```mermaid
 classDiagram
    class HttpW3id.orgSawgraphV1Us-wqp#InstrumentDetectionLevel
    click HttpW3id.orgSawgraphV1Us-wqp#InstrumentDetectionLevel href "../HttpW3id.orgSawgraphV1Us-wqp#InstrumentDetectionLevel"
      HttpW3id.orgSawgraphV1Us-wqp#InstrumentDetectionLevel : qudt_hasUnit
        
          
    
    
    HttpW3id.orgSawgraphV1Us-wqp#InstrumentDetectionLevel --> "0..1" Any : qudt_hasUnit
    click Any href "../Any"

        
      HttpW3id.orgSawgraphV1Us-wqp#InstrumentDetectionLevel : qudt_numericValue
        
          
    
    
    HttpW3id.orgSawgraphV1Us-wqp#InstrumentDetectionLevel --> "0..1" QudtNumericUnion : qudt_numericValue
...
| ---  | --- | --- | --- | --- |
| [qudt_hasUnit](../slots/qudt_hasUnit.md) | 0..1 <br/> [QudtUnit](../classes/QudtUnit.md)&nbsp;or&nbsp;<br />[xsd:anyURI](http://www.w3.org/2001/XMLSchema#anyURI)&nbsp;or&nbsp;<br />[QudtContextualUnit](../classes/QudtContextualUnit.md)&nbsp;or&nbsp;<br />[QudtLogarithmicUnit](../classes/QudtLogarithmicUnit.md)&nbsp;or&nbsp;<br />[QudtCurrencyUnit](../classes/QudtCurrencyUnit.md)&nbsp;or&nbsp;<br />[QudtDerivedUnit](../classes/QudtDerivedUnit.md)&nbsp;or&nbsp;<br />[QudtCountingUnit](../classes/QudtCountingUnit.md) | This property relates a factor unit its unit <br/> description: This property relates a factor unit to its unit or a system of units with a unit of measure that is either a) defined by the system, or b) accepted for use by the system and is convertible to a unit of equivalent dimension that is defined by the system. Systems of units may distinguish between base and derived units. Base units are the units which measure the base quantities for the corresponding system of quantities. The base units are used to define units for all other quantities as products of powers of the base units. Such units are called derived units for the system.<br/>title: hasUnit | direct | 620 |
| [qudt_numericValue](../slots/qudt_numericValue.md) | 0..1 <br/> [QudtNumericUnion](../types/QudtNumericUnion.md) |  <br/>  | direct | 620 |
...
| ---  | --- | --- | --- |
| [HttpW3id.orgSawgraphV1Us-wqp#Single-PFAS-Concentration](../classes/HttpW3id.orgSawgraphV1Us-wqp#Single-PFAS-Concentration.md) | [coso_hasResultQualifier](../slots/coso_hasResultQualifier.md) | any_of[range] | [HttpW3id.orgSawgraphV1Us-wqp#InstrumentDetectionLevel](../classes/HttpW3id.orgSawgraphV1Us-wqp#InstrumentDetectionLevel.md) |
...
```yaml
name: http___w3id.org_sawgraph_v1_us-wqp#InstrumentDetectionLevel
from_schema: okns:sawgraph-kg
rank: 1000
slots:
- qudt_hasUnit
- qudt_numericValue
class_uri: http://w3id.org/sawgraph/v1/us-wqp#InstrumentDetectionLevel
...
attributes:
  qudt_hasUnit:
    ...
    alias: qudt_hasUnit
    owner: http___w3id.org_sawgraph_v1_us-wqp#InstrumentDetectionLevel
    domain_of:
