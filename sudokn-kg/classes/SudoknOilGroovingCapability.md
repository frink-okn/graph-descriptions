...
# Class: TODO -- what's a good name for this class (type)? (sudokn_OilGroovingCapability)
...
URI: [sudokn:OilGroovingCapability](http://asu.edu/semantics/SUDOKN/OilGroovingCapability)
...
```mermaid
 classDiagram
    class SudoknOilGroovingCapability
    click SudoknOilGroovingCapability href "../SudoknOilGroovingCapability"
      SudoknOilGroovingCapability : rdfs_label
        
          
    
    
    SudoknOilGroovingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknOilGroovingCapability](../classes/SudoknOilGroovingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknOilGroovingCapability](../classes/SudoknOilGroovingCapability.md) |
...
| Value |
| --- |
| sudokn:BUSCHPRECISION-OilGroovingCapability-inst |
...
| ---  | ---  |
| self | sudokn:OilGroovingCapability |
| native | sudokn-kg/:SudoknOilGroovingCapability |
...
<details>
```yaml
name: sudokn_OilGroovingCapability
...
examples:
- value: sudokn:BUSCHPRECISION-OilGroovingCapability-inst
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:OilGroovingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_OilGroovingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
