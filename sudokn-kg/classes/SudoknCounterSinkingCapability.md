...
# Class: TODO -- what's a good name for this class (type)? (sudokn_CounterSinkingCapability)
...
| ---  | ---  |
| self | sudokn:CounterSinkingCapability |
| native | sudokn-kg/:SudoknCounterSinkingCapability |
