...
# Class: HttpsIdir.uta.eduSockg-ontology#PesticideTarget
...
URI: [https://idir.uta.edu/sockg-ontology#PesticideTarget](https://idir.uta.edu/sockg-ontology#PesticideTarget)
...
```mermaid
 classDiagram
    ...
    click HttpsIdir.uta.eduSockg-ontology#PesticideTarget href "../HttpsIdir.uta.eduSockg-ontology#PesticideTarget"
      HttpsIdir.uta.eduSockg-ontology#PesticideTarget : rdfs_label
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#PesticideTarget --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: https___idir.uta.edu_sockg-ontology#PesticideTarget
from_schema: okns:soc-kg
rank: 1000
slots:
- rdfs_label
class_uri: https://idir.uta.edu/sockg-ontology#PesticideTarget
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: https___idir.uta.edu_sockg-ontology#PesticideTarget
    domain_of:
    - qudt_AspectClass
    - qudt_BinaryPrefix
