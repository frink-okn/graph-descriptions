...
# Class: gun drilling capability (sudokn_GunDrillingCapability)





URI: [sudokn:GunDrillingCapability](http://asu.edu/semantics/SUDOKN/GunDrillingCapability)
...
```mermaid
 classDiagram
    class SudoknGunDrillingCapability
    click SudoknGunDrillingCapability href "../SudoknGunDrillingCapability"
      ...
      SudoknGunDrillingCapability : rdfs_label
        
          
    
    
    SudoknGunDrillingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject | [SudoknDrillingCapability](../classes/SudoknDrillingCapability.md), [SudoknDeepHoleDrillingCapability](../classes/SudoknDeepHoleDrillingCapability.md), [SudoknMachiningCapability](../classes/SudoknMachiningCapability.md) |  |
...
```yaml
name: sudokn_GunDrillingCapability
title: gun drilling capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_DeepHoleDrillingCapability
class_uri: sudokn:GunDrillingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_GunDrillingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
