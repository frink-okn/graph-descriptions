...
# Class: No class (type) name specified (sudokn_MetalProcessingCapability)
...
```mermaid
 classDiagram
    ...
    SudoknMetalProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string) | No slot (predicate) description specified <br/>  | direct | 6560 |
...
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknMetalProcessingCapability](../classes/SudoknMetalProcessingCapability.md) |
