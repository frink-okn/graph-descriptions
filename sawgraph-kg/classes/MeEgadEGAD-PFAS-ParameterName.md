...
```mermaid
 classDiagram
    ...
    click MeEgadEGAD-PFAS-ParameterName href "../MeEgadEGAD-PFAS-ParameterName"
      ...
      MeEgadEGAD-PFAS-ParameterName : owl_sameAs
        
          
    
    
    MeEgadEGAD-PFAS-ParameterName --> "0..1" OwlThing : owl_sameAs
    click OwlThing href "../OwlThing"
    ...
    MeEgadEGAD-PFAS-ParameterName --> "0..1" Any : rdfs_label
    click Any href "../Any"
    ...
    MeEgadEGAD-PFAS-ParameterName --> "0..1" Any : skos_altLabel
    click Any href "../Any"
