...
# Class: wood product manufacturing industry (sudokn_WoodProductManufacturingIndustry)
...
```mermaid
 classDiagram
    ...
    SudoknWoodProductManufacturingIndustry --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
title: wood product manufacturing industry
