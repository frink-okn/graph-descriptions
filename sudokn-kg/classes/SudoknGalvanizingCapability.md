...
# Class: TODO -- what's a good name for this class (type)? (sudokn_GalvanizingCapability)
...
URI: [sudokn:GalvanizingCapability](http://asu.edu/semantics/SUDOKN/GalvanizingCapability)
...
```mermaid
 classDiagram
    class SudoknGalvanizingCapability
    click SudoknGalvanizingCapability href "../SudoknGalvanizingCapability"
      ...
      SudoknGalvanizingCapability : rdfs_label
        
          
    
    
    SudoknGalvanizingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknGalvanizingCapability](../classes/SudoknGalvanizingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknGalvanizingCapability](../classes/SudoknGalvanizingCapability.md) |
...
| Value |
| --- |
| sudokn:3ERP-GalvanizingCapability-inst |
...
| ---  | ---  |
| self | sudokn:GalvanizingCapability |
| native | sudokn-kg/:SudoknGalvanizingCapability |
...
<details>
```yaml
name: sudokn_GalvanizingCapability
...
- if you think the class is perfect.
notes:
- Class with 72 occurences.
examples:
- value: sudokn:3ERP-GalvanizingCapability-inst
from_schema: sudokn-kg
is_a: sudokn_CoatingCapability
slots:
- rdfs_label
class_uri: sudokn:GalvanizingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_GalvanizingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
