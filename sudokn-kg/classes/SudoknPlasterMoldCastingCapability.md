...
# Class: plaster mold casting capability (sudokn_PlasterMoldCastingCapability)
...
```mermaid
 classDiagram
    ...
    SudoknPlasterMoldCastingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
title: plaster mold casting capability
