...
# Class: hole making capability (sudokn_HoleMakingCapability)





URI: [sudokn:HoleMakingCapability](http://asu.edu/semantics/SUDOKN/HoleMakingCapability)
...
```mermaid
 classDiagram
    class SudoknHoleMakingCapability
    click SudoknHoleMakingCapability href "../SudoknHoleMakingCapability"
      ...
      SudoknHoleMakingCapability <|-- SudoknCounterBoringCapability
        click SudoknCounterBoringCapability href "../SudoknCounterBoringCapability"
      SudoknHoleMakingCapability <|-- SudoknCounterSinkingCapability
        click SudoknCounterSinkingCapability href "../SudoknCounterSinkingCapability"
      SudoknHoleMakingCapability <|-- SudoknDrillingCapability
        click SudoknDrillingCapability href "../SudoknDrillingCapability"
      SudoknHoleMakingCapability <|-- SudoknReamingCapability
        click SudoknReamingCapability href "../SudoknReamingCapability"
      SudoknHoleMakingCapability <|-- SudoknTappingCapability
        click SudoknTappingCapability href "../SudoknTappingCapability"
      
      
      SudoknHoleMakingCapability : rdfs_label
        
          
    
    
    SudoknHoleMakingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
        ...
        * [SudoknMachiningCapability](../classes/SudoknMachiningCapability.md)
            * [SudoknMultiPointCuttingCapability](../classes/SudoknMultiPointCuttingCapability.md)
                * **SudoknHoleMakingCapability**
                    * [SudoknCounterBoringCapability](../classes/SudoknCounterBoringCapability.md)
                    * [SudoknCounterSinkingCapability](../classes/SudoknCounterSinkingCapability.md)
                    * [SudoknDrillingCapability](../classes/SudoknDrillingCapability.md)
                    * [SudoknReamingCapability](../classes/SudoknReamingCapability.md)
                    * [SudoknTappingCapability](../classes/SudoknTappingCapability.md)
...
```yaml
name: sudokn_HoleMakingCapability
title: hole making capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_MultiPointCuttingCapability
class_uri: sudokn:HoleMakingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_HoleMakingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
