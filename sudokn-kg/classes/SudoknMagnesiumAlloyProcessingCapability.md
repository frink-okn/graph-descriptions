...
# Class: No class (type) name specified (sudokn_MagnesiumAlloyProcessingCapability)
...
URI: [sudokn:MagnesiumAlloyProcessingCapability](http://asu.edu/semantics/SUDOKN/MagnesiumAlloyProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknMagnesiumAlloyProcessingCapability
    click SudoknMagnesiumAlloyProcessingCapability href "../SudoknMagnesiumAlloyProcessingCapability"
      ...
      SudoknMagnesiumAlloyProcessingCapability : rdfs_label
        
          
    
    
    SudoknMagnesiumAlloyProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string) | No slot (predicate) description specified | [SudoknMetalProcessingCapability](../classes/SudoknMetalProcessingCapability.md) |  |
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_MagnesiumAlloyProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
    - owl_NamedIndividual
