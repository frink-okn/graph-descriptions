...
# Class: TODO -- what's a good name for this class (type)? (sudokn_GearCuttingCapability)
...
URI: [sudokn:GearCuttingCapability](http://asu.edu/semantics/SUDOKN/GearCuttingCapability)
...
```mermaid
 classDiagram
    class SudoknGearCuttingCapability
    click SudoknGearCuttingCapability href "../SudoknGearCuttingCapability"
      ...
      SudoknGearCuttingCapability : rdfs_label
        
          
    
    
    SudoknGearCuttingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknGearCuttingCapability](../classes/SudoknGearCuttingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknGearCuttingCapability](../classes/SudoknGearCuttingCapability.md) |
...
| Value |
| --- |
| sudokn:BrintleMachineWorks-GearCutting |
...
| ---  | ---  |
| self | sudokn:GearCuttingCapability |
| native | sudokn-kg/:SudoknGearCuttingCapability |
...
<details>
```yaml
name: sudokn_GearCuttingCapability
...
examples:
- value: sudokn:BrintleMachineWorks-GearCutting
from_schema: sudokn-kg
rank: 1000
is_a: sudokn_MultiPointCuttingCapability
slots:
- rdfs_label
class_uri: sudokn:GearCuttingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_GearCuttingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
