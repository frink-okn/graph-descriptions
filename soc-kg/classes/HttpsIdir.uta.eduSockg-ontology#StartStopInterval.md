...
# Class: HttpsIdir.uta.eduSockg-ontology#StartStopInterval
...
URI: [https://idir.uta.edu/sockg-ontology#StartStopInterval](https://idir.uta.edu/sockg-ontology#StartStopInterval)
...
```mermaid
 classDiagram
    ...
    click HttpsIdir.uta.eduSockg-ontology#StartStopInterval href "../HttpsIdir.uta.eduSockg-ontology#StartStopInterval"
      HttpsIdir.uta.eduSockg-ontology#StartStopInterval : rdfs_label
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#StartStopInterval --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: https___idir.uta.edu_sockg-ontology#StartStopInterval
from_schema: okns:soc-kg
rank: 1000
slots:
- rdfs_label
class_uri: https://idir.uta.edu/sockg-ontology#StartStopInterval
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: https___idir.uta.edu_sockg-ontology#StartStopInterval
    domain_of:
    - qudt_AspectClass
    - qudt_BinaryPrefix
