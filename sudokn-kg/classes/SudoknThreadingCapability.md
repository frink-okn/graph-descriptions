...
# Class: threading capability (sudokn_ThreadingCapability)





URI: [sudokn:ThreadingCapability](http://asu.edu/semantics/SUDOKN/ThreadingCapability)
...
```mermaid
 classDiagram
    class SudoknThreadingCapability
    click SudoknThreadingCapability href "../SudoknThreadingCapability"
      ...
      SudoknThreadingCapability : rdfs_label
        
          
    
    
    SudoknThreadingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: sudokn_ThreadingCapability
title: threading capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_MachiningCapability
class_uri: sudokn:ThreadingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ThreadingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
