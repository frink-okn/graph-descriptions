...
# Class: chromate conversion coating capability (sudokn_ChromateConversionCoatingCapability)




This class occurs 139 times.


URI: [sudokn:ChromateConversionCoatingCapability](http://asu.edu/semantics/SUDOKN/ChromateConversionCoatingCapability)
...
```mermaid
 classDiagram
    class SudoknChromateConversionCoatingCapability
    click SudoknChromateConversionCoatingCapability href "../SudoknChromateConversionCoatingCapability"
      ...
      SudoknChromateConversionCoatingCapability : rdfs_label
        
          
    
    
    SudoknChromateConversionCoatingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
        ...
        * [SudoknSurfaceFinishingCapability](../classes/SudoknSurfaceFinishingCapability.md)
            * [SudoknCoatingCapability](../classes/SudoknCoatingCapability.md)
                * [SudoknChemicalCoatingCapability](../classes/SudoknChemicalCoatingCapability.md)
                    * [SudoknChemicalConversionCoatingCapability](../classes/SudoknChemicalConversionCoatingCapability.md)
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject <br/>  | direct | 139 |
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknChromateConversionCoatingCapability](../classes/SudoknChromateConversionCoatingCapability.md) |
...
```yaml
name: sudokn_ChromateConversionCoatingCapability
title: chromate conversion coating capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_ChemicalConversionCoatingCapability
slots:
- rdfs_label
class_uri: sudokn:ChromateConversionCoatingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ChromateConversionCoatingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
