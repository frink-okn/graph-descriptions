...
# Class: HttpsIdir.uta.eduSockg-ontology#Cultivar
...
URI: [https://idir.uta.edu/sockg-ontology#Cultivar](https://idir.uta.edu/sockg-ontology#Cultivar)
...
```mermaid
 classDiagram
    ...
    click HttpsIdir.uta.eduSockg-ontology#Cultivar href "../HttpsIdir.uta.eduSockg-ontology#Cultivar"
      HttpsIdir.uta.eduSockg-ontology#Cultivar : rdfs_label
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#Cultivar --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: https___idir.uta.edu_sockg-ontology#Cultivar
from_schema: okns:soc-kg
rank: 1000
slots:
- rdfs_label
class_uri: https://idir.uta.edu/sockg-ontology#Cultivar
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: https___idir.uta.edu_sockg-ontology#Cultivar
    domain_of:
