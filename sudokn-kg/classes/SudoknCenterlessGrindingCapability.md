...
# Class: centerless grinding capability (sudokn_CenterlessGrindingCapability)
...
```mermaid
 classDiagram
    ...
    SudoknCenterlessGrindingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
title: centerless grinding capability
