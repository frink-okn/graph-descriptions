...
# Class: TODO -- what's a good name for this class (type)? (sudokn_LaserCuttingCapability)
...
URI: [sudokn:LaserCuttingCapability](http://asu.edu/semantics/SUDOKN/LaserCuttingCapability)
...
```mermaid
 classDiagram
    class SudoknLaserCuttingCapability
    click SudoknLaserCuttingCapability href "../SudoknLaserCuttingCapability"
      ...
      SudoknLaserCuttingCapability <|-- SudoknCNCLaserCuttingCapability
        click SudoknCNCLaserCuttingCapability href "../SudoknCNCLaserCuttingCapability"
      
      
      SudoknLaserCuttingCapability : rdfs_label
        
          
    
    
    SudoknLaserCuttingCapability --> "0..1" String : rdfs_label
        ...
        * [SudoknThermalSubtractionCapability](../classes/SudoknThermalSubtractionCapability.md)
            * [SudoknHighEnergyBeamMachiningCapability](../classes/SudoknHighEnergyBeamMachiningCapability.md)
                * **SudoknLaserCuttingCapability**
                    * [SudoknCNCLaserCuttingCapability](../classes/SudoknCNCLaserCuttingCapability.md)
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknLaserCuttingCapability](../classes/SudoknLaserCuttingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknLaserCuttingCapability](../classes/SudoknLaserCuttingCapability.md) |
...
| Value |
| --- |
| sudokn:1DIETECH-LaserCuttingCapability-inst |
...
| ---  | ---  |
| self | sudokn:LaserCuttingCapability |
| native | sudokn-kg/:SudoknLaserCuttingCapability |
...
<details>
```yaml
name: sudokn_LaserCuttingCapability
...
- if you think the class is perfect.
notes:
- Class with 581 occurences.
examples:
- value: sudokn:1DIETECH-LaserCuttingCapability-inst
from_schema: sudokn-kg
is_a: sudokn_HighEnergyBeamMachiningCapability
slots:
- rdfs_label
class_uri: sudokn:LaserCuttingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_LaserCuttingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
