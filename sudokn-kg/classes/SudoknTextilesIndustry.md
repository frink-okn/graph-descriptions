...
# Class: textiles industry (sudokn_TextilesIndustry)
...
| ---  | ---  |
| self | sudokn:TextilesIndustry |
| native | sudokn-kg/:SudoknTextilesIndustry |
...
examples:
- value: sudokn:Textiles-Industry
