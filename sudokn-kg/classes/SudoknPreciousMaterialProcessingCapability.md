...
# Class: TODO -- what's a good name for this class (type)? (sudokn_PreciousMaterialProcessingCapability)
...
URI: [sudokn:PreciousMaterialProcessingCapability](http://asu.edu/semantics/SUDOKN/PreciousMaterialProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknPreciousMaterialProcessingCapability
    click SudoknPreciousMaterialProcessingCapability href "../SudoknPreciousMaterialProcessingCapability"
      SudoknPreciousMaterialProcessingCapability : rdfs_label
        
          
    
    
    SudoknPreciousMaterialProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknPreciousMaterialProcessingCapability](../classes/SudoknPreciousMaterialProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknPreciousMaterialProcessingCapability](../classes/SudoknPreciousMaterialProcessingCapability.md) |
...
| Value |
| --- |
| sudokn:AMERICANLASERINC-PreciousMaterial-inst |
...
| ---  | ---  |
| self | sudokn:PreciousMaterialProcessingCapability |
| native | sudokn-kg/:SudoknPreciousMaterialProcessingCapability |
...
<details>
```yaml
name: sudokn_PreciousMaterialProcessingCapability
...
examples:
- value: sudokn:AMERICANLASERINC-PreciousMaterial-inst
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:PreciousMaterialProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_PreciousMaterialProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
