...
# Class: TODO -- what's a good name for this class (type)? (sudokn_DipBrazingCapability)
...
URI: [sudokn:DipBrazingCapability](http://asu.edu/semantics/SUDOKN/DipBrazingCapability)
...
```mermaid
 classDiagram
    class SudoknDipBrazingCapability
    click SudoknDipBrazingCapability href "../SudoknDipBrazingCapability"
      ...
      SudoknDipBrazingCapability : rdfs_label
        
          
    
    
    SudoknDipBrazingCapability --> "0..1" String : rdfs_label
...
| ---  | ---  |
| self | sudokn:DipBrazingCapability |
| native | sudokn-kg/:SudoknDipBrazingCapability |
...
<details>
```yaml
name: sudokn_DipBrazingCapability
...
class_uri: sudokn:DipBrazingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_DipBrazingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
