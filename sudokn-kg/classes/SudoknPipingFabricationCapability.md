...
# Class: TODO -- what's a good name for this class (type)? (sudokn_PipingFabricationCapability)
...
URI: [sudokn:PipingFabricationCapability](http://asu.edu/semantics/SUDOKN/PipingFabricationCapability)
...
```mermaid
 classDiagram
    class SudoknPipingFabricationCapability
    click SudoknPipingFabricationCapability href "../SudoknPipingFabricationCapability"
      SudoknPipingFabricationCapability : rdfs_label
        
          
    
    
    SudoknPipingFabricationCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknPipingFabricationCapability](../classes/SudoknPipingFabricationCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknPipingFabricationCapability](../classes/SudoknPipingFabricationCapability.md) |
...
| Value |
| --- |
| sudokn:K-Industries-PipingFabrication |
...
| ---  | ---  |
| self | sudokn:PipingFabricationCapability |
| native | sudokn-kg/:SudoknPipingFabricationCapability |
...
<details>
```yaml
name: sudokn_PipingFabricationCapability
...
examples:
- value: sudokn:K-Industries-PipingFabrication
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:PipingFabricationCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_PipingFabricationCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
