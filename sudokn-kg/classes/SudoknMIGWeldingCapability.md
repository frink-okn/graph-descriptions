...
# Class: TODO -- what's a good name for this class (type)? (sudokn_MIGWeldingCapability)
...
URI: [sudokn:MIGWeldingCapability](http://asu.edu/semantics/SUDOKN/MIGWeldingCapability)
...
```mermaid
 classDiagram
    class SudoknMIGWeldingCapability
    click SudoknMIGWeldingCapability href "../SudoknMIGWeldingCapability"
      SudoknGasMetalArcWeldingCapability <|-- SudoknMIGWeldingCapability
        click SudoknGasMetalArcWeldingCapability href "../SudoknGasMetalArcWeldingCapability"
      
      SudoknMIGWeldingCapability : rdfs_label
        
          
    
    
    SudoknMIGWeldingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknMIGWeldingCapability](../classes/SudoknMIGWeldingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknMIGWeldingCapability](../classes/SudoknMIGWeldingCapability.md) |
...
| Value |
| --- |
| sudokn:LlewellynMetalFabricators-MIGWelding |
...
| ---  | ---  |
| self | sudokn:MIGWeldingCapability |
| native | sudokn-kg/:SudoknMIGWeldingCapability |
...
<details>
```yaml
name: sudokn_MIGWeldingCapability
...
examples:
- value: sudokn:LlewellynMetalFabricators-MIGWelding
from_schema: sudokn-kg
rank: 1000
is_a: sudokn_GasMetalArcWeldingCapability
slots:
- rdfs_label
class_uri: sudokn:MIGWeldingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_MIGWeldingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
