...
# Class: composite processing capability (sudokn_CompositeProcessingCapability)
...
URI: [sudokn:CompositeProcessingCapability](http://asu.edu/semantics/SUDOKN/CompositeProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknCompositeProcessingCapability
    click SudoknCompositeProcessingCapability href "../SudoknCompositeProcessingCapability"
      ...
      SudoknCompositeProcessingCapability : rdfs_label
        
          
    
    
    SudoknCompositeProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknCompositeProcessingCapability](../classes/SudoknCompositeProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknCompositeProcessingCapability](../classes/SudoknCompositeProcessingCapability.md) |
...
| ---  | ---  |
| self | sudokn:CompositeProcessingCapability |
| native | sudokn-kg/:SudoknCompositeProcessingCapability |
...
<details>
```yaml
name: sudokn_CompositeProcessingCapability
description: TODO -- tell the world what this class (type) describes.
title: composite processing capability
todos:
- TODO -- Todos for this class go here
- or you can delete the todos
- if you think the class is perfect.
notes:
- Class with 1196 occurences.
examples:
- value: sudokn:3DMACH-Composite-inst
from_schema: sudokn-kg
is_a: sudokn_MaterialProcessingCapability
slots:
- rdfs_label
class_uri: sudokn:CompositeProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_CompositeProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
