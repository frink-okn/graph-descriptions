...
# Class: TODO -- what's a good name for this class (type)? (sudokn_CarbonGraphiteProcessingCapability)
...
URI: [sudokn:CarbonGraphiteProcessingCapability](http://asu.edu/semantics/SUDOKN/CarbonGraphiteProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknCarbonGraphiteProcessingCapability
    click SudoknCarbonGraphiteProcessingCapability href "../SudoknCarbonGraphiteProcessingCapability"
      SudoknCarbonGraphiteProcessingCapability : rdfs_label
        
          
    
    
    SudoknCarbonGraphiteProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknCarbonGraphiteProcessingCapability](../classes/SudoknCarbonGraphiteProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknCarbonGraphiteProcessingCapability](../classes/SudoknCarbonGraphiteProcessingCapability.md) |
...
| Value |
| --- |
| sudokn:CARBONFIBERGLASS-CarbonGraphite-inst |
...
| ---  | ---  |
| self | sudokn:CarbonGraphiteProcessingCapability |
| native | sudokn-kg/:SudoknCarbonGraphiteProcessingCapability |
...
<details>
```yaml
name: sudokn_CarbonGraphiteProcessingCapability
...
examples:
- value: sudokn:CARBONFIBERGLASS-CarbonGraphite-inst
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:CarbonGraphiteProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_CarbonGraphiteProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
