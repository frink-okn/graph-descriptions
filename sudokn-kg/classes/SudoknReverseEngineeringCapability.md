...
# Class: reverse engineering capability (sudokn_ReverseEngineeringCapability)
...
| ---  | ---  |
| self | sudokn:ReverseEngineeringCapability |
| native | sudokn-kg/:SudoknReverseEngineeringCapability |
...
title: reverse engineering capability
todos:
- TODO -- Todos for this class go here
- or you can delete the todos
- if you think the class is perfect.
