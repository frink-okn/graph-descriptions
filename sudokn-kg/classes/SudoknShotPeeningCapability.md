...
# Class: TODO -- what's a good name for this class (type)? (sudokn_ShotPeeningCapability)
...
URI: [sudokn:ShotPeeningCapability](http://asu.edu/semantics/SUDOKN/ShotPeeningCapability)
...
```mermaid
 classDiagram
    class SudoknShotPeeningCapability
    click SudoknShotPeeningCapability href "../SudoknShotPeeningCapability"
      ...
      SudoknShotPeeningCapability : rdfs_label
        
          
    
    
    SudoknShotPeeningCapability --> "0..1" String : rdfs_label
...
| ---  | ---  |
| self | sudokn:ShotPeeningCapability |
| native | sudokn-kg/:SudoknShotPeeningCapability |
...
<details>
```yaml
name: sudokn_ShotPeeningCapability
...
class_uri: sudokn:ShotPeeningCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ShotPeeningCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
