...
# Class: zero-stock machining capability (sudokn_ZeroStockMachiningCapability)





URI: [sudokn:ZeroStockMachiningCapability](http://asu.edu/semantics/SUDOKN/ZeroStockMachiningCapability)
...
```mermaid
 classDiagram
    class SudoknZeroStockMachiningCapability
    click SudoknZeroStockMachiningCapability href "../SudoknZeroStockMachiningCapability"
      ...
      SudoknZeroStockMachiningCapability : rdfs_label
        
          
    
    
    SudoknZeroStockMachiningCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: sudokn_ZeroStockMachiningCapability
title: zero-stock machining capability
...
class_uri: sudokn:ZeroStockMachiningCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ZeroStockMachiningCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
