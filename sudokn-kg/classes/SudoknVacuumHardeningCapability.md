...
# Class: TODO -- what's a good name for this class (type)? (sudokn_VacuumHardeningCapability)
...
URI: [sudokn:VacuumHardeningCapability](http://asu.edu/semantics/SUDOKN/VacuumHardeningCapability)
...
```mermaid
 classDiagram
    class SudoknVacuumHardeningCapability
    click SudoknVacuumHardeningCapability href "../SudoknVacuumHardeningCapability"
      ...
      SudoknVacuumHardeningCapability : rdfs_label
        
          
    
    
    SudoknVacuumHardeningCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknVacuumHardeningCapability](../classes/SudoknVacuumHardeningCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknVacuumHardeningCapability](../classes/SudoknVacuumHardeningCapability.md) |
...
| Value |
| --- |
| sudokn:AmericanMetalTreating-VacuumHardening |
...
| ---  | ---  |
| self | sudokn:VacuumHardeningCapability |
| native | sudokn-kg/:SudoknVacuumHardeningCapability |
...
<details>
```yaml
name: sudokn_VacuumHardeningCapability
...
examples:
- value: sudokn:AmericanMetalTreating-VacuumHardening
from_schema: sudokn-kg
rank: 1000
is_a: sudokn_SurfaceHardeningCapability
slots:
- rdfs_label
class_uri: sudokn:VacuumHardeningCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_VacuumHardeningCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
