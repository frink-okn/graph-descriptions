...
# Class: TODO -- what's a good name for this class (type)? (sudokn_NotchingCapability)
...
URI: [sudokn:NotchingCapability](http://asu.edu/semantics/SUDOKN/NotchingCapability)
...
```mermaid
 classDiagram
    class SudoknNotchingCapability
    click SudoknNotchingCapability href "../SudoknNotchingCapability"
      SudoknNotchingCapability : rdfs_label
        
          
    
    
    SudoknNotchingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknNotchingCapability](../classes/SudoknNotchingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknNotchingCapability](../classes/SudoknNotchingCapability.md) |
...
| Value |
| --- |
| sudokn:A-1SHEETMETAL-NotchingCapability-inst |
...
| ---  | ---  |
| self | sudokn:NotchingCapability |
| native | sudokn-kg/:SudoknNotchingCapability |
...
<details>
```yaml
name: sudokn_NotchingCapability
...
- if you think the class is perfect.
notes:
- Class with 109 occurences.
examples:
- value: sudokn:A-1SHEETMETAL-NotchingCapability-inst
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:NotchingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_NotchingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
