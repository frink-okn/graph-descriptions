...
# Class: TODO -- what's a good name for this class (type)? (sudokn_InstallationCapability)
...
URI: [sudokn:InstallationCapability](http://asu.edu/semantics/SUDOKN/InstallationCapability)
...
```mermaid
 classDiagram
    class SudoknInstallationCapability
    click SudoknInstallationCapability href "../SudoknInstallationCapability"
      SudoknInstallationCapability : rdfs_label
        
          
    
    
    SudoknInstallationCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknInstallationCapability](../classes/SudoknInstallationCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknInstallationCapability](../classes/SudoknInstallationCapability.md) |
...
| Value |
| --- |
| sudokn:EnvironmentalAirSystems-Installation |
...
| ---  | ---  |
| self | sudokn:InstallationCapability |
| native | sudokn-kg/:SudoknInstallationCapability |
...
<details>
```yaml
name: sudokn_InstallationCapability
...
examples:
- value: sudokn:EnvironmentalAirSystems-Installation
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:InstallationCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_InstallationCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
