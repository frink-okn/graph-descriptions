...
# Class: rolling capability (sudokn_RollingCapability)
...
URI: [sudokn:RollingCapability](http://asu.edu/semantics/SUDOKN/RollingCapability)
...
```mermaid
 classDiagram
    ...
    click SudoknRollingCapability href "../SudoknRollingCapability"
      ...
      SudoknRollingCapability : rdfs_label
        
          
    
    
    SudoknRollingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknRollingCapability](../classes/SudoknRollingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknRollingCapability](../classes/SudoknRollingCapability.md) |
...
| Value |
| --- |
| sudokn:A-1SHEETMETAL-RollingCapability-inst |
...
| ---  | ---  |
| self | sudokn:RollingCapability |
| native | sudokn-kg/:SudoknRollingCapability |
...
<details>
```yaml
name: sudokn_RollingCapability
description: TODO -- tell the world what this class (type) describes.
title: rolling capability
todos:
- TODO -- Todos for this class go here
- or you can delete the todos
- if you think the class is perfect.
notes:
- Class with 605 occurences.
examples:
- value: sudokn:A-1SHEETMETAL-RollingCapability-inst
from_schema: sudokn-kg
is_a: sudokn_FormingCapability
slots:
- rdfs_label
class_uri: sudokn:RollingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_RollingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
