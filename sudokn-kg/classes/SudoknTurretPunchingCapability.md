...
# Class: TODO -- what's a good name for this class (type)? (sudokn_TurretPunchingCapability)
...
URI: [sudokn:TurretPunchingCapability](http://asu.edu/semantics/SUDOKN/TurretPunchingCapability)
...
```mermaid
 classDiagram
    class SudoknTurretPunchingCapability
    click SudoknTurretPunchingCapability href "../SudoknTurretPunchingCapability"
      SudoknTurretPunchingCapability : rdfs_label
        
          
    
    
    SudoknTurretPunchingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknTurretPunchingCapability](../classes/SudoknTurretPunchingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknTurretPunchingCapability](../classes/SudoknTurretPunchingCapability.md) |
...
| Value |
| --- |
| sudokn:Forma-FabMetals-TurretPunching |
...
| ---  | ---  |
| self | sudokn:TurretPunchingCapability |
| native | sudokn-kg/:SudoknTurretPunchingCapability |
...
<details>
```yaml
name: sudokn_TurretPunchingCapability
...
examples:
- value: sudokn:Forma-FabMetals-TurretPunching
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:TurretPunchingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_TurretPunchingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
