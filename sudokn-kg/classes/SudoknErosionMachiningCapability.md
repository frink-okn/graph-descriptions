...
# Class: erosion machining capability (sudokn_ErosionMachiningCapability)





URI: [sudokn:ErosionMachiningCapability](http://asu.edu/semantics/SUDOKN/ErosionMachiningCapability)
...
```mermaid
 classDiagram
    class SudoknErosionMachiningCapability
    click SudoknErosionMachiningCapability href "../SudoknErosionMachiningCapability"
      ...
      SudoknErosionMachiningCapability : rdfs_label
        
          
    
    
    SudoknErosionMachiningCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
    ...
    * [SudoknManufacturingProcessCapability](../classes/SudoknManufacturingProcessCapability.md)
        * [SudoknMachiningCapability](../classes/SudoknMachiningCapability.md)
            * **SudoknErosionMachiningCapability**
                * [SudoknWaterjetCuttingCapability](../classes/SudoknWaterjetCuttingCapability.md)
...
```yaml
name: sudokn_ErosionMachiningCapability
title: erosion machining capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_MachiningCapability
class_uri: sudokn:ErosionMachiningCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ErosionMachiningCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
