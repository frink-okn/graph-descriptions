...
# Class: TODO -- what's a good name for this class (type)? (sudokn_ZincArcSprayCapability)
...
URI: [sudokn:ZincArcSprayCapability](http://asu.edu/semantics/SUDOKN/ZincArcSprayCapability)
...
```mermaid
 classDiagram
    class SudoknZincArcSprayCapability
    click SudoknZincArcSprayCapability href "../SudoknZincArcSprayCapability"
      SudoknZincArcSprayCapability : rdfs_label
        
          
    
    
    SudoknZincArcSprayCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknZincArcSprayCapability](../classes/SudoknZincArcSprayCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknZincArcSprayCapability](../classes/SudoknZincArcSprayCapability.md) |
...
| Value |
| --- |
| sudokn:WeathersMfg-ZincArcSpray |
...
| ---  | ---  |
| self | sudokn:ZincArcSprayCapability |
| native | sudokn-kg/:SudoknZincArcSprayCapability |
...
<details>
```yaml
name: sudokn_ZincArcSprayCapability
...
examples:
- value: sudokn:WeathersMfg-ZincArcSpray
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:ZincArcSprayCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ZincArcSprayCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
