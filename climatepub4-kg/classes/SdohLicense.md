...
# Class: TODO -- what's a good name for this class (type)? (sdoh_License)
...
URI: [sdoh:License](http://schema.org/License)
...
```mermaid
 classDiagram
    ...
    click SdohLicense href "../SdohLicense"
      SdohLicense : skos_broader
        
          
    
    
    SdohLicense --> "0..1" Any : skos_broader
    click Any href "../Any"

        
      SdohLicense : skos_definition
        
          
    
    
    SdohLicense --> "0..1" String : skos_definition
    click String href "../String"

        
      SdohLicense : skos_prefLabel
        
          
    
    
    SdohLicense --> "0..1" String : skos_prefLabel
    click String href "../String"
...
| ---  | --- | --- | --- |
| [SdohCmip6SourceId](../classes/SdohCmip6SourceId.md) | [http___relation.org_HasLicenseInfo](../slots/http___relation.org_HasLicenseInfo.md) | range | [SdohLicense](../classes/SdohLicense.md) |
...
| ---  | ---  |
| self | sdoh:License |
| native | climatepub4-kg/:SdohLicense |
