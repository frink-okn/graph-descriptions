...
```mermaid
 classDiagram
    ...
    click Any href "../Any"
      ...
      OwlNothing : geo_hasDefaultGeometry
        
          
    
    
    OwlNothing --> "0..1" Any : geo_hasDefaultGeometry
    click Any href "../Any"
    ...
    click Any href "../Any"
      ...
      OwlNothing : geo_hasMetricArea
        
          
    
    
    OwlNothing --> "0..1" Float : geo_hasMetricArea
    click Float href "../Float"

        
      OwlNothing : kwgo_administrativePartOf
        
          
    
    
    OwlNothing --> "0..1" Any : kwgo_administrativePartOf
    click Any href "../Any"

        
      OwlNothing : kwgo_cellID
        
          
    
    
    OwlNothing --> "0..1" Integer : kwgo_cellID
    click Integer href "../Integer"

        
      OwlNothing : kwgo_hasFIPS
        
          
    
    
    OwlNothing --> "0..1" String : kwgo_hasFIPS
    ...
    click Any href "../Any"
      ...
      OwlNothing : kwgo_sfTouches
        
          
    
    
    OwlNothing --> "0..1" Any : kwgo_sfTouches
    click Any href "../Any"
