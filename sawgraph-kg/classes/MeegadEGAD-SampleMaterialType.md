...
URI: [meegad:EGAD-SampleMaterialType](http://sawgraph.spatialai.org/v1/me-egad#EGAD-SampleMaterialType)
...
## Inheritance
* [ContaminosoMaterialType](../classes/ContaminosoMaterialType.md)
...
| ---  | ---  |
| self | meegad:EGAD-SampleMaterialType |
| native | sawgraph-kg/:MeegadEGAD-SampleMaterialType |
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: meegad_EGAD-SampleMaterialType
    domain_of:
