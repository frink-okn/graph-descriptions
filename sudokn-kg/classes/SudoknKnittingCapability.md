...
URI: [sudokn:KnittingCapability](http://asu.edu/semantics/SUDOKN/KnittingCapability)
...
```mermaid
 classDiagram
    class SudoknKnittingCapability
    click SudoknKnittingCapability href "../SudoknKnittingCapability"
      ...
      SudoknKnittingCapability : rdfs_label
        
          
    
    
    SudoknKnittingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknKnittingCapability](../classes/SudoknKnittingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknKnittingCapability](../classes/SudoknKnittingCapability.md) |
...
| Value |
| --- |
| sudokn:CommonPartsGrouping-Knitting |
...
| ---  | ---  |
| self | sudokn:KnittingCapability |
| native | sudokn-kg/:SudoknKnittingCapability |
...
slots:
- rdfs_label
class_uri: sudokn:KnittingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_KnittingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
