...
# Class: carbonitriding capability (sudokn_CarbonitridingCapability)




This class occurs 43 times.


URI: [sudokn:CarbonitridingCapability](http://asu.edu/semantics/SUDOKN/CarbonitridingCapability)
...
```mermaid
 classDiagram
    class SudoknCarbonitridingCapability
    click SudoknCarbonitridingCapability href "../SudoknCarbonitridingCapability"
      ...
      SudoknCarbonitridingCapability : rdfs_label
        
          
    
    
    SudoknCarbonitridingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCarbonitridingCapability](../classes/SudoknCarbonitridingCapability.md) |
...
```yaml
name: sudokn_CarbonitridingCapability
title: carbonitriding capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_DiffusionHardeningCapability
slots:
- rdfs_label
class_uri: sudokn:CarbonitridingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_CarbonitridingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
