...
# Class: Justice (fio-epa-frs_Agency.Justice)
...
URI: [fio-epa-frs:Agency.Justice](http://w3id.org/fio/v1/epa-frs#Agency.Justice)
...
```mermaid
 classDiagram
    class Fio-epa-frsAgency.Justice
    click Fio-epa-frsAgency.Justice href "../Fio-epa-frsAgency.Justice"
      ProvAgent <|-- Fio-epa-frsAgency.Justice
        click ProvAgent href "../ProvAgent"
      
      Fio-epa-frsAgency.Justice : owl_sameAs
        
          
    
    
    Fio-epa-frsAgency.Justice --> "0..1" OwlThing : owl_sameAs
    click OwlThing href "../OwlThing"

        
      Fio-epa-frsAgency.Justice : rdfs_label
        
          
    
    
    Fio-epa-frsAgency.Justice --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- |
| [Fio-epa-frsEPA-PFAS-Facility](../classes/Fio-epa-frsEPA-PFAS-Facility.md) | [fio_ownedBy](../slots/fio_ownedBy.md) | any_of[range] | [Fio-epa-frsAgency.Justice](../classes/Fio-epa-frsAgency.Justice.md) |
| [Fio-epa-frsFRS-Facility](../classes/Fio-epa-frsFRS-Facility.md) | [fio_ownedBy](../slots/fio_ownedBy.md) | any_of[range] | [Fio-epa-frsAgency.Justice](../classes/Fio-epa-frsAgency.Justice.md) |
...
```yaml
name: fio-epa-frs_Agency.Justice
title: Justice
from_schema: okns:fio-kg
exact_mappings:
- http://w3id.org/fio/v1/epa-frs#Agency.Justice
rank: 1000
is_a: prov_Agent
slots:
- rdfs_label
- owl_sameAs
class_uri: fio-epa-frs:Agency.Justice
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: fio-epa-frs_Agency.Justice
    domain_of:
