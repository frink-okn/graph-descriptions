...
# Class: TODO -- what's a good name for this class (type)? (sudokn_CNCCylindricalGrindingCapability)
...
URI: [sudokn:CNCCylindricalGrindingCapability](http://asu.edu/semantics/SUDOKN/CNCCylindricalGrindingCapability)
...
```mermaid
 classDiagram
    class SudoknCNCCylindricalGrindingCapability
    click SudoknCNCCylindricalGrindingCapability href "../SudoknCNCCylindricalGrindingCapability"
      SudoknCNCCylindricalGrindingCapability : rdfs_label
        
          
    
    
    SudoknCNCCylindricalGrindingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCNCCylindricalGrindingCapability](../classes/SudoknCNCCylindricalGrindingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCNCCylindricalGrindingCapability](../classes/SudoknCNCCylindricalGrindingCapability.md) |
...
| Value |
| --- |
| sudokn:IndTool-CNCCylindricalGrinding |
...
| ---  | ---  |
| self | sudokn:CNCCylindricalGrindingCapability |
| native | sudokn-kg/:SudoknCNCCylindricalGrindingCapability |
...
<details>
```yaml
name: sudokn_CNCCylindricalGrindingCapability
...
examples:
- value: sudokn:IndTool-CNCCylindricalGrinding
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:CNCCylindricalGrindingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_CNCCylindricalGrindingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
