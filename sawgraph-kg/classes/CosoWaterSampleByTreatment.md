...
# Class: Water Sample by Treatment (coso_WaterSampleByTreatment)





URI: [coso:WaterSampleByTreatment](http://w3id.org/coso/v1/contaminoso#WaterSampleByTreatment)
...
```mermaid
 classDiagram
    class CosoWaterSampleByTreatment
    click CosoWaterSampleByTreatment href "../CosoWaterSampleByTreatment"
      ...
      CosoWaterSampleByTreatment <|-- CosoTreatedWaterSample
        click CosoTreatedWaterSample href "../CosoTreatedWaterSample"
      
      
      CosoWaterSampleByTreatment : owl_sameAs
        
          
    
    
    CosoWaterSampleByTreatment --> "0..1" OwlThing : owl_sameAs
    click OwlThing href "../OwlThing"

        
      CosoWaterSampleByTreatment : rdfs_label
        
          
    
    
    CosoWaterSampleByTreatment --> "0..1" Any : rdfs_label
    click Any href "../Any"
    ...
    * [SosaSample](../classes/SosaSample.md)
        * [CosoWaterSample](../classes/CosoWaterSample.md)
            * **CosoWaterSampleByTreatment**
                * [CosoTreatedWaterSample](../classes/CosoTreatedWaterSample.md)
...
```yaml
name: coso_WaterSampleByTreatment
title: Water Sample by Treatment
from_schema: okns:sawgraph-kg
rank: 1000
is_a: coso_WaterSample
class_uri: coso:WaterSampleByTreatment
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: coso_WaterSampleByTreatment
    domain_of:
