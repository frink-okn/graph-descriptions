...
# Class: State (fio-epa-frs_Agency.State)
...
URI: [fio-epa-frs:Agency.State](http://w3id.org/fio/v1/epa-frs#Agency.State)
...
```mermaid
 classDiagram
    class Fio-epa-frsAgency.State
    click Fio-epa-frsAgency.State href "../Fio-epa-frsAgency.State"
      ProvAgent <|-- Fio-epa-frsAgency.State
        click ProvAgent href "../ProvAgent"
      
      Fio-epa-frsAgency.State : owl_sameAs
        
          
    
    
    Fio-epa-frsAgency.State --> "0..1" OwlThing : owl_sameAs
    click OwlThing href "../OwlThing"

        
      Fio-epa-frsAgency.State : rdfs_label
        
          
    
    
    Fio-epa-frsAgency.State --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
- rdfs_label
- owl_sameAs
class_uri: fio-epa-frs:Agency.State
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: fio-epa-frs_Agency.State
    domain_of:
    - time_DayOfWeek
    - time_TemporalUnit
