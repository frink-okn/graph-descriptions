...
# Class: TODO -- what's a good name for this class (type)? (sudokn_ElectrolessPlatingCapability)
...
URI: [sudokn:ElectrolessPlatingCapability](http://asu.edu/semantics/SUDOKN/ElectrolessPlatingCapability)
...
```mermaid
 classDiagram
    class SudoknElectrolessPlatingCapability
    click SudoknElectrolessPlatingCapability href "../SudoknElectrolessPlatingCapability"
      SudoknElectrolessPlatingCapability : rdfs_label
        
          
    
    
    SudoknElectrolessPlatingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknElectrolessPlatingCapability](../classes/SudoknElectrolessPlatingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknElectrolessPlatingCapability](../classes/SudoknElectrolessPlatingCapability.md) |
...
| Value |
| --- |
| sudokn:WilliamsPlatingCompany-ElectrolessPlating |
...
| ---  | ---  |
| self | sudokn:ElectrolessPlatingCapability |
| native | sudokn-kg/:SudoknElectrolessPlatingCapability |
...
<details>
```yaml
name: sudokn_ElectrolessPlatingCapability
...
examples:
- value: sudokn:WilliamsPlatingCompany-ElectrolessPlating
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:ElectrolessPlatingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ElectrolessPlatingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
