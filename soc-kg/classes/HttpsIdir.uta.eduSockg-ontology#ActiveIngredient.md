...
# Class: HttpsIdir.uta.eduSockg-ontology#ActiveIngredient
...
URI: [https://idir.uta.edu/sockg-ontology#ActiveIngredient](https://idir.uta.edu/sockg-ontology#ActiveIngredient)
...
```mermaid
 classDiagram
    ...
    click HttpsIdir.uta.eduSockg-ontology#ActiveIngredient href "../HttpsIdir.uta.eduSockg-ontology#ActiveIngredient"
      HttpsIdir.uta.eduSockg-ontology#ActiveIngredient : coso_casNumber
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#ActiveIngredient --> "0..1" String : coso_casNumber
    click String href "../String"

        
      HttpsIdir.uta.eduSockg-ontology#ActiveIngredient : rdfs_label
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#ActiveIngredient --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: https___idir.uta.edu_sockg-ontology#ActiveIngredient
from_schema: okns:soc-kg
rank: 1000
slots:
- coso_casNumber
- rdfs_label
class_uri: https://idir.uta.edu/sockg-ontology#ActiveIngredient
...
attributes:
  coso_casNumber:
    ...
    owner: https___idir.uta.edu_sockg-ontology#ActiveIngredient
    domain_of:
