...
# Class: No class (type) name specified (sudokn_SubmergedArcWeldingCapability)
...
URI: [sudokn:SubmergedArcWeldingCapability](http://asu.edu/semantics/SUDOKN/SubmergedArcWeldingCapability)
...
```mermaid
 classDiagram
    class SudoknSubmergedArcWeldingCapability
    click SudoknSubmergedArcWeldingCapability href "../SudoknSubmergedArcWeldingCapability"
      ...
      SudoknSubmergedArcWeldingCapability : rdfs_label
        
          
    
    
    SudoknSubmergedArcWeldingCapability --> "0..1" String : rdfs_label
...
```yaml
name: sudokn_SubmergedArcWeldingCapability
...
class_uri: sudokn:SubmergedArcWeldingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_SubmergedArcWeldingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
    - owl_NamedIndividual
