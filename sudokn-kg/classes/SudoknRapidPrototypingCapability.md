...
# Class: TODO -- what's a good name for this class (type)? (sudokn_RapidPrototypingCapability)
...
URI: [sudokn:RapidPrototypingCapability](http://asu.edu/semantics/SUDOKN/RapidPrototypingCapability)
...
```mermaid
 classDiagram
    class SudoknRapidPrototypingCapability
    click SudoknRapidPrototypingCapability href "../SudoknRapidPrototypingCapability"
      SudoknRapidPrototypingCapability : rdfs_label
        
          
    
    
    SudoknRapidPrototypingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknRapidPrototypingCapability](../classes/SudoknRapidPrototypingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknRapidPrototypingCapability](../classes/SudoknRapidPrototypingCapability.md) |
...
| Value |
| --- |
| sudokn:3DXINDUSTRIES-RapidPrototypingCapability-inst |
...
| ---  | ---  |
| self | sudokn:RapidPrototypingCapability |
| native | sudokn-kg/:SudoknRapidPrototypingCapability |
...
<details>
```yaml
name: sudokn_RapidPrototypingCapability
...
- if you think the class is perfect.
notes:
- Class with 256 occurences.
examples:
- value: sudokn:3DXINDUSTRIES-RapidPrototypingCapability-inst
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:RapidPrototypingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_RapidPrototypingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
