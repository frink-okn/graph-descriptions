...
# Class: HttpsIdir.uta.eduSockg-ontology#ResidueRemoval
...
URI: [https://idir.uta.edu/sockg-ontology#ResidueRemoval](https://idir.uta.edu/sockg-ontology#ResidueRemoval)
...
```mermaid
 classDiagram
    ...
    click HttpsIdir.uta.eduSockg-ontology#ResidueRemoval href "../HttpsIdir.uta.eduSockg-ontology#ResidueRemoval"
      HttpsIdir.uta.eduSockg-ontology#ResidueRemoval : dct_description
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#ResidueRemoval --> "0..1" String : dct_description
...
```yaml
name: https___idir.uta.edu_sockg-ontology#ResidueRemoval
from_schema: okns:soc-kg
rank: 1000
slots:
- dct_description
class_uri: https://idir.uta.edu/sockg-ontology#ResidueRemoval
...
attributes:
  dct_description:
    ...
    owner: https___idir.uta.edu_sockg-ontology#ResidueRemoval
    domain_of:
    - qudt_BinaryPrefix
