...
# Class: TODO -- what's a good name for this class (type)? (sudokn_PaintingCapability)
...
URI: [sudokn:PaintingCapability](http://asu.edu/semantics/SUDOKN/PaintingCapability)
...
```mermaid
 classDiagram
    class SudoknPaintingCapability
    click SudoknPaintingCapability href "../SudoknPaintingCapability"
      SudoknPaintingCapability : rdfs_label
        
          
    
    
    SudoknPaintingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknPaintingCapability](../classes/SudoknPaintingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknPaintingCapability](../classes/SudoknPaintingCapability.md) |
...
| Value |
| --- |
| sudokn:GrowlerManufacturingandEngineering-Painting |
...
| ---  | ---  |
| self | sudokn:PaintingCapability |
| native | sudokn-kg/:SudoknPaintingCapability |
...
<details>
```yaml
name: sudokn_PaintingCapability
...
examples:
- value: sudokn:GrowlerManufacturingandEngineering-Painting
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:PaintingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_PaintingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
