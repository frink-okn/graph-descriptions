...
# Class: TODO -- what's a good name for this class (type)? (sudokn_BoringCapability)
...
```mermaid
 classDiagram
    ...
    SudoknBoringCapability --> "0..1" String : rdfs_label
...
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknBoringCapability](../classes/SudoknBoringCapability.md) |
...
| Value |
| --- |
| sudokn:3DIMENSIONAL-BoringCapability-inst |
...
| ---  | ---  |
| self | sudokn:BoringCapability |
| native | sudokn-kg/:SudoknBoringCapability |
...
- if you think the class is perfect.
notes:
- Class with 857 occurences.
examples:
- value: sudokn:3DIMENSIONAL-BoringCapability-inst
