...
# Class: TODO -- what's a good name for this class (type)? (sudokn_CuttingCapability)
...
URI: [sudokn:CuttingCapability](http://asu.edu/semantics/SUDOKN/CuttingCapability)
...
```mermaid
 classDiagram
    class SudoknCuttingCapability
    click SudoknCuttingCapability href "../SudoknCuttingCapability"
      SudoknCuttingCapability : rdfs_label
        
          
    
    
    SudoknCuttingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCuttingCapability](../classes/SudoknCuttingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCuttingCapability](../classes/SudoknCuttingCapability.md) |
...
| Value |
| --- |
| sudokn:AQUAJETSERVICES-CuttingCapability-inst |
...
| ---  | ---  |
| self | sudokn:CuttingCapability |
| native | sudokn-kg/:SudoknCuttingCapability |
...
examples:
- value: sudokn:AQUAJETSERVICES-CuttingCapability-inst
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:CuttingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_CuttingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
