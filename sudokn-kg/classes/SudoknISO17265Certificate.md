...
# Class: No class (type) name specified (sudokn_ISO17265Certificate)
...
```mermaid
 classDiagram
    class SudoknISO17265Certificate
    click SudoknISO17265Certificate href "../SudoknISO17265Certificate"
      ...
      SudoknISO17265Certificate : rdfs_label
        
          
    
    
    SudoknISO17265Certificate --> "0..1" String : rdfs_label
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ISO17265Certificate
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
    - owl_NamedIndividual
