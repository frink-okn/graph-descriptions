...
# Class: TODO -- what's a good name for this class (type)? (sudokn_AnodizingCapability)
...
```mermaid
 classDiagram
    ...
    SudoknAnodizingCapability --> "0..1" String : rdfs_label
...
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknAnodizingCapability](../classes/SudoknAnodizingCapability.md) |
...
| Value |
| --- |
| sudokn:3DMACH-AnodizingCapability-inst |
...
| ---  | ---  |
| self | sudokn:AnodizingCapability |
| native | sudokn-kg/:SudoknAnodizingCapability |
...
- if you think the class is perfect.
notes:
- Class with 659 occurences.
examples:
- value: sudokn:3DMACH-AnodizingCapability-inst
