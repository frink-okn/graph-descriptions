...
# Class: TODO -- what's a good name for this class (type)? (sudokn_DiffusionBondingCapability)
...
| ---  | ---  |
| self | sudokn:DiffusionBondingCapability |
| native | sudokn-kg/:SudoknDiffusionBondingCapability |
