...
```mermaid
 classDiagram
    ...
    click SudoknNAICS332996 href "../SudoknNAICS332996"
      SudoknNAICS333 <|-- SudoknNAICS332996
    ...
    SudoknNAICS332996 --> "0..1" Integer : sudokn_hasNAICSCodeValue
    ...
    SudoknNAICS332996 --> "0..1" String : sudokn_hasNAICSTextValue
