...
# Class: TODO -- what's a good name for this class (type)? (sudokn_CreepFeedGrindingCapability)
...
```mermaid
 classDiagram
    ...
    SudoknCreepFeedGrindingCapability --> "0..1" String : rdfs_label
...
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCreepFeedGrindingCapability](../classes/SudoknCreepFeedGrindingCapability.md) |
...
| Value |
| --- |
| sudokn:ABRASIVE-FORM-CreepFeedGrindingCapability-inst |
...
| ---  | ---  |
| self | sudokn:CreepFeedGrindingCapability |
| native | sudokn-kg/:SudoknCreepFeedGrindingCapability |
...
examples:
- value: sudokn:ABRASIVE-FORM-CreepFeedGrindingCapability-inst
