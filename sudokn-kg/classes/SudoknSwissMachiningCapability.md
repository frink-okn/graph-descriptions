...
# Class: TODO -- what's a good name for this class (type)? (sudokn_SwissMachiningCapability)
...
URI: [sudokn:SwissMachiningCapability](http://asu.edu/semantics/SUDOKN/SwissMachiningCapability)
...
```mermaid
 classDiagram
    class SudoknSwissMachiningCapability
    click SudoknSwissMachiningCapability href "../SudoknSwissMachiningCapability"
      SudoknSwissMachiningCapability : rdfs_label
        
          
    
    
    SudoknSwissMachiningCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknSwissMachiningCapability](../classes/SudoknSwissMachiningCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknSwissMachiningCapability](../classes/SudoknSwissMachiningCapability.md) |
...
| Value |
| --- |
| sudokn:DPMACHINING-SwissMachiningCapability-inst |
...
| ---  | ---  |
| self | sudokn:SwissMachiningCapability |
| native | sudokn-kg/:SudoknSwissMachiningCapability |
...
<details>
```yaml
name: sudokn_SwissMachiningCapability
...
- if you think the class is perfect.
notes:
- Class with 19 occurences.
examples:
- value: sudokn:DPMACHINING-SwissMachiningCapability-inst
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:SwissMachiningCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_SwissMachiningCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
