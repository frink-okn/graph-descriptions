...
# Class: TODO -- what's a good name for this class (type)? (sudokn_SandBlastingCapability)
...
URI: [sudokn:SandBlastingCapability](http://asu.edu/semantics/SUDOKN/SandBlastingCapability)
...
```mermaid
 classDiagram
    class SudoknSandBlastingCapability
    click SudoknSandBlastingCapability href "../SudoknSandBlastingCapability"
      ...
      SudoknSandBlastingCapability : rdfs_label
        
          
    
    
    SudoknSandBlastingCapability --> "0..1" String : rdfs_label
...
* [IoscProductionCapability](../classes/IoscProductionCapability.md)
    * [SudoknManufacturingProcessCapability](../classes/SudoknManufacturingProcessCapability.md)
        * [SudoknFinishingCapability](../classes/SudoknFinishingCapability.md)
            * [SudoknSurfacePreparationCapability](../classes/SudoknSurfacePreparationCapability.md)
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknSandBlastingCapability](../classes/SudoknSandBlastingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknSandBlastingCapability](../classes/SudoknSandBlastingCapability.md) |
...
| Value |
| --- |
| sudokn:A-M-W-SandBlastingCapability-inst |
...
| ---  | ---  |
| self | sudokn:SandBlastingCapability |
| native | sudokn-kg/:SudoknSandBlastingCapability |
...
<details>
```yaml
name: sudokn_SandBlastingCapability
...
- if you think the class is perfect.
notes:
- Class with 340 occurences.
examples:
- value: sudokn:A-M-W-SandBlastingCapability-inst
from_schema: sudokn-kg
is_a: sudokn_SurfacePreparationCapability
slots:
- rdfs_label
class_uri: sudokn:SandBlastingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_SandBlastingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
