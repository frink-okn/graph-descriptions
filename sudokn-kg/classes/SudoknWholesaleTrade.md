...
# Class: No class (type) name specified (sudokn_WholesaleTrade)
...
URI: [sudokn:WholesaleTrade](http://asu.edu/semantics/SUDOKN/WholesaleTrade)
...
```mermaid
 classDiagram
    ...
    click SudoknWholesaleTrade href "../SudoknWholesaleTrade"
      ...
      SudoknWholesaleTrade : sudokn_hasNAICSCodeValue
        
          
    
    
    SudoknWholesaleTrade --> "0..1" Any : sudokn_hasNAICSCodeValue
    click Any href "../Any"

        
      SudoknWholesaleTrade : sudokn_hasNAICSTextValue
        
          
    
    
    SudoknWholesaleTrade --> "0..1" Any : sudokn_hasNAICSTextValue
    click Any href "../Any"
...
class_uri: sudokn:WholesaleTrade
