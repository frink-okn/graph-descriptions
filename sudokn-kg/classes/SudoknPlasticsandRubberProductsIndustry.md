...
# Class: TODO -- what's a good name for this class (type)? (sudokn_PlasticsandRubberProductsIndustry)
...
URI: [sudokn:PlasticsandRubberProductsIndustry](http://asu.edu/semantics/SUDOKN/PlasticsandRubberProductsIndustry)
...
```mermaid
 classDiagram
    class SudoknPlasticsandRubberProductsIndustry
    click SudoknPlasticsandRubberProductsIndustry href "../SudoknPlasticsandRubberProductsIndustry"
      SudoknPlasticsandRubberProductsIndustry : rdfs_label
        
          
    
    
    SudoknPlasticsandRubberProductsIndustry --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknPlasticsandRubberProductsIndustry](../classes/SudoknPlasticsandRubberProductsIndustry.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknPlasticsandRubberProductsIndustry](../classes/SudoknPlasticsandRubberProductsIndustry.md) |
...
| Value |
| --- |
| sudokn:PlasticsandRubberProducts-Industry |
...
| ---  | ---  |
| self | sudokn:PlasticsandRubberProductsIndustry |
| native | sudokn-kg/:SudoknPlasticsandRubberProductsIndustry |
...
<details>
```yaml
name: sudokn_PlasticsandRubberProductsIndustry
...
examples:
- value: sudokn:PlasticsandRubberProducts-Industry
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:PlasticsandRubberProductsIndustry
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_PlasticsandRubberProductsIndustry
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
