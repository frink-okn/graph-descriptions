...
# Class: 5-axis machining capability (sudokn_FiveAxixMachiningCapability)





URI: [sudokn:FiveAxixMachiningCapability](http://asu.edu/semantics/SUDOKN/FiveAxixMachiningCapability)
...
```mermaid
 classDiagram
    class SudoknFiveAxixMachiningCapability
    click SudoknFiveAxixMachiningCapability href "../SudoknFiveAxixMachiningCapability"
      ...
      SudoknFiveAxixMachiningCapability : rdfs_label
        
          
    
    
    SudoknFiveAxixMachiningCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: sudokn_FiveAxixMachiningCapability
title: 5-axis machining capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_CNCMachiningCapability
class_uri: sudokn:FiveAxixMachiningCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_FiveAxixMachiningCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
