...
# Class: thread milling capability (sudokn_ThreadMillingCapability)





URI: [sudokn:ThreadMillingCapability](http://asu.edu/semantics/SUDOKN/ThreadMillingCapability)
...
```mermaid
 classDiagram
    class SudoknThreadMillingCapability
    click SudoknThreadMillingCapability href "../SudoknThreadMillingCapability"
      ...
      SudoknThreadMillingCapability : rdfs_label
        
          
    
    
    SudoknThreadMillingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject | [SudoknMillingCapability](../classes/SudoknMillingCapability.md), [SudoknMachiningCapability](../classes/SudoknMachiningCapability.md) |  |
...
```yaml
name: sudokn_ThreadMillingCapability
title: thread milling capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_MillingCapability
class_uri: sudokn:ThreadMillingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ThreadMillingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
