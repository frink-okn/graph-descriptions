...
```mermaid
 classDiagram
    ...
    SudoknJoiningCapability --> "0..1" String : rdfs_label
...
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknJoiningCapability](../classes/SudoknJoiningCapability.md) |
...
| Value |
| --- |
| sudokn:AAAPLATING-JoiningCapability-inst |
...
| ---  | ---  |
| self | sudokn:JoiningCapability |
| native | sudokn-kg/:SudoknJoiningCapability |
...
examples:
- value: sudokn:AAAPLATING-JoiningCapability-inst
