...
# Class: HttpsIdir.uta.eduSockg-ontology#Abstract
...
URI: [https://idir.uta.edu/sockg-ontology#Abstract](https://idir.uta.edu/sockg-ontology#Abstract)
...
```mermaid
 classDiagram
    ...
    click HttpsIdir.uta.eduSockg-ontology#Abstract href "../HttpsIdir.uta.eduSockg-ontology#Abstract"
      ...
      HttpsIdir.uta.eduSockg-ontology#Abstract : dct_bibliographicCitation
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#Abstract --> "0..1" RdfsLiteral : dct_bibliographicCitation
    click RdfsLiteral href "../RdfsLiteral"

        
      HttpsIdir.uta.eduSockg-ontology#Abstract : dct_creator
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#Abstract --> "0..1" Any : dct_creator
    click Any href "../Any"

        
      HttpsIdir.uta.eduSockg-ontology#Abstract : dct_issued
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#Abstract --> "0..1" Any : dct_issued
    click Any href "../Any"

        
      HttpsIdir.uta.eduSockg-ontology#Abstract : dct_title
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#Abstract --> "0..1" Any : dct_title
    click Any href "../Any"

        
      HttpsIdir.uta.eduSockg-ontology#Abstract : https___idir.uta.edu_sockg_ontology#correspondingAuthor
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#Abstract --> "0..1" String : https___idir.uta.edu_sockg_ontology#correspondingAuthor
    click String href "../String"

        
      HttpsIdir.uta.eduSockg-ontology#Abstract : rdfs_label
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#Abstract --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| [https___idir.uta.edu_sockg_ontology#correspondingAuthor](../slots/https___idir.uta.edu_sockg_ontology#correspondingAuthor.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string) |  <br/>  | direct | 3 |
...
| ---  | --- | --- | --- |
| [HttpsIdir.uta.eduSockg-ontology#Location](../classes/HttpsIdir.uta.eduSockg-ontology#Location.md) | [https___idir.uta.edu_sockg_ontology#cites](../slots/https___idir.uta.edu_sockg_ontology#cites.md) | any_of[range] | [HttpsIdir.uta.eduSockg-ontology#Abstract](../classes/HttpsIdir.uta.eduSockg-ontology#Abstract.md) |
...
```yaml
name: https___idir.uta.edu_sockg-ontology#Abstract
...
- dct_issued
class_uri: https://idir.uta.edu/sockg-ontology#Abstract
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: https___idir.uta.edu_sockg-ontology#Abstract
    domain_of:
    - qudt_AspectClass
    - qudt_BinaryPrefix
