...
# Class: aluminum processing capability (sudokn_AluminumProcessingCapability)
...
URI: [sudokn:AluminumProcessingCapability](http://asu.edu/semantics/SUDOKN/AluminumProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknAluminumProcessingCapability
    click SudoknAluminumProcessingCapability href "../SudoknAluminumProcessingCapability"
      ...
      SudoknAluminumProcessingCapability : rdfs_label
        
          
    
    
    SudoknAluminumProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknAluminumProcessingCapability](../classes/SudoknAluminumProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknAluminumProcessingCapability](../classes/SudoknAluminumProcessingCapability.md) |
...
| Value |
| --- |
| sudokn:/AluminumProcessingCapability_1 |
...
| ---  | ---  |
| self | sudokn:AluminumProcessingCapability |
| native | sudokn-kg/:SudoknAluminumProcessingCapability |
...
<details>
```yaml
name: sudokn_AluminumProcessingCapability
description: No type description provided
title: aluminum processing capability
todos:
- TODO -- Todos for this class go here
- or you can delete the todos
- if you think the class is perfect.
notes:
- Class with 5647 occurences.
examples:
- value: sudokn:/AluminumProcessingCapability_1
from_schema: sudokn-kg
rank: 1000
is_a: sudokn_MetalProcessingCapability
slots:
- rdfs_label
class_uri: sudokn:AluminumProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_AluminumProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
