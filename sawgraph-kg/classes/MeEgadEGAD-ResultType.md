...
# Class: EGAD - Result Type (me_egad_EGAD-ResultType)
...
URI: [me_egad:EGAD-ResultType](http://sawgraph.spatialai.org/v1/me-egad#EGAD-ResultType)
...
```mermaid
 classDiagram
    class MeEgadEGAD-ResultType
    click MeEgadEGAD-ResultType href "../MeEgadEGAD-ResultType"
      OwlThing <|-- MeEgadEGAD-ResultType
        click OwlThing href "../OwlThing"
      
      MeEgadEGAD-ResultType : owl_sameAs
        
          
    
    
    MeEgadEGAD-ResultType --> "0..1" OwlThing : owl_sameAs
    click OwlThing href "../OwlThing"

        
      MeEgadEGAD-ResultType : rdfs_label
        
          
    
    
    MeEgadEGAD-ResultType --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- |
| [HttpW3id.orgSawgraphV1Me-egad#EGAD-PFAS-Observation](../classes/HttpW3id.orgSawgraphV1Me-egad#EGAD-PFAS-Observation.md) | [coso_observationAnnotation](../slots/coso_observationAnnotation.md) | any_of[range] | [MeEgadEGAD-ResultType](../classes/MeEgadEGAD-ResultType.md) |
| [MeEgadEGAD-PFAS-Observation](../classes/MeEgadEGAD-PFAS-Observation.md) | [me_egad_resultType](../slots/me_egad_resultType.md) | any_of[range] | [MeEgadEGAD-ResultType](../classes/MeEgadEGAD-ResultType.md) |
| [MeEgadEGAD-PFAS-Observation](../classes/MeEgadEGAD-PFAS-Observation.md) | [coso_observationAnnotation](../slots/coso_observationAnnotation.md) | any_of[range] | [MeEgadEGAD-ResultType](../classes/MeEgadEGAD-ResultType.md) |
...
- rdfs_label
- owl_sameAs
class_uri: me_egad:EGAD-ResultType
