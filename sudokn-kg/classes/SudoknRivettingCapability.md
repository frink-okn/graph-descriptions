...
# Class: TODO -- what's a good name for this class (type)? (sudokn_RivettingCapability)
...
URI: [sudokn:RivettingCapability](http://asu.edu/semantics/SUDOKN/RivettingCapability)
...
```mermaid
 classDiagram
    class SudoknRivettingCapability
    click SudoknRivettingCapability href "../SudoknRivettingCapability"
      SudoknRivettingCapability : rdfs_label
        
          
    
    
    SudoknRivettingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknRivettingCapability](../classes/SudoknRivettingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknRivettingCapability](../classes/SudoknRivettingCapability.md) |
...
| Value |
| --- |
| sudokn:PrecisionSteelWorks-Rivetting |
...
| ---  | ---  |
| self | sudokn:RivettingCapability |
| native | sudokn-kg/:SudoknRivettingCapability |
...
<details>
```yaml
name: sudokn_RivettingCapability
...
examples:
- value: sudokn:PrecisionSteelWorks-Rivetting
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:RivettingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_RivettingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
