...
# Class: TODO -- what's a good name for this class (type)? (sudokn_HotDipGalvanizingCapability)
...
URI: [sudokn:HotDipGalvanizingCapability](http://asu.edu/semantics/SUDOKN/HotDipGalvanizingCapability)
...
```mermaid
 classDiagram
    class SudoknHotDipGalvanizingCapability
    click SudoknHotDipGalvanizingCapability href "../SudoknHotDipGalvanizingCapability"
      SudoknHotDipGalvanizingCapability : rdfs_label
        
          
    
    
    SudoknHotDipGalvanizingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknHotDipGalvanizingCapability](../classes/SudoknHotDipGalvanizingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknHotDipGalvanizingCapability](../classes/SudoknHotDipGalvanizingCapability.md) |
...
| Value |
| --- |
| sudokn:Wire-Bond-HotDipGalvanizing |
...
| ---  | ---  |
| self | sudokn:HotDipGalvanizingCapability |
| native | sudokn-kg/:SudoknHotDipGalvanizingCapability |
...
<details>
```yaml
name: sudokn_HotDipGalvanizingCapability
...
examples:
- value: sudokn:Wire-Bond-HotDipGalvanizing
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:HotDipGalvanizingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_HotDipGalvanizingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
