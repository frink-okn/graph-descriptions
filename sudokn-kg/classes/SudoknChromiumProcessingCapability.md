...
# Class: TODO -- what's a good name for this class (type)? (sudokn_ChromiumProcessingCapability)
...
URI: [sudokn:ChromiumProcessingCapability](http://asu.edu/semantics/SUDOKN/ChromiumProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknChromiumProcessingCapability
    click SudoknChromiumProcessingCapability href "../SudoknChromiumProcessingCapability"
      SudoknChromiumProcessingCapability : rdfs_label
        
          
    
    
    SudoknChromiumProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknChromiumProcessingCapability](../classes/SudoknChromiumProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknChromiumProcessingCapability](../classes/SudoknChromiumProcessingCapability.md) |
...
| ---  | ---  |
| self | sudokn:ChromiumProcessingCapability |
| native | sudokn-kg/:SudoknChromiumProcessingCapability |
...
<details>
```yaml
name: sudokn_ChromiumProcessingCapability
...
- if you think the class is perfect.
notes:
- Class with 551 occurences.
examples:
- value: sudokn:A1JAYS-Chromium-inst
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:ChromiumProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ChromiumProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
