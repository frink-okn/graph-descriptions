...
# Class: TODO -- what's a good name for this class (type)? (sudokn_DeepFreezingCapability)
...
URI: [sudokn:DeepFreezingCapability](http://asu.edu/semantics/SUDOKN/DeepFreezingCapability)
...
```mermaid
 classDiagram
    class SudoknDeepFreezingCapability
    click SudoknDeepFreezingCapability href "../SudoknDeepFreezingCapability"
      SudoknDeepFreezingCapability : rdfs_label
        
          
    
    
    SudoknDeepFreezingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknDeepFreezingCapability](../classes/SudoknDeepFreezingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknDeepFreezingCapability](../classes/SudoknDeepFreezingCapability.md) |
...
| Value |
| --- |
| sudokn:AmericanMetalTreating-DeepFreezing |
...
| ---  | ---  |
| self | sudokn:DeepFreezingCapability |
| native | sudokn-kg/:SudoknDeepFreezingCapability |
...
<details>
```yaml
name: sudokn_DeepFreezingCapability
...
examples:
- value: sudokn:AmericanMetalTreating-DeepFreezing
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:DeepFreezingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_DeepFreezingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
