...
# Class: No class (type) name specified (sudokn_EducationalServices)
...
URI: [sudokn:EducationalServices](http://asu.edu/semantics/SUDOKN/EducationalServices)
...
```mermaid
 classDiagram
    class SudoknEducationalServices
    click SudoknEducationalServices href "../SudoknEducationalServices"
      ...
      SudoknEducationalServices : sudokn_hasNAICSCodeValue
        
          
    
    
    SudoknEducationalServices --> "0..1" Any : sudokn_hasNAICSCodeValue
    click Any href "../Any"

        
      SudoknEducationalServices : sudokn_hasNAICSTextValue
        
          
    
    
    SudoknEducationalServices --> "0..1" Any : sudokn_hasNAICSTextValue
    click Any href "../Any"
...
```yaml
name: sudokn_EducationalServices
...
class_uri: sudokn:EducationalServices
...
attributes:
  sudokn_hasNAICSCodeValue:
    ...
    owner: sudokn_EducationalServices
    domain_of:
    - sudokn_NAICS332111
    - sudokn_NAICS332112
    - sudokn_NAICS332114
