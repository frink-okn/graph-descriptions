...
# Class: beverage industry (sudokn_BeverageIndustry)





URI: [sudokn:BeverageIndustry](http://asu.edu/semantics/SUDOKN/BeverageIndustry)
...
```mermaid
 classDiagram
    ...
    click SudoknBeverageIndustry href "../SudoknBeverageIndustry"
      ...
      SudoknBeverageIndustry : rdfs_label
        
          
    
    
    SudoknBeverageIndustry --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject | [SudoknFoodIndustry](../classes/SudoknFoodIndustry.md) |  |
...
```yaml
name: sudokn_BeverageIndustry
title: beverage industry
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_FoodIndustry
class_uri: sudokn:BeverageIndustry
