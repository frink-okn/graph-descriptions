...
# Class: TODO -- what's a good name for this class (type)? (sudokn_BroachingCapability)
...
URI: [sudokn:BroachingCapability](http://asu.edu/semantics/SUDOKN/BroachingCapability)
...
```mermaid
 classDiagram
    class SudoknBroachingCapability
    click SudoknBroachingCapability href "../SudoknBroachingCapability"
      ...
      SudoknBroachingCapability : rdfs_label
        
          
    
    
    SudoknBroachingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknBroachingCapability](../classes/SudoknBroachingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknBroachingCapability](../classes/SudoknBroachingCapability.md) |
...
| ---  | ---  |
| self | sudokn:BroachingCapability |
| native | sudokn-kg/:SudoknBroachingCapability |
...
<details>
```yaml
name: sudokn_BroachingCapability
...
slots:
- rdfs_label
class_uri: sudokn:BroachingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_BroachingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
