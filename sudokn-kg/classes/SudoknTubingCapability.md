...
# Class: TODO -- what's a good name for this class (type)? (sudokn_TubingCapability)
...
URI: [sudokn:TubingCapability](http://asu.edu/semantics/SUDOKN/TubingCapability)
...
```mermaid
 classDiagram
    class SudoknTubingCapability
    click SudoknTubingCapability href "../SudoknTubingCapability"
      SudoknTubingCapability : rdfs_label
        
          
    
    
    SudoknTubingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknTubingCapability](../classes/SudoknTubingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknTubingCapability](../classes/SudoknTubingCapability.md) |
...
| Value |
| --- |
| sudokn:3DIMENSIONAL-TubingCapability-inst |
...
| ---  | ---  |
| self | sudokn:TubingCapability |
| native | sudokn-kg/:SudoknTubingCapability |
...
- if you think the class is perfect.
notes:
- Class with 533 occurences.
examples:
- value: sudokn:3DIMENSIONAL-TubingCapability-inst
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:TubingCapability
