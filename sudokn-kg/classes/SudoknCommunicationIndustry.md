...
# Class: TODO -- what's a good name for this class (type)? (sudokn_CommunicationIndustry)
...
URI: [sudokn:CommunicationIndustry](http://asu.edu/semantics/SUDOKN/CommunicationIndustry)
...
```mermaid
 classDiagram
    class SudoknCommunicationIndustry
    click SudoknCommunicationIndustry href "../SudoknCommunicationIndustry"
      SudoknCommunicationIndustry : rdfs_label
        
          
    
    
    SudoknCommunicationIndustry --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknCommunicationIndustry](../classes/SudoknCommunicationIndustry.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknCommunicationIndustry](../classes/SudoknCommunicationIndustry.md) |
...
| ---  | ---  |
| self | sudokn:CommunicationIndustry |
| native | sudokn-kg/:SudoknCommunicationIndustry |
...
<details>
```yaml
name: sudokn_CommunicationIndustry
...
examples:
- value: sudokn:Communication-Industry
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:CommunicationIndustry
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_CommunicationIndustry
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
