...
This class occurs 368761 times.
...
```mermaid
 classDiagram
    ...
    click Fio-epa-frsStateTrackingRecord href "../Fio-epa-frsStateTrackingRecord"
      ...
      Fio-epa-frsStateTrackingRecord : dc_identifier
        
          
    
    
    Fio-epa-frsStateTrackingRecord --> "0..1" Any : dc_identifier
    click Any href "../Any"
