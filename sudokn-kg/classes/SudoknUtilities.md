...
# Class: No class (type) name specified (sudokn_Utilities)
...
URI: [sudokn:Utilities](http://asu.edu/semantics/SUDOKN/Utilities)
...
```mermaid
 classDiagram
    ...
    click SudoknUtilities href "../SudoknUtilities"
      ...
      SudoknUtilities : sudokn_hasNAICSCodeValue
        
          
    
    
    SudoknUtilities --> "0..1" Any : sudokn_hasNAICSCodeValue
    click Any href "../Any"

        
      SudoknUtilities : sudokn_hasNAICSTextValue
        
          
    
    
    SudoknUtilities --> "0..1" Any : sudokn_hasNAICSTextValue
    click Any href "../Any"
