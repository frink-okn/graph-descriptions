...
# Class: TODO -- what's a good name for this class (type)? (sudokn_NAICS332410)
...
URI: [sudokn:NAICS332410](http://asu.edu/semantics/SUDOKN/NAICS332410)
...
```mermaid
 classDiagram
    class SudoknNAICS332410
    click SudoknNAICS332410 href "../SudoknNAICS332410"
      SudoknNAICS332410 : sudokn_hasNAICSCodeValue
        
          
    
    
    SudoknNAICS332410 --> "0..1" Any : sudokn_hasNAICSCodeValue
    click Any href "../Any"

        
      SudoknNAICS332410 : sudokn_hasNAICSTextValue
        
          
    
    
    SudoknNAICS332410 --> "0..1" Any : sudokn_hasNAICSTextValue
    click Any href "../Any"
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasPrimaryNAICSClassifier](../slots/sudokn_hasPrimaryNAICSClassifier.md) | any_of[range] | [SudoknNAICS332410](../classes/SudoknNAICS332410.md) |
...
| ---  | ---  |
| self | sudokn:NAICS332410 |
| native | sudokn-kg/:SudoknNAICS332410 |
