...
# Class: SudoknSuperAlloyProcessingCapability





URI: [sudokn:SuperAlloyProcessingCapability](http://asu.edu/semantics/SUDOKN/SuperAlloyProcessingCapability)
...
```mermaid
 classDiagram
    ...
    click SudoknSuperAlloyProcessingCapability href "../SudoknSuperAlloyProcessingCapability"
      ...
      SudoknSuperAlloyProcessingCapability : rdfs_label
        
          
    
    
    SudoknSuperAlloyProcessingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
    ...
    * [SudoknMaterialProcessingCapability](../classes/SudoknMaterialProcessingCapability.md)
        * [SudoknMetalProcessingCapability](../classes/SudoknMetalProcessingCapability.md)
            * **SudoknSuperAlloyProcessingCapability**
                * [SudoknWaspaloyProcessingCapability](../classes/SudoknWaspaloyProcessingCapability.md)
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject | [SudoknMetalProcessingCapability](../classes/SudoknMetalProcessingCapability.md) |  |
...
```yaml
name: sudokn_SuperAlloyProcessingCapability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_MetalProcessingCapability
class_uri: sudokn:SuperAlloyProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_SuperAlloyProcessingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
