...
# Class: No class (entity type) name specified -- this class is noted as a superclass of another class in this graph but has not itself been defined. (sudokn_ElectricArcWeldingCapability)





URI: [sudokn:ElectricArcWeldingCapability](http://asu.edu/semantics/SUDOKN/ElectricArcWeldingCapability)
...
```mermaid
 classDiagram
    class SudoknElectricArcWeldingCapability
    click SudoknElectricArcWeldingCapability href "../SudoknElectricArcWeldingCapability"
      SudoknThermalWeldingCapability <|-- SudoknElectricArcWeldingCapability
        click SudoknThermalWeldingCapability href "../SudoknThermalWeldingCapability"
      

      SudoknElectricArcWeldingCapability <|-- SudoknCarbonArcWeldingCapability
        click SudoknCarbonArcWeldingCapability href "../SudoknCarbonArcWeldingCapability"
      SudoknElectricArcWeldingCapability <|-- SudoknFluxCoredArcWeldingCapability
        click SudoknFluxCoredArcWeldingCapability href "../SudoknFluxCoredArcWeldingCapability"
      SudoknElectricArcWeldingCapability <|-- SudoknGasMetalArcWeldingCapability
        click SudoknGasMetalArcWeldingCapability href "../SudoknGasMetalArcWeldingCapability"
      SudoknElectricArcWeldingCapability <|-- SudoknGasTungstenArcWeldingCapability
        click SudoknGasTungstenArcWeldingCapability href "../SudoknGasTungstenArcWeldingCapability"
      SudoknElectricArcWeldingCapability <|-- SudoknShieldedMetalArcWeldingCapability
        click SudoknShieldedMetalArcWeldingCapability href "../SudoknShieldedMetalArcWeldingCapability"
      SudoknElectricArcWeldingCapability <|-- SudoknStudWeldingCapability
        click SudoknStudWeldingCapability href "../SudoknStudWeldingCapability"
      SudoknElectricArcWeldingCapability <|-- SudoknSubmergedArcWeldingCapability
        click SudoknSubmergedArcWeldingCapability href "../SudoknSubmergedArcWeldingCapability"
      
      
      SudoknElectricArcWeldingCapability : rdfs_label
        
          
    
    
    SudoknElectricArcWeldingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
* [IoscProductionCapability](../classes/IoscProductionCapability.md)
    * [SudoknManufacturingProcessCapability](../classes/SudoknManufacturingProcessCapability.md)
        * [SudoknJoiningCapability](../classes/SudoknJoiningCapability.md)
            * [SudoknThermaJoiningCapability](../classes/SudoknThermaJoiningCapability.md)
                * [SudoknThermalWeldingCapability](../classes/SudoknThermalWeldingCapability.md)
                    * **SudoknElectricArcWeldingCapability**
                        * [SudoknCarbonArcWeldingCapability](../classes/SudoknCarbonArcWeldingCapability.md)
                        * [SudoknFluxCoredArcWeldingCapability](../classes/SudoknFluxCoredArcWeldingCapability.md)
                        * [SudoknGasMetalArcWeldingCapability](../classes/SudoknGasMetalArcWeldingCapability.md)
                        * [SudoknGasTungstenArcWeldingCapability](../classes/SudoknGasTungstenArcWeldingCapability.md)
                        * [SudoknShieldedMetalArcWeldingCapability](../classes/SudoknShieldedMetalArcWeldingCapability.md)
                        * [SudoknStudWeldingCapability](../classes/SudoknStudWeldingCapability.md)
                        * [SudoknSubmergedArcWeldingCapability](../classes/SudoknSubmergedArcWeldingCapability.md)
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject | [SudoknJoiningCapability](../classes/SudoknJoiningCapability.md) |  |
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ElectricArcWeldingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
