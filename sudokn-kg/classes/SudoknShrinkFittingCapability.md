...
# Class: shrink fitting capability (sudokn_ShrinkFittingCapability)
...
URI: [sudokn:ShrinkFittingCapability](http://asu.edu/semantics/SUDOKN/ShrinkFittingCapability)
...
```mermaid
 classDiagram
    class SudoknShrinkFittingCapability
    click SudoknShrinkFittingCapability href "../SudoknShrinkFittingCapability"
      ...
      SudoknShrinkFittingCapability : rdfs_label
        
          
    
    
    SudoknShrinkFittingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject <br/>  | direct | 9 |
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknShrinkFittingCapability](../classes/SudoknShrinkFittingCapability.md) |
...
```yaml
name: sudokn_ShrinkFittingCapability
title: shrink fitting capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_PressFittingCapability
slots:
- rdfs_label
class_uri: sudokn:ShrinkFittingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ShrinkFittingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
