...
# Class: Agriculture (fio-epa-frs_Agency.Agriculture)
...
URI: [fio-epa-frs:Agency.Agriculture](http://w3id.org/fio/v1/epa-frs#Agency.Agriculture)
...
```mermaid
 classDiagram
    class Fio-epa-frsAgency.Agriculture
    click Fio-epa-frsAgency.Agriculture href "../Fio-epa-frsAgency.Agriculture"
      ProvAgent <|-- Fio-epa-frsAgency.Agriculture
        click ProvAgent href "../ProvAgent"
      
      Fio-epa-frsAgency.Agriculture : owl_sameAs
        
          
    
    
    Fio-epa-frsAgency.Agriculture --> "0..1" OwlThing : owl_sameAs
    click OwlThing href "../OwlThing"

        
      Fio-epa-frsAgency.Agriculture : rdfs_label
        
          
    
    
    Fio-epa-frsAgency.Agriculture --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- |
| [Fio-epa-frsEPA-PFAS-Facility](../classes/Fio-epa-frsEPA-PFAS-Facility.md) | [fio_ownedBy](../slots/fio_ownedBy.md) | any_of[range] | [Fio-epa-frsAgency.Agriculture](../classes/Fio-epa-frsAgency.Agriculture.md) |
| [Fio-epa-frsFRS-Facility](../classes/Fio-epa-frsFRS-Facility.md) | [fio_ownedBy](../slots/fio_ownedBy.md) | any_of[range] | [Fio-epa-frsAgency.Agriculture](../classes/Fio-epa-frsAgency.Agriculture.md) |
...
- rdfs_label
- owl_sameAs
class_uri: fio-epa-frs:Agency.Agriculture
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: fio-epa-frs_Agency.Agriculture
    domain_of:
