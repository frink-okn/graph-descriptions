...
# Class: TODO -- what's a good name for this class (type)? (sudokn_FlameSprayingCapability)
...
```mermaid
 classDiagram
    ...
    SudoknFlameSprayingCapability --> "0..1" String : rdfs_label
...
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknFlameSprayingCapability](../classes/SudoknFlameSprayingCapability.md) |
...
| Value |
| --- |
| sudokn:ASTROMECHANICS-FlameSprayingCapability-inst |
...
| ---  | ---  |
| self | sudokn:FlameSprayingCapability |
| native | sudokn-kg/:SudoknFlameSprayingCapability |
...
examples:
- value: sudokn:ASTROMECHANICS-FlameSprayingCapability-inst
