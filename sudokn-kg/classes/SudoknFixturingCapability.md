...
# Class: TODO -- what's a good name for this class (type)? (sudokn_FixturingCapability)
...
URI: [sudokn:FixturingCapability](http://asu.edu/semantics/SUDOKN/FixturingCapability)
...
```mermaid
 classDiagram
    class SudoknFixturingCapability
    click SudoknFixturingCapability href "../SudoknFixturingCapability"
      SudoknFixturingCapability : rdfs_label
        
          
    
    
    SudoknFixturingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknFixturingCapability](../classes/SudoknFixturingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknFixturingCapability](../classes/SudoknFixturingCapability.md) |
...
| Value |
| --- |
| sudokn:RoyalDevelopmentMetalStamping-Fixturing |
...
| ---  | ---  |
| self | sudokn:FixturingCapability |
| native | sudokn-kg/:SudoknFixturingCapability |
...
<details>
```yaml
name: sudokn_FixturingCapability
...
examples:
- value: sudokn:RoyalDevelopmentMetalStamping-Fixturing
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:FixturingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_FixturingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
