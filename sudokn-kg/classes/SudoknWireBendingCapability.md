...
# Class: TODO -- what's a good name for this class (type)? (sudokn_WireBendingCapability)
...
URI: [sudokn:WireBendingCapability](http://asu.edu/semantics/SUDOKN/WireBendingCapability)
...
```mermaid
 classDiagram
    class SudoknWireBendingCapability
    click SudoknWireBendingCapability href "../SudoknWireBendingCapability"
      ...
      SudoknWireBendingCapability : rdfs_label
        
          
    
    
    SudoknWireBendingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknWireBendingCapability](../classes/SudoknWireBendingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknWireBendingCapability](../classes/SudoknWireBendingCapability.md) |
...
| Value |
| --- |
| sudokn:RedTailGroup-WireBending |
...
| ---  | ---  |
| self | sudokn:WireBendingCapability |
| native | sudokn-kg/:SudoknWireBendingCapability |
...
<details>
```yaml
name: sudokn_WireBendingCapability
...
examples:
- value: sudokn:RedTailGroup-WireBending
from_schema: sudokn-kg
is_a: sudokn_BendingCapability
slots:
- rdfs_label
class_uri: sudokn:WireBendingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_WireBendingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
