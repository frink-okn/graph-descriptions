...
# Class: TODO -- what's a good name for this class (type)? (sudokn_RoboticWeldingCapability)
...
URI: [sudokn:RoboticWeldingCapability](http://asu.edu/semantics/SUDOKN/RoboticWeldingCapability)
...
```mermaid
 classDiagram
    class SudoknRoboticWeldingCapability
    click SudoknRoboticWeldingCapability href "../SudoknRoboticWeldingCapability"
      SudoknRoboticWeldingCapability : rdfs_label
        
          
    
    
    SudoknRoboticWeldingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknRoboticWeldingCapability](../classes/SudoknRoboticWeldingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknRoboticWeldingCapability](../classes/SudoknRoboticWeldingCapability.md) |
...
| Value |
| --- |
| sudokn:BarnesMetalCrafters-RoboticWelding |
...
| ---  | ---  |
| self | sudokn:RoboticWeldingCapability |
| native | sudokn-kg/:SudoknRoboticWeldingCapability |
...
<details>
```yaml
name: sudokn_RoboticWeldingCapability
...
examples:
- value: sudokn:BarnesMetalCrafters-RoboticWelding
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:RoboticWeldingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_RoboticWeldingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
