...
# Class: TODO -- what's a good name for this class (type)? (prov_Organization)
...
| ---  | --- | --- | --- |
| [ContaminosoContaminantObservation](../classes/ContaminosoContaminantObservation.md) | [contaminoso_analyzedBy](../slots/contaminoso_analyzedBy.md) | range | [ProvOrganization](../classes/ProvOrganization.md) |
...
| Value |
| --- |
| http://sawgraph.spatialai.org/v1/me-egad-data#organization.lab.AA |
...
| native | sawgraph-kg/:ProvOrganization |
...
examples:
- value: http://sawgraph.spatialai.org/v1/me-egad-data#organization.lab.AA
