...
# Class: foam processing capability (sudokn_FoamProcessingCapability)
...
URI: [sudokn:FoamProcessingCapability](http://asu.edu/semantics/SUDOKN/FoamProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknFoamProcessingCapability
    click SudoknFoamProcessingCapability href "../SudoknFoamProcessingCapability"
      ...
      SudoknFoamProcessingCapability : rdfs_label
        
          
    
    
    SudoknFoamProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknFoamProcessingCapability](../classes/SudoknFoamProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknFoamProcessingCapability](../classes/SudoknFoamProcessingCapability.md) |
...
| ---  | ---  |
| self | sudokn:FoamProcessingCapability |
| native | sudokn-kg/:SudoknFoamProcessingCapability |
...
<details>
```yaml
name: sudokn_FoamProcessingCapability
description: TODO -- tell the world what this class (type) describes.
title: foam processing capability
todos:
- TODO -- Todos for this class go here
- or you can delete the todos
- if you think the class is perfect.
notes:
- Class with 1065 occurences.
examples:
- value: sudokn:149401-US-Foam-inst
from_schema: sudokn-kg
is_a: sudokn_MaterialProcessingCapability
slots:
- rdfs_label
class_uri: sudokn:FoamProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_FoamProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
