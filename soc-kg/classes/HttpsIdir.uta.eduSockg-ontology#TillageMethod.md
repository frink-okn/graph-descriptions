...
# Class: HttpsIdir.uta.eduSockg-ontology#TillageMethod
...
URI: [https://idir.uta.edu/sockg-ontology#TillageMethod](https://idir.uta.edu/sockg-ontology#TillageMethod)
...
```mermaid
 classDiagram
    ...
    click HttpsIdir.uta.eduSockg-ontology#TillageMethod href "../HttpsIdir.uta.eduSockg-ontology#TillageMethod"
      HttpsIdir.uta.eduSockg-ontology#TillageMethod : rdfs_label
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#TillageMethod --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: https___idir.uta.edu_sockg-ontology#TillageMethod
from_schema: okns:soc-kg
rank: 1000
slots:
- rdfs_label
class_uri: https://idir.uta.edu/sockg-ontology#TillageMethod
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: https___idir.uta.edu_sockg-ontology#TillageMethod
    domain_of:
