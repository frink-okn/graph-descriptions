...
# Class: HttpsIdir.uta.eduSockg-ontology#Equipment
...
URI: [https://idir.uta.edu/sockg-ontology#Equipment](https://idir.uta.edu/sockg-ontology#Equipment)
...
```mermaid
 classDiagram
    ...
    click HttpsIdir.uta.eduSockg-ontology#Equipment href "../HttpsIdir.uta.eduSockg-ontology#Equipment"
      HttpsIdir.uta.eduSockg-ontology#Equipment : rdfs_label
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#Equipment --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: https___idir.uta.edu_sockg-ontology#Equipment
from_schema: okns:soc-kg
rank: 1000
slots:
- rdfs_label
class_uri: https://idir.uta.edu/sockg-ontology#Equipment
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: https___idir.uta.edu_sockg-ontology#Equipment
    domain_of:
