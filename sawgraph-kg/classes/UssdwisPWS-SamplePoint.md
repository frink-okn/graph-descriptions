...
# Class: TODO -- what's a good name for this class (type)? (ussdwis_PWS-SamplePoint)
...
URI: [ussdwis:PWS-SamplePoint](http://sawgraph.spatialai.org/v1/us-sdwis#PWS-SamplePoint)
...
```mermaid
 classDiagram
    ...
    click UssdwisPWS-SamplePoint href "../UssdwisPWS-SamplePoint"
      ...
      UssdwisPWS-SamplePoint : geo_hasSerialization
        
          
    
    
    UssdwisPWS-SamplePoint --> "0..1" GeoWktLiteral : geo_hasSerialization
...
| ---  | ---  |
| self | ussdwis:PWS-SamplePoint |
| native | sawgraph-kg/:UssdwisPWS-SamplePoint |
...
class_uri: ussdwis:PWS-SamplePoint
