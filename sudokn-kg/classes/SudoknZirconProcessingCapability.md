...
# Class: TODO -- what's a good name for this class (type)? (sudokn_ZirconProcessingCapability)
...
URI: [sudokn:ZirconProcessingCapability](http://asu.edu/semantics/SUDOKN/ZirconProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknZirconProcessingCapability
    click SudoknZirconProcessingCapability href "../SudoknZirconProcessingCapability"
      SudoknZirconProcessingCapability : rdfs_label
        
          
    
    
    SudoknZirconProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknZirconProcessingCapability](../classes/SudoknZirconProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknZirconProcessingCapability](../classes/SudoknZirconProcessingCapability.md) |
...
| Value |
| --- |
| sudokn:ABILITYENGINEERING-Zircon-inst |
...
| ---  | ---  |
| self | sudokn:ZirconProcessingCapability |
| native | sudokn-kg/:SudoknZirconProcessingCapability |
...
<details>
```yaml
name: sudokn_ZirconProcessingCapability
...
- if you think the class is perfect.
notes:
- Class with 240 occurences.
examples:
- value: sudokn:ABILITYENGINEERING-Zircon-inst
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:ZirconProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ZirconProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
