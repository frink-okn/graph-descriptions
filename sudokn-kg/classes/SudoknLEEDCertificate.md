...
# Class: LEED certificate (sudokn_LEEDCertificate)
...
```mermaid
 classDiagram
    ...
    click SudoknLEEDCertificate href "../SudoknLEEDCertificate"
      SudoknSustainabilityCertificate <|-- SudoknLEEDCertificate
    ...
    SudoknLEEDCertificate --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
rank: 1000
is_a: sudokn_SustainabilityCertificate
slots:
- rdfs_label
