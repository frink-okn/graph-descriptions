...
# Class: TODO -- what's a good name for this class (type)? (sudokn_ISO9001)
...
| ---  | ---  |
| self | sudokn:ISO9001 |
| native | sudokn-kg/:SudoknISO9001 |
...
- if you think the class is perfect.
notes:
- Class with 82 occurences.
examples:
- value: sudokn:Accu-Fab-ISO9001
