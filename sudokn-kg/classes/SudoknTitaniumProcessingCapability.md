...
# Class: titanium processing capability (sudokn_TitaniumProcessingCapability)
...
URI: [sudokn:TitaniumProcessingCapability](http://asu.edu/semantics/SUDOKN/TitaniumProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknTitaniumProcessingCapability
    click SudoknTitaniumProcessingCapability href "../SudoknTitaniumProcessingCapability"
      ...
      SudoknTitaniumProcessingCapability : rdfs_label
        
          
    
    
    SudoknTitaniumProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknTitaniumProcessingCapability](../classes/SudoknTitaniumProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknTitaniumProcessingCapability](../classes/SudoknTitaniumProcessingCapability.md) |
...
| Value |
| --- |
| sudokn:3DXINDUSTRIES-Titanium-inst |
...
| ---  | ---  |
| self | sudokn:TitaniumProcessingCapability |
| native | sudokn-kg/:SudoknTitaniumProcessingCapability |
...
<details>
```yaml
name: sudokn_TitaniumProcessingCapability
description: No type description provided
title: titanium processing capability
todos:
- TODO -- Todos for this class go here
- or you can delete the todos
- if you think the class is perfect.
notes:
- Class with 1349 occurences.
examples:
- value: sudokn:3DXINDUSTRIES-Titanium-inst
from_schema: sudokn-kg
rank: 1000
is_a: sudokn_MetalProcessingCapability
slots:
- rdfs_label
class_uri: sudokn:TitaniumProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_TitaniumProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
