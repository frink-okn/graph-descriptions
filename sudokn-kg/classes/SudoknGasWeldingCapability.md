...
# Class: No class (entity type) name specified -- this class is noted as a superclass of another class in this graph but has not itself been defined. (sudokn_GasWeldingCapability)





URI: [sudokn:GasWeldingCapability](http://asu.edu/semantics/SUDOKN/GasWeldingCapability)
...
```mermaid
 classDiagram
    class SudoknGasWeldingCapability
    click SudoknGasWeldingCapability href "../SudoknGasWeldingCapability"
      ...
      SudoknGasWeldingCapability <|-- SudoknAtomicHydrogenWeldingCapability
        click SudoknAtomicHydrogenWeldingCapability href "../SudoknAtomicHydrogenWeldingCapability"
      SudoknGasWeldingCapability <|-- SudoknCombustableGasWeldingCapability
        click SudoknCombustableGasWeldingCapability href "../SudoknCombustableGasWeldingCapability"
      
      
      SudoknGasWeldingCapability : rdfs_label
        
          
    
    
    SudoknGasWeldingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
            ...
            * [SudoknThermaJoiningCapability](../classes/SudoknThermaJoiningCapability.md)
                * [SudoknThermalWeldingCapability](../classes/SudoknThermalWeldingCapability.md)
                    * **SudoknGasWeldingCapability**
                        * [SudoknAtomicHydrogenWeldingCapability](../classes/SudoknAtomicHydrogenWeldingCapability.md)
                        * [SudoknCombustableGasWeldingCapability](../classes/SudoknCombustableGasWeldingCapability.md)
...
```yaml
name: sudokn_GasWeldingCapability
title: No class (entity type) name specified -- this class is noted as a superclass
  of another class in this graph but has not itself been defined.
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_ThermalWeldingCapability
class_uri: sudokn:GasWeldingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_GasWeldingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
