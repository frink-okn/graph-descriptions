...
# Class: harperizing capability (sudokn_HarperizingCapability)
...
```mermaid
 classDiagram
    ...
    SudoknHarperizingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
* centrifugal finishing capability
