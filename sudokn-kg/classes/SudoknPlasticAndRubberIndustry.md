...
# Class: plastic and rubber industry (sudokn_PlasticAndRubberIndustry)
...
URI: [sudokn:PlasticAndRubberIndustry](http://asu.edu/semantics/SUDOKN/PlasticAndRubberIndustry)
...
```mermaid
 classDiagram
    class SudoknPlasticAndRubberIndustry
    click SudoknPlasticAndRubberIndustry href "../SudoknPlasticAndRubberIndustry"
      ...
      SudoknPlasticAndRubberIndustry : rdfs_label
        
          
    
    
    SudoknPlasticAndRubberIndustry --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknPlasticAndRubberIndustry](../classes/SudoknPlasticAndRubberIndustry.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknPlasticAndRubberIndustry](../classes/SudoknPlasticAndRubberIndustry.md) |
...
| ---  | ---  |
| self | sudokn:PlasticAndRubberIndustry |
| native | sudokn-kg/:SudoknPlasticAndRubberIndustry |
...
<details>
```yaml
name: sudokn_PlasticAndRubberIndustry
description: TODO -- tell the world what this class (type) describes.
title: plastic and rubber industry
todos:
- TODO -- Todos for this class go here
- or you can delete the todos
- if you think the class is perfect.
...
slots:
- rdfs_label
class_uri: sudokn:PlasticAndRubberIndustry
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_PlasticAndRubberIndustry
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
