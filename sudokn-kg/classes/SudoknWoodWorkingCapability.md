...
# Class: wood working capability (sudokn_WoodWorkingCapability)
...
URI: [sudokn:WoodWorkingCapability](http://asu.edu/semantics/SUDOKN/WoodWorkingCapability)
...
```mermaid
 classDiagram
    class SudoknWoodWorkingCapability
    click SudoknWoodWorkingCapability href "../SudoknWoodWorkingCapability"
      ...
      SudoknWoodWorkingCapability : rdfs_label
        
          
    
    
    SudoknWoodWorkingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknWoodWorkingCapability](../classes/SudoknWoodWorkingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknWoodWorkingCapability](../classes/SudoknWoodWorkingCapability.md) |
...
| Value |
| --- |
| sudokn:BCTINT-WoodWorkingCapability-inst |
...
| ---  | ---  |
| self | sudokn:WoodWorkingCapability |
| native | sudokn-kg/:SudoknWoodWorkingCapability |
...
<details>
```yaml
name: sudokn_WoodWorkingCapability
description: TODO -- tell the world what this class (type) describes.
title: wood working capability
todos:
- TODO -- Todos for this class go here
- or you can delete the todos
- if you think the class is perfect.
...
examples:
- value: sudokn:BCTINT-WoodWorkingCapability-inst
from_schema: sudokn-kg
is_a: sudokn_ManufacturingProcessCapability
slots:
- rdfs_label
class_uri: sudokn:WoodWorkingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_WoodWorkingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
