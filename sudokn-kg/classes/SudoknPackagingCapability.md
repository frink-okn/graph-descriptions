...
# Class: TODO -- what's a good name for this class (type)? (sudokn_PackagingCapability)
...
URI: [sudokn:PackagingCapability](http://asu.edu/semantics/SUDOKN/PackagingCapability)
...
```mermaid
 classDiagram
    class SudoknPackagingCapability
    click SudoknPackagingCapability href "../SudoknPackagingCapability"
      SudoknPackagingCapability : rdfs_label
        
          
    
    
    SudoknPackagingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknPackagingCapability](../classes/SudoknPackagingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknPackagingCapability](../classes/SudoknPackagingCapability.md) |
...
| ---  | ---  |
| self | sudokn:PackagingCapability |
| native | sudokn-kg/:SudoknPackagingCapability |
...
<details>
```yaml
name: sudokn_PackagingCapability
...
examples:
- value: sudokn:HorizonTool-Packaging
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:PackagingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_PackagingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
