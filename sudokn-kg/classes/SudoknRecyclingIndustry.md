...
# Class: recycling industry (sudokn_RecyclingIndustry)
...
| ---  | ---  |
| self | sudokn:RecyclingIndustry |
| native | sudokn-kg/:SudoknRecyclingIndustry |
...
examples:
- value: sudokn:Recycling-Industry
