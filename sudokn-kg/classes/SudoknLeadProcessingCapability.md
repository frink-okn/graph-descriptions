...
# Class: TODO -- what's a good name for this class (type)? (sudokn_LeadProcessingCapability)
...
URI: [sudokn:LeadProcessingCapability](http://asu.edu/semantics/SUDOKN/LeadProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknLeadProcessingCapability
    click SudoknLeadProcessingCapability href "../SudoknLeadProcessingCapability"
      SudoknLeadProcessingCapability : rdfs_label
        
          
    
    
    SudoknLeadProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknLeadProcessingCapability](../classes/SudoknLeadProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknLeadProcessingCapability](../classes/SudoknLeadProcessingCapability.md) |
...
| ---  | ---  |
| self | sudokn:LeadProcessingCapability |
| native | sudokn-kg/:SudoknLeadProcessingCapability |
...
<details>
```yaml
name: sudokn_LeadProcessingCapability
...
- if you think the class is perfect.
notes:
- Class with 2484 occurences.
examples:
- value: sudokn:2RIVERSUPPLY-Lead-inst
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:LeadProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_LeadProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
