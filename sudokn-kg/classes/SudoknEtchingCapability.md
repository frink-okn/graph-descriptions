...
# Class: TODO -- what's a good name for this class (type)? (sudokn_EtchingCapability)
...
```mermaid
 classDiagram
    ...
    SudoknEtchingCapability --> "0..1" String : rdfs_label
...
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknEtchingCapability](../classes/SudoknEtchingCapability.md) |
...
| Value |
| --- |
| sudokn:3DMACH-EtchingCapability-inst |
...
| ---  | ---  |
| self | sudokn:EtchingCapability |
| native | sudokn-kg/:SudoknEtchingCapability |
...
- if you think the class is perfect.
notes:
- Class with 487 occurences.
examples:
- value: sudokn:3DMACH-EtchingCapability-inst
