...
# Class: phosphor bronze processing capability (sudokn_PhosphorBronzeProcessingCapability)


_phosphor bronze processing capability_
...
```mermaid
 classDiagram
    ...
    SudoknPhosphorBronzeProcessingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
description: phosphor bronze processing capability
title: phosphor bronze processing capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_BronzeProcessingCapability
slots:
- rdfs_label
