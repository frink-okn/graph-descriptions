...
# Class: honing capability (sudokn_HoningCapability)
...
URI: [sudokn:HoningCapability](http://asu.edu/semantics/SUDOKN/HoningCapability)
...
```mermaid
 classDiagram
    ...
    click SudoknHoningCapability href "../SudoknHoningCapability"
      ...
      SudoknHoningCapability : rdfs_label
        
          
    
    
    SudoknHoningCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknHoningCapability](../classes/SudoknHoningCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknHoningCapability](../classes/SudoknHoningCapability.md) |
...
| Value |
| --- |
| sudokn:A1JAYS-HoningCapability-inst |
...
| ---  | ---  |
| self | sudokn:HoningCapability |
| native | sudokn-kg/:SudoknHoningCapability |
...
<details>
```yaml
name: sudokn_HoningCapability
description: No type description provided
title: honing capability
todos:
- TODO -- Todos for this class go here
- or you can delete the todos
- if you think the class is perfect.
notes:
- Class with 460 occurences.
examples:
- value: sudokn:A1JAYS-HoningCapability-inst
from_schema: sudokn-kg
rank: 1000
is_a: sudokn_AbrassiveMachiningCapability
slots:
- rdfs_label
class_uri: sudokn:HoningCapability
