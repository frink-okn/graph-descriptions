...
# Class: TODO -- what's a good name for this class (type)? (sudokn_ExtrusionCapability)
...
URI: [sudokn:ExtrusionCapability](http://asu.edu/semantics/SUDOKN/ExtrusionCapability)
...
```mermaid
 classDiagram
    class SudoknExtrusionCapability
    click SudoknExtrusionCapability href "../SudoknExtrusionCapability"
      SudoknExtrusionCapability : rdfs_label
        
          
    
    
    SudoknExtrusionCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknExtrusionCapability](../classes/SudoknExtrusionCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknExtrusionCapability](../classes/SudoknExtrusionCapability.md) |
...
| Value |
| --- |
| sudokn:SignandAwningSystems-Extrusion |
...
| ---  | ---  |
| self | sudokn:ExtrusionCapability |
| native | sudokn-kg/:SudoknExtrusionCapability |
...
<details>
```yaml
name: sudokn_ExtrusionCapability
...
examples:
- value: sudokn:SignandAwningSystems-Extrusion
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:ExtrusionCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ExtrusionCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
