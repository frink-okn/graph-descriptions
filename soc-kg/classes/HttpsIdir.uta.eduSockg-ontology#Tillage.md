...
# Class: HttpsIdir.uta.eduSockg-ontology#Tillage
...
URI: [https://idir.uta.edu/sockg-ontology#Tillage](https://idir.uta.edu/sockg-ontology#Tillage)
...
```mermaid
 classDiagram
    ...
    click HttpsIdir.uta.eduSockg-ontology#Tillage href "../HttpsIdir.uta.eduSockg-ontology#Tillage"
      HttpsIdir.uta.eduSockg-ontology#Tillage : dct_description
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#Tillage --> "0..1" String : dct_description
...
| ---  | --- | --- | --- |
| [HttpsIdir.uta.eduSockg-ontology#Treatment](../classes/HttpsIdir.uta.eduSockg-ontology#Treatment.md) | [https___idir.uta.edu_sockg_ontology#hasTillage](../slots/https___idir.uta.edu_sockg_ontology#hasTillage.md) | range | [HttpsIdir.uta.eduSockg-ontology#Tillage](../classes/HttpsIdir.uta.eduSockg-ontology#Tillage.md) |
...
```yaml
name: https___idir.uta.edu_sockg-ontology#Tillage
from_schema: okns:soc-kg
rank: 1000
slots:
- dct_description
class_uri: https://idir.uta.edu/sockg-ontology#Tillage
...
attributes:
  dct_description:
    ...
    owner: https___idir.uta.edu_sockg-ontology#Tillage
    domain_of:
    - qudt_BinaryPrefix
