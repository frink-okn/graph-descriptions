...
# Class: WQP - Sampled Feature (http___w3id.org_sawgraph_v1_us-wqp#SampledFeature)




This class occurs 472 times.


URI: [http://w3id.org/sawgraph/v1/us-wqp#SampledFeature](http://w3id.org/sawgraph/v1/us-wqp#SampledFeature)
...
```mermaid
 classDiagram
    class HttpW3id.orgSawgraphV1Us-wqp#SampledFeature
    click HttpW3id.orgSawgraphV1Us-wqp#SampledFeature href "../HttpW3id.orgSawgraphV1Us-wqp#SampledFeature"
      ...
      HttpW3id.orgSawgraphV1Us-wqp#SampledFeature : http___w3id.org_sawgraph_v1_us_wqp#locationType
        
          
    
    
    HttpW3id.orgSawgraphV1Us-wqp#SampledFeature --> "0..1" Any : http___w3id.org_sawgraph_v1_us_wqp#locationType
    click Any href "../Any"

        
      HttpW3id.orgSawgraphV1Us-wqp#SampledFeature : rdfs_label
        
          
    
    
    HttpW3id.orgSawgraphV1Us-wqp#SampledFeature --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- | --- |
| [http___w3id.org_sawgraph_v1_us_wqp#locationType](../slots/http___w3id.org_sawgraph_v1_us_wqp#locationType.md) | 0..1 <br/> [HttpW3id.orgSawgraphV1Us-wqp#DefWQPSurfaceWaterFeatureType](../classes/HttpW3id.orgSawgraphV1Us-wqp#DefWQPSurfaceWaterFeatureType.md)&nbsp;or&nbsp;<br />[HttpW3id.orgSawgraphV1Us-wqp#LocationType](../classes/HttpW3id.orgSawgraphV1Us-wqp#LocationType.md)&nbsp;or&nbsp;<br />[xsd:anyURI](http://www.w3.org/2001/XMLSchema#anyURI)&nbsp;or&nbsp;<br />[HttpW3id.orgSawgraphV1Us-wqp#DefWQPGroundWaterFeatureType](../classes/HttpW3id.orgSawgraphV1Us-wqp#DefWQPGroundWaterFeatureType.md) |  <br/>  | direct | 388 |
...
| ---  | --- | --- | --- |
| [HttpW3id.orgSawgraphV1Me-egad#EGAD-SamplePoint](../classes/HttpW3id.orgSawgraphV1Me-egad#EGAD-SamplePoint.md) | [coso_pointFromFeature](../slots/coso_pointFromFeature.md) | any_of[range] | [HttpW3id.orgSawgraphV1Us-wqp#SampledFeature](../classes/HttpW3id.orgSawgraphV1Us-wqp#SampledFeature.md) |
| [HttpW3id.orgSawgraphV1Us-wqp#SampledFeature](../classes/HttpW3id.orgSawgraphV1Us-wqp#SampledFeature.md) | [http___w3id.org_sawgraph_v1_us_wqp#locationType](../slots/http___w3id.org_sawgraph_v1_us_wqp#locationType.md) | domain | [HttpW3id.orgSawgraphV1Us-wqp#SampledFeature](../classes/HttpW3id.orgSawgraphV1Us-wqp#SampledFeature.md) |
| [HttpW3id.orgSawgraphV1Us-wqp#Site](../classes/HttpW3id.orgSawgraphV1Us-wqp#Site.md) | [coso_pointFromFeature](../slots/coso_pointFromFeature.md) | any_of[range] | [HttpW3id.orgSawgraphV1Us-wqp#SampledFeature](../classes/HttpW3id.orgSawgraphV1Us-wqp#SampledFeature.md) |
| [MeEgadEGAD-SamplePoint](../classes/MeEgadEGAD-SamplePoint.md) | [coso_pointFromFeature](../slots/coso_pointFromFeature.md) | any_of[range] | [HttpW3id.orgSawgraphV1Us-wqp#SampledFeature](../classes/HttpW3id.orgSawgraphV1Us-wqp#SampledFeature.md) |
...
```yaml
name: http___w3id.org_sawgraph_v1_us-wqp#SampledFeature
title: WQP - Sampled Feature
...
- rdfs_label
class_uri: http://w3id.org/sawgraph/v1/us-wqp#SampledFeature
...
attributes:
  http___w3id.org_sawgraph_v1_us-wqp#locationType:
    name: http___w3id.org_sawgraph_v1_us-wqp#locationType
    title: wqp - location type
    from_schema: okns:sawgraph-kg
    rank: 1000
    domain: http___w3id.org_sawgraph_v1_us-wqp#SampledFeature
    slot_uri: http://w3id.org/sawgraph/v1/us-wqp#locationType
    alias: http___w3id.org_sawgraph_v1_us_wqp#locationType
    owner: http___w3id.org_sawgraph_v1_us-wqp#SampledFeature
    domain_of:
    - http___w3id.org_sawgraph_v1_us-wqp#SampledFeature
    subproperty_of: coso_ofFeatureType
    range: Any
    any_of:
    - range: http___w3id.org_sawgraph_v1_us-wqp#DefWQPSurfaceWaterFeatureType
    - range: http___w3id.org_sawgraph_v1_us-wqp#LocationType
    - range: uri
    - range: http___w3id.org_sawgraph_v1_us-wqp#DefWQPGroundWaterFeatureType
  rdfs_label:
    name: rdfs_label
