...
# Class: TODO -- what's a good name for this class (type)? (sudokn_SheetMetalFormingCapability)
...
URI: [sudokn:SheetMetalFormingCapability](http://asu.edu/semantics/SUDOKN/SheetMetalFormingCapability)
...
```mermaid
 classDiagram
    class SudoknSheetMetalFormingCapability
    click SudoknSheetMetalFormingCapability href "../SudoknSheetMetalFormingCapability"
      SudoknSheetMetalFormingCapability : rdfs_label
        
          
    
    
    SudoknSheetMetalFormingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknSheetMetalFormingCapability](../classes/SudoknSheetMetalFormingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknSheetMetalFormingCapability](../classes/SudoknSheetMetalFormingCapability.md) |
...
| Value |
| --- |
| sudokn:ParkerIndustries-SheetMetalForming |
...
| ---  | ---  |
| self | sudokn:SheetMetalFormingCapability |
| native | sudokn-kg/:SudoknSheetMetalFormingCapability |
...
<details>
```yaml
name: sudokn_SheetMetalFormingCapability
...
examples:
- value: sudokn:ParkerIndustries-SheetMetalForming
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:SheetMetalFormingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_SheetMetalFormingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
