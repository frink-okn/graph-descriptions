...
# Class: TODO -- what's a good name for this class (type)? (sudokn_RamEDMCapability)
...
URI: [sudokn:RamEDMCapability](http://asu.edu/semantics/SUDOKN/RamEDMCapability)
...
```mermaid
 classDiagram
    class SudoknRamEDMCapability
    click SudoknRamEDMCapability href "../SudoknRamEDMCapability"
      SudoknRamEDMCapability : rdfs_label
        
          
    
    
    SudoknRamEDMCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknRamEDMCapability](../classes/SudoknRamEDMCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknRamEDMCapability](../classes/SudoknRamEDMCapability.md) |
...
| Value |
| --- |
| sudokn:ABBOTT-TOOL-RamEDMCapability-inst |
...
| ---  | ---  |
| self | sudokn:RamEDMCapability |
| native | sudokn-kg/:SudoknRamEDMCapability |
...
examples:
- value: sudokn:ABBOTT-TOOL-RamEDMCapability-inst
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:RamEDMCapability
