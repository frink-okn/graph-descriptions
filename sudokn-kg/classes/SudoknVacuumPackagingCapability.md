...
# Class: vacuum packaging capability (sudokn_VacuumPackagingCapability)
...
```mermaid
 classDiagram
    ...
    SudoknVacuumPackagingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
title: vacuum packaging capability
from_schema: okns:sudokn-kg
aliases:
- vacuum packing capability
rank: 1000
is_a: sudokn_PackingCapability
slots:
- rdfs_label
