...
# Class: TODO -- what's a good name for this class (type)? (sudokn_GoldProcessingCapability)
...
URI: [sudokn:GoldProcessingCapability](http://asu.edu/semantics/SUDOKN/GoldProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknGoldProcessingCapability
    click SudoknGoldProcessingCapability href "../SudoknGoldProcessingCapability"
      SudoknGoldProcessingCapability : rdfs_label
        
          
    
    
    SudoknGoldProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknGoldProcessingCapability](../classes/SudoknGoldProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknGoldProcessingCapability](../classes/SudoknGoldProcessingCapability.md) |
...
| ---  | ---  |
| self | sudokn:GoldProcessingCapability |
| native | sudokn-kg/:SudoknGoldProcessingCapability |
...
<details>
```yaml
name: sudokn_GoldProcessingCapability
...
- if you think the class is perfect.
notes:
- Class with 1302 occurences.
examples:
- value: sudokn:800GOLD-Gold-inst
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:GoldProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_GoldProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
