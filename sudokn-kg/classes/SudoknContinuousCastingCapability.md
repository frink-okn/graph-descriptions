...
# Class: continuous casting capability (sudokn_ContinuousCastingCapability)
...
```mermaid
 classDiagram
    ...
    SudoknContinuousCastingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
title: continuous casting capability
