...
This class occurs 1654 times.


URI: [sudokn:GrindingCapability](http://asu.edu/semantics/SUDOKN/GrindingCapability)
...
```mermaid
 classDiagram
    class SudoknGrindingCapability
    click SudoknGrindingCapability href "../SudoknGrindingCapability"
      SudoknAbrassiveMachiningCapability <|-- SudoknGrindingCapability
        click SudoknAbrassiveMachiningCapability href "../SudoknAbrassiveMachiningCapability"
      

      SudoknGrindingCapability <|-- SudoknCenterlessGrindingCapability
        click SudoknCenterlessGrindingCapability href "../SudoknCenterlessGrindingCapability"
      SudoknGrindingCapability <|-- SudoknClyndricalGrindingCapability
        click SudoknClyndricalGrindingCapability href "../SudoknClyndricalGrindingCapability"
      SudoknGrindingCapability <|-- SudoknCreepFeedGrindingCapability
        click SudoknCreepFeedGrindingCapability href "../SudoknCreepFeedGrindingCapability"
      SudoknGrindingCapability <|-- SudoknCurvicGrindingCapability
        click SudoknCurvicGrindingCapability href "../SudoknCurvicGrindingCapability"
      SudoknGrindingCapability <|-- SudoknIDODGrindingCapability
        click SudoknIDODGrindingCapability href "../SudoknIDODGrindingCapability"
      SudoknGrindingCapability <|-- SudoknPlungeGrindingCapability
        click SudoknPlungeGrindingCapability href "../SudoknPlungeGrindingCapability"
      
      
      SudoknGrindingCapability : rdfs_label
        
          
    
    
    SudoknGrindingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
        ...
        * [SudoknMachiningCapability](../classes/SudoknMachiningCapability.md)
            * [SudoknAbrassiveMachiningCapability](../classes/SudoknAbrassiveMachiningCapability.md)
                * **SudoknGrindingCapability**
                    * [SudoknCenterlessGrindingCapability](../classes/SudoknCenterlessGrindingCapability.md)
                    * [SudoknClyndricalGrindingCapability](../classes/SudoknClyndricalGrindingCapability.md)
                    * [SudoknCreepFeedGrindingCapability](../classes/SudoknCreepFeedGrindingCapability.md)
                    * [SudoknCurvicGrindingCapability](../classes/SudoknCurvicGrindingCapability.md)
                    * [SudoknIDODGrindingCapability](../classes/SudoknIDODGrindingCapability.md)
                    * [SudoknPlungeGrindingCapability](../classes/SudoknPlungeGrindingCapability.md)
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject <br/>  | direct | 1654 |
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknGrindingCapability](../classes/SudoknGrindingCapability.md) |
...
slots:
- rdfs_label
class_uri: sudokn:GrindingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_GrindingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
