...
# Class: TODO -- what's a good name for this class (type)? (sudokn_PressureWeldingCapability)
...
| ---  | ---  |
| self | sudokn:PressureWeldingCapability |
| native | sudokn-kg/:SudoknPressureWeldingCapability |
