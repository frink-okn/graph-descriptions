...
```mermaid
 classDiagram
    ...
    click Fio-epa-frsRiskPlanRecord href "../Fio-epa-frsRiskPlanRecord"
      ...
      Fio-epa-frsRiskPlanRecord : dc_identifier
        
          
    
    
    Fio-epa-frsRiskPlanRecord --> "0..1" Any : dc_identifier
    click Any href "../Any"
