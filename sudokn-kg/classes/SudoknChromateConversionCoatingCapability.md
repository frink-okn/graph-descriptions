...
# Class: TODO -- what's a good name for this class (type)? (sudokn_ChromateConversionCoatingCapability)
...
```mermaid
 classDiagram
    ...
    SudoknChromateConversionCoatingCapability --> "0..1" String : rdfs_label
...
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknChromateConversionCoatingCapability](../classes/SudoknChromateConversionCoatingCapability.md) |
...
| Value |
| --- |
| sudokn:ACCENTMETAL-ChromateConversionCoatingCapability-inst |
...
| ---  | ---  |
| self | sudokn:ChromateConversionCoatingCapability |
| native | sudokn-kg/:SudoknChromateConversionCoatingCapability |
...
- if you think the class is perfect.
notes:
- Class with 139 occurences.
examples:
- value: sudokn:ACCENTMETAL-ChromateConversionCoatingCapability-inst
