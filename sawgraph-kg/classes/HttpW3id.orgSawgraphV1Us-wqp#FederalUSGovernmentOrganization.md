...
# Class: HttpW3id.orgSawgraphV1Us-wqp#FederalUSGovernmentOrganization
...
URI: [http://w3id.org/sawgraph/v1/us-wqp#Federal_USGovernment_Organization](http://w3id.org/sawgraph/v1/us-wqp#Federal_USGovernment_Organization)
...
```mermaid
 classDiagram
    class HttpW3id.orgSawgraphV1Us-wqp#FederalUSGovernmentOrganization
    click HttpW3id.orgSawgraphV1Us-wqp#FederalUSGovernmentOrganization href "../HttpW3id.orgSawgraphV1Us-wqp#FederalUSGovernmentOrganization"
      HttpW3id.orgSawgraphV1Us-wqp#FederalUSGovernmentOrganization : http___w3id.org_sawgraph_v1_us_wqp#organizationDescription
        
          
    
    
    HttpW3id.orgSawgraphV1Us-wqp#FederalUSGovernmentOrganization --> "0..1" Uri : http___w3id.org_sawgraph_v1_us_wqp#organizationDescription
    click Uri href "../Uri"

        
      HttpW3id.orgSawgraphV1Us-wqp#FederalUSGovernmentOrganization : http___w3id.org_sawgraph_v1_us_wqp#organizationId
        
          
    
    
    HttpW3id.orgSawgraphV1Us-wqp#FederalUSGovernmentOrganization --> "0..1" String : http___w3id.org_sawgraph_v1_us_wqp#organizationId
    click String href "../String"

        
      HttpW3id.orgSawgraphV1Us-wqp#FederalUSGovernmentOrganization : rdfs_label
        
          
    
    
    HttpW3id.orgSawgraphV1Us-wqp#FederalUSGovernmentOrganization --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- | --- |
| [http___w3id.org_sawgraph_v1_us_wqp#organizationId](../slots/http___w3id.org_sawgraph_v1_us_wqp#organizationId.md) | 0..1 <br/> [xsd:string](http://www.w3.org/2001/XMLSchema#string) |  <br/>  | direct | 3 |
...
| [http___w3id.org_sawgraph_v1_us_wqp#organizationDescription](../slots/http___w3id.org_sawgraph_v1_us_wqp#organizationDescription.md) | 0..1 <br/> [xsd:anyURI](http://www.w3.org/2001/XMLSchema#anyURI) |  <br/>  | direct | 1 |
...
```yaml
name: http___w3id.org_sawgraph_v1_us-wqp#Federal_USGovernment_Organization
...
class_uri: http://w3id.org/sawgraph/v1/us-wqp#Federal_USGovernment_Organization
...
attributes:
  http___w3id.org_sawgraph_v1_us-wqp#organizationId:
    ...
    owner: http___w3id.org_sawgraph_v1_us-wqp#Federal_USGovernment_Organization
    domain_of:
