...
# Class: spark plasma sintering capability (sudokn_SparkPlasmaSinteringCapability)





URI: [sudokn:SparkPlasmaSinteringCapability](http://asu.edu/semantics/SUDOKN/SparkPlasmaSinteringCapability)
...
```mermaid
 classDiagram
    class SudoknSparkPlasmaSinteringCapability
    click SudoknSparkPlasmaSinteringCapability href "../SudoknSparkPlasmaSinteringCapability"
      ...
      SudoknSparkPlasmaSinteringCapability : rdfs_label
        
          
    
    
    SudoknSparkPlasmaSinteringCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: sudokn_SparkPlasmaSinteringCapability
title: spark plasma sintering capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_PowderMetalFormingCapability
class_uri: sudokn:SparkPlasmaSinteringCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_SparkPlasmaSinteringCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
