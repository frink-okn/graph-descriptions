...
# Class: FDA-PMA certificate (sudokn_FDA-PMACertificate)
...
URI: [sudokn:FDA-PMACertificate](http://asu.edu/semantics/SUDOKN/FDA-PMACertificate)
...
```mermaid
 classDiagram
    class SudoknFDA-PMACertificate
    click SudoknFDA-PMACertificate href "../SudoknFDA-PMACertificate"
      ...
      SudoknFDA-PMACertificate : rdfs_label
        
          
    
    
    SudoknFDA-PMACertificate --> "0..1" String : rdfs_label
...
| ---  | ---  |
| self | sudokn:FDA-PMACertificate |
| native | sudokn-kg/:SudoknFDA-PMACertificate |
...
<details>
```yaml
name: sudokn_FDA-PMACertificate
description: TODO -- tell the world what this class (type) describes.
title: FDA-PMA certificate
todos:
- TODO -- Todos for this class go here
- or you can delete the todos
- if you think the class is perfect.
...
class_uri: sudokn:FDA-PMACertificate
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_FDA-PMACertificate
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
