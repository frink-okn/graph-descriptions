...
# Class: TODO -- what's a good name for this class (type)? (sudokn_RivetingCapability)
...
URI: [sudokn:RivetingCapability](http://asu.edu/semantics/SUDOKN/RivetingCapability)
...
```mermaid
 classDiagram
    class SudoknRivetingCapability
    click SudoknRivetingCapability href "../SudoknRivetingCapability"
      ...
      SudoknRivetingCapability : rdfs_label
        
          
    
    
    SudoknRivetingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknRivetingCapability](../classes/SudoknRivetingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknRivetingCapability](../classes/SudoknRivetingCapability.md) |
...
| Value |
| --- |
| sudokn:AllredMetalStampingWorks-Riveting |
...
| ---  | ---  |
| self | sudokn:RivetingCapability |
| native | sudokn-kg/:SudoknRivetingCapability |
...
<details>
```yaml
name: sudokn_RivetingCapability
...
examples:
- value: sudokn:AllredMetalStampingWorks-Riveting
from_schema: sudokn-kg
rank: 1000
is_a: sudokn_MechanicalJoiningCapability
slots:
- rdfs_label
class_uri: sudokn:RivetingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_RivetingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
