...
# Class: TODO -- what's a good name for this class (type)? (sudokn_Industry)
...
URI: [sudokn:Industry](http://asu.edu/semantics/SUDOKN/Industry)
...
```mermaid
 classDiagram
    class SudoknIndustry
    click SudoknIndustry href "../SudoknIndustry"
      SudoknIndustry : rdfs_label
        
          
    
    
    SudoknIndustry --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknIndustry](../classes/SudoknIndustry.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_suppliesToIndustry](../slots/sudokn_suppliesToIndustry.md) | any_of[range] | [SudoknIndustry](../classes/SudoknIndustry.md) |
...
| ---  | ---  |
| self | sudokn:Industry |
| native | sudokn-kg/:SudoknIndustry |
...
examples:
- value: sudokn:-Industry
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:Industry
