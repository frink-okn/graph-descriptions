...
# Class: Congress (fio-epa-frs_Agency.Congress)
...
URI: [fio-epa-frs:Agency.Congress](http://w3id.org/fio/v1/epa-frs#Agency.Congress)
...
```mermaid
 classDiagram
    class Fio-epa-frsAgency.Congress
    click Fio-epa-frsAgency.Congress href "../Fio-epa-frsAgency.Congress"
      ProvAgent <|-- Fio-epa-frsAgency.Congress
        click ProvAgent href "../ProvAgent"
      
      Fio-epa-frsAgency.Congress : owl_sameAs
        
          
    
    
    Fio-epa-frsAgency.Congress --> "0..1" OwlThing : owl_sameAs
    click OwlThing href "../OwlThing"

        
      Fio-epa-frsAgency.Congress : rdfs_label
        
          
    
    
    Fio-epa-frsAgency.Congress --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: fio-epa-frs_Agency.Congress
title: Congress
...
- rdfs_label
- owl_sameAs
class_uri: fio-epa-frs:Agency.Congress
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: fio-epa-frs_Agency.Congress
    domain_of:
    - time_DayOfWeek
    - time_TemporalUnit
