...
```mermaid
 classDiagram
    ...
    SudoknBronzeProcessingCapability --> "0..1" String : rdfs_label
...
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknBronzeProcessingCapability](../classes/SudoknBronzeProcessingCapability.md) |
...
| ---  | ---  |
| self | sudokn:BronzeProcessingCapability |
| native | sudokn-kg/:SudoknBronzeProcessingCapability |
...
- if you think the class is perfect.
notes:
- Class with 1754 occurences.
examples:
- value: sudokn:101PIPE-Bronze-inst
