...
# Class: TODO -- what's a good name for this class (type)? (sudokn_CNCPressBrakeCapability)
...
URI: [sudokn:CNCPressBrakeCapability](http://asu.edu/semantics/SUDOKN/CNCPressBrakeCapability)
...
```mermaid
 classDiagram
    class SudoknCNCPressBrakeCapability
    click SudoknCNCPressBrakeCapability href "../SudoknCNCPressBrakeCapability"
      SudoknCNCPressBrakeCapability : rdfs_label
        
          
    
    
    SudoknCNCPressBrakeCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCNCPressBrakeCapability](../classes/SudoknCNCPressBrakeCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCNCPressBrakeCapability](../classes/SudoknCNCPressBrakeCapability.md) |
...
| Value |
| --- |
| sudokn:FarrisFabAndMachining-CNCPressBrake |
...
| ---  | ---  |
| self | sudokn:CNCPressBrakeCapability |
| native | sudokn-kg/:SudoknCNCPressBrakeCapability |
...
<details>
```yaml
name: sudokn_CNCPressBrakeCapability
...
examples:
- value: sudokn:FarrisFabAndMachining-CNCPressBrake
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:CNCPressBrakeCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_CNCPressBrakeCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
