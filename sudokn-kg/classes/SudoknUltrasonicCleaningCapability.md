...
# Class: ultrasonic cleaning capability (sudokn_UltrasonicCleaningCapability)





URI: [sudokn:UltrasonicCleaningCapability](http://asu.edu/semantics/SUDOKN/UltrasonicCleaningCapability)
...
```mermaid
 classDiagram
    class SudoknUltrasonicCleaningCapability
    click SudoknUltrasonicCleaningCapability href "../SudoknUltrasonicCleaningCapability"
      ...
      SudoknUltrasonicCleaningCapability : rdfs_label
        
          
    
    
    SudoknUltrasonicCleaningCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject | [SudoknSurfacePreparationCapability](../classes/SudoknSurfacePreparationCapability.md), [SudoknSurfaceFinishingCapability](../classes/SudoknSurfaceFinishingCapability.md) |  |
...
```yaml
name: sudokn_UltrasonicCleaningCapability
title: ultrasonic cleaning capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_SurfacePreparationCapability
class_uri: sudokn:UltrasonicCleaningCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_UltrasonicCleaningCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
