...
# Class: TODO -- what's a good name for this class (type)? (sudokn_WireHarnessAssemblyCapability)
...
URI: [sudokn:WireHarnessAssemblyCapability](http://asu.edu/semantics/SUDOKN/WireHarnessAssemblyCapability)
...
```mermaid
 classDiagram
    class SudoknWireHarnessAssemblyCapability
    click SudoknWireHarnessAssemblyCapability href "../SudoknWireHarnessAssemblyCapability"
      ...
      SudoknWireHarnessAssemblyCapability : rdfs_label
        
          
    
    
    SudoknWireHarnessAssemblyCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknWireHarnessAssemblyCapability](../classes/SudoknWireHarnessAssemblyCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknWireHarnessAssemblyCapability](../classes/SudoknWireHarnessAssemblyCapability.md) |
...
| Value |
| --- |
| sudokn:ADCURAMFG-WireHarnessAssemblyCapability-inst |
...
| ---  | ---  |
| self | sudokn:WireHarnessAssemblyCapability |
| native | sudokn-kg/:SudoknWireHarnessAssemblyCapability |
...
<details>
```yaml
name: sudokn_WireHarnessAssemblyCapability
...
examples:
- value: sudokn:ADCURAMFG-WireHarnessAssemblyCapability-inst
from_schema: sudokn-kg
is_a: sudokn_AssemblyCapibility
slots:
- rdfs_label
class_uri: sudokn:WireHarnessAssemblyCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_WireHarnessAssemblyCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
