...
# Class: TODO -- what's a good name for this class (type)? (sudokn_MetalSpinningCapability)
...
URI: [sudokn:MetalSpinningCapability](http://asu.edu/semantics/SUDOKN/MetalSpinningCapability)
...
```mermaid
 classDiagram
    class SudoknMetalSpinningCapability
    click SudoknMetalSpinningCapability href "../SudoknMetalSpinningCapability"
      SudoknMetalSpinningCapability : rdfs_label
        
          
    
    
    SudoknMetalSpinningCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknMetalSpinningCapability](../classes/SudoknMetalSpinningCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknMetalSpinningCapability](../classes/SudoknMetalSpinningCapability.md) |
...
| ---  | ---  |
| self | sudokn:MetalSpinningCapability |
| native | sudokn-kg/:SudoknMetalSpinningCapability |
...
<details>
```yaml
name: sudokn_MetalSpinningCapability
...
examples:
- value: sudokn:ClaroLux-MetalSpinning
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:MetalSpinningCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_MetalSpinningCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
