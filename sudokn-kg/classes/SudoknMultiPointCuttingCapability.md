...
# Class: multi-point cutting capability (sudokn_MultiPointCuttingCapability)





URI: [sudokn:MultiPointCuttingCapability](http://asu.edu/semantics/SUDOKN/MultiPointCuttingCapability)
...
```mermaid
 classDiagram
    class SudoknMultiPointCuttingCapability
    click SudoknMultiPointCuttingCapability href "../SudoknMultiPointCuttingCapability"
      ...
      SudoknMultiPointCuttingCapability <|-- SudoknBroachingCapability
        click SudoknBroachingCapability href "../SudoknBroachingCapability"
      SudoknMultiPointCuttingCapability <|-- SudoknGearCuttingCapability
        click SudoknGearCuttingCapability href "../SudoknGearCuttingCapability"
      SudoknMultiPointCuttingCapability <|-- SudoknGearHobbingCapability
        click SudoknGearHobbingCapability href "../SudoknGearHobbingCapability"
      SudoknMultiPointCuttingCapability <|-- SudoknHoleMakingCapability
        click SudoknHoleMakingCapability href "../SudoknHoleMakingCapability"
      SudoknMultiPointCuttingCapability <|-- SudoknMillingCapability
        click SudoknMillingCapability href "../SudoknMillingCapability"
      SudoknMultiPointCuttingCapability <|-- SudoknSawingCapability
        click SudoknSawingCapability href "../SudoknSawingCapability"
      
      
      SudoknMultiPointCuttingCapability : rdfs_label
        
          
    
    
    SudoknMultiPointCuttingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
    ...
    * [SudoknManufacturingProcessCapability](../classes/SudoknManufacturingProcessCapability.md)
        * [SudoknMachiningCapability](../classes/SudoknMachiningCapability.md)
            * **SudoknMultiPointCuttingCapability**
                * [SudoknBroachingCapability](../classes/SudoknBroachingCapability.md)
                * [SudoknGearCuttingCapability](../classes/SudoknGearCuttingCapability.md)
                * [SudoknGearHobbingCapability](../classes/SudoknGearHobbingCapability.md)
                * [SudoknHoleMakingCapability](../classes/SudoknHoleMakingCapability.md)
                * [SudoknMillingCapability](../classes/SudoknMillingCapability.md)
                * [SudoknSawingCapability](../classes/SudoknSawingCapability.md)
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject | [SudoknMachiningCapability](../classes/SudoknMachiningCapability.md) |  |
...
title: multi-point cutting capability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_MultiPointCuttingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
