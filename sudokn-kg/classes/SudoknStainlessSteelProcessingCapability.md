...
# Class: stainless steel processing capability (sudokn_StainlessSteelProcessingCapability)
...
URI: [sudokn:StainlessSteelProcessingCapability](http://asu.edu/semantics/SUDOKN/StainlessSteelProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknStainlessSteelProcessingCapability
    click SudoknStainlessSteelProcessingCapability href "../SudoknStainlessSteelProcessingCapability"
      ...
      SudoknStainlessSteelProcessingCapability : rdfs_label
        
          
    
    
    SudoknStainlessSteelProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknStainlessSteelProcessingCapability](../classes/SudoknStainlessSteelProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknStainlessSteelProcessingCapability](../classes/SudoknStainlessSteelProcessingCapability.md) |
...
| Value |
| --- |
| sudokn:/StainlessSteelProcessingCapability_1 |
...
| ---  | ---  |
| self | sudokn:StainlessSteelProcessingCapability |
| native | sudokn-kg/:SudoknStainlessSteelProcessingCapability |
...
<details>
```yaml
name: sudokn_StainlessSteelProcessingCapability
description: TODO -- tell the world what this class (type) describes.
title: stainless steel processing capability
todos:
- TODO -- Todos for this class go here
- or you can delete the todos
- if you think the class is perfect.
notes:
- Class with 4796 occurences.
examples:
- value: sudokn:/StainlessSteelProcessingCapability_1
from_schema: sudokn-kg
is_a: sudokn_SteelProcessingCapability
slots:
- rdfs_label
class_uri: sudokn:StainlessSteelProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_StainlessSteelProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
