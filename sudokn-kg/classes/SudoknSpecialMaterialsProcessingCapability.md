...
# Class: TODO -- what's a good name for this class (type)? (sudokn_SpecialMaterialsProcessingCapability)
...
URI: [sudokn:SpecialMaterialsProcessingCapability](http://asu.edu/semantics/SUDOKN/SpecialMaterialsProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknSpecialMaterialsProcessingCapability
    click SudoknSpecialMaterialsProcessingCapability href "../SudoknSpecialMaterialsProcessingCapability"
      SudoknSpecialMaterialsProcessingCapability : rdfs_label
        
          
    
    
    SudoknSpecialMaterialsProcessingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknSpecialMaterialsProcessingCapability](../classes/SudoknSpecialMaterialsProcessingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknSpecialMaterialsProcessingCapability](../classes/SudoknSpecialMaterialsProcessingCapability.md) |
...
| Value |
| --- |
| sudokn:ABILITYMETAL-SpecialMaterials-inst |
...
| ---  | ---  |
| self | sudokn:SpecialMaterialsProcessingCapability |
| native | sudokn-kg/:SudoknSpecialMaterialsProcessingCapability |
...
<details>
```yaml
name: sudokn_SpecialMaterialsProcessingCapability
...
- if you think the class is perfect.
notes:
- Class with 71 occurences.
examples:
- value: sudokn:ABILITYMETAL-SpecialMaterials-inst
from_schema: sudokn-kg
slots:
- rdfs_label
class_uri: sudokn:SpecialMaterialsProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_SpecialMaterialsProcessingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
