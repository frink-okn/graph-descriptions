...
# Class: TODO -- what's a good name for this class (type)? (sudokn_CerakoteCoatingCapability)
...
URI: [sudokn:CerakoteCoatingCapability](http://asu.edu/semantics/SUDOKN/CerakoteCoatingCapability)
...
```mermaid
 classDiagram
    class SudoknCerakoteCoatingCapability
    click SudoknCerakoteCoatingCapability href "../SudoknCerakoteCoatingCapability"
      SudoknCerakoteCoatingCapability : rdfs_label
        
          
    
    
    SudoknCerakoteCoatingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCerakoteCoatingCapability](../classes/SudoknCerakoteCoatingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCerakoteCoatingCapability](../classes/SudoknCerakoteCoatingCapability.md) |
...
| Value |
| --- |
| sudokn:TriangleCoatings-CerakoteCoating |
...
| ---  | ---  |
| self | sudokn:CerakoteCoatingCapability |
| native | sudokn-kg/:SudoknCerakoteCoatingCapability |
...
<details>
```yaml
name: sudokn_CerakoteCoatingCapability
...
examples:
- value: sudokn:TriangleCoatings-CerakoteCoating
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:CerakoteCoatingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_CerakoteCoatingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
