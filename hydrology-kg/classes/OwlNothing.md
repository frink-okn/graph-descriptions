...
```mermaid
 classDiagram
    ...
    click OwlNothing href "../OwlNothing"
      ...
      OwlNothing : badwdt_P2043
        
          
    
    
    OwlNothing --> "0..1" Float : badwdt_P2043
    click Float href "../Float"

        
      OwlNothing : badwdt_P403
        
          
    
    
    OwlNothing --> "0..1" Any : badwdt_P403
    click Any href "../Any"

        
      OwlNothing : badwdt_P885
        
          
    
    
    OwlNothing --> "0..1" Any : badwdt_P885
    click Any href "../Any"

        
      OwlNothing : geo_asWKT
        
          
    
    
    OwlNothing --> "0..1" GeoWktLiteral : geo_asWKT
    click GeoWktLiteral href "../GeoWktLiteral"

        
      OwlNothing : geo_defaultGeometry
        
          
    
    
    OwlNothing --> "0..1" Any : geo_defaultGeometry
    click Any href "../Any"

        
      OwlNothing : geo_hasGeometry
        
          
    
    
    OwlNothing --> "0..1" Any : geo_hasGeometry
    click Any href "../Any"

        
      OwlNothing : hyf__downstreamWaterbody
        
          
    
    
    OwlNothing --> "0..1" Any : hyf__downstreamWaterbody
    click Any href "../Any"

        
      OwlNothing : hyf__downstreamWaterbodyTC
        
          
    
    
    OwlNothing --> "0..1" Any : hyf__downstreamWaterbodyTC
    click Any href "../Any"

        
      OwlNothing : kwgo_sfContains
        
          
    
    
    OwlNothing --> "0..1" Any : kwgo_sfContains
    click Any href "../Any"

        
      OwlNothing : kwgo_sfCrosses
        
          
    
    
    OwlNothing --> "0..1" Any : kwgo_sfCrosses
    click Any href "../Any"

        
      OwlNothing : kwgo_sfOverlaps
        
          
    
    
    OwlNothing --> "0..1" Any : kwgo_sfOverlaps
    click Any href "../Any"

        
      OwlNothing : kwgo_sfWithin
        
          
    
    
    OwlNothing --> "0..1" Any : kwgo_sfWithin
    click Any href "../Any"

        
      OwlNothing : memgs2_SAWidAquifer
        
          
    
    
    OwlNothing --> "0..1" String : memgs2_SAWidAquifer
    ...
    click Any href "../Any"
      ...
      OwlNothing : prov_hadPrimarySource
        
          
    
    
    OwlNothing --> "0..1" OwlThing : prov_hadPrimarySource
    click OwlThing href "../OwlThing"

        
      OwlNothing : rdfs_comment
        
          
    
    
    OwlNothing --> "0..1" Any : rdfs_comment
    click Any href "../Any"

        
      OwlNothing : rdfs_domain
        
          
    
    
    OwlNothing --> "0..1" Any : rdfs_domain
    click Any href "../Any"
    ...
    click Any href "../Any"
      ...
      OwlNothing : rdfs_range
        
          
    
    
    OwlNothing --> "0..1" Any : rdfs_range
    click Any href "../Any"

        
      OwlNothing : sawwater_hasCOMID
        
          
    
    
    OwlNothing --> "0..1" String : sawwater_hasCOMID
    click String href "../String"

        
      OwlNothing : sawwater_hasFCODE
        
          
    
    
    OwlNothing --> "0..1" String : sawwater_hasFCODE
    click String href "../String"

        
      OwlNothing : sawwater_hasFTYPE
        
          
    
    
    OwlNothing --> "0..1" String : sawwater_hasFTYPE
    click String href "../String"

        
      OwlNothing : sawwater_hasReachCode
        
          
    
    
    OwlNothing --> "0..1" String : sawwater_hasReachCode
    click String href "../String"

        
      OwlNothing : schema_name
        
          
    
    
    OwlNothing --> "0..1" String : schema_name
    click String href "../String"
