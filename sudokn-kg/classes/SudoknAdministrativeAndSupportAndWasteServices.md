...
# Class: No class (type) name specified (sudokn_AdministrativeAndSupportAndWasteServices)
...
URI: [sudokn:AdministrativeAndSupportAndWasteServices](http://asu.edu/semantics/SUDOKN/AdministrativeAndSupportAndWasteServices)
...
```mermaid
 classDiagram
    class SudoknAdministrativeAndSupportAndWasteServices
    click SudoknAdministrativeAndSupportAndWasteServices href "../SudoknAdministrativeAndSupportAndWasteServices"
      ...
      SudoknAdministrativeAndSupportAndWasteServices : sudokn_hasNAICSCodeValue
        
          
    
    
    SudoknAdministrativeAndSupportAndWasteServices --> "0..1" Any : sudokn_hasNAICSCodeValue
    click Any href "../Any"

        
      SudoknAdministrativeAndSupportAndWasteServices : sudokn_hasNAICSTextValue
        
          
    
    
    SudoknAdministrativeAndSupportAndWasteServices --> "0..1" Any : sudokn_hasNAICSTextValue
    click Any href "../Any"
...
```yaml
name: sudokn_AdministrativeAndSupportAndWasteServices
...
class_uri: sudokn:AdministrativeAndSupportAndWasteServices
...
attributes:
  sudokn_hasNAICSCodeValue:
    ...
    owner: sudokn_AdministrativeAndSupportAndWasteServices
    domain_of:
    - sudokn_NAICS332111
    - sudokn_NAICS332112
    - sudokn_NAICS332114
