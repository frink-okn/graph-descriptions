...
# Class: TODO -- what's a good name for this class (type)? (sudokn_CarbonitridingCapability)
...
```mermaid
 classDiagram
    ...
    SudoknCarbonitridingCapability --> "0..1" String : rdfs_label
...
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCarbonitridingCapability](../classes/SudoknCarbonitridingCapability.md) |
...
| Value |
| --- |
| sudokn:BLUEWATERTHERMAL-CarbonitridingCapability-inst |
...
| ---  | ---  |
| self | sudokn:CarbonitridingCapability |
| native | sudokn-kg/:SudoknCarbonitridingCapability |
...
examples:
- value: sudokn:BLUEWATERTHERMAL-CarbonitridingCapability-inst
