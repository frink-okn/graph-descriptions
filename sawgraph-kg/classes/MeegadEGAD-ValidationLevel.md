...
# Class: TODO -- what's a good name for this class (type)? (meegad_EGAD-ValidationLevel)
...
URI: [meegad:EGAD-ValidationLevel](http://sawgraph.spatialai.org/v1/me-egad#EGAD-ValidationLevel)
...
```mermaid
 classDiagram
    ...
    click MeegadEGAD-ValidationLevel href "../MeegadEGAD-ValidationLevel"
      ...
      MeegadEGAD-ValidationLevel : contaminoso_resultAnnotation
        
          
    
    
    MeegadEGAD-ValidationLevel --> "0..1" Any : contaminoso_resultAnnotation
    click Any href "../Any"

        
      MeegadEGAD-ValidationLevel : meegad_methodDetectionLimit
        
          
    
    
    MeegadEGAD-ValidationLevel --> "0..1" ContaminosoResultQualifier : meegad_methodDetectionLimit
    click ContaminosoResultQualifier href "../ContaminosoResultQualifier"

        
      MeegadEGAD-ValidationLevel : meegad_parameterGroup
        
          
    
    
    MeegadEGAD-ValidationLevel --> "0..1" String : meegad_parameterGroup
    click String href "../String"

        
      MeegadEGAD-ValidationLevel : meegad_reportingLimit
        
          
    
    
    MeegadEGAD-ValidationLevel --> "0..1" ContaminosoResultQualifier : meegad_reportingLimit
    click ContaminosoResultQualifier href "../ContaminosoResultQualifier"

        
      MeegadEGAD-ValidationLevel : qudt_numericValue
        
          
    
    
    MeegadEGAD-ValidationLevel --> "0..1" Any : qudt_numericValue
    click Any href "../Any"
...
| ---  | ---  |
| self | meegad:EGAD-ValidationLevel |
| native | sawgraph-kg/:MeegadEGAD-ValidationLevel |
...
<details>
```yaml
name: meegad_EGAD-ValidationLevel
...
class_uri: meegad:EGAD-ValidationLevel
...
attributes:
  meegad_reportingLimit:
    ...
    owner: meegad_EGAD-ValidationLevel
    domain_of:
