...
# Class: Animal Blood Sample (coso_AnimalBloodSample)
...
URI: [coso:AnimalBloodSample](http://w3id.org/coso/v1/contaminoso#AnimalBloodSample)
...
```mermaid
 classDiagram
    class CosoAnimalBloodSample
    click CosoAnimalBloodSample href "../CosoAnimalBloodSample"
      SosaSample <|-- CosoAnimalBloodSample
        click SosaSample href "../SosaSample"
      
      CosoAnimalBloodSample : coso_fromSamplePoint
        
          
    
    
    CosoAnimalBloodSample --> "0..1" Any : coso_fromSamplePoint
    click Any href "../Any"

        
      CosoAnimalBloodSample : coso_isSampleOf
        
          
    
    
    CosoAnimalBloodSample --> "0..1" Any : coso_isSampleOf
    click Any href "../Any"

        
      CosoAnimalBloodSample : coso_sampleAnnotation
        
          
    
    
    CosoAnimalBloodSample --> "0..1" Any : coso_sampleAnnotation
    click Any href "../Any"

        
      CosoAnimalBloodSample : coso_sampleOfMaterialType
        
          
    
    
    CosoAnimalBloodSample --> "0..1" Any : coso_sampleOfMaterialType
    click Any href "../Any"

        
      CosoAnimalBloodSample : dct_identifier
        
          
    
    
    CosoAnimalBloodSample --> "0..1" RdfsLiteral : dct_identifier
    click RdfsLiteral href "../RdfsLiteral"

        
      CosoAnimalBloodSample : http___w3id.org_sawgraph_v1_me_egad#sampleCollectionMethod
        
          
    
    
    CosoAnimalBloodSample --> "0..1" Any : http___w3id.org_sawgraph_v1_me_egad#sampleCollectionMethod
    click Any href "../Any"

        
      CosoAnimalBloodSample : owl_sameAs
        
          
    
    
    CosoAnimalBloodSample --> "0..1" OwlThing : owl_sameAs
    click OwlThing href "../OwlThing"

        
      CosoAnimalBloodSample : rdfs_label
        
          
    
    
    CosoAnimalBloodSample --> "0..1" Any : rdfs_label
    click Any href "../Any"

        
      CosoAnimalBloodSample : sosa_isSampleOf
        
          
    
    
    CosoAnimalBloodSample --> "0..1" HttpW3id.orgSawgraphV1Me-egad#EGAD-SampledFeature : sosa_isSampleOf
...
| ---  | --- | --- | --- |
| [HttpW3id.orgSawgraphV1Me-egad#EGAD-PFAS-Observation](../classes/HttpW3id.orgSawgraphV1Me-egad#EGAD-PFAS-Observation.md) | [coso_analyzedSample](../slots/coso_analyzedSample.md) | any_of[range] | [CosoAnimalBloodSample](../classes/CosoAnimalBloodSample.md) |
| [HttpW3id.orgSawgraphV1Me-egad#EGAD-PFAS-Observation](../classes/HttpW3id.orgSawgraphV1Me-egad#EGAD-PFAS-Observation.md) | [coso_hasAnyFeatureOfInterest](../slots/coso_hasAnyFeatureOfInterest.md) | any_of[range] | [CosoAnimalBloodSample](../classes/CosoAnimalBloodSample.md) |
| [HttpW3id.orgSawgraphV1Us-wqp#Observation](../classes/HttpW3id.orgSawgraphV1Us-wqp#Observation.md) | [coso_analyzedSample](../slots/coso_analyzedSample.md) | any_of[range] | [CosoAnimalBloodSample](../classes/CosoAnimalBloodSample.md) |
| [MeEgadEGAD-PFAS-Observation](../classes/MeEgadEGAD-PFAS-Observation.md) | [coso_analyzedSample](../slots/coso_analyzedSample.md) | any_of[range] | [CosoAnimalBloodSample](../classes/CosoAnimalBloodSample.md) |
| [MeEgadEGAD-PFAS-Observation](../classes/MeEgadEGAD-PFAS-Observation.md) | [coso_hasAnyFeatureOfInterest](../slots/coso_hasAnyFeatureOfInterest.md) | any_of[range] | [CosoAnimalBloodSample](../classes/CosoAnimalBloodSample.md) |
...
```yaml
name: coso_AnimalBloodSample
title: Animal Blood Sample
...
- coso_fromSamplePoint
class_uri: coso:AnimalBloodSample
