...
```mermaid
 classDiagram
    ...
    click SudoknCoatingCapability href "../SudoknCoatingCapability"
      SudoknFinishingCapability <|-- SudoknCoatingCapability
    ...
    SudoknCoatingCapability --> "0..1" String : rdfs_label
...
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCoatingCapability](../classes/SudoknCoatingCapability.md) |
...
| Value |
| --- |
| sudokn:3PINDUSTRIES-CoatingCapability-inst |
...
| ---  | ---  |
| self | sudokn:CoatingCapability |
| native | sudokn-kg/:SudoknCoatingCapability |
...
- if you think the class is perfect.
notes:
- Class with 1744 occurences.
examples:
- value: sudokn:3PINDUSTRIES-CoatingCapability-inst
from_schema: sudokn-kg
is_a: sudokn_FinishingCapability
slots:
- rdfs_label
