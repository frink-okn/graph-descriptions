...
# Class: TODO -- what's a good name for this class (type)? (sudokn_TurningCapability)
...
```mermaid
 classDiagram
    ...
    SudoknTurningCapability --> "0..1" String : rdfs_label
...
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknTurningCapability](../classes/SudoknTurningCapability.md) |
...
| Value |
| --- |
| sudokn:3DMACH-TurningCapability-inst |
...
| ---  | ---  |
| self | sudokn:TurningCapability |
| native | sudokn-kg/:SudoknTurningCapability |
...
- if you think the class is perfect.
notes:
- Class with 2077 occurences.
examples:
- value: sudokn:3DMACH-TurningCapability-inst
