...
# Class: clyndrical grinding capability (sudokn_ClyndricalGrindingCapability)





URI: [sudokn:ClyndricalGrindingCapability](http://asu.edu/semantics/SUDOKN/ClyndricalGrindingCapability)
...
```mermaid
 classDiagram
    class SudoknClyndricalGrindingCapability
    click SudoknClyndricalGrindingCapability href "../SudoknClyndricalGrindingCapability"
      ...
      SudoknClyndricalGrindingCapability : rdfs_label
        
          
    
    
    SudoknClyndricalGrindingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
            ...
            * [SudoknAbrassiveMachiningCapability](../classes/SudoknAbrassiveMachiningCapability.md)
                * [SudoknGrindingCapability](../classes/SudoknGrindingCapability.md)
                    * **SudoknClyndricalGrindingCapability**
                        * [SudoknCNCClyndricalGrindingCapability](../classes/SudoknCNCClyndricalGrindingCapability.md)
...
title: clyndrical grinding capability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ClyndricalGrindingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
