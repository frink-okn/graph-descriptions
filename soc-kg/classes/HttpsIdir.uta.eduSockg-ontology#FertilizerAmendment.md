...
# Class: HttpsIdir.uta.eduSockg-ontology#FertilizerAmendment
...
URI: [https://idir.uta.edu/sockg-ontology#FertilizerAmendment](https://idir.uta.edu/sockg-ontology#FertilizerAmendment)
...
```mermaid
 classDiagram
    ...
    click HttpsIdir.uta.eduSockg-ontology#FertilizerAmendment href "../HttpsIdir.uta.eduSockg-ontology#FertilizerAmendment"
      HttpsIdir.uta.eduSockg-ontology#FertilizerAmendment : dct_description
        
          
    
    
    HttpsIdir.uta.eduSockg-ontology#FertilizerAmendment --> "0..1" String : dct_description
...
```yaml
name: https___idir.uta.edu_sockg-ontology#FertilizerAmendment
from_schema: okns:soc-kg
rank: 1000
slots:
- dct_description
class_uri: https://idir.uta.edu/sockg-ontology#FertilizerAmendment
...
attributes:
  dct_description:
    ...
    owner: https___idir.uta.edu_sockg-ontology#FertilizerAmendment
    domain_of:
    - qudt_BinaryPrefix
