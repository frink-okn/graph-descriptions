...
# Class: TODO -- what's a good name for this class (type)? (sudokn_StudWeldingCapability)
...
| ---  | ---  |
| self | sudokn:StudWeldingCapability |
| native | sudokn-kg/:SudoknStudWeldingCapability |
