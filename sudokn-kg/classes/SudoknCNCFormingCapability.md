...
# Class: TODO -- what's a good name for this class (type)? (sudokn_CNCFormingCapability)
...
URI: [sudokn:CNCFormingCapability](http://asu.edu/semantics/SUDOKN/CNCFormingCapability)
...
```mermaid
 classDiagram
    class SudoknCNCFormingCapability
    click SudoknCNCFormingCapability href "../SudoknCNCFormingCapability"
      SudoknCNCFormingCapability : rdfs_label
        
          
    
    
    SudoknCNCFormingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCNCFormingCapability](../classes/SudoknCNCFormingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknCNCFormingCapability](../classes/SudoknCNCFormingCapability.md) |
...
| Value |
| --- |
| sudokn:PerformanceMachineAndFab-CNCForming |
...
| ---  | ---  |
| self | sudokn:CNCFormingCapability |
| native | sudokn-kg/:SudoknCNCFormingCapability |
...
<details>
```yaml
name: sudokn_CNCFormingCapability
...
examples:
- value: sudokn:PerformanceMachineAndFab-CNCForming
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:CNCFormingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_CNCFormingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
