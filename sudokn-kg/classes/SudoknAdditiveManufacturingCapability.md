...
# Class: additive manufacturing capability (sudokn_AdditiveManufacturingCapability)




This class occurs 209 times.


URI: [sudokn:AdditiveManufacturingCapability](http://asu.edu/semantics/SUDOKN/AdditiveManufacturingCapability)
...
```mermaid
 classDiagram
    class SudoknAdditiveManufacturingCapability
    click SudoknAdditiveManufacturingCapability href "../SudoknAdditiveManufacturingCapability"
      ...
      SudoknAdditiveManufacturingCapability <|-- SudoknFusedDepositionModelingCapability
        click SudoknFusedDepositionModelingCapability href "../SudoknFusedDepositionModelingCapability"
      SudoknAdditiveManufacturingCapability <|-- SudoknSelectiveLaserSinteringCapability
        click SudoknSelectiveLaserSinteringCapability href "../SudoknSelectiveLaserSinteringCapability"
      SudoknAdditiveManufacturingCapability <|-- SudoknStereolithographyCapability
        click SudoknStereolithographyCapability href "../SudoknStereolithographyCapability"
      
      
      SudoknAdditiveManufacturingCapability : rdfs_label
        
          
    
    
    SudoknAdditiveManufacturingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
* [IoscProductionCapability](../classes/IoscProductionCapability.md)
    * [SudoknManufacturingProcessCapability](../classes/SudoknManufacturingProcessCapability.md)
        * **SudoknAdditiveManufacturingCapability**
            * [SudoknFusedDepositionModelingCapability](../classes/SudoknFusedDepositionModelingCapability.md)
            * [SudoknSelectiveLaserSinteringCapability](../classes/SudoknSelectiveLaserSinteringCapability.md)
            * [SudoknStereolithographyCapability](../classes/SudoknStereolithographyCapability.md)
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject <br/>  | direct | 209 |
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknAdditiveManufacturingCapability](../classes/SudoknAdditiveManufacturingCapability.md) |
...
```yaml
name: sudokn_AdditiveManufacturingCapability
title: additive manufacturing capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_ManufacturingProcessCapability
slots:
- rdfs_label
class_uri: sudokn:AdditiveManufacturingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_AdditiveManufacturingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
