...
# Class: TODO -- what's a good name for this class (type)? (sudokn_ShapingCapability)
...
URI: [sudokn:ShapingCapability](http://asu.edu/semantics/SUDOKN/ShapingCapability)
...
```mermaid
 classDiagram
    ...
    click SudoknShapingCapability href "../SudoknShapingCapability"
      ...
      SudoknShapingCapability : rdfs_label
        
          
    
    
    SudoknShapingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknShapingCapability](../classes/SudoknShapingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknShapingCapability](../classes/SudoknShapingCapability.md) |
...
| Value |
| --- |
| sudokn:3DSYSTEMS-ShapingCapability-inst |
...
| ---  | ---  |
| self | sudokn:ShapingCapability |
| native | sudokn-kg/:SudoknShapingCapability |
...
- if you think the class is perfect.
notes:
- Class with 504 occurences.
examples:
- value: sudokn:3DSYSTEMS-ShapingCapability-inst
from_schema: sudokn-kg
is_a: sudokn_SinglePointCuttingCapability
slots:
- rdfs_label
class_uri: sudokn:ShapingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_ShapingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
