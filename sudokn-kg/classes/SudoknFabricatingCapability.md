...
```mermaid
 classDiagram
    ...
    SudoknFabricatingCapability --> "0..1" String : rdfs_label
...
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknFabricatingCapability](../classes/SudoknFabricatingCapability.md) |
...
| Value |
| --- |
| sudokn:1776FABRICATION-FabricatingCapability-inst |
...
| ---  | ---  |
| self | sudokn:FabricatingCapability |
| native | sudokn-kg/:SudoknFabricatingCapability |
...
- if you think the class is perfect.
notes:
- Class with 2518 occurences.
examples:
- value: sudokn:1776FABRICATION-FabricatingCapability-inst
