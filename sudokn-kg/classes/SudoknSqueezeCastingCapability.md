...
# Class: squeeze casting capability (sudokn_SqueezeCastingCapability)





URI: [sudokn:SqueezeCastingCapability](http://asu.edu/semantics/SUDOKN/SqueezeCastingCapability)
...
```mermaid
 classDiagram
    class SudoknSqueezeCastingCapability
    click SudoknSqueezeCastingCapability href "../SudoknSqueezeCastingCapability"
      ...
      SudoknSqueezeCastingCapability : rdfs_label
        
          
    
    
    SudoknSqueezeCastingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: sudokn_SqueezeCastingCapability
title: squeeze casting capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_CastingCapability
class_uri: sudokn:SqueezeCastingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_SqueezeCastingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
