...
# Class: No class (type) name specified (sudokn_StudWeldingCapability)
...
URI: [sudokn:StudWeldingCapability](http://asu.edu/semantics/SUDOKN/StudWeldingCapability)
...
```mermaid
 classDiagram
    class SudoknStudWeldingCapability
    click SudoknStudWeldingCapability href "../SudoknStudWeldingCapability"
      ...
      SudoknStudWeldingCapability : rdfs_label
        
          
    
    
    SudoknStudWeldingCapability --> "0..1" String : rdfs_label
...
```yaml
name: sudokn_StudWeldingCapability
...
class_uri: sudokn:StudWeldingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_StudWeldingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
    - owl_NamedIndividual
