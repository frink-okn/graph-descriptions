...
# Class: stereolithography capability (sudokn_StereolithographyCapability)





URI: [sudokn:StereolithographyCapability](http://asu.edu/semantics/SUDOKN/StereolithographyCapability)
...
```mermaid
 classDiagram
    class SudoknStereolithographyCapability
    click SudoknStereolithographyCapability href "../SudoknStereolithographyCapability"
      ...
      SudoknStereolithographyCapability : rdfs_label
        
          
    
    
    SudoknStereolithographyCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
```yaml
name: sudokn_StereolithographyCapability
title: stereolithography capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_AdditiveManufacturingCapability
class_uri: sudokn:StereolithographyCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_StereolithographyCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
