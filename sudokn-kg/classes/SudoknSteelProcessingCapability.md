...
# Class: steel processing capability (sudokn_SteelProcessingCapability)




This class occurs 7200 times.


URI: [sudokn:SteelProcessingCapability](http://asu.edu/semantics/SUDOKN/SteelProcessingCapability)
...
```mermaid
 classDiagram
    class SudoknSteelProcessingCapability
    click SudoknSteelProcessingCapability href "../SudoknSteelProcessingCapability"
      ...
      SudoknSteelProcessingCapability <|-- SudoknAlloySteelProcessingCapability
        click SudoknAlloySteelProcessingCapability href "../SudoknAlloySteelProcessingCapability"
      SudoknSteelProcessingCapability <|-- SudoknColdRolledSteelProcessingCapability
        click SudoknColdRolledSteelProcessingCapability href "../SudoknColdRolledSteelProcessingCapability"
      SudoknSteelProcessingCapability <|-- SudoknStainlessSteelProcessingCapability
        click SudoknStainlessSteelProcessingCapability href "../SudoknStainlessSteelProcessingCapability"
      
      
      SudoknSteelProcessingCapability : rdfs_label
        
          
    
    
    SudoknSteelProcessingCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
    ...
    * [SudoknMaterialProcessingCapability](../classes/SudoknMaterialProcessingCapability.md)
        * [SudoknMetalProcessingCapability](../classes/SudoknMetalProcessingCapability.md)
            * **SudoknSteelProcessingCapability**
                * [SudoknAlloySteelProcessingCapability](../classes/SudoknAlloySteelProcessingCapability.md)
                * [SudoknColdRolledSteelProcessingCapability](../classes/SudoknColdRolledSteelProcessingCapability.md)
                * [SudoknStainlessSteelProcessingCapability](../classes/SudoknStainlessSteelProcessingCapability.md)
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject <br/>  | direct | 7200 |
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasMaterialCapability](../slots/sudokn_hasMaterialCapability.md) | any_of[range] | [SudoknSteelProcessingCapability](../classes/SudoknSteelProcessingCapability.md) |
...
```yaml
name: sudokn_SteelProcessingCapability
title: steel processing capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_MetalProcessingCapability
slots:
- rdfs_label
class_uri: sudokn:SteelProcessingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_SteelProcessingCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
