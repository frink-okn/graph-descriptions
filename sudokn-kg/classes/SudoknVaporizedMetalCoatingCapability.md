...
# Class: TODO -- what's a good name for this class (type)? (sudokn_VaporizedMetalCoatingCapability)
...
URI: [sudokn:VaporizedMetalCoatingCapability](http://asu.edu/semantics/SUDOKN/VaporizedMetalCoatingCapability)
...
```mermaid
 classDiagram
    class SudoknVaporizedMetalCoatingCapability
    click SudoknVaporizedMetalCoatingCapability href "../SudoknVaporizedMetalCoatingCapability"
      SudoknThermalCoatingCapability <|-- SudoknVaporizedMetalCoatingCapability
        click SudoknThermalCoatingCapability href "../SudoknThermalCoatingCapability"
      

      SudoknVaporizedMetalCoatingCapability <|-- SudoknPhysicalVaporDepositionCapability
        click SudoknPhysicalVaporDepositionCapability href "../SudoknPhysicalVaporDepositionCapability"
      
      
      SudoknVaporizedMetalCoatingCapability : rdfs_label
        
          
    
    
    SudoknVaporizedMetalCoatingCapability --> "0..1" String : rdfs_label
            ...
            * [SudoknCoatingCapability](../classes/SudoknCoatingCapability.md)
                * [SudoknThermalCoatingCapability](../classes/SudoknThermalCoatingCapability.md)
                    * **SudoknVaporizedMetalCoatingCapability**
                        * [SudoknPhysicalVaporDepositionCapability](../classes/SudoknPhysicalVaporDepositionCapability.md)
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknVaporizedMetalCoatingCapability](../classes/SudoknVaporizedMetalCoatingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknVaporizedMetalCoatingCapability](../classes/SudoknVaporizedMetalCoatingCapability.md) |
...
| Value |
| --- |
| sudokn:ADDITIVEMANUFACTURINGLLC-VaporizedMetalCoatingCapability-inst |
...
| ---  | ---  |
| self | sudokn:VaporizedMetalCoatingCapability |
| native | sudokn-kg/:SudoknVaporizedMetalCoatingCapability |
...
<details>
```yaml
name: sudokn_VaporizedMetalCoatingCapability
...
- if you think the class is perfect.
notes:
- Class with 13 occurences.
examples:
- value: sudokn:ADDITIVEMANUFACTURINGLLC-VaporizedMetalCoatingCapability-inst
from_schema: sudokn-kg
rank: 1000
is_a: sudokn_ThermalCoatingCapability
slots:
- rdfs_label
class_uri: sudokn:VaporizedMetalCoatingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_VaporizedMetalCoatingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
