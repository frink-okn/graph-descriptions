...
# Class: assembly capability (sudokn_AssemblyCapability)




This class occurs 2932 times.
...
```mermaid
 classDiagram
    ...
    click SudoknAssemblyCapability href "../SudoknAssemblyCapability"
      ...
      SudoknAssemblyCapability <|-- SudoknKittingCapability
        click SudoknKittingCapability href "../SudoknKittingCapability"
      SudoknAssemblyCapability <|-- SudoknWireHarnessAssemblyCapability
    ...
    SudoknAssemblyCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject <br/>  | direct | 2931 |
