...
# Class: No class (type) name specified (sudokn_CounterBoringCapability)
...
URI: [sudokn:CounterBoringCapability](http://asu.edu/semantics/SUDOKN/CounterBoringCapability)
...
```mermaid
 classDiagram
    class SudoknCounterBoringCapability
    click SudoknCounterBoringCapability href "../SudoknCounterBoringCapability"
      ...
      SudoknCounterBoringCapability : rdfs_label
        
          
    
    
    SudoknCounterBoringCapability --> "0..1" String : rdfs_label
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_CounterBoringCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
    - owl_NamedIndividual
