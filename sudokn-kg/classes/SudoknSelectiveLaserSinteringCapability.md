...
# Class: selective laser sintering capability (sudokn_SelectiveLaserSinteringCapability)





URI: [sudokn:SelectiveLaserSinteringCapability](http://asu.edu/semantics/SUDOKN/SelectiveLaserSinteringCapability)
...
```mermaid
 classDiagram
    class SudoknSelectiveLaserSinteringCapability
    click SudoknSelectiveLaserSinteringCapability href "../SudoknSelectiveLaserSinteringCapability"
      ...
      SudoknSelectiveLaserSinteringCapability : rdfs_label
        
          
    
    
    SudoknSelectiveLaserSinteringCapability --> "0..1" Any : rdfs_label
    click Any href "../Any"
...
| ---  | --- | --- | --- | --- |
| [rdfs_label](../slots/rdfs_label.md) | 0..1 <br/> [RdfsLiteral](../classes/RdfsLiteral.md)&nbsp;or&nbsp;<br />[xsd:string](http://www.w3.org/2001/XMLSchema#string) | A human-readable name for the subject | [SudoknAdditiveManufacturingCapability](../classes/SudoknAdditiveManufacturingCapability.md) |  |
...
```yaml
name: sudokn_SelectiveLaserSinteringCapability
title: selective laser sintering capability
from_schema: okns:sudokn-kg
rank: 1000
is_a: sudokn_AdditiveManufacturingCapability
class_uri: sudokn:SelectiveLaserSinteringCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_SelectiveLaserSinteringCapability
    domain_of:
    - rdf_List
    - rdfs_Datatype
    - io_Manufacturer
