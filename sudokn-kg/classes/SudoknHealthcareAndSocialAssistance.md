...
# Class: No class (type) name specified (sudokn_HealthcareAndSocialAssistance)
...
URI: [sudokn:HealthcareAndSocialAssistance](http://asu.edu/semantics/SUDOKN/HealthcareAndSocialAssistance)
...
```mermaid
 classDiagram
    class SudoknHealthcareAndSocialAssistance
    click SudoknHealthcareAndSocialAssistance href "../SudoknHealthcareAndSocialAssistance"
      ...
      SudoknHealthcareAndSocialAssistance : sudokn_hasNAICSCodeValue
        
          
    
    
    SudoknHealthcareAndSocialAssistance --> "0..1" Any : sudokn_hasNAICSCodeValue
    click Any href "../Any"

        
      SudoknHealthcareAndSocialAssistance : sudokn_hasNAICSTextValue
        
          
    
    
    SudoknHealthcareAndSocialAssistance --> "0..1" Any : sudokn_hasNAICSTextValue
    click Any href "../Any"
...
```yaml
name: sudokn_HealthcareAndSocialAssistance
...
class_uri: sudokn:HealthcareAndSocialAssistance
...
attributes:
  sudokn_hasNAICSCodeValue:
    ...
    owner: sudokn_HealthcareAndSocialAssistance
    domain_of:
    - sudokn_NAICS332111
    - sudokn_NAICS332112
    - sudokn_NAICS332114
