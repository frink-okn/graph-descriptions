...
# Class: TODO -- what's a good name for this class (type)? (sudokn_VacuumPackagingCapability)
...
URI: [sudokn:VacuumPackagingCapability](http://asu.edu/semantics/SUDOKN/VacuumPackagingCapability)
...
```mermaid
 classDiagram
    class SudoknVacuumPackagingCapability
    click SudoknVacuumPackagingCapability href "../SudoknVacuumPackagingCapability"
      SudoknVacuumPackagingCapability : rdfs_label
        
          
    
    
    SudoknVacuumPackagingCapability --> "0..1" String : rdfs_label
...
| ---  | --- | --- | --- |
| [IoManufacturer](../classes/IoManufacturer.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknVacuumPackagingCapability](../classes/SudoknVacuumPackagingCapability.md) |
| [OwlNamedIndividual](../classes/OwlNamedIndividual.md) | [sudokn_hasProcessCapability](../slots/sudokn_hasProcessCapability.md) | any_of[range] | [SudoknVacuumPackagingCapability](../classes/SudoknVacuumPackagingCapability.md) |
...
| Value |
| --- |
| sudokn:NEWHORIZONMACHINE-VacuumPackagingCapability-inst |
...
| ---  | ---  |
| self | sudokn:VacuumPackagingCapability |
| native | sudokn-kg/:SudoknVacuumPackagingCapability |
...
<details>
```yaml
name: sudokn_VacuumPackagingCapability
...
examples:
- value: sudokn:NEWHORIZONMACHINE-VacuumPackagingCapability-inst
from_schema: sudokn-kg
rank: 1000
slots:
- rdfs_label
class_uri: sudokn:VacuumPackagingCapability
...
attributes:
  rdfs_label:
    ...
    slot_uri: rdfs:label
    alias: rdfs_label
    owner: sudokn_VacuumPackagingCapability
    domain_of:
    - io_Manufacturer
    - io_MaterialProduct
